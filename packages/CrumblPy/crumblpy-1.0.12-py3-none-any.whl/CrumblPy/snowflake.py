...
class SnowflakeToolKit:
    ...
    def __init__(self, prefect=False, user=None, password=None, role=None, warehouse='DATA_SCIENCE_TEAM'):
        if user and password and role:
            ...
            self.password = serialization.load_pem_private_key(
            ...
            self.role = 'DATA_SCIENCE_SCRIPT_WRITE'
        else:
    ...
    def connect(self):
        self.connection = snowflake.connector.connect(
            ...
            user=self.user,
            password= None if self.prefect else self.password,
            private_key=self.password if self.prefect else None,
            role=self.role,
