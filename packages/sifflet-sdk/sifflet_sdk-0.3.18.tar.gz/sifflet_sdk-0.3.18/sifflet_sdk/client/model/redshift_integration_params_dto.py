...
def lazy_import():
    from sifflet_sdk.client.model.integration_params_dto import IntegrationParamsDto
    from sifflet_sdk.client.model.redshift_integration_params_dto_all_of import (
        RedshiftIntegrationParamsDtoAllOf,
    )
    from sifflet_sdk.client.model.time_zone_dto import TimeZoneDto

    globals()["IntegrationParamsDto"] = IntegrationParamsDto
    globals()["RedshiftIntegrationParamsDtoAllOf"] = RedshiftIntegrationParamsDtoAllOf
    globals()["TimeZoneDto"] = TimeZoneDto


class RedshiftIntegrationParamsDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """RedshiftIntegrationParamsDto - a model defined in OpenAPI
