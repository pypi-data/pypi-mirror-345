...
class DefaultBid(BaseModel):
    ...
    status: DefaultBidStatus
    __properties: ClassVar[List[str]] = ["id", "auctionProductType", "deliveryPeriodStart", "deliveryPeriodEnd", "validityPeriodStart", "validityPeriodEnd", "borderDirection", "status"]
