...
def lazy_import():
    from sifflet_sdk.client.model.public_description_dto import PublicDescriptionDto
    from sifflet_sdk.client.model.public_domain_get_dto import PublicDomainGetDto
    from sifflet_sdk.client.model.public_get_asset_column_dto import (
        PublicGetAssetColumnDto,
    )
    from sifflet_sdk.client.model.public_get_asset_dto_custom_metadata_values_inner import (
    ...
    from sifflet_sdk.client.model.public_tag_reference_get_dto import (
        PublicTagReferenceGetDto,
    )
    from sifflet_sdk.client.model.public_transformation_run_dto import (
        PublicTransformationRunDto,
    )

    globals()["PublicDescriptionDto"] = PublicDescriptionDto
    globals()["PublicDomainGetDto"] = PublicDomainGetDto
    globals()["PublicGetAssetColumnDto"] = PublicGetAssetColumnDto
    globals()["PublicGetAssetDtoCustomMetadataValuesInner"] = PublicGetAssetDtoCustomMetadataValuesInner
    ...
    globals()["PublicTagReferenceGetDto"] = PublicTagReferenceGetDto
    globals()["PublicTransformationRunDto"] = PublicTransformationRunDto


class PublicGetAssetDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "domains": ([PublicDomainGetDto],),  # noqa: E501
            "health_status": (str,),  # noqa: E501
            "id": (str,),  # noqa: E501
            "ingestion_method": (str,),  # noqa: E501
            "name": (str,),  # noqa: E501
            ...
            "urn": (str,),  # noqa: E501
            "usage": (str,),  # noqa: E501
            "columns": ([PublicGetAssetColumnDto],),  # noqa: E501
            "custom_metadata_values": ([PublicGetAssetDtoCustomMetadataValuesInner],),  # noqa: E501
            "description": (
                str,
                none_type,
            ),  # noqa: E501
            "external_descriptions": ([PublicDescriptionDto],),  # noqa: E501
            "owners": ([PublicReferenceByIdOrEmailDto],),  # noqa: E501
            "tags": ([PublicTagReferenceGetDto],),  # noqa: E501
            "terms": ([PublicReferenceByIdOrNameDto],),  # noqa: E501
            "transformation_run": (PublicTransformationRunDto,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        "id": "id",  # noqa: E501
        "ingestion_method": "ingestionMethod",  # noqa: E501
        "name": "name",  # noqa: E501
        ...
        "transformation_run": "transformationRun",  # noqa: E501
    }
    ...
    def _from_openapi_data(
        cls, domains, health_status, id, ingestion_method, name, technology, type, uri, urn, usage, *args, **kwargs
    ):  # noqa: E501
        """PublicGetAssetDto - a model defined in OpenAPI

        Args:
            domains ([PublicDomainGetDto]): Domains of the asset
            health_status (str): Asset health status
            id (str):
            ingestion_method (str): Ingestion method of the asset
            name (str): Name of the asset
            technology (str): Technology of the asset
            type (str): Type of the asset
            uri (str): URI string identifying the asset. <a href=\"https://docs.siffletdata.com/docs/uris\">[Read more about URIs]</a>
            urn (str): Internal Sifflet identifier for the asset
            usage (str): Usage level of the asset
        ...
        Keyword Args:
            ...
            columns ([PublicGetAssetColumnDto]): Fields of the asset. [optional]  # noqa: E501
            custom_metadata_values ([PublicGetAssetDtoCustomMetadataValuesInner]): Custom metadata values of the asset. [optional]  # noqa: E501
            description (str, none_type): Description of the asset. [optional]  # noqa: E501
            external_descriptions ([PublicDescriptionDto]): Descriptions of the asset from external providers. [optional]  # noqa: E501
            owners ([PublicReferenceByIdOrEmailDto]): Owners of the asset. [optional]  # noqa: E501
            tags ([PublicTagReferenceGetDto]): Tags of the asset. [optional]  # noqa: E501
            terms ([PublicReferenceByIdOrNameDto]): Business glossaries of the asset. [optional]  # noqa: E501
            transformation_run (PublicTransformationRunDto): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, domains, health_status, id, ingestion_method, name, technology, type, uri, urn, usage, *args, **kwargs
    ):  # noqa: E501
        """PublicGetAssetDto - a model defined in OpenAPI
