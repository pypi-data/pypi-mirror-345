...
class GetMyTradesV3RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["commission", "commissionAsset", "id", "isBestMatch", "isBuyer", "isMaker", "orderId", "orderListId", "price", "qty", "quoteQty", "symbol", "time"]
