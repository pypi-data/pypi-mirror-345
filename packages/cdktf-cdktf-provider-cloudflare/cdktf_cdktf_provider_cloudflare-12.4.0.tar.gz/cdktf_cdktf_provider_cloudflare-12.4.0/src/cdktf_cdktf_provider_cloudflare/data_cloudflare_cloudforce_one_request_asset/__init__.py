...
Refer to the Terraform Registry for docs: [`data_cloudflare_cloudforce_one_request_asset`](https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/cloudforce_one_request_asset).
'''
...
class DataCloudflareCloudforceOneRequestAsset(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_identifier: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/cloudforce_one_request_asset#account_identifier DataCloudflareCloudforceOneRequestAsset#account_identifier}
        :param asset_identifer: UUID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/cloudforce_one_request_asset#asset_identifer DataCloudflareCloudforceOneRequestAsset#asset_identifer}
        :param request_identifier: UUID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/cloudforce_one_request_asset#request_identifier DataCloudflareCloudforceOneRequestAsset#request_identifier}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
        ...
        config = DataCloudflareCloudforceOneRequestAssetConfig(
            ...
            asset_identifer=asset_identifer,
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataCloudflareCloudforceOneRequestAsset that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/cloudforce_one_request_asset#import import section} in the documentation of this resource for the id to use
    ...
    @builtins.property
    @jsii.member(jsii_name="assetIdentiferInput")
    def asset_identifer_input(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "assetIdentiferInput"))
    ...
    def account_identifier(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5f70746f1c9a467faa1a3d03f1574c8695a0b613763ac23362b6dea7aba0420c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "accountIdentifier", value) # pyright: ignore[reportArgumentType]

    @builtins.property
    @jsii.member(jsii_name="assetIdentifer")
    def asset_identifer(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "assetIdentifer"))

    @asset_identifer.setter
    def asset_identifer(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__205c0528aa0945de53057534244bd83150a48bfca2803f2bf295feb4b7cf37c8)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "assetIdentifer", value) # pyright: ignore[reportArgumentType]
    ...
    def request_identifier(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__373c9c9ac507b6e83028ab6bb77f0ad1804fb9e0450db8cce1f79ddc9c067814)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "asset_identifer": "assetIdentifer",
...
class DataCloudflareCloudforceOneRequestAssetConfig(
    ...
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument asset_identifer", value=asset_identifer, expected_type=type_hints["asset_identifer"])
    ...
    def account_identifier(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/cloudforce_one_request_asset#account_identifier DataCloudflareCloudforceOneRequestAsset#account_identifier}
        '''
    ...
    def asset_identifer(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/cloudforce_one_request_asset#asset_identifer DataCloudflareCloudforceOneRequestAsset#asset_identifer}
        '''
        result = self._values.get("asset_identifer")
        assert result is not None, "Required property 'asset_identifer' is missing"
        return typing.cast(builtins.str, result)
    ...
    def request_identifier(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/cloudforce_one_request_asset#request_identifier DataCloudflareCloudforceOneRequestAsset#request_identifier}
        '''
...
def _typecheckingstub__5f70746f1c9a467faa1a3d03f1574c8695a0b613763ac23362b6dea7aba0420c(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__205c0528aa0945de53057534244bd83150a48bfca2803f2bf295feb4b7cf37c8(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__373c9c9ac507b6e83028ab6bb77f0ad1804fb9e0450db8cce1f79ddc9c067814(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
