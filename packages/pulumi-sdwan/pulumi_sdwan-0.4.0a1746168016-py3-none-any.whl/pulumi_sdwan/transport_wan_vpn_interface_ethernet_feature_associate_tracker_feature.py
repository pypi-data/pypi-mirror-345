...
__all__ = ['TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs', 'TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature']

@pulumi.input_type
class TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs:
    def __init__(__self__, *,
                 feature_profile_id: pulumi.Input[builtins.str],
                 transport_tracker_feature_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] transport_tracker_feature_id: Transport Tracker Feature ID
    ...
    def transport_tracker_feature_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def transport_tracker_feature_id(self, value: pulumi.Input[builtins.str]):
...
@pulumi.input_type
class _TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureState:
    def __init__(__self__, *,
                 feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
                 transport_tracker_feature_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="transportTrackerFeatureId")
    def transport_tracker_feature_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Transport Tracker Feature ID
        """
        return pulumi.get(self, "transport_tracker_feature_id")
    ...
    @transport_tracker_feature_id.setter
    def transport_tracker_feature_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "transport_tracker_feature_id", value)
...
class TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature(pulumi.CustomResource):
    ...
    pulumi_type = "sdwan:index/transportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature:TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature"
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource can manage a Transport WAN VPN Interface Ethernet Feature Associate Tracker Feature .
          - Minimum SD-WAN Manager version: `20.12.0`
        ...
        :param str resource_name: The name of the resource.
        :param TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs.__new__(TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs)
    ...
    def get(resource_name: str,
            ...
            transport_wan_vpn_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            transport_wan_vpn_interface_ethernet_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature':
        """
        ...
        __props__ = _TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureState.__new__(_TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureState)
    ...
    @property
    @pulumi.getter(name="transportTrackerFeatureId")
    def transport_tracker_feature_id(self) -> pulumi.Output[builtins.str]:
        """
        Transport Tracker Feature ID
        """
        return pulumi.get(self, "transport_tracker_feature_id")
