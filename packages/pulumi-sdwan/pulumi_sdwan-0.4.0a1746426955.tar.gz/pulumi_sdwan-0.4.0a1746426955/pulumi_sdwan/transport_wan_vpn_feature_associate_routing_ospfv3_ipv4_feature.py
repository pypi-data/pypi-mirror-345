...
__all__ = ['TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4FeatureArgs', 'TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4Feature']

@pulumi.input_type
class TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4FeatureArgs:
    def __init__(__self__, *,
                 feature_profile_id: pulumi.Input[builtins.str],
                 transport_routing_ospfv3_ipv4_feature_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] transport_routing_ospfv3_ipv4_feature_id: Transport Routing OSPFv4 IPv4 Feature ID
    ...
    def transport_routing_ospfv3_ipv4_feature_id(self) -> pulumi.Input[builtins.str]:
        """
        Transport Routing OSPFv4 IPv4 Feature ID
        """
        return pulumi.get(self, "transport_routing_ospfv3_ipv4_feature_id")

    @transport_routing_ospfv3_ipv4_feature_id.setter
    def transport_routing_ospfv3_ipv4_feature_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "transport_routing_ospfv3_ipv4_feature_id", value)
...
@pulumi.input_type
class _TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4FeatureState:
    def __init__(__self__, *,
                 feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
                 transport_routing_ospfv3_ipv4_feature_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        if feature_profile_id is not None:
            pulumi.set(__self__, "feature_profile_id", feature_profile_id)
        if transport_routing_ospfv3_ipv4_feature_id is not None:
            pulumi.set(__self__, "transport_routing_ospfv3_ipv4_feature_id", transport_routing_ospfv3_ipv4_feature_id)
    ...
    @property
    @pulumi.getter(name="transportRoutingOspfv3Ipv4FeatureId")
    def transport_routing_ospfv3_ipv4_feature_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Transport Routing OSPFv4 IPv4 Feature ID
        """
        return pulumi.get(self, "transport_routing_ospfv3_ipv4_feature_id")
    ...
    @transport_routing_ospfv3_ipv4_feature_id.setter
    def transport_routing_ospfv3_ipv4_feature_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "transport_routing_ospfv3_ipv4_feature_id", value)
...
class TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4Feature(pulumi.CustomResource):
    ...
    pulumi_type = "sdwan:index/transportWanVpnFeatureAssociateRoutingOspfv3Ipv4Feature:TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4Feature"
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4FeatureArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource can manage a Transport WAN VPN Feature Associate Routing OSPFv3 IPv4 Feature .
          - Minimum SD-WAN Manager version: `20.12.0`
        ...
        :param str resource_name: The name of the resource.
        :param TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4FeatureArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4FeatureArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4FeatureArgs.__new__(TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4FeatureArgs)

            if feature_profile_id is None and not opts.urn:
                raise TypeError("Missing required property 'feature_profile_id'")
            __props__.__dict__["feature_profile_id"] = feature_profile_id
            if transport_routing_ospfv3_ipv4_feature_id is None and not opts.urn:
                raise TypeError("Missing required property 'transport_routing_ospfv3_ipv4_feature_id'")
    ...
    def get(resource_name: str,
            ...
            transport_routing_ospfv3_ipv4_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            transport_wan_vpn_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4Feature':
        """
        ...
        __props__ = _TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4FeatureState.__new__(_TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4FeatureState)
    ...
    @property
    @pulumi.getter(name="transportRoutingOspfv3Ipv4FeatureId")
    def transport_routing_ospfv3_ipv4_feature_id(self) -> pulumi.Output[builtins.str]:
        """
        Transport Routing OSPFv4 IPv4 Feature ID
        """
        return pulumi.get(self, "transport_routing_ospfv3_ipv4_feature_id")
