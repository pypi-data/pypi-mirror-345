...
def database_settings_source(settings: BaseSettings):
    return fetch_settings_from_database(settings_class=settings.__class__, namespace=settings.__class__.__name__)
...
def fetch_settings_from_database(settings_class, namespace: str):
    ...
    try:
        ...
        for setting in settings:
            ...
            if setting.key in settings_class.__fields__ :
