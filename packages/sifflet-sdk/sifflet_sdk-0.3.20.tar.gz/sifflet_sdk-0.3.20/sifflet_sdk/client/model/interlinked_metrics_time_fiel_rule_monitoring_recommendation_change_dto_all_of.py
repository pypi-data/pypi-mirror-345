...
class InterlinkedMetricsTimeFielRuleMonitoringRecommendationChangeDtoAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InterlinkedMetricsTimeFielRuleMonitoringRecommendationChangeDtoAllOf - a model defined in OpenAPI
