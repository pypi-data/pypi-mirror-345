...
class Thickness(_message.Message):
    ...
    class LayersReferenceTableRow(_message.Message):
        __slots__ = ("no", "description", "layer_no", "layer_type", "thickness_type_or_id", "material", "thickness", "angle", "integration_points", "connection_with_other_topological_elements", "edge_finishing_type", "comment", "specific_weight", "weight")
        ...
        EDGE_FINISHING_TYPE_FIELD_NUMBER: _ClassVar[int]
