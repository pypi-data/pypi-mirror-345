...
class UpdateUserUiRequestDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "domains": ([UserPermissionAssignmentDto],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, auth_types, domains, is_active, name, role, *args, **kwargs):  # noqa: E501
        """UpdateUserUiRequestDto - a model defined in OpenAPI

        Args:
            auth_types ([str]):
            domains ([UserPermissionAssignmentDto]):
            is_active (bool):
            name (str):
            role (str):
    ...
    @convert_js_args_to_python_args
    def __init__(self, auth_types, domains, is_active, name, role, *args, **kwargs):  # noqa: E501
        """UpdateUserUiRequestDto - a model defined in OpenAPI
