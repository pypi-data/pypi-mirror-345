"""
Configuration system for the inspectomat package.
...
# Import the logger
from inspectomat.logger import get_logger

# Get logger for this module
logger = get_logger(__name__)

# Default configuration directory
DEFAULT_CONFIG_DIR = os.path.expanduser('~/.inspectomat')
...
class ConfigManager:
    """
    Configuration manager for the inspectomat package.
    """
    def __init__(self, config_file: Optional[str] = None):
        ...
        Args:
            config_file: Path to the configuration file (default: ~/.inspectomat/config.json)
        """
