...
def lazy_import():
    from sifflet_sdk.client.model.get_tables_job_action_all_of import (
        GetTablesJobActionAllOf,
    )
    from sifflet_sdk.client.model.jdbc_datasource_job_action import (
        JdbcDatasourceJobAction,
    )

    globals()["GetTablesJobActionAllOf"] = GetTablesJobActionAllOf
    globals()["JdbcDatasourceJobAction"] = JdbcDatasourceJobAction


class GetTablesJobAction(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GetTablesJobAction - a model defined in OpenAPI
