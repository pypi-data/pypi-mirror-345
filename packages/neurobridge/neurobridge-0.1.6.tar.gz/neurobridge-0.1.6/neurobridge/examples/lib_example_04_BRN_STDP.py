    ...
    def build_user_network(self, rank: int, world_size: int, device: str):
        ...
        with self.autoparent("graph"):
            ...
            e2e: StaticDenseConnection = (exc_neurons >> exc_neurons)(
                ...
                w_max = 3e-6,
                mask = torch.rand((exc_neurons.size, exc_neurons.size), device=device) < self.conn_prob, #TODO: Esto es feo, habría que simplificar asignar valores aleatorios a mask sin tener que poner el tamaño de la matriz
            )
