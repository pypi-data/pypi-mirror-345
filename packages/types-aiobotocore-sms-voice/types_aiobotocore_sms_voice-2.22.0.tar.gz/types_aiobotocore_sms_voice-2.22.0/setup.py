"""
Setup script for types-aiobotocore-sms-voice.
...
setup(
    ...
    description="Type annotations for aiobotocore SMSVoice 2.22.0 service generated with mypy-boto3-builder 8.10.1",
    classifiers=[
    ...
    keywords="aiobotocore sms-voice aiobotocore-stubs type-annotations mypy typeshed autocomplete",
