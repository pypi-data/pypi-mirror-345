...
from empire_platform_api_public_client_legacy.models.day_ahead_or_intra_day_auction_bid_group_result_batch import DayAheadOrIntraDayAuctionBidGroupResultBatch  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DayAheadOrIntraDayAuctionBidGroupResultBatch:
        ...
        if include_optional:
            return DayAheadOrIntraDayAuctionBidGroupResultBatch(
                entries = [
                    empire_platform_api_public_client_legacy.models.day_ahead_or_intra_day_auction_bid_group_result.DayAheadOrIntraDayAuctionBidGroupResult(
                        ...
                        participant = empire_platform_api_public_client_legacy.models.audit_log_user_organisation.AuditLogUserOrganisation(
                            ...
                            name = '', ), 
                        bids = [
                            empire_platform_api_public_client_legacy.models.day_ahead_or_intra_day_auction_bid_group_result_bids.DayAheadOrIntraDayAuctionBidGroupResult_bids(
