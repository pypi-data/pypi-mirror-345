...
def _check_ibm_qc(max_time_ibm):
    ...
    #token = "0bcf8048b2deb623d011c71cdeabe527ee86ffc3e3d93a333fc489127a77e66ce7ad769f2934d7f2da92668b8575b6d0bca7f15cb893f3a128185cdf4a926eb6"
    #service = QiskitRuntimeService(channel="ibm_quantum", token=token, proxies=proxies)
    #print(service)

    token = "DMlEJtWl012lD820FwU6x9S0WhjcuaFXCOv0SiZ_FfOe"
    instance = "crn:v1:bluemix:public:quantum-computing:us-east:a/133e882f88ff4a43abcc79c2bd2804b5:4ea14bd9-a090-4d48-8288-ed9f2bfdea1c::"
