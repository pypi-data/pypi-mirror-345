"""
Setup script for mypy-boto3-bedrock-data-automation.
...
setup(
    ...
    version="1.38.8",
    packages=["mypy_boto3_bedrock_data_automation"],
    ...
    package_data={"mypy_boto3_bedrock_data_automation": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
