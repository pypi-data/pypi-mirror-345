...
class GetAccountApiTradingStatusV1Resp(BaseModel):
    """
    GetAccountApiTradingStatusV1Resp
    """ # noqa: E501
    data: Optional[GetAccountApiTradingStatusV1RespData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GetAccountApiTradingStatusV1RespData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
