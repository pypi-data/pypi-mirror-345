...
class GetCmAccountV1RespPositionsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["entryPrice", "initialMargin", "leverage", "maintMargin", "maxQty", "openOrderInitialMargin", "positionAmt", "positionInitialMargin", "positionSide", "symbol", "unrealizedProfit", "updateTime"]
