...
class GetUmAccountConfigV1Resp(BaseModel):
    """
    ...
    dual_side_position: Optional[StrictBool] = Field(default=None, alias="dualSidePosition")
    ...
    __properties: ClassVar[List[str]] = ["canDeposit", "canTrade", "canWithdraw", "dualSidePosition", "feeTier", "multiAssetsMargin", "tradeGroupId", "updateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dualSidePosition": obj.get("dualSidePosition"),
