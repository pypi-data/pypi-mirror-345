"""
The wntrfr.network.controls module includes methods to define network controls
...
from wntrfr.utils.doc_inheritor import DocInheritor
import warnings
...
class ControlCondition(six.with_metaclass(abc.ABCMeta, object)):
    ...
    def backtrack(self):
        ...
        Should be updated by the :class:`~wntrfr.network.controls.ControlCondition.evaluate` method if appropriate.
...
class TimeOfDayCondition(ControlCondition):
    ...
    Unlike the :class:`~wntrfr.network.controls.SimTimeCondition`, greater-than and less-than
...
class Control(Rule):
    ...
    def _time_control(cls, wnm, run_at_time, time_flag, daily_flag, control_action, name=None):
        ...
        Parameters
        ----------
        wnm: wntrfr.network.WaterNetworkModel
