...
from SajadMr.optimizations.TraceCollections import (
    TraceCollectionPureFunction,
    withChangeIndicationsTo,
)
from SajadMr.PythonVersions import python_version
from SajadMr.specs.ParameterSpecs import (
    ParameterSpec,
    TooManyArguments,
    matchCall,
)
from SajadMr.Tracing import optimization_logger, printError
from SajadMr.tree.Extractions import updateVariableUsage
from SajadMr.tree.SourceHandling import readSourceLines
from SajadMr.tree.TreeHelpers import makeDictCreationOrConstant2
...
class ExpressionFunctionRef(ExpressionNoSideEffectsMixin, ExpressionBase):
    ...
    def getFunctionBody(self):
        if self.function_body is None:
            ...
            from SajadMr.ModuleRegistry import getModuleFromCodeName
...
class ExpressionFunctionCall(ChildrenHavingFunctionValuesTupleMixin, ExpressionBase):
    ...
    def computeExpression(self, trace_collection):
        ...
        if cost is not None and cost < 50:
            from SajadMr.optimizations.FunctionInlining import (
