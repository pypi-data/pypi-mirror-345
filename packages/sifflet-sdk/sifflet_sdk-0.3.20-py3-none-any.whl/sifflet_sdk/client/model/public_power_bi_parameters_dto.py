...
def lazy_import():
    from sifflet_sdk.client.model.public_power_bi_parameters_dto_all_of import (
        PublicPowerBiParametersDtoAllOf,
    )
    from sifflet_sdk.client.model.public_source_parameters_dto import (
        PublicSourceParametersDto,
    )

    globals()["PublicPowerBiParametersDtoAllOf"] = PublicPowerBiParametersDtoAllOf
    globals()["PublicSourceParametersDto"] = PublicSourceParametersDto


class PublicPowerBiParametersDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PublicPowerBiParametersDto - a model defined in OpenAPI

        Keyword Args:
            client_id (str): Your Azure AD client ID
            tenant_id (str): Your Azure AD tenant ID
            workspace_id (str): Your Power BI workspace ID
            type (str):
