...
<p align="center">
    <a href="https://pypi.org/project/evo-data-converters-resqml/"><img alt="PyPI - Version" src="https://img.shields.io/pypi/v/evo-data-converters-resqml" /></a>
...
To protect against this there is a `memory_threshold` setting in [conversion_options.py](src/evo/data_converters/resqml/importer/conversion_options.py). Grids will only be converted if the estimated size of `grid.corner_points` is less than the threshold. The default is 8 GiB but this can be increased if you have more memory available where the importer is running.
