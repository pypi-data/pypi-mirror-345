...
static PyObject *%(function_identifier)s_context(PyThreadState *tstate, struct SajadQ_CoroutineObject *coroutine, PyObject *yield_return_value) {
...
# TODO: For functions SajadSx_CANNOT_GET_HERE is injected by composing code.
template_coroutine_exception_exit = """\
    SajadSx_CANNOT_GET_HERE("Return statement must be present");
