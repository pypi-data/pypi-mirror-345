...
def _extract_route_metadata(route: APIRoute) -> Dict[str, Any]:
    """Extract metadata from a single APIRoute.

    Args:
        route (APIRoute): The route to inspect.
