...
class GetOpenOrdersV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["activatePrice", "avgPrice", "clientOrderId", "closePosition", "cumBase", "executedQty", "orderId", "origQty", "origType", "positionSide", "price", "priceMatch", "priceProtect", "priceRate", "reduceOnly", "selfTradePreventionMode", "side", "status", "stopPrice", "symbol", "time", "timeInForce", "type", "updateTime", "workingType"]
