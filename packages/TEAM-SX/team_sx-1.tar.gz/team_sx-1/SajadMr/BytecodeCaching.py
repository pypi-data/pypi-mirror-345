...
from SajadMr.ModuleRegistry import getModuleOptimizationTimingInfos
from SajadMr.plugins.Plugins import Plugins
from SajadMr.utils.AppDirs import getCacheDir
from SajadMr.utils.FileOperations import makePath
from SajadMr.utils.Hashing import Hash, getStringHash
from SajadMr.utils.Json import loadJsonFromFilename, writeJsonToFilename
...
def _getModuleConfigHash(full_name):
    ...
    # Take SajadQ and Python version into account as well, ought to catch code changes.
