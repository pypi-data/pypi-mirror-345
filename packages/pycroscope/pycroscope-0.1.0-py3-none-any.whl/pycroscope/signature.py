...
class ImplReturn(NamedTuple):
    ...
    These functions return either a single :class:`pycroscope.value.Value`
    ...
    """A :class:`pycroscope.stacked_scopes.Constraint` indicating things that are true
...
class Signature:
    ...
    :class:`pycroscope.value.CallableValue` class.
