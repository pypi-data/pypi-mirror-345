...
class OAuthIntegrationRedirectDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, state, *args, **kwargs):  # noqa: E501
        """OAuthIntegrationRedirectDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, state, *args, **kwargs):  # noqa: E501
        """OAuthIntegrationRedirectDto - a model defined in OpenAPI
