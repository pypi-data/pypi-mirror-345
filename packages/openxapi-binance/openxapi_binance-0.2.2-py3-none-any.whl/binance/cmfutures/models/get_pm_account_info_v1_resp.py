...
class GetPmAccountInfoV1Resp(BaseModel):
    """
    ...
    max_withdraw_amount_usd: Optional[StrictStr] = Field(default=None, alias="maxWithdrawAmountUSD")
    __properties: ClassVar[List[str]] = ["asset", "maxWithdrawAmount", "maxWithdrawAmountUSD"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maxWithdrawAmountUSD": obj.get("maxWithdrawAmountUSD")
        })
        return _obj
