...
class LiveToolsThroughputTestArgs:
    def __init__(__self__, *,
                 ...
                 throughput_test_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] throughput_test_id: ID of throughput test job
        """
    ...
    def throughput_test_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def throughput_test_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _LiveToolsThroughputTestState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['LiveToolsThroughputTestCallbackArgs'] callback: Details for the callback. Please include either an httpServerId OR url and sharedSecret
        :param pulumi.Input[builtins.str] error: Description of the error.
        ...
        :param pulumi.Input[builtins.str] serial: serial path parameter.
        :param pulumi.Input[builtins.str] status: Status of the throughput test request
        :param pulumi.Input[builtins.str] throughput_test_id: ID of throughput test job
        :param pulumi.Input[builtins.str] url: GET this url to check the status of your throughput test request
        """
        if callback is not None:
            pulumi.set(__self__, "callback", callback)
...
class LiveToolsThroughputTest(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            throughput_test_id: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'LiveToolsThroughputTest':
        """
    ...
    @property
    @pulumi.getter(name="throughputTestId")
    def throughput_test_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of throughput test job
        """
        return pulumi.get(self, "throughput_test_id")
