...
class GetOpenOrdersV1RespItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["avgPrice", "clientOrderId", "createTime", "executedQty", "fee", "mmp", "optionSide", "orderId", "postOnly", "price", "priceScale", "quantity", "quantityScale", "quoteAsset", "reduceOnly", "side", "status", "symbol", "timeInForce", "type", "updateTime"]
