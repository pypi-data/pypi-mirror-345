...
#ifndef __SajadSx_HELPER_COMPLEX_H__
#define __SajadSx_HELPER_COMPLEX_H__

SajadSx_MAY_BE_UNUSED static PyObject *BUILTIN_COMPLEX1(PyThreadState *tstate, PyObject *real) {
    CHECK_OBJECT(real);
...
SajadSx_MAY_BE_UNUSED static PyObject *BUILTIN_COMPLEX2(PyThreadState *tstate, PyObject *real, PyObject *imag) {
    if (real == NULL) {
        assert(imag != NULL);
