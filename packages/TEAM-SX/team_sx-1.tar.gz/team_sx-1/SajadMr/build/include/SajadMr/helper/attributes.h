...
#ifndef __SajadSx_HELPER_ATTRIBUTES_H__
#define __SajadSx_HELPER_ATTRIBUTES_H__
...
static inline bool SajadQ_Descr_IsData(PyObject *object) { return Py_TYPE(object)->tp_descr_set != NULL; }
#else
#define SajadQ_Descr_IsData(object) PyDescr_IsData(object)
#endif
