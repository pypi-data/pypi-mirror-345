...
class global_poa(ResourceTypeDescriptor):
    """The total solar irradiance incident on a photovoltaic (PV) module, accounting for the module's orientation and tilt. """
