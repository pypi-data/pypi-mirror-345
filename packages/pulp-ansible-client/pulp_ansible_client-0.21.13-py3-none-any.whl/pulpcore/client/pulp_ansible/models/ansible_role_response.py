...
class AnsibleRoleResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, pulp_href=None, artifact=None, pulp_created=None, version=None, name=None, namespace=None, local_vars_configuration=None):  # noqa: E501
