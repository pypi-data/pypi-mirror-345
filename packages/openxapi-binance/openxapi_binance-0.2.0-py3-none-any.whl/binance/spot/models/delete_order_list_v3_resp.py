...
class DeleteOrderListV3Resp(BaseModel):
    """
    ...
    order_reports: Optional[List[DeleteOrderListV3RespOrderReportsInner]] = Field(default=None, alias="orderReports")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderReports": [DeleteOrderListV3RespOrderReportsInner.from_dict(_item) for _item in obj["orderReports"]] if obj.get("orderReports") is not None else None,
