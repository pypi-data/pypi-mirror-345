...
class ChatsResponse(object):
    ...
    def __init__(self, result=None, errors=None):  # noqa: E501
        """ChatsResponse - a model defined in Swagger"""  # noqa: E501
        self._result = None
        self._errors = None
    ...
    @property
    def result(self):
        """Gets the result of this ChatsResponse.  # noqa: E501


        :return: The result of this ChatsResponse.  # noqa: E501
        :rtype: list[Chat]
        """
        return self._result
    ...
    def result(self, result):
        """Sets the result of this ChatsResponse.


        :param result: The result of this ChatsResponse.  # noqa: E501
        :type: list[Chat]
        """
    ...
    @property
    def errors(self):
        """Gets the errors of this ChatsResponse.  # noqa: E501

        Ohibki, esli est  # noqa: E501

        :return: The errors of this ChatsResponse.  # noqa: E501
        :rtype: list[str]
        """
        return self._errors
    ...
    def errors(self, errors):
        """Sets the errors of this ChatsResponse.

        Ohibki, esli est  # noqa: E501

        :param errors: The errors of this ChatsResponse.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ChatsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChatsResponse):
            return False
