...
Type annotations for [aioboto3 14.2.0](https://pypi.org/project/aioboto3/)
...
1. Run mypy-boto3-builder in your package root directory:
   `uvx --with 'aioboto3==14.2.0' mypy-boto3-builder`
...
- `types-aioboto3[full]` - Type annotations for all 401 services in one package
  (recommended).
- `types-aioboto3[all]` - Type annotations for all 401 services in separate
  packages.
