...
class SystemMrfFeatureArgs:
    ...
    def enable_migration_to_mrf(self) -> Optional[pulumi.Input[builtins.str]]:
        """
...
class SystemMrfFeature(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secondary_region_id: Optional[pulumi.Input[builtins.int]] = None,
            secondary_region_id_variable: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'SystemMrfFeature':
        """
    ...
    @property
    @pulumi.getter(name="enableMigrationToMrf")
    def enable_migration_to_mrf(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Enable migration mode to Multi-Region Fabric - Choices: `enabled`, `enabled-from-bgp-core`
        """
        return pulumi.get(self, "enable_migration_to_mrf")
