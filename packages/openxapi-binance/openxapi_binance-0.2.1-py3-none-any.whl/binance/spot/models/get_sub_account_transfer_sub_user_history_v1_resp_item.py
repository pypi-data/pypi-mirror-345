...
class GetSubAccountTransferSubUserHistoryV1RespItem(BaseModel):
    """
    GetSubAccountTransferSubUserHistoryV1RespItem
    """ # noqa: E501
    asset: Optional[StrictStr] = None
    counter_party: Optional[StrictStr] = Field(default=None, alias="counterParty")
    ...
    __properties: ClassVar[List[str]] = ["asset", "counterParty", "email", "fromAccountType", "qty", "status", "time", "toAccountType", "tranId", "type"]
