...
class GetUmForceOrdersV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["avgPrice", "clientOrderId", "cumQuote", "executedQty", "orderId", "origQty", "origType", "positionSide", "price", "reduceOnly", "side", "status", "symbol", "time", "timeInForce", "type", "updateTime"]
