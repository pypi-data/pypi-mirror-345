<a id="types-boto3-appconfig"></a>

# types-boto3-appconfig

[![PyPI - types-boto3-appconfig](https://img.shields.io/pypi/v/types-boto3-appconfig.svg?color=blue)](https://pypi.org/project/types-boto3-appconfig/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-appconfig.svg?color=blue)](https://pypi.org/project/types-boto3-appconfig/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-appconfig)](https://pypistats.org/packages/types-boto3-appconfig)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 AppConfig 1.38.7](https://pypi.org/project/boto3/)
...
[types-boto3-appconfig docs](https://youtype.github.io/types_boto3_docs/types_boto3_appconfig/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-appconfig](#types-boto3-appconfig)
...
- Install `types-boto3[appconfig]` in your environment:
...
- Install `types-boto3[appconfig]` with services you use in your environment:
...
`types-boto3-appconfig` dependency in production. However, there is an issue in
...
from types_boto3_appconfig import AppConfigClient
...
`types_boto3_appconfig.paginator` module contains type annotations for all
paginators.
...
from types_boto3_appconfig import AppConfigClient
from types_boto3_appconfig.paginator import (
...
`types_boto3_appconfig.waiter` module contains type annotations for all
waiters.
...
environment_ready_for_deployment_waiter: EnvironmentReadyForDeploymentWaiter = client.get_waiter(
...
`types_boto3_appconfig.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

Full list of `AppConfig` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_appconfig/literals/).
...
`types_boto3_appconfig.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `AppConfig` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_appconfig/type_defs/).
...
`types-boto3-appconfig` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_appconfig/)
