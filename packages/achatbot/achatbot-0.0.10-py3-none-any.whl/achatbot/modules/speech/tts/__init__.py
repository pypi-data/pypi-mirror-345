...
from achatbot.common.types import ASSETS_DIR, MODELS_DIR, RECORDS_DIR
...
class TTSEnvInit:
    ...
    def get_tts_cosy_voice_args() -> dict:
        from achatbot.common.types import CosyVoiceTTSArgs
    ...
    def get_tts_fishspeech_args() -> dict:
        from achatbot.types.speech.tts.fish_speech import FishSpeechTTSArgs
    ...
    def get_tts_f5_args() -> dict:
        from achatbot.types.speech.tts.f5 import F5TTSArgs, F5TTSDiTModelConfig
    ...
    def get_tts_openvoicev2_args() -> dict:
        from achatbot.types.speech.tts.openvoicev2 import OpenVoiceV2TTSArgs
    ...
    def get_tts_llasa_args() -> dict:
        from achatbot.types.speech.tts.llasa import LlasaTTSArgs
        from achatbot.types.llm.transformers import TransformersSpeechLMArgs
        from achatbot.types.codec import CodecArgs
    ...
    def get_tts_orpheus_args() -> dict:
        from achatbot.types.speech.tts.orpheus import OrpheusTTSArgs
        from achatbot.types.llm.transformers import TransformersSpeechLMArgs
        from achatbot.types.codec import CodecArgs
    ...
    def get_tts_step_args() -> dict:
        from achatbot.types.speech.tts.step import StepTTSArgs
        from achatbot.types.llm.transformers import TransformersSpeechLMArgs
    ...
    def get_tts_spark_args() -> dict:
        from achatbot.types.speech.tts.spark import SparkTTSArgs
        from achatbot.types.llm.transformers import TransformersSpeechLMArgs
    ...
    def get_tts_mega3_args() -> dict:
        from achatbot.types.speech.tts.mega3 import Mega3TTSArgs
    ...
    def get_tts_zonos_args() -> dict:
        from achatbot.types.speech.tts.zonos import ZonosTTSArgs
