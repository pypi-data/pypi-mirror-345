...
class Resource(root.AbstractMemberObject):
    ...
    def creator_users(self) -> list[str]:
        ...
        True. Returns a de-duplicated list. This property and the add_*, remove_*, and is_* methods must all be
        overridden together.
        """
    ...
    def creator_groups(self) -> list[str]:
        ...
        is True. Returns a de-duplicated list. This property and the add_*, remove_*, and is_* methods must all be
        overridden together.
        """
    ...
    def collection_accessor_users(self) -> list[str]:
        ...
        access these objects via a Collection. Getting the users will return a de-duplicated list. This property
    ...
    def collection_accessor_groups(self) -> list[str]:
        ...
        access these objects via a Collection. Getting the groups will return a de-duplicated list. This property
        and the add_*, remove_*, and is_* methods must all be overridden together.
        """
