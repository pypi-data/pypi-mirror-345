...
class ConcreteEffectiveLengths(_message.Message):
    ...
    class FireDesignNodalSupportsRow(_message.Message):
        ...
        support_in_y_type: ConcreteEffectiveLengths.FireDesignNodalSupportsRow.SupportInY
        restraint_about_x_type: ConcreteEffectiveLengths.FireDesignNodalSupportsRow.RestraintAboutX
        restraint_about_z_type: ConcreteEffectiveLengths.FireDesignNodalSupportsRow.RestraintAboutZ
        restraint_warping_type: ConcreteEffectiveLengths.FireDesignNodalSupportsRow.RestraintWarping
        nodes: _containers.RepeatedScalarFieldContainer[int]
        def __init__(self, no: _Optional[int] = ..., description: _Optional[str] = ..., support_type: _Optional[_Union[ConcreteEffectiveLengths.FireDesignNodalSupportsRow.SupportType, str]] = ..., support_in_z: bool = ..., support_spring_in_y: _Optional[float] = ..., eccentricity_type: _Optional[_Union[ConcreteEffectiveLengths.FireDesignNodalSupportsRow.EccentricityType, str]] = ..., eccentricity_ez: _Optional[float] = ..., restraint_spring_about_x: _Optional[float] = ..., restraint_spring_about_z: _Optional[float] = ..., restraint_spring_warping: _Optional[float] = ..., support_in_y_type: _Optional[_Union[ConcreteEffectiveLengths.FireDesignNodalSupportsRow.SupportInY, str]] = ..., restraint_about_x_type: _Optional[_Union[ConcreteEffectiveLengths.FireDesignNodalSupportsRow.RestraintAboutX, str]] = ..., restraint_about_z_type: _Optional[_Union[ConcreteEffectiveLengths.FireDesignNodalSupportsRow.RestraintAboutZ, str]] = ..., restraint_warping_type: _Optional[_Union[ConcreteEffectiveLengths.FireDesignNodalSupportsRow.RestraintWarping, str]] = ..., nodes: _Optional[_Iterable[int]] = ...) -> None: ...
    ...
    class NodalSupportsRow(_message.Message):
        ...
        restraint_spring_about_z: float
        restraint_spring_warping: float
        support_in_y_type: ConcreteEffectiveLengths.NodalSupportsRow.SupportInY
        restraint_about_x_type: ConcreteEffectiveLengths.NodalSupportsRow.RestraintAboutX
        restraint_about_z_type: ConcreteEffectiveLengths.NodalSupportsRow.RestraintAboutZ
        restraint_warping_type: ConcreteEffectiveLengths.NodalSupportsRow.RestraintWarping
        nodes: _containers.RepeatedScalarFieldContainer[int]
        def __init__(self, no: _Optional[int] = ..., description: _Optional[str] = ..., support_type: _Optional[_Union[ConcreteEffectiveLengths.NodalSupportsRow.SupportType, str]] = ..., support_in_z: bool = ..., support_spring_in_y: _Optional[float] = ..., eccentricity_type: _Optional[_Union[ConcreteEffectiveLengths.NodalSupportsRow.EccentricityType, str]] = ..., eccentricity_ez: _Optional[float] = ..., restraint_spring_about_x: _Optional[float] = ..., restraint_spring_about_z: _Optional[float] = ..., restraint_spring_warping: _Optional[float] = ..., support_in_y_type: _Optional[_Union[ConcreteEffectiveLengths.NodalSupportsRow.SupportInY, str]] = ..., restraint_about_x_type: _Optional[_Union[ConcreteEffectiveLengths.NodalSupportsRow.RestraintAboutX, str]] = ..., restraint_about_z_type: _Optional[_Union[ConcreteEffectiveLengths.NodalSupportsRow.RestraintAboutZ, str]] = ..., restraint_warping_type: _Optional[_Union[ConcreteEffectiveLengths.NodalSupportsRow.RestraintWarping, str]] = ..., nodes: _Optional[_Iterable[int]] = ...) -> None: ...
    ...
    def __init__(self, no: _Optional[int] = ..., user_defined_name_enabled: bool = ..., name: _Optional[str] = ..., comment: _Optional[str] = ..., members: _Optional[_Iterable[int]] = ..., member_sets: _Optional[_Iterable[int]] = ..., lateral_torsional_buckling: bool = ..., buckling_factor_value_type: _Optional[_Union[ConcreteEffectiveLengths.BucklingFactorValueType, str]] = ..., is_generated: bool = ..., generating_object_info: _Optional[str] = ..., intermediate_nodes: bool = ..., different_properties: bool = ..., factors_definition_absolute: bool = ..., fire_design_nodal_supports: _Optional[_Union[ConcreteEffectiveLengths.FireDesignNodalSupportsTable, _Mapping]] = ..., fire_design_factors: _Optional[_Union[ConcreteEffectiveLengths.FireDesignFactorsTable, _Mapping]] = ..., fire_design_lengths: _Optional[_Union[ConcreteEffectiveLengths.FireDesignLengthsTable, _Mapping]] = ..., fire_design_intermediate_nodes: bool = ..., fire_design_different_properties: bool = ..., fire_design_factors_definition_absolute: bool = ..., fire_design_different_buckling_factors: bool = ..., import_from_stability_analysis_enabled: bool = ..., stability_import_data_factors_definition_absolute: bool = ..., stability_import_data_member_y: _Optional[int] = ..., stability_import_data_loading_y: _Optional[int] = ..., stability_import_data_mode_number_y: _Optional[int] = ..., stability_import_data_member_z: _Optional[int] = ..., stability_import_data_loading_z: _Optional[int] = ..., stability_import_data_mode_number_z: _Optional[int] = ..., stability_import_data_factors: _Optional[_Union[ConcreteEffectiveLengths.StabilityImportDataFactorsTable, _Mapping]] = ..., stability_import_data_lengths: _Optional[_Union[ConcreteEffectiveLengths.StabilityImportDataLengthsTable, _Mapping]] = ..., stability_import_data_user_defined_y: bool = ..., stability_import_data_user_defined_z: bool = ..., structure_type_about_axis_y: _Optional[_Union[ConcreteEffectiveLengths.StructureTypeAboutAxisY, str]] = ..., structure_type_about_axis_z: _Optional[_Union[ConcreteEffectiveLengths.StructureTypeAboutAxisZ, str]] = ..., structural_scheme_about_axis_y: _Optional[_Union[ConcreteEffectiveLengths.StructuralSchemeAboutAxisY, str]] = ..., structural_scheme_about_axis_z: _Optional[_Union[ConcreteEffectiveLengths.StructuralSchemeAboutAxisZ, str]] = ..., flexural_buckling_about_y: bool = ..., flexural_buckling_about_z: bool = ..., nodal_supports: _Optional[_Union[ConcreteEffectiveLengths.NodalSupportsTable, _Mapping]] = ..., factors: _Optional[_Union[ConcreteEffectiveLengths.FactorsTable, _Mapping]] = ..., lengths: _Optional[_Union[ConcreteEffectiveLengths.LengthsTable, _Mapping]] = ..., structure_type_about_axis_y_sp63: _Optional[_Union[ConcreteEffectiveLengths.StructureTypeAboutAxisYSp63, str]] = ..., structure_type_about_axis_z_sp63: _Optional[_Union[ConcreteEffectiveLengths.StructureTypeAboutAxisZSp63, str]] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...
