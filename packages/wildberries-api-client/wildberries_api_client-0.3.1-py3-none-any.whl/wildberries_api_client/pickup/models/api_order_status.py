...
class ApiOrderStatus(object):
    ...
    def __init__(self, id=None, supplier_status=None, wb_status=None):  # noqa: E501
        """ApiOrderStatus - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this ApiOrderStatus.  # noqa: E501

        ID sborohnogo zadania  # noqa: E501

        :return: The id of this ApiOrderStatus.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ApiOrderStatus.

        ID sborohnogo zadania  # noqa: E501

        :param id: The id of this ApiOrderStatus.  # noqa: E501
        :type: int
        """
    ...
    def supplier_status(self):
        """Gets the supplier_status of this ApiOrderStatus.  # noqa: E501

        Status sborohnogo zadania prodavca (ustanavlivaetsa prodavcom)  # noqa: E501

        :return: The supplier_status of this ApiOrderStatus.  # noqa: E501
        :rtype: str
        """
    ...
    def supplier_status(self, supplier_status):
        """Sets the supplier_status of this ApiOrderStatus.

        Status sborohnogo zadania prodavca (ustanavlivaetsa prodavcom)  # noqa: E501

        :param supplier_status: The supplier_status of this ApiOrderStatus.  # noqa: E501
        :type: str
        """
    ...
    @property
    def wb_status(self):
        """Gets the wb_status of this ApiOrderStatus.  # noqa: E501

        Status sborohnogo zadania v sisteme WB  # noqa: E501

        :return: The wb_status of this ApiOrderStatus.  # noqa: E501
        :rtype: str
        """
    ...
    def wb_status(self, wb_status):
        """Sets the wb_status of this ApiOrderStatus.

        Status sborohnogo zadania v sisteme WB  # noqa: E501

        :param wb_status: The wb_status of this ApiOrderStatus.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApiOrderStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiOrderStatus):
            return False
