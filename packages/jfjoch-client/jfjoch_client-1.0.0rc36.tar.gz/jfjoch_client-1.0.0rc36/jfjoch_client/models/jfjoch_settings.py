...
class JfjochSettings(BaseModel):
    ...
    resonet_model: Optional[StrictStr] = Field(default=None, description="Path to Resonet model")
    ...
    __properties: ClassVar[List[str]] = ["pcie", "zeromq", "instrument", "file_writer", "detector", "detector_settings", "azim_int", "image_format", "image_buffer_MiB", "receiver_threads", "numa_policy", "frontend_directory", "resonet_model", "image_pusher", "zeromq_preview", "zeromq_metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resonet_model": obj.get("resonet_model"),
