...
def full_process_wrapper(default_dir):
    ...
    pf.resample_to_hourly(df=raw_data, config_data=config_data, default_dir=default_dir) #resamples the input data to hourly intevals
...
full_process_wrapper(default_dir=r"C:\Users\joedw\OneDrive - University of Bristol\Documents\Civil Engineering\Y4\RP4\data\IAEA\Austria\Petzenkirchen\test1")
