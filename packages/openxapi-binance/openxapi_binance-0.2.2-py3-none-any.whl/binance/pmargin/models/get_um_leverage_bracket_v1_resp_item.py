...
class GetUmLeverageBracketV1RespItem(BaseModel):
    """
    GetUmLeverageBracketV1RespItem
    """ # noqa: E501
    brackets: Optional[List[GetUmLeverageBracketV1RespItemBracketsInner]] = None
    notional_coef: Optional[StrictStr] = Field(default=None, alias="notionalCoef")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "brackets": [GetUmLeverageBracketV1RespItemBracketsInner.from_dict(_item) for _item in obj["brackets"]] if obj.get("brackets") is not None else None,
