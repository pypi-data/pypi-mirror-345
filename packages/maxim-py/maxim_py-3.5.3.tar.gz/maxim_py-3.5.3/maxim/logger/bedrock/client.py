    ...
    def converse_stream(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            logging.error(f"Error preparing logging: {str(e)}")
        ...
        try:
                    ...
                    for event in stream:
                        ...
                        if event_type == "contentBlockDelta":
                            ...
                            if usage:
                                ...
                                logging.warning("No usage metrics available in metadata")
            ...
            logging.error(f"Error processing Bedrock stream or logging: {str(e)}")
    ...
    def converse(
        ...
        *,
        ...
        try:
            ...
            logging.error(f"[MaximSDK:BedrockClient] Error preparing logging: {str(e)}")
        api_params = {
            "modelId": modelId,
            "messages": list(messages),
        }
        ...
        try:
            ...
            logging.error(f"[MaximSDK:BedrockClient] Error processing Bedrock stream or logging: {str(e)}")
        return response
