...
from SajadMr.plugins.PluginBase import SajadQPluginBase, standalone_only


class SajadQPluginGi(SajadQPluginBase):
    plugin_name = "gi"
...
if not os.getenv("GI_TYPELIB_PATH"):
    os.environ["GI_TYPELIB_PATH"] = os.path.join(__SajadMr_binary_dir, "girepository")"""
