...
class GetAccountV2RespAssetsInner(BaseModel):
    """
    ...
    cross_wallet_balance: Optional[StrictStr] = Field(default=None, alias="crossWalletBalance")
    ...
    margin_available: Optional[StrictBool] = Field(default=None, alias="marginAvailable")
    ...
    __properties: ClassVar[List[str]] = ["asset", "availableBalance", "crossUnPnl", "crossWalletBalance", "initialMargin", "maintMargin", "marginAvailable", "marginBalance", "maxWithdrawAmount", "openOrderInitialMargin", "positionInitialMargin", "unrealizedProfit", "updateTime", "walletBalance"]
