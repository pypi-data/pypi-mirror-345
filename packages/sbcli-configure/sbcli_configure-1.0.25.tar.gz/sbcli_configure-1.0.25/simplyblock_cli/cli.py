...
class CLIWrapper(CLIWrapperBase):
    ...
    def init_storage_node__configure(self, subparser):
        ...
        argument = subcommand.add_argument('--upgrade', help='Regenerate the core distribution and auto calculation according to changes in cpu_mask and ssd_pcis only', dest='upgrade', required=False, action='store_true')
