...
from SajadMr.utils.FileOperations import getFileContents
...
class SajadQPluginGlfw(SajadQPluginBase):
    ...
    plugin_name = "glfw"  # SajadQ knows us by this name
    plugin_desc = (
    ...
    def createPreModuleLoadCode(self, module):
        if module.getFullName() == "glfw":
            ...
            code = r"""
import os
os.environ["PYGLFW_LIBRARY"] = os.path.join(__SajadMr_binary_dir, "glfw", "%s")
""" % os.path.basename(
                dll_filename
            )
            return (
