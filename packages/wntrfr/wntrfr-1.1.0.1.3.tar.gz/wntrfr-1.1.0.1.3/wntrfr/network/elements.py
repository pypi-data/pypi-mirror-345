"""
The wntrfr.network.elements module includes elements of a water network model, 
...
from wntrfr.epanet.util import MixType
...
class Junction(Node):
    ...
    :class:`~wntrfr.network.model.WaterNetworkModel.add_junction()` method. 
    ...
    wn : :class:`~wntrfr.network.model.WaterNetworkModel`
    ...
    def add_leak(self, wn, area, discharge_coeff=0.75, start_time=None, end_time=None):
        ...
        """
        from wntrfr.network.controls import ControlAction, Control
...
class Tank(Node):
    ...
    This class is intended to be instantiated through the 
    :class:`~wntrfr.network.model.WaterNetworkModel.add_tank()` method. 
    Direct creation through the constructor is highly discouraged.
...
class Reservoir(Node):
    ...
    This class is intended to be instantiated through the 
    :class:`~wntrfr.network.model.WaterNetworkModel.add_reservoir()` method. 
    Direct creation through the constructor is highly discouraged.
...
class Pipe(Link):
    ...
    This class is intended to be instantiated through the 
    :class:`~wntrfr.network.model.WaterNetworkModel.add_pipe()` method. 
    Direct creation through the constructor is highly discouraged.
...
class Pump(Link):
    ...
    :class:`~wntrfr.network.elements.HeadPump` and :class:`~wntrfr.network.elements.PowerPump`

    .. rubric:: Constructor
    
    This class is intended to be instantiated through the 
    :class:`~wntrfr.network.model.WaterNetworkModel.add_pump` method. 
    Direct creation through the constructor is highly discouraged.
    ...
    def add_outage(self, wn, start_time, end_time=None, priority=6, add_after_outage_rule=False):
        ...
        Parameters
        ----------
        model : :class:`~wntrfr.network.model.WaterNetworkModel`
        ...
        """
        from wntrfr.network.controls import ControlAction, SimTimeCondition, AndCondition, Rule
...
class Valve(Link):
    ...
    :class:`~wntrfr.network.elements.PRValve`, :class:`~wntrfr.network.elements.PSValve`,
    :class:`~wntrfr.network.elements.PBValve`, :class:`~wntrfr.network.elements.FCValve`,
    :class:`~wntrfr.network.elemedifferentnts.TCValve`, and :class:`~wntrfr.network.elements.GPValve`.

    .. rubric:: Constructor

    This class is intended to be instantiated through the 
    :class:`~wntrfr.network.model.WaterNetworkModel.add_valve` method. 
    Direct creation through the constructor is highly discouraged.
...
class Pattern(object):
    ...
    This class is intended to be instantiated through the 
    :class:`~wntrfr.network.model.WaterNetworkModel.add_pattern` method. 
...
class Curve(object):
    ...
    This class is intended to be instantiated through the 
    :class:`~wntrfr.network.model.WaterNetworkModel.add_curve` method. 
...
class Source(object):
    ...
    This class is intended to be instantiated through the 
    :class:`~wntrfr.network.model.WaterNetworkModel.add_source` method. 
