...
class CreateCountdownCancelAllV1Resp(BaseModel):
    """
    CreateCountdownCancelAllV1Resp
    """ # noqa: E501
    countdown_time: Optional[StrictInt] = Field(default=None, alias="countdownTime")
    underlying: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["countdownTime", "underlying"]
