...
class BufferUsageBitfield(IntFlag):
    ...
    def __str__(self):
        ...
        if self is BufferUsageBitfield.Transfer:
            return "Transfer"
        if self is BufferUsageBitfield.DispatchIndirectParams:
            return "DispatchIndirectParams"
...
@register_attribute_builder("anonymous_557")
def _anonymous_557(x, context):
    return _ods_ir.IntegerAttr.get(_ods_ir.IntegerType.get_signless(32, context=context), int(x))
