...
class CacheClusterManager(Boto3ModelManager):
    ...
    def create(
        self,
        model: "CacheCluster",
        AZMode: Optional[Literal["single-az", "cross-az"]] = None,
        ...
        OutpostMode: Optional[Literal["single-outpost", "cross-outpost"]] = None,
...
class CacheSubnetGroupManager(Boto3ModelManager):
    ...
    def create(
        self, model: "CacheSubnetGroup", Tags: Optional[List[Tag]] = None
    ) -> "CacheSubnetGroup":
        """
    ...
    def update(
        self, model: "CacheSubnetGroup", SubnetIds: Optional[List[str]] = None
    ) -> "CacheSubnetGroup":
        """
...
class ReplicationGroupManager(Boto3ModelManager):
    ...
    def create(
        ...
        NodeGroupConfiguration: Optional[List["NodeGroupConfiguration"]] = None,
...
class PendingLogDeliveryConfiguration(Boto3Model):
    ...
    LogType: Optional[Literal["slow-log", "engine-log"]] = None
    """
...
class ElastiCachePendingModifiedValues(Boto3Model):
    ...
    """
    AuthTokenStatus: Optional[Literal["SETTING", "ROTATING"]] = None
    """
...
class CacheNode(Boto3Model):
    ...
    * The configuration variables ``appendonly`` and ``appendfsync`` are not supported on Valkey, or on Redis OSS version
    ...
    """
    Endpoint: Optional[ElastiCacheEndpoint] = None
    """
...
Refers to `slow-log <https://redis.io/commands/slowlog>`_ or engine-log.
    ...
    """
    Status: Optional[
        Literal["active", "enabling", "modifying", "disabling", "error"]
    ] = None
    """
...
class CacheCluster(CacheClusterModelMixin, PrimaryBoto3Model):
    ...
    Returns the destination, format and type of the logs.
    """
    NetworkType: Optional[Literal["ipv4", "ipv6", "dual_stack"]] = None
    """
...
class CacheParameterGroup(PrimaryBoto3Model):
    ...
    def parameters(
        ...
        return (
            cast(CacheParameterGroupManager, self.objects)
            .using(self.session)
...
class CacheSubnetGroup(PrimaryBoto3Model):
    ...
    * ``ModifyCacheSubnetGroup``"""
    ...
    @cached_property
    def ec2_subnets(self) -> Optional[List["Subnet"]]:
        """
...
class CacheSecurityGroup(PrimaryBoto3Model):
    ...
    * ``RevokeCacheSecurityGroupIngress``"""
    ...
    def authorize_ingress(
        ...
        return (
            cast(CacheSecurityGroupManager, self.objects)
            .using(self.session)
            .authorize_ingress(
...
class ReshardingStatus(Boto3Model):
    ...
    SlotMigration: Optional[ElastiCacheSlotMigration] = None
    """
    Represents the progress of an online resharding operation.
    """
...
The current state of this replication group - ``creating``, ``available``, ``modifying``, ``deleting``.
    ...
    """
    ReaderEndpoint: Optional[ElastiCacheEndpoint] = None
    """
...
class ReplicationGroup(ReplicationGroupModelMixin, PrimaryBoto3Model):
    ...
    MultiAZ: Optional[Literal["enabled", "disabled"]]
    """
...
class CacheClusterMessage(Boto3Model):
    ...
    """
    CacheClusters: Optional[List["CacheCluster"]] = None
    """
    A list of clusters.
...
class CacheParameterGroupsMessage(Boto3Model):
    ...
    Provides an identifier to allow retrieval of paginated results.
    """
    CacheParameterGroups: Optional[List["CacheParameterGroup"]] = None
    """
...
class CacheParameterGroupDetails(Boto3Model):
    ...
    Provides an identifier to allow retrieval of paginated results.
    """
    Parameters: Optional[List["CacheParameter"]] = None
    """
...
class CacheSubnetGroupMessage(Boto3Model):
    ...
    Provides an identifier to allow retrieval of paginated results.
    """
    CacheSubnetGroups: Optional[List["CacheSubnetGroup"]] = None
    """
...
class CacheSecurityGroupMessage(Boto3Model):
    ...
    Provides an identifier to allow retrieval of paginated results.
    """
    CacheSecurityGroups: Optional[List["CacheSecurityGroup"]] = None
    """
...
class ReplicationGroupMessage(Boto3Model):
    ...
    Provides an identifier to allow retrieval of paginated results.
    """
    ReplicationGroups: Optional[List["ReplicationGroup"]] = None
    """
