...
class CloudFrontToOaiToS3(
    ...
    jsii_type="@aws-solutions-constructs/aws-cloudfront-oai-s3.CloudFrontToOaiToS3",
):
    def __init__(
        self,
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__acf4014159c8246ce40fc3fd5cd3c68fc6f76e43738c271897d9ce8cfe87ddad)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = CloudFrontToOaiToS3Props(
    ...
    def origin_access_identity(
        ...
        return typing.cast(_aws_cdk_aws_cloudfront_ceddda9d.OriginAccessIdentity, jsii.get(self, "originAccessIdentity"))
...
@jsii.data_type(
    jsii_type="@aws-solutions-constructs/aws-cloudfront-oai-s3.CloudFrontToOaiToS3Props",
    jsii_struct_bases=[],
    name_mapping={
...
class CloudFrontToOaiToS3Props:
    def __init__(
        self,
        *,
        bucket_props: typing.Optional[typing.Union[_aws_cdk_aws_s3_ceddda9d.BucketProps, typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ce452c1b179e1e9257bbdec8d4bad981cd745aeb81f84cf9e42373b54adcf494)
    ...
    def __repr__(self) -> str:
        return "CloudFrontToOaiToS3Props(%s)" % ", ".join(
...
def _typecheckingstub__acf4014159c8246ce40fc3fd5cd3c68fc6f76e43738c271897d9ce8cfe87ddad(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    bucket_props: typing.Optional[typing.Union[_aws_cdk_aws_s3_ceddda9d.BucketProps, typing.Dict[builtins.str, typing.Any]]] = None,
...
def _typecheckingstub__ce452c1b179e1e9257bbdec8d4bad981cd745aeb81f84cf9e42373b54adcf494(
    *,
    bucket_props: typing.Optional[typing.Union[_aws_cdk_aws_s3_ceddda9d.BucketProps, typing.Dict[builtins.str, typing.Any]]] = None,
    cloud_front_distribution_props: typing.Any = None,
    cloud_front_logging_bucket_access_log_bucket_props: typing.Optional[typing.Union[_aws_cdk_aws_s3_ceddda9d.BucketProps, typing.Dict[builtins.str, typing.Any]]] = None,
