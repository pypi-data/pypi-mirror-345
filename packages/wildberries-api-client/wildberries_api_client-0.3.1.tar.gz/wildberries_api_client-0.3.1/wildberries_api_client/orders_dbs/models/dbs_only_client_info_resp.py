...
class DbsOnlyClientInfoResp(object):
    ...
    def __init__(self, orders=None):  # noqa: E501
        """DbsOnlyClientInfoResp - a model defined in Swagger"""  # noqa: E501
        self._orders = None
    ...
    @property
    def orders(self):
        """Gets the orders of this DbsOnlyClientInfoResp.  # noqa: E501

        Informacia o pokupatele  # noqa: E501

        :return: The orders of this DbsOnlyClientInfoResp.  # noqa: E501
        :rtype: list[DbsOnlyClientInfo]
        """
        return self._orders

    @orders.setter
    def orders(self, orders):
        """Sets the orders of this DbsOnlyClientInfoResp.

        Informacia o pokupatele  # noqa: E501

        :param orders: The orders of this DbsOnlyClientInfoResp.  # noqa: E501
        :type: list[DbsOnlyClientInfo]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DbsOnlyClientInfoResp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DbsOnlyClientInfoResp):
            return False
