...
[![PyPI - Downloads](https://static.pepy.tech/badge/types-aiobotocore-privatenetworks)](https://pypistats.org/packages/types-aiobotocore-privatenetworks)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[aiobotocore Private5G 2.22.0](https://pypi.org/project/aiobotocore/)
...
`types-aiobotocore-privatenetworks` dependency in production. However, there is
