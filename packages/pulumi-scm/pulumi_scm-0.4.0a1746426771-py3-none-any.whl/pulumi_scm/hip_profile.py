...
class HipProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] match: The Match param. String length must not exceed 2048 characters.
...
class HipProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            snippet: Optional[pulumi.Input[builtins.str]] = None,
            tfid: Optional[pulumi.Input[builtins.str]] = None) -> 'HipProfile':
        """
