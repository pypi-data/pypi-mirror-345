...
def isSajadQPython():
    """Is this our own fork of CPython named SajadQ-Python."""

    # spell-checker: ignore SajadMrpython

    if python_version >= 0x300:
        return sys.implementation.name == "SajadMrpython"
    else:
        return sys.subversion[0] == "SajadMrpython"
