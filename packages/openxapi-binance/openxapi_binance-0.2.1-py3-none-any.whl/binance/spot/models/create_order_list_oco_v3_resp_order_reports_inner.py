...
class CreateOrderListOcoV3RespOrderReportsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clientOrderId", "cummulativeQuoteQty", "executedQty", "icebergQty", "orderId", "orderListId", "origQty", "origQuoteOrderQty", "price", "selfTradePreventionMode", "side", "status", "stopPrice", "symbol", "timeInForce", "transactTime", "type", "workingTime"]
