...
import orientedViewEdgeIterator
...
copy constructor or from an :class:`Id`.
  ...
  def push_vertex_back(self, vertex: SVertex) -> None:
  ...
  def push_vertex_front(self, vertex: SVertex) -> None:
...
copy constructor, or an overloaded constructor
  ...
  def __init__(self, line: mathutils.Vector, diffuse: typing.Any, ambient: mathutils.Vector, specular: mathutils.Vector, emission: mathutils.Vector, shininess: float, priority: int) -> None:
