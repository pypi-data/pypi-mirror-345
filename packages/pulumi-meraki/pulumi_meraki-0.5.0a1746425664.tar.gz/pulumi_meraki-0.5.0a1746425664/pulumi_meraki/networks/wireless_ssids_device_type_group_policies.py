...
class WirelessSsidsDeviceTypeGroupPoliciesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: If true, the SSID device type group policies are enabled.
        """
...
class WirelessSsidsDeviceTypeGroupPolicies(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enabled: Optional[pulumi.Input[builtins.bool]] = None,
            network_id: Optional[pulumi.Input[builtins.str]] = None,
            number: Optional[pulumi.Input[builtins.str]] = None) -> 'WirelessSsidsDeviceTypeGroupPolicies':
        """
