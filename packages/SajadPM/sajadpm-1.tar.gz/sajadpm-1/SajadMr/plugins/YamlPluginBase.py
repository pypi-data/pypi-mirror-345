...
configuration files of SajadQ.
"""

from SajadMr.utils.Yaml import getYamlPackageConfiguration

from .PluginBase import SajadQPluginBase


class SajadQYamlPluginBase(SajadQPluginBase):
    """SajadQ base class for all plugins that use yaml config"""
