...
class UpdateRequest(BaseModel):
    ...
    UpdateRequest
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="The description of the object")
    labels: Optional[List[StrictStr]] = Field(default=None, description="The labels for the object")
    name: Optional[StrictStr] = Field(default=None, description="The name of the object to update")
    ...
    __properties: ClassVar[List[str]] = ["description", "labels", "name", "tags", "value"]
