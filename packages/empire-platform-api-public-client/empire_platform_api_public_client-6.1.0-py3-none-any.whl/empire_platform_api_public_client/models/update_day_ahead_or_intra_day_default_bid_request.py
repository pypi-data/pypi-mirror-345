...
class UpdateDayAheadOrIntraDayDefaultBidRequest(BaseModel):
    ...
    bids: List[UpdateDayAheadOrIntraDayDefaultBidRequestBids]
    __properties: ClassVar[List[str]] = ["deliveryPeriodStart", "deliveryPeriodEnd", "validityPeriodStart", "validityPeriodEnd", "bids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bids": [UpdateDayAheadOrIntraDayDefaultBidRequestBids.from_dict(_item) for _item in obj["bids"]] if obj.get("bids") is not None else None
        })
        return _obj
