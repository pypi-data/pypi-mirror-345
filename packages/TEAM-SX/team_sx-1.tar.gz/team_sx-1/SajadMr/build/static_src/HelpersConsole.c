...
#if defined(_WIN32)
#if defined(_SajadSx_ATTACH_CONSOLE_WINDOW)
#include <io.h>
...
#if !defined(SajadSx_FORCED_STDERR_PATH) && !defined(SajadSx_FORCED_STDERR_NONE_BOOL) &&                                 \
    !defined(SajadSx_FORCED_STDERR_NULL_BOOL)
