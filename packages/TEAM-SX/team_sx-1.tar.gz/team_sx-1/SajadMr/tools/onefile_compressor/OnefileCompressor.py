...
from SajadMr.__past__ import to_byte
...
from SajadMr.Tracing import onefile_logger
...
from SajadMr.utils.Hashing import Hash, HashCRC32
...
def main():
    ...
    if os.getenv("SajadSx_PROGRESS_BAR") == "1":
        enableProgressBar()
