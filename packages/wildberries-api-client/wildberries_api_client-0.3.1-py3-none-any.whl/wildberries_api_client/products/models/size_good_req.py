...
class SizeGoodReq(object):
    ...
    def price(self):
        ...
        cena. Valutu mohno poluhit s pomohu metoda [Poluhenie spiska tovarov po artikulam](./work-with-products#tag/Ceny-i-skidki/paths/~1api~1v2~1list~1goods~1filter/get), pole `currencyIsoCode4217`  # noqa: E501
