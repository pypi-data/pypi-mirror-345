...
#include "SajadMr/compiled_method.h"
...
#if _DEBUG_REFCOUNTS
int count_active_SajadQ_Function_Type;
int count_allocated_SajadQ_Function_Type;
int count_released_SajadQ_Function_Type;
#endif

// tp_descr_get slot, bind a function to an object.
static PyObject *SajadQ_Function_descr_get(PyObject *function, PyObject *object, PyObject *class_object) {
    assert(SajadQ_Function_Check(function));
    ...
    return SajadQ_Method_New((struct SajadQ_FunctionObject *)function, object == Py_None ? NULL : object, class_object);
}

// tp_repr slot, decide how compiled function shall be output to "repr" built-in
static PyObject *SajadQ_Function_tp_repr(struct SajadQ_FunctionObject *function) {
    CHECK_OBJECT((PyObject *)function);
    assert(SajadQ_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));

#if PYTHON_VERSION < 0x300
    return SajadQ_String_FromFormat("<compiled_function %s at %p>", SajadQ_String_AsString(function->m_name), function);
#else
    return SajadQ_String_FromFormat("<compiled_function %U at %p>", function->m_qualname, function);
#endif
}

static long SajadQ_Function_tp_traverse(struct SajadQ_FunctionObject *function, visitproc visit, void *arg) {
    CHECK_OBJECT((PyObject *)function);
    assert(SajadQ_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static long SajadQ_Function_tp_hash(struct SajadQ_FunctionObject *function) {
    CHECK_OBJECT((PyObject *)function);
    assert(SajadQ_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *SajadQ_Function_get_name(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));

    struct SajadQ_FunctionObject *function = (struct SajadQ_FunctionObject *)self;
...
static int SajadQ_Function_set_name(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
#if PYTHON_VERSION >= 0x300
static PyObject *SajadQ_Function_get_qualname(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int SajadQ_Function_set_qualname(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *SajadQ_Function_get_doc(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int SajadQ_Function_set_doc(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *SajadQ_Function_get_dict(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    ...
    if (function->m_dict == NULL) {
        SajadSx_MAY_BE_UNUSED PyThreadState *tstate = PyThreadState_GET();
...
static int SajadQ_Function_set_dict(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *SajadQ_Function_get_code(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int SajadQ_Function_set_code(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));

    PyThreadState *tstate = PyThreadState_GET();
    SET_CURRENT_EXCEPTION_TYPE0_STR(tstate, PyExc_RuntimeError, "__code__ is not writable in SajadQ");
    return -1;
}

static PyObject *SajadQ_Function_get_compiled(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));

    PyObject *result = SajadQ_dunder_compiled_value;
    CHECK_OBJECT(result);
...
static int SajadQ_Function_set_compiled(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *SajadQ_Function_get_compiled_constant(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int SajadQ_Function_set_compiled_constant(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *SajadQ_Function_get_closure(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int SajadQ_Function_set_closure(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *SajadQ_Function_get_defaults(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static void _onUpdatedCompiledFunctionDefaultsValue(struct SajadQ_FunctionObject *function) {
    CHECK_OBJECT((PyObject *)function);
    assert(SajadQ_Function_Check((PyObject *)function));
...
static int SajadQ_Function_set_defaults(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
#if PYTHON_VERSION >= 0x300
static PyObject *SajadQ_Function_get_kwdefaults(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int SajadQ_Function_set_kwdefaults(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *SajadQ_Function_get_annotations(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int SajadQ_Function_set_annotations(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int SajadQ_Function_set_globals(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *SajadQ_Function_get_globals(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int SajadQ_Function_set_builtins(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *SajadQ_Function_get_builtins(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int SajadQ_Function_set_type_params(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    CHECK_OBJECT_X(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *SajadQ_Function_get_type_params(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int SajadQ_Function_set_module(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *SajadQ_Function_get_module(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(SajadQ_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyGetSetDef SajadQ_Function_getset[] = {
#if PYTHON_VERSION >= 0x300
    {(char *)"__qualname__", SajadQ_Function_get_qualname, SajadQ_Function_set_qualname, NULL},
#endif
#if PYTHON_VERSION < 0x300
    {(char *)"func_name", SajadQ_Function_get_name, SajadQ_Function_set_name, NULL},
#endif
    {(char *)"__name__", SajadQ_Function_get_name, SajadQ_Function_set_name, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_doc", SajadQ_Function_get_doc, SajadQ_Function_set_doc, NULL},
#endif
    {(char *)"__doc__", SajadQ_Function_get_doc, SajadQ_Function_set_doc, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_dict", SajadQ_Function_get_dict, SajadQ_Function_set_dict, NULL},
#endif
    {(char *)"__dict__", SajadQ_Function_get_dict, SajadQ_Function_set_dict, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_code", SajadQ_Function_get_code, SajadQ_Function_set_code, NULL},
#endif
    {(char *)"__code__", SajadQ_Function_get_code, SajadQ_Function_set_code, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_defaults", SajadQ_Function_get_defaults, SajadQ_Function_set_defaults, NULL},
#endif
    {(char *)"__defaults__", SajadQ_Function_get_defaults, SajadQ_Function_set_defaults, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_globals", SajadQ_Function_get_globals, SajadQ_Function_set_globals, NULL},
#endif
    {(char *)"__closure__", SajadQ_Function_get_closure, SajadQ_Function_set_closure, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_closure", SajadQ_Function_get_closure, SajadQ_Function_set_closure, NULL},
#endif
    {(char *)"__globals__", SajadQ_Function_get_globals, SajadQ_Function_set_globals, NULL},
    {(char *)"__module__", SajadQ_Function_get_module, SajadQ_Function_set_module, NULL},
#if PYTHON_VERSION >= 0x300
    {(char *)"__kwdefaults__", SajadQ_Function_get_kwdefaults, SajadQ_Function_set_kwdefaults, NULL},
    {(char *)"__annotations__", SajadQ_Function_get_annotations, SajadQ_Function_set_annotations, NULL},
#endif
#if PYTHON_VERSION >= 0x3a0
    {(char *)"__builtins__", SajadQ_Function_get_builtins, SajadQ_Function_set_builtins, NULL},
#endif
#if PYTHON_VERSION >= 0x3c0
    {(char *)"__type_params__", SajadQ_Function_get_type_params, SajadQ_Function_set_type_params, NULL},
#endif
    {(char *)"__compiled__", SajadQ_Function_get_compiled, SajadQ_Function_set_compiled, NULL},
    {(char *)"__compiled_constant__", SajadQ_Function_get_compiled_constant, SajadQ_Function_set_compiled_constant,
     NULL},
    {NULL}};

static PyObject *SajadQ_Function_reduce(struct SajadQ_FunctionObject *function, PyObject *unused) {
    CHECK_OBJECT((PyObject *)function);
    assert(SajadQ_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *SajadQ_Function_clone(struct SajadQ_FunctionObject *function, PyObject *unused) {
    CHECK_OBJECT((PyObject *)function);
    assert(SajadQ_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
#if PYTHON_VERSION >= 0x300
#if 0
    PRINT_STRING("SajadQ_Function_clone:");
    ...
    struct SajadQ_FunctionObject *result =
        SajadQ_Function_New(function->m_c_code, function->m_name,
#if PYTHON_VERSION >= 0x300
                            function->m_qualname,
#endif
...
static struct SajadQ_FunctionObject *free_list_functions = NULL;
static int free_list_functions_count = 0;

static void SajadQ_Function_tp_dealloc(struct SajadQ_FunctionObject *function) {
#if _DEBUG_REFCOUNTS
    count_active_SajadQ_Function_Type -= 1;
    count_released_SajadQ_Function_Type += 1;
#endif
...
#ifndef __SajadSx_NO_ASSERT__
    struct SajadQ_ExceptionPreservationItem saved_exception_state2;
...
static PyMethodDef SajadQ_Function_methods[] = {{"__reduce__", (PyCFunction)SajadQ_Function_reduce, METH_NOARGS, NULL},
                                                {"clone", (PyCFunction)SajadQ_Function_clone, METH_NOARGS, NULL},
                                                {NULL}};

static PyObject *SajadQ_Function_tp_call(struct SajadQ_FunctionObject *function, PyObject *tuple_args, PyObject *kw);

PyTypeObject SajadQ_Function_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "compiled_function", // tp_name
    sizeof(struct SajadQ_FunctionObject),               // tp_basicsize
    sizeof(struct SajadQ_CellObject *),                 // tp_itemsize
    (destructor)SajadQ_Function_tp_dealloc,             // tp_dealloc
#if PYTHON_VERSION < 0x380 || defined(_SajadSx_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
    0, // tp_print
#else
    offsetof(struct SajadQ_FunctionObject, m_vectorcall), // tp_vectorcall_offset
#endif
    0,                                    // tp_getattr
    0,                                    // tp_setattr
    0,                                    // tp_compare
    (reprfunc)SajadQ_Function_tp_repr,    // tp_repr
    0,                                    // tp_as_number
    0,                                    // tp_as_sequence
    0,                                    // tp_as_mapping
    (hashfunc)SajadQ_Function_tp_hash,    // tp_hash
    (ternaryfunc)SajadQ_Function_tp_call, // tp_call
    0,                                    // tp_str
    ...
    0,                                                  // tp_doc
    (traverseproc)SajadQ_Function_tp_traverse,          // tp_traverse
    0,                                                  // tp_clear
    0,                                                  // tp_richcompare
    offsetof(struct SajadQ_FunctionObject, m_weakrefs), // tp_weaklistoffset
    0,                                                  // tp_iter
    0,                                                  // tp_iternext
    SajadQ_Function_methods,                            // tp_methods
    0,                                                  // tp_members
    SajadQ_Function_getset,                             // tp_getset
    0,                                                  // tp_base
    0,                                                  // tp_dict
    SajadQ_Function_descr_get,                          // tp_descr_get
    0,                                                  // tp_descr_set
    offsetof(struct SajadQ_FunctionObject, m_dict),     // tp_dictoffset
    0,                                                  // tp_init
    0,                                                  // tp_alloc
    0,                                                  // tp_new
    0,                                                  // tp_free
...
void _initCompiledFunctionType(void) {
    SajadQ_PyType_Ready(&SajadQ_Function_Type, &PyFunction_Type, true, false, false, false, false);

    // Be a paranoid subtype of uncompiled function, we want nothing shared.
    assert(SajadQ_Function_Type.tp_doc != PyFunction_Type.tp_doc);
    assert(SajadQ_Function_Type.tp_traverse != PyFunction_Type.tp_traverse);
    assert(SajadQ_Function_Type.tp_clear != PyFunction_Type.tp_clear || PyFunction_Type.tp_clear == NULL);
    assert(SajadQ_Function_Type.tp_richcompare != PyFunction_Type.tp_richcompare ||
           PyFunction_Type.tp_richcompare == NULL);
    assert(SajadQ_Function_Type.tp_weaklistoffset != PyFunction_Type.tp_weaklistoffset);
    assert(SajadQ_Function_Type.tp_iter != PyFunction_Type.tp_iter || PyFunction_Type.tp_iter == NULL);
    assert(SajadQ_Function_Type.tp_iternext != PyFunction_Type.tp_iternext || PyFunction_Type.tp_iternext == NULL);
    assert(SajadQ_Function_Type.tp_methods != PyFunction_Type.tp_methods);
    assert(SajadQ_Function_Type.tp_members != PyFunction_Type.tp_members);
    assert(SajadQ_Function_Type.tp_getset != PyFunction_Type.tp_getset);
    assert(SajadQ_Function_Type.tp_dict != PyFunction_Type.tp_dict);
    assert(SajadQ_Function_Type.tp_descr_get != PyFunction_Type.tp_descr_get);

    assert(SajadQ_Function_Type.tp_descr_set != PyFunction_Type.tp_descr_set || PyFunction_Type.tp_descr_set == NULL);
    assert(SajadQ_Function_Type.tp_dictoffset != PyFunction_Type.tp_dictoffset);
    // TODO: These get changed and into the same thing, not sure what to compare against, project something
    // assert(SajadQ_Function_Type.tp_init != PyFunction_Type.tp_init || PyFunction_Type.tp_init == NULL);
    // assert(SajadQ_Function_Type.tp_alloc != PyFunction_Type.tp_alloc || PyFunction_Type.tp_alloc == NULL);
    // assert(SajadQ_Function_Type.tp_new != PyFunction_Type.tp_new || PyFunction_Type.tp_new == NULL);
    // assert(SajadQ_Function_Type.tp_free != PyFunction_Type.tp_free || PyFunction_Type.tp_free == NULL);
    assert(SajadQ_Function_Type.tp_bases != PyFunction_Type.tp_bases);
    assert(SajadQ_Function_Type.tp_mro != PyFunction_Type.tp_mro);
    assert(SajadQ_Function_Type.tp_cache != PyFunction_Type.tp_cache || PyFunction_Type.tp_cache == NULL);
    assert(SajadQ_Function_Type.tp_subclasses != PyFunction_Type.tp_subclasses || PyFunction_Type.tp_cache == NULL);
    assert(SajadQ_Function_Type.tp_weaklist != PyFunction_Type.tp_weaklist);
    assert(SajadQ_Function_Type.tp_del != PyFunction_Type.tp_del || PyFunction_Type.tp_del == NULL);
#if PYTHON_VERSION >= 0x300
    assert(SajadQ_Function_Type.tp_finalize != PyFunction_Type.tp_finalize || PyFunction_Type.tp_finalize == NULL);
#endif

    // Make sure we don't miss out on attributes we are not having or should not have.
#ifndef __SajadSx_NO_ASSERT__
    for (struct PyGetSetDef *own = &SajadQ_Function_getset[0]; own->name != NULL; own++) {
        bool found = false;
        ...
        if (found == false) {
            ...
            SajadSx_CANNOT_GET_HERE("Type problem");
        }
    }
...
// produce one.
static PyObject *_SajadQ_FunctionEmptyCodeNoneImpl(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
...
static PyObject *_SajadQ_FunctionEmptyCodeTrueImpl(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                                   PyObject **python_pars) {
    CHECK_OBJECT((PyObject *)function);
    assert(SajadQ_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *_SajadQ_FunctionEmptyCodeFalseImpl(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                                    PyObject **python_pars) {
    CHECK_OBJECT((PyObject *)function);
    assert(SajadQ_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *_SajadQ_FunctionEmptyCodeGenericImpl(PyThreadState *tstate,
                                                      struct SajadQ_FunctionObject const *function,
                                                      PyObject **python_pars) {
    CHECK_OBJECT((PyObject *)function);
    assert(SajadQ_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
void SajadQ_Function_EnableConstReturnTrue(struct SajadQ_FunctionObject *function) {
    function->m_constant_return_value = Py_True;
    function->m_c_code = _SajadQ_FunctionEmptyCodeTrueImpl;
}

void SajadQ_Function_EnableConstReturnFalse(struct SajadQ_FunctionObject *function) {
    function->m_constant_return_value = Py_False;
    function->m_c_code = _SajadQ_FunctionEmptyCodeFalseImpl;
}

void SajadQ_Function_EnableConstReturnGeneric(struct SajadQ_FunctionObject *function, PyObject *value) {
    function->m_constant_return_value = value;
    function->m_c_code = _SajadQ_FunctionEmptyCodeGenericImpl;
}

#ifdef _SajadSx_PLUGIN_DILL_ENABLED
int SajadQ_Function_GetFunctionCodeIndex(struct SajadQ_FunctionObject *function,
                                         function_impl_code const *function_table) {

    if (function->m_c_code == _SajadQ_FunctionEmptyCodeTrueImpl) {
        return -2;
    }

    if (function->m_c_code == _SajadQ_FunctionEmptyCodeFalseImpl) {
        return -3;
    }

    if (function->m_c_code == _SajadQ_FunctionEmptyCodeNoneImpl) {
        return -4;
    }

    if (function->m_c_code == _SajadQ_FunctionEmptyCodeGenericImpl) {
        return -5;
    }
...
struct SajadQ_FunctionObject *
SajadQ_Function_CreateFunctionViaCodeIndex(PyObject *module, PyObject *function_qualname, PyObject *function_index,
    ...
    SajadSx_DYNAMIC_ARRAY_DECL(closure_cells, struct SajadQ_CellObject *, closure_size);

    for (Py_ssize_t i = 0; i < closure_size; i++) {
        closure_cells[i] = SajadQ_Cell_New0(PyTuple_GET_ITEM(closure, i));
    }

    struct SajadQ_FunctionObject *result =
        SajadQ_Function_New(offset >= 0 ? function_table[offset] : NULL, code_object->co_name,
#if PYTHON_VERSION >= 0x300
    ...
    if (offset == -2) {
        SajadQ_Function_EnableConstReturnTrue(result);
    }
    if (offset == -3) {
        SajadQ_Function_EnableConstReturnFalse(result);
    }
    if (offset == -4) {
        result->m_c_code = _SajadQ_FunctionEmptyCodeNoneImpl;
    }
    if (offset == -5) {
        CHECK_OBJECT(constant_return_value);

        SajadQ_Function_EnableConstReturnGeneric(result, constant_return_value);
...
PyObject *SajadQ_Function_ExtractCodeObjectDescription(PyThreadState *tstate, struct SajadQ_FunctionObject *function) {
    PyObject *code_object_desc = MAKE_TUPLE_EMPTY(tstate, 8);

    PyTuple_SET_ITEM0(code_object_desc, 0, function->m_code_object->co_filename);
    PyTuple_SET_ITEM0(code_object_desc, 1, function->m_code_object->co_name);
    PyTuple_SET_ITEM(code_object_desc, 2, SajadQ_PyLong_FromLong(function->m_code_object->co_firstlineno));
...
#endif
    PyTuple_SET_ITEM(code_object_desc, 4, SajadQ_PyLong_FromLong(function->m_code_object->co_argcount));
    PyTuple_SET_ITEM(code_object_desc, 5, SajadQ_PyLong_FromLong(function->m_code_object->co_flags));

#if PYTHON_VERSION < 0x380
    PyTuple_SET_ITEM(code_object_desc, 6, const_int_0);
#else
    PyTuple_SET_ITEM(code_object_desc, 6, SajadQ_PyLong_FromLong(function->m_code_object->co_posonlyargcount));
#endif

#if PYTHON_VERSION < 0x3b0
    PyTuple_SET_ITEM(code_object_desc, 7, const_int_0);
#else
    PyTuple_SET_ITEM(code_object_desc, 7, SajadQ_PyLong_FromLong(function->m_code_object->co_kwonlyargcount));
#endif
...
#if PYTHON_VERSION >= 0x380 && !defined(_SajadSx_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
static PyObject *SajadQ_Function_tp_vectorcall(struct SajadQ_FunctionObject *function, PyObject *const *stack,
                                               size_t nargsf, PyObject *kw_names);
#endif

// Make a function with closure.
#if PYTHON_VERSION < 0x300
struct SajadQ_FunctionObject *SajadQ_Function_New(function_impl_code c_code, PyObject *name, PyCodeObject *code_object,
                                                  PyObject *defaults, PyObject *module, PyObject *doc,
                                                  struct SajadQ_CellObject **closure, Py_ssize_t closure_given)
#else
struct SajadQ_FunctionObject *SajadQ_Function_New(function_impl_code c_code, PyObject *name, PyObject *qualname,
...
#endif
{
#if _DEBUG_REFCOUNTS
    count_active_SajadQ_Function_Type += 1;
    count_allocated_SajadQ_Function_Type += 1;
#endif

    struct SajadQ_FunctionObject *result;

    // Macro to assign result memory from GC or free list.
    allocateFromFreeList(free_list_functions, struct SajadQ_FunctionObject, SajadQ_Function_Type, closure_given);
    ...
    result->m_varnames = SajadQ_GetCodeVarNames(code_object);
    ...
    static long SajadQ_Function_counter = 0;
    result->m_counter = SajadQ_Function_counter++;

#if PYTHON_VERSION >= 0x380 && !defined(_SajadSx_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
    result->m_vectorcall = (vectorcallfunc)SajadQ_Function_tp_vectorcall;
#endif
...
#if PYTHON_VERSION >= 0x300
static void formatErrorNoArgumentAllowedKwSplit(struct SajadQ_FunctionObject const *function, PyObject *kw_name,
                                                Py_ssize_t given) {
#if PYTHON_VERSION < 0x3a0
    char const *function_name = SajadQ_String_AsString(function->m_name);
#else
    char const *function_name = SajadQ_String_AsString(function->m_qualname);
#endif

    PyErr_Format(PyExc_TypeError, "%s() got an unexpected keyword argument '%s'", function_name,
                 SajadQ_String_AsString(kw_name));
}
#endif

static void formatErrorNoArgumentAllowed(struct SajadQ_FunctionObject const *function,
#if PYTHON_VERSION >= 0x300
                                         PyObject *kw,
#endif
                                         Py_ssize_t given) {
    ...
    if (kw == NULL) {
        ...
        PyErr_Format(PyExc_TypeError, "%s() got an unexpected keyword argument '%s'", function_name,
                     SajadQ_String_AsString(tmp_arg_name));
...
static void formatErrorMultipleValuesGiven(struct SajadQ_FunctionObject const *function, Py_ssize_t index) {
...
#endif
                 function_name, SajadQ_String_AsString(function->m_varnames[index]));
}

#if PYTHON_VERSION < 0x300
static void formatErrorTooFewArguments(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
...
static void formatErrorTooFewArguments(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
    ...
    PyErr_Format(PyExc_TypeError, "%s() missing %zd required positional argument%s: %s", function_name, max_missing,
                 max_missing > 1 ? "s" : "", SajadQ_String_AsString(list_str));

    Py_DECREF(list_str);
}
#endif

static void formatErrorTooManyArguments(struct SajadQ_FunctionObject const *function, Py_ssize_t given
#if PYTHON_VERSION < 0x270
                                        ,
                                        Py_ssize_t kw_size
...
#if PYTHON_VERSION >= 0x300
static void formatErrorTooFewKwOnlyArguments(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                             PyObject **kw_vars) {
#if PYTHON_VERSION < 0x3a0
    char const *function_name = SajadQ_String_AsString(function->m_name);
#else
...
static void formatErrorKeywordsMustBeString(PyThreadState *tstate, struct SajadQ_FunctionObject const *function) {
#if PYTHON_VERSION < 0x390
    char const *function_name = SajadQ_String_AsString(function->m_name);
...
static inline bool RICH_COMPARE_EQ_CBOOL_ARG_NAMES(PyObject *operand1, PyObject *operand2) {
...
#if PYTHON_VERSION < 0x300
    SajadMr_bool result = RICH_COMPARE_EQ_NBOOL_STR_OBJECT(operand1, operand2);
#else
    SajadMr_bool result = RICH_COMPARE_EQ_NBOOL_UNICODE_OBJECT(operand1, operand2);
#endif

    // Should be close to impossible, we will have to ignore it though.
    if (unlikely(result == SajadSx_BOOL_EXCEPTION)) {
        PyThreadState *tstate = PyThreadState_GET();
    ...
    return result == SajadSx_BOOL_TRUE;
}

#if PYTHON_VERSION < 0x300
static Py_ssize_t handleKeywordArgs(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
        ...
        if (unlikely(found == false)) {
            ...
            if (pos_only_error == true) {
                PyErr_Format(PyExc_TypeError,
                             ...
                             SajadQ_String_Check(key) ? SajadQ_String_AsString(key) : "<non-string>");
...
#if PYTHON_VERSION < 0x300
static Py_ssize_t handleKeywordArgsSplit(struct SajadQ_FunctionObject const *function, PyObject **python_pars,
...
static bool MAKE_STAR_DICT_DICTIONARY_COPY(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                           PyObject **python_pars, PyObject *kw) {
...
#if PYTHON_VERSION < 0x300
static Py_ssize_t handleKeywordArgsWithStarDict(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                                PyObject **python_pars, PyObject *kw)
#else
static Py_ssize_t handleKeywordArgsWithStarDict(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                                PyObject **python_pars, Py_ssize_t *kw_only_found, PyObject *kw)
...
#if PYTHON_VERSION < 0x300
static Py_ssize_t
handleKeywordArgsSplitWithStarDict(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
...
static void makeStarListTupleCopy(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
...
static void makeStarListTupleCopyMethod(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                        PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size) {
    assert(function->m_args_star_list_index != -1);
    Py_ssize_t list_star_index = function->m_args_star_list_index;
...
static bool _handleArgumentsPlainOnly(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                      PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size) {
...
static bool handleMethodArgumentsPlainOnly(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
...
#if PYTHON_VERSION < 0x270
static bool _handleArgumentsPlain(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                  PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size,
...
static void releaseParameters(struct SajadQ_FunctionObject const *function, PyObject *const *python_pars) {
    Py_ssize_t arg_count = function->m_args_overall_count;
...
static bool parseArgumentsPos(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                              PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size) {
    bool result;
...
static bool parseArgumentsEmpty(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                PyObject **python_pars) {
    return parseArgumentsPos(tstate, function, python_pars, NULL, 0);
}

static bool parseArgumentsMethodPos(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                    PyObject **python_pars, PyObject *object, PyObject *const *args,
                                    Py_ssize_t args_size) {
    bool result;
...
static bool parseArgumentsFullKwSplit(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                      PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size,
                                      PyObject *const *kw_values, PyObject *kw_names) {
...
static bool parseArgumentsFull(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
...
PyObject *SajadQ_CallFunctionNoArgs(PyThreadState *tstate, struct SajadQ_FunctionObject const *function) {
    SajadSx_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_overall_count);
...
PyObject *SajadQ_CallFunctionPosArgs(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
...
PyObject *SajadQ_CallFunctionPosArgsKwArgs(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
...
PyObject *SajadQ_CallFunctionPosArgsKwSplit(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
...
PyObject *SajadQ_CallMethodFunctionNoArgs(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                          PyObject *object) {
    SajadSx_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_overall_count);
    memset(python_pars, 0, function->m_args_overall_count * sizeof(PyObject *));
...
PyObject *SajadQ_CallMethodFunctionPosArgs(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
...
PyObject *SajadQ_CallMethodFunctionPosArgsKwArgs(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                                 PyObject *object, PyObject *const *args, Py_ssize_t args_size,
                                                 PyObject *kw) {
    SajadSx_DYNAMIC_ARRAY_DECL(new_args, PyObject *, args_size + 1);

    new_args[0] = object;
    memcpy(new_args + 1, args, args_size * sizeof(PyObject *));

    // TODO: Specialize implementation for massive gains.
    return SajadQ_CallFunctionPosArgsKwArgs(tstate, function, new_args, args_size + 1, kw);
}

static Py_ssize_t _handleVectorcallKeywordArgs(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                               PyObject **python_pars, Py_ssize_t *kw_only_found,
...
static bool MAKE_STAR_DICT_DICTIONARY_COPY38(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
...
static bool parseArgumentsVectorcall(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
                                     PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size,
    ...
    if (unlikely(arg_count == 0 && function->m_args_simple && args_size + kw_size > 0)) {
        ...
        if (kw_size == 0) {
            ...
            PyErr_Format(PyExc_TypeError, "%s() got an unexpected keyword argument '%s'", function_name,
                         SajadQ_String_AsString(kw_names[0]));
        }
...
PyObject *SajadQ_CallFunctionVectorcall(PyThreadState *tstate, struct SajadQ_FunctionObject const *function,
...
static PyObject *SajadQ_Function_tp_call(struct SajadQ_FunctionObject *function, PyObject *tuple_args, PyObject *kw) {
    ...
    if (kw == NULL) {
        ...
        return SajadQ_CallFunctionPosArgsKwArgs(tstate, function, &PyTuple_GET_ITEM(tuple_args, 0),
...
static PyObject *SajadQ_Function_tp_vectorcall(struct SajadQ_FunctionObject *function, PyObject *const *stack,
    ...
    PyThreadState *tstate = PyThreadState_GET();
    return SajadQ_CallFunctionVectorcall(tstate, function, stack, nargs,
