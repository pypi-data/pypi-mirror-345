...
from SajadMr.__past__ import StringIO
from SajadMr.plugins.PluginBase import SajadQPluginBase
from SajadMr.utils.FileOperations import getFileContents, listDir
...
class SajadQPluginPmw(SajadQPluginBase):
...
class SajadQPluginDetectorPmw(SajadQPluginBase):
    detector_for = SajadQPluginPmw
