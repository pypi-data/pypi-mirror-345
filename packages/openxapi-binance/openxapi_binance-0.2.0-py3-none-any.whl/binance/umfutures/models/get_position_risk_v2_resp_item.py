...
class GetPositionRiskV2RespItem(BaseModel):
    """
    ...
    is_auto_add_margin: Optional[StrictStr] = Field(default=None, alias="isAutoAddMargin")
    ...
    __properties: ClassVar[List[str]] = ["breakEvenPrice", "entryPrice", "isAutoAddMargin", "isolatedMargin", "isolatedWallet", "leverage", "liquidationPrice", "marginType", "markPrice", "maxNotionalValue", "notional", "positionAmt", "positionSide", "symbol", "unRealizedProfit", "updateTime"]
