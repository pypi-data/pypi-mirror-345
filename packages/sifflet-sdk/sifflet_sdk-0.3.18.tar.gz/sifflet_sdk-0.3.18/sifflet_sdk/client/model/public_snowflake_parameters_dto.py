...
def lazy_import():
    from sifflet_sdk.client.model.public_snowflake_parameters_dto_all_of import (
        PublicSnowflakeParametersDtoAllOf,
    )
    from sifflet_sdk.client.model.public_source_parameters_dto import (
        PublicSourceParametersDto,
    )

    globals()["PublicSnowflakeParametersDtoAllOf"] = PublicSnowflakeParametersDtoAllOf
    globals()["PublicSourceParametersDto"] = PublicSourceParametersDto


class PublicSnowflakeParametersDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PublicSnowflakeParametersDto - a model defined in OpenAPI
