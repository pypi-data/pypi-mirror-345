...
class TableProductResponse(object):
    ...
    def __init__(self, items=None):  # noqa: E501
        """TableProductResponse - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this TableProductResponse.  # noqa: E501

        Mnohestvo dannyh po tovaram  # noqa: E501

        :return: The items of this TableProductResponse.  # noqa: E501
    ...
    def items(self, items):
        """Sets the items of this TableProductResponse.

        Mnohestvo dannyh po tovaram  # noqa: E501

        :param items: The items of this TableProductResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TableProductResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TableProductResponse):
            return False
