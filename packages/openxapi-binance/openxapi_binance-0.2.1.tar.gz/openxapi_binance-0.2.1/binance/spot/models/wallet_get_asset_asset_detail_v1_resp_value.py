...
class WalletGetAssetAssetDetailV1RespValue(BaseModel):
    """
    ...
    min_withdraw_amount: Optional[StrictStr] = Field(default=None, alias="minWithdrawAmount")
    ...
    __properties: ClassVar[List[str]] = ["depositStatus", "depositTip", "minWithdrawAmount", "withdrawFee", "withdrawStatus"]
