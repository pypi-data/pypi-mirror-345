...
class CreateMarginOrderOcoV1Resp(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contingencyType", "listClientOrderId", "listOrderStatus", "listStatusType", "marginBuyBorrowAmount", "marginBuyBorrowAsset", "orderListId", "orderReports", "orders", "symbol", "transactionTime"]
