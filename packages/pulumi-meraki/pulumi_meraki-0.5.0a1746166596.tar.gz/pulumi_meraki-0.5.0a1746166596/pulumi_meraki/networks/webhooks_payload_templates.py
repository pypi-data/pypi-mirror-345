...
class WebhooksPayloadTemplatesArgs:
    def __init__(__self__, *,
                 ...
                 body_file: Optional[pulumi.Input[builtins.str]] = None,
                 headers: Optional[pulumi.Input[Sequence[pulumi.Input['WebhooksPayloadTemplatesHeaderArgs']]]] = None,
                 headers_file: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 payload_template_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] body: The body of the payload template, in liquid template
        :param pulumi.Input[builtins.str] body_file: A file containing liquid template used for the body of the webhook message. Either *body* or *bodyFile* must be specified.
        ...
        :param pulumi.Input[builtins.str] headers_file: A file containing the liquid template used with the webhook headers.
        :param pulumi.Input[builtins.str] name: The name of the payload template
        :param pulumi.Input[builtins.str] payload_template_id: Webhook payload template Id
        """
    ...
    def body_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @body_file.setter
    def body_file(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def headers_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @headers_file.setter
    def headers_file(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def payload_template_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def payload_template_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _WebhooksPayloadTemplatesState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The type of the payload template
        """
        if body is not None:
            pulumi.set(__self__, "body", body)
        if body_file is not None:
...
class WebhooksPayloadTemplates(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'WebhooksPayloadTemplates':
        """
    ...
    @property
    @pulumi.getter(name="bodyFile")
    def body_file(self) -> pulumi.Output[builtins.str]:
        """
        A file containing liquid template used for the body of the webhook message. Either *body* or *bodyFile* must be specified.
        """
        return pulumi.get(self, "body_file")
    ...
    @property
    @pulumi.getter(name="headersFile")
    def headers_file(self) -> pulumi.Output[builtins.str]:
        """
        A file containing the liquid template used with the webhook headers.
        """
        return pulumi.get(self, "headers_file")
    ...
    @property
    @pulumi.getter(name="payloadTemplateId")
    def payload_template_id(self) -> pulumi.Output[builtins.str]:
        """
        Webhook payload template Id
        """
        return pulumi.get(self, "payload_template_id")
