...
class SnmpArgs:
    def __init__(__self__, *,
                 ...
                 peer_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 v2c_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 v3_auth_mode: Optional[pulumi.Input[builtins.str]] = None,
                 v3_auth_pass: Optional[pulumi.Input[builtins.str]] = None,
                 v3_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 v3_priv_mode: Optional[pulumi.Input[builtins.str]] = None,
                 v3_priv_pass: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] peer_ips: The list of IPv4 addresses that are allowed to access the SNMP server.
        :param pulumi.Input[builtins.bool] v2c_enabled: Boolean indicating whether SNMP version 2c is enabled for the organization.
        :param pulumi.Input[builtins.str] v3_auth_mode: The SNMP version 3 authentication mode. Can be either 'MD5' or 'SHA'.
        :param pulumi.Input[builtins.str] v3_auth_pass: The SNMP version 3 authentication password. Must be at least 8 characters if specified.
        :param pulumi.Input[builtins.bool] v3_enabled: Boolean indicating whether SNMP version 3 is enabled for the organization.
        :param pulumi.Input[builtins.str] v3_priv_mode: The SNMP version 3 privacy mode. Can be either 'DES' or 'AES128'.
        :param pulumi.Input[builtins.str] v3_priv_pass: The SNMP version 3 privacy password. Must be at least 8 characters if specified.
        """
    ...
    def peer_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @peer_ips.setter
    def peer_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "peer_ips", value)

    @property
    @pulumi.getter(name="v2cEnabled")
    def v2c_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @v2c_enabled.setter
    def v2c_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "v2c_enabled", value)

    @property
    @pulumi.getter(name="v3AuthMode")
    def v3_auth_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @v3_auth_mode.setter
    def v3_auth_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "v3_auth_mode", value)

    @property
    @pulumi.getter(name="v3AuthPass")
    def v3_auth_pass(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @v3_auth_pass.setter
    def v3_auth_pass(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def v3_priv_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @v3_priv_mode.setter
    def v3_priv_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "v3_priv_mode", value)

    @property
    @pulumi.getter(name="v3PrivPass")
    def v3_priv_pass(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @v3_priv_pass.setter
    def v3_priv_pass(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SnmpState:
    def __init__(__self__, *,
                 ...
                 v2_community_string: Optional[pulumi.Input[builtins.str]] = None,
                 v2c_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 v3_auth_mode: Optional[pulumi.Input[builtins.str]] = None,
                 v3_auth_pass: Optional[pulumi.Input[builtins.str]] = None,
                 v3_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 v3_priv_mode: Optional[pulumi.Input[builtins.str]] = None,
                 v3_priv_pass: Optional[pulumi.Input[builtins.str]] = None,
                 v3_user: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Snmp resources.
        :param pulumi.Input[builtins.str] hostname: The hostname of the SNMP server.
        :param pulumi.Input[builtins.str] organization_id: organizationId path parameter. Organization ID
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] peer_ips: The list of IPv4 addresses that are allowed to access the SNMP server.
        :param pulumi.Input[builtins.int] port: The port of the SNMP server.
        :param pulumi.Input[builtins.str] v2_community_string: The community string for SNMP version 2c, if enabled.
        :param pulumi.Input[builtins.bool] v2c_enabled: Boolean indicating whether SNMP version 2c is enabled for the organization.
        :param pulumi.Input[builtins.str] v3_auth_mode: The SNMP version 3 authentication mode. Can be either 'MD5' or 'SHA'.
        :param pulumi.Input[builtins.str] v3_auth_pass: The SNMP version 3 authentication password. Must be at least 8 characters if specified.
        :param pulumi.Input[builtins.bool] v3_enabled: Boolean indicating whether SNMP version 3 is enabled for the organization.
        :param pulumi.Input[builtins.str] v3_priv_mode: The SNMP version 3 privacy mode. Can be either 'DES' or 'AES128'.
        :param pulumi.Input[builtins.str] v3_priv_pass: The SNMP version 3 privacy password. Must be at least 8 characters if specified.
        :param pulumi.Input[builtins.str] v3_user: The user for SNMP version 3, if enabled.
        """
    ...
    def v2_community_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def v2_community_string(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def v3_user(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @v3_user.setter
    def v3_user(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "v3_user", value)


class Snmp(pulumi.CustomResource):

    pulumi_type = "meraki:organizations/snmp:Snmp"
    ...
    def get(resource_name: str,
            ...
            v3_priv_mode: Optional[pulumi.Input[builtins.str]] = None,
            v3_priv_pass: Optional[pulumi.Input[builtins.str]] = None,
            v3_user: Optional[pulumi.Input[builtins.str]] = None) -> 'Snmp':
        """
    ...
    @property
    @pulumi.getter(name="peerIps")
    def peer_ips(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of IPv4 addresses that are allowed to access the SNMP server.
        """
        return pulumi.get(self, "peer_ips")
    ...
    @property
    @pulumi.getter(name="v2CommunityString")
    def v2_community_string(self) -> pulumi.Output[builtins.str]:
        """
        The community string for SNMP version 2c, if enabled.
        """
        return pulumi.get(self, "v2_community_string")
    ...
    @property
    @pulumi.getter(name="v2cEnabled")
    def v2c_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Boolean indicating whether SNMP version 2c is enabled for the organization.
        """
        return pulumi.get(self, "v2c_enabled")
    ...
    @property
    @pulumi.getter(name="v3AuthMode")
    def v3_auth_mode(self) -> pulumi.Output[builtins.str]:
        """
        The SNMP version 3 authentication mode. Can be either 'MD5' or 'SHA'.
        """
        return pulumi.get(self, "v3_auth_mode")
    ...
    @property
    @pulumi.getter(name="v3AuthPass")
    def v3_auth_pass(self) -> pulumi.Output[builtins.str]:
        """
        The SNMP version 3 authentication password. Must be at least 8 characters if specified.
        """
        return pulumi.get(self, "v3_auth_pass")
    ...
    @property
    @pulumi.getter(name="v3Enabled")
    def v3_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Boolean indicating whether SNMP version 3 is enabled for the organization.
        """
        return pulumi.get(self, "v3_enabled")
    ...
    @property
    @pulumi.getter(name="v3PrivMode")
    def v3_priv_mode(self) -> pulumi.Output[builtins.str]:
        """
        The SNMP version 3 privacy mode. Can be either 'DES' or 'AES128'.
        """
        return pulumi.get(self, "v3_priv_mode")
    ...
    @property
    @pulumi.getter(name="v3PrivPass")
    def v3_priv_pass(self) -> pulumi.Output[builtins.str]:
        """
        The SNMP version 3 privacy password. Must be at least 8 characters if specified.
        """
        return pulumi.get(self, "v3_priv_pass")
    ...
    @property
    @pulumi.getter(name="v3User")
    def v3_user(self) -> pulumi.Output[builtins.str]:
        """
        The user for SNMP version 3, if enabled.
        """
        return pulumi.get(self, "v3_user")
