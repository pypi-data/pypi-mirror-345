...
<div align="center">
  <table>
    <tr>
      <td>
        ⚠️ <strong>IMPORTANT:</strong> This package has been renamed to <strong>agent-squad</strong>.<br>
        Please use <code>pip install agent-squad</code> instead.<br>
        See: <a href="https://pypi.org/project/agent-squad">https://pypi.org/project/agent-squad</a>
      </td>
    </tr>
  </table>
</div>
