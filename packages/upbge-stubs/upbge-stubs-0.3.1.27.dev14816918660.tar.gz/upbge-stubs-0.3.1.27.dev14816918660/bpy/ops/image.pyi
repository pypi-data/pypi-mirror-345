...
def convert_to_mesh_plane(*args, interpolation: str = 'Linear', extension: str = 'CLIP', alpha_mode: str = 'STRAIGHT', use_auto_refresh: bool = True, relative: bool = True, shader: str = 'PRINCIPLED', emit_strength: float = 1.0, use_transparency: bool = True, render_method: str = 'DITHERED', use_backface_culling: bool = False, show_transparent_back: bool = True, overwrite_material: bool = True, name_from: str = 'OBJECT', delete_ref: bool = True) -> None:
