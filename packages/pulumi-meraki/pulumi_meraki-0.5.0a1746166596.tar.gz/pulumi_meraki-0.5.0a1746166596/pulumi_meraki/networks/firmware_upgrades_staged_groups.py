...
class FirmwareUpgradesStagedGroupsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Description of the Staged Upgrade Group
        :param pulumi.Input[builtins.str] group_id: Id of staged upgrade group
        :param pulumi.Input[builtins.bool] is_default: Boolean indicating the default Group. Any device that does not have a group explicitly assigned will upgrade with this group
        :param pulumi.Input[builtins.str] name: Name of the Staged Upgrade Group
        """
...
class FirmwareUpgradesStagedGroups(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            is_default: Optional[pulumi.Input[builtins.bool]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            network_id: Optional[pulumi.Input[builtins.str]] = None) -> 'FirmwareUpgradesStagedGroups':
        """
