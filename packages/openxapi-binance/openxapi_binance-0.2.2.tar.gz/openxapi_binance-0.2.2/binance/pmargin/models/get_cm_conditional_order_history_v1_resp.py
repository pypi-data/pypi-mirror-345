...
class GetCmConditionalOrderHistoryV1Resp(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["activatePrice", "bookTime", "newClientStrategyId", "orderId", "origQty", "positionSide", "price", "priceMatch", "priceProtect", "priceRate", "reduceOnly", "side", "status", "stopPrice", "strategyId", "strategyStatus", "strategyType", "symbol", "timeInForce", "triggerTime", "type", "updateTime", "workingType"]
