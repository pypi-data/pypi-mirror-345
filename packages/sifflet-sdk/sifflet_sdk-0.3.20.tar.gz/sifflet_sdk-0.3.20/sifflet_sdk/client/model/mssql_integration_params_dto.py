...
def lazy_import():
    ...
    from sifflet_sdk.client.model.mssql_integration_params_dto_all_of import (
        MssqlIntegrationParamsDtoAllOf,
    )
    from sifflet_sdk.client.model.time_zone_dto import TimeZoneDto

    globals()["IntegrationParamsDto"] = IntegrationParamsDto
    globals()["MssqlIntegrationParamsDtoAllOf"] = MssqlIntegrationParamsDtoAllOf
    globals()["TimeZoneDto"] = TimeZoneDto


class MssqlIntegrationParamsDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MssqlIntegrationParamsDto - a model defined in OpenAPI
