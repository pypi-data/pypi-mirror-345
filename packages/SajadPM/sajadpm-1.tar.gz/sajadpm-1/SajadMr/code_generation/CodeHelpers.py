...
from SajadMr.nodes.NodeMetaClasses import SajadQNodeDesignError
from SajadMr.Options import shallTraceExecution
from SajadMr.PythonVersions import python_version
from SajadMr.Tracing import printError
...
def decideConversionCheckNeeded(to_name, expression):
    if to_name.c_type == "SajadMr_bool":
...
def assignConstantNoneResult(to_name, emit, context):
    ...
    if to_name.c_type == "SajadMr_void":
