...
__all__ = ['SmDevicesModifyTagsArgs', 'SmDevicesModifyTags']

@pulumi.input_type
class SmDevicesModifyTagsArgs:
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Input['SmDevicesModifyTagsParametersArgs']:
        return pulumi.get(self, "parameters")

    @parameters.setter
    def parameters(self, value: pulumi.Input['SmDevicesModifyTagsParametersArgs']):
...
class SmDevicesModifyTags(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SmDevicesModifyTagsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SmDevicesModifyTagsArgs.__new__(SmDevicesModifyTagsArgs)
        ...
        super(SmDevicesModifyTags, __self__).__init__(
    ...
    def get(resource_name: str,
        ...
        __props__ = _SmDevicesModifyTagsState.__new__(_SmDevicesModifyTagsState)

        __props__.__dict__["items"] = items
        __props__.__dict__["network_id"] = network_id
        __props__.__dict__["parameters"] = parameters
        return SmDevicesModifyTags(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[Sequence['outputs.SmDevicesModifyTagsItem']]:
        """
        Array of ResponseSmModifyNetworkSmDevicesTags
        """
        return pulumi.get(self, "items")
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Output['outputs.SmDevicesModifyTagsParameters']:
        return pulumi.get(self, "parameters")
