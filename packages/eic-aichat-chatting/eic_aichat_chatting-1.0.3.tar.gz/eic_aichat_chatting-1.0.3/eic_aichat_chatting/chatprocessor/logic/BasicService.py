...
class BasicService(IBasicService, IConfigurable, IReferenceable):
    ...
    def __init__(self):
        ...
        self._conn_operations: ModelConnectionOperationsV1 = None
    ...
    def configure(self, config: ConfigParams):
        ...
        self._base_models_service.configure(config)
        self._conn_operations.configure(config)
    ...
    def set_references(self, references: IReferences):
        ...
        self._conn_operations = references.get_one_required(Descriptor('aichatconnect', 'operations', '*', '*', '1.0'))
        if self._conn_operations is not None:
            self._conn_operations.set_references(references)
    ...
    def handle_model_request(self, context: Optional[IContext], request: RequestV1) -> ResponseV1:
        ...
        try:
            ...
            resp = self._conn_operations.execute_request(context, conn_params, req)
