...
class GetBrokerTransferFuturesV1Resp(BaseModel):
    """
    GetBrokerTransferFuturesV1Resp
    """ # noqa: E501
    futures_type: Optional[StrictInt] = Field(default=None, alias="futuresType")
    success: Optional[StrictBool] = None
    transfers: Optional[List[GetBrokerTransferFuturesV1RespTransfersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transfers": [GetBrokerTransferFuturesV1RespTransfersInner.from_dict(_item) for _item in obj["transfers"]] if obj.get("transfers") is not None else None
        })
        return _obj
