...
def test_cudaawkward_ListArray64_compact_offsets_64_1():
    ...
    length = 3
    funcC = cupy_backend['awkward_ListArray_compact_offsets', cupy.int64, cupy.int64, cupy.int64]
...
def test_cudaawkward_ListArray64_compact_offsets_64_2():
    tooffsets = cupy.array([123, 123, 123, 123], dtype=cupy.int64)
...
def test_cudaawkward_ListArray64_compact_offsets_64_3():
    tooffsets = cupy.array([123, 123, 123, 123], dtype=cupy.int64)
...
def test_cudaawkward_ListArray64_compact_offsets_64_4():
    tooffsets = cupy.array([123, 123, 123, 123], dtype=cupy.int64)
...
def test_cudaawkward_ListArray64_compact_offsets_64_5():
    tooffsets = cupy.array([123, 123, 123, 123], dtype=cupy.int64)
