...
class ApplicationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_application_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/applications/{applicationId}',
            ...
            root_map={
                'validations': {
                    ('application_id',): {
                        ...
                        'regex': {
                            'pattern': r'.*\/Application[^\/]*',  # noqa: E501
                        },
                    },
                },
                'allowed_values': {
        ...
        self.search_applications_endpoint = _Endpoint(
            settings={
                'response_type': ([ApplicationView],),
                'auth': [
                    'basicAuth',
                ...
                'endpoint_path': '/api/v1/applications/search',
                'operation_id': 'search_applications',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.update_application_endpoint = _Endpoint(
            settings={
                'response_type': (ApplicationView,),
                'auth': [
                    'basicAuth',
    ...
    def create_application(
        ...
        **kwargs
        ...
        Keyword Args:
            application_form (ApplicationForm): [optional]
    ...
    def search_applications(
        ...
        **kwargs
        ...
        """search_applications  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_applications(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            application_filters (ApplicationFilters): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.search_applications_endpoint.call_with_http_info(**kwargs)
    ...
    def update_application(
        ...
        **kwargs
        ...
        kwargs['application_id'] = \
            application_id
        return self.update_application_endpoint.call_with_http_info(**kwargs)
