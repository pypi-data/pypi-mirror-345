...
class GeneralPoliciesPruningFunction(pymimir.advanced.languages.description_logics.IRefinementPruningFunction):
    ...
    @overload
    def __init__(self, states: Sequence[Tuple[pymimir.advanced.search.State, pymimir.advanced.formalism.Problem]], transitions: Sequence[Tuple[Tuple[pymimir.advanced.search.State, pymimir.advanced.formalism.Problem], Tuple[pymimir.advanced.search.State, pymimir.advanced.formalism.Problem]]], ref_denotation_repositories: pymimir.advanced.languages.description_logics.DenotationRepositories) -> None: ...
