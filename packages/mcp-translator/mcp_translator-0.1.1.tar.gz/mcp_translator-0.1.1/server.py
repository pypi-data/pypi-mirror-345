...
import sqlite3
import os
import database # Use relative import
from text_splitter import split_text_intelligently # Import the function
...
GEMINI_MODEL_NAME = "gemini-2.0-flash" # Use a standard model name
...
@click.command()
def main() -> int:
    logger.info(f"Starting Translator Server.")
    mcp.run()
