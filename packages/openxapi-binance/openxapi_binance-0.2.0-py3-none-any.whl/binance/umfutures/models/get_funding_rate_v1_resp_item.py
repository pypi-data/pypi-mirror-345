...
class GetFundingRateV1RespItem(BaseModel):
    """
    GetFundingRateV1RespItem
    """ # noqa: E501
    funding_rate: Optional[StrictStr] = Field(default=None, alias="fundingRate")
    funding_time: Optional[StrictInt] = Field(default=None, alias="fundingTime")
    mark_price: Optional[StrictStr] = Field(default=None, alias="markPrice")
    symbol: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["fundingRate", "fundingTime", "markPrice", "symbol"]
