...
__all__ = ['DefaultPreventionPolicyLinuxArgs', 'DefaultPreventionPolicyLinux']

@pulumi.input_type
class DefaultPreventionPolicyLinuxArgs:
    def __init__(__self__, *,
                 ioa_rule_groups: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 cloud_anti_malware: Optional[pulumi.Input['DefaultPreventionPolicyLinuxCloudAntiMalwareArgs']] = None,
                 ...
                 sensor_anti_malware: Optional[pulumi.Input['DefaultPreventionPolicyLinuxSensorAntiMalwareArgs']] = None,
        ...
        :param pulumi.Input['DefaultPreventionPolicyLinuxCloudAntiMalwareArgs'] cloud_anti_malware: Use cloud-based machine learning informed by global analysis of executables to detect and prevent known malware for your online hosts.
        ...
        :param pulumi.Input['DefaultPreventionPolicyLinuxSensorAntiMalwareArgs'] sensor_anti_malware: For offline and online hosts, use sensor-based machine learning to identify and analyze unknown executables as they run to detect and prevent malware.
    ...
    def cloud_anti_malware(self) -> Optional[pulumi.Input['DefaultPreventionPolicyLinuxCloudAntiMalwareArgs']]:
        """
    ...
    def cloud_anti_malware(self, value: Optional[pulumi.Input['DefaultPreventionPolicyLinuxCloudAntiMalwareArgs']]):
    ...
    def sensor_anti_malware(self) -> Optional[pulumi.Input['DefaultPreventionPolicyLinuxSensorAntiMalwareArgs']]:
        """
    ...
    def sensor_anti_malware(self, value: Optional[pulumi.Input['DefaultPreventionPolicyLinuxSensorAntiMalwareArgs']]):
...
@pulumi.input_type
class _DefaultPreventionPolicyLinuxState:
    def __init__(__self__, *,
                 cloud_anti_malware: Optional[pulumi.Input['DefaultPreventionPolicyLinuxCloudAntiMalwareArgs']] = None,
                 custom_blocking: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
...
class DefaultPreventionPolicyLinux(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 cloud_anti_malware: Optional[pulumi.Input[Union['DefaultPreventionPolicyLinuxCloudAntiMalwareArgs', 'DefaultPreventionPolicyLinuxCloudAntiMalwareArgsDict']]] = None,
                 custom_blocking: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 drift_prevention: Optional[pulumi.Input[builtins.bool]] = None,
                 email_protocol_visibility: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 quarantine: Optional[pulumi.Input[builtins.bool]] = None,
                 script_based_execution_monitoring: Optional[pulumi.Input[builtins.bool]] = None,
                 sensor_anti_malware: Optional[pulumi.Input[Union['DefaultPreventionPolicyLinuxSensorAntiMalwareArgs', 'DefaultPreventionPolicyLinuxSensorAntiMalwareArgsDict']]] = None,
                 sensor_tampering_protection: Optional[pulumi.Input[builtins.bool]] = None,
                 tls_visibility: Optional[pulumi.Input[builtins.bool]] = None,
                 upload_unknown_detection_related_executables: Optional[pulumi.Input[builtins.bool]] = None,
                 upload_unknown_executables: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Union['DefaultPreventionPolicyLinuxCloudAntiMalwareArgs', 'DefaultPreventionPolicyLinuxCloudAntiMalwareArgsDict']] cloud_anti_malware: Use cloud-based machine learning informed by global analysis of executables to detect and prevent known malware for your online hosts.
        :param pulumi.Input[builtins.bool] custom_blocking: Whether to enable the setting. Block processes matching hashes that you add to IOC Management with the action set to "Block" or "Block, hide detection".
        :param pulumi.Input[builtins.str] description: Description of the prevention policy.
        :param pulumi.Input[builtins.bool] drift_prevention: Whether to enable the setting. Block new processes originating from files written in a container. This prevents a container from drifting from its immutable runtime state.
        :param pulumi.Input[builtins.bool] email_protocol_visibility: Whether to enable the setting. Allows the sensor to monitor SMTP, IMAP, and POP3 traffic for malicious patterns and improved detections.
        ...
        :param pulumi.Input[builtins.bool] quarantine: Whether to enable the setting. Quarantine executable files after they’re prevented by NGAV. When this is enabled, we recommend setting anti-malware prevention levels to Moderate or higher and not using other antivirus solutions.
        :param pulumi.Input[builtins.bool] script_based_execution_monitoring: Whether to enable the setting. Provides visibility into suspicious scripts, including shell and other scripting languages.
        :param pulumi.Input[Union['DefaultPreventionPolicyLinuxSensorAntiMalwareArgs', 'DefaultPreventionPolicyLinuxSensorAntiMalwareArgsDict']] sensor_anti_malware: For offline and online hosts, use sensor-based machine learning to identify and analyze unknown executables as they run to detect and prevent malware.
        :param pulumi.Input[builtins.bool] sensor_tampering_protection: Whether to enable the setting. Block attempts to tamper with the sensor by protecting critical components and resources. If disabled, the sensor still creates detections for tampering attempts but will not prevent the activity from occurring. Disabling is not recommended.
        :param pulumi.Input[builtins.bool] tls_visibility: Whether to enable the setting. Allows the sensor to monitor TLS traffic for malicious patterns and improved detections.
        :param pulumi.Input[builtins.bool] upload_unknown_detection_related_executables: Whether to enable the setting. Upload all unknown detection-related executables for advanced analysis in the cloud.
        :param pulumi.Input[builtins.bool] upload_unknown_executables: Whether to enable the setting. Upload all unknown executables for advanced analysis in the cloud.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DefaultPreventionPolicyLinuxArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DefaultPreventionPolicyLinuxArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DefaultPreventionPolicyLinuxArgs.__new__(DefaultPreventionPolicyLinuxArgs)
        ...
        super(DefaultPreventionPolicyLinux, __self__).__init__(
            'crowdstrike:index/defaultPreventionPolicyLinux:DefaultPreventionPolicyLinux',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            tls_visibility: Optional[pulumi.Input[builtins.bool]] = None,
            upload_unknown_detection_related_executables: Optional[pulumi.Input[builtins.bool]] = None,
            upload_unknown_executables: Optional[pulumi.Input[builtins.bool]] = None) -> 'DefaultPreventionPolicyLinux':
        """
        ...
        __props__ = _DefaultPreventionPolicyLinuxState.__new__(_DefaultPreventionPolicyLinuxState)
        ...
        __props__.__dict__["upload_unknown_detection_related_executables"] = upload_unknown_detection_related_executables
        __props__.__dict__["upload_unknown_executables"] = upload_unknown_executables
        return DefaultPreventionPolicyLinux(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="cloudAntiMalware")
    def cloud_anti_malware(self) -> pulumi.Output['outputs.DefaultPreventionPolicyLinuxCloudAntiMalware']:
        """
        Use cloud-based machine learning informed by global analysis of executables to detect and prevent known malware for your online hosts.
        """
        return pulumi.get(self, "cloud_anti_malware")
    ...
    @property
    @pulumi.getter(name="sensorAntiMalware")
    def sensor_anti_malware(self) -> pulumi.Output['outputs.DefaultPreventionPolicyLinuxSensorAntiMalware']:
        """
        For offline and online hosts, use sensor-based machine learning to identify and analyze unknown executables as they run to detect and prevent malware.
        """
        return pulumi.get(self, "sensor_anti_malware")
