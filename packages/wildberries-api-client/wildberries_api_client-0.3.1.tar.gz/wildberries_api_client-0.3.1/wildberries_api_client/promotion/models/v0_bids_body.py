...
class V0BidsBody(object):
    ...
    def __init__(self, bids=None):  # noqa: E501
        """V0BidsBody - a model defined in Swagger"""  # noqa: E501
        self._bids = None
    ...
    @property
    def bids(self):
        """Gets the bids of this V0BidsBody.  # noqa: E501


        :return: The bids of this V0BidsBody.  # noqa: E501
        :rtype: list[V0AdvertMultibid]
        """
        return self._bids

    @bids.setter
    def bids(self, bids):
        """Sets the bids of this V0BidsBody.


        :param bids: The bids of this V0BidsBody.  # noqa: E501
        :type: list[V0AdvertMultibid]
        """
        if bids is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V0BidsBody):
            return False
