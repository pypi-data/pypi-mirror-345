...
""")
    ...
    def show_help(self):
        ...
        print("fix ./my_project           - Fix GDPR issues in a directory")
        print("report ./my_project report.json  - Generate a compliance report")
        print("mark_false_positive 2      - Mark issue #2 as a false positive")
