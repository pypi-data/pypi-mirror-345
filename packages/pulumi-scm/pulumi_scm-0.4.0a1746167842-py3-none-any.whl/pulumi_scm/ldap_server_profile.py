...
class LdapServerProfileArgs:
    def __init__(__self__, *,
                 ...
                 bind_timelimit: Optional[pulumi.Input[builtins.str]] = None,
                 device: Optional[pulumi.Input[builtins.str]] = None,
                 folder: Optional[pulumi.Input[builtins.str]] = None,
                 ldap_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 timelimit: Optional[pulumi.Input[builtins.int]] = None,
                 verify_server_certificate: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] base: The Base param. String length must not exceed 255 characters.
        :param pulumi.Input[builtins.str] bind_dn: The BindDn param. String length must not exceed 255 characters.
        :param pulumi.Input[builtins.str] bind_password: The BindPassword param. String length must not exceed 121 characters.
        :param pulumi.Input[builtins.str] bind_timelimit: The BindTimelimit param.
        :param pulumi.Input[builtins.str] device: The Device param.
        :param pulumi.Input[builtins.str] folder: The Folder param.
        :param pulumi.Input[builtins.str] ldap_type: The LdapType param. String must be one of these: `"active-directory"`, `"e-directory"`, `"sun"`, `"other"`.
        :param pulumi.Input[builtins.int] retry_interval: The RetryInterval param.
        :param pulumi.Input[builtins.str] snippet: The Snippet param.
        :param pulumi.Input[builtins.bool] ssl: The Ssl param.
        :param pulumi.Input[builtins.int] timelimit: The Timelimit param.
        :param pulumi.Input[builtins.bool] verify_server_certificate: The VerifyServerCertificate param.
        """
    ...
    def bind_timelimit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bind_timelimit(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ldap_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ldap_type.setter
    def ldap_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def timelimit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The Timelimit param.
        """
    ...
    @timelimit.setter
    def timelimit(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "timelimit", value)

    @property
    @pulumi.getter(name="verifyServerCertificate")
    def verify_server_certificate(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def verify_server_certificate(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class LdapServerProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tfid: Optional[pulumi.Input[builtins.str]] = None,
            timelimit: Optional[pulumi.Input[builtins.int]] = None,
            verify_server_certificate: Optional[pulumi.Input[builtins.bool]] = None) -> 'LdapServerProfile':
        """
    ...
    @property
    @pulumi.getter
    def base(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Base param. String length must not exceed 255 characters.
        """
        return pulumi.get(self, "base")
    ...
    @property
    @pulumi.getter(name="bindDn")
    def bind_dn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The BindDn param. String length must not exceed 255 characters.
        """
        return pulumi.get(self, "bind_dn")
    ...
    @property
    @pulumi.getter(name="bindPassword")
    def bind_password(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The BindPassword param. String length must not exceed 121 characters.
        """
        return pulumi.get(self, "bind_password")
    ...
    @property
    @pulumi.getter(name="bindTimelimit")
    def bind_timelimit(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The BindTimelimit param.
        """
        return pulumi.get(self, "bind_timelimit")
    ...
    @property
    @pulumi.getter(name="ldapType")
    def ldap_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The LdapType param. String must be one of these: `"active-directory"`, `"e-directory"`, `"sun"`, `"other"`.
        """
        return pulumi.get(self, "ldap_type")
    ...
    @property
    @pulumi.getter
    def timelimit(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The Timelimit param.
        """
        return pulumi.get(self, "timelimit")
    ...
    @property
    @pulumi.getter(name="verifyServerCertificate")
    def verify_server_certificate(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The VerifyServerCertificate param.
        """
        return pulumi.get(self, "verify_server_certificate")
