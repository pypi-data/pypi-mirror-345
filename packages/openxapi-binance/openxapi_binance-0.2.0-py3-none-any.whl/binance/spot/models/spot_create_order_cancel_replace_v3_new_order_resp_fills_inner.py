...
class SpotCreateOrderCancelReplaceV3NewOrderRespFillsInner(BaseModel):
    """
    SpotCreateOrderCancelReplaceV3NewOrderRespFillsInner
    """ # noqa: E501
    alloc_id: Optional[Any] = Field(default=None, alias="allocId")
    ...
    __properties: ClassVar[List[str]] = ["allocId", "commission", "commissionAsset", "matchType", "price", "qty", "tradeId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if alloc_id (nullable) is None
        # and model_fields_set contains the field
        if self.alloc_id is None and "alloc_id" in self.model_fields_set:
            _dict['allocId'] = None
