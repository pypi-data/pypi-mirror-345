    ...
    def set_workflow_definition(self, workflow_definition):
        ...
        if workflow_request.state == state.initialize:
            ...
            if product_definition:
                ...
                for prop in workflow_request.alias:
                    version_alias_id = 'alias_' + prop
                    alias_value = workflow_request.alias[prop]
                    updatedProperties[version_alias_id] = alias_value
                    self.lambda_framework.log(f'{version_alias_id} = {alias_value}')
