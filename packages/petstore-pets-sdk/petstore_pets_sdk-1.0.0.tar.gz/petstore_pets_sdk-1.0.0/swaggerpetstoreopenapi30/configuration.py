...
class Configuration(HttpClientConfiguration):
    ...
    def create_auth_credentials_object(api_key,
        ...
        warnings.warn(message=('The \'api_key\' params are deprecated. Use \'cu'
                               'stom_header_authentication_credentials\' param '
                               'instead.'),
                      category=DeprecationWarning,
                      stacklevel=stack_level)

        if custom_header_authentication_credentials is not None:
            return custom_header_authentication_credentials.clone_with(api_key)

        from swaggerpetstoreopenapi30.http.auth.custom_header_authentication import CustomHeaderAuthenticationCredentials
        return CustomHeaderAuthenticationCredentials(api_key)
