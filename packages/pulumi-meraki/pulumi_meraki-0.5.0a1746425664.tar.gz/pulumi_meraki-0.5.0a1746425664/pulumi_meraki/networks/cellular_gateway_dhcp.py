...
class CellularGatewayDhcpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dhcp_lease_time: DHCP Lease time for all MG in the network.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_custom_nameservers: List of fixed IPs representing the the DNS Name servers when the mode is 'custom'.
        :param pulumi.Input[builtins.str] dns_nameservers: DNS name servers mode for all MG in the network.
        """
...
class CellularGatewayDhcp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            dns_custom_nameservers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            dns_nameservers: Optional[pulumi.Input[builtins.str]] = None,
            network_id: Optional[pulumi.Input[builtins.str]] = None) -> 'CellularGatewayDhcp':
        """
