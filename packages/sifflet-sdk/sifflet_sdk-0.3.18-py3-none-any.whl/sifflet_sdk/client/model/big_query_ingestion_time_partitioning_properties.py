...
def lazy_import():
    from sifflet_sdk.client.model.big_query_ingestion_time_partitioning_properties_all_of import (
        BigQueryIngestionTimePartitioningPropertiesAllOf,
    )
    from sifflet_sdk.client.model.big_query_partitioning_properties import (
        BigQueryPartitioningProperties,
    )

    globals()["BigQueryIngestionTimePartitioningPropertiesAllOf"] = BigQueryIngestionTimePartitioningPropertiesAllOf
    globals()["BigQueryPartitioningProperties"] = BigQueryPartitioningProperties


class BigQueryIngestionTimePartitioningProperties(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BigQueryIngestionTimePartitioningProperties - a model defined in OpenAPI
