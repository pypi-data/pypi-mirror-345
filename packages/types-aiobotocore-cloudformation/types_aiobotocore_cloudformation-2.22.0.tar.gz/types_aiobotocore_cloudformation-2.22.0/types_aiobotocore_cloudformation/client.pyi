...
class CloudFormationClient(AioBaseClient):
    ...
    async def create_stack_refactor(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/client/#create_stack_refactor)
        """
    ...
    async def describe_stack_refactor(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/client/#describe_stack_refactor)
        """
    ...
    async def execute_stack_refactor(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/client/#execute_stack_refactor)
        """
    ...
    async def list_stack_refactor_actions(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/client/#list_stack_refactor_actions)
        """
    ...
    async def list_stack_refactors(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/client/#list_stack_refactors)
        """
