...
class GetCapitalDepositHisrecV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["address", "addressTag", "amount", "coin", "completeTime", "confirmTimes", "id", "insertTime", "network", "status", "transferType", "txId", "unlockConfirm", "walletType"]
