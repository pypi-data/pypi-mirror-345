...
class PipelineActivity(BaseModel):
    ...
    artifacts: Optional[List[PipelineActivityartifacts]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "artifacts": [PipelineActivityartifacts.from_dict(_item) for _item in obj["artifacts"]] if obj.get("artifacts") is not None else None,
