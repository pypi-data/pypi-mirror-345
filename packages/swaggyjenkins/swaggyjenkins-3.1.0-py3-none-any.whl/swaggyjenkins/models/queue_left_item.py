...
class QueueLeftItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_class", "actions", "blocked", "buildable", "id", "inQueueSince", "params", "stuck", "task", "url", "why", "cancelled", "executable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "executable": FreeStyleBuild.from_dict(obj["executable"]) if obj.get("executable") is not None else None
        })
        return _obj
