...
class VictronInverter(ModbusBattery):
    ...
    def set_power_setpoint(self, phase: int, setpoint: int):
    ...
    def set_current_setpoint(self, phase: int, setpoint: int):
        ...
        self.set_power_setpoint(phase, power_setpoint)

    def get_active_power_total(self):
        '''Get the total active power of the victron inverter

        Returns:
            int: the active power of the victron inverter
        '''
    ...
    def get_active_current_total(self):
        ...
        Returns:
            int: the active current of the victron inverter
        '''
        return self.read_holding_register(
