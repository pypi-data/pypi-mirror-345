...
__all__ = ['SwitchRoutingInterfacesDhcpArgs', 'SwitchRoutingInterfacesDhcp']

@pulumi.input_type
class SwitchRoutingInterfacesDhcpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SwitchRoutingInterfacesDhcpDhcpOptionArgs']]] dhcp_options: Array of DHCP options consisting of code, type and value for the DHCP server running on the switch stack interface
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SwitchRoutingInterfacesDhcpFixedIpAssignmentArgs']]] fixed_ip_assignments: Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
        :param pulumi.Input[Sequence[pulumi.Input['SwitchRoutingInterfacesDhcpReservedIpRangeArgs']]] reserved_ip_ranges: Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
        """
...
class SwitchRoutingInterfacesDhcp(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] dhcp_lease_time: The DHCP lease time config for the dhcp server running on the switch stack interface ('30 minutes', '1 hour', '4 hours', '12 hours', '1 day' or '1 week')
        :param pulumi.Input[builtins.str] dhcp_mode: The DHCP mode options for the switch stack interface ('dhcpDisabled', 'dhcpRelay' or 'dhcpServer')
        :param pulumi.Input[Sequence[pulumi.Input[Union['SwitchRoutingInterfacesDhcpDhcpOptionArgs', 'SwitchRoutingInterfacesDhcpDhcpOptionArgsDict']]]] dhcp_options: Array of DHCP options consisting of code, type and value for the DHCP server running on the switch stack interface
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dhcp_relay_server_ips: The DHCP relay server IPs to which DHCP packets would get relayed for the switch stack interface
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_custom_nameservers: The DHCP name server IPs when DHCP name server option is 'custom'
        :param pulumi.Input[builtins.str] dns_nameservers_option: The DHCP name server option for the dhcp server running on the switch stack interface ('googlePublicDns', 'openDns' or 'custom')
        :param pulumi.Input[Sequence[pulumi.Input[Union['SwitchRoutingInterfacesDhcpFixedIpAssignmentArgs', 'SwitchRoutingInterfacesDhcpFixedIpAssignmentArgsDict']]]] fixed_ip_assignments: Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
        :param pulumi.Input[builtins.str] interface_id: interfaceId path parameter. Interface ID
        :param pulumi.Input[Sequence[pulumi.Input[Union['SwitchRoutingInterfacesDhcpReservedIpRangeArgs', 'SwitchRoutingInterfacesDhcpReservedIpRangeArgsDict']]]] reserved_ip_ranges: Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
        :param pulumi.Input[builtins.str] serial: serial path parameter.
        """
        ...
    @overload
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SwitchRoutingInterfacesDhcpArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SwitchRoutingInterfacesDhcpArgs.__new__(SwitchRoutingInterfacesDhcpArgs)
        ...
        super(SwitchRoutingInterfacesDhcp, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            interface_id: Optional[pulumi.Input[builtins.str]] = None,
            reserved_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SwitchRoutingInterfacesDhcpReservedIpRangeArgs', 'SwitchRoutingInterfacesDhcpReservedIpRangeArgsDict']]]]] = None,
            serial: Optional[pulumi.Input[builtins.str]] = None) -> 'SwitchRoutingInterfacesDhcp':
        """
        ...
        __props__ = _SwitchRoutingInterfacesDhcpState.__new__(_SwitchRoutingInterfacesDhcpState)
        ...
        __props__.__dict__["reserved_ip_ranges"] = reserved_ip_ranges
        __props__.__dict__["serial"] = serial
        return SwitchRoutingInterfacesDhcp(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="dhcpOptions")
    def dhcp_options(self) -> pulumi.Output[Sequence['outputs.SwitchRoutingInterfacesDhcpDhcpOption']]:
        """
        Array of DHCP options consisting of code, type and value for the DHCP server running on the switch stack interface
        """
        return pulumi.get(self, "dhcp_options")
    ...
    @property
    @pulumi.getter(name="fixedIpAssignments")
    def fixed_ip_assignments(self) -> pulumi.Output[Sequence['outputs.SwitchRoutingInterfacesDhcpFixedIpAssignment']]:
        """
        Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
        """
        return pulumi.get(self, "fixed_ip_assignments")
    ...
    @property
    @pulumi.getter(name="reservedIpRanges")
    def reserved_ip_ranges(self) -> pulumi.Output[Sequence['outputs.SwitchRoutingInterfacesDhcpReservedIpRange']]:
        """
        Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
        """
        return pulumi.get(self, "reserved_ip_ranges")
