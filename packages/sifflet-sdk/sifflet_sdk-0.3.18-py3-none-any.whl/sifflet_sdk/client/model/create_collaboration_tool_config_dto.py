...
def lazy_import():
    from sifflet_sdk.client.model.create_jira_config_dto import CreateJiraConfigDto

    globals()["CreateJiraConfigDto"] = CreateJiraConfigDto


class CreateCollaborationToolConfigDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "config": (CreateJiraConfigDto,),  # noqa: E501
            "type": (str,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, config, type, *args, **kwargs):  # noqa: E501
        """CreateCollaborationToolConfigDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, config, type, *args, **kwargs):  # noqa: E501
        """CreateCollaborationToolConfigDto - a model defined in OpenAPI
