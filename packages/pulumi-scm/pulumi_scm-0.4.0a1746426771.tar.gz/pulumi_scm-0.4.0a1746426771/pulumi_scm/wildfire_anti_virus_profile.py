...
class WildfireAntiVirusProfileArgs:
    def __init__(__self__, *,
                 ...
                 packet_capture: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] name: The Name param. String validation regex: `^[a-zA-Z0-9._-]+$`.
        :param pulumi.Input[builtins.bool] packet_capture: The PacketCapture param.
    ...
    def packet_capture(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def packet_capture(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class WildfireAntiVirusProfile(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="packetCapture")
    def packet_capture(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The PacketCapture param.
        """
        return pulumi.get(self, "packet_capture")
