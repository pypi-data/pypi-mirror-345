...
class ProviderArgs:
    def __init__(__self__, *,
                 auth_file: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] auth_file: The file path to the JSON file with auth creds for SCM.
        :param pulumi.Input[builtins.str] auth_url: The URL to send auth credentials to which will return a JWT. Default:
        ...
        :param pulumi.Input[builtins.str] client_id: The client ID for the connection. Environment variable: `SCM_CLIENT_ID`. JSON config file variable: `client_id`.
        :param pulumi.Input[builtins.str] client_secret: The client secret for the connection. Environment variable: `SCM_CLIENT_SECRET`. JSON config file variable:
               `client_secret`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] headers: Custom HTTP headers to be sent with all API commands. Environment variable: `SCM_HEADERS`. JSON config file variable:
               `headers`.
        :param pulumi.Input[builtins.str] host: The hostname of Strata Cloud Manager API. Default: `api.sase.paloaltonetworks.com`. Environment variable: `SCM_HOST`.
               JSON config file variable: `host`.
        :param pulumi.Input[builtins.str] logging: The logging level of the provider and the underlying communication. Default: `quiet`. Environment variable:
               `SCM_LOGGING`. JSON config file variable: `logging`.
        :param pulumi.Input[builtins.int] port: The port number to use for API commands, if non-standard for the given protocol. Environment variable: `SCM_PORT`. JSON
               config file variable: `port`.
        :param pulumi.Input[builtins.str] protocol: The protocol to use for SCM. This should be 'http' or 'https'. Default: `https`. Environment variable: `SCM_PROTOCOL`.
               JSON config file variable: `protocol`.
        :param pulumi.Input[builtins.str] scope: The client scope. Environment variable: `SCM_SCOPE`. JSON config file variable: `scope`.
        """
    ...
    def auth_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @auth_file.setter
    def auth_file(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Provider(pulumi.ProviderResource):
    ...
    pulumi_type = "pulumi:providers:scm"
    ...
    @property
    @pulumi.getter(name="authFile")
    def auth_file(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The file path to the JSON file with auth creds for SCM.
        """
        return pulumi.get(self, "auth_file")
