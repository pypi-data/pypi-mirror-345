...
class SecondaryMarketLongTermTransferRequestOptions(BaseModel):
    ...
    """ # noqa: E501
    available_capacity: StrictInt = Field(description="Capacity value in kilowatts (kW) - the required system precision allows for handling capacity values as integers", alias="availableCapacity")
    __properties: ClassVar[List[str]] = ["availableCapacity"]
