...
class DeleteSubAccountSubAccountApiIpRestrictionIpListV1Resp(BaseModel):
    """
    ...
    ip_restrict: Optional[StrictStr] = Field(default=None, alias="ipRestrict")
    update_time: Optional[StrictInt] = Field(default=None, alias="updateTime")
    __properties: ClassVar[List[str]] = ["apiKey", "ipList", "ipRestrict", "updateTime"]
