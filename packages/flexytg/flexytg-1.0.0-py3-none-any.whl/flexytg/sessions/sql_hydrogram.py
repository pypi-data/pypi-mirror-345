#Function To Pack And Unpack hydrogram Sql Sessions
...
#Defs
def unsql_hydrogram(sql_session=None):
...
def sql_hydrogram(file_name='hydrogram.session', dc_id=None, api_id=None, test_mode=0, auth_key=None, 
