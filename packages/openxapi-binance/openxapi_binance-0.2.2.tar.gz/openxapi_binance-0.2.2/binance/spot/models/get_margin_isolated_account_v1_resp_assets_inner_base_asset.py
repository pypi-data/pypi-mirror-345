...
class GetMarginIsolatedAccountV1RespAssetsInnerBaseAsset(BaseModel):
    """
    ...
    borrowed: Optional[StrictStr] = None
    ...
    net_asset_of_btc: Optional[StrictStr] = Field(default=None, alias="netAssetOfBtc")
    repay_enabled: Optional[StrictBool] = Field(default=None, alias="repayEnabled")
    total_asset: Optional[StrictStr] = Field(default=None, alias="totalAsset")
