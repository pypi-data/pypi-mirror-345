...
class OptionsCreateBatchOrdersV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clientOrderId", "mmp", "orderId", "postOnly", "price", "quantity", "reduceOnly", "side", "symbol", "type"]
