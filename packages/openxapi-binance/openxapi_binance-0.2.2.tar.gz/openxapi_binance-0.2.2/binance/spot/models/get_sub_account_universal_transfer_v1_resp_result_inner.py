...
class GetSubAccountUniversalTransferV1RespResultInner(BaseModel):
    """
    ...
    create_time_stamp: Optional[StrictInt] = Field(default=None, alias="createTimeStamp")
    ...
    __properties: ClassVar[List[str]] = ["amount", "asset", "clientTranId", "createTimeStamp", "fromAccountType", "fromEmail", "status", "toAccountType", "toEmail", "tranId"]
