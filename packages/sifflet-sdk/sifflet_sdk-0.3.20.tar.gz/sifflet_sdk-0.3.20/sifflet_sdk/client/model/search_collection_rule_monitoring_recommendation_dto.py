...
def lazy_import():
    from sifflet_sdk.client.model.rule_monitoring_recommendation_dto import (
        RuleMonitoringRecommendationDto,
    )

    globals()["RuleMonitoringRecommendationDto"] = RuleMonitoringRecommendationDto


class SearchCollectionRuleMonitoringRecommendationDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([RuleMonitoringRecommendationDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SearchCollectionRuleMonitoringRecommendationDto - a model defined in OpenAPI

        Args:
            data ([RuleMonitoringRecommendationDto]):
