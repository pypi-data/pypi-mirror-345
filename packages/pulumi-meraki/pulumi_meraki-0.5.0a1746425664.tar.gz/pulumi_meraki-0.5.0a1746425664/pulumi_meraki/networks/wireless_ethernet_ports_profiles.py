...
class WirelessEthernetPortsProfilesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] profile_id: AP port profile ID
        :param pulumi.Input[builtins.str] name: AP port profile name
...
class _WirelessEthernetPortsProfilesState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] is_default: Is default profile
        :param pulumi.Input[builtins.str] name: AP port profile name
        :param pulumi.Input[builtins.str] network_id: networkId path parameter. Network ID
        :param pulumi.Input[Sequence[pulumi.Input['WirelessEthernetPortsProfilesPortArgs']]] ports: Ports config
        :param pulumi.Input[builtins.str] profile_id: AP port profile ID
