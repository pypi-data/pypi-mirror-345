...
class BranchImpllinks(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["self", "actions", "runs", "queue", "_class"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "runs": Link.from_dict(obj["runs"]) if obj.get("runs") is not None else None,
            "queue": Link.from_dict(obj["queue"]) if obj.get("queue") is not None else None,
