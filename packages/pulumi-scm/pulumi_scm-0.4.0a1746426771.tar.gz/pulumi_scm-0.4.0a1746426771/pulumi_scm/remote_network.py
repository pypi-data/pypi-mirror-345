...
class RemoteNetworkArgs:
    def __init__(__self__, *,
                 ...
                 ecmp_load_balancing: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 spn_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] region: The Region param. String length must exceed 1 characters.
        :param pulumi.Input[builtins.str] ecmp_load_balancing: The EcmpLoadBalancing param. String must be one of these: `"enable"`, `"disable"`. Default: `"disable"`.
        ...
        :param pulumi.Input[builtins.str] folder: The Folder param. String can either be a specific string(`"Remote Networks"`) or match this regex: `^[\\s0-9a-zA-Z._-]{1,}$`. Default: `"Remote Networks"`.
        :param pulumi.Input[builtins.str] ipsec_tunnel: ipsec*tunnel is required when ecmp*load_balancing is disable.
        :param pulumi.Input[builtins.str] license_type: New customer will only be on aggregate bandwidth licensing. String length must exceed 1 characters. Default: `"FWAAS-AGGREGATE"`.
        :param pulumi.Input[builtins.str] name: Alphanumeric string begin with letter: [0-9a-zA-Z._-]. String length must not exceed 63 characters.
        :param pulumi.Input['RemoteNetworkProtocolArgs'] protocol: setup the protocol when ecmp*load*balancing is disable.
        :param pulumi.Input[builtins.str] secondary_ipsec_tunnel: specify secondary ipsec_tunnel if needed.
        :param pulumi.Input[builtins.str] spn_name: spn-name is needed when license_type is FWAAS-AGGREGATE.
    ...
    def ecmp_load_balancing(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ecmp_load_balancing(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def spn_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @spn_name.setter
    def spn_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RemoteNetwork(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            spn_name: Optional[pulumi.Input[builtins.str]] = None,
            subnets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tfid: Optional[pulumi.Input[builtins.str]] = None) -> 'RemoteNetwork':
        """
    ...
    @property
    @pulumi.getter(name="ecmpLoadBalancing")
    def ecmp_load_balancing(self) -> pulumi.Output[builtins.str]:
        """
        The EcmpLoadBalancing param. String must be one of these: `"enable"`, `"disable"`. Default: `"disable"`.
        """
        return pulumi.get(self, "ecmp_load_balancing")
    ...
    @property
    @pulumi.getter(name="ipsecTunnel")
    def ipsec_tunnel(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ipsec*tunnel is required when ecmp*load_balancing is disable.
        """
        return pulumi.get(self, "ipsec_tunnel")
    ...
    @property
    @pulumi.getter(name="spnName")
    def spn_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        spn-name is needed when license_type is FWAAS-AGGREGATE.
        """
        return pulumi.get(self, "spn_name")
