...
class ParticipantDashboardFinanceOverviewData(BaseModel):
    ...
    invoices: List[ParticipantDashboardFinanceOverviewInvoice]
    __properties: ClassVar[List[str]] = ["financeOverview", "invoices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoices": [ParticipantDashboardFinanceOverviewInvoice.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None
        })
        return _obj
