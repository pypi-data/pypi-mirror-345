...
from trialbench.utils import smiles_txt_to_lst, protocol2feature, icdcode_text_2_lst_of_lst, sentence2vec, read_from_huggingface, read_data_from_local
...
def mortality_rate(phase):
    ...
    X_train, y_train, X_test, y_test = read_data_from_local(target, phase)
