...
class GetCmAccountV1RespAssetsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["asset", "crossUnPnl", "crossWalletBalance", "initialMargin", "maintMargin", "openOrderInitialMargin", "positionInitialMargin", "updateTime"]
