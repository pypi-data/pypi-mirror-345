...
from empire_platform_api_public_client_legacy.models.organisation_user_batch import OrganisationUserBatch  # noqa: E501
    ...
    def make_instance(self, include_optional) -> OrganisationUserBatch:
        ...
        if include_optional:
            return OrganisationUserBatch(
                entries = [
                    empire_platform_api_public_client_legacy.models.organisation_user.OrganisationUser(
