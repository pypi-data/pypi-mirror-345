...
class CreateBrokerSubAccountApiCommissionFuturesV1Resp(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["makerAdjustment", "makerCommission", "subAccountId", "symbol", "takerAdjustment", "takerCommission"]
