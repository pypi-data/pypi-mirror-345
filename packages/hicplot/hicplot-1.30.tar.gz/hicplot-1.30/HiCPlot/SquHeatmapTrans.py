...
def main(argv=None): 
    ...
    parser.add_argument('--start1', type=int, default=10500000, help='Start position for region 1.')
    parser.add_argument('--end1', type=int, default=13200000, help='End position for region 1.')
    parser.add_argument('--chrid1', type=str, default='chr2', help='Chromosome ID for region 1.')
