...
class TestCommandRegistry:
    ...
    @pytest.mark.asyncio
    async def test_register_command_valid(self, registry):
        ...
        assert await registry.dispatcher.execute("valid", a=5, b=3) == 8
    ...
    def test_register_command_invalid_auto_fix(self, registry):
    ...
    @pytest.mark.asyncio
    async def test_params_command(self, registry):
        ...
        assert await registry.dispatcher.execute("params_command", params=test_params) == {"params": test_params}
...
""")
    ...
    @pytest.mark.asyncio
    async def test_register_all_commands(self, temp_module_dir):
        ...
        # Check that the command can be executed
        assert await registry.dispatcher.execute("test_command", a=5, b=3) == 8 