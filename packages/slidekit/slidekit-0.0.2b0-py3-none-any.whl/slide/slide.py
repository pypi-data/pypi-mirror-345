...
from slide.analysis.loader import AnalysisLoader
from slide.annotations.io import AnnotationsIO
from slide.input.io import InputIO
from slide.log import params, set_global_verbosity


class SLIDE(InputIO, AnnotationsIO, AnalysisLoader):
    """
    ...
    validating data formats, integrating external annotations, and enabling downstream
