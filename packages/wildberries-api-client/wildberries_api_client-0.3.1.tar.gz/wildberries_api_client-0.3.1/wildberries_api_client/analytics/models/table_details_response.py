...
class TableDetailsResponse(object):
    ...
    """
    swagger_types = {
        'products': 'list[TableProductItem]'
    }
    ...
    def __init__(self, products=None):  # noqa: E501
        """TableDetailsResponse - a model defined in Swagger"""  # noqa: E501
        self._products = None
    ...
    @property
    def products(self):
        """Gets the products of this TableDetailsResponse.  # noqa: E501

        Spisok tovarov v gruppe po filtru   # noqa: E501

        :return: The products of this TableDetailsResponse.  # noqa: E501
    ...
    def products(self, products):
        """Sets the products of this TableDetailsResponse.

        Spisok tovarov v gruppe po filtru   # noqa: E501

        :param products: The products of this TableDetailsResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TableDetailsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TableDetailsResponse):
            return False
