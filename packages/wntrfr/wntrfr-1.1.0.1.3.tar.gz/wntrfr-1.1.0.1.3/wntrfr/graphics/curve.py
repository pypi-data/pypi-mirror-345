"""
The wntrfr.graphics.curve module includes methods plot fragility curves and 
pump curves.
"""
import numpy as np
...
def plot_fragility_curve(FC, fill=True, key='Default',
    ...
    Parameters
    -----------
    FC : wntrfr.scenario.FragilityCurve object
        Fragility curve
    fill : bool, optional
...
def plot_pump_curve(pump, title='Pump curve', 
    ...
    Parameters
    -----------
    pump : wntrfr.network.elements.Pump object
        Pump
    title : string, optional
        Plot title
    xmin : float, optional
...
def plot_tank_volume_curve(tank, title='Tank volume curve', 
    ...
    Parameters
    -----------
    tank : wntrfr.network.elements.Tank object
        Tank 
    title : string, optional
        Plot title
    ax : matplotlib axes object, optional
