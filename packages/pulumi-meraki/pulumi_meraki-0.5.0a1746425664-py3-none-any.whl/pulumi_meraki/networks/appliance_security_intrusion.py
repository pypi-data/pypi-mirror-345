...
class ApplianceSecurityIntrusionArgs:
    def __init__(__self__, *,
                 ...
                 ids_rulesets: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] ids_rulesets: Intrusion detection ruleset
        :param pulumi.Input[builtins.str] mode: Intrusion detection mode
    ...
    def ids_rulesets(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ids_rulesets.setter
    def ids_rulesets(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ApplianceSecurityIntrusion(pulumi.CustomResource):
    ...
    pulumi_type = "meraki:networks/applianceSecurityIntrusion:ApplianceSecurityIntrusion"
    ...
    @property
    @pulumi.getter(name="idsRulesets")
    def ids_rulesets(self) -> pulumi.Output[builtins.str]:
        """
        Intrusion detection ruleset
        """
        return pulumi.get(self, "ids_rulesets")
