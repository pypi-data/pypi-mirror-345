...
class CreatePortfolioRedeemV1Resp(BaseModel):
    """
    CreatePortfolioRedeemV1Resp
    """ # noqa: E501
    from_asset: Optional[StrictStr] = Field(default=None, alias="fromAsset")
    from_asset_qty: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="fromAssetQty")
    rate: Optional[Union[StrictFloat, StrictInt]] = None
    target_asset: Optional[StrictStr] = Field(default=None, alias="targetAsset")
    target_asset_qty: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="targetAssetQty")
    __properties: ClassVar[List[str]] = ["fromAsset", "fromAssetQty", "rate", "targetAsset", "targetAssetQty"]
