...
class TestLegendrePolynomial(TestPolynomial, unittest.TestCase):
...
class TestJacobiPolynomial(TestPolynomial, unittest.TestCase):
...
class TestChebyshevFirstKindPolynomial(TestPolynomial, unittest.TestCase):
...
class TestChebyshevSecondKindPolynomial(TestPolynomial, unittest.TestCase):
...
class TestLaguerreAlpha0Polynomial(TestPolynomial, unittest.TestCase):
...
class TestLaguerreAlpha1Polynomial(TestPolynomial, unittest.TestCase):
...
class TestHermitePhysicistsPolynomial(TestPolynomial, unittest.TestCase):
...
class TestHermiteProbabilistsPolynomial(TestPolynomial, unittest.TestCase):
...
class TestFourierBasis(TestOrthogonalBasis, unittest.TestCase):
...
class TestHermitePhysicistsFunction(TestPolynomial, unittest.TestCase):
...
class TestHermiteProbabilistsFunction(TestPolynomial, unittest.TestCase):
...
class TestLaguerreAlpha0Function(TestPolynomial, unittest.TestCase):
...
class TestLaguerreAlpha1Function(TestPolynomial, unittest.TestCase):
...
class TestConstantExtendedHermiteProbabilistsFunction(TestBasis, unittest.TestCase):
    ...
    def get_basis(self):
        return S1D.ConstantExtendedHermiteProbabilistsFunction(30)

    def get_sampler(self):
        return stats.norm(loc=0, scale=1./np.sqrt(2.))

class TestHermiteProbabilistsRadialBasisFunction(TestBasis, unittest.TestCase):
    ...
    def get_basis(self):
        return S1D.HermiteProbabilistsRadialBasisFunction(30)

    def get_sampler(self):
        return stats.norm(loc=0, scale=1./np.sqrt(2.))

class TestConstantExtendedHermiteProbabilistsRadialBasisFunction(TestBasis, unittest.TestCase):
    ...
    def get_basis(self):
        return S1D.ConstantExtendedHermiteProbabilistsRadialBasisFunction(30)

    def get_sampler(self):
        return stats.norm(loc=0, scale=1./np.sqrt(2.))
        

class TestLinearExtendedHermiteProbabilistsRadialBasisFunction(TestBasis, unittest.TestCase):
    ...
    def get_basis(self):
        return S1D.LinearExtendedHermiteProbabilistsRadialBasisFunction(30)
...
def build_suite():
    ...
    # if ORTHPOL_SUPPORT:
    #     suites_list.append(suite_generic)
