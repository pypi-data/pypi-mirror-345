...
class GetCopyTradingFuturesUserStatusV1RespData(BaseModel):
    """
    GetCopyTradingFuturesUserStatusV1RespData
    """ # noqa: E501
    is_lead_trader: Optional[StrictBool] = Field(default=None, alias="isLeadTrader")
    time: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["isLeadTrader", "time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "isLeadTrader": obj.get("isLeadTrader"),
            "time": obj.get("time")
        })
        return _obj
