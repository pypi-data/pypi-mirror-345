...
class NmReportGetReportsResponse(object):
    ...
    """
    swagger_types = {
        'data': 'list[NmReportGetReportsResponseData]'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """NmReportGetReportsResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this NmReportGetReportsResponse.  # noqa: E501


        :return: The data of this NmReportGetReportsResponse.  # noqa: E501
        :rtype: list[NmReportGetReportsResponseData]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this NmReportGetReportsResponse.


        :param data: The data of this NmReportGetReportsResponse.  # noqa: E501
        :type: list[NmReportGetReportsResponseData]
        """
        if data is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NmReportGetReportsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NmReportGetReportsResponse):
            return False
