...
Refer to the Terraform Registry for docs: [`cloudflare_magic_wan_ipsec_tunnel`](https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel).
'''
...
class MagicWanIpsecTunnel(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel#account_id MagicWanIpsecTunnel#account_id}
        :param cloudflare_endpoint: The IP address assigned to the Cloudflare side of the IPsec tunnel. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel#cloudflare_endpoint MagicWanIpsecTunnel#cloudflare_endpoint}
        :param interface_address: A 31-bit prefix (/31 in CIDR notation) supporting two hosts, one for each side of the tunnel. Select the subnet from the following private IP space: 10.0.0.0–10.255.255.255, 172.16.0.0–172.31.255.255, 192.168.0.0–192.168.255.255. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel#interface_address MagicWanIpsecTunnel#interface_address}
        :param name: The name of the IPsec tunnel. The name cannot share a name with other tunnels. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel#name MagicWanIpsecTunnel#name}
        :param customer_endpoint: The IP address assigned to the customer side of the IPsec tunnel. Not required, but must be set for proactive traceroutes to work. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel#customer_endpoint MagicWanIpsecTunnel#customer_endpoint}
        :param description: An optional description forthe IPsec tunnel. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel#description MagicWanIpsecTunnel#description}
        :param health_check: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel#health_check MagicWanIpsecTunnel#health_check}.
        :param psk: A randomly generated or provided string for use in the IPsec tunnel. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel#psk MagicWanIpsecTunnel#psk}
        :param replay_protection: If ``true``, then IPsec replay protection will be supported in the Cloudflare-to-customer direction. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel#replay_protection MagicWanIpsecTunnel#replay_protection}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing MagicWanIpsecTunnel that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel#import import section} in the documentation of this resource for the id to use
    ...
    def put_health_check(
        ...
        *,
        ...
        :param enabled: Determines whether to run healthchecks for a tunnel. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel#enabled MagicWanIpsecTunnel#enabled}
        :param rate: How frequent the health check is run. The default value is ``mid``. Available values: "low", "mid", "high". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel#rate MagicWanIpsecTunnel#rate}
        :param target: The destination address in a request type health check. After the healthcheck is decapsulated at the customer end of the tunnel, the ICMP echo will be forwarded to this address. This field defaults to ``customer_gre_endpoint address``. This field is ignored for bidirectional healthchecks as the interface_address (not assigned to the Cloudflare side of the tunnel) is used as the target. Must be in object form if the x-magic-new-hc-target header is set to true and string form if x-magic-new-hc-target is absent or set to false. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel#target MagicWanIpsecTunnel#target}
        :param type: The type of healthcheck to run, reply or request. The default value is ``reply``. Available values: "reply", "request". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel#type MagicWanIpsecTunnel#type}
        '''
    ...
    def ipsec_tunnel(self) -> "MagicWanIpsecTunnelIpsecTunnelOutputReference":
        return typing.cast("MagicWanIpsecTunnelIpsecTunnelOutputReference", jsii.get(self, "ipsecTunnel"))

    @builtins.property
    @jsii.member(jsii_name="modified")
    def modified(self) -> _cdktf_9a9027ec.IResolvable:
        return typing.cast(_cdktf_9a9027ec.IResolvable, jsii.get(self, "modified"))

    @builtins.property
    @jsii.member(jsii_name="modifiedIpsecTunnel")
    def modified_ipsec_tunnel(
        self,
    ) -> "MagicWanIpsecTunnelModifiedIpsecTunnelOutputReference":
        return typing.cast("MagicWanIpsecTunnelModifiedIpsecTunnelOutputReference", jsii.get(self, "modifiedIpsecTunnel"))
...
class MagicWanIpsecTunnelHealthCheckOutputReference(
    ...
    def put_target(self, *, saved: typing.Optional[builtins.str] = None) -> None:
        '''
        :param saved: The saved health check target. Setting the value to the empty string indicates that the calculated default value will be used. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_ipsec_tunnel#saved MagicWanIpsecTunnel#saved}
        '''
...
@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelIpsecTunnel",
    jsii_struct_bases=[],
    name_mapping={},
)
class MagicWanIpsecTunnelIpsecTunnel:
    ...
    def __repr__(self) -> str:
        return "MagicWanIpsecTunnelIpsecTunnel(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelIpsecTunnelHealthCheck",
    jsii_struct_bases=[],
    name_mapping={},
)
class MagicWanIpsecTunnelIpsecTunnelHealthCheck:
    def __init__(self) -> None:
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "MagicWanIpsecTunnelIpsecTunnelHealthCheck(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class MagicWanIpsecTunnelIpsecTunnelHealthCheckOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelIpsecTunnelHealthCheckOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__902121a6d0c3361c0fbb1b788d693354eb9cf229853b83491753323cbb604d48)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def target(
        self,
    ) -> "MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetOutputReference":
        return typing.cast("MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetOutputReference", jsii.get(self, "target"))
    ...
    def internal_value(
        self,
    ) -> typing.Optional[MagicWanIpsecTunnelIpsecTunnelHealthCheck]:
        return typing.cast(typing.Optional[MagicWanIpsecTunnelIpsecTunnelHealthCheck], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[MagicWanIpsecTunnelIpsecTunnelHealthCheck],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3baec4216e2eab78858430af3fc3b30f1dd4ca983cddf70120155d9cb89d79c7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value) # pyright: ignore[reportArgumentType]


@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelIpsecTunnelHealthCheckTarget",
    jsii_struct_bases=[],
    name_mapping={},
)
class MagicWanIpsecTunnelIpsecTunnelHealthCheckTarget:
    def __init__(self) -> None:
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "MagicWanIpsecTunnelIpsecTunnelHealthCheckTarget(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5766e673f2beb0a441ad9b4fd30ef732d63a4c91208ada17147440b715f8e6ae)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def internal_value(
        self,
    ) -> typing.Optional[MagicWanIpsecTunnelIpsecTunnelHealthCheckTarget]:
        return typing.cast(typing.Optional[MagicWanIpsecTunnelIpsecTunnelHealthCheckTarget], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[MagicWanIpsecTunnelIpsecTunnelHealthCheckTarget],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e46e397859ee476a9d4d98551be6da57ff3f1dfb70d6835fd1fa4c9d394a45ef)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value) # pyright: ignore[reportArgumentType]


class MagicWanIpsecTunnelIpsecTunnelOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelIpsecTunnelOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__647227805ebaca93ceac04505ce26df598f84f8dcf319a8dd53ee317d3fd6700)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    @builtins.property
    @jsii.member(jsii_name="healthCheck")
    def health_check(self) -> MagicWanIpsecTunnelIpsecTunnelHealthCheckOutputReference:
        return typing.cast(MagicWanIpsecTunnelIpsecTunnelHealthCheckOutputReference, jsii.get(self, "healthCheck"))
    ...
    def psk_metadata(
        self,
    ) -> "MagicWanIpsecTunnelIpsecTunnelPskMetadataOutputReference":
        return typing.cast("MagicWanIpsecTunnelIpsecTunnelPskMetadataOutputReference", jsii.get(self, "pskMetadata"))
    ...
    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(self) -> typing.Optional[MagicWanIpsecTunnelIpsecTunnel]:
        return typing.cast(typing.Optional[MagicWanIpsecTunnelIpsecTunnel], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[MagicWanIpsecTunnelIpsecTunnel],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bc2bab9122fd4ff39e719769fceab14257bc8db76e37852ecf9945cc496e02f3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value) # pyright: ignore[reportArgumentType]


@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelIpsecTunnelPskMetadata",
    jsii_struct_bases=[],
    name_mapping={},
)
class MagicWanIpsecTunnelIpsecTunnelPskMetadata:
    def __init__(self) -> None:
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "MagicWanIpsecTunnelIpsecTunnelPskMetadata(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class MagicWanIpsecTunnelIpsecTunnelPskMetadataOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelIpsecTunnelPskMetadataOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__33db804d285366b9f8cb1d4cd558201fdba6fcd392aff302946d2295dfda0365)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def internal_value(
        self,
    ) -> typing.Optional[MagicWanIpsecTunnelIpsecTunnelPskMetadata]:
        return typing.cast(typing.Optional[MagicWanIpsecTunnelIpsecTunnelPskMetadata], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[MagicWanIpsecTunnelIpsecTunnelPskMetadata],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c9171f7465c18573f85d186e879a2556289f2aa1f89b9cf9431f42efbcff16fe)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value) # pyright: ignore[reportArgumentType]


@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelModifiedIpsecTunnel",
    jsii_struct_bases=[],
    name_mapping={},
)
class MagicWanIpsecTunnelModifiedIpsecTunnel:
    def __init__(self) -> None:
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "MagicWanIpsecTunnelModifiedIpsecTunnel(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheck",
    jsii_struct_bases=[],
    name_mapping={},
)
class MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheck:
    def __init__(self) -> None:
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheck(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a4608182080ba138bf8db9050adbf9d09767a28567f5bb4a2ed6128236e043cc)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def target(
        ...
        return typing.cast("MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetOutputReference", jsii.get(self, "target"))
    ...
    def internal_value(
        self,
    ) -> typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheck]:
        return typing.cast(typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheck], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheck],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__aa39795637882189d3ad08c9f4d6321c9bc911a5da5c0efae24af8f73f4d3cca)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value) # pyright: ignore[reportArgumentType]


@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTarget",
    jsii_struct_bases=[],
    name_mapping={},
)
class MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTarget:
    def __init__(self) -> None:
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTarget(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTargetOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b060a64abe959df1ac64d464c78360c8884866da2c6abc20d122f2c8effc2f57)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def internal_value(
        self,
    ) -> typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTarget]:
        return typing.cast(typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTarget], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTarget],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f7d4b92dae843364ae350f2afeae5ef031669759f4383827a3b017ccea7176ca)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value) # pyright: ignore[reportArgumentType]


class MagicWanIpsecTunnelModifiedIpsecTunnelOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelModifiedIpsecTunnelOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e54ae6f2ae389b6bf4345d9daab99fe0291e9ea7fe290c2afade6cabab1b9c5e)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def health_check(
        self,
    ) -> MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckOutputReference:
        return typing.cast(MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckOutputReference, jsii.get(self, "healthCheck"))
    ...
    def psk_metadata(
        self,
    ) -> "MagicWanIpsecTunnelModifiedIpsecTunnelPskMetadataOutputReference":
        return typing.cast("MagicWanIpsecTunnelModifiedIpsecTunnelPskMetadataOutputReference", jsii.get(self, "pskMetadata"))
    ...
    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(self) -> typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnel]:
        return typing.cast(typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnel], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnel],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9c12c0411a2897a9e21661c45b06728fb349bad7deb24a2bc48ece64ebaa09ed)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value) # pyright: ignore[reportArgumentType]


@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelModifiedIpsecTunnelPskMetadata",
    jsii_struct_bases=[],
    name_mapping={},
)
class MagicWanIpsecTunnelModifiedIpsecTunnelPskMetadata:
    def __init__(self) -> None:
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "MagicWanIpsecTunnelModifiedIpsecTunnelPskMetadata(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class MagicWanIpsecTunnelModifiedIpsecTunnelPskMetadataOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-cloudflare.magicWanIpsecTunnel.MagicWanIpsecTunnelModifiedIpsecTunnelPskMetadataOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e224379f2b8ec13e3371124e23808a7a965192631cbd4306fee946de7cb05615)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def internal_value(
        self,
    ) -> typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnelPskMetadata]:
        return typing.cast(typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnelPskMetadata], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnelPskMetadata],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__40541e62dec0ff14ac0b21377e3279b261eb7d5a3ba2e55e9271d8f99365b4f7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value) # pyright: ignore[reportArgumentType]
...
__all__ = [
    ...
    "MagicWanIpsecTunnelIpsecTunnelHealthCheckTargetOutputReference",
    "MagicWanIpsecTunnelIpsecTunnelOutputReference",
...
def _typecheckingstub__902121a6d0c3361c0fbb1b788d693354eb9cf229853b83491753323cbb604d48(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__3baec4216e2eab78858430af3fc3b30f1dd4ca983cddf70120155d9cb89d79c7(
    value: typing.Optional[MagicWanIpsecTunnelIpsecTunnelHealthCheck],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5766e673f2beb0a441ad9b4fd30ef732d63a4c91208ada17147440b715f8e6ae(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__e46e397859ee476a9d4d98551be6da57ff3f1dfb70d6835fd1fa4c9d394a45ef(
    value: typing.Optional[MagicWanIpsecTunnelIpsecTunnelHealthCheckTarget],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__647227805ebaca93ceac04505ce26df598f84f8dcf319a8dd53ee317d3fd6700(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__bc2bab9122fd4ff39e719769fceab14257bc8db76e37852ecf9945cc496e02f3(
    value: typing.Optional[MagicWanIpsecTunnelIpsecTunnel],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__33db804d285366b9f8cb1d4cd558201fdba6fcd392aff302946d2295dfda0365(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__c9171f7465c18573f85d186e879a2556289f2aa1f89b9cf9431f42efbcff16fe(
    value: typing.Optional[MagicWanIpsecTunnelIpsecTunnelPskMetadata],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a4608182080ba138bf8db9050adbf9d09767a28567f5bb4a2ed6128236e043cc(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__aa39795637882189d3ad08c9f4d6321c9bc911a5da5c0efae24af8f73f4d3cca(
    value: typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheck],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__b060a64abe959df1ac64d464c78360c8884866da2c6abc20d122f2c8effc2f57(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__f7d4b92dae843364ae350f2afeae5ef031669759f4383827a3b017ccea7176ca(
    value: typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnelHealthCheckTarget],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e54ae6f2ae389b6bf4345d9daab99fe0291e9ea7fe290c2afade6cabab1b9c5e(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__9c12c0411a2897a9e21661c45b06728fb349bad7deb24a2bc48ece64ebaa09ed(
    value: typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnel],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e224379f2b8ec13e3371124e23808a7a965192631cbd4306fee946de7cb05615(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__40541e62dec0ff14ac0b21377e3279b261eb7d5a3ba2e55e9271d8f99365b4f7(
    value: typing.Optional[MagicWanIpsecTunnelModifiedIpsecTunnelPskMetadata],
) -> None:
    """Type checking stubs"""
    pass
