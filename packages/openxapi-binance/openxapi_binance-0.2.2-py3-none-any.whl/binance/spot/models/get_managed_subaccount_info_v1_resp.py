...
class GetManagedSubaccountInfoV1Resp(BaseModel):
    """
    GetManagedSubaccountInfoV1Resp
    """ # noqa: E501
    manager_sub_user_info_vo_list: Optional[List[GetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner]] = Field(default=None, alias="managerSubUserInfoVoList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "managerSubUserInfoVoList": [GetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner.from_dict(_item) for _item in obj["managerSubUserInfoVoList"]] if obj.get("managerSubUserInfoVoList") is not None else None,
            "total": obj.get("total")
        })
        return _obj
