...
class SwitchPortSchedulesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name for your port schedule. Required
        ...
        :param pulumi.Input[builtins.str] port_schedule_id: portScheduleId path parameter. Port schedule ID
        """
...
class SwitchPortSchedules(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_id: Optional[pulumi.Input[builtins.str]] = None,
            port_schedule: Optional[pulumi.Input[Union['SwitchPortSchedulesPortScheduleArgs', 'SwitchPortSchedulesPortScheduleArgsDict']]] = None,
            port_schedule_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SwitchPortSchedules':
        """
