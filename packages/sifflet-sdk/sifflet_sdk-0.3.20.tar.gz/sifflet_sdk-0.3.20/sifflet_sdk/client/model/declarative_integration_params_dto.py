...
def lazy_import():
    from sifflet_sdk.client.model.declarative_integration_params_dto_all_of import (
        DeclarativeIntegrationParamsDtoAllOf,
    )
    ...
    globals()["DeclarativeIntegrationParamsDtoAllOf"] = DeclarativeIntegrationParamsDtoAllOf
    globals()["IntegrationParamsDto"] = IntegrationParamsDto
    globals()["TimeZoneDto"] = TimeZoneDto


class DeclarativeIntegrationParamsDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DeclarativeIntegrationParamsDto - a model defined in OpenAPI

        Keyword Args:
            asset_name_separator (str):
            authority (str):
