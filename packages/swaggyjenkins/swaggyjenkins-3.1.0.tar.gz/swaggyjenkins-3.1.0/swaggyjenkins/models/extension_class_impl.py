...
class ExtensionClassImpl(BaseModel):
    ...
    links: Optional[ExtensionClassImpllinks] = Field(default=None, alias="_links")
    classes: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["_class", "_links", "classes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": ExtensionClassImpllinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
