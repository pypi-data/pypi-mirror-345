...
def lazy_import():
    ...
    globals()["GetCustomMetadataEntry200Response"] = GetCustomMetadataEntry200Response


class SearchCollectionGetCustomMetadataEntryValueResponseDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([GetCustomMetadataEntry200Response],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SearchCollectionGetCustomMetadataEntryValueResponseDto - a model defined in OpenAPI

        Args:
            data ([GetCustomMetadataEntry200Response]):
