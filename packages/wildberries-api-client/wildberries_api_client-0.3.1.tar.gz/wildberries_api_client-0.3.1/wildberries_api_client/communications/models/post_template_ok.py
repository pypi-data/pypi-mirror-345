...
class PostTemplateOK(object):
    ...
    def __init__(self, data=None, error=None, error_text=None, additional_errors=None):  # noqa: E501
        """PostTemplateOK - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._error = None
    ...
    @property
    def data(self):
        """Gets the data of this PostTemplateOK.  # noqa: E501


        :return: The data of this PostTemplateOK.  # noqa: E501
        :rtype: PostTemplateOKData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this PostTemplateOK.


        :param data: The data of this PostTemplateOK.  # noqa: E501
        :type: PostTemplateOKData
        """
    ...
    @property
    def error(self):
        """Gets the error of this PostTemplateOK.  # noqa: E501

        Est li ohibka  # noqa: E501

        :return: The error of this PostTemplateOK.  # noqa: E501
        :rtype: bool
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this PostTemplateOK.

        Est li ohibka  # noqa: E501

        :param error: The error of this PostTemplateOK.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def error_text(self):
        """Gets the error_text of this PostTemplateOK.  # noqa: E501

        Opisanie ohibki  # noqa: E501

        :return: The error_text of this PostTemplateOK.  # noqa: E501
        :rtype: str
        """
    ...
    def error_text(self, error_text):
        """Sets the error_text of this PostTemplateOK.

        Opisanie ohibki  # noqa: E501

        :param error_text: The error_text of this PostTemplateOK.  # noqa: E501
        :type: str
        """
    ...
    def additional_errors(self):
        """Gets the additional_errors of this PostTemplateOK.  # noqa: E501

        Dopolnitelnye ohibki  # noqa: E501

        :return: The additional_errors of this PostTemplateOK.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def additional_errors(self, additional_errors):
        """Sets the additional_errors of this PostTemplateOK.

        Dopolnitelnye ohibki  # noqa: E501

        :param additional_errors: The additional_errors of this PostTemplateOK.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PostTemplateOK, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PostTemplateOK):
            return False
