...
class UmfuturesGetLeverageBracketV1RespItem(BaseModel):
    """
    UmfuturesGetLeverageBracketV1RespItem
    """ # noqa: E501
    brackets: Optional[List[UmfuturesGetLeverageBracketV1RespItemBracketsInner]] = None
    notional_coef: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="notionalCoef")
    symbol: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["brackets", "notionalCoef", "symbol"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "brackets": [UmfuturesGetLeverageBracketV1RespItemBracketsInner.from_dict(_item) for _item in obj["brackets"]] if obj.get("brackets") is not None else None,
