...
class GetUmPositionRiskV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["entryPrice", "leverage", "liquidationPrice", "markPrice", "maxNotionalValue", "notional", "positionAmt", "positionSide", "symbol", "unRealizedProfit", "updateTime"]
