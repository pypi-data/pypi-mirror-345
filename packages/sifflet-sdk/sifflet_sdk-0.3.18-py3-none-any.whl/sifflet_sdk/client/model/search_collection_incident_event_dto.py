...
def lazy_import():
    from sifflet_sdk.client.model.search_collection_incident_event_dto_data_inner import (
        SearchCollectionIncidentEventDtoDataInner,
    )

    globals()["SearchCollectionIncidentEventDtoDataInner"] = SearchCollectionIncidentEventDtoDataInner


class SearchCollectionIncidentEventDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([SearchCollectionIncidentEventDtoDataInner],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SearchCollectionIncidentEventDto - a model defined in OpenAPI

        Args:
            data ([SearchCollectionIncidentEventDtoDataInner]):
