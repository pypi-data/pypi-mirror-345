...
class Deformation(object):
    ...
    def forward_mapping(self):
        ...
        assert self._forward_mapping is not None, (
            "You're using an abstract deformation class (but must be forward or backward)"
        )
...
# Note. This HAS to follow the order: _deformgrid, _deformfield, _subs. Otherwise the circular import comes back.
