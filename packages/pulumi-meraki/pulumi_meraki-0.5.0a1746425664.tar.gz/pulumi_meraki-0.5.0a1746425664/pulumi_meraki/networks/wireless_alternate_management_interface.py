...
class WirelessAlternateManagementInterfaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: Boolean value to enable or disable alternate management interface
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] protocols: Can be one or more of the following values: 'radius', 'snmp', 'syslog' or 'ldap'
        :param pulumi.Input[builtins.int] vlan_id: Alternate management interface VLAN, must be between 1 and 4094
        """
...
class WirelessAlternateManagementInterface(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_id: Optional[pulumi.Input[builtins.str]] = None,
            protocols: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            vlan_id: Optional[pulumi.Input[builtins.int]] = None) -> 'WirelessAlternateManagementInterface':
        """
