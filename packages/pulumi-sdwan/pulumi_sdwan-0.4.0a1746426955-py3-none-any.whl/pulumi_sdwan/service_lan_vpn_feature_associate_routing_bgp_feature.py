...
__all__ = ['ServiceLanVpnFeatureAssociateRoutingBgpFeatureArgs', 'ServiceLanVpnFeatureAssociateRoutingBgpFeature']

@pulumi.input_type
class ServiceLanVpnFeatureAssociateRoutingBgpFeatureArgs:
    def __init__(__self__, *,
                 feature_profile_id: pulumi.Input[builtins.str],
                 service_lan_vpn_feature_id: pulumi.Input[builtins.str],
                 service_routing_bgp_feature_id: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] service_routing_bgp_feature_id: Service Routing BGP Feature ID
        """
    ...
    def service_routing_bgp_feature_id(self) -> pulumi.Input[builtins.str]:
        """
        Service Routing BGP Feature ID
        """
        return pulumi.get(self, "service_routing_bgp_feature_id")

    @service_routing_bgp_feature_id.setter
    def service_routing_bgp_feature_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "service_routing_bgp_feature_id", value)


@pulumi.input_type
class _ServiceLanVpnFeatureAssociateRoutingBgpFeatureState:
    def __init__(__self__, *,
                 feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
                 service_lan_vpn_feature_id: Optional[pulumi.Input[builtins.str]] = None,
                 service_routing_bgp_feature_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="serviceRoutingBgpFeatureId")
    def service_routing_bgp_feature_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Service Routing BGP Feature ID
        """
        return pulumi.get(self, "service_routing_bgp_feature_id")
    ...
    @service_routing_bgp_feature_id.setter
    def service_routing_bgp_feature_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_routing_bgp_feature_id", value)
...
class ServiceLanVpnFeatureAssociateRoutingBgpFeature(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ServiceLanVpnFeatureAssociateRoutingBgpFeatureArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource can manage a Service LAN VPN Feature Associate Routing BGP Feature .
          - Minimum SD-WAN Manager version: `20.12.0`
        ...
        :param str resource_name: The name of the resource.
        :param ServiceLanVpnFeatureAssociateRoutingBgpFeatureArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServiceLanVpnFeatureAssociateRoutingBgpFeatureArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServiceLanVpnFeatureAssociateRoutingBgpFeatureArgs.__new__(ServiceLanVpnFeatureAssociateRoutingBgpFeatureArgs)
    ...
    def get(resource_name: str,
            ...
            service_lan_vpn_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            service_routing_bgp_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'ServiceLanVpnFeatureAssociateRoutingBgpFeature':
        """
        ...
        __props__ = _ServiceLanVpnFeatureAssociateRoutingBgpFeatureState.__new__(_ServiceLanVpnFeatureAssociateRoutingBgpFeatureState)
    ...
    @property
    @pulumi.getter(name="serviceRoutingBgpFeatureId")
    def service_routing_bgp_feature_id(self) -> pulumi.Output[builtins.str]:
        """
        Service Routing BGP Feature ID
        """
        return pulumi.get(self, "service_routing_bgp_feature_id")
