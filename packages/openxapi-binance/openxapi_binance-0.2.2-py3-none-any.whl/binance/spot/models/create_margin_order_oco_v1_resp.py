...
class CreateMarginOrderOcoV1Resp(BaseModel):
    """
    ...
    margin_buy_borrow_amount: Optional[StrictStr] = Field(default=None, alias="marginBuyBorrowAmount")
    margin_buy_borrow_asset: Optional[StrictStr] = Field(default=None, alias="marginBuyBorrowAsset")
    order_list_id: Optional[StrictInt] = Field(default=None, alias="orderListId")
    order_reports: Optional[List[CreateMarginOrderOcoV1RespOrderReportsInner]] = Field(default=None, alias="orderReports")
    ...
    __properties: ClassVar[List[str]] = ["contingencyType", "isIsolated", "listClientOrderId", "listOrderStatus", "listStatusType", "marginBuyBorrowAmount", "marginBuyBorrowAsset", "orderListId", "orderReports", "orders", "symbol", "transactionTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderReports": [CreateMarginOrderOcoV1RespOrderReportsInner.from_dict(_item) for _item in obj["orderReports"]] if obj.get("orderReports") is not None else None,
