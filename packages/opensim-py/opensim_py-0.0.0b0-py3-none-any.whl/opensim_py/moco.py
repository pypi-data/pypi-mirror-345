...
class MocoGoal(opensim.common.OpenSimObject):
    ...
    def setEndpointConstraintBounds(self, bounds):
        r"""
        ...
        This info is ignored if getSupportsEndpointConstraint() is false.
        """
        return _moco.MocoGoal_setEndpointConstraintBounds(self, bounds)

    def getEndpointConstraintBounds(self):
        r"""
        Get the vector of the endpoint constraint bounds for this MocoGoal.
        Note: the return value is constructed fresh on every call from
        the internal property. Avoid repeated calls to this function.
        """
        return _moco.MocoGoal_getEndpointConstraintBounds(self)
    ...
    def setDivideByDisplacement(self, tf):
        ...
        Notes: Increases the stage dependency of this goal to
        SimTK::Stage::Position, if it is not already equal or higher.
        """
        return _moco.MocoGoal_setDivideByDisplacement(self, tf)

    def getDivideByDisplacement(self):
        return _moco.MocoGoal_getDivideByDisplacement(self)

    def setDivideByDuration(self, tf):
        r"""
        Set if the goal should be divided by the phase duration.
        Notes: Increases the stage dependency of this goal to
        SimTK::Stage::Topology, if it is not already equal or higher
        """
        return _moco.MocoGoal_setDivideByDuration(self, tf)

    def getDivideByDuration(self):
        return _moco.MocoGoal_getDivideByDuration(self)
    ...
    def setDivideByMass(self, tf):
        ...
        """
        return _moco.MocoGoal_setDivideByMass(self, tf)

    def getDivideByMass(self):
        return _moco.MocoGoal_getDivideByMass(self)
...
class MocoStateTrackingGoal(MocoGoal):
    ...
    def addScaleFactor(self, name, state, bounds):
        r"""
...
class MocoMarkerTrackingGoal(MocoGoal):
    ...
    def addScaleFactor(self, name, marker, index, bounds):
        r"""
        Add a MocoParameter to the problem that will scale the tracking reference
...
class MocoControlTrackingGoal(MocoGoal):
    ...
    def addScaleFactor(self, name, control, bounds):
        r"""
        Add a MocoParameter to the problem that will scale the tracking reference
...
class MocoContactTrackingGoal(MocoGoal):
    ...
    def addScaleFactor(self, name, externalForceName, index, bounds):
        r"""
        Add a MocoParameter to the problem that will scale the tracking reference
        data associated with a contact force group. Scale factors are applied
        to the tracking error calculations based on the following equation:
    ...
    def setNormalizeTrackingError(self, tf):
        r"""
        ...
        """
        return _moco.MocoContactTrackingGoal_setNormalizeTrackingError(self, tf)

    def getNormalizeTrackingError(self):
        return _moco.MocoContactTrackingGoal_getNormalizeTrackingError(self)
...
class MocoContactImpulseTrackingGoalGroup(opensim.common.OpenSimObject):
    r"""
    ...
    other* body (e.g., the toes) under alternative_frame_paths. Without
        ...
        (the force on the sphere or the force on the half-space) when summing the
        contact forces across contact force elements.
        See also: MocoContactImpulseTrackingGoal
    """
    ...
    @staticmethod
    def safeDownCast(obj):
        return _moco.MocoContactImpulseTrackingGoalGroup_safeDownCast(obj)

    def assign(self, aObject):
        return _moco.MocoContactImpulseTrackingGoalGroup_assign(self, aObject)

    @staticmethod
    def getClassName():
        return _moco.MocoContactImpulseTrackingGoalGroup_getClassName()

    def clone(self):
        return _moco.MocoContactImpulseTrackingGoalGroup_clone(self)

    def getConcreteClassName(self):
        return _moco.MocoContactImpulseTrackingGoalGroup_getConcreteClassName(self)

    def copyProperty_contact_force_paths(self, source):
        return _moco.MocoContactImpulseTrackingGoalGroup_copyProperty_contact_force_paths(self, source)

    def get_contact_force_paths(self, i):
        return _moco.MocoContactImpulseTrackingGoalGroup_get_contact_force_paths(self, i)

    def upd_contact_force_paths(self, i):
        return _moco.MocoContactImpulseTrackingGoalGroup_upd_contact_force_paths(self, i)

    def set_contact_force_paths(self, i, value):
        return _moco.MocoContactImpulseTrackingGoalGroup_set_contact_force_paths(self, i, value)

    def append_contact_force_paths(self, value):
        return _moco.MocoContactImpulseTrackingGoalGroup_append_contact_force_paths(self, value)

    def constructProperty_contact_force_paths(self):
        return _moco.MocoContactImpulseTrackingGoalGroup_constructProperty_contact_force_paths(self)

    def copyProperty_external_force_name(self, source):
        return _moco.MocoContactImpulseTrackingGoalGroup_copyProperty_external_force_name(self, source)

    def append_external_force_name(self, value):
        return _moco.MocoContactImpulseTrackingGoalGroup_append_external_force_name(self, value)

    def constructProperty_external_force_name(self, initValue):
        return _moco.MocoContactImpulseTrackingGoalGroup_constructProperty_external_force_name(self, initValue)

    def get_external_force_name(self, *args):
        return _moco.MocoContactImpulseTrackingGoalGroup_get_external_force_name(self, *args)

    def upd_external_force_name(self, *args):
        return _moco.MocoContactImpulseTrackingGoalGroup_upd_external_force_name(self, *args)

    def set_external_force_name(self, *args):
        return _moco.MocoContactImpulseTrackingGoalGroup_set_external_force_name(self, *args)

    def copyProperty_alternative_frame_paths(self, source):
        return _moco.MocoContactImpulseTrackingGoalGroup_copyProperty_alternative_frame_paths(self, source)

    def get_alternative_frame_paths(self, i):
        return _moco.MocoContactImpulseTrackingGoalGroup_get_alternative_frame_paths(self, i)

    def upd_alternative_frame_paths(self, i):
        return _moco.MocoContactImpulseTrackingGoalGroup_upd_alternative_frame_paths(self, i)

    def set_alternative_frame_paths(self, i, value):
        return _moco.MocoContactImpulseTrackingGoalGroup_set_alternative_frame_paths(self, i, value)

    def append_alternative_frame_paths(self, value):
        return _moco.MocoContactImpulseTrackingGoalGroup_append_alternative_frame_paths(self, value)

    def constructProperty_alternative_frame_paths(self):
        return _moco.MocoContactImpulseTrackingGoalGroup_constructProperty_alternative_frame_paths(self)

    def __init__(self, *args):
        _moco.MocoContactImpulseTrackingGoalGroup_swiginit(self, _moco.new_MocoContactImpulseTrackingGoalGroup(*args))
    __swig_destroy__ = _moco.delete_MocoContactImpulseTrackingGoalGroup

# Register MocoContactImpulseTrackingGoalGroup in _moco:
_moco.MocoContactImpulseTrackingGoalGroup_swigregister(MocoContactImpulseTrackingGoalGroup)
class MocoContactImpulseTrackingGoal(MocoGoal):
    r"""
    ...
    - :math:`mg`: the total weight of the system; replaced with
        :math:`m` if :math:`g = 0`.
    - :math:`a`: the impulse axis to be tracked.
    ...
    @staticmethod
    def safeDownCast(obj):
        return _moco.MocoContactImpulseTrackingGoal_safeDownCast(obj)

    def assign(self, aObject):
        return _moco.MocoContactImpulseTrackingGoal_assign(self, aObject)

    @staticmethod
    def getClassName():
        return _moco.MocoContactImpulseTrackingGoal_getClassName()

    def clone(self):
        return _moco.MocoContactImpulseTrackingGoal_clone(self)

    def getConcreteClassName(self):
        return _moco.MocoContactImpulseTrackingGoal_getConcreteClassName(self)

    def __init__(self, *args):
        _moco.MocoContactImpulseTrackingGoal_swiginit(self, _moco.new_MocoContactImpulseTrackingGoal(*args))
    ...
    def setExternalLoadsFile(self, extLoadsFile):
        ...
        provided as an object, if one exists.
        """
        return _moco.MocoContactImpulseTrackingGoal_setExternalLoadsFile(self, extLoadsFile)
    ...
    def setExternalLoads(self, extLoads):
        ...
        XML file, if provided.
        """
        return _moco.MocoContactImpulseTrackingGoal_setExternalLoads(self, extLoads)
    ...
    def addContactGroup(self, *args):
        ...
        *Overload 2:*
        ...
        """
        return _moco.MocoContactImpulseTrackingGoal_addContactGroup(self, *args)

    def setImpulseAxis(self, impulseAxis):
        r"""
        ...
        tracked.
        """
        return _moco.MocoContactImpulseTrackingGoal_setImpulseAxis(self, impulseAxis)

    def getImpulseAxis(self):
        return _moco.MocoContactImpulseTrackingGoal_getImpulseAxis(self)

    def addScaleFactor(self, name, externalForceName, bounds):
        r"""
        Add a MocoParameter to the problem that will scale the tracking reference
        data associated with a contact force group. Scale factors are applied
        to the tracking error calculations based on the following equation:
        ...
        ExternalLoads in each contact group.
        """
        return _moco.MocoContactImpulseTrackingGoal_addScaleFactor(self, name, externalForceName, bounds)
    __swig_destroy__ = _moco.delete_MocoContactImpulseTrackingGoal

# Register MocoContactImpulseTrackingGoal in _moco:
_moco.MocoContactImpulseTrackingGoal_swigregister(MocoContactImpulseTrackingGoal)
...
class MocoOrientationTrackingGoal(MocoGoal):
    ...
    def setRotationReference(self, *args):
        r"""
        *Overload 1:*
...
class MocoAngularVelocityTrackingGoal(MocoGoal):
    ...
    def setAngularVelocityReferenceFile(self, filepath):
        r"""
    ...
    def setAngularVelocityReference(self, ref):
        r"""
        Each column label must be the path of a valid frame path (see
    ...
    def getAngularVelocityReferenceFile(self):
        r"""
...
class MocoOutputExtremumGoal(MocoOutputBase):
    r"""
    ...
    - :math:`d`: displacement of the system, if `divide_by_displacement` is
      true; 1 otherwise.
    - :math:`m`: mass of the system, if `divide_by_mass` is
      true; 1 otherwise.
    - :math:`v`: the output variable of choice.
    - :math:`w_v`: the weight for output variable :math:`v`.
    - :math:`\beta`: the approximate extremum to be taken (:math:`\beta` == -1 for
      minimum; :math:`\beta` == 1 for maximum).
    - :math:`s`: the smoothing factor for approximating the extremum. With
      :math:`s` == 1 the approximation is closer to the true extremum taken.
      For :math:`v` with potentially large magnitudes (> 2000) during a simulation
    ...
    @staticmethod
    def safeDownCast(obj):
        return _moco.MocoOutputExtremumGoal_safeDownCast(obj)

    def assign(self, aObject):
        return _moco.MocoOutputExtremumGoal_assign(self, aObject)

    @staticmethod
    def getClassName():
        return _moco.MocoOutputExtremumGoal_getClassName()

    def clone(self):
        return _moco.MocoOutputExtremumGoal_clone(self)

    def getConcreteClassName(self):
        return _moco.MocoOutputExtremumGoal_getConcreteClassName(self)

    def __init__(self, *args):
        _moco.MocoOutputExtremumGoal_swiginit(self, _moco.new_MocoOutputExtremumGoal(*args))

    def setExtremumType(self, extremum_type):
        r"""
        Set the type of extremum ('minimum' or 'maximum') to be applied to the
           output variable of choice.
        """
        return _moco.MocoOutputExtremumGoal_setExtremumType(self, extremum_type)

    def getExtremumType(self):
        return _moco.MocoOutputExtremumGoal_getExtremumType(self)

    def setSmoothingFactor(self, smoothing_factor):
        r"""
        ...
        """
        return _moco.MocoOutputExtremumGoal_setSmoothingFactor(self, smoothing_factor)

    def getSmoothingFactor(self):
        return _moco.MocoOutputExtremumGoal_getSmoothingFactor(self)
    __swig_destroy__ = _moco.delete_MocoOutputExtremumGoal

# Register MocoOutputExtremumGoal in _moco:
_moco.MocoOutputExtremumGoal_swigregister(MocoOutputExtremumGoal)
...
class MocoOutputTrackingGoal(MocoOutputBase):
    ...
    def setTrackingFunction(self, f):
...
class MocoStepTimeAsymmetryGoal(MocoGoal):
    ...
    def setLeftContactGroup(self, contactForcePaths, footPositionForcePath):
        r"""
    ...
    def setRightContactGroup(self, contactForcePaths, footPositionForcePath):
        r"""
    ...
    def setTargetAsymmetry(self, asymmetry):
        r"""
    ...
    def getTargetAsymmetry(self):
        return _moco.MocoStepTimeAsymmetryGoal_getTargetAsymmetry(self)

    def setContactForceThreshold(self, threshold):
        r"""
    ...
    def getContactForceThreshold(self):
        return _moco.MocoStepTimeAsymmetryGoal_getContactForceThreshold(self)

    def setContactForceDirection(self, direction):
        r"""
    ...
    def getContactForceDirection(self):
        return _moco.MocoStepTimeAsymmetryGoal_getContactForceDirection(self)

    def setWalkingDirection(self, direction):
        r"""
    ...
    def getWalkingDirection(self):
        return _moco.MocoStepTimeAsymmetryGoal_getWalkingDirection(self)

    def setAsymmetrySmoothing(self, smoothing):
        r"""
    ...
    def getAsymmetrySmoothing(self):
        return _moco.MocoStepTimeAsymmetryGoal_getAsymmetrySmoothing(self)

    def setContactDetectionSmoothing(self, smoothing):
        r"""
    ...
    def getContactDetectionSmoothing(self):
...
class MocoStepLengthAsymmetryGoal(MocoGoal):
    ...
    def setStrideLength(self, length):
        r"""
...
class MocoConstraintInfo(opensim.common.OpenSimObject):
    r"""
    ...
    @staticmethod
    def safeDownCast(obj):
        return _moco.MocoConstraintInfo_safeDownCast(obj)

    def assign(self, aObject):
        return _moco.MocoConstraintInfo_assign(self, aObject)

    @staticmethod
    def getClassName():
        return _moco.MocoConstraintInfo_getClassName()

    def clone(self):
        return _moco.MocoConstraintInfo_clone(self)

    def getConcreteClassName(self):
        return _moco.MocoConstraintInfo_getConcreteClassName(self)

    def __init__(self):
        _moco.MocoConstraintInfo_swiginit(self, _moco.new_MocoConstraintInfo())

    def getNumEquations(self):
        return _moco.MocoConstraintInfo_getNumEquations(self)
    ...
    def getBounds(self):
        ...
        the internal property. Avoid repeated calls to this function.
        """
        return _moco.MocoConstraintInfo_getBounds(self)
    ...
    def getSuffixes(self):
        ...
        the internal property. Avoid repeated calls to this function.
        """
        return _moco.MocoConstraintInfo_getSuffixes(self)

    def setBounds(self, bounds):
        r"""
        Note: if the number of equations has not been set, this updates
        ...
        thrown.
        """
        return _moco.MocoConstraintInfo_setBounds(self, bounds)

    def setSuffixes(self, suffixes):
        
        return _moco.MocoConstraintInfo_setSuffixes(self, suffixes)

    def getConstraintLabels(self):
        r"""
        Get a list of constraint labels based on the constraint name and, if
           ...
           getNumEquations().
        """
        return _moco.MocoConstraintInfo_getConstraintLabels(self)
    ...
    def printDescription(self):
        ...
        Print the name, type, number of scalar equations, and bounds for this
           constraint.
        """
        return _moco.MocoConstraintInfo_printDescription(self)
    __swig_destroy__ = _moco.delete_MocoConstraintInfo

# Register MocoConstraintInfo in _moco:
_moco.MocoConstraintInfo_swigregister(MocoConstraintInfo)
class StdVectorMocoBounds(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _moco.StdVectorMocoBounds_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _moco.StdVectorMocoBounds___nonzero__(self)

    def __bool__(self):
        return _moco.StdVectorMocoBounds___bool__(self)

    def __len__(self):
        return _moco.StdVectorMocoBounds___len__(self)

    def __getslice__(self, i, j):
        return _moco.StdVectorMocoBounds___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _moco.StdVectorMocoBounds___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _moco.StdVectorMocoBounds___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _moco.StdVectorMocoBounds___delitem__(self, *args)

    def __getitem__(self, *args):
        return _moco.StdVectorMocoBounds___getitem__(self, *args)

    def __setitem__(self, *args):
        return _moco.StdVectorMocoBounds___setitem__(self, *args)

    def pop(self):
        return _moco.StdVectorMocoBounds_pop(self)

    def append(self, x):
        return _moco.StdVectorMocoBounds_append(self, x)

    def empty(self):
        return _moco.StdVectorMocoBounds_empty(self)

    def size(self):
        return _moco.StdVectorMocoBounds_size(self)

    def swap(self, v):
        return _moco.StdVectorMocoBounds_swap(self, v)

    def begin(self):
        return _moco.StdVectorMocoBounds_begin(self)

    def end(self):
        return _moco.StdVectorMocoBounds_end(self)

    def rbegin(self):
        return _moco.StdVectorMocoBounds_rbegin(self)

    def rend(self):
        return _moco.StdVectorMocoBounds_rend(self)

    def clear(self):
        return _moco.StdVectorMocoBounds_clear(self)

    def get_allocator(self):
        return _moco.StdVectorMocoBounds_get_allocator(self)

    def pop_back(self):
        return _moco.StdVectorMocoBounds_pop_back(self)

    def erase(self, *args):
        return _moco.StdVectorMocoBounds_erase(self, *args)

    def __init__(self, *args):
        _moco.StdVectorMocoBounds_swiginit(self, _moco.new_StdVectorMocoBounds(*args))

    def push_back(self, x):
        return _moco.StdVectorMocoBounds_push_back(self, x)

    def front(self):
        return _moco.StdVectorMocoBounds_front(self)

    def back(self):
        return _moco.StdVectorMocoBounds_back(self)

    def assign(self, n, x):
        return _moco.StdVectorMocoBounds_assign(self, n, x)

    def resize(self, *args):
        return _moco.StdVectorMocoBounds_resize(self, *args)

    def insert(self, *args):
        return _moco.StdVectorMocoBounds_insert(self, *args)

    def reserve(self, n):
        return _moco.StdVectorMocoBounds_reserve(self, n)

    def capacity(self):
        return _moco.StdVectorMocoBounds_capacity(self)
    __swig_destroy__ = _moco.delete_StdVectorMocoBounds

# Register StdVectorMocoBounds in _moco:
_moco.StdVectorMocoBounds_swigregister(StdVectorMocoBounds)
...
class MocoTrajectory(object):
    ...
    def trimToIndices(self, newStartIndex, newFinalIndex):
        r"""
        Trim the trajectory to include the rows starting at newStartIndex and
        and ending at newFinalIndex.
        """
        return _moco.MocoTrajectory_trimToIndices(self, newStartIndex, newFinalIndex)
    ...
    def getNumMultibodyStates(self):
        return _moco.MocoTrajectory_getNumMultibodyStates(self)

    def getNumAuxiliaryStates(self):
        return _moco.MocoTrajectory_getNumAuxiliaryStates(self)

    def getNumAccelerations(self):
        return _moco.MocoTrajectory_getNumAccelerations(self)

    def getNumDerivativesWithoutAccelerations(self):
    ...
    def getSpeedNames(self):
        return _moco.MocoTrajectory_getSpeedNames(self)

    def getMultibodyStateNames(self):
        return _moco.MocoTrajectory_getMultibodyStateNames(self)

    def getAuxiliaryStateNames(self):
        return _moco.MocoTrajectory_getAuxiliaryStateNames(self)

    def getAccelerationNames(self):
        return _moco.MocoTrajectory_getAccelerationNames(self)

    def getDerivativeNamesWithoutAccelerations(self):
    ...
    def getValuesTrajectory(self):
        return _moco.MocoTrajectory_getValuesTrajectory(self)

    def getSpeedsTrajectory(self):
        return _moco.MocoTrajectory_getSpeedsTrajectory(self)

    def getMultibodyStatesTrajectory(self):
        return _moco.MocoTrajectory_getMultibodyStatesTrajectory(self)

    def getAuxiliaryStatesTrajectory(self):
        return _moco.MocoTrajectory_getAuxiliaryStatesTrajectory(self)

    def getAccelerationsTrajectory(self):
        return _moco.MocoTrajectory_getAccelerationsTrajectory(self)

    def getDerivativesWithoutAccelerationsTrajectory(self):
    ...
    def exportToAccelerationsTable(self):
        r"""
    ...
    def exportToDerivativesWithoutAccelerationsTable(self):
        r"""
...
def analyzeMocoTrajectory(model, trajectory, outputPaths):
    r"""
    Calculate the requested outputs using the model in the problem and the
...
def analyzeMocoTrajectoryVec3(model, trajectory, outputPaths):
    r"""
    Calculate the requested outputs using the model in the problem and the
    provided StatesTrajectory and controls table.
    The controls table is used to set the model's controls vector.
...
def analyzeMocoTrajectorySpatialVec(model, trajectory, outputPaths):
    r"""
    Calculate the requested outputs using the model in the problem and the
    provided StatesTrajectory and controls table.
    The controls table is used to set the model's controls vector.
