...
class VariableHours:
    ...
    def create(self, employee_id: str, data: Dict[str, Any]):
        ...
        hours_model = VariableHoursCreate(**data)
        
        if self.nmbrs.mock_mode:
            return hours_model
        
        # Convert validated model to dict for API payload
        payload = hours_model.dict(exclude_none=True)
    ...
    def update(self, employee_id: str, data: Dict[str, Any]):
        ...
        """
        # Validate with Pydantic model
        hours_model = VariableHoursUpdate(**data)
...
class FixedHours:
    ...
    def create(self, employee_id: str, data: Dict[str, Any]):
        ...
        """
        # Validate with Pydantic model
        hours_model = FixedHoursCreate(**data)
    ...
    def update(self, employee_id: str, data: Dict[str, Any]):
        ...
        """
        # Validate with Pydantic model
        hours_model = FixedHoursUpdate(**data)
