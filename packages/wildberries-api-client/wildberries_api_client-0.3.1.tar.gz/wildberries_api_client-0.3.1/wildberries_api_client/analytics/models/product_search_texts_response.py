...
class ProductSearchTextsResponse(object):
    ...
    """
    swagger_types = {
        'items': 'list[TableSearchTextItem]'
    }
    ...
    def __init__(self, items=None):  # noqa: E501
        """ProductSearchTextsResponse - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this ProductSearchTextsResponse.  # noqa: E501


        :return: The items of this ProductSearchTextsResponse.  # noqa: E501
        :rtype: list[TableSearchTextItem]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this ProductSearchTextsResponse.


        :param items: The items of this ProductSearchTextsResponse.  # noqa: E501
        :type: list[TableSearchTextItem]
        """
        if items is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProductSearchTextsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProductSearchTextsResponse):
            return False
