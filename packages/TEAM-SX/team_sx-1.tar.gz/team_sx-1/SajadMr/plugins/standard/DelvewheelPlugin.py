...
from SajadMr.utils.FileOperations import listDllFilesFromDirectory

# spell-checker: ignore delvewheel


class SajadQPluginDelvewheel(SajadQPluginBase):
    ...
    plugin_name = "delvewheel"  # SajadQ knows us by this name
    plugin_desc = (
