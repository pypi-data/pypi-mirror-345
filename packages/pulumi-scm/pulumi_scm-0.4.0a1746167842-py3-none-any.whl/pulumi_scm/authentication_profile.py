...
class AuthenticationProfileArgs:
    def __init__(__self__, *,
                 ...
                 username_modifier: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a AuthenticationProfile resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allow_lists: The AllowList param.
        ...
        :param pulumi.Input[builtins.str] user_domain: The UserDomain param. String length must not exceed 63 characters.
        :param pulumi.Input[builtins.str] username_modifier: The UsernameModifier param. String must be one of these: `"%USERINPUT%"`, `"%USERINPUT%@%USERDOMAIN%"`, `"%USERDOMAIN%\\\\%USERINPUT%"`.
        """
    ...
    def username_modifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def username_modifier(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AuthenticationProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tfid: Optional[pulumi.Input[builtins.str]] = None,
            user_domain: Optional[pulumi.Input[builtins.str]] = None,
            username_modifier: Optional[pulumi.Input[builtins.str]] = None) -> 'AuthenticationProfile':
        """
    ...
    @property
    @pulumi.getter(name="allowLists")
    def allow_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The AllowList param.
        """
        return pulumi.get(self, "allow_lists")
    ...
    @property
    @pulumi.getter(name="usernameModifier")
    def username_modifier(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The UsernameModifier param. String must be one of these: `"%USERINPUT%"`, `"%USERINPUT%@%USERDOMAIN%"`, `"%USERDOMAIN%\\\\%USERINPUT%"`.
        """
        return pulumi.get(self, "username_modifier")
