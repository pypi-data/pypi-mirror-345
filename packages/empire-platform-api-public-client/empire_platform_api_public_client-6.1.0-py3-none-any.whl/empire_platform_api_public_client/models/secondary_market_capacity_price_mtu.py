...
class SecondaryMarketCapacityPriceMtu(BaseModel):
    ...
    capacity: Optional[StrictInt] = Field(default=None, description="Capacity value in kilowatts (kW) - the required system precision allows for handling capacity values as integers")
    ...
    __properties: ClassVar[List[str]] = ["mtu", "capacity", "price"]
