...
class PipelineStepImpl(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": PipelineStepImpllinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "displayName": obj.get("displayName"),
            "durationInMillis": obj.get("durationInMillis"),
            "id": obj.get("id"),
            "input": InputStepImpl.from_dict(obj["input"]) if obj.get("input") is not None else None,
