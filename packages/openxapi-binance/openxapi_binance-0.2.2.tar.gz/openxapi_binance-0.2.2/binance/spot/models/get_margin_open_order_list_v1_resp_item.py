...
class GetMarginOpenOrderListV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["contingencyType", "isIsolated", "listClientOrderId", "listOrderStatus", "listStatusType", "orderListId", "orders", "symbol", "transactionTime"]
