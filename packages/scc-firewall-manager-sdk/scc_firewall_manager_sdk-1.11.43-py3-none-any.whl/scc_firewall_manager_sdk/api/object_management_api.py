...
class ObjectManagementApi:
    ...
    def get_issues_count(
        self,
        q: Annotated[StrictStr, Field(description="The query to execute. Use the Lucene Query Syntax to construct your query. Possible fields to search by are name, content.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param q: The query to execute. Use the Lucene Query Syntax to construct your query. Possible fields to search by are name, content. (required)
        :type q: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_object(
        ...
        fields: Annotated[StrictStr, Field(description="The scope of the fields to be retrieved. One of [\"@basic\", \"@detailed\"]. Defaults to \"@basic\".")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type uid: str
        :param fields: The scope of the fields to be retrieved. One of [\"@basic\", \"@detailed\"]. Defaults to \"@basic\". (required)
        :type fields: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_objects(
        self,
        q: Annotated[StrictStr, Field(description="The query to execute. Use the Lucene Query Syntax to construct your query. Possible fields to search by are name, content.")],
        include_overrides: Annotated[StrictBool, Field(description="If enabled, the search will also include results from override objects.")],
        offset: Annotated[str, Field(strict=True, description="The offset of the results retrieved. The Security Cloud Control API uses the offset field to determine the index of the first result retrieved, and will retrieve `limit` results from the offset specified.")],
        limit: Annotated[str, Field(strict=True, description="The number of results to retrieve.")],
        sort_by: Annotated[StrictStr, Field(description="The fields to sort results by.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param q: The query to execute. Use the Lucene Query Syntax to construct your query. Possible fields to search by are name, content. (required)
        :type q: str
        :param include_overrides: If enabled, the search will also include results from override objects. (required)
        :type include_overrides: bool
        :param offset: The offset of the results retrieved. The Security Cloud Control API uses the offset field to determine the index of the first result retrieved, and will retrieve `limit` results from the offset specified. (required)
        :type offset: str
        :param limit: The number of results to retrieve. (required)
        :type limit: str
        :param sort_by: The fields to sort results by. (required)
        :type sort_by: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_targets(
        self,
        uid: Annotated[StrictStr, Field(description="the unique identifier of the object for which the targets are being added to.")],
        q: Annotated[StrictStr, Field(description="The query to execute. Use the Lucene Query Syntax to construct your query. Possible fields to search by are: targetType.")],
        offset: Annotated[str, Field(strict=True, description="The offset of the results retrieved. The Security Cloud Control API uses the offset field to determine the index of the first result retrieved, and will retrieve `limit` results from the offset specified.")],
        limit: Annotated[str, Field(strict=True, description="The number of results to retrieve.")],
        _request_timeout: Union[
            None,
        ...
        :param uid: the unique identifier of the object for which the targets are being added to. (required)
        :type uid: str
        :param q: The query to execute. Use the Lucene Query Syntax to construct your query. Possible fields to search by are: targetType. (required)
        :type q: str
        :param offset: The offset of the results retrieved. The Security Cloud Control API uses the offset field to determine the index of the first result retrieved, and will retrieve `limit` results from the offset specified. (required)
        :type offset: str
        :param limit: The number of results to retrieve. (required)
