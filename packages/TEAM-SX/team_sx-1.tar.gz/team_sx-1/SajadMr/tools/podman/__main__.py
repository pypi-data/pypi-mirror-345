...
from SajadMr.tools.release.Release import (
    getBranchName,
...
from SajadMr.utils.Utils import getArchitecture, isWin32Windows

from .Podman import getPodmanExecutablePath

containers_logger = OurLogger("SajadQ-Containers", base_style="blue")
...
def main():
    ...
    if options.command is None:
        options.command = "python3 -m SajadMr --version"
    ...
    container_tag_name = "SajadMr-build-%s-%s:latest" % (
    ...
    if options.network:
        command.append("--add-host=ssh.SajadMr.net:116.202.30.188")
    else:
