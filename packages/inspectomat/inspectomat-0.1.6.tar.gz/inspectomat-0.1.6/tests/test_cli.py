...
from inspectomat.cli import CleanerShell, ScriptableShell, main
...
class TestMain(unittest.TestCase):
    ...
    @patch('sys.argv', ['inspectomat', '-l'])
    @patch('inspectomat.cli.ScriptableShell')
    ...
    @patch('sys.argv', ['inspectomat', 'test_command'])
    @patch('inspectomat.cli.ScriptableShell')
