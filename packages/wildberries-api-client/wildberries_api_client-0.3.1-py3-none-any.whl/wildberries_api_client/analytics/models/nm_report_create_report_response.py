...
class NmReportCreateReportResponse(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """NmReportCreateReportResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this NmReportCreateReportResponse.  # noqa: E501

        Uvedomlenie, hto nahalas generacia otheta  # noqa: E501

        :return: The data of this NmReportCreateReportResponse.  # noqa: E501
        :rtype: str
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this NmReportCreateReportResponse.

        Uvedomlenie, hto nahalas generacia otheta  # noqa: E501

        :param data: The data of this NmReportCreateReportResponse.  # noqa: E501
        :type: str
        """
        if data is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NmReportCreateReportResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NmReportCreateReportResponse):
            return False
