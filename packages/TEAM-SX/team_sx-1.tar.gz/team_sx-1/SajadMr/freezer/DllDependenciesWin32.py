...
from SajadMr.build.SconsUtils import readSconsReport
from SajadMr.containers.OrderedSets import OrderedSet
from SajadMr.Options import isExperimental, isShowProgress
...
from SajadMr.utils.Hashing import Hash
from SajadMr.utils.SharedLibraries import getPEFileUsedDllNames, getPyWin32Dir
from SajadMr.utils.Utils import getArchitecture
from SajadMr.Version import version_string
...
def _getCacheFilename(
    ...
    # Take SajadQ version into account as well, ought to catch code changes.
