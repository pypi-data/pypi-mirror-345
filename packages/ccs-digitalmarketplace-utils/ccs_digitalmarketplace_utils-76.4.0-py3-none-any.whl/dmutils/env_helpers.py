...
def get_cdp_api_endpoint_from_stage(stage: str) -> str:
    ...
    """
    stage_domains = {
        'local': 'https://data-sharing.integration.supplier.information.findatender.codatt.net',
        'development': 'https://data-sharing.integration.supplier.information.findatender.codatt.net',
        'preview': 'https://data-sharing.integration.supplier.information.findatender.codatt.net',
        'nft': 'https://data-sharing.integration.supplier.information.findatender.codatt.net',
        'pre-production': 'https://data-sharing.integration.supplier.information.findatender.codatt.net',
        'production': 'https://data-sharing.integration.supplier.information.findatender.codatt.net',
    }
