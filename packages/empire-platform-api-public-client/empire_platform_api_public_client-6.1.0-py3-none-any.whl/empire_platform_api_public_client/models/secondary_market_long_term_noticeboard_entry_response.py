...
class SecondaryMarketLongTermNoticeboardEntryResponse(BaseModel):
    ...
    """ # noqa: E501
    reponse_capacity: StrictInt = Field(description="Capacity value in kilowatts (kW) - the required system precision allows for handling capacity values as integers", alias="reponseCapacity")
    ...
    __properties: ClassVar[List[str]] = ["reponseCapacity", "responsePrice", "contactName", "phoneNumber", "email", "comment", "respondedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reponseCapacity": obj.get("reponseCapacity"),
