...
class PulpAnsibleDefaultApiV3CollectionsVersionsDocsBlobApi(object):
    ...
    def read_with_http_info(self, name, namespace, version,  **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/default/api/v3/collections/{namespace}/{name}/versions/{version}/docs-blob/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
