...
from sifflet_sdk.client import rest
from sifflet_sdk.client.configuration import Configuration
from sifflet_sdk.client.exceptions import ApiException, ApiTypeError, ApiValueError
from sifflet_sdk.client.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class ApiClient(object):
    ...
    def __call_api(
        ...
        self.update_params_for_auth(
            header_params, query_params, auth_settings, resource_path, method, body, request_auths=_request_auths
        )
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AIPredictionsApi()
        api_instance.generate_text_for_rule  # this is an instance of the class Endpoint
        api_instance.generate_text_for_rule()  # this invokes api_instance.generate_text_for_rule.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.generate_text_for_rule.callable or self.callable in this class
