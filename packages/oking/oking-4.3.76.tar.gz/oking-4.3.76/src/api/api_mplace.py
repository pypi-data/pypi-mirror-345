...
def post_products_mplace(body: List[Produto_Mplace], job_config_dict, db_config):
    try:
        logger.info('Dormindo 1.2s Zzz...')
        time.sleep(1.2)
        headers = {'Content-type': 'application/json',
        ...
        for i in range(len(dados)):
            ...
            if src.client_data['operacao'].lower().__contains__('b2c'):
                ...
                if verify:
                    ...
                    dados_json['multiple'] = dados[i]['multiple']
                    dados_json['package_quantity'] = dados[i]['package_quantity']
                    ...
                    dados_json['active'] = dados[i]['active']
            ...
            if src.client_data['operacao'].lower().__contains__('b2b'):
                ...
                if verify:
                    ...
                    dados_json['price_attributes'] = None
