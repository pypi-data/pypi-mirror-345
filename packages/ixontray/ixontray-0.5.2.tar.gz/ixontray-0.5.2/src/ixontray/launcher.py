...
class Launcher(QWidget):
    def __init__(self, settings: QSettings, parent: QWidget | None = None) -> None:
        ...
        QLineEdit {{ background: #333; border: 2px; color: #FFF;
        padding: {scaled_padding}px; margin: {scaled_margin}px; }};
        QListWidget {{ font-size: {scaled_font_size}pt; margin: {scaled_margin}px;}}
        """)
