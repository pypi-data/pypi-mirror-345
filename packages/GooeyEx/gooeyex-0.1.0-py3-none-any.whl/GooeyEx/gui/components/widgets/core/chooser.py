...
from GooeyEx.gui.components.widgets.core.text_input import TextInput
from GooeyEx.gui.components.widgets.dialogs.calender_dialog import CalendarDlg
from GooeyEx.gui.components.widgets.dialogs.time_dialog import TimeDlg
from GooeyEx.gui.lang.i18n import _
from GooeyEx.util.functional import merge
from GooeyEx.gui.util.filedrop import FileDrop
...
class FileChooser(Chooser):
    ...
    def getDialog(self):
        ...
        return wx.FileDialog(
            self,
            message=options.get("message", _("open_file")),
...
class MultiFileChooser(Chooser):
    ...
    def getDialog(self):
        ...
        return wx.FileDialog(
            self,
            message=options.get("message", _("open_files")),
...
class DirChooser(Chooser):
    ...
    def getDialog(self):
        ...
        return wx.DirDialog(
            self,
            message=options.get("message", _("choose_folder")),
...
class ColourChooser(Chooser):
    ...
    def __init__(self, *args, **kwargs):
        defaults = {"label": _("choose_colour"), "style": wx.TE_RICH}
