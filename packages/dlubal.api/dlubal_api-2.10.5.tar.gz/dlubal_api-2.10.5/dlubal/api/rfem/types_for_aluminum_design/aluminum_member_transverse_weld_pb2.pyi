...
class AluminumMemberTransverseWeld(_message.Message):
    ...
    class ComponentsRow(_message.Message):
        ...
        size: float
        method_ec_or_adm_type: AluminumMemberTransverseWeld.ComponentsRow.MethodEcOrAdm
        method_gb_type: AluminumMemberTransverseWeld.ComponentsRow.MethodGb
        number_of_heat_paths: int
        temperature_of_material_between_welding_cycles: float
        def __init__(self, no: _Optional[int] = ..., description: _Optional[str] = ..., weld_type: _Optional[_Union[AluminumMemberTransverseWeld.ComponentsRow.WeldType, str]] = ..., position: _Optional[float] = ..., multiple: bool = ..., note: _Optional[str] = ..., multiple_number: _Optional[int] = ..., multiple_offset_definition_type: _Optional[_Union[AluminumMemberTransverseWeld.ComponentsRow.MultipleOffsetDefinitionType, str]] = ..., multiple_offset: _Optional[float] = ..., size: _Optional[float] = ..., method_ec_or_adm_type: _Optional[_Union[AluminumMemberTransverseWeld.ComponentsRow.MethodEcOrAdm, str]] = ..., method_gb_type: _Optional[_Union[AluminumMemberTransverseWeld.ComponentsRow.MethodGb, str]] = ..., number_of_heat_paths: _Optional[int] = ..., temperature_of_material_between_welding_cycles: _Optional[float] = ...) -> None: ...
    NO_FIELD_NUMBER: _ClassVar[int]
