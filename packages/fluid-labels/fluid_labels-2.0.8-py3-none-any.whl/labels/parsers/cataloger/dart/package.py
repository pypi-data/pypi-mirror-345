...
def _update_advisories(package: Package) -> None:
    pkg_advisories = advisories.get_vulnerabilities("pub", package.name, package.version)
    if pkg_advisories:
