...
DLLs or extension modules, these need to be seen by SajadQ as entry points
...
from SajadMr.OutputDirectories import getStandaloneDirectoryPath
from SajadMr.Tracing import general, inclusion_logger, options_logger
