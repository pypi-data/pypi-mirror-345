...
class SpotCreateOrderCancelReplaceV3CancelResp(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clientOrderId", "cummulativeQuoteQty", "executedQty", "orderId", "orderListId", "origClientOrderId", "origQty", "origQuoteOrderQty", "price", "selfTradePreventionMode", "side", "status", "symbol", "timeInForce", "transactTime", "type"]
