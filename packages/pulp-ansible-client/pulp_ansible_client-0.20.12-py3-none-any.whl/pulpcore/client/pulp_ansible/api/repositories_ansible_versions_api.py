...
class RepositoriesAnsibleVersionsApi(object):
    ...
    def rebuild_metadata(self, ansible_ansible_repository_version_href, ansible_repository_rebuild,  **kwargs):  # noqa: E501
        """rebuild_metadata  # noqa: E501

        Trigger an asynchronous task to rebuild Ansible content meta.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rebuild_metadata(ansible_ansible_repository_version_href, ansible_repository_rebuild, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.rebuild_metadata_with_http_info(ansible_ansible_repository_version_href, ansible_repository_rebuild,  **kwargs)  # noqa: E501

    def rebuild_metadata_with_http_info(self, ansible_ansible_repository_version_href, ansible_repository_rebuild,  **kwargs):  # noqa: E501
        """rebuild_metadata  # noqa: E501

        Trigger an asynchronous task to rebuild Ansible content meta.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rebuild_metadata_with_http_info(ansible_ansible_repository_version_href, ansible_repository_rebuild, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('ansible_ansible_repository_version_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['ansible_ansible_repository_version_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ansible_ansible_repository_version_href` when calling `rebuild_metadata`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '{ansible_ansible_repository_version_href}rebuild_metadata/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def repair(self, ansible_ansible_repository_version_href, repair,  **kwargs):  # noqa: E501
        """repair  # noqa: E501

        Trigger an asynchronous task to repair a repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repair(ansible_ansible_repository_version_href, repair, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.repair_with_http_info(ansible_ansible_repository_version_href, repair,  **kwargs)  # noqa: E501

    def repair_with_http_info(self, ansible_ansible_repository_version_href, repair,  **kwargs):  # noqa: E501
        """repair  # noqa: E501

        Trigger an asynchronous task to repair a repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repair_with_http_info(ansible_ansible_repository_version_href, repair, async_req=True)
        >>> result = thread.get()
