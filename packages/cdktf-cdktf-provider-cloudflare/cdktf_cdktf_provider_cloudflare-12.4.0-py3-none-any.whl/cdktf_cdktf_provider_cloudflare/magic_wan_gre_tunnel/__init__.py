...
Refer to the Terraform Registry for docs: [`cloudflare_magic_wan_gre_tunnel`](https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel).
'''
...
class MagicWanGreTunnel(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#account_id MagicWanGreTunnel#account_id}
        :param cloudflare_gre_endpoint: The IP address assigned to the Cloudflare side of the GRE tunnel. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#cloudflare_gre_endpoint MagicWanGreTunnel#cloudflare_gre_endpoint}
        :param customer_gre_endpoint: The IP address assigned to the customer side of the GRE tunnel. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#customer_gre_endpoint MagicWanGreTunnel#customer_gre_endpoint}
        :param interface_address: A 31-bit prefix (/31 in CIDR notation) supporting two hosts, one for each side of the tunnel. Select the subnet from the following private IP space: 10.0.0.0–10.255.255.255, 172.16.0.0–172.31.255.255, 192.168.0.0–192.168.255.255. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#interface_address MagicWanGreTunnel#interface_address}
        :param name: The name of the tunnel. The name cannot contain spaces or special characters, must be 15 characters or less, and cannot share a name with another GRE tunnel. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#name MagicWanGreTunnel#name}
        :param description: An optional description of the GRE tunnel. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#description MagicWanGreTunnel#description}
        :param health_check: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#health_check MagicWanGreTunnel#health_check}.
        :param mtu: Maximum Transmission Unit (MTU) in bytes for the GRE tunnel. The minimum value is 576. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#mtu MagicWanGreTunnel#mtu}
        :param ttl: Time To Live (TTL) in number of hops of the GRE tunnel. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#ttl MagicWanGreTunnel#ttl}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing MagicWanGreTunnel that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#import import section} in the documentation of this resource for the id to use
    ...
    def put_health_check(
        ...
        *,
        ...
        '''
        :param direction: The direction of the flow of the healthcheck. Either unidirectional, where the probe comes to you via the tunnel and the result comes back to Cloudflare via the open Internet, or bidirectional where both the probe and result come and go via the tunnel. Available values: "unidirectional", "bidirectional". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#direction MagicWanGreTunnel#direction}
        :param enabled: Determines whether to run healthchecks for a tunnel. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#enabled MagicWanGreTunnel#enabled}
        :param rate: How frequent the health check is run. The default value is ``mid``. Available values: "low", "mid", "high". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#rate MagicWanGreTunnel#rate}
        :param target: The destination address in a request type health check. After the healthcheck is decapsulated at the customer end of the tunnel, the ICMP echo will be forwarded to this address. This field defaults to ``customer_gre_endpoint address``. This field is ignored for bidirectional healthchecks as the interface_address (not assigned to the Cloudflare side of the tunnel) is used as the target. Must be in object form if the x-magic-new-hc-target header is set to true and string form if x-magic-new-hc-target is absent or set to false. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#target MagicWanGreTunnel#target}
        :param type: The type of healthcheck to run, reply or request. The default value is ``reply``. Available values: "reply", "request". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#type MagicWanGreTunnel#type}
        '''
    ...
    def gre_tunnel(self) -> "MagicWanGreTunnelGreTunnelOutputReference":
        return typing.cast("MagicWanGreTunnelGreTunnelOutputReference", jsii.get(self, "greTunnel"))
    ...
    @builtins.property
    @jsii.member(jsii_name="modifiedGreTunnel")
    def modified_gre_tunnel(
        self,
    ) -> "MagicWanGreTunnelModifiedGreTunnelOutputReference":
        return typing.cast("MagicWanGreTunnelModifiedGreTunnelOutputReference", jsii.get(self, "modifiedGreTunnel"))
...
class MagicWanGreTunnelConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def account_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#account_id MagicWanGreTunnel#account_id}
        '''
    ...
    def cloudflare_gre_endpoint(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#cloudflare_gre_endpoint MagicWanGreTunnel#cloudflare_gre_endpoint}
        '''
    ...
    def customer_gre_endpoint(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#customer_gre_endpoint MagicWanGreTunnel#customer_gre_endpoint}
        '''
    ...
    def interface_address(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#interface_address MagicWanGreTunnel#interface_address}
        '''
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#name MagicWanGreTunnel#name}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#description MagicWanGreTunnel#description}
        '''
    ...
    def health_check(self) -> typing.Optional["MagicWanGreTunnelHealthCheck"]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#health_check MagicWanGreTunnel#health_check}.'''
    ...
    def mtu(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#mtu MagicWanGreTunnel#mtu}
        '''
    ...
    def ttl(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#ttl MagicWanGreTunnel#ttl}
        '''
...
@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.magicWanGreTunnel.MagicWanGreTunnelGreTunnel",
    jsii_struct_bases=[],
    name_mapping={},
)
class MagicWanGreTunnelGreTunnel:
    ...
    def __repr__(self) -> str:
        return "MagicWanGreTunnelGreTunnel(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.magicWanGreTunnel.MagicWanGreTunnelGreTunnelHealthCheck",
    jsii_struct_bases=[],
    name_mapping={},
)
class MagicWanGreTunnelGreTunnelHealthCheck:
    def __init__(self) -> None:
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "MagicWanGreTunnelGreTunnelHealthCheck(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class MagicWanGreTunnelGreTunnelHealthCheckOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-cloudflare.magicWanGreTunnel.MagicWanGreTunnelGreTunnelHealthCheckOutputReference",
):
    def __init__(
        self,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3f58f7c3c3a5feed9511064ffeeb8614c75fb95a9016ca7a8ca04a5808fac319)
    ...
    def target(self) -> "MagicWanGreTunnelGreTunnelHealthCheckTargetOutputReference":
        return typing.cast("MagicWanGreTunnelGreTunnelHealthCheckTargetOutputReference", jsii.get(self, "target"))
    ...
    def internal_value(self) -> typing.Optional[MagicWanGreTunnelGreTunnelHealthCheck]:
        return typing.cast(typing.Optional[MagicWanGreTunnelGreTunnelHealthCheck], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[MagicWanGreTunnelGreTunnelHealthCheck],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bdb992fb5d8b1e04b26d7b80958552840ade60fa3eb0ef4de791c90ea0689945)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value) # pyright: ignore[reportArgumentType]


@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.magicWanGreTunnel.MagicWanGreTunnelGreTunnelHealthCheckTarget",
    jsii_struct_bases=[],
    name_mapping={},
)
class MagicWanGreTunnelGreTunnelHealthCheckTarget:
    def __init__(self) -> None:
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "MagicWanGreTunnelGreTunnelHealthCheckTarget(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class MagicWanGreTunnelGreTunnelHealthCheckTargetOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-cloudflare.magicWanGreTunnel.MagicWanGreTunnelGreTunnelHealthCheckTargetOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6d2da9f55482bc968eff6e5c4582d58e6f2e8e379e8c1a631b957604e5d2d4a2)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def internal_value(
        self,
    ) -> typing.Optional[MagicWanGreTunnelGreTunnelHealthCheckTarget]:
        return typing.cast(typing.Optional[MagicWanGreTunnelGreTunnelHealthCheckTarget], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[MagicWanGreTunnelGreTunnelHealthCheckTarget],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0be2addb45b418908991b897fa7d8f29ed77d085117191db24f41300f72203ae)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value) # pyright: ignore[reportArgumentType]


class MagicWanGreTunnelGreTunnelOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-cloudflare.magicWanGreTunnel.MagicWanGreTunnelGreTunnelOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dbcd370baec1cb9dacd56c70a21cdc1102a55ca579c0382aa151f4c24a29af6a)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    @builtins.property
    @jsii.member(jsii_name="healthCheck")
    def health_check(self) -> MagicWanGreTunnelGreTunnelHealthCheckOutputReference:
        return typing.cast(MagicWanGreTunnelGreTunnelHealthCheckOutputReference, jsii.get(self, "healthCheck"))
    ...
    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(self) -> typing.Optional[MagicWanGreTunnelGreTunnel]:
        return typing.cast(typing.Optional[MagicWanGreTunnelGreTunnel], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[MagicWanGreTunnelGreTunnel],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1245fbd9f1fa412f78d119f5c53ac4af8994f4c1c46aeed16d3becdce07cb311)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value) # pyright: ignore[reportArgumentType]
...
class MagicWanGreTunnelHealthCheck:
    ...
    def enabled(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#enabled MagicWanGreTunnel#enabled}
        '''
    ...
    def rate(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#rate MagicWanGreTunnel#rate}
        '''
    ...
    def target(self) -> typing.Optional["MagicWanGreTunnelHealthCheckTarget"]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#target MagicWanGreTunnel#target}
        '''
    ...
    def type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#type MagicWanGreTunnel#type}
        '''
...
class MagicWanGreTunnelHealthCheckOutputReference(
    ...
    def put_target(self, *, saved: typing.Optional[builtins.str] = None) -> None:
        '''
        :param saved: The saved health check target. Setting the value to the empty string indicates that the calculated default value will be used. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#saved MagicWanGreTunnel#saved}
        '''
...
class MagicWanGreTunnelHealthCheckTarget:
    ...
    def saved(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/magic_wan_gre_tunnel#saved MagicWanGreTunnel#saved}
        '''
...
@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.magicWanGreTunnel.MagicWanGreTunnelModifiedGreTunnel",
    jsii_struct_bases=[],
    name_mapping={},
)
class MagicWanGreTunnelModifiedGreTunnel:
    def __init__(self) -> None:
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "MagicWanGreTunnelModifiedGreTunnel(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.magicWanGreTunnel.MagicWanGreTunnelModifiedGreTunnelHealthCheck",
    jsii_struct_bases=[],
    name_mapping={},
)
class MagicWanGreTunnelModifiedGreTunnelHealthCheck:
    def __init__(self) -> None:
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "MagicWanGreTunnelModifiedGreTunnelHealthCheck(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class MagicWanGreTunnelModifiedGreTunnelHealthCheckOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-cloudflare.magicWanGreTunnel.MagicWanGreTunnelModifiedGreTunnelHealthCheckOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bb07ad94a9c03178091a5edc43dd725cc86623ef8de8f8edc5519944cac159f0)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def target(
        self,
    ) -> "MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetOutputReference":
        return typing.cast("MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetOutputReference", jsii.get(self, "target"))
    ...
    def internal_value(
        self,
    ) -> typing.Optional[MagicWanGreTunnelModifiedGreTunnelHealthCheck]:
        return typing.cast(typing.Optional[MagicWanGreTunnelModifiedGreTunnelHealthCheck], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[MagicWanGreTunnelModifiedGreTunnelHealthCheck],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a199aee3d8348eb286c4084369f88db8d80fbb16952ef93aaa917d68f2e350eb)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value) # pyright: ignore[reportArgumentType]


@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.magicWanGreTunnel.MagicWanGreTunnelModifiedGreTunnelHealthCheckTarget",
    jsii_struct_bases=[],
    name_mapping={},
)
class MagicWanGreTunnelModifiedGreTunnelHealthCheckTarget:
    def __init__(self) -> None:
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "MagicWanGreTunnelModifiedGreTunnelHealthCheckTarget(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-cloudflare.magicWanGreTunnel.MagicWanGreTunnelModifiedGreTunnelHealthCheckTargetOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__148a57981bb93fc09774970fe6b5fb59b3bc9abf29a83c24e5ced1fb5a296308)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def internal_value(
        self,
    ) -> typing.Optional[MagicWanGreTunnelModifiedGreTunnelHealthCheckTarget]:
        return typing.cast(typing.Optional[MagicWanGreTunnelModifiedGreTunnelHealthCheckTarget], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[MagicWanGreTunnelModifiedGreTunnelHealthCheckTarget],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3b77beb629ac59019580401ae535deb51609ffd46158ed38e6e693c8b61371d4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value) # pyright: ignore[reportArgumentType]


class MagicWanGreTunnelModifiedGreTunnelOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-cloudflare.magicWanGreTunnel.MagicWanGreTunnelModifiedGreTunnelOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1c994214339ea5bee80733c0165e32621d6661781c34d00a3149f1e21ba21bbb)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def health_check(
        self,
    ) -> MagicWanGreTunnelModifiedGreTunnelHealthCheckOutputReference:
        return typing.cast(MagicWanGreTunnelModifiedGreTunnelHealthCheckOutputReference, jsii.get(self, "healthCheck"))
    ...
    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(self) -> typing.Optional[MagicWanGreTunnelModifiedGreTunnel]:
        return typing.cast(typing.Optional[MagicWanGreTunnelModifiedGreTunnel], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[MagicWanGreTunnelModifiedGreTunnel],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__45e1b76775dfa940435700e39a9b5cc952a37d2b1d8739b88cc53b92fd647708)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value) # pyright: ignore[reportArgumentType]
...
__all__ = [
    ...
    "MagicWanGreTunnelGreTunnelHealthCheckOutputReference",
    "MagicWanGreTunnelGreTunnelHealthCheckTarget",
    "MagicWanGreTunnelGreTunnelHealthCheckTargetOutputReference",
    "MagicWanGreTunnelGreTunnelOutputReference",
...
def _typecheckingstub__3f58f7c3c3a5feed9511064ffeeb8614c75fb95a9016ca7a8ca04a5808fac319(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__bdb992fb5d8b1e04b26d7b80958552840ade60fa3eb0ef4de791c90ea0689945(
    value: typing.Optional[MagicWanGreTunnelGreTunnelHealthCheck],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6d2da9f55482bc968eff6e5c4582d58e6f2e8e379e8c1a631b957604e5d2d4a2(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__0be2addb45b418908991b897fa7d8f29ed77d085117191db24f41300f72203ae(
    value: typing.Optional[MagicWanGreTunnelGreTunnelHealthCheckTarget],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__dbcd370baec1cb9dacd56c70a21cdc1102a55ca579c0382aa151f4c24a29af6a(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__1245fbd9f1fa412f78d119f5c53ac4af8994f4c1c46aeed16d3becdce07cb311(
    value: typing.Optional[MagicWanGreTunnelGreTunnel],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__bb07ad94a9c03178091a5edc43dd725cc86623ef8de8f8edc5519944cac159f0(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__a199aee3d8348eb286c4084369f88db8d80fbb16952ef93aaa917d68f2e350eb(
    value: typing.Optional[MagicWanGreTunnelModifiedGreTunnelHealthCheck],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__148a57981bb93fc09774970fe6b5fb59b3bc9abf29a83c24e5ced1fb5a296308(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__3b77beb629ac59019580401ae535deb51609ffd46158ed38e6e693c8b61371d4(
    value: typing.Optional[MagicWanGreTunnelModifiedGreTunnelHealthCheckTarget],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__1c994214339ea5bee80733c0165e32621d6661781c34d00a3149f1e21ba21bbb(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__45e1b76775dfa940435700e39a9b5cc952a37d2b1d8739b88cc53b92fd647708(
    value: typing.Optional[MagicWanGreTunnelModifiedGreTunnel],
) -> None:
    """Type checking stubs"""
    pass
