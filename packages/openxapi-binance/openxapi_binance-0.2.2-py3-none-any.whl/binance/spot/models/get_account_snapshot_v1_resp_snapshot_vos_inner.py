...
class GetAccountSnapshotV1RespSnapshotVosInner(BaseModel):
    """
    GetAccountSnapshotV1RespSnapshotVosInner
    """ # noqa: E501
    data: Optional[GetAccountSnapshotV1RespSnapshotVosInnerData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GetAccountSnapshotV1RespSnapshotVosInnerData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "type": obj.get("type"),
