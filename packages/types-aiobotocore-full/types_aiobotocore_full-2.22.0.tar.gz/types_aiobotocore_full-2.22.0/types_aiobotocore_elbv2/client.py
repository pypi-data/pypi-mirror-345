...
class ElasticLoadBalancingv2Client(AioBaseClient):
    ...
    async def describe_capacity_reservation(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_elbv2/client/#describe_capacity_reservation)
        """
    ...
    async def modify_capacity_reservation(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_elbv2/client/#modify_capacity_reservation)
        """
