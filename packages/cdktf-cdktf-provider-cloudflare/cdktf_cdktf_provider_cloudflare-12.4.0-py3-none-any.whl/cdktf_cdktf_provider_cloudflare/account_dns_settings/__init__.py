...
Refer to the Terraform Registry for docs: [`cloudflare_account_dns_settings`](https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings).
'''
...
class AccountDnsSettings(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings cloudflare_account_dns_settings}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings cloudflare_account_dns_settings} Resource.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param account_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#account_id AccountDnsSettings#account_id}
        :param zone_defaults: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#zone_defaults AccountDnsSettings#zone_defaults}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing AccountDnsSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#import import section} in the documentation of this resource for the id to use
    ...
    def put_zone_defaults(
        ...
        *,
        ...
        '''
        :param flatten_all_cnames: Whether to flatten all CNAME records in the zone. Note that, due to DNS limitations, a CNAME record at the zone apex will always be flattened. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#flatten_all_cnames AccountDnsSettings#flatten_all_cnames}
        :param foundation_dns: Whether to enable Foundation DNS Advanced Nameservers on the zone. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#foundation_dns AccountDnsSettings#foundation_dns}
        :param internal_dns: Settings for this internal zone. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#internal_dns AccountDnsSettings#internal_dns}
        :param multi_provider: Whether to enable multi-provider DNS, which causes Cloudflare to activate the zone even when non-Cloudflare NS records exist, and to respect NS records at the zone apex during outbound zone transfers. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#multi_provider AccountDnsSettings#multi_provider}
        :param nameservers: Settings determining the nameservers through which the zone should be available. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#nameservers AccountDnsSettings#nameservers}
        :param ns_ttl: The time to live (TTL) of the zone's nameserver (NS) records. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#ns_ttl AccountDnsSettings#ns_ttl}
        :param secondary_overrides: Allows a Secondary DNS zone to use (proxied) override records and CNAME flattening at the zone apex. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#secondary_overrides AccountDnsSettings#secondary_overrides}
        :param soa: Components of the zone's SOA record. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#soa AccountDnsSettings#soa}
        :param zone_mode: Whether the zone mode is a regular or CDN/DNS only zone. Available values: "standard", "cdn_only", "dns_only". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#zone_mode AccountDnsSettings#zone_mode}
        '''
...
class AccountDnsSettingsConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def account_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#account_id AccountDnsSettings#account_id}
        '''
    ...
    def zone_defaults(self) -> typing.Optional["AccountDnsSettingsZoneDefaults"]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#zone_defaults AccountDnsSettings#zone_defaults}.'''
...
class AccountDnsSettingsZoneDefaults:
    ...
    def flatten_all_cnames(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#flatten_all_cnames AccountDnsSettings#flatten_all_cnames}
        '''
    ...
    def foundation_dns(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#foundation_dns AccountDnsSettings#foundation_dns}
        '''
    ...
    def internal_dns(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#internal_dns AccountDnsSettings#internal_dns}
        '''
    ...
    def multi_provider(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#multi_provider AccountDnsSettings#multi_provider}
        '''
    ...
    def nameservers(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#nameservers AccountDnsSettings#nameservers}
        '''
    ...
    def ns_ttl(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#ns_ttl AccountDnsSettings#ns_ttl}
        '''
    ...
    def secondary_overrides(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#secondary_overrides AccountDnsSettings#secondary_overrides}
        '''
    ...
    def soa(self) -> typing.Optional["AccountDnsSettingsZoneDefaultsSoa"]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#soa AccountDnsSettings#soa}
        '''
    ...
    def zone_mode(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#zone_mode AccountDnsSettings#zone_mode}
        '''
...
class AccountDnsSettingsZoneDefaultsInternalDns:
    def __init__(
        ...
        *,
        ...
        '''
        :param reference_zone_id: The ID of the zone to fallback to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#reference_zone_id AccountDnsSettings#reference_zone_id}
        '''
        if __debug__:
    ...
    def reference_zone_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#reference_zone_id AccountDnsSettings#reference_zone_id}
        '''
...
class AccountDnsSettingsZoneDefaultsNameservers:
    def __init__(self, *, type: builtins.str) -> None:
        '''
        :param type: Nameserver type Available values: "cloudflare.standard", "cloudflare.standard.random", "custom.account", "custom.tenant". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#type AccountDnsSettings#type}
        '''
        if __debug__:
    ...
    def type(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#type AccountDnsSettings#type}
        '''
...
class AccountDnsSettingsZoneDefaultsOutputReference(
    ...
    def put_nameservers(self, *, type: builtins.str) -> None:
        '''
        :param type: Nameserver type Available values: "cloudflare.standard", "cloudflare.standard.random", "custom.account", "custom.tenant". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#type AccountDnsSettings#type}
        '''
    ...
    def put_soa(
        ...
        *,
        ...
        '''
        :param expire: Time in seconds of being unable to query the primary server after which secondary servers should stop serving the zone. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#expire AccountDnsSettings#expire}
        :param min_ttl: The time to live (TTL) for negative caching of records within the zone. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#min_ttl AccountDnsSettings#min_ttl}
        :param mname: The primary nameserver, which may be used for outbound zone transfers. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#mname AccountDnsSettings#mname}
        :param refresh: Time in seconds after which secondary servers should re-check the SOA record to see if the zone has been updated. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#refresh AccountDnsSettings#refresh}
        :param retry: Time in seconds after which secondary servers should retry queries after the primary server was unresponsive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#retry AccountDnsSettings#retry}
        :param rname: The email address of the zone administrator, with the first label representing the local part of the email address. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#rname AccountDnsSettings#rname}
        :param ttl: The time to live (TTL) of the SOA record itself. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#ttl AccountDnsSettings#ttl}
        '''
...
class AccountDnsSettingsZoneDefaultsSoa:
    ...
    def expire(self) -> jsii.Number:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#expire AccountDnsSettings#expire}
        '''
        result = self._values.get("expire")
        assert result is not None, "Required property 'expire' is missing"
    ...
    def min_ttl(self) -> jsii.Number:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#min_ttl AccountDnsSettings#min_ttl}
        '''
    ...
    def mname(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#mname AccountDnsSettings#mname}
        '''
        result = self._values.get("mname")
        assert result is not None, "Required property 'mname' is missing"
        return typing.cast(builtins.str, result)
    ...
    def refresh(self) -> jsii.Number:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#refresh AccountDnsSettings#refresh}
        '''
        result = self._values.get("refresh")
        assert result is not None, "Required property 'refresh' is missing"
        return typing.cast(jsii.Number, result)
    ...
    def retry(self) -> jsii.Number:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#retry AccountDnsSettings#retry}
        '''
    ...
    def rname(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#rname AccountDnsSettings#rname}
        '''
        result = self._values.get("rname")
        assert result is not None, "Required property 'rname' is missing"
        return typing.cast(builtins.str, result)
    ...
    def ttl(self) -> jsii.Number:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_dns_settings#ttl AccountDnsSettings#ttl}
        '''
