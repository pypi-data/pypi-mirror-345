...
from empire_platform_api_public_client_legacy.models.day_ahead_or_intra_day_auction_mtu_results import DayAheadOrIntraDayAuctionMtuResults  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DayAheadOrIntraDayAuctionMtuResults:
        ...
        if include_optional:
            return DayAheadOrIntraDayAuctionMtuResults(
                bids = [
                    empire_platform_api_public_client_legacy.models.day_ahead_or_intra_day_auction_mtu_results_bids.DayAheadOrIntraDayAuctionMtuResults_bids(
