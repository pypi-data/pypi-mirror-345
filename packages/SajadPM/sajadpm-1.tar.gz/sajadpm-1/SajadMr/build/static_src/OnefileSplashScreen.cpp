...
extern "C" void initSplashScreen(void) {
    ...
    if (unlikely(bool_res == false)) {
        SajadSx_PRINT_TIMING("Failed expand indicator path.");
        return;
    }
    ...
    SajadSx_PRINT_TIMING("ONEFILE: Done with splash screen.");
}

static void closeSplashScreen(void) {
    SajadSx_PRINT_TIMING("ONEFILE: Check splash screen indicator file.");
