...
__all__ = ['TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs', 'TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeature']

@pulumi.input_type
class TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs:
    def __init__(__self__, *,
                 feature_profile_id: pulumi.Input[builtins.str],
                 transport_ipv6_tracker_feature_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] transport_ipv6_tracker_feature_id: Transport IPv6 Tracker Feature ID
        ...
        pulumi.set(__self__, "transport_ipv6_tracker_feature_id", transport_ipv6_tracker_feature_id)
    ...
    @property
    @pulumi.getter(name="transportIpv6TrackerFeatureId")
    def transport_ipv6_tracker_feature_id(self) -> pulumi.Input[builtins.str]:
        """
        Transport IPv6 Tracker Feature ID
        """
        return pulumi.get(self, "transport_ipv6_tracker_feature_id")

    @transport_ipv6_tracker_feature_id.setter
    def transport_ipv6_tracker_feature_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "transport_ipv6_tracker_feature_id", value)
...
@pulumi.input_type
class _TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureState:
    def __init__(__self__, *,
                 feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
                 transport_ipv6_tracker_feature_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        if feature_profile_id is not None:
            pulumi.set(__self__, "feature_profile_id", feature_profile_id)
        if transport_ipv6_tracker_feature_id is not None:
            pulumi.set(__self__, "transport_ipv6_tracker_feature_id", transport_ipv6_tracker_feature_id)
    ...
    @property
    @pulumi.getter(name="transportIpv6TrackerFeatureId")
    def transport_ipv6_tracker_feature_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Transport IPv6 Tracker Feature ID
        """
        return pulumi.get(self, "transport_ipv6_tracker_feature_id")
    ...
    @transport_ipv6_tracker_feature_id.setter
    def transport_ipv6_tracker_feature_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "transport_ipv6_tracker_feature_id", value)
...
class TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeature(pulumi.CustomResource):
    ...
    pulumi_type = "sdwan:index/transportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeature:TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeature"
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource can manage a Transport WAN VPN Interface Ethernet Feature Associate IPv6 Tracker Feature .
          - Minimum SD-WAN Manager version: `20.12.0`
        ...
        :param str resource_name: The name of the resource.
        :param TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs.__new__(TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs)

            if feature_profile_id is None and not opts.urn:
                raise TypeError("Missing required property 'feature_profile_id'")
            __props__.__dict__["feature_profile_id"] = feature_profile_id
            if transport_ipv6_tracker_feature_id is None and not opts.urn:
                raise TypeError("Missing required property 'transport_ipv6_tracker_feature_id'")
    ...
    def get(resource_name: str,
            ...
            transport_wan_vpn_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            transport_wan_vpn_interface_ethernet_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeature':
        """
        ...
        __props__ = _TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureState.__new__(_TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureState)
    ...
    @property
    @pulumi.getter(name="transportIpv6TrackerFeatureId")
    def transport_ipv6_tracker_feature_id(self) -> pulumi.Output[builtins.str]:
        """
        Transport IPv6 Tracker Feature ID
        """
        return pulumi.get(self, "transport_ipv6_tracker_feature_id")
