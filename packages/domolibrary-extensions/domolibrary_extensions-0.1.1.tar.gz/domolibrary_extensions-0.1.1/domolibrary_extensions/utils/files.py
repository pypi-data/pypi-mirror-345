...
# %% auto 0
__all__ = ['rename_filepath_to_match_datatype', 'change_file_suffix', 'detect_encoding', 'read_html_file_as_soup',
           'upsert_folder', 'upsert_file', 'get_all_files_and_folders', 'update_env', 'output_content_and_update_env',
           'ImageBlockConverter', 'md', 'convert_html_to_markdown', 'convert_remove_html_tags', 'download_zip',
           'download_pptx', 'download_markdown', 'generate_filename_from_url']
...
# %% ../../nbs/utils/files.ipynb 34
def download_markdown(content, output_folder, replace_folder: bool = True):

    upsert_file(
        file_path=output_folder, content=md(content), replace_folder=replace_folder
    )

# %% ../../nbs/utils/files.ipynb 36
