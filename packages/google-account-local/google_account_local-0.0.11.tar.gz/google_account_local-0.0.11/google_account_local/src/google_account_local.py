...
class GoogleAccountLocal(
    ...
    def __init__(self, is_test_data: bool = False) -> None:
        ...
        self.user_email = our_get_env(
            "GOOGLE_EMAIL_ADDRESS", raise_if_empty=False, raise_if_not_found=False, default=None
        )
    ...
    def __authorize(self, oauth_state: str = None) -> int:
        ...
        if not auth_code:
            ...
            raise Exception(
                "Auth code not found in the database, you probably didn't choose the Google Account to use in the browser opened."
            )
