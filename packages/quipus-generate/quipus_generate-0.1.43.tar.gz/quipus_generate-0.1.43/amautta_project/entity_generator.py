...
def create(name, microservice = None):
    ...
    archivos = {
        ...
        f"infrastructure/dto/output_{name}.py":(
            ...
            "    example: str = Field(..., description=\"Example field\")\n"
            "    deleted_at: Optional[str] = Field(None, description=\"Timestamp when the user was deleted\")\n"
        ),
        f"infrastructure/models/{name}_model.py":(
            ...
            "\n"
            "from app.user.domain.value_objects.datetime import DateTime\n"
        ...
        f"infrastructure/validations/insert.py":(
            ...
            "\n"
            "class {name.capitalize()}InsertValidation:\n"
            "    @staticmethod\n"
