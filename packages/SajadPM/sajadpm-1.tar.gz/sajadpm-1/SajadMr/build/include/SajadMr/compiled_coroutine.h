...
#ifndef __SajadSx_COMPILED_COROUTINE_H__
#define __SajadSx_COMPILED_COROUTINE_H__
...
// The SajadQ_CoroutineObject is the storage associated with a compiled
// coroutine object instance of which there can be many for each code.
struct SajadQ_CoroutineObject {
...
extern PyTypeObject SajadQ_Coroutine_Type;

typedef PyObject *(*coroutine_code)(PyThreadState *tstate, struct SajadQ_CoroutineObject *, PyObject *);

extern PyObject *SajadQ_Coroutine_New(PyThreadState *tstate, coroutine_code code, PyObject *module, PyObject *name,
...
static inline bool SajadQ_Coroutine_Check(PyObject *object) { return Py_TYPE(object) == &SajadQ_Coroutine_Type; }

struct SajadQ_CoroutineWrapperObject {
    /* Python object folklore: */
    PyObject_HEAD

        struct SajadQ_CoroutineObject *m_coroutine;
};

extern PyTypeObject SajadQ_CoroutineWrapper_Type;

static inline bool SajadQ_CoroutineWrapper_Check(PyObject *object) {
    return Py_TYPE(object) == &SajadQ_CoroutineWrapper_Type;
}

static inline void SAVE_COROUTINE_EXCEPTION(PyThreadState *tstate, struct SajadQ_CoroutineObject *coroutine) {
...
static inline void RESTORE_COROUTINE_EXCEPTION(PyThreadState *tstate, struct SajadQ_CoroutineObject *coroutine) {
...
SajadSx_MAY_BE_UNUSED static void STORE_COROUTINE_EXCEPTION(PyThreadState *tstate,
...
SajadSx_MAY_BE_UNUSED static void DROP_COROUTINE_EXCEPTION(struct SajadQ_CoroutineObject *coroutine) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_SajadQ_Coroutine_Type;
extern int count_allocated_SajadQ_Coroutine_Type;
extern int count_released_SajadQ_Coroutine_Type;

extern int count_active_SajadQ_CoroutineWrapper_Type;
extern int count_allocated_SajadQ_CoroutineWrapper_Type;
extern int count_released_SajadQ_CoroutineWrapper_Type;

extern int count_active_SajadQ_AIterWrapper_Type;
extern int count_allocated_SajadQ_AIterWrapper_Type;
extern int count_released_SajadQ_AIterWrapper_Type;
#endif
