...
class PublicGetAssetListDto(ModelNormal):
    ...
    def _from_openapi_data(
        cls, health_status, id, ingestion_method, name, technology, type, uri, urn, usage, *args, **kwargs
    ):  # noqa: E501
        """PublicGetAssetListDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, health_status, id, ingestion_method, name, technology, type, uri, urn, usage, *args, **kwargs
    ):  # noqa: E501
        """PublicGetAssetListDto - a model defined in OpenAPI
