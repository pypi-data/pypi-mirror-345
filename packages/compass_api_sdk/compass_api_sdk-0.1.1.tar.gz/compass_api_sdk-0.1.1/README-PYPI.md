...
with CompassAPISDK(
    ...
    res = compass_api_sdk.aave_v3.token_price(chain=models.AaveTokenPriceChain.ARBITRUM_MAINNET, token=models.AaveTokenPriceToken.USDC)
...
async def main():
    ...
    async with CompassAPISDK(
        ...
        res = await compass_api_sdk.aave_v3.token_price_async(chain=models.AaveTokenPriceChain.ARBITRUM_MAINNET, token=models.AaveTokenPriceToken.USDC)
