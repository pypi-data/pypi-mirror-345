...
class GetPortfolioAssetIndexPriceV1RespItem(BaseModel):
    """
    GetPortfolioAssetIndexPriceV1RespItem
    """ # noqa: E501
    asset: Optional[StrictStr] = None
    asset_index_price: Optional[StrictStr] = Field(default=None, alias="assetIndexPrice")
    time: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["asset", "assetIndexPrice", "time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "asset": obj.get("asset"),
            "assetIndexPrice": obj.get("assetIndexPrice"),
            "time": obj.get("time")
        })
        return _obj
