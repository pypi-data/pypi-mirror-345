...
import SajadMr.specs.BuiltinUnicodeOperationSpecs
from SajadMr.code_generation.BinaryOperationHelperDefinitions import (
    getSpecializedBinaryOperations,
    isCommutativeOperation,
    parseTypesFromHelper,
)
from SajadMr.code_generation.c_types.CTypePyObjectPointers import (
    make_list_constant_direct_threshold,
    make_list_constant_hinted_threshold,
)
from SajadMr.code_generation.CallCodes import (
    getQuickCallCode,
...
from SajadMr.code_generation.ComparisonHelperDefinitions import (
    getSpecializedComparisonOperations,
)
from SajadMr.code_generation.ImportCodes import getImportModuleHardCodeName
from SajadMr.containers.OrderedSets import OrderedSet
from SajadMr.HardImportRegistry import (
    hard_modules,
...
from SajadMr.utils.Jinja2 import getTemplateC
...
def getDoExtensionUsingTemplateC(template_name):
    return getTemplateC(
        package_name="SajadMr.code_generation",
...
def makeHelpersComparisonOperation(operand, op_code):
    ...
    filename_c = "SajadMr/build/static_src/HelpersComparison%s.c" % op_code.capitalize()
    filename_h = "SajadMr/build/include/SajadMr/helper/comparisons_%s.h" % op_code.lower()
...
def makeHelpersComparisonDualOperation(operand, op_code):
    ...
    filename_c = (
        "SajadMr/build/static_src/HelpersComparisonDual%s.c" % op_code.capitalize()
    )
    filename_h = (
        "SajadMr/build/include/SajadMr/helper/comparisons_dual_%s.h" % op_code.lower()
    )
...
def makeHelpersBinaryOperation(operator, op_code):
    ...
    filename_c = (
        "SajadMr/build/static_src/HelpersOperationBinary%s.c" % op_code.capitalize()
    )
    filename_h = (
        "SajadMr/build/include/SajadMr/helper/operations_binary_%s.h" % op_code.lower()
    )
...
def makeHelpersInplaceOperation(operator, op_code):
    ...
    filename_c = (
        "SajadMr/build/static_src/HelpersOperationInplace%s.c" % op_code.capitalize()
    )
    filename_h = (
        "SajadMr/build/include/SajadMr/helper/operations_inplace_%s.h" % op_code.lower()
    )
...
def makeHelpersBinaryDualOperation(operand, op_code):
    ...
    filename_c = (
        "SajadMr/build/static_src/HelpersOperationBinaryDual%s.c" % op_code.capitalize()
    )
    filename_h = (
        "SajadMr/build/include/SajadMr/helper/operations_binary_dual_%s.h"
        % op_code.lower()
    )
...
def makeHelpersImportHard():
    filename_c = "SajadMr/build/static_src/HelpersImportHard.c"
    filename_h = "SajadMr/build/include/SajadMr/helper/import_hard.h"
...
def makeHelperCalls():
    filename_c = "SajadMr/build/static_src/HelpersCallingGenerated.c"
    filename_h = "SajadMr/build/include/SajadMr/helper/calling_generated.h"
    ...
    with withFileOpenedAndAutoFormatted(filename_c) as output_c:
        with withFileOpenedAndAutoFormatted(filename_h) as output_h:
            ...
            template = getTemplateC(
                "SajadMr.code_generation", "CodeTemplateCallsPositional.c.j2"
            )
            ...
            template = getTemplateC(
                "SajadMr.code_generation", "CodeTemplateCallsMixed.c.j2"
            )
...
def makeHelperLists():
    filename_c = "SajadMr/build/static_src/HelpersListsGenerated.c"
    filename_h = "SajadMr/build/include/SajadMr/helper/lists_generated.h"
    ...
    with withFileOpenedAndAutoFormatted(filename_c) as output_c:
        with withFileOpenedAndAutoFormatted(filename_h) as output_h:
            ...
            template = getTemplateC(
                "SajadMr.code_generation", "CodeTemplateMakeListSmall.c.j2"
            )
            ...
            template = getTemplateC(
                "SajadMr.code_generation", "CodeTemplateMakeListHinted.c.j2"
            )
...
generate_builtin_type_operations = [
    ...
    # that we do not have easy access to, but we might one day for SajadQ-Python
    ...
    (
        "tshape_unicode",
        unicode_desc,
        SajadMr.specs.BuiltinUnicodeOperationSpecs,
        (
            "strip",
            "rstrip",
            "lstrip",
...
def makeDictCopyHelperCodes():
    filename_c = "SajadMr/build/static_src/HelpersDictionariesGenerated.c"
...
def _getCheckForShape(shape):
    ...
    if shape is tshape_str:
        return "SajadQ_String_CheckExact"
...
def makeHelperBuiltinTypeMethods():
    ...
    filename_c = "SajadMr/build/static_src/HelpersBuiltinTypeMethods.c"
    filename_h = "SajadMr/build/include/SajadMr/helper/operations_builtin_types.h"
    with withFileOpenedAndAutoFormatted(filename_c) as output_c:
        with withFileOpenedAndAutoFormatted(filename_h) as output_h:
