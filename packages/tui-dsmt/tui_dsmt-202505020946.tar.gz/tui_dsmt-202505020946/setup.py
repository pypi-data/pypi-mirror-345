requirements = [
    ...
    'fa2_modified==0.3.10',
    'ipyparallel==9.0.1',
    'ipython==9.0.2',  # separate install... otherwise, IPython.utils.coloransi cannot be found
    'matplotlib==3.10.1',
    'mlxtend==0.23.4',
    'mpi4py==4.0.3',  # mpi4py is installed via conda (see Dockerfile)
    'networkx==3.4.2',
    'numpy==1.26.4',  # scikit-learn-extra does not work with NumPy >= 2
    'plotly==6.0.1',
    'pandas==2.2.3',
    'pyarrow==19.0.1',
    'pyfpgrowth==1.0',
