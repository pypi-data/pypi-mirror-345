...
def run_vmeas(config, ps, hv, yr, layer, use_calib_adc):
    """
...
@inject_metadata(test_type=TEST_TYPE)
def run_tmeas(config, ps, hv, yr, layer, use_calib_adc):
    """
...
@inject_metadata(test_type=TEST_TYPE)
def run_vdda_vddd_vs_trim(config, ps, hv, yr, layer, debug_gnd, use_calib_adc):
    """
...
@inject_metadata(test_type=TEST_TYPE)
def run_readregister(config, ps, yr, layer):
    """
