...
class Account(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: Account name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account#name Account#name}
        :param type: the type of account being created. For self-serve customers, use standard. for enterprise customers, use enterprise. Available values: "standard", "enterprise". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account#type Account#type}
        :param settings: Account settings. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account#settings Account#settings}
        :param unit: information related to the tenant unit, and optionally, an id of the unit to create the account on. see https://developers.cloudflare.com/tenant/how-to/manage-accounts/ Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account#unit Account#unit}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Account that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account#import import section} in the documentation of this resource for the id to use
    ...
    def put_settings(
        ...
        *,
        ...
        default_nameservers: typing.Optional[builtins.str] = None,
        enforce_twofactor: typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]] = None,
        use_account_custom_ns_by_default: typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]] = None,
    ) -> None:
        '''
        :param abuse_contact_email: Sets an abuse contact email to notify for abuse reports. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account#abuse_contact_email Account#abuse_contact_email}
        :param default_nameservers: Specifies the default nameservers to be used for new zones added to this account. - ``cloudflare.standard`` for Cloudflare-branded nameservers - ``custom.account`` for account custom nameservers - ``custom.tenant`` for tenant custom nameservers See `Custom Nameservers <https://developers.cloudflare.com/dns/additional-options/custom-nameservers/>`_ for more information. Deprecated in favor of `DNS Settings <https://developers.cloudflare.com/api/operations/dns-settings-for-an-account-update-dns-settings>`_. Available values: "cloudflare.standard", "custom.account", "custom.tenant". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account#default_nameservers Account#default_nameservers}
        :param enforce_twofactor: Indicates whether membership in this account requires that Two-Factor Authentication is enabled. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account#enforce_twofactor Account#enforce_twofactor}
        :param use_account_custom_ns_by_default: Indicates whether new zones should use the account-level custom nameservers by default. Deprecated in favor of `DNS Settings <https://developers.cloudflare.com/api/operations/dns-settings-for-an-account-update-dns-settings>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account#use_account_custom_ns_by_default Account#use_account_custom_ns_by_default}
        '''
    ...
    def put_unit(self, *, id: typing.Optional[builtins.str] = None) -> None:
        '''
        :param id: Tenant unit ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account#id Account#id} Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        '''
...
class AccountSettings:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument default_nameservers", value=default_nameservers, expected_type=type_hints["default_nameservers"])
            check_type(argname="argument enforce_twofactor", value=enforce_twofactor, expected_type=type_hints["enforce_twofactor"])
            check_type(argname="argument use_account_custom_ns_by_default", value=use_account_custom_ns_by_default, expected_type=type_hints["use_account_custom_ns_by_default"])
        self._values: typing.Dict[builtins.str, typing.Any] = {}
        if abuse_contact_email is not None:
            self._values["abuse_contact_email"] = abuse_contact_email
        if default_nameservers is not None:
            self._values["default_nameservers"] = default_nameservers
        ...
        if use_account_custom_ns_by_default is not None:
            self._values["use_account_custom_ns_by_default"] = use_account_custom_ns_by_default
    ...
    @builtins.property
    def default_nameservers(self) -> typing.Optional[builtins.str]:
        ...
        See `Custom Nameservers <https://developers.cloudflare.com/dns/additional-options/custom-nameservers/>`_
        for more information.

        Deprecated in favor of `DNS Settings <https://developers.cloudflare.com/api/operations/dns-settings-for-an-account-update-dns-settings>`_.
        ...
        '''
        result = self._values.get("default_nameservers")
        return typing.cast(typing.Optional[builtins.str], result)
    ...
    @builtins.property
    def use_account_custom_ns_by_default(
        self,
    ) -> typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]]:
        ...
        '''
        result = self._values.get("use_account_custom_ns_by_default")
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]], result)
...
class AccountSettingsOutputReference(
    ...
    @jsii.member(jsii_name="resetDefaultNameservers")
    def reset_default_nameservers(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetDefaultNameservers", []))
    ...
    @jsii.member(jsii_name="resetUseAccountCustomNsByDefault")
    def reset_use_account_custom_ns_by_default(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetUseAccountCustomNsByDefault", []))
    ...
    @builtins.property
    @jsii.member(jsii_name="defaultNameserversInput")
    def default_nameservers_input(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "defaultNameserversInput"))
    ...
    @builtins.property
    @jsii.member(jsii_name="useAccountCustomNsByDefaultInput")
    def use_account_custom_ns_by_default_input(
        self,
    ) -> typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "useAccountCustomNsByDefaultInput"))
    ...
    @builtins.property
    @jsii.member(jsii_name="defaultNameservers")
    def default_nameservers(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "defaultNameservers"))

    @default_nameservers.setter
    def default_nameservers(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__830e5999647ad88cbfedfd92621ff1256dfaddd47593e61a97f896c3e2756615)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "defaultNameservers", value) # pyright: ignore[reportArgumentType]
    ...
    @builtins.property
    @jsii.member(jsii_name="useAccountCustomNsByDefault")
    def use_account_custom_ns_by_default(
        self,
    ) -> typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable], jsii.get(self, "useAccountCustomNsByDefault"))
    ...
    def use_account_custom_ns_by_default(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__96b42032226768f86ae77821613ff2eb96b44182692acaf188aeb052f1b83c3f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "useAccountCustomNsByDefault", value) # pyright: ignore[reportArgumentType]
...
def _typecheckingstub__830e5999647ad88cbfedfd92621ff1256dfaddd47593e61a97f896c3e2756615(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__96b42032226768f86ae77821613ff2eb96b44182692acaf188aeb052f1b83c3f(
    value: typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable],
) -> None:
    """Type checking stubs"""
    pass
