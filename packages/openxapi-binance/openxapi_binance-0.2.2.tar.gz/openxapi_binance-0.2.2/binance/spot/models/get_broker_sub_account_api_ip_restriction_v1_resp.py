...
class GetBrokerSubAccountApiIpRestrictionV1Resp(BaseModel):
    """
    GetBrokerSubAccountApiIpRestrictionV1Resp
    """ # noqa: E501
    apikey: Optional[StrictStr] = None
    ip_list: Optional[List[StrictStr]] = Field(default=None, alias="ipList")
    ...
    __properties: ClassVar[List[str]] = ["apikey", "ipList", "ipRestrict", "subaccountId", "updateTime"]
