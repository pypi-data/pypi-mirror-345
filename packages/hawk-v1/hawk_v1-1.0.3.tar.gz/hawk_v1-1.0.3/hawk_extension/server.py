    ...
    <body>
        <div class="container">
            ...
            <div class="download-section">
                <h2>Download H.A.W.K Extension</h2>
                <p>Click the button below to download the H.A.W.K extension package:</p>
                <a href="/download" class="btn btn-download">Download Extension</a>
            </div>
            
            <div id="step1">
                <h2>Installation Steps</h2>
                <p>After downloading, follow these steps to install the H.A.W.K extension in Chrome:</p>
            </div>
            ...
            <div class="installation-steps">
                ...
                <div class="step">
                    ...
                    <span>Extract the downloaded ZIP file to a location of your choice</span>
                </div>
                <div class="step">
                    <span class="step-num">4</span>
                    <span>Click "Load unpacked" in Chrome and select the "hawk_extension" folder from the extracted files</span>
                </div>
                <div class="step">
...
def download_extension():
    """Serve the extension as a downloadable file"""
    extension_dir = os.path.join(os.path.dirname(__file__), "extension")
    # Create a zip file of the extension with a directory structure
    from zipfile import ZipFile
    import io
    
    memory_file = io.BytesIO()
    with ZipFile(memory_file, 'w') as zf:
        # Create a parent folder structure in the zip file
        parent_folder = "hawk_extension"
        for root, dirs, files in os.walk(extension_dir):
            for file in files:
                file_path = os.path.join(root, file)
                # Get the relative path and add it to the parent folder
                rel_path = os.path.relpath(file_path, extension_dir)
                arcname = os.path.join(parent_folder, rel_path)
    ...
    return send_file(
        memory_file,
        download_name='hawk_extension.zip',
        as_attachment=True,
