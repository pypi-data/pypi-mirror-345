...
class MacroDaemon:
    def __init__(self, target_device_name, macros):
        ...
        self.keyboards = []
        asyncio.create_task(self.update_keyboards())
    ...
    async def pause(self):
        logger.info("[DBUS DEBUG] Received 'pause' command via DBus.")

    async def resume(self):
        logger.info("[DBUS DEBUG] Received 'resume' command via DBus.")

    async def stop(self):
        logger.info("[DBUS DEBUG] Received 'stop' command via DBus.")
