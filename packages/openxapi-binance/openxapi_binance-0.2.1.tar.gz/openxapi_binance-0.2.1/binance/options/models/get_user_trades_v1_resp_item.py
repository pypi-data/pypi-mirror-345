...
class GetUserTradesV1RespItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fee", "id", "liquidity", "optionSide", "orderId", "price", "priceScale", "quantity", "quantityScale", "quoteAsset", "realizedProfit", "side", "symbol", "time", "tradeId", "type", "volatility"]
