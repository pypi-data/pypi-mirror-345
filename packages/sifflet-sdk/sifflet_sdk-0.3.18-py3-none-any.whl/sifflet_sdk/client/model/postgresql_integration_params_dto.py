...
def lazy_import():
    ...
    from sifflet_sdk.client.model.oracle_integration_params_dto_all_of import (
        OracleIntegrationParamsDtoAllOf,
    )
    from sifflet_sdk.client.model.time_zone_dto import TimeZoneDto

    globals()["IntegrationParamsDto"] = IntegrationParamsDto
    globals()["OracleIntegrationParamsDtoAllOf"] = OracleIntegrationParamsDtoAllOf
    globals()["TimeZoneDto"] = TimeZoneDto


class PostgresqlIntegrationParamsDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PostgresqlIntegrationParamsDto - a model defined in OpenAPI
