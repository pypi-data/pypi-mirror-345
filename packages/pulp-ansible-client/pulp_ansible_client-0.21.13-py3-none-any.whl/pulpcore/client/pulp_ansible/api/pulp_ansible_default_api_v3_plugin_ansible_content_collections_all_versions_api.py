...
class PulpAnsibleDefaultApiV3PluginAnsibleContentCollectionsAllVersionsApi(object):
    ...
    def list_with_http_info(self, distro_base_path,  **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/default/api/v3/plugin/ansible/content/{distro_base_path}/collections/all-versions/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
