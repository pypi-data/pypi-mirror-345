...
from SajadMr.Options import isStandaloneMode, shallCreateAppBundle
from SajadMr.plugins.PluginBase import SajadQPluginBase
from SajadMr.PythonFlavors import isHomebrewPython
from SajadMr.PythonVersions import getSystemPrefixPath, getTkInterVersion
...
class SajadQPluginTkinter(SajadQPluginBase):
    ...
    plugin_name = "tk-inter"  # SajadQ knows us by this name
...
Please report as a issue."""
    ...
    def createPreModuleLoadCode(module):
        ...
        if _isTkInterModule(module):
            ...
            code = r"""
import os
os.environ["TCL_LIBRARY"] = os.path.join(__SajadMr_binary_dir, "tcl")
os.environ["TK_LIBRARY"] = os.path.join(__SajadMr_binary_dir, "tk")"""
    ...
    def addPluginCommandLineOptions(cls, group):
        group.add_option(
            ...
            default=None,
            help="""\
The Tk library dir. SajadQ is supposed to automatically detect it, but you can
...
that works, report a bug so it can be added to SajadQ."""
            )
...
class SajadQPluginDetectorTkinter(SajadQPluginBase):
    ...
    detector_for = SajadQPluginTkinter
