...
TMP_DIR     = Path("tmp")
# throttle aria2c to avoid overwhelming the host
CONNS       = 2    # total simultaneous connections per download
SPLITS      = 2    # pieces to split each file into
MIN_SPLIT   = "5M"
MAX_WORKERS = 5    # how many proxy‐racing threads for metadata lookups
TIMEOUT     = 10
