...
def get_overview_module(
    ...
    current_module_dict = current_module.to_dict()
    ...
    from fastpluggy.core.routers.actions.modules import remove_plugin
    ...
    items = [
        ...
        ListButtonView(buttons=[
            FunctionButtonView(
                ...
                call=install_module_requirements,
            ...
            # FunctionButtonView(
            #     label="Load Module", param_inputs={'module_name': plugin_name}, call=load_domain_module
            # ),
        ...
        TabbedView(tabs=[
            TableView(
                ...
                data=current_module_dict.get('models'),
                links=[
