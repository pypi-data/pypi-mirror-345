...
class TestTowerSE(unittest.TestCase):
    ...
    def testExampleRegression(self):
        ...
        npt.assert_almost_equal(
            ...
            [
                [0.40526962, 0.36821094, 0.31520594, 0.28477377, 0.16253415, 0.06753509],
                [0.28063729, 0.25480579, 0.21733269, 0.19389137, 0.10537682, 0.04620917],
            ],
        )
        npt.assert_almost_equal(
        ...
        npt.assert_almost_equal(
            ...
            [
                [0.26039816, 0.21058997, 0.15289471, 0.14166725, 0.0525108 , 0.01429983],
                [0.13498358, 0.10946867, 0.07921019, 0.0738301 , 0.02709445, 0.0099116 ],
            ],
        )
        npt.assert_allclose(
        ...
        npt.assert_almost_equal(
            prob["post.constr_global_buckling"].T,
            [
                [0.65098417, 0.59678994, 0.50458258, 0.45341302, 0.25395848, 0.07910217],
                [0.483598  , 0.44100083, 0.37004085, 0.32810018, 0.17516978, 0.05246313],
            ],
        )
        npt.assert_almost_equal(
            prob["post.constr_shell_buckling"].T,
            [
                [0.05573742, 0.05336165, 0.05151858, 0.07121122, 0.07069755, 0.0711703 ],
                [0.05063498, 0.05015991, 0.04753817, 0.06528223, 0.06251989, 0.06040982],
            ],
        )
        npt.assert_allclose(
            prob["tower.turbine_F"].T,
