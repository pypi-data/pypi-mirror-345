...
class IUpdateAttestationPayload(BaseModel):
    """
    IUpdateAttestationPayload
    """ # noqa: E501
    attestation_id: Optional[StrictStr] = Field(default=None, description="The attestation ID. If you are the owner, you can simply use the attestationId to update the attestation. One of inviteCode or attestationId must be provided.", alias="attestationId")
    invite_code: Optional[StrictStr] = Field(default=None, description="The key to add oneself as a holder to the attestation. This is given to the holder themselves. One of inviteCode or attestationId must be provided.", alias="inviteCode")
    rotate_invite_code: Optional[StrictBool] = Field(default=None, description="Whether or not to rotate the invite code.", alias="rotateInviteCode")
    holders_to_set: Optional[List[IUpdateAttestationPayloadHoldersToSetInner]] = Field(default=None, description="Holders can use the attestation to prove something about themselves. This is a list of holders that have added this attestation to their profile.", alias="holdersToSet")
    anchors_to_add: Optional[List[IUpdateAttestationPayloadAnchorsToAddInner]] = Field(default=None, description="Blockchain anchors to add to the attestation. These are on-chain transactions that can be used to prove stuff about the attestation, like existence at a certain point in time or to maintain data integrity.", alias="anchorsToAdd")
    proof_of_issuance: Optional[ICreateAttestationPayloadProofOfIssuance] = Field(default=None, alias="proofOfIssuance")
    message_format: Optional[StrictStr] = Field(default=None, description="The message format of the messages.", alias="messageFormat")
    scheme: Optional[StrictStr] = Field(default=None, description="The scheme of the attestation. BBS+ signatures are supported and can be used where selective disclosure is a requirement. Otherwise, you can simply use your native blockchain's signature scheme.")
    ...
    messages: Optional[List[StrictStr]] = Field(default=None, description="Thesse are the attestations that are signed. For BBS+ signatures, there can be >1 messages, and the signer can selectively disclose the attestations. For standard signatures, there is only 1 attestationMessage.")
    data_integrity_proof: Optional[IUpdateAttestationPayloadDataIntegrityProof] = Field(default=None, alias="dataIntegrityProof")
    ...
    name: Optional[StrictStr] = Field(default=None, description="Metadata for the attestation for display purposes. Note this should not contain anything sensitive. It may be displayed to verifiers.")
    image: Optional[StrictStr] = Field(default=None, description="Metadata for the attestation for display purposes. Note this should not contain anything sensitive. It may be displayed to verifiers.")
    description: Optional[StrictStr] = Field(default=None, description="Metadata for the attestation for display purposes. Note this should not contain anything sensitive. It may be displayed to verifiers.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["attestationId", "inviteCode", "rotateInviteCode", "holdersToSet", "anchorsToAdd", "proofOfIssuance", "messageFormat", "scheme", "originalProvider", "messages", "dataIntegrityProof", "publicVisibility", "name", "image", "description"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateAttestationPayload from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in holders_to_set (list)
        _items = []
        if self.holders_to_set:
            for _item_holders_to_set in self.holders_to_set:
                if _item_holders_to_set:
                    _items.append(_item_holders_to_set.to_dict())
            _dict['holdersToSet'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in anchors_to_add (list)
        _items = []
        if self.anchors_to_add:
            for _item_anchors_to_add in self.anchors_to_add:
                if _item_anchors_to_add:
                    _items.append(_item_anchors_to_add.to_dict())
            _dict['anchorsToAdd'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateAttestationPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "rotateInviteCode": obj.get("rotateInviteCode"),
            "holdersToSet": [IUpdateAttestationPayloadHoldersToSetInner.from_dict(_item) for _item in obj["holdersToSet"]] if obj.get("holdersToSet") is not None else None,
            "anchorsToAdd": [IUpdateAttestationPayloadAnchorsToAddInner.from_dict(_item) for _item in obj["anchorsToAdd"]] if obj.get("anchorsToAdd") is not None else None,
            "proofOfIssuance": ICreateAttestationPayloadProofOfIssuance.from_dict(obj["proofOfIssuance"]) if obj.get("proofOfIssuance") is not None else None,
            "messageFormat": obj.get("messageFormat"),
            "scheme": obj.get("scheme"),
            "originalProvider": obj.get("originalProvider"),
            "messages": obj.get("messages"),
            "dataIntegrityProof": IUpdateAttestationPayloadDataIntegrityProof.from_dict(obj["dataIntegrityProof"]) if obj.get("dataIntegrityProof") is not None else None,
