...
class SearchCollectionDatasourceIngestionRunDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([DatasourceIngestionRunDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SearchCollectionDatasourceIngestionRunDto - a model defined in OpenAPI

        Args:
            data ([DatasourceIngestionRunDto]):
