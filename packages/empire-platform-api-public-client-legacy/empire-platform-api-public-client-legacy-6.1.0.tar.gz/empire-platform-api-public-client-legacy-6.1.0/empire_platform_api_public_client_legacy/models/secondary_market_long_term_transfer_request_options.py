...
class SecondaryMarketLongTermTransferRequestOptions(BaseModel):
    ...
    """
    available_capacity: StrictInt = Field(default=..., alias="availableCapacity", description="Capacity value in kilowatts (kW) - the required system precision allows for handling capacity values as integers")
