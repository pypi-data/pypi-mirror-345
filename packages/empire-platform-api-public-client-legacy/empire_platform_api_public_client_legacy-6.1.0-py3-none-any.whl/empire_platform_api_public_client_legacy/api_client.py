...
import empire_platform_api_public_client_legacy.models
from empire_platform_api_public_client_legacy import rest
from empire_platform_api_public_client_legacy.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(empire_platform_api_public_client_legacy.models, klass)
