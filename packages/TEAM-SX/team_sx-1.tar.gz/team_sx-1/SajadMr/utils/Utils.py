...
from SajadMr.__past__ import WindowsError  # pylint: disable=I0021,redefined-builtin
...
def getLaunchingSajadQProcessEnvironmentValue(environment_variable_name):
    ...
    from SajadMr import getLaunchingSajadQProcessEnvironmentValue

    return getLaunchingSajadQProcessEnvironmentValue(environment_variable_name)
