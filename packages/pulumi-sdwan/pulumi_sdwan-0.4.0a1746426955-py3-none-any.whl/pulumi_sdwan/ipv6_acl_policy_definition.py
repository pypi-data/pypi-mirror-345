...
__all__ = ['Ipv6AclPolicyDefinitionArgs', 'Ipv6AclPolicyDefinition']

@pulumi.input_type
class Ipv6AclPolicyDefinitionArgs:
    def __init__(__self__, *,
                 description: pulumi.Input[builtins.str],
                 sequences: pulumi.Input[Sequence[pulumi.Input['Ipv6AclPolicyDefinitionSequenceArgs']]],
    ...
    @property
    @pulumi.getter
    def sequences(self) -> pulumi.Input[Sequence[pulumi.Input['Ipv6AclPolicyDefinitionSequenceArgs']]]:
        """
    ...
    @sequences.setter
    def sequences(self, value: pulumi.Input[Sequence[pulumi.Input['Ipv6AclPolicyDefinitionSequenceArgs']]]):
...
@pulumi.input_type
class _Ipv6AclPolicyDefinitionState:
    def __init__(__self__, *,
                 default_action: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 sequences: Optional[pulumi.Input[Sequence[pulumi.Input['Ipv6AclPolicyDefinitionSequenceArgs']]]] = None,
    ...
    @property
    @pulumi.getter
    def sequences(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['Ipv6AclPolicyDefinitionSequenceArgs']]]]:
        """
        List of ACL sequences
        """
        return pulumi.get(self, "sequences")
    ...
    @sequences.setter
    def sequences(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['Ipv6AclPolicyDefinitionSequenceArgs']]]]):
        pulumi.set(self, "sequences", value)
...
class Ipv6AclPolicyDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param Ipv6AclPolicyDefinitionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Ipv6AclPolicyDefinitionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = Ipv6AclPolicyDefinitionArgs.__new__(Ipv6AclPolicyDefinitionArgs)
        ...
        super(Ipv6AclPolicyDefinition, __self__).__init__(
            'sdwan:index/ipv6AclPolicyDefinition:Ipv6AclPolicyDefinition',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            sequences: Optional[pulumi.Input[Sequence[pulumi.Input[Union['Ipv6AclPolicyDefinitionSequenceArgs', 'Ipv6AclPolicyDefinitionSequenceArgsDict']]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'Ipv6AclPolicyDefinition':
        """
        ...
        __props__ = _Ipv6AclPolicyDefinitionState.__new__(_Ipv6AclPolicyDefinitionState)
        ...
        return Ipv6AclPolicyDefinition(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def sequences(self) -> pulumi.Output[Sequence['outputs.Ipv6AclPolicyDefinitionSequence']]:
        """
        List of ACL sequences
        """
        return pulumi.get(self, "sequences")
