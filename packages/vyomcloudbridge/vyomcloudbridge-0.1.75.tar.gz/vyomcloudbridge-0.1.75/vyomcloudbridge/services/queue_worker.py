...
class QueueWorker(ServiceAbstract):
    ...
    def __init__(self, multi_thread: bool = False):
        try:
            ...
            self.rabbit_mq = ThreadedRabbitMQ() if parse_bool(multi_thread) else RabbitMQ()
    ...
    def proccess_deque_message(self, message: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            return self.vyom_sender.send_message(
    ...
    def stop(self):
        ...
        try:
            if self.is_running:
                self.logger.info("Yeah, are you able to join convert? QueueWorker service...")
