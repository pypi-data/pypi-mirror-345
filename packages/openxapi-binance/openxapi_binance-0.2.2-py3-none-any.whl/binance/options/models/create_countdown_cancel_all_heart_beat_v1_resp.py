...
class CreateCountdownCancelAllHeartBeatV1Resp(BaseModel):
    """
    CreateCountdownCancelAllHeartBeatV1Resp
    """ # noqa: E501
    underlyings: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["underlyings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "underlyings": obj.get("underlyings")
        })
        return _obj
