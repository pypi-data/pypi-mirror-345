...
def lazy_import():
    from sifflet_sdk.client.model.big_query_integer_range_partitioning_properties_all_of import (
        BigQueryIntegerRangePartitioningPropertiesAllOf,
    )
    from sifflet_sdk.client.model.big_query_partitioning_properties import (
        BigQueryPartitioningProperties,
    )

    globals()["BigQueryIntegerRangePartitioningPropertiesAllOf"] = BigQueryIntegerRangePartitioningPropertiesAllOf
    globals()["BigQueryPartitioningProperties"] = BigQueryPartitioningProperties


class BigQueryIntegerRangePartitioningProperties(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BigQueryIntegerRangePartitioningProperties - a model defined in OpenAPI
