...
class OthetOVozvratahIPeremeheniiTovarovApi(object):
    ...
    def api_v1_analytics_goods_return_get(self, date_from, date_to, **kwargs):  # noqa: E501
        """Poluhit othet  # noqa: E501

        Metod predostavlaet othet o [vozvratah tovarov prodavcu](https://seller.wildberries.ru/analytics-reports/goods-return). <br><br>  Mohno poluhit othet maksimum za 31 den.  <div class=\"description_limit\">     Maksimum 1 zapros v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> na odin akkaunt prodavca </div>    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v1_analytics_goods_return_get(date_from, date_to, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api_v1_analytics_goods_return_get_with_http_info(date_from, date_to, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v1_analytics_goods_return_get_with_http_info(date_from, date_to, **kwargs)  # noqa: E501
            return data

    def api_v1_analytics_goods_return_get_with_http_info(self, date_from, date_to, **kwargs):  # noqa: E501
        """Poluhit othet  # noqa: E501

        Metod predostavlaet othet o [vozvratah tovarov prodavcu](https://seller.wildberries.ru/analytics-reports/goods-return). <br><br>  Mohno poluhit othet maksimum za 31 den.  <div class=\"description_limit\">     Maksimum 1 zapros v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> na odin akkaunt prodavca </div>    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v1_analytics_goods_return_get_with_http_info(date_from, date_to, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v1_analytics_goods_return_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('date_from' not in params or
            ...
            raise ValueError("Missing the required parameter `date_from` when calling `api_v1_analytics_goods_return_get`")  # noqa: E501
        # verify the required parameter 'date_to' is set
        if ('date_to' not in params or
                params['date_to'] is None):
            raise ValueError("Missing the required parameter `date_to` when calling `api_v1_analytics_goods_return_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/analytics/goods-return', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
