...
class PulpAnsibleDefaultApiV3PluginAnsibleContentCollectionsArtifactsApi(object):
    ...
    def download(self, distro_base_path, filename,  **kwargs):  # noqa: E501
        """download  # noqa: E501

        Collection download endpoint.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.download(distro_base_path, filename, async_req=True)
        >>> result = thread.get()
        ...
        return self.download_with_http_info(distro_base_path, filename,  **kwargs)  # noqa: E501

    def download_with_http_info(self, distro_base_path, filename,  **kwargs):  # noqa: E501
        """download  # noqa: E501

        Collection download endpoint.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.download_with_http_info(distro_base_path, filename, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/default/api/v3/plugin/ansible/content/{distro_base_path}/collections/artifacts/{filename}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
