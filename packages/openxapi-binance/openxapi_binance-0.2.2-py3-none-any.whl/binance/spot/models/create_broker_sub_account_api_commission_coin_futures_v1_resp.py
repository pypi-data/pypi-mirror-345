...
class CreateBrokerSubAccountApiCommissionCoinFuturesV1Resp(BaseModel):
    """
    CreateBrokerSubAccountApiCommissionCoinFuturesV1Resp
    """ # noqa: E501
    maker_adjustment: Optional[StrictInt] = Field(default=None, alias="makerAdjustment")
    maker_commission: Optional[StrictInt] = Field(default=None, alias="makerCommission")
    pair: Optional[StrictStr] = None
    sub_account_id: Optional[StrictInt] = Field(default=None, alias="subAccountId")
    taker_adjustment: Optional[StrictInt] = Field(default=None, alias="takerAdjustment")
    taker_commission: Optional[StrictInt] = Field(default=None, alias="takerCommission")
    __properties: ClassVar[List[str]] = ["makerAdjustment", "makerCommission", "pair", "subAccountId", "takerAdjustment", "takerCommission"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "makerAdjustment": obj.get("makerAdjustment"),
            "makerCommission": obj.get("makerCommission"),
            "pair": obj.get("pair"),
            "subAccountId": obj.get("subAccountId"),
            "takerAdjustment": obj.get("takerAdjustment"),
