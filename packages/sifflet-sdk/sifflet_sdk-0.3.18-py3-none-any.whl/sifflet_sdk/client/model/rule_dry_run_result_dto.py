...
class RuleDryRunResultDto(ModelNormal):
    ...
    attribute_map = {
        ...
        "failing_rows": "failingRows",  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, failing_rows, status, *args, **kwargs):  # noqa: E501
        """RuleDryRunResultDto - a model defined in OpenAPI

        Args:
            description (str):
            failing_rows ([{str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)}]):
            status (str):
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, failing_rows, status, *args, **kwargs):  # noqa: E501
        """RuleDryRunResultDto - a model defined in OpenAPI
