...
from empire_platform_api_public_client_legacy.models.auction_overview import AuctionOverview  # noqa: E501

class TestAuctionOverview(unittest.TestCase):
    """AuctionOverview unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionOverview:
        """Test AuctionOverview
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionOverview`
        """
        model = AuctionOverview()  # noqa: E501
        if include_optional:
            return AuctionOverview(
                ...
                buy_now_offers = [
                    empire_platform_api_public_client_legacy.models.buy_now_offer_overview_item.BuyNowOfferOverviewItem(
                        display_id = '', 
