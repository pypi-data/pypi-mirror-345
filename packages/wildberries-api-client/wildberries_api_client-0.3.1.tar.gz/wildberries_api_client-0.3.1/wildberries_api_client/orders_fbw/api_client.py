...
import wildberries_api_client.orders_fbw.models
from wildberries_api_client.orders_fbw import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wildberries_api_client.orders_fbw.models, klass)
