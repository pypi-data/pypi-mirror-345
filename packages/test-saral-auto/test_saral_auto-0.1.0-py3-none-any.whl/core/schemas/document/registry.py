"""
This module contains the registry for the block types. It is used to register the block types and get the block class.
"""
...
from core.schemas.document.blocks import Block, Caption, Code, Equation, Figure, \
...
from core.schemas.document.groups import FigureGroup, ListGroup, PageGroup, \
