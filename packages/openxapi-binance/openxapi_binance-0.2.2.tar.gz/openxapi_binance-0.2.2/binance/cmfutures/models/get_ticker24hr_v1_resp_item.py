...
class GetTicker24hrV1RespItem(BaseModel):
    """
    GetTicker24hrV1RespItem
    """ # noqa: E501
    base_volume: Optional[StrictStr] = Field(default=None, alias="baseVolume")
    ...
    __properties: ClassVar[List[str]] = ["baseVolume", "closeTime", "count", "firstId", "highPrice", "lastId", "lastPrice", "lastQty", "lowPrice", "openPrice", "openTime", "pair", "priceChange", "priceChangePercent", "symbol", "volume", "weightedAvgPrice"]
