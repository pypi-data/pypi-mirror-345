...
extern "C" size_t hel_ZZXdeg(const NTL::ZZX *x) { return deg(*x); }
...
extern "C" NTL::ZZX *hel_alloc_ZZX_array(size_t n) { return new NTL::ZZX[n]; }
extern "C" void hel_ZZX_setlength(NTL::ZZX *x, size_t n) { (*x).SetLength(n); }
extern "C" void hel_conv_hists(NTL::ZZX *dest, const NTL::ZZX *src1,
                               const NTL::ZZX *src2) {
  *dest = *src1 * *src2;
}
extern "C" NTL::ZZ *hel_ZZX_index(NTL::ZZX *x, size_t n) { return &((*x)[n]); }
extern "C" void hel_ZZX_index_assign(NTL::ZZX *x, size_t n,
                                     const NTL::ZZ *val) {
  (*x)[n] = *val;
}
extern "C" void hel_ZZ_add(NTL::ZZ *dest, const NTL::ZZ *op1,
                           const NTL::ZZ *op2) {
  *dest = *op1 + *op2;
}
extern "C" void hel_ZZ_incr(NTL::ZZ *dest) { *dest = *dest + 1; }
extern "C" NTL::ZZX *hel_new_ZZX() { return new NTL::ZZX(); }
extern "C" void hel_delete_ZZX(NTL::ZZX *x) { delete x; }
extern "C" void hel_trunc_ZZX(NTL::ZZX *x, long m) { trunc(*x, *x, m); }
...
extern "C" void hel_ZZX_normalize(NTL::ZZX *x) { (*x).normalize(); }
