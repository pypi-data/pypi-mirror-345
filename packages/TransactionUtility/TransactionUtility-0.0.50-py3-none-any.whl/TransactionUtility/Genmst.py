    ...
    def insert_or_update_genmst(self, column, connection, con_type):
        ...
        if missing_keys:
            ...
            if con_type == 'Oracle':
                ...
                values = [
                    {
                        ...
                        'arg_type': 'C.String', 'arg_xfrm': None, 'chg_date': datetime.now().strftime('%d-%m-%y'), 'chg_user': 'System', 'chg_term': 'System', 'arg_value': None
                    },
                    {
                ...
                """
                values = [
                    ('post_gen_val', 1, 'COMPONENT_TYPE', 'I', None, 'C.String', None, datetime.now().strftime('%d-%m-%y'), 'System', 'System', None),
