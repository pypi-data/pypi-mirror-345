...
def lazy_import():
    from sifflet_sdk.client.model.collaboration_tool_status_change_event_dto_all_of import (
        CollaborationToolStatusChangeEventDtoAllOf,
    )
    from sifflet_sdk.client.model.incident_event_dto import IncidentEventDto

    globals()["CollaborationToolStatusChangeEventDtoAllOf"] = CollaborationToolStatusChangeEventDtoAllOf
    globals()["IncidentEventDto"] = IncidentEventDto


class CollaborationToolStatusChangeEventDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CollaborationToolStatusChangeEventDto - a model defined in OpenAPI
