...
class V0KeywordsStatisticsResponse(object):
    ...
    """
    swagger_types = {
        'keywords': 'list[V0KeywordsStatistics]'
    }
    ...
    def __init__(self, keywords=None):  # noqa: E501
        """V0KeywordsStatisticsResponse - a model defined in Swagger"""  # noqa: E501
        self._keywords = None
    ...
    @property
    def keywords(self):
        """Gets the keywords of this V0KeywordsStatisticsResponse.  # noqa: E501


        :return: The keywords of this V0KeywordsStatisticsResponse.  # noqa: E501
        :rtype: list[V0KeywordsStatistics]
        """
        return self._keywords

    @keywords.setter
    def keywords(self, keywords):
        """Sets the keywords of this V0KeywordsStatisticsResponse.


        :param keywords: The keywords of this V0KeywordsStatisticsResponse.  # noqa: E501
        :type: list[V0KeywordsStatistics]
        """
        if keywords is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V0KeywordsStatisticsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V0KeywordsStatisticsResponse):
            return False
