...
class OrderOptions(object):
    ...
    def __init__(self, is_b2b=None):  # noqa: E501
        """OrderOptions - a model defined in Swagger"""  # noqa: E501
        self._is_b2b = None
    ...
    @property
    def is_b2b(self):
        """Gets the is_b2b of this OrderOptions.  # noqa: E501

        Priznak B2B-prodahi:   - <code>false</code> — ne B2B-prodaha   - <code>true</code> — B2B-prodaha   # noqa: E501

        :return: The is_b2b of this OrderOptions.  # noqa: E501
        :rtype: bool
        """
        return self._is_b2b
    ...
    def is_b2b(self, is_b2b):
        """Sets the is_b2b of this OrderOptions.

        Priznak B2B-prodahi:   - <code>false</code> — ne B2B-prodaha   - <code>true</code> — B2B-prodaha   # noqa: E501

        :param is_b2b: The is_b2b of this OrderOptions.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrderOptions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrderOptions):
            return False
