...
class CalculationDiagram(_message.Message):
    ...
    vertical_axis_object: int
    vertical_axis_node: int
    table: CalculationDiagram.Table
    comment: str
    id_for_export_import: str
    metadata_for_export_import: str
    def __init__(self, no: _Optional[int] = ..., user_defined_name_enabled: bool = ..., name: _Optional[str] = ..., diagram_type: _Optional[_Union[CalculationDiagram.DiagramType, str]] = ..., analysis_type: _Optional[_Union[CalculationDiagram.AnalysisType, str]] = ..., case: _Optional[int] = ..., horizontal_axis_result_type: _Optional[_Union[CalculationDiagram.HorizontalAxisResultType, str]] = ..., horizontal_axis_value: _Optional[_Union[CalculationDiagram.HorizontalAxisValue, str]] = ..., horizontal_axis_object: _Optional[int] = ..., horizontal_axis_node: _Optional[int] = ..., vertical_axis_result_type: _Optional[_Union[CalculationDiagram.VerticalAxisResultType, str]] = ..., vertical_axis_value: _Optional[_Union[CalculationDiagram.VerticalAxisValue, str]] = ..., vertical_axis_object: _Optional[int] = ..., vertical_axis_node: _Optional[int] = ..., table: _Optional[_Union[CalculationDiagram.Table, _Mapping]] = ..., comment: _Optional[str] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...
