...
class SamlRolesArgs:
    def __init__(__self__, *,
                 ...
                 saml_role_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] org_access: The privilege of the SAML administrator on the organization
        :param pulumi.Input[builtins.str] role: The role of the SAML administrator
        :param pulumi.Input[builtins.str] saml_role_id: samlRoleId path parameter. Saml role ID
    ...
    def saml_role_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @saml_role_id.setter
    def saml_role_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SamlRoles(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="samlRoleId")
    def saml_role_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        samlRoleId path parameter. Saml role ID
        """
        return pulumi.get(self, "saml_role_id")
