...
class GetAlgoSpotHistoricalOrdersV1RespOrdersInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["algoId", "algoStatus", "algoType", "avgPrice", "bookTime", "clientAlgoId", "endTime", "executedAmt", "executedQty", "side", "symbol", "totalQty", "urgency"]
