...
class CdoCliResultPage(BaseModel):
    """
    CdoCliResultPage
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="The total number of results available.")
    items: Optional[List[CdoCliResult]] = Field(default=None, description="The list of items retrieved.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "items": [CdoCliResult.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "limit": obj.get("limit"),
