...
def full_process_wrapper(default_dir):
    ...
    raw_data = pf.resample_to_hourly(df=raw_data) #resamples the input data to hourly intevals
    ...
    #~~~ BOKEH HTML INTERACTIVE PLOT PAGE ~~~#
    vf.plot_page(df=processed_sm_data)
