...
@_include_global_option_docs
def IntegerField(
    initial_value=None, validator=None, min=0, max=100, increment=1, **layout_options
):
    """
...
@_include_global_option_docs
def TextArea(
    initial_value=None, height=None, readonly=False, validator=None, **layout_options
):
    """
...
def DirectoryChooser(
    wildcard=None, default_path=None, message=None, initial_value=None, **layout_options
):
    """
...
def _clean(options):
    cleaned = {
        k: v for k, v in options.items() if v is not None and k != "layout_options"
    }
