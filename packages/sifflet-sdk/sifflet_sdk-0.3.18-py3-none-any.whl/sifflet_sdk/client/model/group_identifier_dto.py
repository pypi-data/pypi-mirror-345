...
class GroupIdentifierDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, hash, keys, values, *args, **kwargs):  # noqa: E501
        """GroupIdentifierDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, hash, keys, values, *args, **kwargs):  # noqa: E501
        """GroupIdentifierDto - a model defined in OpenAPI
