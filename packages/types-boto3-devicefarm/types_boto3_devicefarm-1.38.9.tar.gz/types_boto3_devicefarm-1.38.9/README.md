<a id="types-boto3-devicefarm"></a>

# types-boto3-devicefarm

[![PyPI - types-boto3-devicefarm](https://img.shields.io/pypi/v/types-boto3-devicefarm.svg?color=blue)](https://pypi.org/project/types-boto3-devicefarm/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-devicefarm.svg?color=blue)](https://pypi.org/project/types-boto3-devicefarm/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-devicefarm)](https://pypistats.org/packages/types-boto3-devicefarm)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 DeviceFarm 1.38.9](https://pypi.org/project/boto3/)
...
[types-boto3-devicefarm docs](https://youtype.github.io/types_boto3_docs/types_boto3_devicefarm/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-devicefarm](#types-boto3-devicefarm)
...
- Install `types-boto3[devicefarm]` in your environment:
...
- Install `types-boto3[devicefarm]` with services you use in your environment:
...
`types-boto3-devicefarm` dependency in production. However, there is an issue
...
from types_boto3_devicefarm import DeviceFarmClient
...
`types_boto3_devicefarm.paginator` module contains type annotations for all
paginators.
...
from types_boto3_devicefarm import DeviceFarmClient
from types_boto3_devicefarm.paginator import (
...
`types_boto3_devicefarm.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `DeviceFarm` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_devicefarm/literals/).
...
`types_boto3_devicefarm.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `DeviceFarm` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_devicefarm/type_defs/).
...
`types-boto3-devicefarm` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_devicefarm/)
