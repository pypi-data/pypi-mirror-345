...
`,I=e=>u.iv`
  ...
  color: ${e.colors.grayscale.base};
`,z=e=>{var t;return"object"==typeof e&&Array.isArray(e._schema)&&!(null==(t=e._schema)||!t.find((e=>"Must provide a password for the database"===e)))},P=e=>{var t;return"object"==typeof e&&Array.isArray(e._schema)&&!(null==(t=e._schema)||!t.find((e=>"Must provide a password for the ssh tunnel"===e)))},M=e=>{var t;return"object"==typeof e&&Array.isArray(e._schema)&&!(null==(t=e._schema)||!t.find((e=>"Must provide a private key for the ssh tunnel"===e)))},K=e=>{var t;return"object"==typeof e&&Array.isArray(e._schema)&&!(null==(t=e._schema)||!t.find((e=>"Must provide a private key password for the ssh tunnel"===e)))},A=e=>"string"==typeof e&&e.includes("already exists and `overwrite=true` was not passed"),D=e=>e.map((e=>Object.entries(e.extra).filter((([,e])=>z(e))).map((([e])=>e)))).flat(),F=e=>e.map((e=>Object.entries(e.extra).filter((([,e])=>P(e))).map((([e])=>e)))).flat(),q=e=>e.map((e=>Object.entries(e.extra).filter((([,e])=>M(e))).map((([e])=>e)))).flat(),B=e=>e.map((e=>Object.entries(e.extra).filter((([,e])=>K(e))).map((([e])=>e)))).flat(),L=e=>e.map((e=>Object.entries(e.extra).filter((([,e])=>A(e))).map((([e])=>e)))).flat(),X=e=>e.some((e=>{const t=Object.entries(e.extra).filter((([e])=>"issue_codes"!==e));return 0===t.length||!t.every((([,e])=>z(e)||A(e)||P(e)||M(e)||K(e)))})),V=(e,t)=>void 0!==e&&a()(e,t).length>0,G=(e,t,r,n,a)=>{const o=(0,g.R)("can_csv_upload","Database",e)&&V(t,a),i=V(r,a)&&(0,g.R)("can_columnar_upload","Database",e),s=V(n,a)&&(0,g.R)("can_excel_upload","Database",e);return{canUploadCSV:o,canUploadColumnar:i,canUploadExcel:s,canUploadData:o||i||s}};function H(e,t,r,n){return e===f.F.Created||t===b.g.SavedQueries&&e===f.F.Mine?[{id:"created_by",operator:"rel_o_m",value:`${null==r?void 0:r.userId}`}]:t===b.g.SavedQueries&&e===f.F.Favorite?[{id:"id",operator:"saved_query_is_fav",value:!0}]:e===f.F.Mine&&r?[{id:"owners",operator:"rel_m_m",value:`${r.userId}`}]:e===f.F.Favorite&&[b.g.Dashboards,b.g.Charts].includes(t)?[{id:"id",operator:t===b.g.Dashboards?"dashboard_is_favorite":"chart_is_favorite",value:!0}]:e===f.F.Other?(n||[]).map((e=>({id:e.col,operator:e.opr,value:e.value}))):[]}}}]);
//# sourceMappingURL=8003.6df80773e92bc201b3fd.entry.js.map