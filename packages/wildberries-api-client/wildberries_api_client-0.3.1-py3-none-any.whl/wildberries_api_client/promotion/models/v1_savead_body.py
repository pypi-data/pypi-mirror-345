...
class V1SaveadBody(object):
    ...
    def subject_id(self):
        ...
        ID predmeta, dla kotorogo sozdaetsa kampania.<br> Suhestvuuhie u prodavca ID mohno poluhit metodom iz razdela \"Kontent / Prosmotr\" - \"Spisok NM\", pole otveta - `subjectID`.   # noqa: E501
    ...
    def btype(self):
        ...
        <dl> <dt>Tip spisania.</dt> <dd><code>0</code> - Shet</dd> <dd><code>1</code> - Balans</dd> <dd><code>3</code> - Bonusy</dd> </dl>   # noqa: E501
    ...
    def nms(self):
        ...
        Massiv artikulov WB. <br> Maksimum 100 artikulov.    # noqa: E501
    ...
    def cpm(self):
        ...
        Stavka. <br> Esli budet ukazana stavka menhe dopustimogo razmera, to avtomatiheski ustanovitsa stavka minimalno dopustimogo razmera.   # noqa: E501
