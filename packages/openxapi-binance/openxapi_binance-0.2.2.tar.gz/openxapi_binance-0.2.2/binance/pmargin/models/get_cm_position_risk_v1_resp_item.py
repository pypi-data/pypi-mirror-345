...
class GetCmPositionRiskV1RespItem(BaseModel):
    """
    ...
    notional_value: Optional[StrictStr] = Field(default=None, alias="notionalValue")
    ...
    __properties: ClassVar[List[str]] = ["entryPrice", "leverage", "liquidationPrice", "markPrice", "maxQty", "notionalValue", "positionAmt", "positionSide", "symbol", "unRealizedProfit", "updateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notionalValue": obj.get("notionalValue"),
