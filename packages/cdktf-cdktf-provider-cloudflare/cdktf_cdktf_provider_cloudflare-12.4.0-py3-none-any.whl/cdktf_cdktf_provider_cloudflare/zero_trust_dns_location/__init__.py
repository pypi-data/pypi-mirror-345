...
Refer to the Terraform Registry for docs: [`cloudflare_zero_trust_dns_location`](https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location).
'''
...
class ZeroTrustDnsLocation(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#account_id ZeroTrustDnsLocation#account_id}.
        :param name: The name of the location. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#name ZeroTrustDnsLocation#name}
        :param client_default: True if the location is the default location. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#client_default ZeroTrustDnsLocation#client_default}
        :param dns_destination_ips_id: The identifier of the pair of IPv4 addresses assigned to this location. When creating a location, if this field is absent or set with null, the pair of shared IPv4 addresses (0e4a32c6-6fb8-4858-9296-98f51631e8e6) is auto-assigned. When updating a location, if the field is absent or set with null, the pre-assigned pair remains unchanged. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#dns_destination_ips_id ZeroTrustDnsLocation#dns_destination_ips_id}
        :param ecs_support: True if the location needs to resolve EDNS queries. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#ecs_support ZeroTrustDnsLocation#ecs_support}
        :param endpoints: The destination endpoints configured for this location. When updating a location, if this field is absent or set with null, the endpoints configuration remains unchanged. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#endpoints ZeroTrustDnsLocation#endpoints}
        :param networks: A list of network ranges that requests from this location would originate from. A non-empty list is only effective if the ipv4 endpoint is enabled for this location. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#networks ZeroTrustDnsLocation#networks}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing ZeroTrustDnsLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#import import section} in the documentation of this resource for the id to use
    ...
    def put_endpoints(
        self,
        *,
        doh: typing.Optional[typing.Union["ZeroTrustDnsLocationEndpointsDoh", typing.Dict[builtins.str, typing.Any]]] = None,
        dot: typing.Optional[typing.Union["ZeroTrustDnsLocationEndpointsDot", typing.Dict[builtins.str, typing.Any]]] = None,
        ipv4: typing.Optional[typing.Union["ZeroTrustDnsLocationEndpointsIpv4", typing.Dict[builtins.str, typing.Any]]] = None,
        ipv6: typing.Optional[typing.Union["ZeroTrustDnsLocationEndpointsIpv6", typing.Dict[builtins.str, typing.Any]]] = None,
    ) -> None:
        '''
        :param doh: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#doh ZeroTrustDnsLocation#doh}.
        :param dot: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#dot ZeroTrustDnsLocation#dot}.
        :param ipv4: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#ipv4 ZeroTrustDnsLocation#ipv4}.
        :param ipv6: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#ipv6 ZeroTrustDnsLocation#ipv6}.
        '''
...
class ZeroTrustDnsLocationEndpoints:
    ...
    @builtins.property
    def doh(self) -> typing.Optional["ZeroTrustDnsLocationEndpointsDoh"]:
        ...
        return typing.cast(typing.Optional["ZeroTrustDnsLocationEndpointsDoh"], result)

    @builtins.property
    def dot(self) -> typing.Optional["ZeroTrustDnsLocationEndpointsDot"]:
        ...
        return typing.cast(typing.Optional["ZeroTrustDnsLocationEndpointsDot"], result)

    @builtins.property
    def ipv4(self) -> typing.Optional["ZeroTrustDnsLocationEndpointsIpv4"]:
        ...
        return typing.cast(typing.Optional["ZeroTrustDnsLocationEndpointsIpv4"], result)

    @builtins.property
    def ipv6(self) -> typing.Optional["ZeroTrustDnsLocationEndpointsIpv6"]:
        ...
        return typing.cast(typing.Optional["ZeroTrustDnsLocationEndpointsIpv6"], result)
...
class ZeroTrustDnsLocationEndpointsDoh:
    def __init__(
        ...
        *,
        ...
        '''
        :param enabled: True if the endpoint is enabled for this location. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#enabled ZeroTrustDnsLocation#enabled}
        :param networks: A list of allowed source IP network ranges for this endpoint. When empty, all source IPs are allowed. A non-empty list is only effective if the endpoint is enabled for this location. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#networks ZeroTrustDnsLocation#networks}
        :param require_token: True if the endpoint requires `user identity <https://developers.cloudflare.com/cloudflare-one/connections/connect-devices/agentless/dns/dns-over-https/#filter-doh-requests-by-user>`_ authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#require_token ZeroTrustDnsLocation#require_token}
        '''
        if __debug__:
    ...
    def require_token(
        ...
        '''True if the endpoint requires `user identity <https://developers.cloudflare.com/cloudflare-one/connections/connect-devices/agentless/dns/dns-over-https/#filter-doh-requests-by-user>`_ authentication.
...
class ZeroTrustDnsLocationEndpointsDohNetworks:
    def __init__(self, *, network: builtins.str) -> None:
        '''
        :param network: The IP address or IP CIDR. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#network ZeroTrustDnsLocation#network}
        '''
        if __debug__:
...
class ZeroTrustDnsLocationEndpointsIpv6:
    def __init__(
        ...
        *,
        ...
        '''
        :param enabled: True if the endpoint is enabled for this location. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#enabled ZeroTrustDnsLocation#enabled}
        :param networks: A list of allowed source IPv6 network ranges for this endpoint. When empty, all source IPs are allowed. A non-empty list is only effective if the endpoint is enabled for this location. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#networks ZeroTrustDnsLocation#networks}
        '''
        if __debug__:
...
class ZeroTrustDnsLocationEndpointsIpv6Networks:
    def __init__(self, *, network: builtins.str) -> None:
        '''
        :param network: The IPv6 address or IPv6 CIDR. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#network ZeroTrustDnsLocation#network}
        '''
        if __debug__:
...
class ZeroTrustDnsLocationNetworks:
    def __init__(self, *, network: builtins.str) -> None:
        '''
        :param network: The IPv4 address or IPv4 CIDR. IPv4 CIDRs are limited to a maximum of /24. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_dns_location#network ZeroTrustDnsLocation#network}
        '''
        if __debug__:
