...
def lazy_import():
    ...
    from sifflet_sdk.client.model.public_source_v2_tableau_parameters_dto_all_of import (
        PublicSourceV2TableauParametersDtoAllOf,
    )

    globals()["PublicSourceV2ParametersDto"] = PublicSourceV2ParametersDto
    globals()["PublicSourceV2TableauParametersDtoAllOf"] = PublicSourceV2TableauParametersDtoAllOf


class PublicSourceV2TableauParametersDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PublicSourceV2TableauParametersDto - a model defined in OpenAPI

        Keyword Args:
            host (str): Your Tableau Server hostname
            type (str):
