...
class InlineResponse20012Dimensions(object):
    ...
    def __init__(self, length=None, width=None, height=None, weight_brutto=None, is_valid=None):  # noqa: E501
        """InlineResponse20012Dimensions - a model defined in Swagger"""  # noqa: E501
        self._length = None
        self._width = None
        self._height = None
    ...
    @property
    def length(self):
        """Gets the length of this InlineResponse20012Dimensions.  # noqa: E501

        Dlina, sm  # noqa: E501

        :return: The length of this InlineResponse20012Dimensions.  # noqa: E501
        :rtype: int
        """
        return self._length
    ...
    def length(self, length):
        """Sets the length of this InlineResponse20012Dimensions.

        Dlina, sm  # noqa: E501

        :param length: The length of this InlineResponse20012Dimensions.  # noqa: E501
        :type: int
        """
    ...
    @property
    def width(self):
        """Gets the width of this InlineResponse20012Dimensions.  # noqa: E501

        hirina, sm  # noqa: E501

        :return: The width of this InlineResponse20012Dimensions.  # noqa: E501
        :rtype: int
        """
        return self._width
    ...
    def width(self, width):
        """Sets the width of this InlineResponse20012Dimensions.

        hirina, sm  # noqa: E501

        :param width: The width of this InlineResponse20012Dimensions.  # noqa: E501
        :type: int
        """
    ...
    @property
    def height(self):
        """Gets the height of this InlineResponse20012Dimensions.  # noqa: E501

        Vysota, sm  # noqa: E501

        :return: The height of this InlineResponse20012Dimensions.  # noqa: E501
        :rtype: int
        """
        return self._height
    ...
    def height(self, height):
        """Sets the height of this InlineResponse20012Dimensions.

        Vysota, sm  # noqa: E501

        :param height: The height of this InlineResponse20012Dimensions.  # noqa: E501
        :type: int
        """
    ...
    def weight_brutto(self):
        """Gets the weight_brutto of this InlineResponse20012Dimensions.  # noqa: E501

        Ves, kg. Kolihestvo znakov posle zapatoi <=3  # noqa: E501

        :return: The weight_brutto of this InlineResponse20012Dimensions.  # noqa: E501
        :rtype: float
        """
    ...
    def weight_brutto(self, weight_brutto):
        """Sets the weight_brutto of this InlineResponse20012Dimensions.

        Ves, kg. Kolihestvo znakov posle zapatoi <=3  # noqa: E501

        :param weight_brutto: The weight_brutto of this InlineResponse20012Dimensions.  # noqa: E501
        :type: float
        """
    ...
    @property
    def is_valid(self):
        """Gets the is_valid of this InlineResponse20012Dimensions.  # noqa: E501
        ...
        :return: The is_valid of this InlineResponse20012Dimensions.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_valid(self, is_valid):
        """Sets the is_valid of this InlineResponse20012Dimensions.

        Potencialnaa nekorrektnost gabaritov tovara:  - `true` — ne vyavlena. `\"isValid\":true` ne garantiruet, hto razmery ukazany korrektno. V otdelnyh sluhaah (naprimer, pri sozdanii novoi kategorii tovarov) `\"isValid\":true` budet vozvrahatsa pri lubyh znaheniah, krome nulevyh.  - `false` — ukazannye gabarity znahitelno otlihautsa ot srednih po kategorii (predmetu). Rekomenduetsa pereproverit, pravilno li ukazany razmery tovara v upakovke **v santimetrah**. Funkcionalnost kartohki tovara, v tom hisle nahislenie logistiki i hranenia, pri etom ogranihena ne budet. Logistika i hranenie prodolhaut nahislatsa — po tekuhim gabaritam. Takhe `\"isValid\":false` vozvrahaetsa pri otsutstvii znahenii ili nulevom znahenii luboi storony.   # noqa: E501

        :param is_valid: The is_valid of this InlineResponse20012Dimensions.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponse20012Dimensions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse20012Dimensions):
            return False
