...
from digitalai.release.v1 import rest
from digitalai.release.v1.configuration import Configuration
from digitalai.release.v1.exceptions import ApiTypeError, ApiValueError, ApiException
from digitalai.release.v1.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ActivityLogsApi()
        api_instance.get_activity_logs  # this is an instance of the class Endpoint
        api_instance.get_activity_logs()  # this invokes api_instance.get_activity_logs.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_activity_logs.callable or self.callable in this class
