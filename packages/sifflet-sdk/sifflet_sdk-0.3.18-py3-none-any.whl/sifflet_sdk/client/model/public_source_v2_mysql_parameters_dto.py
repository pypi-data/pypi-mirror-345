...
def lazy_import():
    from sifflet_sdk.client.model.public_mysql_parameters_dto_all_of import (
        PublicMysqlParametersDtoAllOf,
    )
    from sifflet_sdk.client.model.public_source_v2_parameters_dto import (
        PublicSourceV2ParametersDto,
    )

    globals()["PublicMysqlParametersDtoAllOf"] = PublicMysqlParametersDtoAllOf
    globals()["PublicSourceV2ParametersDto"] = PublicSourceV2ParametersDto


class PublicSourceV2MysqlParametersDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PublicSourceV2MysqlParametersDto - a model defined in OpenAPI

        Keyword Args:
            database (str): Your database name
            host (str): Your MySQL server hostname
            mysql_tls_version (str): The TLS version to use to connect to your MySQL server
            port (int): Your MySQL server port
            type (str):
