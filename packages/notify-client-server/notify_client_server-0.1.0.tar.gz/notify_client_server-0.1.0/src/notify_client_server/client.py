...
from .cfg import cfg
from .common.logger_null import LoggerNull
...
class NotifyClient:
    ...
    def notify(self, tag, status, desc):
        ...
        data = {
            ...
            'source': socket.gethostname(),  # -  hostname that sent the notification
    ...
    def _send_it(self, url, data):
        ...
        self._log.dbg(f"{response.text: <20} POST {status} {cfg.server_url}")
        return response
