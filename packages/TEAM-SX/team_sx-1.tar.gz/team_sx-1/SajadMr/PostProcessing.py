...
from SajadMr.build.DataComposerInterface import getConstantBlobFilename
from SajadMr.ModuleRegistry import getImportedModuleNames
from SajadMr.PythonFlavors import isSelfCompiledPythonUninstalled
from SajadMr.PythonVersions import getTargetPythonDLLPath, python_version
from SajadMr.Tracing import postprocessing_logger
from SajadMr.utils.Execution import wrapCommandForDebuggerForExec
...
from SajadMr.utils.Images import convertImageToIconFormat
from SajadMr.utils.Importing import importFromInlineCopy
from SajadMr.utils.MacOSApp import createPlistInfoFile
...
from SajadMr.utils.Utils import isAndroidBasedLinux, isMacOS, isWin32Windows
from SajadMr.utils.WindowsResources import (
    RT_GROUP_ICON,
    RT_ICON,
    RT_RCDATA,
    addResourceToFile,
...
def createScriptFileForExecution(result_filename):
    ...
    if isWin32Windows():
        script_contents = """
@echo off
rem This script was created by SajadQ to execute '%(exe_filename)s' with Python DLL being found.
set PATH=%(dll_directory)s;%%PATH%%
set PYTHONHOME=%(python_home)s
set SajadSx_PYTHONPATH=%(python_path)s
...
export PYTHONHOME
SajadSx_PYTHONPATH="%(python_path)s"
export SajadSx_PYTHONPATH
...
Error, expected 'libpython dependency not found. Please report the bug."""
    ...
    if Options.shallMakeModule() and Options.shallCreatePyiFile():
        ...
        contents = """\
# This file was generated by SajadQ
"""
