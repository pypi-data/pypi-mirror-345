...
def get_seo_description(description=None,keywords=None,keyword_length=None,desc_length=None):
    ...
    seo_desc = f"{eatAllQuotes(description)} Explore {eatAllQuotes(keywords)}"
    seo_description = get_from_list(eatAllQuotes(seo_desc),length=desc_length)
...
def get_title_tags_description(title=None,keywords=None,summary=None,filename = None,title_length = None,summary_length=None,keyword_length=None,desc_length=None,description=None):
    ...
    keyword_length = keyword_length or 3
    summary_desc = eatAllQuotes(get_from_list(description,length=summary_length))
    ...
    seo_description = eatAllQuotes(get_seo_description(description= eatAllQuotes(summary_desc),keywords = eatAllQuotes(keywords_str),keyword_length=keyword_length,desc_length=desc_length))
