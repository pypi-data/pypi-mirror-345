...
class PredefinedUrlCategoryOverrideArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: The action to take. Valid values are `none`, `allow`, `alert`, or `block`. Defaults to `none`.
...
class _PredefinedUrlCategoryOverrideState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name.
        :param pulumi.Input[builtins.str] rulestack: The rulestack.
        :param pulumi.Input[builtins.str] update_token: Update token.
        """
        if action is not None:
            pulumi.set(__self__, "action", action)
        if audit_comment is not None:
...
class PredefinedUrlCategoryOverride(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            rulestack: Optional[pulumi.Input[builtins.str]] = None,
            update_token: Optional[pulumi.Input[builtins.str]] = None) -> 'PredefinedUrlCategoryOverride':
        """
