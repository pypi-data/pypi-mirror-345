...
class MonteCarloFlexibleBarostat(Force):
    ...
    def computeCurrentPressure(self, context):
        ...
        """
        return _openmm.MonteCarloFlexibleBarostat_computeCurrentPressure(self, context)
...
class MonteCarloAnisotropicBarostat(Force):
    ...
    def computeCurrentPressure(self, context):
        ...
        """
        return _openmm.MonteCarloAnisotropicBarostat_computeCurrentPressure(self, context)
...
class MonteCarloBarostat(Force):
    ...
    def computeCurrentPressure(self, context):
        ...
        """
        return _openmm.MonteCarloBarostat_computeCurrentPressure(self, context)
...
class MonteCarloMembraneBarostat(Force):
    ...
    def computeCurrentPressure(self, context):
        ...
        Vec3
            a vector containing the pressure along each axis
        """
        return _openmm.MonteCarloMembraneBarostat_computeCurrentPressure(self, context)
