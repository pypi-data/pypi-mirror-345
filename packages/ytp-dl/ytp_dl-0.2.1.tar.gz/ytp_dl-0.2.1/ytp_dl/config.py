...
CONNS       = 4    # total simultaneous connections per download
SPLITS      = 4    # pieces to split each file into
MIN_SPLIT   = "1M"
MAX_WORKERS = 2    # how many proxy‐racing threads for metadata lookups
TIMEOUT     = 3
