...
""" Runner for program tests of SajadQ.
...
def main():
    ...
    extra_options = os.environ.get("SajadSx_EXTRA_OPTIONS", "")
    ...
    for filename, filename_main in scanDirectoryForTestCaseFolders("."):
        ...
        if filename == "plugin_import":
            os.environ["SajadSx_EXTRA_OPTIONS"] = (
            ...
            os.environ["SajadSx_EXTRA_OPTIONS"] = extra_options
