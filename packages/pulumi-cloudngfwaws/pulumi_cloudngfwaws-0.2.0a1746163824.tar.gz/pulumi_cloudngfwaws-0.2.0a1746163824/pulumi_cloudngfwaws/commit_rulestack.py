...
class CommitRulestackArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] state: The rulestack state. This can only be the default value. Defaults to `Running`.
        """
...
class _CommitRulestackState:
    def __init__(__self__, *,
                 commit_errors: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 commit_status: Optional[pulumi.Input[builtins.str]] = None,
                 rulestack: Optional[pulumi.Input[builtins.str]] = None,
                 scope: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 validation_errors: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] commit_errors: Commit error messages.
        :param pulumi.Input[builtins.str] commit_status: The commit status.
        :param pulumi.Input[builtins.str] rulestack: The rulestack.
        :param pulumi.Input[builtins.str] scope: The rulestack's scope. A local rulestack will require that you've retrieved a LRA JWT. A global rulestack will require that you've retrieved a GRA JWT. Valid values are `Local` or `Global`. Defaults to `Local`.
        :param pulumi.Input[builtins.str] state: The rulestack state. This can only be the default value. Defaults to `Running`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] validation_errors: Validation error messages.
        :param pulumi.Input[builtins.str] validation_status: The validation status.
        """
    ...
    def commit_errors(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def commit_errors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "commit_errors", value)

    @property
    @pulumi.getter(name="commitStatus")
    def commit_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The commit status.
        """
    ...
    def commit_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def validation_errors(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def validation_errors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "validation_errors", value)

    @property
    @pulumi.getter(name="validationStatus")
    def validation_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def validation_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CommitRulestack(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            validation_errors: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            validation_status: Optional[pulumi.Input[builtins.str]] = None) -> 'CommitRulestack':
        """
    ...
    @property
    @pulumi.getter(name="commitErrors")
    def commit_errors(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Commit error messages.
        """
        return pulumi.get(self, "commit_errors")
    ...
    @property
    @pulumi.getter(name="commitStatus")
    def commit_status(self) -> pulumi.Output[builtins.str]:
        """
        The commit status.
        """
        return pulumi.get(self, "commit_status")
    ...
    @property
    @pulumi.getter(name="validationErrors")
    def validation_errors(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Validation error messages.
        """
        return pulumi.get(self, "validation_errors")
    ...
    @property
    @pulumi.getter(name="validationStatus")
    def validation_status(self) -> pulumi.Output[builtins.str]:
        """
        The validation status.
        """
        return pulumi.get(self, "validation_status")
