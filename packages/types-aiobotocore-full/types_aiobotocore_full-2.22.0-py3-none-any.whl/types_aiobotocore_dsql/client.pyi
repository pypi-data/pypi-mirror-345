...
class AuroraDSQLClient(AioBaseClient):
    ...
    async def create_multi_region_clusters(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_dsql/client/#create_multi_region_clusters)
        """
    ...
    async def delete_multi_region_clusters(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_dsql/client/#delete_multi_region_clusters)
        """
