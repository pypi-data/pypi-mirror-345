...
#ifndef __SajadSx_HELPER_RANGEOBJECTS_H__
#define __SajadSx_HELPER_RANGEOBJECTS_H__
...
SajadSx_MAY_BE_UNUSED static PyObject *PyRange_Start(PyObject *range) { return ((struct _rangeobject3 *)range)->start; }

SajadSx_MAY_BE_UNUSED static PyObject *PyRange_Stop(PyObject *range) { return ((struct _rangeobject3 *)range)->stop; }

SajadSx_MAY_BE_UNUSED static PyObject *PyRange_Step(PyObject *range) { return ((struct _rangeobject3 *)range)->step; }
