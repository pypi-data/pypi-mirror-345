...
class VideoTextPipeline:
    def __init__(self, video_path=None, output_dir=None, output_path=None, new_filename=None, info_data=None, output_option=None, info_path=None, whisper_result_path=None, reencode=None, frame_interval=None, remove_phrases=None,model_size=None):
        self.info = {}
        ...
        self.info_data["is_optimized"] = self.info_data.get("is_optimized", self.is_optimized)
    ...
    def needs_text(self, whisper_text=None):
        ...
        if info_data.get('summary') is None:
            info_data['summary'] = get_summary(full_text=whisper_text, max_words=200, max_length=100, min_length=50)
