...
class SearchCollectionRuleCatalogAssetDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([RuleCatalogAssetDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SearchCollectionRuleCatalogAssetDto - a model defined in OpenAPI

        Args:
            data ([RuleCatalogAssetDto]):
