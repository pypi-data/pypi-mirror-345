...
__all__ = ['ClaimArgs', 'Claim']

@pulumi.input_type
class ClaimArgs:
    def __init__(__self__, *,
                 organization_id: pulumi.Input[builtins.str],
                 parameters: pulumi.Input['ClaimParametersArgs']):
        """
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Input['ClaimParametersArgs']:
        return pulumi.get(self, "parameters")

    @parameters.setter
    def parameters(self, value: pulumi.Input['ClaimParametersArgs']):
...
class _ClaimState:
    def __init__(__self__, *,
                 item: Optional[pulumi.Input['ClaimItemArgs']] = None,
                 organization_id: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input['ClaimParametersArgs']] = None):
        """
    ...
    @property
    @pulumi.getter
    def item(self) -> Optional[pulumi.Input['ClaimItemArgs']]:
        return pulumi.get(self, "item")

    @item.setter
    def item(self, value: Optional[pulumi.Input['ClaimItemArgs']]):
    ...
    @property
    @pulumi.getter
    def parameters(self) -> Optional[pulumi.Input['ClaimParametersArgs']]:
        return pulumi.get(self, "parameters")

    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input['ClaimParametersArgs']]):
        pulumi.set(self, "parameters", value)
...
class Claim(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ClaimArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ClaimArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ClaimArgs.__new__(ClaimArgs)
    ...
    def get(resource_name: str,
        ...
        __props__ = _ClaimState.__new__(_ClaimState)

        __props__.__dict__["item"] = item
        __props__.__dict__["organization_id"] = organization_id
        __props__.__dict__["parameters"] = parameters
        return Claim(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def item(self) -> pulumi.Output['outputs.ClaimItem']:
        return pulumi.get(self, "item")
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Output['outputs.ClaimParameters']:
        return pulumi.get(self, "parameters")
