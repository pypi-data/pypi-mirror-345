...
def lazy_import():
    from sifflet_sdk.client.model.public_mssql_parameters_dto_all_of import (
        PublicMssqlParametersDtoAllOf,
    )
    from sifflet_sdk.client.model.public_source_parameters_dto import (
        PublicSourceParametersDto,
    )

    globals()["PublicMssqlParametersDtoAllOf"] = PublicMssqlParametersDtoAllOf
    globals()["PublicSourceParametersDto"] = PublicSourceParametersDto


class PublicMssqlParametersDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PublicMssqlParametersDto - a model defined in OpenAPI
