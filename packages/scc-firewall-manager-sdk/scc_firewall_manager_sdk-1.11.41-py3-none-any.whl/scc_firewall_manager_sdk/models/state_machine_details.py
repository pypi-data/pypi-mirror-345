...
class StateMachineDetails(BaseModel):
    """
    The device state machine details.
    """ # noqa: E501
    identifier: Optional[StrictStr] = None
    last_error: Optional[StateMachineError] = Field(default=None, alias="lastError")
    __properties: ClassVar[List[str]] = ["identifier", "lastError"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastError": StateMachineError.from_dict(obj["lastError"]) if obj.get("lastError") is not None else None
        })
        return _obj
