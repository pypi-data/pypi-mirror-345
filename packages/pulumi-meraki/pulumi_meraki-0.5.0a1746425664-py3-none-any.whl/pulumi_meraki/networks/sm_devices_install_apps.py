...
__all__ = ['SmDevicesInstallAppsArgs', 'SmDevicesInstallApps']

@pulumi.input_type
class SmDevicesInstallAppsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] device_id: deviceId path parameter. Device ID
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Input['SmDevicesInstallAppsParametersArgs']:
        return pulumi.get(self, "parameters")

    @parameters.setter
    def parameters(self, value: pulumi.Input['SmDevicesInstallAppsParametersArgs']):
        pulumi.set(self, "parameters", value)


@pulumi.input_type
class _SmDevicesInstallAppsState:
    def __init__(__self__, *,
    ...
    @property
    @pulumi.getter
    def parameters(self) -> Optional[pulumi.Input['SmDevicesInstallAppsParametersArgs']]:
        return pulumi.get(self, "parameters")

    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input['SmDevicesInstallAppsParametersArgs']]):
        pulumi.set(self, "parameters", value)
...
class SmDevicesInstallApps(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 device_id: Optional[pulumi.Input[builtins.str]] = None,
                 network_id: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input[Union['SmDevicesInstallAppsParametersArgs', 'SmDevicesInstallAppsParametersArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SmDevicesInstallAppsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SmDevicesInstallAppsArgs.__new__(SmDevicesInstallAppsArgs)
        ...
        super(SmDevicesInstallApps, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            device_id: Optional[pulumi.Input[builtins.str]] = None,
            network_id: Optional[pulumi.Input[builtins.str]] = None,
            parameters: Optional[pulumi.Input[Union['SmDevicesInstallAppsParametersArgs', 'SmDevicesInstallAppsParametersArgsDict']]] = None) -> 'SmDevicesInstallApps':
        """
        Get an existing SmDevicesInstallApps resource's state with the given name, id, and optional extra
        ...
        __props__ = _SmDevicesInstallAppsState.__new__(_SmDevicesInstallAppsState)

        __props__.__dict__["device_id"] = device_id
        __props__.__dict__["network_id"] = network_id
        __props__.__dict__["parameters"] = parameters
        return SmDevicesInstallApps(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Output['outputs.SmDevicesInstallAppsParameters']:
        return pulumi.get(self, "parameters")
