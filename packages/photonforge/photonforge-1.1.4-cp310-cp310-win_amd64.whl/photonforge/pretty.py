from .extension import Component, Technology, LayerSpec, PortSpec, ExtrusionSpec, Z_MAX
...
def _console_table(titles: list[str], rows: list[list[str]], alignments: str):
...
def _html_table(titles: list[str], rows: list[list[str]], alignments: str):
    a = {"l": "left", "r": "right"}
...
def _path_profile_str(path_profiles, technology):
    names = {}
