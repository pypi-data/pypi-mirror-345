...
class MaximLangchainTracer(BaseCallbackHandler):
    ...
    def on_chat_model_start(
        ...
        **kwargs: Any,
        ...
        scribe().debug("[Langchain] on_chat_model_start called")
    ...
    def on_chain_start(
        ...
        try:
            ...
            scribe().error("[MaximSDK] Error while processing chain_start %s", e)
    ...
    def on_chain_end(self, outputs: Union[str, Dict[str, Any]], **kwargs: Any) -> Any:
        try:
            ...
            scribe().error("[MaximSDK] Failed to parse chain-end: %s", e)
    ...
    def on_tool_start(
        ...
        try:
            ...
            scribe().error("[MaximSDK] Failed to parse tool-start: %s", e)
    ...
    def on_tool_end(self, output: Any, **kwargs: Any) -> Any:
        try:
            ...
            scribe().error("[MaximSDK] Failed to parse tool-end: %s", e)
