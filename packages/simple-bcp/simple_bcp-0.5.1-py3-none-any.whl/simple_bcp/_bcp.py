...
class BCP:
    ...
    def _download(self, *, source_target_specification: str, database_parameters: MsSqlDatabaseParameters,
                  ...
                  default_filename_parts: list[str], mode: Literal[_Mode.OUT, _Mode.QUERY_OUT],
                  field_encoding_mode: FieldEncodingMode) -> pathlib.Path:
    ...
    def download_table(self, *, table_name: str, database_parameters: MsSqlDatabaseParameters,
                       ...
                       field_encoding_mode: FieldEncodingMode.NATIVE) -> pathlib.Path:
        """
        ...
        :param table_name: The name of the table to download.
           ...
           database, bcp will have an error and a `subprocess.CalledProcessError` will be raised.
    ...
    def download_query(self, *, query: str, database_parameters: MsSqlDatabaseParameters,
        ...
        :param query: sql query string.
          ...
          `database_name.schema.table_name`. If `database_name.schema.table_name` is used and
          `database_parameters.database_name` is set to a different database,
          bcp will have an error and a `subprocess.CalledProcessError` will be raised.
        :param database_parameters: database connection details
        :param output_file_path: output the data to this path.
                                 Defaults to None which means let this package decide on the path.
                                 Notice: BCP requires the file to not exist, it will be created using the provided path.
    ...
    def upload_into_table(self, *, table_name: str,
                          ...
                          batch_size: _POSITIVE_INT | None = None,
                          field_encoding_mode: FieldEncodingMode.NATIVE) -> None:
        """
