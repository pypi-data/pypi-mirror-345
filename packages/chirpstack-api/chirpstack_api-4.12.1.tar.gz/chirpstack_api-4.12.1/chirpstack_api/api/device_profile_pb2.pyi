...
class Ts003Version(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    TS003_NOT_IMPLEMENTED: _ClassVar[Ts003Version]
    TS003_V100: _ClassVar[Ts003Version]
    TS003_v200: _ClassVar[Ts003Version]

class Ts004Version(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    TS004_NOT_IMPLEMENTED: _ClassVar[Ts004Version]
    TS004_V100: _ClassVar[Ts004Version]
    TS004_V200: _ClassVar[Ts004Version]

class Ts005Version(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    TS005_NOT_IMPLEMENTED: _ClassVar[Ts005Version]
    TS005_V100: _ClassVar[Ts005Version]
    TS005_V200: _ClassVar[Ts005Version]
NONE: CodecRuntime
...
class DeviceProfile(_message.Message):
    ...
    APP_LAYER_PARAMS_FIELD_NUMBER: _ClassVar[int]
    id: str
    tenant_id: str
    name: str
    description: str
...
class AppLayerParams(_message.Message):
    __slots__ = ("ts003_version", "ts003_f_port", "ts004_version", "ts004_f_port", "ts005_version", "ts005_f_port")
    TS003_VERSION_FIELD_NUMBER: _ClassVar[int]
    TS003_F_PORT_FIELD_NUMBER: _ClassVar[int]
    TS004_VERSION_FIELD_NUMBER: _ClassVar[int]
    TS004_F_PORT_FIELD_NUMBER: _ClassVar[int]
    TS005_VERSION_FIELD_NUMBER: _ClassVar[int]
    TS005_F_PORT_FIELD_NUMBER: _ClassVar[int]
    ts003_version: Ts003Version
    ts003_f_port: int
    ts004_version: Ts004Version
    ts004_f_port: int
    ts005_version: Ts005Version
    ts005_f_port: int
    def __init__(self, ts003_version: _Optional[_Union[Ts003Version, str]] = ..., ts003_f_port: _Optional[int] = ..., ts004_version: _Optional[_Union[Ts004Version, str]] = ..., ts004_f_port: _Optional[int] = ..., ts005_version: _Optional[_Union[Ts005Version, str]] = ..., ts005_f_port: _Optional[int] = ...) -> None: ...
