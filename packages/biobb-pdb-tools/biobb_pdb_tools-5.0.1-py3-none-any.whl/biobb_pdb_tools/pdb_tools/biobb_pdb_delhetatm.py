...
class Delhetatm(BiobbObject):
    ...
    def __init__(
        ...
        self.binary_path = properties.get("binary_path", "pdb_delhetatm")
    ...
    @launchlogger
    def launch(self) -> int:
        """Execute the :class:`Delhetatm <biobb_pdb_tools.pdb_tools.pdb_delhetatm>` object."""
...
def biobb_pdb_delhetatm(
    input_file_path: str,
    output_file_path: str,
    properties: Optional[dict] = None,
    **kwargs,
) -> int:
    """Create :class:`Delhetatm <biobb_pdb_tools.pdb_tools.pdb_delhetatm>` class and
    execute the :meth:`launch() <biobb_pdb_tools.pdb_tools.pdb_delhetatm.launch>` method."""
    return Delhetatm(
