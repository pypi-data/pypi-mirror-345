...
@deprecated(
    ...
    removed_in="7.0.0",
    current_version=VERSION,
    details="Call vfg_upgrade; this function is redundant and the other method is better named.",
)
...
@deprecated(
    ...
    removed_in="7.0.0",
    current_version=VERSION,
    details="Rely on gpil-pipeline for persistence; pyvfg should be stateless!",
)
