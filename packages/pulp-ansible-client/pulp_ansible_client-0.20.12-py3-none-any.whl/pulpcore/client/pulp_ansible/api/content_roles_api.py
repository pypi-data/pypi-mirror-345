...
class ContentRolesApi(object):
    ...
    def create(self, ansible_role,  **kwargs):  # noqa: E501
        """Create a role  # noqa: E501

        ViewSet for Role.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create(ansible_role, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param AnsibleRole ansible_role: (required)
        ...
        return self.create_with_http_info(ansible_role,  **kwargs)  # noqa: E501

    def create_with_http_info(self, ansible_role,  **kwargs):  # noqa: E501
        """Create a role  # noqa: E501

        ViewSet for Role.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(ansible_role, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(AnsibleRoleResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        # verify the required parameter 'ansible_role' is set
        if self.api_client.client_side_validation and ('ansible_role' not in local_var_params or  # noqa: E501
                                                        local_var_params['ansible_role'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ansible_role` when calling `create`")  # noqa: E501
        ...
        body_params = None
        if 'ansible_role' in local_var_params:
            body_params = local_var_params['ansible_role']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='AnsibleRoleResponse',  # noqa: E501
    ...
    def list_with_http_info(self,  **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PaginatedansibleRoleResponseList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PaginatedansibleRoleResponseList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def read(self, ansible_role_href,  **kwargs):  # noqa: E501
        """Inspect a role  # noqa: E501

        ViewSet for Role.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(ansible_role_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(ansible_role_href,  **kwargs)  # noqa: E501

    def read_with_http_info(self, ansible_role_href,  **kwargs):  # noqa: E501
        """Inspect a role  # noqa: E501

        ViewSet for Role.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(ansible_role_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('ansible_role_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `ansible_role_href` when calling `read`")  # noqa: E501
