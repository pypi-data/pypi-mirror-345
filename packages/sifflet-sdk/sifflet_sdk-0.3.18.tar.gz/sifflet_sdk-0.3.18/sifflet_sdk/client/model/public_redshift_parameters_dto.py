...
def lazy_import():
    from sifflet_sdk.client.model.public_redshift_parameters_dto_all_of import (
        PublicRedshiftParametersDtoAllOf,
    )
    from sifflet_sdk.client.model.public_source_parameters_dto import (
        PublicSourceParametersDto,
    )

    globals()["PublicRedshiftParametersDtoAllOf"] = PublicRedshiftParametersDtoAllOf
    globals()["PublicSourceParametersDto"] = PublicSourceParametersDto


class PublicRedshiftParametersDto(ModelComposed):
