...
def lazy_import():
    ...
    from sifflet_sdk.client.model.rule_in_incident_scope_dto import (
        RuleInIncidentScopeDto,
    )

    globals()["DatasetBriefDto"] = DatasetBriefDto
    globals()["RuleInIncidentScopeDto"] = RuleInIncidentScopeDto


class IncidentScope(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "rules": ([RuleInIncidentScopeDto],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, datasets, rules, *args, **kwargs):  # noqa: E501
        """IncidentScope - a model defined in OpenAPI

        Args:
            datasets ([DatasetBriefDto]):
            rules ([RuleInIncidentScopeDto]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, datasets, rules, *args, **kwargs):  # noqa: E501
        """IncidentScope - a model defined in OpenAPI
