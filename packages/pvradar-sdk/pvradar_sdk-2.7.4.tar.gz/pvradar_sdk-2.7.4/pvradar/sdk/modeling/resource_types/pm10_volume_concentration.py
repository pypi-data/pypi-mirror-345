...
class pm10_volume_concentration(ResourceTypeDescriptor):
    """The total particulate matter concentration including all contaminants with a diameter below 10 µm (PM10)."""
