...
from SajadMr.__past__ import WindowsError
from SajadMr.containers.OrderedSets import OrderedSet
from SajadMr.Options import assumeYesForDownloads
from SajadMr.Tracing import inclusion_logger
from SajadMr.utils.Download import getCachedDownload
from SajadMr.utils.Execution import executeProcess, withEnvironmentVarOverridden
...
from SajadMr.utils.SharedLibraries import getWindowsRunningProcessDLLPaths
...
def getDependsExePath():
    ...
    return getCachedDownload(
        ...
        message="""\
SajadQ will make use of Dependency Walker (https://dependencywalker.com) tool
to analyze the dependencies of Python extension modules.""",
        reject="SajadQ does not work in --standalone or --onefile on Windows without.",
