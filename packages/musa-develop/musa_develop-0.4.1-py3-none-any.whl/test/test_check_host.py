...
def test_check_Lspci_simulation_negative():
...
Lspci
    ...
    - {GREEN_PREFIX}Recommendation{COLOR_SUFFIX}: The command 'musa-develop' is currently being executed inside a container. To check Lspci, please run the command outside the container."""
    tester.set_simulation_log(simulation_log)
    tester.set_module_ground_truth(lspci_ground_truth)
    tester.test_single_module()
...
def test_check_IOMMU_simulation_negative():
    tester = TestChecker(CheckModuleNames.host.name)
    simulation_log = {"IOMMU": ("", "", 1)}
    IOMMU_ground_truth = f"""\
IOMMU
    - status: \x1b[91mATTENTION\x1b[0m
    - {GREEN_PREFIX}Recommendation{COLOR_SUFFIX}: Unable to get whether IOMMU is enabled."""
    tester.set_simulation_log(simulation_log)
...
def test_check_IOMMU_simulation_inside_container():
    tester = TestChecker(CheckModuleNames.host.name)
    simulation_log = {
        "IOMMU": ("", "grep: /etc/default/grub: No such file or directory\n", 2)
    }
    IOMMU_ground_truth = f"""\
IOMMU
    - status: \x1b[91mUNKNOWN\x1b[0m
    - {GREEN_PREFIX}Recommendation{COLOR_SUFFIX}: The command 'musa-develop' is currently being executed inside a container. To check IOMMU, please run the command outside the container."""
    tester.set_simulation_log(simulation_log)
    tester.set_module_ground_truth(IOMMU_ground_truth)
    tester.test_single_module()
...
DKMS
    - status: \x1b[91mUNKNOWN\x1b[0m
    - {GREEN_PREFIX}Recommendation{COLOR_SUFFIX}: The command 'musa-develop' is currently being executed inside a container. To check DKMS, please run the command outside the container."""
    tester.set_simulation_log(simulation_log)
    tester.set_module_ground_truth(DKMS_ground_truth)
    tester.test_single_module()
...
Lightdm
    - status: \x1b[91mUNKNOWN\x1b[0m
    - {GREEN_PREFIX}Recommendation{COLOR_SUFFIX}: The command 'musa-develop' is currently being executed inside a container. To check Lightdm, please run the command outside the container."""
    tester.set_simulation_log(simulation_log)
    tester.set_module_ground_truth(Lightdm_ground_truth)
    tester.test_single_module()
...
def test_check_Docker_simulation():
    ...
    simulation_log = {
        "Docker": [
            ("20.10.21", "", 0),
            (
                "Active:active(running)sinceWed2024-11-1323:39:53CST;1months20daysago",
                "",
                0,
            ),
        ]
    }
    Docker_ground_truth = "Docker                      Version: 20.10.21"
    tester.set_simulation_log(simulation_log)
...
Docker
    - status: \x1b[91mUNKNOWN\x1b[0m
    - {GREEN_PREFIX}Recommendation{COLOR_SUFFIX}: The command 'musa-develop' is currently being executed inside a container. To check Docker, please run the command outside the container."""
    tester.set_simulation_log(simulation_log)
    tester.set_module_ground_truth(Docker_ground_truth)
    tester.test_single_module()
