...
:func:`edit_directory_path`

:func:`execute`

:func:`external_operation`
...
def bookmark_delete(*args, index: int = -1) -> None:
...
def bookmark_move(*args, direction: str = 'TOP') -> None:
...
def directory_new(*args, directory: str = '', open: bool = False, confirm: bool = True) -> None:
...
def external_operation(*args, filepath: str = '', operation: str = 'OPEN') -> None:
...
def filenum(*args, increment: int = 1) -> None:
...
def filepath_drop(*args, filepath: str = 'Path') -> None:
...
def select(*args, wait_to_deselect_others: bool = False, mouse_x: int = 0, mouse_y: int = 0, extend: bool = False, fill: bool = False, open: bool = True, deselect_all: bool = False, only_activate_if_selected: bool = False, pass_through: bool = False) -> None:
...
def select_bookmark(*args, dir: str = '') -> None:
...
def select_walk(*args, direction: str = 'UP', extend: bool = False, fill: bool = False) -> None:
...
def unpack_all(*args, method: str = 'USE_LOCAL') -> None:
...
def unpack_item(*args, method: str = 'USE_LOCAL', id_name: str = '', id_type: int = 19785) -> None:
