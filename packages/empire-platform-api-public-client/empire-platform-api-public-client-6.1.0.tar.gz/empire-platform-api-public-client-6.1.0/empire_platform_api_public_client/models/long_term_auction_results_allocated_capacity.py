...
class LongTermAuctionResultsAllocatedCapacity(BaseModel):
    ...
    * `requestedCapacity` - Sum of ALL bids from the given Participant in kilowatts * `allocatedTrs` - Transmission rights allocated for the given Participant in the Auction 
    """ # noqa: E501
    participant: AuctionResultParticipant
    requested_capacity: Optional[StrictInt] = Field(default=None, description="Capacity value in kilowatts (kW) - the required system precision allows for handling capacity values as integers", alias="requestedCapacity")
    ...
    __properties: ClassVar[List[str]] = ["participant", "requestedCapacity", "allocatedTrs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "participant": AuctionResultParticipant.from_dict(obj["participant"]) if obj.get("participant") is not None else None,
