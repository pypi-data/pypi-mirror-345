...
class PipelineBranchesitempullRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_links", "author", "id", "title", "url", "_class"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": PipelineBranchesitempullRequestlinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
