...
class DefaultNominationDetails(BaseModel):
    ...
    delivery_period_start: date = Field(description="One single calendar day, interpreted in **System Time**  - ISO 8601 compliant string in `yyyy-mm-dd` format ", alias="deliveryPeriodStart")
    delivery_period_end: Optional[date] = Field(default=None, description="One single calendar day, interpreted in **System Time**  - ISO 8601 compliant string in `yyyy-mm-dd` format ", alias="deliveryPeriodEnd")
    mtus: List[DefaultNominationMtu]
    __properties: ClassVar[List[str]] = ["id", "timescale", "borderDirection", "deliveryPeriodStart", "deliveryPeriodEnd", "mtus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mtus": [DefaultNominationMtu.from_dict(_item) for _item in obj["mtus"]] if obj.get("mtus") is not None else None
        })
        return _obj
