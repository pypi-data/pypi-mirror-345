...
class WebhooksHttpServersArgs:
    def __init__(__self__, *,
                 ...
                 http_server_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] network_id: A Meraki network ID.
        :param pulumi.Input[builtins.str] http_server_id: httpServerId path parameter. Http server ID
        :param pulumi.Input[builtins.str] name: A name for easy reference to the HTTP server
        ...
        :param pulumi.Input[builtins.str] shared_secret: A shared secret that will be included in POSTs sent to the HTTP server. This secret can be used to verify that the request was sent by Meraki.
        :param pulumi.Input[builtins.str] url: The URL of the HTTP server.
        """
    ...
    def http_server_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def http_server_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WebhooksHttpServers(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            payload_template: Optional[pulumi.Input[Union['WebhooksHttpServersPayloadTemplateArgs', 'WebhooksHttpServersPayloadTemplateArgsDict']]] = None,
            shared_secret: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'WebhooksHttpServers':
        """
    ...
    @property
    @pulumi.getter(name="httpServerId")
    def http_server_id(self) -> pulumi.Output[builtins.str]:
        """
        httpServerId path parameter. Http server ID
        """
        return pulumi.get(self, "http_server_id")
