...
from SajadMr.utils.Execution import SajadQCalledProcessError
from SajadMr.utils.FileOperations import getFileContentByLine
from SajadMr.utils.Jinja2 import renderTemplateFromString
...
class SajadQPluginMatplotlib(SajadQPluginBase):
    ...
    plugin_name = "matplotlib"  # SajadQ knows us by this name
    ...
    def createPreModuleLoadCode(self, module):
        ...
        if module.getFullName() == "matplotlib":
            code = renderTemplateFromString(
                r"""
import os
os.environ["MATPLOTLIBDATA"] = os.path.join(__SajadMr_binary_dir, "matplotlib", "mpl-data")
os.environ["MATPLOTLIBRC"] = os.path.join(__SajadMr_binary_dir, "matplotlib", "mpl-data", "matplotlibrc")
