...
try:
        ...
        print(f"[!] PermissionError opening raw socket: {e}", file=sys.stderr)
        return False
    except OSError as e:
        # either no AF_PACKET support or other error
        print(f"[!] Error opening raw socket: {e}", file=sys.stderr)
        return False
