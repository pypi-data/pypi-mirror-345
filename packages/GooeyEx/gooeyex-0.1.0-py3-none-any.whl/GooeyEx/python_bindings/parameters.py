...
from GooeyEx.gui.util.freeze import getResourcePath
from GooeyEx.python_bindings.types import GooeyParams
    ...
    return GooeyParams(
        **{  # type: ignore
            ...
            "timing_options": merge(
                {"show_time_remaining": False, "hide_time_remaining_on_complete": True},
                kwargs.get("timing_options", {}),
            ),
            "disable_progress_bar_animation": kwargs.get(
            ...
            "body_bg_color": kwargs.get(
                "body_bg_color",
                constants.COLOR_GREY_90 if use_dark_mode else constants.COLOR_GREY_5,
            ),
            "body_text_color": kwargs.get("body_text_color", default_text_color),
            "header_bg_color": kwargs.get(
                "header_bg_color",
                constants.COLOR_GREY_100 if use_dark_mode else constants.COLOR_WHITE,
            ),
            ...
            "footer_bg_color": kwargs.get(
                "footer_bg_color",
                constants.COLOR_GREY_90 if use_dark_mode else constants.COLOR_GREY_5,
            ),
            "sidebar_bg_color": kwargs.get(
                "sidebar_bg_color",
                constants.COLOR_GREY_90 if use_dark_mode else constants.COLOR_GREY_5,
            ),
            "terminal_panel_color": kwargs.get(
                "terminal_panel_color",
                constants.COLOR_GREY_80 if use_dark_mode else constants.COLOR_GREY_10,
            ),
            "terminal_font_color": kwargs.get(
                "terminal_font_color", default_text_color
            ),
