...
class PulpAnsibleApiV3PluginAnsibleContentCollectionsIndexVersionsDocsBlobApi(object):
    ...
    def read_with_http_info(self, distro_base_path, name, namespace, path, version,  **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/{path}/api/v3/plugin/ansible/content/{distro_base_path}/collections/index/{namespace}/{name}/versions/{version}/docs-blob/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
