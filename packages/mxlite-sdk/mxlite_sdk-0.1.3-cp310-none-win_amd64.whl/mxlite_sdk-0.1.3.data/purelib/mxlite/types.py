...
# 主机信息响应
HostInfoResponse = Union[HostInfoSuccessResponse, HostInfoErrorResponse]
...
# 完整任务结果
TaskResult = Union[TaskSuccessResponse, ErrorResponse]
...
# 添加任务结果
AddTaskResult = Union[AddTaskSuccessResponse, ErrorResponse]
...
# 目录列表响应
LsdirResponse = Union[LsdirSuccessResponse, LsdirErrorResponse]
