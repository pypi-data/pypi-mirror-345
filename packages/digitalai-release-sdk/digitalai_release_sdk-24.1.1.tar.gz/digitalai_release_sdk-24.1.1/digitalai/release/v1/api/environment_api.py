...
class EnvironmentApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_environment_endpoint = _Endpoint(
            settings={
                'response_type': (EnvironmentView,),
                'auth': [
                    'basicAuth',
                    'patAuth'
                ],
                'endpoint_path': '/api/v1/environments',
        ...
        self.delete_environment_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/environments/{environmentId}',
            ...
            root_map={
                'validations': {
                    ('environment_id',): {
                        ...
                        'regex': {
                            'pattern': r'.*\/Environment[^\/]*',  # noqa: E501
                        },
                    },
                },
                'allowed_values': {
        ...
        self.get_deployable_applications_for_environment_endpoint = _Endpoint(
            settings={
                'response_type': ([BaseApplicationView],),
                'auth': [
                    'basicAuth',
                    'patAuth'
                ],
                'endpoint_path': '/api/v1/environments/{environmentId}/applications',
                'operation_id': 'get_deployable_applications_for_environment',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_reservations_for_environment_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/environments/{environmentId}/reservations',
                'operation_id': 'get_reservations_for_environment',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.search_environments_endpoint = _Endpoint(
            settings={
                'response_type': ([EnvironmentView],),
                'auth': [
                    'basicAuth',
                ...
                'endpoint_path': '/api/v1/environments/search',
    ...
    def create_environment(
        ...
        **kwargs
        ...
        Keyword Args:
            environment_form (EnvironmentForm): [optional]
    ...
    def get_deployable_applications_for_environment(
        self,
        environment_id,
        **kwargs
    ):
        """get_deployable_applications_for_environment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_deployable_applications_for_environment(environment_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_id'] = \
            environment_id
        return self.get_deployable_applications_for_environment_endpoint.call_with_http_info(**kwargs)
    ...
    def get_reservations_for_environment(
        self,
        environment_id,
        **kwargs
    ):
        """get_reservations_for_environment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_reservations_for_environment(environment_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_id'] = \
            environment_id
        return self.get_reservations_for_environment_endpoint.call_with_http_info(**kwargs)

    def search_environments(
        self,
        **kwargs
    ):
        """search_environments  # noqa: E501
        ...
        Keyword Args:
            environment_filters (EnvironmentFilters): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.search_environments_endpoint.call_with_http_info(**kwargs)
