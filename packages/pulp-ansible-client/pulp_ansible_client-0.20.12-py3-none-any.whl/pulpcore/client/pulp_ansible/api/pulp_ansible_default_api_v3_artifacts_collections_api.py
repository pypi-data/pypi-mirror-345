...
class PulpAnsibleDefaultApiV3ArtifactsCollectionsApi(object):
    ...
    def get(self, filename, path,  **kwargs):  # noqa: E501
        """get  # noqa: E501

        Download collection.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get(filename, path, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_with_http_info(filename, path,  **kwargs)  # noqa: E501

    def get_with_http_info(self, filename, path,  **kwargs):  # noqa: E501
        """get  # noqa: E501

        Download collection.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_with_http_info(filename, path, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('filename' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `filename` when calling `get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/default/api/v3/artifacts/collections/{path}/{filename}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
