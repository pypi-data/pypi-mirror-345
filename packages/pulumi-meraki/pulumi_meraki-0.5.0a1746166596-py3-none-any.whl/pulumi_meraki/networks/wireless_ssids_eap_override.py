...
class WirelessSsidsEapOverrideArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] max_retries: Maximum number of general EAP retries.
        :param pulumi.Input[builtins.int] timeout: General EAP timeout in seconds.
        """
...
class WirelessSsidsEapOverride(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_id: Optional[pulumi.Input[builtins.str]] = None,
            number: Optional[pulumi.Input[builtins.str]] = None,
            timeout: Optional[pulumi.Input[builtins.int]] = None) -> 'WirelessSsidsEapOverride':
        """
