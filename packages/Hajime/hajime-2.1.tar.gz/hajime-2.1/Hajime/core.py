...
class Hajime:
    ...
    def template(self, filename, **context):
        ...
        context['js_include'] = lambda js_file: f'<script src="{self.get_script_path(js_file)}"></script>'
        context['svelte_include'] = lambda svelte_file: f'<script src="{self.get_script_path(svelte_file)}" type="module"></script>'
        ...
        # Process function calls like {{ svelte_include('component.svelte') }}
