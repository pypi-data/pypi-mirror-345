...
class DefaultTagsApi(object):
    ...
    def api_metadata_tags_get(self, **kwargs):  # noqa: E501
        """api_metadata_tags_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_metadata_tags_get(async_req=True)
        >>> result = thread.get()
        ...
        :return: FilterResponsePersistenceModelsTagWithTypeDto
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_metadata_tags_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.api_metadata_tags_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def api_metadata_tags_get_with_http_info(self, **kwargs):  # noqa: E501
        """api_metadata_tags_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_metadata_tags_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_metadata_tags_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='FilterResponsePersistenceModelsTagWithTypeDto',  # noqa: E501
