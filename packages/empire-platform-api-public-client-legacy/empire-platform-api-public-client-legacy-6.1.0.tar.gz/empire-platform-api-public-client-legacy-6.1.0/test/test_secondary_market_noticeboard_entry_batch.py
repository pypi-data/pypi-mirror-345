...
from empire_platform_api_public_client_legacy.models.secondary_market_noticeboard_entry_batch import SecondaryMarketNoticeboardEntryBatch  # noqa: E501
    ...
    def make_instance(self, include_optional) -> SecondaryMarketNoticeboardEntryBatch:
        ...
        if include_optional:
            return SecondaryMarketNoticeboardEntryBatch(
                entries = [
                    empire_platform_api_public_client_legacy.models.secondary_market_noticeboard_entry.SecondaryMarketNoticeboardEntry(
