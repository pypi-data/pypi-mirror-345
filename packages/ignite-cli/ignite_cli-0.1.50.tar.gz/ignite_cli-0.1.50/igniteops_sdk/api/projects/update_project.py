...
) -> Optional[Union[Any, UpdateProjectResponse200]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, UpdateProjectResponse200]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update a project (favourite/unfavourite)
     ...
     Updates the favourite status of the specified project.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, UpdateProjectResponse200]
    """
