...
class ImperfectionCase(_message.Message):
    ...
    class ImperfectionCasesItemsRow(_message.Message):
        ...
        name: int
        factor: float
        operator_type: ImperfectionCase.ImperfectionCasesItemsRow.Operator
        comment: str
        def __init__(self, no: _Optional[int] = ..., description: _Optional[str] = ..., name: _Optional[int] = ..., factor: _Optional[float] = ..., operator_type: _Optional[_Union[ImperfectionCase.ImperfectionCasesItemsRow.Operator, str]] = ..., comment: _Optional[str] = ...) -> None: ...
    NO_FIELD_NUMBER: _ClassVar[int]
