...
class GetAlgoFuturesSubOrdersV1RespSubOrdersInner(BaseModel):
    """
    ...
    fee_amt: Optional[StrictStr] = Field(default=None, alias="feeAmt")
    fee_asset: Optional[StrictStr] = Field(default=None, alias="feeAsset")
    ...
    sub_id: Optional[StrictInt] = Field(default=None, alias="subId")
    symbol: Optional[StrictStr] = None
    time_in_force: Optional[StrictStr] = Field(default=None, alias="timeInForce")
    __properties: ClassVar[List[str]] = ["algoId", "avgPrice", "bookTime", "executedAmt", "executedQty", "feeAmt", "feeAsset", "orderId", "orderStatus", "origQty", "side", "subId", "symbol", "timeInForce"]
