...
def b_run_python(
    *args: str|list[str],
    ...
    print(f"{BColor.GREEN}====================={BColor.RESET}")
    print(f"{BColor.GREEN}BRunPython 结束:{BColor.RESET}")
    for string in str_lst:
        if 'Time limit' in string:
            print(f"\t{BColor.YELLOW}" + string + f"{BColor.RESET}")
        elif 'Error' in string:
            print(f"\t{BColor.RED}" + string + f"{BColor.RESET}")
        else:
            print(f"\t{BColor.GREEN}" + string + f"{BColor.RESET}")
    print(f"{BColor.GREEN}====================={BColor.RESET}")
