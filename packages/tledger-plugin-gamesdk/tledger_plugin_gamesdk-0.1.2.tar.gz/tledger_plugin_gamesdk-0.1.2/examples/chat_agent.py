...
from src.game_sdk.game.custom_types import ActionResponse, FunctionCallResponse, FunctionResult, GameChatResponse, Function, AgentMessage, ChatResponse
from src.game_sdk.game.api_v2 import GAMEClientV2
...
class Chat:
    ...
    def _update_conversation(self, message: str) -> GameChatResponse:
        data = {
            "message": message,
            "state": self.get_state_fn().__str__() if self.get_state_fn else None,
            "functions": (
