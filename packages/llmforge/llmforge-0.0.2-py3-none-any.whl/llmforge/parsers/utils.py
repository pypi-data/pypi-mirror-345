"""
JSON parsing utilities originally taken from the LangChain project:
https://github.com/langchain-ai/langchain/blob/master/libs/core/langchain_core/utils/json.py

These functions were adapted under the terms of the MIT License.

Original authorship and credit go to the LangChain team. 
Modifications may have been made to better suit the needs of this library.
