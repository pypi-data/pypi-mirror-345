...
class InvoiceDetails(BaseModel):
    ...
    __properties = ["id", "groupId", "displayId", "participant", "period", "netAmount", "grossAmount", "dueDate", "sentDate", "paidDate", "status", "lastStatusChange", "sendable", "lineItems", "vatRates", "summaries", "attachment", "history"]
