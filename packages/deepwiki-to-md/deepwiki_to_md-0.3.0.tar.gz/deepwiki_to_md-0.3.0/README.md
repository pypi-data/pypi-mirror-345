...
The tool automatically runs a link-fixing utility on the generated .md files. This utility finds Markdown links in the format [Text](URL) and replaces them with [Text]().
