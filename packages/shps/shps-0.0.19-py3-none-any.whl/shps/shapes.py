...
#
import numpy as np
from xbim.frame.shapes import load_aisc, from_aisc, Angle, Channel, Rectangle, WideFlange, HollowRectangle
# from shps.frame import patch, layer, _create_mesh, GeneralSection
