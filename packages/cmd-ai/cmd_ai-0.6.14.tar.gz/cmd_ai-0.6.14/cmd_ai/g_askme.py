...
from cmd_ai import function_chmi, function_goog, function_webc, function_calendar, function_gmail, function_sympy
...
#                 role=None,
    ...
    # **********
    #print(fg.cyan, message, fg.default)
...
def g_ask_anyone(
    ...
    if config.DEBUG:
        print("D... in g_ask_anyone... DEBUG IS ON")
    ...
    if config.MODEL_TO_USE.find("claude") >= 0:
        ...
        models = [ "gpt-4o-2024-11-20", "claude-3-7-sonnet-20250219", "gemini-2.5-pro-exp-03-25", "o3-mini-2025-01-31"]
        models = [ config.CONFIG['model_to_use'], "claude-3-7-sonnet-20250219", "gemini-2.5-pro-exp-03-25", "o3-mini-2025-01-31"]
