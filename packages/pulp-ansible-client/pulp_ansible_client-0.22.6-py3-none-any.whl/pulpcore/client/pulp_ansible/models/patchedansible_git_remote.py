...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, sock_read_timeout=None, proxy_password=None, username=None, connect_timeout=None, headers=None, client_cert=None, tls_validation=None, password=None, proxy_username=None, pulp_labels=None, sock_connect_timeout=None, ca_cert=None, download_concurrency=None, max_retries=None, name=None, client_key=None, rate_limit=None, proxy_url=None, url=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
