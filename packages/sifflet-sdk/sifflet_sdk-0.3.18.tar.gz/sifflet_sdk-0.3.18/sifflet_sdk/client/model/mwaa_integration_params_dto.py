...
def lazy_import():
    ...
    from sifflet_sdk.client.model.mwaa_integration_params_dto_all_of import (
        MwaaIntegrationParamsDtoAllOf,
    )
    from sifflet_sdk.client.model.time_zone_dto import TimeZoneDto

    globals()["IntegrationParamsDto"] = IntegrationParamsDto
    globals()["MwaaIntegrationParamsDtoAllOf"] = MwaaIntegrationParamsDtoAllOf
    globals()["TimeZoneDto"] = TimeZoneDto


class MwaaIntegrationParamsDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MwaaIntegrationParamsDto - a model defined in OpenAPI
