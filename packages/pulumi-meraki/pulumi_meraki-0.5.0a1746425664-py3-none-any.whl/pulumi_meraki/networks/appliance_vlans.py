...
class ApplianceVlansArgs:
    def __init__(__self__, *,
                 ...
                 appliance_ip: Optional[pulumi.Input[builtins.str]] = None,
                 cidr: Optional[pulumi.Input[builtins.str]] = None,
                 dhcp_boot_filename: Optional[pulumi.Input[builtins.str]] = None,
                 dhcp_boot_next_server: Optional[pulumi.Input[builtins.str]] = None,
                 dhcp_boot_options_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 dhcp_handling: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 dns_nameservers: Optional[pulumi.Input[builtins.str]] = None,
                 group_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 mask: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 template_vlan_type: Optional[pulumi.Input[builtins.str]] = None,
                 vpn_nat_subnet: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] vlan_id: The VLAN ID of the VLAN
        :param pulumi.Input[builtins.str] appliance_ip: The local IP of the appliance on the VLAN
        :param pulumi.Input[builtins.str] cidr: CIDR of the pool of subnets. Applicable only for template network. Each network bound to the template will automatically pick a subnet from this pool to build its own VLAN.
        :param pulumi.Input[builtins.str] dhcp_boot_filename: DHCP boot option for boot filename
        :param pulumi.Input[builtins.str] dhcp_boot_next_server: DHCP boot option to direct boot clients to the server to load the boot file from
        :param pulumi.Input[builtins.bool] dhcp_boot_options_enabled: Use DHCP boot options specified in other properties
        :param pulumi.Input[builtins.str] dhcp_handling: The appliance's handling of DHCP requests on this VLAN. One of: 'Run a DHCP server', 'Relay DHCP to another server' or 'Do not respond to DHCP requests'
        :param pulumi.Input[builtins.str] dhcp_lease_time: The term of DHCP leases if the appliance is running a DHCP server on this VLAN. One of: '30 minutes', '1 hour', '4 hours', '12 hours', '1 day' or '1 week'
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dhcp_relay_server_ips: The IPs of the DHCP servers that DHCP requests should be relayed to
        :param pulumi.Input[builtins.str] dns_nameservers: The DNS nameservers used for DHCP responses, either "upstream*dns", "google*dns", "opendns", or a newline seperated string of IP addresses or domain names
        :param pulumi.Input[builtins.str] group_policy_id: The id of the desired group policy to apply to the VLAN
        ...
        :param pulumi.Input[builtins.int] mask: Mask used for the subnet of all bound to the template networks. Applicable only for template network.
        :param pulumi.Input[builtins.str] name: The name of the VLAN
        ...
        :param pulumi.Input[builtins.str] subnet: The subnet of the VLAN
        :param pulumi.Input[builtins.str] template_vlan_type: Type of subnetting of the VLAN. Applicable only for template network.
        :param pulumi.Input[builtins.str] vpn_nat_subnet: The translated VPN subnet if VPN and VPN subnet translation are enabled on the VLAN
        """
    ...
    def appliance_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @appliance_ip.setter
    def appliance_ip(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def dhcp_boot_filename(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dhcp_boot_filename(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dhcp_boot_filename", value)

    @property
    @pulumi.getter(name="dhcpBootNextServer")
    def dhcp_boot_next_server(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dhcp_boot_next_server(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dhcp_boot_next_server", value)

    @property
    @pulumi.getter(name="dhcpBootOptionsEnabled")
    def dhcp_boot_options_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def dhcp_boot_options_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "dhcp_boot_options_enabled", value)

    @property
    @pulumi.getter(name="dhcpHandling")
    def dhcp_handling(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dhcp_handling(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def dns_nameservers(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dns_nameservers(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dns_nameservers", value)

    @property
    @pulumi.getter(name="groupPolicyId")
    def group_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def group_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def mask(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @mask.setter
    def mask(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def template_vlan_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def template_vlan_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "template_vlan_type", value)

    @property
    @pulumi.getter(name="vpnNatSubnet")
    def vpn_nat_subnet(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vpn_nat_subnet(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ApplianceVlansState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dns_nameservers: The DNS nameservers used for DHCP responses, either "upstream*dns", "google*dns", "opendns", or a newline seperated string of IP addresses or domain names
        :param pulumi.Input[builtins.str] group_policy_id: The id of the desired group policy to apply to the VLAN
        :param pulumi.Input[builtins.str] interface_id: The interface ID of the VLAN
        :param pulumi.Input['ApplianceVlansIpv6Args'] ipv6: IPv6 configuration on the VLAN
        :param pulumi.Input['ApplianceVlansMandatoryDhcpArgs'] mandatory_dhcp: Mandatory DHCP will enforce that clients connecting to this VLAN must use the IP address assigned by the DHCP server. Clients who use a static IP address won't be able to associate. Only available on firmware versions 17.0 and above
        :param pulumi.Input[builtins.int] mask: Mask used for the subnet of all bound to the template networks. Applicable only for template network.
        :param pulumi.Input[builtins.str] name: The name of the VLAN
...
class ApplianceVlans(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            template_vlan_type: Optional[pulumi.Input[builtins.str]] = None,
            vlan_id: Optional[pulumi.Input[builtins.str]] = None,
            vpn_nat_subnet: Optional[pulumi.Input[builtins.str]] = None) -> 'ApplianceVlans':
        """
    ...
    @property
    @pulumi.getter(name="applianceIp")
    def appliance_ip(self) -> pulumi.Output[builtins.str]:
        """
        The local IP of the appliance on the VLAN
        """
        return pulumi.get(self, "appliance_ip")
    ...
    @property
    @pulumi.getter(name="dhcpBootFilename")
    def dhcp_boot_filename(self) -> pulumi.Output[builtins.str]:
        """
        DHCP boot option for boot filename
        """
        return pulumi.get(self, "dhcp_boot_filename")
    ...
    @property
    @pulumi.getter(name="dhcpBootNextServer")
    def dhcp_boot_next_server(self) -> pulumi.Output[builtins.str]:
        """
        DHCP boot option to direct boot clients to the server to load the boot file from
        """
        return pulumi.get(self, "dhcp_boot_next_server")
    ...
    @property
    @pulumi.getter(name="dhcpBootOptionsEnabled")
    def dhcp_boot_options_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Use DHCP boot options specified in other properties
        """
        return pulumi.get(self, "dhcp_boot_options_enabled")
    ...
    @property
    @pulumi.getter(name="dhcpHandling")
    def dhcp_handling(self) -> pulumi.Output[builtins.str]:
        """
        The appliance's handling of DHCP requests on this VLAN. One of: 'Run a DHCP server', 'Relay DHCP to another server' or 'Do not respond to DHCP requests'
        """
        return pulumi.get(self, "dhcp_handling")
    ...
    @property
    @pulumi.getter(name="dnsNameservers")
    def dns_nameservers(self) -> pulumi.Output[builtins.str]:
        """
        The DNS nameservers used for DHCP responses, either "upstream*dns", "google*dns", "opendns", or a newline seperated string of IP addresses or domain names
        """
        return pulumi.get(self, "dns_nameservers")
    ...
    @property
    @pulumi.getter(name="groupPolicyId")
    def group_policy_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of the desired group policy to apply to the VLAN
        """
        return pulumi.get(self, "group_policy_id")
    ...
    @property
    @pulumi.getter
    def mask(self) -> pulumi.Output[builtins.int]:
        """
        Mask used for the subnet of all bound to the template networks. Applicable only for template network.
        """
        return pulumi.get(self, "mask")
    ...
    @property
    @pulumi.getter(name="templateVlanType")
    def template_vlan_type(self) -> pulumi.Output[builtins.str]:
        """
        Type of subnetting of the VLAN. Applicable only for template network.
        """
        return pulumi.get(self, "template_vlan_type")
    ...
    @property
    @pulumi.getter(name="vlanId")
    def vlan_id(self) -> pulumi.Output[builtins.str]:
        """
        The VLAN ID of the VLAN
        """
        return pulumi.get(self, "vlan_id")
    ...
    @property
    @pulumi.getter(name="vpnNatSubnet")
    def vpn_nat_subnet(self) -> pulumi.Output[builtins.str]:
        """
        The translated VPN subnet if VPN and VPN subnet translation are enabled on the VLAN
        """
        return pulumi.get(self, "vpn_nat_subnet")
