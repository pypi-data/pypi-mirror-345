...
class Db:
    ...
    def get_async_sql_write_client(
        ...
        if new_instance:
            return SQLModelAsyncSession(self.async_sql_write_engine)
    ...
    def get_async_sql_read_client(
        ...
        if new_instance:
            return SQLModelAsyncSession(self.async_sql_read_engine)
        if not new_instance and self._async_sql_read_instance is not None:
            return self._async_sql_read_instance
        self._async_sql_read_instance = SQLModelAsyncSession(self.async_sql_read_engine)
        return self._async_sql_read_instance
