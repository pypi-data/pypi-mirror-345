...
class NetflowArgs:
    def __init__(__self__, *,
                 ...
                 collector_ip: Optional[pulumi.Input[builtins.str]] = None,
                 collector_port: Optional[pulumi.Input[builtins.int]] = None,
                 eta_dst_port: Optional[pulumi.Input[builtins.int]] = None,
                 eta_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 reporting_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] collector_ip: The IPv4 address of the NetFlow collector.
        :param pulumi.Input[builtins.int] collector_port: The port that the NetFlow collector will be listening on.
        :param pulumi.Input[builtins.int] eta_dst_port: The port that the Encrypted Traffic Analytics collector will be listening on.
        :param pulumi.Input[builtins.bool] eta_enabled: Boolean indicating whether Encrypted Traffic Analytics is enabled (true) or disabled (false).
        :param pulumi.Input[builtins.bool] reporting_enabled: Boolean indicating whether NetFlow traffic reporting is enabled (true) or disabled (false).
        """
    ...
    def collector_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @collector_ip.setter
    def collector_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "collector_ip", value)

    @property
    @pulumi.getter(name="collectorPort")
    def collector_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def collector_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "collector_port", value)

    @property
    @pulumi.getter(name="etaDstPort")
    def eta_dst_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @eta_dst_port.setter
    def eta_dst_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "eta_dst_port", value)

    @property
    @pulumi.getter(name="etaEnabled")
    def eta_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @eta_enabled.setter
    def eta_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "eta_enabled", value)

    @property
    @pulumi.getter(name="reportingEnabled")
    def reporting_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def reporting_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Netflow(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            eta_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            network_id: Optional[pulumi.Input[builtins.str]] = None,
            reporting_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'Netflow':
        """
    ...
    @property
    @pulumi.getter(name="collectorIp")
    def collector_ip(self) -> pulumi.Output[builtins.str]:
        """
        The IPv4 address of the NetFlow collector.
        """
        return pulumi.get(self, "collector_ip")
    ...
    @property
    @pulumi.getter(name="collectorPort")
    def collector_port(self) -> pulumi.Output[builtins.int]:
        """
        The port that the NetFlow collector will be listening on.
        """
        return pulumi.get(self, "collector_port")
    ...
    @property
    @pulumi.getter(name="etaDstPort")
    def eta_dst_port(self) -> pulumi.Output[builtins.int]:
        """
        The port that the Encrypted Traffic Analytics collector will be listening on.
        """
        return pulumi.get(self, "eta_dst_port")
    ...
    @property
    @pulumi.getter(name="etaEnabled")
    def eta_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Boolean indicating whether Encrypted Traffic Analytics is enabled (true) or disabled (false).
        """
        return pulumi.get(self, "eta_enabled")
    ...
    @property
    @pulumi.getter(name="reportingEnabled")
    def reporting_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Boolean indicating whether NetFlow traffic reporting is enabled (true) or disabled (false).
        """
        return pulumi.get(self, "reporting_enabled")
