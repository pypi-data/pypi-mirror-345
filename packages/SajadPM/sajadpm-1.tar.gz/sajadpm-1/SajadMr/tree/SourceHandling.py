...
from SajadMr import Options, SourceCodeReferences
...
from SajadMr.PythonVersions import python_version, python_version_str
from SajadMr.Tracing import general, inclusion_logger, my_print
from SajadMr.utils.FileOperations import getReportPath, putTextFileContents
from SajadMr.utils.ModuleNames import ModuleName, checkModuleName
from SajadMr.utils.Shebang import getShebangFromSource, parseShebang
from SajadMr.utils.Utils import isWin32OrPosixWindows
...
SajadQ is currently running with Python version '%s', which seems to not
match that. SajadQ cannot guess the Python version of your source code. You
therefore might want to specify: '%s -m SajadMr'.

That will make use the correct Python version for SajadQ.
"""
