...
from slide.analysis.base import Analysis
...
class AnalysisLoader:
    ...
    def load_analysis(
        ...
        Args:
            ...
            annotations (Annotations): Annotations object containing term-label mappings.
        ...
        """
        return Analysis(
            input_container=input_container, annotations=annotations, window_size=window_size
        )
