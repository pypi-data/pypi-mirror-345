...
class total_precipitation_mass_rate(ResourceTypeDescriptor):
    """The amount of liquid and frozen water mass, including rain and snow, per unit are per unit time."""
