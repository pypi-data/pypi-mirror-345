...
def lazy_import():
    from sifflet_sdk.client.model.rule_run_details_by_group_dto import (
        RuleRunDetailsByGroupDto,
    )

    globals()["RuleRunDetailsByGroupDto"] = RuleRunDetailsByGroupDto


class SearchCollectionRuleRunDetailsByGroupDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([RuleRunDetailsByGroupDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SearchCollectionRuleRunDetailsByGroupDto - a model defined in OpenAPI

        Args:
            data ([RuleRunDetailsByGroupDto]):
