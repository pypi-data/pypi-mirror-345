...
#ifndef __SajadSx_TRACING_H__
#define __SajadSx_TRACING_H__
...
#define SajadSx_PRINT_TRACE(value)                                                                                      \
    {                                                                                                                  \
        puts(value);                                                                                                   \
        fflush(stdout);                                                                                                \
    }
#define SajadSx_PRINTF_TRACE(...)                                                                                       \
    {                                                                                                                  \
        printf(__VA_ARGS__);                                                                                           \
        fflush(stdout);                                                                                                \
    }
...
#define SajadSx_PRINT_TIMING(value)                                                                                     \
    {                                                                                                                  \
        PRINT_TIME_STAMP();                                                                                            \
        puts(value);                                                                                                   \
        fflush(stdout);                                                                                                \
...
#define SajadSx_PRINT_TIMING(value) SajadSx_PRINT_TRACE(value)
