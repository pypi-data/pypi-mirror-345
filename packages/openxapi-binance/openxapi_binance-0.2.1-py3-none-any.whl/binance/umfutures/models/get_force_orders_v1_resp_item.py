...
class GetForceOrdersV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["avgPrice", "clientOrderId", "closePosition", "cumQuote", "executedQty", "orderId", "origQty", "origType", "positionSide", "price", "reduceOnly", "side", "status", "stopPrice", "symbol", "time", "timeInForce", "type", "updateTime", "workingType"]
