...
static struct SajadQ_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
...
// in this un-optimized form. These are not compiled by SajadQ, and therefore
...
void copyFrozenModulesTo(struct _frozen *destination) {
    SajadSx_PRINT_TIMING("copyFrozenModulesTo(): Calling _loadBytesCodesBlob.");
    _loadBytesCodesBlob(NULL);

    SajadSx_PRINT_TIMING("copyFrozenModulesTo(): Updating frozen module table sizes.");
...
struct SajadQ_MetaPathBasedLoaderEntry const *getLoaderEntry(char const *name) {
    struct SajadQ_MetaPathBasedLoaderEntry *current = meta_path_loader_entries;
