...
class CookiesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.refresh_auth_cookie_endpoint = _Endpoint(
            settings={
                "response_type": None,
                "auth": ["JWT"],
                "endpoint_path": "/ui/v1/auth/cookies/refresh",
                "operation_id": "refresh_auth_cookie",
                "http_method": "GET",
                "servers": None,
            },
    ...
    def refresh_auth_cookie(self, **kwargs):
        """Refresh an authentication cookie  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.refresh_auth_cookie(async_req=True)
        >>> result = thread.get()
        ...
        return self.refresh_auth_cookie_endpoint.call_with_http_info(**kwargs)
