# AUTOGENERATED! DO NOT EDIT! File to edit: ../../pts/api/export.pct.py.
...
# %% ../../pts/api/export.pct.py 19
def get_nb_as_function():
    pass

# %% ../../pts/api/export.pct.py 21
