...
class SearchCollectionAlertingHookDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([AlertingHookDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SearchCollectionAlertingHookDto - a model defined in OpenAPI

        Args:
            data ([AlertingHookDto]):
