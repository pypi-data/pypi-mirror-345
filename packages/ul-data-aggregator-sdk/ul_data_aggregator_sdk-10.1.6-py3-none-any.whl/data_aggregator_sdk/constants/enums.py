...
class IntegrationV0MessageEvent(Enum):
    ...
    @classmethod
    def get_events_by_level(cls, level: str) -> list['IntegrationV0MessageEvent']:
        events_levels_mapping = {
            DeviceEventLevelEnum.CRITICAL.value: cls.get_critical(),
            DeviceEventLevelEnum.WARNING.value: cls.get_warning(),
            DeviceEventLevelEnum.INFO.value: cls.get_info(),
            DeviceEventLevelEnum.SYSTEM.value: cls.get_system(),
        }
