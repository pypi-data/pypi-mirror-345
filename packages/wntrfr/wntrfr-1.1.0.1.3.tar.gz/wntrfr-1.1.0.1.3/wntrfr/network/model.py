...
import pandas as pd
import six
import wntrfr.epanet
import wntrfr.network.io
...
class WaterNetworkModel(AbstractModel):
    ...
    def add_pattern(self, name, pattern=None):
        ...
        :class:`~wntrfr.network.elements.Pattern` object. The Pattern class has options to automatically
        ...
        pattern : list of floats or Pattern
            A list of floats that make up the pattern, or a :class:`~wntrfr.network.elements.Pattern` object.
    ...
    def to_dict(self):
        ...
        dict
        """
        return wntrfr.network.io.to_dict(self)
    ...
    def from_dict(self, d: dict):
        ...
        d : dict
            Dictionary representation of the WaterNetworkModel
        """
        wntrfr.network.io.from_dict(d, append=self)
    ...
    def to_gis(self, crs=None, pumps_as_points=False, valves_as_points=False):
        ...
        """
        return wntrfr.network.io.to_gis(self, crs, pumps_as_points, valves_as_points)
    ...
    def from_gis(self, gis_data):
        ...
        WaterNetworkModel
        """
        return wntrfr.network.io.from_gis(gis_data, append=self)
    ...
    def to_graph(self, node_weight=None, link_weight=None, 
        ...
        """
        return wntrfr.network.io.to_graph(self, node_weight, link_weight, 
                                        modify_direction)
    ...
    def get_graph(self, node_weight=None, link_weight=None, modify_direction=False):
        ...
        networkx MultiDiGraph
        """
        warn("wntrfr.network.WaterNetworkModel.get_graph is deprecated, use wntrfr.network.WaterNetworkModel.to_graph instead", DeprecationWarning, stacklevel=2)
    ...
    def query_node_attribute(self, attribute, operation=None, value=None, node_type=None):
        ...
        node_type: Node type
            ...
            wntrfr.network.model.Node,
            wntrfr.network.model.Junction,
            wntrfr.network.model.Reservoir,
            wntrfr.network.model.Tank, or None. Default = None.
            Note None and wntrfr.network.model.Node produce the same results.
    ...
    def query_link_attribute(self, attribute, operation=None, value=None, link_type=None):
        ...
        link_type: Link type
            ...
            wntrfr.network.model.Link,
            wntrfr.network.model.Pipe,
            wntrfr.network.model.Pump,
            wntrfr.network.model.Valve, or None. Default = None.
            Note None and wntrfr.network.model.Link produce the same results.
...
class PatternRegistry(Registry):
    ...
    def add_pattern(self, name, pattern=None):
        ...
        a :class:`~wntrfr.network.elements.Pattern` object. The Pattern class has 
        ...
        pattern : list of floats or Pattern
            ...
            :class:`~wntrfr.network.elements.Pattern` object.
