...
class ClientsPolicyArgs:
    def __init__(__self__, *,
                 ...
                 device_policy: Optional[pulumi.Input[builtins.str]] = None,
                 group_policy_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ClientsPolicy resource.
        :param pulumi.Input[builtins.str] client_id: clientId path parameter. Client ID
        :param pulumi.Input[builtins.str] network_id: networkId path parameter. Network ID
        :param pulumi.Input[builtins.str] device_policy: The name of the client's policy
        :param pulumi.Input[builtins.str] group_policy_id: The group policy identifier of the client
        """
    ...
    def device_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def device_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ClientsPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] device_policy: The name of the client's policy
        :param pulumi.Input[builtins.str] group_policy_id: The group policy identifier of the client
        :param pulumi.Input[builtins.str] mac: The MAC address of the client
        :param pulumi.Input[builtins.str] network_id: networkId path parameter. Network ID
        """
...
class ClientsPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            group_policy_id: Optional[pulumi.Input[builtins.str]] = None,
            mac: Optional[pulumi.Input[builtins.str]] = None,
            network_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ClientsPolicy':
        """
    ...
    @property
    @pulumi.getter(name="devicePolicy")
    def device_policy(self) -> pulumi.Output[builtins.str]:
        """
        The name of the client's policy
        """
        return pulumi.get(self, "device_policy")
