...
class diffuse_poa_on_back(ResourceTypeDescriptor):
    """The total diffuse solar irradiance incident on the back side of a photovoltaic (PV) module, adjusted for the module’s orientation and tilt"""
