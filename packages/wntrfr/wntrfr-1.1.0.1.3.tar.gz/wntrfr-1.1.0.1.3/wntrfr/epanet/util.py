"""
The wntrfr.epanet.util module contains unit conversion utilities based on EPANET units.
"""
import enum
import logging
...
class FlowUnits(enum.Enum):
    ...
    Examples
    --------
    >>> from wntrfr.epanet import FlowUnits
    >>> FlowUnits.GPM
...
class HydParam(enum.Enum):
    ...
    between EPANET internal units and SI units used by wntrfr. The units for each
