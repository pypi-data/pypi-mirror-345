...
import warnings
from wntrfr.utils.polynomial_interpolation import cubic_spline
from wntrfr.network import LinkStatus
from wntrfr.sim.models.utils import ModelUpdater, Definition
    ...
    def build(cls, m, wn, updater, index_over=None):
        ...
        for link_name in index_over:
            ...
            if status == LinkStatus.Closed or link._is_isolated:
                ...
                if status is wntrfr.network.LinkStatus.Active:
