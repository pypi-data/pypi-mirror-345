...
class GetBalanceV1RespItem(BaseModel):
    """
    ...
    withdraw_available: Optional[StrictStr] = Field(default=None, alias="withdrawAvailable")
    __properties: ClassVar[List[str]] = ["accountAlias", "asset", "availableBalance", "balance", "crossUnPnl", "crossWalletBalance", "updateTime", "withdrawAvailable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "withdrawAvailable": obj.get("withdrawAvailable")
        })
        return _obj
