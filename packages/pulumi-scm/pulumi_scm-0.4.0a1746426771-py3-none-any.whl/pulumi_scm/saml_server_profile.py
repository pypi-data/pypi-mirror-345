...
class SamlServerProfileArgs:
    def __init__(__self__, *,
                 ...
                 slo_bindings: Optional[pulumi.Input[builtins.str]] = None,
                 snippet: Optional[pulumi.Input[builtins.str]] = None,
                 sso_bindings: Optional[pulumi.Input[builtins.str]] = None,
                 sso_url: Optional[pulumi.Input[builtins.str]] = None,
                 validate_idp_certificate: Optional[pulumi.Input[builtins.bool]] = None,
                 want_auth_requests_signed: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a SamlServerProfile resource.
        :param pulumi.Input[builtins.str] certificate: The Certificate param. String length must not exceed 63 characters.
        :param pulumi.Input[builtins.str] device: The Device param.
        :param pulumi.Input[builtins.str] entity_id: The EntityId param. String length must be between 1 and 1024 characters.
        :param pulumi.Input[builtins.str] folder: The Folder param.
        :param pulumi.Input[builtins.int] max_clock_skew: The MaxClockSkew param. Value must be between 1 and 900.
        :param pulumi.Input[builtins.str] slo_bindings: The SloBindings param. String must be one of these: `"post"`, `"redirect"`.
        :param pulumi.Input[builtins.str] snippet: The Snippet param.
        :param pulumi.Input[builtins.str] sso_bindings: The SsoBindings param. String must be one of these: `"post"`, `"redirect"`.
        :param pulumi.Input[builtins.str] sso_url: The SsoUrl param. String length must be between 1 and 255 characters.
        :param pulumi.Input[builtins.bool] validate_idp_certificate: The ValidateIdpCertificate param.
        :param pulumi.Input[builtins.bool] want_auth_requests_signed: The WantAuthRequestsSigned param.
        """
    ...
    def max_clock_skew(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_clock_skew(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_clock_skew", value)

    @property
    @pulumi.getter(name="sloBindings")
    def slo_bindings(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @slo_bindings.setter
    def slo_bindings(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sso_bindings(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sso_bindings.setter
    def sso_bindings(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def validate_idp_certificate(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def validate_idp_certificate(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "validate_idp_certificate", value)

    @property
    @pulumi.getter(name="wantAuthRequestsSigned")
    def want_auth_requests_signed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def want_auth_requests_signed(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class SamlServerProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tfid: Optional[pulumi.Input[builtins.str]] = None,
            validate_idp_certificate: Optional[pulumi.Input[builtins.bool]] = None,
            want_auth_requests_signed: Optional[pulumi.Input[builtins.bool]] = None) -> 'SamlServerProfile':
        """
    ...
    @property
    @pulumi.getter(name="entityId")
    def entity_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The EntityId param. String length must be between 1 and 1024 characters.
        """
        return pulumi.get(self, "entity_id")
    ...
    @property
    @pulumi.getter(name="maxClockSkew")
    def max_clock_skew(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The MaxClockSkew param. Value must be between 1 and 900.
        """
        return pulumi.get(self, "max_clock_skew")
    ...
    @property
    @pulumi.getter(name="sloBindings")
    def slo_bindings(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The SloBindings param. String must be one of these: `"post"`, `"redirect"`.
        """
        return pulumi.get(self, "slo_bindings")
    ...
    @property
    @pulumi.getter(name="ssoBindings")
    def sso_bindings(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The SsoBindings param. String must be one of these: `"post"`, `"redirect"`.
        """
        return pulumi.get(self, "sso_bindings")
    ...
    @property
    @pulumi.getter(name="validateIdpCertificate")
    def validate_idp_certificate(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The ValidateIdpCertificate param.
        """
        return pulumi.get(self, "validate_idp_certificate")
    ...
    @property
    @pulumi.getter(name="wantAuthRequestsSigned")
    def want_auth_requests_signed(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The WantAuthRequestsSigned param.
        """
        return pulumi.get(self, "want_auth_requests_signed")
