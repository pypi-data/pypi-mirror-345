...
class GetBrokerUniversalTransferV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["asset", "clientTranId", "fromAccountType", "qty", "status", "time", "toAccountType", "toId", "txnId"]
