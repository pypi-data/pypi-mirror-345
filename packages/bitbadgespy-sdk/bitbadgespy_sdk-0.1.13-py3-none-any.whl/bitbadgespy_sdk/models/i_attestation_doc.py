...
class IAttestationDoc(BaseModel):
    """
    ...
    data_integrity_proof: Optional[ICreateAttestationPayloadDataIntegrityProof] = Field(default=None, alias="dataIntegrityProof")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAttestationDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAttestationDoc from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "dataIntegrityProof": ICreateAttestationPayloadDataIntegrityProof.from_dict(obj["dataIntegrityProof"]) if obj.get("dataIntegrityProof") is not None else None,
            "name": obj.get("name"),
            "image": obj.get("image"),
