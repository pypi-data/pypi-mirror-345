...
class DeleteUmConditionalOrderV1Resp(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["activatePrice", "bookTime", "goodTillDate", "newClientStrategyId", "origQty", "positionSide", "price", "priceMatch", "priceProtect", "priceRate", "reduceOnly", "selfTradePreventionMode", "side", "stopPrice", "strategyId", "strategyStatus", "strategyType", "symbol", "timeInForce", "updateTime", "workingType"]
