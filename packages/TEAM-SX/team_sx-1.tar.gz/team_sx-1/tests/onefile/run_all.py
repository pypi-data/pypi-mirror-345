...
""" Runner for onefile program tests of SajadQ.
...
# Find SajadMr package relative to us. The replacement is for POSIX python
...
from SajadMr.tools.testing.RuntimeTracing import (
