...
Refer to the Terraform Registry for docs: [`data_cloudflare_dns_record`](https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record).
'''
...
class DataCloudflareDnsRecord(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record cloudflare_dns_record}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record cloudflare_dns_record} Data Source.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param zone_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#zone_id DataCloudflareDnsRecord#zone_id}
        :param dns_record_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#dns_record_id DataCloudflareDnsRecord#dns_record_id}
        :param filter: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#filter DataCloudflareDnsRecord#filter}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataCloudflareDnsRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#import import section} in the documentation of this resource for the id to use
    ...
    def put_filter(
        ...
        *,
        ...
        '''
        :param comment: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#comment DataCloudflareDnsRecord#comment}.
        :param content: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#content DataCloudflareDnsRecord#content}.
        :param direction: Direction to order DNS records in. Available values: "asc", "desc". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#direction DataCloudflareDnsRecord#direction}
        :param match: Whether to match all search requirements or at least one (any). If set to ``all``, acts like a logical AND between filters. If set to ``any``, acts like a logical OR instead. Note that the interaction between tag filters is controlled by the ``tag-match`` parameter instead. Available values: "any", "all". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#match DataCloudflareDnsRecord#match}
        :param name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#name DataCloudflareDnsRecord#name}.
        :param order: Field to order DNS records by. Available values: "type", "name", "content", "ttl", "proxied". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#order DataCloudflareDnsRecord#order}
        :param proxied: Whether the record is receiving the performance and security benefits of Cloudflare. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#proxied DataCloudflareDnsRecord#proxied}
        :param search: Allows searching in multiple properties of a DNS record simultaneously. This parameter is intended for human users, not automation. Its exact behavior is intentionally left unspecified and is subject to change in the future. This parameter works independently of the ``match`` setting. For automated searches, please use the other available parameters. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#search DataCloudflareDnsRecord#search}
        :param tag: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#tag DataCloudflareDnsRecord#tag}.
        :param tag_match: Whether to match all tag search requirements or at least one (any). If set to ``all``, acts like a logical AND between tag filters. If set to ``any``, acts like a logical OR instead. Note that the regular ``match`` parameter is still used to combine the resulting condition with other filters that aren't related to tags. Available values: "any", "all". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#tag_match DataCloudflareDnsRecord#tag_match}
        :param type: Record type. Available values: "A", "AAAA", "CAA", "CERT", "CNAME", "DNSKEY", "DS", "HTTPS", "LOC", "MX", "NAPTR", "NS", "OPENPGPKEY", "PTR", "SMIMEA", "SRV", "SSHFP", "SVCB", "TLSA", "TXT", "URI". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#type DataCloudflareDnsRecord#type}
        '''
...
class DataCloudflareDnsRecordConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def zone_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#zone_id DataCloudflareDnsRecord#zone_id}
        '''
    ...
    def dns_record_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#dns_record_id DataCloudflareDnsRecord#dns_record_id}
        '''
    ...
    def filter(self) -> typing.Optional["DataCloudflareDnsRecordFilter"]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#filter DataCloudflareDnsRecord#filter}.'''
...
class DataCloudflareDnsRecordFilter:
    ...
    def comment(self) -> typing.Optional["DataCloudflareDnsRecordFilterComment"]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#comment DataCloudflareDnsRecord#comment}.'''
    ...
    def content(self) -> typing.Optional["DataCloudflareDnsRecordFilterContent"]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#content DataCloudflareDnsRecord#content}.'''
    ...
    def direction(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#direction DataCloudflareDnsRecord#direction}
        '''
    ...
    def match(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#match DataCloudflareDnsRecord#match}
        '''
    ...
    def name(self) -> typing.Optional["DataCloudflareDnsRecordFilterName"]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#name DataCloudflareDnsRecord#name}.'''
    ...
    def order(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#order DataCloudflareDnsRecord#order}
        '''
    ...
    def proxied(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#proxied DataCloudflareDnsRecord#proxied}
        '''
    ...
    def search(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#search DataCloudflareDnsRecord#search}
        '''
    ...
    def tag(self) -> typing.Optional["DataCloudflareDnsRecordFilterTag"]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#tag DataCloudflareDnsRecord#tag}.'''
    ...
    def tag_match(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#tag_match DataCloudflareDnsRecord#tag_match}
        '''
    ...
    def type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#type DataCloudflareDnsRecord#type}
        '''
...
class DataCloudflareDnsRecordFilterComment:
    def __init__(
        ...
        *,
        ...
        '''
        :param absent: If this parameter is present, only records *without* a comment are returned. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#absent DataCloudflareDnsRecord#absent}
        :param contains: Substring of the DNS record comment. Comment filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#contains DataCloudflareDnsRecord#contains}
        :param endswith: Suffix of the DNS record comment. Comment filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#endswith DataCloudflareDnsRecord#endswith}
        :param exact: Exact value of the DNS record comment. Comment filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#exact DataCloudflareDnsRecord#exact}
        :param present: If this parameter is present, only records *with* a comment are returned. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#present DataCloudflareDnsRecord#present}
        :param startswith: Prefix of the DNS record comment. Comment filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#startswith DataCloudflareDnsRecord#startswith}
        '''
        if __debug__:
    ...
    def absent(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#absent DataCloudflareDnsRecord#absent}
        '''
    ...
    def contains(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#contains DataCloudflareDnsRecord#contains}
        '''
    ...
    def endswith(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#endswith DataCloudflareDnsRecord#endswith}
        '''
    ...
    def exact(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#exact DataCloudflareDnsRecord#exact}
        '''
    ...
    def present(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#present DataCloudflareDnsRecord#present}
        '''
    ...
    def startswith(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#startswith DataCloudflareDnsRecord#startswith}
        '''
...
class DataCloudflareDnsRecordFilterContent:
    def __init__(
        ...
        *,
        ...
        '''
        :param contains: Substring of the DNS record content. Content filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#contains DataCloudflareDnsRecord#contains}
        :param endswith: Suffix of the DNS record content. Content filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#endswith DataCloudflareDnsRecord#endswith}
        :param exact: Exact value of the DNS record content. Content filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#exact DataCloudflareDnsRecord#exact}
        :param startswith: Prefix of the DNS record content. Content filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#startswith DataCloudflareDnsRecord#startswith}
        '''
        if __debug__:
...
class DataCloudflareDnsRecordFilterName:
    def __init__(
        ...
        *,
        ...
        '''
        :param contains: Substring of the DNS record name. Name filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#contains DataCloudflareDnsRecord#contains}
        :param endswith: Suffix of the DNS record name. Name filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#endswith DataCloudflareDnsRecord#endswith}
        :param exact: Exact value of the DNS record name. Name filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#exact DataCloudflareDnsRecord#exact}
        :param startswith: Prefix of the DNS record name. Name filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#startswith DataCloudflareDnsRecord#startswith}
        '''
        if __debug__:
...
class DataCloudflareDnsRecordFilterOutputReference(
    ...
    def put_tag(
        ...
        *,
        ...
        '''
        :param absent: Name of a tag which must *not* be present on the DNS record. Tag filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#absent DataCloudflareDnsRecord#absent}
        :param contains: A tag and value, of the form ``<tag-name>:<tag-value>``. The API will only return DNS records that have a tag named ``<tag-name>`` whose value contains ``<tag-value>``. Tag filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#contains DataCloudflareDnsRecord#contains}
        :param endswith: A tag and value, of the form ``<tag-name>:<tag-value>``. The API will only return DNS records that have a tag named ``<tag-name>`` whose value ends with ``<tag-value>``. Tag filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#endswith DataCloudflareDnsRecord#endswith}
        :param exact: A tag and value, of the form ``<tag-name>:<tag-value>``. The API will only return DNS records that have a tag named ``<tag-name>`` whose value is ``<tag-value>``. Tag filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#exact DataCloudflareDnsRecord#exact}
        :param present: Name of a tag which must be present on the DNS record. Tag filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#present DataCloudflareDnsRecord#present}
        :param startswith: A tag and value, of the form ``<tag-name>:<tag-value>``. The API will only return DNS records that have a tag named ``<tag-name>`` whose value starts with ``<tag-value>``. Tag filters are case-insensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/dns_record#startswith DataCloudflareDnsRecord#startswith}
        '''
