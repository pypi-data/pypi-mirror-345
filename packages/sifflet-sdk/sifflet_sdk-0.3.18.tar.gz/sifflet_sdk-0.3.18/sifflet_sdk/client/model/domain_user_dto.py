...
class DomainUserDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email, id, name, role, *args, **kwargs):  # noqa: E501
        """DomainUserDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, email, id, name, role, *args, **kwargs):  # noqa: E501
        """DomainUserDto - a model defined in OpenAPI
