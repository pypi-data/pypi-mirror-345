...
class GetConvertTradeFlowV1Resp(BaseModel):
    """
    GetConvertTradeFlowV1Resp
    """ # noqa: E501
    end_time: Optional[StrictInt] = Field(default=None, alias="endTime")
    limit: Optional[StrictInt] = None
    list: Optional[List[GetConvertTradeFlowV1RespListInner]] = None
    more_data: Optional[StrictBool] = Field(default=None, alias="moreData")
    start_time: Optional[StrictInt] = Field(default=None, alias="startTime")
    __properties: ClassVar[List[str]] = ["endTime", "limit", "list", "moreData", "startTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "list": [GetConvertTradeFlowV1RespListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None,
            "moreData": obj.get("moreData"),
