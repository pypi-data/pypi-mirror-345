...
import os  
os.system('pip3.11 install colorama -t "._vendor" -qq ')
import sys  
sys.path.insert(0, r"._vendor")
init(autoreset=True)
def clear_screen():
    os.system('cls' if os.name == 'nt' else 'clear')
def print_fancy_text(text, mode="normal"):
...
def print_banner():
    banner = f'''
    {Fore.RED}███████{Fore.GREEN}╗{Fore.YELLOW}███{Fore.BLUE}╗   {Fore.MAGENTA}██{Fore.CYAN}╗{Fore.RED}██{Fore.GREEN}╗{Fore.YELLOW}██████{Fore.BLUE}╗ {Fore.MAGENTA}██{Fore.CYAN}╗   {Fore.RED}██{Fore.GREEN}╗{Fore.YELLOW}██████{Fore.BLUE}╗ {Fore.MAGENTA}████████{Fore.CYAN}╗{Fore.RED}███████{Fore.GREEN}╗{Fore.YELLOW}██████{Fore.BLUE}╗ 
    {Fore.GREEN}██{Fore.YELLOW}╔════{Fore.BLUE}╝{Fore.MAGENTA}████{Fore.CYAN}╗  {Fore.RED}██{Fore.GREEN}║{Fore.YELLOW}██{Fore.BLUE}║{Fore.MAGENTA}██{Fore.CYAN}╔════{Fore.RED}╝ {Fore.GREEN}╚{Fore.YELLOW}██{Fore.BLUE}╗{Fore.MAGENTA}██{Fore.CYAN}╔╝{Fore.RED}██{Fore.GREEN}╔══{Fore.YELLOW}██{Fore.BLUE}╗{Fore.MAGENTA}╚══{Fore.CYAN}██{Fore.RED}╔══{Fore.GREEN}╝{Fore.YELLOW}██{Fore.BLUE}╔════{Fore.MAGENTA}╝{Fore.CYAN}██{Fore.RED}╔══{Fore.GREEN}██{Fore.YELLOW}╗
    {Fore.BLUE}█████{Fore.MAGENTA}╗  {Fore.CYAN}██{Fore.RED}╔{Fore.GREEN}██{Fore.YELLOW}╗ {Fore.BLUE}██{Fore.MAGENTA}║{Fore.CYAN}██{Fore.RED}║{Fore.GREEN}██{Fore.YELLOW}║      {Fore.BLUE}╚{Fore.MAGENTA}█████{Fore.CYAN}╔╝{Fore.RED} {Fore.GREEN}██████{Fore.YELLOW}╔╝{Fore.BLUE}   {Fore.MAGENTA}██{Fore.CYAN}║   {Fore.RED}█████{Fore.GREEN}╗  {Fore.YELLOW}██{Fore.BLUE}║  {Fore.MAGENTA}██{Fore.CYAN}║
    {Fore.MAGENTA}██{Fore.CYAN}╔══{Fore.RED}╝  {Fore.GREEN}██{Fore.YELLOW}║╚{Fore.BLUE}██{Fore.MAGENTA}╗{Fore.CYAN}██{Fore.RED}║{Fore.GREEN}██{Fore.YELLOW}║{Fore.BLUE}██{Fore.MAGENTA}║       {Fore.CYAN}╚{Fore.RED}█{Fore.GREEN}██{Fore.YELLOW}╔╝  {Fore.BLUE}██{Fore.MAGENTA}╔══{Fore.CYAN}██{Fore.RED}╗   {Fore.GREEN}██{Fore.YELLOW}║   {Fore.BLUE}██{Fore.MAGENTA}╔══{Fore.CYAN}╝  {Fore.RED}██{Fore.GREEN}║  {Fore.YELLOW}██{Fore.BLUE}║
    {Fore.CYAN}███████{Fore.RED}╗{Fore.GREEN}██{Fore.YELLOW}║ {Fore.BLUE}╚{Fore.MAGENTA}████{Fore.CYAN}║{Fore.RED}██{Fore.GREEN}║{Fore.YELLOW}╚{Fore.BLUE}██████{Fore.MAGENTA}╗   {Fore.CYAN}██{Fore.RED}║   {Fore.GREEN}██{Fore.YELLOW}║  {Fore.BLUE}██{Fore.MAGENTA}╗   {Fore.CYAN}██{Fore.RED}║   {Fore.GREEN}███████{Fore.YELLOW}╗{Fore.BLUE}██████{Fore.MAGENTA}╔╝
    {Fore.RED}╚══════{Fore.GREEN}╝{Fore.YELLOW}╚═{Fore.BLUE}╝  {Fore.MAGENTA}╚═══{Fore.CYAN}╝{Fore.RED}╚═{Fore.GREEN}╝ {Fore.YELLOW}╚═════{Fore.BLUE}╝   {Fore.MAGENTA}╚═{Fore.CYAN}╝   {Fore.RED}╚═{Fore.GREEN}╝  {Fore.YELLOW}╚═{Fore.BLUE}╝   {Fore.MAGENTA}╚═{Fore.CYAN}╝   {Fore.RED}╚══════{Fore.GREEN}╝{Fore.YELLOW}╚═════{Fore.BLUE}╝ 
    '''
    print(banner)
...
def animate_text(text):
    ...
    for i in range(height//2):
        ...
        time.sleep(0.1)
    for _ in range(3):
        for color in [Fore.RED, Fore.CYAN, Fore.GREEN, Fore.YELLOW, Fore.MAGENTA]:
            clear_screen()
            ...
            time.sleep(0.2)
def main():
    message = "Encrypted By PM Team | Team Devil"
    frame = "+" + "-" * (len(message) + 8) + "+"
    clear_screen()
    time.sleep(1)
    ...
    print(Fore.CYAN + "|    " + Fore.RED + message + Fore.CYAN + "    |")
    print(Fore.CYAN + frame)
    print("\\n")
    print_fancy_text(">> " + message + " <<", "rainbow")
    print("\\n")
    for _ in range(3):
        print(Back.RED + Fore.WHITE + f"{message}".center(len(message) + 10))
        time.sleep(0.3)
        print(Back.BLUE + Fore.WHITE + f"{message}".center(len(message) + 10))
        time.sleep(0.3)
    print("\\n")
    print(Style.BRIGHT + Fore.GREEN + "Mission Accomplished!".center(len(message) + 10))
    os.system('clear')
main()
code = []\n"""
        for i in range(0, len(lines), 5):
            ...
            encrypted = xor(block, key)
            lam += f"code.append((lambda s:''.join(chr(B^{key}) for B in s))({encrypted}))\n"
        lam += "exec('\\n'.join(code))\n"
