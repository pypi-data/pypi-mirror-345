...
#     etld_lib_spawn_etl.log_file_max_size = etld_lib_config.host_list_log_file_max_size                                            # 1024 * size = Max Meg Size
#     etld_lib_spawn_etl.spawned_process_max_run_time = etld_lib_config.host_list_spawned_process_max_run_time                      # seconds before terminate as there is an issue.
#     etld_lib_spawn_etl.spawned_process_sleep_time = etld_lib_config.host_list_spawned_process_sleep_time                          # check every n seconds for spawned_process.is_alive()
#     etld_lib_spawn_etl.spawned_process_count_to_status_update = etld_lib_config.host_list_spawned_process_count_to_status_update  # print status spawned_process.is_alive() after n checks
#     etld_lib_spawn_etl.etl_files_max_time_between_changes = etld_lib_config.host_list_etl_files_max_time_between_changes
#
