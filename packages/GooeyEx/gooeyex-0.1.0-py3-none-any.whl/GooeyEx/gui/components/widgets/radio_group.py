...
from GooeyEx.gui.components.widgets.bases import BaseWidget
from GooeyEx.gui.lang.i18n import _
from GooeyEx.gui.util import wx_util
from GooeyEx.gui.components.widgets import CheckBox
from GooeyEx.util.functional import getin, merge
...
class RadioGroup(BaseWidget):
    ...
    def isSameRadioButton(self, radioButton1, radioButton2):
        return getattr(radioButton1, "Id", "r1-not-found") == getattr(
            radioButton2, "Id", "r2-not-found"
        )
    ...
    def createWidgets(self):
        ...
        widgets = [
            getattr(widgets, item["type"])(self, item)
