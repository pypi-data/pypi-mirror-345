...
from senchar.image_io import ImageIO


class Image(ImageHeaders, ImageIO):
    """
    Class to create and manipulate the standard senchar image object.
    """
    ...
    def __init__(self, filename=""):
        ...
        self.from_file = 0
        # True if image was read from a file and has senchar header
    ...
    def write_file(self, filename: str, filetype: int = -1):
        ...
        if filetype == 0:
            ...
            raise senchar.exceptions.SencharError("Invalid filetype for Image")
    ...
    def assemble(self, trim: int = -1):
        ...
        if not self.is_valid:
            raise senchar.exceptions.SencharError("image is not valid")
