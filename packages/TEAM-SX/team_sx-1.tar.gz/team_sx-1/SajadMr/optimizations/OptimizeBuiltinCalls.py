...
from SajadMr.__past__ import unicode, xrange
from SajadMr.Errors import SajadQAssumptionError
from SajadMr.nodes.AttributeNodes import (
    ExpressionBuiltinGetattr,
    ExpressionBuiltinHasattr,
    ExpressionBuiltinSetattr,
    makeExpressionAttributeLookup,
)
from SajadMr.nodes.BuiltinAllNodes import ExpressionBuiltinAll
from SajadMr.nodes.BuiltinAnyNodes import ExpressionBuiltinAny
from SajadMr.nodes.BuiltinComplexNodes import (
    ExpressionBuiltinComplex1,
    ExpressionBuiltinComplex2,
)
from SajadMr.nodes.BuiltinDecodingNodes import (
    ExpressionBuiltinChr,
    ExpressionBuiltinOrd,
)
from SajadMr.nodes.BuiltinDecoratorNodes import (
    ExpressionBuiltinClassmethod,
    ExpressionBuiltinStaticmethod,
)
from SajadMr.nodes.BuiltinDictNodes import ExpressionBuiltinDict
from SajadMr.nodes.BuiltinFormatNodes import (
...
from SajadMr.nodes.BuiltinHashNodes import ExpressionBuiltinHash
from SajadMr.nodes.BuiltinInputNodes import ExpressionBuiltinInput
from SajadMr.nodes.BuiltinIntegerNodes import (
    ExpressionBuiltinInt1,
    ExpressionBuiltinInt2,
)
from SajadMr.nodes.BuiltinIteratorNodes import (
    ExpressionBuiltinIter1,
    ExpressionBuiltinIter2,
)
from SajadMr.nodes.BuiltinLenNodes import ExpressionBuiltinLen
from SajadMr.nodes.BuiltinNextNodes import (
    ExpressionBuiltinNext1,
    ExpressionBuiltinNext2,
)
from SajadMr.nodes.BuiltinOpenNodes import (
    ExpressionBuiltinOpenP2,
    ExpressionBuiltinOpenP3,
)
from SajadMr.nodes.BuiltinRangeNodes import (
...
from SajadMr.nodes.BuiltinRefNodes import (
    ExpressionBuiltinAnonymousRef,
    makeExpressionBuiltinTypeRef,
)
from SajadMr.nodes.BuiltinSumNodes import (
    ExpressionBuiltinSum1,
    ExpressionBuiltinSum2,
)
from SajadMr.nodes.BuiltinTypeNodes import (
...
from SajadMr.nodes.BuiltinVarsNodes import ExpressionBuiltinVars
from SajadMr.nodes.CallNodes import makeExpressionCall
from SajadMr.nodes.ClassNodes import ExpressionBuiltinType3
from SajadMr.nodes.ComparisonNodes import ExpressionComparisonIs
from SajadMr.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from SajadMr.nodes.ConstantRefNodes import makeConstantRefNode
from SajadMr.nodes.ContainerMakingNodes import makeExpressionMakeTupleOrConstant
from SajadMr.nodes.ExecEvalNodes import (
    ExpressionBuiltinCompile,
    ExpressionBuiltinEval,
)
from SajadMr.nodes.GlobalsLocalsNodes import (
    ExpressionBuiltinDir1,
    ExpressionBuiltinGlobals,
)
from SajadMr.nodes.ImportNodes import ExpressionBuiltinImport
from SajadMr.nodes.KeyValuePairNodes import (
...
from SajadMr.nodes.OperatorNodes import ExpressionOperationBinaryDivmod
from SajadMr.nodes.OperatorNodesUnary import (
    ExpressionOperationNot,
    ExpressionOperationUnaryAbs,
    ExpressionOperationUnaryRepr,
)
from SajadMr.nodes.OutlineNodes import ExpressionOutlineBody
from SajadMr.nodes.ReturnNodes import makeStatementReturn
from SajadMr.nodes.SliceNodes import makeExpressionBuiltinSlice
from SajadMr.nodes.TypeNodes import (
...
from SajadMr.nodes.VariableAssignNodes import (
    makeStatementAssignmentVariable,
    makeStatementDelVariable,
)
from SajadMr.nodes.VariableRefNodes import (
    ExpressionTempVariableRef,
    ExpressionVariableRef,
)
from SajadMr.PythonVersions import python_version
from SajadMr.specs import BuiltinParameterSpecs
from SajadMr.tree.ReformulationExecStatements import wrapEvalGlobalsAndLocals
from SajadMr.tree.ReformulationTryFinallyStatements import (
    makeTryFinallyStatement,
)
from SajadMr.tree.TreeHelpers import (
    makeCallNode,
...
def range_extractor(node):
    ...
    def makeRange0(source_ref):
        ...
        try:
            ...
            raise SajadQAssumptionError("range without argument is expected to raise")
...
if python_version < 0x300:
    from SajadMr.nodes.ExecEvalNodes import ExpressionBuiltinExecfile
...
if python_version >= 0x300:
    from SajadMr.nodes.ExecEvalNodes import ExpressionBuiltinExec
...
def open_extractor(node):
    def makeOpen0(source_ref):
        ...
        try:
            ...
            raise SajadQAssumptionError("open without argument is expected to raise")
...
def check():
    from SajadMr.Builtins import builtin_names
