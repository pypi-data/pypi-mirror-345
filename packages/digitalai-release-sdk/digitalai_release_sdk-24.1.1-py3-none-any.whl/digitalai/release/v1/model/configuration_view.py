...
class ConfigurationView(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ConfigurationView - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            properties ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)}): [optional]  # noqa: E501
