...
class CreateMarginOrderOcoV1RespOrderReportsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clientOrderId", "cummulativeQuoteQty", "executedQty", "orderId", "orderListId", "origQty", "price", "selfTradePreventionMode", "side", "status", "stopPrice", "symbol", "timeInForce", "transactTime", "type"]
