...
mod.add_function('gotdf_python_OpentdfConfig_CTor', retval('int64_t'), [])
mod.add_function('gotdf_python_OpentdfConfig_ClientId_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('gotdf_python_OpentdfConfig_ClientId_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('gotdf_python_OpentdfConfig_ClientSecret_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('gotdf_python_OpentdfConfig_ClientSecret_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('gotdf_python_OpentdfConfig_PlatformEndpoint_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('gotdf_python_OpentdfConfig_PlatformEndpoint_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('gotdf_python_OpentdfConfig_TokenEndpoint_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('gotdf_python_OpentdfConfig_TokenEndpoint_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('gotdf_python_OpentdfConfig_KasUrl_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('gotdf_python_OpentdfConfig_KasUrl_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
...
add_checked_function(mod, 'gotdf_python_DecryptFilesInDirNPE', retval('int64_t'), [param('char*', 'dirPath'), param('int64_t', 'config'), param('int64_t', 'authScopes')])
add_checked_string_function(mod, 'gotdf_python_EncryptFile', retval('char*'), [param('char*', 'inputFilePath'), param('char*', 'outputFilePath'), param('int64_t', 'config'), param('int64_t', 'dataAttributes'), param('int64_t', 'authScopes')])
add_checked_function(mod, 'gotdf_python_DecryptFilesWithExtensionsNPE', retval('int64_t'), [param('char*', 'dirPath'), param('int64_t', 'extensions'), param('int64_t', 'config'), param('int64_t', 'authScopes')])
add_checked_string_function(mod, 'gotdf_python_DecryptStringPE', retval('char*'), [param('char*', 'inputText'), param('int64_t', 'config'), param('int64_t', 'token'), param('int64_t', 'authScopes')])
add_checked_string_function(mod, 'gotdf_python_EncryptFilePE', retval('char*'), [param('char*', 'inputFilePath'), param('char*', 'outputFilePath'), param('int64_t', 'config'), param('int64_t', 'token'), param('int64_t', 'dataAttributes'), param('int64_t', 'authScopes')])
add_checked_function(mod, 'gotdf_python_EncryptFilesInDirNPE', retval('int64_t'), [param('char*', 'dirPath'), param('int64_t', 'config'), param('int64_t', 'dataAttributes'), param('int64_t', 'authScopes')])
add_checked_function(mod, 'gotdf_python_EncryptFilesWithExtensionsNPE', retval('int64_t'), [param('char*', 'dirPath'), param('int64_t', 'extensions'), param('int64_t', 'config'), param('int64_t', 'dataAttributes'), param('int64_t', 'authScopes')])
add_checked_string_function(mod, 'gotdf_python_EncryptString', retval('char*'), [param('char*', 'inputText'), param('int64_t', 'config'), param('int64_t', 'dataAttributes'), param('int64_t', 'authScopes')])
...
add_checked_string_function(mod, 'gotdf_python_DecryptFilePE', retval('char*'), [param('char*', 'inputFilePath'), param('char*', 'outputFilePath'), param('int64_t', 'config'), param('int64_t', 'token'), param('int64_t', 'authScopes')])
