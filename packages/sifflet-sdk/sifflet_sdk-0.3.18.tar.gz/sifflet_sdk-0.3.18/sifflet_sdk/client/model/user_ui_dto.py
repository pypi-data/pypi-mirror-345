...
def lazy_import():
    from sifflet_sdk.client.model.domain_ui_light_dto import DomainUiLightDto
    from sifflet_sdk.client.model.time_zone_dto import TimeZoneDto

    globals()["DomainUiLightDto"] = DomainUiLightDto
    globals()["TimeZoneDto"] = TimeZoneDto


class UserUiDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "domains": ([DomainUiLightDto],),  # noqa: E501
            "email": (str,),  # noqa: E501
            "id": (str,),  # noqa: E501
    ...
    def _from_openapi_data(
        ...
        **kwargs,
        ...
        """UserUiDto - a model defined in OpenAPI

        Args:
            auth_types ([str]):
            domains ([DomainUiLightDto]):
            email (str):
            id (str):
            is_active (bool):
            name (str):
        ...
        self.role = role
        self.time_zone_data = time_zone_data
        self.type = type
