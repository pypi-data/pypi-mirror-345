...
class TransportCellularControllerFeatureArgs:
    def __init__(__self__, *,
                 cellular_id: pulumi.Input[builtins.str],
                 feature_profile_id: pulumi.Input[builtins.str],
                 cellular_id_variable: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cellular_id: Cellular ID
        :param pulumi.Input[builtins.str] feature_profile_id: Feature Profile ID
        :param pulumi.Input[builtins.str] cellular_id_variable: Variable name
        ...
        :param pulumi.Input[builtins.int] primary_sim_slot: Set primary SIM slot - Range: `0`-`1`
    ...
    def cellular_id(self) -> pulumi.Input[builtins.str]:
        """
        Cellular ID
        """
    ...
    @cellular_id.setter
    def cellular_id(self, value: pulumi.Input[builtins.str]):
    ...
    def cellular_id_variable(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Variable name
        """
    ...
    def cellular_id_variable(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TransportCellularControllerFeatureState:
    def __init__(__self__, *,
                 cellular_id: Optional[pulumi.Input[builtins.str]] = None,
                 cellular_id_variable: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="cellularId")
    def cellular_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Cellular ID
        """
        return pulumi.get(self, "cellular_id")
    ...
    @cellular_id.setter
    def cellular_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cellular_id", value)
...
class TransportCellularControllerFeature(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sim_failover_timeout: Optional[pulumi.Input[builtins.int]] = None,
            sim_failover_timeout_variable: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'TransportCellularControllerFeature':
        """
    ...
    @property
    @pulumi.getter(name="cellularId")
    def cellular_id(self) -> pulumi.Output[builtins.str]:
        """
        Cellular ID
        """
        return pulumi.get(self, "cellular_id")
    ...
    @property
    @pulumi.getter(name="cellularIdVariable")
    def cellular_id_variable(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Variable name
        """
        return pulumi.get(self, "cellular_id_variable")
