...
from SajadMr.__past__ import (  # pylint: disable=redefined-builtin
    BrokenPipeError,
    raw_input,
)
from SajadMr.utils.Utils import isWin32Windows
...
class OurLogger(object):
    ...
    def _warnMnemonic(mnemonic, style, output_function):
        if mnemonic.startswith("http"):
            ...
            url = "https://SajadMr.net/info/%s.html" % mnemonic
    ...
    def sysexit(
        ...
        from SajadMr.Progress import closeProgressBar
...
general = OurLogger("SajadQ")
plugins_logger = OurLogger("SajadQ-Plugins")
recursion_logger = OurLogger("SajadQ-Inclusion")
progress_logger = OurLogger("SajadQ-Progress", quiet=True)
memory_logger = OurLogger("SajadQ-Memory")
metadata_logger = OurLogger("SajadQ-Metadata")
optimization_logger = FileLogger("SajadQ-Optimization")
pgo_logger = FileLogger("SajadQ-PGO")
code_generation_logger = OurLogger("SajadQ-CodeGen")
inclusion_logger = FileLogger("SajadQ-Inclusion")
scons_logger = OurLogger("SajadQ-Scons")
scons_details_logger = OurLogger("SajadQ-Scons")
postprocessing_logger = OurLogger("SajadQ-Postprocessing")
options_logger = OurLogger("SajadQ-Options")
unusual_logger = OurLogger("SajadQ-Unusual")
data_composer_logger = OurLogger("SajadQ-DataComposer")
onefile_logger = OurLogger("SajadQ-Onefile")
tools_logger = OurLogger("SajadQ-Tools")
wheel_logger = OurLogger("SajadQ-Wheel", base_style="blue")
cache_logger = OurLogger("SajadQ-Cache")
reports_logger = OurLogger("SajadQ-Reports")
offsets_logger = OurLogger("SajadQ-Offsets")
