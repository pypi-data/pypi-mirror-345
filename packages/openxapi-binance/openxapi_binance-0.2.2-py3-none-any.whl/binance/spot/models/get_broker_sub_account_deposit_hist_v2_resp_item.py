...
class GetBrokerSubAccountDepositHistV2RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["address", "addressTag", "amount", "coin", "confirmTimes", "depositId", "insertTime", "network", "selfReturnStatus", "status", "subAccountId", "transferType", "travelRuleStatus", "txId"]
