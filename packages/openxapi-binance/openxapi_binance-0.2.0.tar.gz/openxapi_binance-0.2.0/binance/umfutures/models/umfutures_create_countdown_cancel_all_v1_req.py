...
class UmfuturesCreateCountdownCancelAllV1Req(BaseModel):
    """
    UmfuturesCreateCountdownCancelAllV1Req
    """ # noqa: E501
    countdown_time: StrictInt = Field(alias="countdownTime")
    recv_window: Optional[StrictInt] = Field(default=None, alias="recvWindow")
    symbol: StrictStr
    timestamp: StrictInt
    __properties: ClassVar[List[str]] = ["countdownTime", "recvWindow", "symbol", "timestamp"]
