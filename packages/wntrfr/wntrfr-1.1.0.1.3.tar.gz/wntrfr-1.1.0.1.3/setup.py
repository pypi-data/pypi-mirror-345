...
if build:
    ...
    src_files = os.path.join(project_dir, 'wntrfr', 'sim', 'aml')
    ...
    network_isolation_dir = os.path.join(project_dir, 'wntrfr', 'sim', 'network_isolation')
    ...
    if use_swig:
        aml_core_ext = Extension("wntrfr.sim.aml._evaluator",
                                 ...
                                 libraries=[],
                                 swig_opts = ['-c++', '-builtin'])
        network_isolation_ext = Extension("wntrfr.sim.network_isolation._network_isolation",
...
with open(os.path.join(file_dir, 'wntrfr', '__init__.py')) as f:
    version_file = f.read()
