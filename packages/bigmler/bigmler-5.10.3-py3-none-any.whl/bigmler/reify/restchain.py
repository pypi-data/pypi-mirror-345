...
class RESTChain(object):
    ...
    def get_resource(self, resource_id):
        ...
        """
        if (resource_id and not isinstance(resource_id, str) and
    ...
    def reify_source(self, resource_id):
        ...
        for attribute, default_value in list(source_defaults.items()):
            opts["create"].update(
    ...
    def reify_dataset(self, resource_id):
        ...
        for attribute, default_value in list(dataset_defaults.items()):
            opts["update"].update(
                u.default_setting(child, attribute, *default_value))
        ...
        if len(list(preferred_fields.keys())) == 0:
            preferred_fields = resource_fields.fields
        max_column = sorted([field['column_number']
                             for _, field in list(preferred_fields.items())
    ...
    def reify_evaluation(self, resource_id):
        ...
        fields = list(parent2['fields'].keys())
