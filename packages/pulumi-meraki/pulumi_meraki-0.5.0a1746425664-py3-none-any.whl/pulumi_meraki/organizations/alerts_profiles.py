...
class AlertsProfilesArgs:
    def __init__(__self__, *,
                 ...
                 alert_config_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] alert_config_id: alertConfigId path parameter. Alert config ID
        :param pulumi.Input[builtins.str] description: User supplied description of the alert
        :param pulumi.Input[builtins.bool] enabled: Is the alert config enabled
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_tags: Networks with these tags will be monitored for the alert
        :param pulumi.Input['AlertsProfilesRecipientsArgs'] recipients: List of recipients that will recieve the alert.
        :param pulumi.Input[builtins.str] type: The alert type
        """
    ...
    def alert_config_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alert_config_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AlertsProfiles(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            organization_id: Optional[pulumi.Input[builtins.str]] = None,
            recipients: Optional[pulumi.Input[Union['AlertsProfilesRecipientsArgs', 'AlertsProfilesRecipientsArgsDict']]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'AlertsProfiles':
        """
    ...
    @property
    @pulumi.getter(name="alertConfigId")
    def alert_config_id(self) -> pulumi.Output[builtins.str]:
        """
        alertConfigId path parameter. Alert config ID
        """
        return pulumi.get(self, "alert_config_id")
    ...
    @property
    @pulumi.getter(name="networkTags")
    def network_tags(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Networks with these tags will be monitored for the alert
        """
        return pulumi.get(self, "network_tags")
