...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-devicefarm)](https://pypistats.org/packages/mypy-boto3-devicefarm)
...
`mypy-boto3-devicefarm` dependency in production. However, there is an issue in
