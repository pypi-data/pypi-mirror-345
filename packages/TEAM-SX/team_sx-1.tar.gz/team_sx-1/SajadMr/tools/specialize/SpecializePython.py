...
import sys
import SajadMr.Options

SajadMr.Options.is_full_compat = False
...
import SajadMr.code_generation.BinaryOperationHelperDefinitions
import SajadMr.code_generation.CodeGeneration
import SajadMr.code_generation.ComparisonCodes
import SajadMr.code_generation.Namify
import SajadMr.nodes.NetworkxNodes
import SajadMr.nodes.PackageMetadataNodes
import SajadMr.nodes.PackageResourceNodes
import SajadMr.nodes.SideEffectNodes
import SajadMr.nodes.TensorflowNodes
import SajadMr.specs.BuiltinBytesOperationSpecs
import SajadMr.specs.BuiltinDictOperationSpecs
import SajadMr.specs.BuiltinListOperationSpecs
import SajadMr.specs.BuiltinStrOperationSpecs
import SajadMr.specs.BuiltinTypeOperationSpecs
import SajadMr.specs.HardImportSpecs
import SajadMr.tree.Building
from SajadMr.containers.OrderedDicts import OrderedDict
from SajadMr.containers.OrderedSets import OrderedSet
from SajadMr.nodes.ImportNodes import hard_modules_non_stdlib
from SajadMr.nodes.NodeMetaClasses import NodeCheckMetaClass
from SajadMr.nodes.shapes.BuiltinTypeShapes import (
    tshape_bool,
    tshape_bytes,
    tshape_dict,
    tshape_int,
...
from SajadMr.utils.Jinja2 import getTemplate
...
def _getMixinForShape(shape):
    ...
    if shape is tshape_str:
        return "SajadMr.nodes.ExpressionShapeMixins.ExpressionStrShapeExactMixin"
    elif shape is tshape_list:
        return "SajadMr.nodes.ExpressionShapeMixins.ExpressionListShapeExactMixin"
    elif shape is tshape_tuple:
        return "SajadMr.nodes.ExpressionShapeMixins.ExpressionTupleShapeExactMixin"
    elif shape is tshape_int:
        return "SajadMr.nodes.ExpressionShapeMixins.ExpressionIntShapeExactMixin"
    elif shape is tshape_bool:
        return "SajadMr.nodes.ExpressionShapeMixins.ExpressionBoolShapeExactMixin"
    elif shape is tshape_none:
        return "SajadMr.nodes.ExpressionShapeMixins.ExpressionNoneShapeExactMixin"
    elif shape is tshape_dict:
        return "SajadMr.nodes.ExpressionShapeMixins.ExpressionDictShapeExactMixin"
    elif shape is tshape_bytes:
        return "SajadMr.nodes.ExpressionShapeMixins.ExpressionBytesShapeExactMixin"
    else:
        assert False, shape
...
processTypeShapeAttribute(
    "tshape_dict",
    SajadMr.specs.BuiltinDictOperationSpecs,
    python2_dict_methods,
    python3_dict_methods,
    ("fromkeys",),
)
...
processTypeShapeAttribute(
    "tshape_str",
    SajadMr.specs.BuiltinStrOperationSpecs,
    python2_str_methods,
    python3_str_methods,
)
...
processTypeShapeAttribute(
    "tshape_bytes",
    SajadMr.specs.BuiltinBytesOperationSpecs,
    (),
    python3_bytes_methods,
)
...
processTypeShapeAttribute(
    "tshape_list",
    SajadMr.specs.BuiltinListOperationSpecs,
    python2_list_methods,
    python3_list_methods,
)
...
processTypeShapeAttribute(
    "tshape_type",
    SajadMr.specs.BuiltinTypeOperationSpecs,
    python2_type_methods,
    python3_type_methods,
)
...
def emitGenerationWarning(emit, doc_string, template_name):
    ...
    for spec_descriptions in getSpecVersions(SajadMr.specs.HardImportSpecs):
...
def makeAttributeNodes():
    filename_python = "SajadMr/nodes/AttributeNodesGenerated.py"
    ...
    with withFileOpenedAndAutoFormatted(
        ...
        emit("from SajadMr.specs.BuiltinParameterSpecs import extractBuiltinArgs")

        emit("from SajadMr.nodes.ConstantRefNodes import makeConstantRefNode")
        emit(
            """\
from SajadMr.nodes.NodeMakingHelpers import (
    ...
    makeRaiseExceptionReplacementExpression
        ...
        emit(
            "from SajadMr.nodes.KeyValuePairNodes import makeKeyValuePairExpressionsFromKwArgs"
        )

        emit("from SajadMr.nodes.AttributeNodes import makeExpressionAttributeLookup")

        emit("from SajadMr.PythonVersions import getDictFromkeysNoArgErrorMessage")
...
def makeBuiltinOperationNodes():
    filename_python = "SajadMr/nodes/BuiltinOperationNodeBasesGenerated.py"
...
def makeChildrenHavingMixinNodes():
    ...
    filename_python = "SajadMr/nodes/ChildrenHavingMixins.py"
    filename_python2 = "SajadMr/nodes/ExpressionBasesGenerated.py"
    filename_python3 = "SajadMr/nodes/StatementBasesGenerated.py"
    ...
    with withFileOpenedAndAutoFormatted(
        ...
        emit1(
            """
from SajadMr.nodes.Checkers import (
    checkStatementsSequenceOrNone,
...
def makeHardImportNodes():
    ...
    filename_python = "SajadMr/nodes/HardImportNodesGenerated.py"
