...
class CollaborationToolItemLinkedByMonitorIncidentEventDtoAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CollaborationToolItemLinkedByMonitorIncidentEventDtoAllOf - a model defined in OpenAPI
