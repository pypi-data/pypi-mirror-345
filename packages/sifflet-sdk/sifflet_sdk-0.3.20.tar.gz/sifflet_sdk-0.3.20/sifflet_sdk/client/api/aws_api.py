...
class AWSApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_list_regions_endpoint = _Endpoint(
            settings={
                "response_type": ([str],),
                "auth": ["JWT"],
                "endpoint_path": "/ui/v1/aws/_list-regions",
                "operation_id": "get_list_regions",
                "http_method": "GET",
                "servers": None,
            },
    ...
    def get_list_regions(self, **kwargs):
        """get_list_regions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_list_regions(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_list_regions_endpoint.call_with_http_info(**kwargs)
