...
def lazy_import():
    from sifflet_sdk.client.model.public_credentials_get_dto import (
        PublicCredentialsGetDto,
    )

    globals()["PublicCredentialsGetDto"] = PublicCredentialsGetDto


class PublicCredentialsPageDtoPublicCredentialsGetDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([PublicCredentialsGetDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """PublicCredentialsPageDtoPublicCredentialsGetDto - a model defined in OpenAPI

        Args:
            data ([PublicCredentialsGetDto]):
        ...
        Keyword Args:
            ...
            total_count (int): Number of credentials on the account. [optional]  # noqa: E501
        """
