        ...
        while not found_valid_node_in_chunk and retry_count < max_retries:
            try:
                ...
                if not isinstance(content, str):
                    ...
                    human_message = HumanMessage(content="LLM response content is not a string.")
                ...
                if not nodes_raw:
                    ...
                    human_message = HumanMessage(content="No <node> tags found in response.")
                    messages.append(ai_message)
                    messages.append(human_message)
                ...
                if processed_at_least_one_node:
                    ...
                    ai_message = AIMessage(content=content)
                    human_message = HumanMessage(content="No valid structure in <node> tags.")
                    messages.append(ai_message)
                    messages.append(human_message)
