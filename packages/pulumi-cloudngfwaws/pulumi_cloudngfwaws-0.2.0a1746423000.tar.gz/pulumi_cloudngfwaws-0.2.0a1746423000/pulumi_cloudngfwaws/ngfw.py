...
class NgfwArgs:
    def __init__(__self__, *,
                 ...
                 app_id_version: Optional[pulumi.Input[builtins.str]] = None,
                 automatic_upgrade_app_id_version: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 global_rulestack: Optional[pulumi.Input[builtins.str]] = None,
                 link_id: Optional[pulumi.Input[builtins.str]] = None,
                 multi_vpc: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] endpoint_mode: Set endpoint mode from the following options. Valid values are `ServiceManaged` or `CustomerManaged`.
        ...
        :param pulumi.Input[builtins.str] account_id: The account ID. This field is mandatory if using multiple accounts.
        :param pulumi.Input[builtins.str] app_id_version: App-ID version number.
        :param pulumi.Input[builtins.bool] automatic_upgrade_app_id_version: Automatic App-ID upgrade version number. Defaults to `true`.
        :param pulumi.Input[builtins.str] description: The description.
        :param pulumi.Input[builtins.str] global_rulestack: The global rulestack for this NGFW.
        :param pulumi.Input[builtins.str] link_id: A unique identifier for establishing and managing the link between the Cloud NGFW and other AWS resources.
        :param pulumi.Input[builtins.bool] multi_vpc: Share NGFW with Multiple VPCs. This feature can be enabled only if the endpoint_mode is CustomerManaged.
        :param pulumi.Input[builtins.str] name: The NGFW name.
        :param pulumi.Input[builtins.str] rulestack: The rulestack for this NGFW.
    ...
    def app_id_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def app_id_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "app_id_version", value)

    @property
    @pulumi.getter(name="automaticUpgradeAppIdVersion")
    def automatic_upgrade_app_id_version(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def automatic_upgrade_app_id_version(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def global_rulestack(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def global_rulestack(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def multi_vpc(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @multi_vpc.setter
    def multi_vpc(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _NgfwState:
    def __init__(__self__, *,
                 ...
                 endpoint_service_name: Optional[pulumi.Input[builtins.str]] = None,
                 firewall_id: Optional[pulumi.Input[builtins.str]] = None,
                 global_rulestack: Optional[pulumi.Input[builtins.str]] = None,
                 link_id: Optional[pulumi.Input[builtins.str]] = None,
                 link_status: Optional[pulumi.Input[builtins.str]] = None,
                 multi_vpc: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 rulestack: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The description.
        :param pulumi.Input[builtins.str] endpoint_mode: Set endpoint mode from the following options. Valid values are `ServiceManaged` or `CustomerManaged`.
        :param pulumi.Input[builtins.str] endpoint_service_name: The endpoint service name.
        :param pulumi.Input[builtins.str] firewall_id: The Id of the NGFW.
        :param pulumi.Input[builtins.str] global_rulestack: The global rulestack for this NGFW.
        :param pulumi.Input[builtins.str] link_id: A unique identifier for establishing and managing the link between the Cloud NGFW and other AWS resources.
        :param pulumi.Input[builtins.str] link_status: The link status.
        :param pulumi.Input[builtins.bool] multi_vpc: Share NGFW with Multiple VPCs. This feature can be enabled only if the endpoint_mode is CustomerManaged.
        :param pulumi.Input[builtins.str] name: The NGFW name.
        :param pulumi.Input[builtins.str] rulestack: The rulestack for this NGFW.
        :param pulumi.Input[Sequence[pulumi.Input['NgfwSubnetMappingArgs']]] subnet_mappings: Subnet mappings.
    ...
    def endpoint_service_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def endpoint_service_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def link_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The link status.
        """
    ...
    @link_status.setter
    def link_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Ngfw(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            update_token: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Ngfw':
        """
    ...
    @property
    @pulumi.getter(name="appIdVersion")
    def app_id_version(self) -> pulumi.Output[builtins.str]:
        """
        App-ID version number.
        """
        return pulumi.get(self, "app_id_version")
    ...
    @property
    @pulumi.getter(name="automaticUpgradeAppIdVersion")
    def automatic_upgrade_app_id_version(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Automatic App-ID upgrade version number. Defaults to `true`.
        """
        return pulumi.get(self, "automatic_upgrade_app_id_version")
    ...
    @property
    @pulumi.getter(name="endpointMode")
    def endpoint_mode(self) -> pulumi.Output[builtins.str]:
        """
        Set endpoint mode from the following options. Valid values are `ServiceManaged` or `CustomerManaged`.
        """
        return pulumi.get(self, "endpoint_mode")
    ...
    @property
    @pulumi.getter(name="endpointServiceName")
    def endpoint_service_name(self) -> pulumi.Output[builtins.str]:
        """
        The endpoint service name.
        """
        return pulumi.get(self, "endpoint_service_name")
    ...
    @property
    @pulumi.getter(name="globalRulestack")
    def global_rulestack(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The global rulestack for this NGFW.
        """
        return pulumi.get(self, "global_rulestack")
    ...
    @property
    @pulumi.getter(name="linkStatus")
    def link_status(self) -> pulumi.Output[builtins.str]:
        """
        The link status.
        """
        return pulumi.get(self, "link_status")
    ...
    @property
    @pulumi.getter(name="multiVpc")
    def multi_vpc(self) -> pulumi.Output[builtins.bool]:
        """
        Share NGFW with Multiple VPCs. This feature can be enabled only if the endpoint_mode is CustomerManaged.
        """
        return pulumi.get(self, "multi_vpc")
    ...
    @property
    @pulumi.getter
    def rulestack(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The rulestack for this NGFW.
        """
        return pulumi.get(self, "rulestack")
