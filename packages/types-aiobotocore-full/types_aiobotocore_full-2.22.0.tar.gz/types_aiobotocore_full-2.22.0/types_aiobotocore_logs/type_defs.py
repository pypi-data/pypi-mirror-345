...
[Documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_logs/type_defs/)
...
class StartLiveTailResponseTypeDef(TypedDict):
    responseStream: AioEventStream[StartLiveTailResponseStreamTypeDef]
    ResponseMetadata: ResponseMetadataTypeDef
