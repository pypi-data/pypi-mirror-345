...
def lazy_import():
    from sifflet_sdk.client.model.public_athena_parameters_dto_all_of import (
        PublicAthenaParametersDtoAllOf,
    )
    from sifflet_sdk.client.model.public_source_parameters_dto import (
        PublicSourceParametersDto,
    )

    globals()["PublicAthenaParametersDtoAllOf"] = PublicAthenaParametersDtoAllOf
    globals()["PublicSourceParametersDto"] = PublicSourceParametersDto


class PublicAthenaParametersDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PublicAthenaParametersDto - a model defined in OpenAPI

        Keyword Args:
            database (str): Your Athena database name
