...
:func:`new_image_from_plane_marker`
...
:func:`update_image_from_plane_marker`
...
def add_marker(*args, location: mathutils.Vector = (0.0, 0.0)) -> None:
...
def add_marker_move(*args, CLIP_OT_add_marker: CLIP_OT_add_marker = None, TRANSFORM_OT_translate: TRANSFORM_OT_translate = None) -> None:
...
def add_marker_slide(*args, CLIP_OT_add_marker: CLIP_OT_add_marker = None, TRANSFORM_OT_translate: TRANSFORM_OT_translate = None) -> None:
...
def apply_solution_scale(*args, distance: float = 0.0) -> None:
...
def average_tracks(*args, keep_original: bool = True) -> None:
...
def camera_preset_add(*args, name: str = '', remove_name: bool = False, remove_active: bool = False, use_focal_length: bool = True) -> None:
...
def clean_tracks(*args, frames: int = 0, error: float = 0.0, action: str = 'SELECT') -> None:
...
def clear_track_path(*args, action: str = 'REMAINED', clear_active: bool = False) -> None:
...
def delete_marker(*args, confirm: bool = True) -> None:
...
def delete_track(*args, confirm: bool = True) -> None:
...
def detect_features(*args, placement: str = 'FRAME', margin: int = 16, threshold: float = 0.5, min_distance: int = 120) -> None:
...
def disable_markers(*args, action: str = 'DISABLE') -> None:
...
def dopesheet_select_channel(*args, location: mathutils.Vector = (0.0, 0.0), extend: bool = False) -> None:
...
def filter_tracks(*args, track_threshold: float = 5.0) -> None:
...
def frame_jump(*args, position: str = 'PATHSTART') -> None:
...
def graph_delete_curve(*args, confirm: bool = True) -> None:
...
def graph_disable_markers(*args, action: str = 'DISABLE') -> None:
...
def graph_select(*args, location: mathutils.Vector = (0.0, 0.0), extend: bool = False) -> None:
...
def graph_select_all_markers(*args, action: str = 'TOGGLE') -> None:
...
def graph_select_box(*args, xmin: int = 0, xmax: int = 0, ymin: int = 0, ymax: int = 0, wait_for_input: bool = True, deselect: bool = False, extend: bool = True) -> None:
...
def hide_tracks(*args, unselected: bool = False) -> None:
...
def lock_tracks(*args, action: str = 'LOCK') -> None:
...
def mode_set(*args, mode: str = 'TRACKING') -> None:
...
def new_image_from_plane_marker() -> None:
...
def refine_markers(*args, backwards: bool = False) -> None:
...
def select(*args, extend: bool = False, deselect_all: bool = False, location: mathutils.Vector = (0.0, 0.0)) -> None:
...
def select_grouped(*args, group: str = 'ESTIMATED') -> None:
...
def set_axis(*args, axis: str = 'X') -> None:
...
def set_origin(*args, use_median: bool = False) -> None:
...
def set_plane(*args, plane: str = 'FLOOR') -> None:
...
def set_scale(*args, distance: float = 0.0) -> None:
...
def set_solution_scale(*args, distance: float = 0.0) -> None:
...
def set_solver_keyframe(*args, keyframe: str = 'KEYFRAME_A') -> None:
...
def slide_marker(*args, offset: mathutils.Vector = (0.0, 0.0)) -> None:
...
def track_color_preset_add(*args, name: str = '', remove_name: bool = False, remove_active: bool = False) -> None:
...
def track_markers(*args, backwards: bool = False, sequence: bool = False) -> None:
...
def tracking_settings_preset_add(*args, name: str = '', remove_name: bool = False, remove_active: bool = False) -> None:
...
def update_image_from_plane_marker() -> None:
