...
class GetMarginBorrowRepayV1RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amount", "asset", "interest", "isolatedSymbol", "principal", "status", "timestamp", "txId", "type"]
