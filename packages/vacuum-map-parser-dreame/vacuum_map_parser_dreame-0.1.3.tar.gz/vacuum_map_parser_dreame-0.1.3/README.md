...
[latest_release]: https://github.com/PiotrMachowski/Python-package-vacuum-map-parser-dreame/releases/latest
[releases_shield]: https://img.shields.io/github/release/PiotrMachowski/Python-package-vacuum-map-parser-dreame.svg?style=popout

[pypi_latest_release]: https://pypi.org/project/vacuum-map-parser-dreame/
...
The code of this library was initially created by [@Neonox31](https://github.com/Neonox31) as a part of [Xiaomi Cloud Map Extractor](https://github.com/PiotrMachowski/Home-Assistant-custom-components-Xiaomi-Cloud-Map-Extractor).
