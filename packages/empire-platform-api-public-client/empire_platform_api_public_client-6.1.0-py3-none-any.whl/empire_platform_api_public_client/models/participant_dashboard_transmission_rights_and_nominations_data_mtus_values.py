...
class ParticipantDashboardTransmissionRightsAndNominationsDataMtusValues(BaseModel):
    ...
    nominated_capacity: StrictInt = Field(description="Capacity value in kilowatts (kW) - the required system precision allows for handling capacity values as integers", alias="nominatedCapacity")
    ...
    __properties: ClassVar[List[str]] = ["direction", "allocatedTrs", "nominatedCapacity", "nominationRestriction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nominatedCapacity": obj.get("nominatedCapacity"),
            "nominationRestriction": ParticipantDashboardTransmissionRightsAndNominationsDataMtusValuesNominationRestriction.from_dict(obj["nominationRestriction"]) if obj.get("nominationRestriction") is not None else None
        })
        return _obj
