...
#ifndef __SajadSx_CALLING_H__
#define __SajadSx_CALLING_H__
...
SajadSx_MAY_BE_UNUSED static inline PyObject *SajadQ_CheckFunctionResult(PyThreadState *tstate, PyObject *callable,
                                                                        PyObject *result) {
    if (result == NULL) {
        ...
        // Some buggy C functions do this, and SajadQ inner workings can get
        // upset from it.
...
SajadSx_MAY_BE_UNUSED static PyObject *CALL_FUNCTION(PyThreadState *tstate, PyObject *function_object,
    ...
    return SajadQ_CheckFunctionResult(tstate, function_object, result);
}
...
SajadSx_MAY_BE_UNUSED static PyObject *CALL_FUNCTION_WITH_POS_ARGS(PyThreadState *tstate, PyObject *function_object,
...
SajadSx_MAY_BE_UNUSED static PyObject *CALL_FUNCTION_WITH_KW_ARGS(PyThreadState *tstate, PyObject *function_object,
                                                                 PyObject *named_args) {
...
#include "SajadMr/helper/calling_generated.h"
