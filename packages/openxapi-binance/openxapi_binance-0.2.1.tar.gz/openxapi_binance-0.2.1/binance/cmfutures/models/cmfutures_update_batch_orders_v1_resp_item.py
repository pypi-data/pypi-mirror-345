...
class CmfuturesUpdateBatchOrdersV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["avgPrice", "clientOrderId", "closePosition", "cumBase", "cumQty", "executedQty", "orderId", "origQty", "origType", "pair", "positionSide", "price", "priceMatch", "priceProtect", "reduceOnly", "selfTradePreventionMode", "side", "status", "stopPrice", "symbol", "timeInForce", "type", "updateTime", "workingType"]
