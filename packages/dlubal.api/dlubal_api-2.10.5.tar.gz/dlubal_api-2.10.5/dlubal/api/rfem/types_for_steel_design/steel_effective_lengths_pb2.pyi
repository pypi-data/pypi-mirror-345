...
class SteelEffectiveLengths(_message.Message):
    ...
    class NodalSupportsRow(_message.Message):
        ...
        support_in_y_type: SteelEffectiveLengths.NodalSupportsRow.SupportInY
        restraint_about_x_type: SteelEffectiveLengths.NodalSupportsRow.RestraintAboutX
        restraint_about_z_type: SteelEffectiveLengths.NodalSupportsRow.RestraintAboutZ
        restraint_warping_type: SteelEffectiveLengths.NodalSupportsRow.RestraintWarping
        nodes: _containers.RepeatedScalarFieldContainer[int]
        def __init__(self, no: _Optional[int] = ..., description: _Optional[str] = ..., support_type: _Optional[_Union[SteelEffectiveLengths.NodalSupportsRow.SupportType, str]] = ..., support_in_z: bool = ..., support_spring_in_y: _Optional[float] = ..., eccentricity_type: _Optional[_Union[SteelEffectiveLengths.NodalSupportsRow.EccentricityType, str]] = ..., eccentricity_ez: _Optional[float] = ..., restraint_spring_about_x: _Optional[float] = ..., restraint_spring_about_z: _Optional[float] = ..., restraint_spring_warping: _Optional[float] = ..., support_in_y_type: _Optional[_Union[SteelEffectiveLengths.NodalSupportsRow.SupportInY, str]] = ..., restraint_about_x_type: _Optional[_Union[SteelEffectiveLengths.NodalSupportsRow.RestraintAboutX, str]] = ..., restraint_about_z_type: _Optional[_Union[SteelEffectiveLengths.NodalSupportsRow.RestraintAboutZ, str]] = ..., restraint_warping_type: _Optional[_Union[SteelEffectiveLengths.NodalSupportsRow.RestraintWarping, str]] = ..., nodes: _Optional[_Iterable[int]] = ...) -> None: ...
