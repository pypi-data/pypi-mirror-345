...
class UpdateCmOrderV1Resp(BaseModel):
    """
    UpdateCmOrderV1Resp
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["avgPrice", "clientOrderId", "cumBase", "cumQty", "executedQty", "orderId", "origQty", "origType", "pair", "positionSide", "price", "reduceOnly", "side", "status", "symbol", "timeInForce", "type", "updateTime"]
