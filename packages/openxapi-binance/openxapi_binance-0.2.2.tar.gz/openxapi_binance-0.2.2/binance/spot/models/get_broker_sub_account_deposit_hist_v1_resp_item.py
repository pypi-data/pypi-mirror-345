...
class GetBrokerSubAccountDepositHistV1RespItem(BaseModel):
    """
    ...
    deposit_id: Optional[StrictInt] = Field(default=None, alias="depositId")
    insert_time: Optional[StrictInt] = Field(default=None, alias="insertTime")
    network: Optional[StrictStr] = None
    self_return_status: Optional[StrictInt] = Field(default=None, alias="selfReturnStatus")
    ...
    __properties: ClassVar[List[str]] = ["address", "addressTag", "amount", "coin", "confirmTimes", "depositId", "insertTime", "network", "selfReturnStatus", "sourceAddress", "status", "subAccountId", "transferType", "travelRuleStatus", "txId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selfReturnStatus": obj.get("selfReturnStatus"),
