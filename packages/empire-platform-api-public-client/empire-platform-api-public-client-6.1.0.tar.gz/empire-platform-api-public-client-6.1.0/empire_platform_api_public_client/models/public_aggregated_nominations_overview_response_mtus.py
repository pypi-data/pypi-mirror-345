...
class PublicAggregatedNominationsOverviewResponseMtus(BaseModel):
    ...
    values: List[PublicAggregatedNominationsOverviewResponseMtusValues]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mtu": obj.get("mtu"),
            "values": [PublicAggregatedNominationsOverviewResponseMtusValues.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None,
            "nettedNominations": PublicAggregatedNominationsOverviewResponseMtusNettedNominations.from_dict(obj["nettedNominations"]) if obj.get("nettedNominations") is not None else None
        })
        return _obj
