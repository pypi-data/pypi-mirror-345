...
def extension_path_user(package: str, *args, path: str = '', create: bool = False) -> str:
  ...
  Note: This allows each extension to have it's own user directory to store files.The location of the extension it self is not a suitable place to store files
