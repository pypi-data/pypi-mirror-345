...
class DefaultBidOptions(BaseModel):
    ...
    DefaultBidOptions
    """ # noqa: E501
    mtu_sizes: List[MtuSizePerAuctionProductType] = Field(alias="mtuSizes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mtuSizes": [MtuSizePerAuctionProductType.from_dict(_item) for _item in obj["mtuSizes"]] if obj.get("mtuSizes") is not None else None
        })
        return _obj
