...
class CreateSorOrderV3Resp(BaseModel):
    """
    ...
    fills: Optional[List[CreateSorOrderV3RespFillsInner]] = None
    ...
    used_sor: Optional[StrictBool] = Field(default=None, alias="usedSor")
    working_floor: Optional[StrictStr] = Field(default=None, alias="workingFloor")
    working_time: Optional[StrictInt] = Field(default=None, alias="workingTime")
    __properties: ClassVar[List[str]] = ["clientOrderId", "cummulativeQuoteQty", "executedQty", "fills", "orderId", "orderListId", "origQty", "origQuoteOrderQty", "price", "selfTradePreventionMode", "side", "status", "symbol", "timeInForce", "transactTime", "type", "usedSor", "workingFloor", "workingTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fills": [CreateSorOrderV3RespFillsInner.from_dict(_item) for _item in obj["fills"]] if obj.get("fills") is not None else None,
