...
parser.add_argument(
    "--dropdown", choices=["one", "two"], default="two", widget="Dropdown"
)
parser.add_argument(
    "--listboxie",
    nargs="+",
...
parser.add_argument(
    "--overwrite1", action="store_true", default=True, widget="CheckBox"
)
parser.add_argument(
    "--overwrite2", action="store_true", default=True, widget="BlockCheckbox"
)

verbosity = parser.add_mutually_exclusive_group(gooey_options={"initial_selection": 0})
