...
class CreateOrderTestV1Resp(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["activatePrice", "avgPrice", "clientOrderId", "closePosition", "cumQty", "cumQuote", "executedQty", "goodTillDate", "orderId", "origQty", "origType", "positionSide", "price", "priceMatch", "priceProtect", "priceRate", "reduceOnly", "selfTradePreventionMode", "side", "status", "stopPrice", "symbol", "timeInForce", "type", "updateTime", "workingType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateOrderTestV1Resp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateOrderTestV1Resp from a dict"""
        if obj is None:
            return None
