...
from .. import interp
from .._utils import Aarray, PointSet
from ..splinegrid import SplineGrid, GridContainer, GridInterface, calculate_multiscale_sampling
...
class DeformationGrid(Deformation, GridContainer):
    ...
    @classmethod
    def from_field(cls, field, sampling, weights=None, injective=True, frozenedge=True, fd=None):
    ...
    @classmethod
    def from_points(cls, image, sampling, pp1, pp2, injective=True, frozenedge=True):
