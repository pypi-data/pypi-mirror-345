...
class GetSubAccountFuturesPositionRiskV2Resp(BaseModel):
    """
    GetSubAccountFuturesPositionRiskV2Resp
    """ # noqa: E501
    future_position_risk_vos: Optional[List[GetSubAccountFuturesPositionRiskV2RespFuturePositionRiskVosInner]] = Field(default=None, alias="futurePositionRiskVos")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "futurePositionRiskVos": [GetSubAccountFuturesPositionRiskV2RespFuturePositionRiskVosInner.from_dict(_item) for _item in obj["futurePositionRiskVos"]] if obj.get("futurePositionRiskVos") is not None else None
        })
        return _obj
