...
from empire_platform_api_public_client_legacy.models.submit_long_term_bids_request import SubmitLongTermBidsRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> SubmitLongTermBidsRequest:
        ...
        if include_optional:
            return SubmitLongTermBidsRequest(
                bids = [
                    empire_platform_api_public_client_legacy.models.submit_long_term_bids_request_bids.SubmitLongTermBidsRequest_bids(
