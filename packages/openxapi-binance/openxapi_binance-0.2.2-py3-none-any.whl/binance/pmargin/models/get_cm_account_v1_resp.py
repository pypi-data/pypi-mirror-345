...
class GetCmAccountV1Resp(BaseModel):
    """
    GetCmAccountV1Resp
    """ # noqa: E501
    assets: Optional[List[GetCmAccountV1RespAssetsInner]] = None
    positions: Optional[List[GetCmAccountV1RespPositionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "positions": [GetCmAccountV1RespPositionsInner.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None
        })
        return _obj
