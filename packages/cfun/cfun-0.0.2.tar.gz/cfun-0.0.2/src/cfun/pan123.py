"""
这里的代码来源: https://github.com/wojiaoyishang/123pan
我只是将其进行了部分修改，方便使用。因为自己可能需要长期使用上传接口
而源代码没有进行封装,且没有打包上传 pypi,所以我将其进行了封装。
"""
...
class pan123openAPI:
    ...
    def upload(self, filename, upload_name, parentFileID):
        """
