...
class WirelessBluetoothSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] major: Desired major value of the beacon. If the value is set to null it will reset to Dashboard's automatically generated value.
        :param pulumi.Input[builtins.int] minor: Desired minor value of the beacon. If the value is set to null it will reset to Dashboard's automatically generated value.
        :param pulumi.Input[builtins.str] uuid: Desired UUID of the beacon. If the value is set to null it will reset to Dashboard's automatically generated value.
        """
...
class WirelessBluetoothSettings(pulumi.CustomResource):
    ...
    pulumi_type = "meraki:devices/wirelessBluetoothSettings:WirelessBluetoothSettings"
