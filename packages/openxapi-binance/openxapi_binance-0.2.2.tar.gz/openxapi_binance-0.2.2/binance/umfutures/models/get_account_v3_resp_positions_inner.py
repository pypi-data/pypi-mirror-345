...
class GetAccountV3RespPositionsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["initialMargin", "isolatedMargin", "isolatedWallet", "maintMargin", "notional", "positionAmt", "positionSide", "symbol", "unrealizedProfit", "updateTime"]
