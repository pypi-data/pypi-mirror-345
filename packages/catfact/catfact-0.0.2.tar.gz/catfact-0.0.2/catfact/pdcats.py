...
@dispatch
def fct_inorder(fct: pd.Series, ordered=None):
...
@dispatch
def fct_infreq(fct: pd.Series, ordered=None):
...
@dispatch
def fct_reorder(fct: pd.Series, x, func = np.median, desc = False) -> pd.Categorical:
...
@dispatch
def fct_recode(fct: pd.Series, recat=None, **kwargs) -> pd.Categorical:
...
@dispatch
def fct_collapse(fct: pd.Series, recat, group_other = None) -> pd.Categorical:
...
@dispatch
def fct_lump(fct: pd.Series, n = None, prop = None, w = None, other_level = "Other", ties = None) -> pd.Categorical:
...
@dispatch
def fct_rev(fct: pd.Series) -> pd.Categorical:
