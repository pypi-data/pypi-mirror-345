...
class LastIngestionStatusDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, timestamp, *args, **kwargs):  # noqa: E501
        """LastIngestionStatusDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, timestamp, *args, **kwargs):  # noqa: E501
        """LastIngestionStatusDto - a model defined in OpenAPI
