...
class AggregatedNominationsNlMtus(BaseModel):
    ...
    values: List[AggregatedNominationsMtuValue]
    ...
    __properties: ClassVar[List[str]] = ["mtu", "values", "nettedNominations", "eprogramValues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mtu": obj.get("mtu"),
            "values": [AggregatedNominationsMtuValue.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None,
            "nettedNominations": AggregatedNominationsMtuNettedNominations.from_dict(obj["nettedNominations"]) if obj.get("nettedNominations") is not None else None,
            "eprogramValues": AggregatedNominationsNlMtusEprogramValues.from_dict(obj["eprogramValues"]) if obj.get("eprogramValues") is not None else None
        })
        return _obj
