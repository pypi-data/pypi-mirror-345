...
class InlineResponse2009Adverts(object):
    ...
    def __init__(self, type=None, status=None, count=None):  # noqa: E501
        """InlineResponse2009Adverts - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._status = None
        self._count = None
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this InlineResponse2009Adverts.

        <dl> <dt>Tip mediakampanii:</dt> <dd><code>1</code> - razmehenie po dnam</dd> <dd><code>2</code> - razmehenie po prosmotram</dd> </dl>   # noqa: E501

        :param type: The type of this InlineResponse2009Adverts.  # noqa: E501
        :type: int
        """
    ...
    @property
    def status(self):
        """Gets the status of this InlineResponse2009Adverts.  # noqa: E501
        ...
        :return: The status of this InlineResponse2009Adverts.  # noqa: E501
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this InlineResponse2009Adverts.

        <dl> <dt>Status mediakampanii:</dt>   <dd><code>1</code> - hernovik</dd>   <dd><code>2</code> - moderacia   <dd><code>3</code> - otkloneno (s vozmohnostu vernut na moderaciu)</dd>   <dd><code>4</code> - odobreno</dd>   <dd><code>5</code> - zaplanirovano</dd>   <dd><code>6</code> - na pokazah</dd>   <dd><code>7</code> - zaverheno</dd>   <dd><code>8</code> - otkazalsa</dd>   <dd><code>9</code> - priostanovlena prodavcom</dd>   <dd><code>10</code> - pauza po dnevnomu limitu</dd>   <dd><code>11</code> - pauza po rashodu budheta</dd> </dl>   # noqa: E501

        :param status: The status of this InlineResponse2009Adverts.  # noqa: E501
        :type: int
        """
    ...
    @property
    def count(self):
        """Gets the count of this InlineResponse2009Adverts.  # noqa: E501

        Kolihestvo mediakampanii  # noqa: E501

        :return: The count of this InlineResponse2009Adverts.  # noqa: E501
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """Sets the count of this InlineResponse2009Adverts.

        Kolihestvo mediakampanii  # noqa: E501

        :param count: The count of this InlineResponse2009Adverts.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponse2009Adverts, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse2009Adverts):
            return False
