...
class GetCopyTradingFuturesUserStatusV1Resp(BaseModel):
    """
    GetCopyTradingFuturesUserStatusV1Resp
    """ # noqa: E501
    code: Optional[StrictStr] = None
    data: Optional[GetCopyTradingFuturesUserStatusV1RespData] = None
    message: Optional[StrictStr] = None
    success: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["code", "data", "message", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": GetCopyTradingFuturesUserStatusV1RespData.from_dict(obj["data"]) if obj.get("data") is not None else None,
