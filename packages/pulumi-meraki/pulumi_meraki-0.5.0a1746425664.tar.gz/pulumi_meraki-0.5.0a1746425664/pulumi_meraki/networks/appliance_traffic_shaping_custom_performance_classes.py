...
__all__ = ['ApplianceTrafficShapingCustomPerformanceClassesArgs', 'ApplianceTrafficShapingCustomPerformanceClasses']

@pulumi.input_type
class ApplianceTrafficShapingCustomPerformanceClassesArgs:
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Input['ApplianceTrafficShapingCustomPerformanceClassesParametersArgs']:
        return pulumi.get(self, "parameters")

    @parameters.setter
    def parameters(self, value: pulumi.Input['ApplianceTrafficShapingCustomPerformanceClassesParametersArgs']):
...
class ApplianceTrafficShapingCustomPerformanceClasses(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ApplianceTrafficShapingCustomPerformanceClassesArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ApplianceTrafficShapingCustomPerformanceClassesArgs.__new__(ApplianceTrafficShapingCustomPerformanceClassesArgs)
        ...
        super(ApplianceTrafficShapingCustomPerformanceClasses, __self__).__init__(
    ...
    def get(resource_name: str,
        ...
        __props__ = _ApplianceTrafficShapingCustomPerformanceClassesState.__new__(_ApplianceTrafficShapingCustomPerformanceClassesState)

        __props__.__dict__["network_id"] = network_id
        __props__.__dict__["parameters"] = parameters
        return ApplianceTrafficShapingCustomPerformanceClasses(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Output['outputs.ApplianceTrafficShapingCustomPerformanceClassesParameters']:
        return pulumi.get(self, "parameters")
