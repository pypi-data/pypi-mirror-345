...
class DutyCycleStats(_message.Message):
    ...
    def __init__(self, regulation: _Optional[_Union[_common_pb2.Regulation, str]] = ..., window: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., bands: _Optional[_Iterable[_Union[DutyCycleBand, _Mapping]]] = ...) -> None: ...
...
class DutyCycleBand(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., frequency_min: _Optional[int] = ..., frequency_max: _Optional[int] = ..., load_max: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., load_tracked: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...
...
class MeshHeartbeat(_message.Message):
    __slots__ = ("gateway_id", "relay_id", "time", "relay_path")
    GATEWAY_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    relay_id: str
    time: _timestamp_pb2.Timestamp
    relay_path: _containers.RepeatedCompositeFieldContainer[MeshHeartbeatRelayPath]
    def __init__(self, gateway_id: _Optional[str] = ..., relay_id: _Optional[str] = ..., time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., relay_path: _Optional[_Iterable[_Union[MeshHeartbeatRelayPath, _Mapping]]] = ...) -> None: ...

class MeshHeartbeatRelayPath(_message.Message):
