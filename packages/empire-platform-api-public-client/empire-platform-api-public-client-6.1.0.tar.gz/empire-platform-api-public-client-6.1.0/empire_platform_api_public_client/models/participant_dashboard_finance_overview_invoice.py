...
class ParticipantDashboardFinanceOverviewInvoice(BaseModel):
    ...
    payment_date: Optional[date] = Field(default=None, description="One single calendar day, interpreted in **System Time**  - ISO 8601 compliant string in `yyyy-mm-dd` format ", alias="paymentDate")
    __properties: ClassVar[List[str]] = ["id", "displayId", "status", "attachment", "dueDate", "paymentDate"]
