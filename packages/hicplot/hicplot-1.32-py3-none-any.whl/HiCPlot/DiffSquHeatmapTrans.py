...
def main(argv=None): 
    ...
    # region1
    parser.add_argument('--chrid1', type=str, required=True, help='Chromosome ID.')
    parser.add_argument('--start1', type=int, required=True, help='Start position for the region of interest.')
    parser.add_argument('--end1',   type=int, required=True, help='End position for the region of interest.')
    # region2
    parser.add_argument('--chrid2', type=str, required=True, help='Chromosome ID.)
    parser.add_argument('--start2', type=int, required=True, help='Start position for the region of interest.')
    parser.add_argument('--end2',   type=int, required=True, help='End position for the region of interest.')
    # diff options
