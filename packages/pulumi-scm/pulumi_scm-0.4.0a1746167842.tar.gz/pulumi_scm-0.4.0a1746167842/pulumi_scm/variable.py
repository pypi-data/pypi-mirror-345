...
class VariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The Type param. String must be one of these: `"percent"`, `"count"`, `"ip-netmask"`, `"zone"`, `"ip-range"`, `"ip-wildcard"`, `"device-priority"`, `"device-id"`, `"egress-max"`, `"as-number"`, `"fqdn"`, `"port"`, `"link-tag"`, `"group-id"`, `"rate"`, `"router-id"`, `"qos-profile"`, `"timer"`.
        :param pulumi.Input[builtins.str] value: value can accept either string or integer.
        """
...
class _VariableState:
    def __init__(__self__, *,
                 ...
                 folder: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 overridden: Optional[pulumi.Input[builtins.bool]] = None,
                 snippet: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] folder: The Folder param.
        :param pulumi.Input[builtins.str] name: Alphanumeric string begin with letter: [0-9a-zA-Z._-]. String length must not exceed 63 characters.
        :param pulumi.Input[builtins.bool] overridden: The Overridden param.
        :param pulumi.Input[builtins.str] snippet: The Snippet param.
        :param pulumi.Input[builtins.str] type: The Type param. String must be one of these: `"percent"`, `"count"`, `"ip-netmask"`, `"zone"`, `"ip-range"`, `"ip-wildcard"`, `"device-priority"`, `"device-id"`, `"egress-max"`, `"as-number"`, `"fqdn"`, `"port"`, `"link-tag"`, `"group-id"`, `"rate"`, `"router-id"`, `"qos-profile"`, `"timer"`.
        :param pulumi.Input[builtins.str] value: value can accept either string or integer.
        """
    ...
    @property
    @pulumi.getter
    def overridden(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @overridden.setter
    def overridden(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Variable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tfid: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'Variable':
        """
    ...
    @property
    @pulumi.getter
    def overridden(self) -> pulumi.Output[builtins.bool]:
        """
        The Overridden param.
        """
        return pulumi.get(self, "overridden")
