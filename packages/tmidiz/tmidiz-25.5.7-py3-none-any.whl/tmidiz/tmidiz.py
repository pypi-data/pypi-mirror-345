...
#
#   NOTE: TMIDI Z Module starts after the partial MIDI.py module @ line 807
#
...
###################################################################################
###################################################################################
# This is the beginning of the partial MIDI Python module code
###################################################################################
###################################################################################
...
###################################################################################
###################################################################################
# This is the beginning of the TMIDIZ Python module code
###################################################################################
###################################################################################

def ms_escore_to_midi(ms_escore,
                      output_signature = 'TMIDIZ Module', 
                      track_name = 'Project Los Angeles',
                      list_of_MIDI_patches = [0, 24, 32, 40, 42, 46, 56, 71, 73, 0, 0, 0, 0, 0, 0, 0],
                      output_file_name = 'TMIDIZ-Composition',
...
def plot_ms_escore(ms_escore,
  ...
  notes = [s for s in ms_escore if s[0] == 'note']
...
def write_pickle(Data, input_file_name='TMIDI_Pickle_File'):
...
def read_pickle(input_file_name='TMIDI_Pickle_File', ext='.pickle', verbose=True):
...
def chordify_escore_notes(escore_notes, escore_is_delta=False, times_idx=1):
...
def advanced_score_processor(raw_score, 
  ...
  '''TMIDIZ Advanced Score Processor'''
