...
TEST_EMAIL_ADDRESS = our_get_env("GOOGLE_EMAIL_ADDRESS", raise_if_empty=True)
TEST_USER_EXTERNAL_USERNAME = our_get_env(
...
class GoogleAccountLocalConstants:
    class LoggerSetupConstants:
        ...
        DEVELOPER_EMAIL = TEST_EMAIL_ADDRESS
