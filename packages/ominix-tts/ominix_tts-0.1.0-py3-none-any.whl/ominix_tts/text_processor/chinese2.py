...
try:
    ...
    try:
        ...
        current_file_path = os.path.dirname(__file__)
        file_path = os.path.join(current_file_path, "opencpop-strict.txt")
        ...
        # Create a minimal version as fallback for development
        print("Warning: opencpop-strict.txt not found, using minimal pinyin map")
        pinyin_to_symbol_map = {
...
if is_g2pw:
    ...
    g2pw = G2PWPinyin(model_dir="MOTTS/text/G2PWModel",model_source=os.environ.get("bert_path","MOTTS/pretrained_models/chinese-roberta-wwm-ext-large"),v_to_u=False, neutral_tone_with_five=True)
