...
class SpotCreateOrderCancelReplaceV3NewOrderResp(BaseModel):
    """
    ...
    fills: Optional[List[SpotCreateOrderCancelReplaceV3NewOrderRespFillsInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["clientOrderId", "cummulativeQuoteQty", "executedQty", "fills", "orderId", "orderListId", "origQty", "origQuoteOrderQty", "price", "selfTradePreventionMode", "side", "status", "symbol", "timeInForce", "transactTime", "type", "workingTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fills": [SpotCreateOrderCancelReplaceV3NewOrderRespFillsInner.from_dict(_item) for _item in obj["fills"]] if obj.get("fills") is not None else None,
