...
exclusions)
        ...
        subroutine OpenMM_AmoebaVdwForce_getNonbondedMethod(target, result)
            use OpenMM_Types; implicit none
            type (OpenMM_AmoebaVdwForce) target
            type (OpenMM_HippoNonbondedForce_NonbondedMethod) result
        end subroutine
        subroutine OpenMM_AmoebaVdwForce_setNonbondedMethod(target, method)
            use OpenMM_Types; implicit none
            type (OpenMM_AmoebaVdwForce) target
            type (OpenMM_HippoNonbondedForce_NonbondedMethod) method
        end subroutine
...
scalingFactor)
        ...
        function OpenMM_AmoebaGeneralizedKirkwoodForce_addParticle_1(target, charge, &
radius, &
scalingFactor, &
descreenRadius, &
neckFactor)
            ...
            real*8 radius
            real*8 scalingFactor
            real*8 descreenRadius
            real*8 neckFactor
            integer*4 OpenMM_AmoebaGeneralizedKirkwoodForce_addParticle_1
        end function
...
neckFactor)
        ...
        function OpenMM_AmoebaGeneralizedKirkwoodForce_getTanhRescaling(target)
            use OpenMM_Types; implicit none
            type (OpenMM_AmoebaGeneralizedKirkwoodForce) target
            integer*4 OpenMM_AmoebaGeneralizedKirkwoodForce_getTanhRescaling
        end function
        subroutine OpenMM_AmoebaGeneralizedKirkwoodForce_setTanhRescaling(target, tanhRescale)
            use OpenMM_Types; implicit none
            type (OpenMM_AmoebaGeneralizedKirkwoodForce) target
            integer*4 tanhRescale
        end subroutine
        subroutine OpenMM_AmoebaGeneralizedKirkwoodForce_getTanhParameters(target, b0, &
b1, &
b2)
            use OpenMM_Types; implicit none
            type (OpenMM_AmoebaGeneralizedKirkwoodForce) target
        ...
        subroutine OpenMM_AmoebaGeneralizedKirkwoodForce_setTanhParameters(target, b0, &
b1, &
b2)
            use OpenMM_Types; implicit none
            type (OpenMM_AmoebaGeneralizedKirkwoodForce) target
        ...
        function OpenMM_AmoebaGeneralizedKirkwoodForce_getDescreenOffset(target)
            use OpenMM_Types; implicit none
            type (OpenMM_AmoebaGeneralizedKirkwoodForce) target
            real*8 OpenMM_AmoebaGeneralizedKirkwoodForce_getDescreenOffset
        end function
        subroutine OpenMM_AmoebaGeneralizedKirkwoodForce_setDescreenOffset(target, descreenOffet)
            use OpenMM_Types; implicit none
            type (OpenMM_AmoebaGeneralizedKirkwoodForce) target
            real*8 descreenOffet
        end subroutine
        ...
        function OpenMM_AmoebaGeneralizedKirkwoodForce_getDielectricOffset(target)
            use OpenMM_Types; implicit none
            type (OpenMM_AmoebaGeneralizedKirkwoodForce) target
            real*8 OpenMM_AmoebaGeneralizedKirkwoodForce_getDielectricOffset
        end function
        subroutine OpenMM_AmoebaGeneralizedKirkwoodForce_setDielectricOffset(target, dielectricOffset)
            use OpenMM_Types; implicit none
            type (OpenMM_AmoebaGeneralizedKirkwoodForce) target
            real*8 dielectricOffset
        end subroutine
