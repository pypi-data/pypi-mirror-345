...
class TlsServiceProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate: SSL certificate file name. String length must not exceed 255 characters.
        ...
        :param pulumi.Input[builtins.str] name: SSL TLS Service Profile name, value is muCustomDomainSSLProfile when it is used on mobile-agent infra settings. String length must not exceed 127 characters. String validation regex: `^[a-zA-Z0-9._-]+$`.
...
class TlsServiceProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            protocol_settings: Optional[pulumi.Input[Union['TlsServiceProfileProtocolSettingsArgs', 'TlsServiceProfileProtocolSettingsArgsDict']]] = None,
            snippet: Optional[pulumi.Input[builtins.str]] = None,
            tfid: Optional[pulumi.Input[builtins.str]] = None) -> 'TlsServiceProfile':
        """
