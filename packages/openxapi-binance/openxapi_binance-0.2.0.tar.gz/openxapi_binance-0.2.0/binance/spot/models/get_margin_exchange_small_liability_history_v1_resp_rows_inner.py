...
class GetMarginExchangeSmallLiabilityHistoryV1RespRowsInner(BaseModel):
    """
    GetMarginExchangeSmallLiabilityHistoryV1RespRowsInner
    """ # noqa: E501
    amount: Optional[StrictStr] = None
    asset: Optional[StrictStr] = None
    biz_type: Optional[StrictStr] = Field(default=None, alias="bizType")
    ...
    __properties: ClassVar[List[str]] = ["amount", "asset", "bizType", "targetAmount", "targetAsset", "timestamp"]
