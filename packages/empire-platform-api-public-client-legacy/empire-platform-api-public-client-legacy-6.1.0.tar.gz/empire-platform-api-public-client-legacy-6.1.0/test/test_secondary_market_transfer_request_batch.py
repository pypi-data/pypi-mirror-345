...
from empire_platform_api_public_client_legacy.models.secondary_market_transfer_request_batch import SecondaryMarketTransferRequestBatch  # noqa: E501
    ...
    def make_instance(self, include_optional) -> SecondaryMarketTransferRequestBatch:
        ...
        if include_optional:
            return SecondaryMarketTransferRequestBatch(
                entries = [
                    empire_platform_api_public_client_legacy.models.secondary_market_transfer_request.SecondaryMarketTransferRequest(
