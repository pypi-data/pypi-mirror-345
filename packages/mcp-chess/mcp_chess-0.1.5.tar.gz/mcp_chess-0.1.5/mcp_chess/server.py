...
mcp = FastMCP("ChessServer", lifespan=server_lifespan, dependencies=["chess", "cairosvg"])
...
async def new_game(arguments: dict[str, str] | None = None) -> types.GetPromptResult:
    ...
    return types.GetPromptResult(
        messages=messages,
        description="Starting a new chess game" + (f" with {opening} opening" if opening else ", visualize the board after your move")
    )
