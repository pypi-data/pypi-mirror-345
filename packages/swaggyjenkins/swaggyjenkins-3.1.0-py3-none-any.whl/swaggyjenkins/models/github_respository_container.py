...
class GithubRespositoryContainer(BaseModel):
    ...
    links: Optional[GithubRespositoryContainerlinks] = Field(default=None, alias="_links")
    repositories: Optional[GithubRepositories] = None
    __properties: ClassVar[List[str]] = ["_class", "_links", "repositories"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of repositories
        if self.repositories:
            _dict['repositories'] = self.repositories.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": GithubRespositoryContainerlinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "repositories": GithubRepositories.from_dict(obj["repositories"]) if obj.get("repositories") is not None else None
        })
        return _obj
