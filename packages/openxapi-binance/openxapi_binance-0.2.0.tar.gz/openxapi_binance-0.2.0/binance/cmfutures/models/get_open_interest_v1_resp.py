...
class GetOpenInterestV1Resp(BaseModel):
    """
    GetOpenInterestV1Resp
    """ # noqa: E501
    contract_type: Optional[StrictStr] = Field(default=None, alias="contractType")
    open_interest: Optional[StrictStr] = Field(default=None, alias="openInterest")
    pair: Optional[StrictStr] = None
    symbol: Optional[StrictStr] = None
    time: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["contractType", "openInterest", "pair", "symbol", "time"]
