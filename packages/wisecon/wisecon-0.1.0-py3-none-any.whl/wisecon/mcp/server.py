...
def fetch_stock_data(
    ...
    period: Literal["1m", "5m", "15m", "30m", "60m", "1D", "1W", "1M"] = Field(description="data period"),
    size: int = Field(description="data size"),
):
    """"""
...
@click.option("--transport", "-p", default="stdio", type=Literal["stdio", "sse"], required=False, help="transport")
