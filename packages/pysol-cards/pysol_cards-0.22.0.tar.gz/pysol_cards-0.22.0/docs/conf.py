# -*- coding: utf-8 -*-
#
# pysol_cards documentation build configuration file, created by
...
htmlhelp_basename = 'pysol_cardsdoc'
...
latex_documents = [
  ('index', 'pysol_cards.tex', u'pysol_cards Documentation',
...
man_pages = [
    ('index', 'pysol_cards', u'pysol_cards Documentation',
     [u'Shlomi Fish'], 1)
]
