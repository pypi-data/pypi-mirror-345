...
class MetaRagConfig:
    def __init__(self, encoder=None, contexts=None, qas=None, llm=None, splitting_method=ChunkingMethod.SENTENCE_MERGER,
                 ...
                 , normalize_text=False, use_parentParagraph_embeddings=False, max_sentence_len=-1,
                 ...
                 log_chunking_report=False, fixed_length=-1, weighted_bfs=False,
                 embedding_steering_influence_factor=0.35,
                 add_neighbor_chunks_k=2, judge=None, useTool=False, project_name=None, run_name=None,
                 encoder_name=None, sample_size=None, qa_sample_ratio=None,
                 local_mode=None,
                 multi_hop_hardness_factor=None, judged=None, llm_name=None,fine_grain_progressbar=True,use_Gemini=None
        ...
        self.qa_sample_ratio = qa_sample_ratio
    ...
    def toDict(self):
        return {
            ...
            "qa_sample_ratio": self.qa_sample_ratio,
...
def get_best_config():
    return MetaRagConfig(splitting_method=ChunkingMethod.SENTENCE_MERGER,
                         ...
                         embedding_steering_influence_factor=0.2)
