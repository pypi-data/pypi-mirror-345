...
class GetConvertTradeFlowV1RespListInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["createTime", "fromAmount", "fromAsset", "inverseRatio", "orderId", "orderStatus", "quoteId", "ratio", "toAmount", "toAsset"]
