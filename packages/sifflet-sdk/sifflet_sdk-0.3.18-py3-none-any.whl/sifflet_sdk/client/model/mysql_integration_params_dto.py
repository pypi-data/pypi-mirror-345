...
def lazy_import():
    ...
    from sifflet_sdk.client.model.mysql_integration_params_dto_all_of import (
        MysqlIntegrationParamsDtoAllOf,
    )
    from sifflet_sdk.client.model.time_zone_dto import TimeZoneDto

    globals()["IntegrationParamsDto"] = IntegrationParamsDto
    globals()["MysqlIntegrationParamsDtoAllOf"] = MysqlIntegrationParamsDtoAllOf
    globals()["TimeZoneDto"] = TimeZoneDto


class MysqlIntegrationParamsDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MysqlIntegrationParamsDto - a model defined in OpenAPI

        Keyword Args:
            database (str):
            host (str):
            mysql_tls_version (str):
            port (int):
            sifflet_agent_enabled (bool):
