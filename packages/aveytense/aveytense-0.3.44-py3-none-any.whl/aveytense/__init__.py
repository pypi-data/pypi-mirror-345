...
def _is_sequence_helper(v, /, type = _Any): # 0.3.36
    ...
    if _sys.version_info >= (3, 9):
        _generic = (_Generic, _tc.GenericAlias)
...
class Tense( # 0.3.24
    ...
    @classmethod
    def isUnbound(self, f: _tc.Callable[[], _Any], v: str, /):
        """
        @since 0.3.44
        ...
        if not callable(f) or reckon(util.ParamVar(f).all) != 0:
                error = TypeError("first parameter must be parameter-less callable")
                raise error
    ...
    @classmethod
    def print(self, *values: object, separator: _opt[str] = " ", ending: _opt[str] = "\n", file: _uni[_tc.Writeable[str], _tc.Flushable, None] = None, flush = False, reprFirst = False):
        """
        \\@since 0.3.25
        ```
        "class method" in class Tense
...
class RGB(_util.Final):
    ...
    def __str__(self):
        """
        \\@since 0.3.28 https://aveyzan.glitch.me/tense#aveytense.RGB.__str__
        """
        return "{}({})".format(type(self).__name__, ", ".join([str(e) for e in self.__rgb]))
        
    def __repr__(self):
        """
        \\@since 0.3.28 https://aveyzan.glitch.me/tense#aveytense.RGB.__repr__
        """
    ...
    def __hex__(self):
        """
        \\@since 0.3.28 https://aveyzan.glitch.me/tense#aveytense.RGB.?hexadecimal_conversion
    ...
    def __int__(self):
        """
        \\@since 0.3.28 https://aveyzan.glitch.me/tense#aveytense.RGB.?integer_conversion
    ...
    def __lt__(self, other): 
        """
        \\@since 0.3.28 https://aveyzan.glitch.me/tense#aveytense.RGB.?comparison_operators
    ...
    def __pos__(self):
        """
        \\@since 0.3.28 https://aveyzan.glitch.me/tense#aveytense.RGB.tuple
    ...
    def __bytes__(self):
        """
        \\@since 0.3.41 https://aveyzan.glitch.me/tense#aveytense.RGB.?bytes_conversion
    ...
    def __hash__(self):
        """
        \\@since 0.3.41 https://aveyzan.glitch.me/tense#aveytense.RGB.__hash__
    ...
    def __bool__(self):
        """
        \\@since 0.3.41 https://aveyzan.glitch.me/tense#aveytense.RGB.__bool__
    ...
    def __bin__(self):
        """
        \\@since 0.3.41 https://aveyzan.glitch.me/tense#aveytense.RGB.?binary_conversion
    ...
    def __oct__(self):
        """
        \\@since 0.3.41 https://aveyzan.glitch.me/tense#aveytense.RGB.?octal_conversion
    ...
    def hex(self):
        """
        \\@since 0.3.38 https://aveyzan.glitch.me/tense#aveytense.RGB.?hexadecimal_conversion
    ...
    def oct(self):
        """
        \\@since 0.3.44 https://aveyzan.glitch.me/tense#aveytense.RGB.?octal_conversion
    ...
    def bin(self):
        """
        \\@since 0.3.44 https://aveyzan.glitch.me/tense#aveytense.RGB.?binary_conversion
    ...
    def tuple(self):
        """
        \\@since 0.3.38 https://aveyzan.glitch.me/tense#aveytense.RGB.tuple
    ...
    def fromValue(n: _uni[int, str], /):
        """
        \\@since 0.3.36 https://aveyzan.glitch.me/tense#aveytense.RGB.fromValue
