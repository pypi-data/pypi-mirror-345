...
__all__ = ['SmDevicesLockArgs', 'SmDevicesLock']

@pulumi.input_type
class SmDevicesLockArgs:
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Input['SmDevicesLockParametersArgs']:
        return pulumi.get(self, "parameters")

    @parameters.setter
    def parameters(self, value: pulumi.Input['SmDevicesLockParametersArgs']):
...
class SmDevicesLock(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SmDevicesLockArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SmDevicesLockArgs.__new__(SmDevicesLockArgs)
        ...
        super(SmDevicesLock, __self__).__init__(
    ...
    def get(resource_name: str,
        ...
        __props__ = _SmDevicesLockState.__new__(_SmDevicesLockState)

        __props__.__dict__["item"] = item
        __props__.__dict__["network_id"] = network_id
        __props__.__dict__["parameters"] = parameters
        return SmDevicesLock(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def item(self) -> pulumi.Output['outputs.SmDevicesLockItem']:
        return pulumi.get(self, "item")
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Output['outputs.SmDevicesLockParameters']:
        return pulumi.get(self, "parameters")
