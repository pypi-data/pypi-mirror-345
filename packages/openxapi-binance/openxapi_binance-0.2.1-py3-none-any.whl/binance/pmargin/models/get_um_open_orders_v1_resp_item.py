...
class GetUmOpenOrdersV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["avgPrice", "clientOrderId", "cumQuote", "executedQty", "goodTillDate", "orderId", "origQty", "origType", "positionSide", "price", "priceMatch", "reduceOnly", "selfTradePreventionMode", "side", "status", "symbol", "time", "timeInForce", "type", "updateTime"]
