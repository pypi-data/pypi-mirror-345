...
class AluminumEffectiveLengths(_message.Message):
    ...
    class NodalSupportsRow(_message.Message):
        ...
        support_in_y_type: AluminumEffectiveLengths.NodalSupportsRow.SupportInY
        restraint_about_x_type: AluminumEffectiveLengths.NodalSupportsRow.RestraintAboutX
        restraint_about_z_type: AluminumEffectiveLengths.NodalSupportsRow.RestraintAboutZ
        restraint_warping_type: AluminumEffectiveLengths.NodalSupportsRow.RestraintWarping
        nodes: _containers.RepeatedScalarFieldContainer[int]
        def __init__(self, no: _Optional[int] = ..., description: _Optional[str] = ..., support_type: _Optional[_Union[AluminumEffectiveLengths.NodalSupportsRow.SupportType, str]] = ..., support_in_z: bool = ..., support_spring_in_y: _Optional[float] = ..., eccentricity_type: _Optional[_Union[AluminumEffectiveLengths.NodalSupportsRow.EccentricityType, str]] = ..., eccentricity_ez: _Optional[float] = ..., restraint_spring_about_x: _Optional[float] = ..., restraint_spring_about_z: _Optional[float] = ..., restraint_spring_warping: _Optional[float] = ..., support_in_y_type: _Optional[_Union[AluminumEffectiveLengths.NodalSupportsRow.SupportInY, str]] = ..., restraint_about_x_type: _Optional[_Union[AluminumEffectiveLengths.NodalSupportsRow.RestraintAboutX, str]] = ..., restraint_about_z_type: _Optional[_Union[AluminumEffectiveLengths.NodalSupportsRow.RestraintAboutZ, str]] = ..., restraint_warping_type: _Optional[_Union[AluminumEffectiveLengths.NodalSupportsRow.RestraintWarping, str]] = ..., nodes: _Optional[_Iterable[int]] = ...) -> None: ...
