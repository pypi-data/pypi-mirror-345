...
#ifndef __SajadSx_HELPER_BYTEARRAYS_H__
#define __SajadSx_HELPER_BYTEARRAYS_H__

SajadSx_MAY_BE_UNUSED static PyObject *BYTEARRAY_COPY(PyThreadState *tstate, PyObject *bytearray) {
