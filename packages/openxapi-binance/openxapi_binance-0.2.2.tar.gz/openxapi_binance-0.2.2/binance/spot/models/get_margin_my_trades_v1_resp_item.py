...
class GetMarginMyTradesV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["commission", "commissionAsset", "id", "isBestMatch", "isBuyer", "isIsolated", "isMaker", "orderId", "price", "qty", "symbol", "time"]
