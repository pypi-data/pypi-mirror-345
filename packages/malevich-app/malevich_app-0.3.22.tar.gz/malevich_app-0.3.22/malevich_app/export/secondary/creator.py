...
from malevich_app.export.secondary.jls_imported import set_imported, set_imported2, set_imported3
...
def do_cfg(text: Optional[str], info_url: str, is_run: bool = False, extension_key: str = "", *, all_extension_keys: bool = False) -> Tuple[Cfg, Optional[Union[Dict[str, str], str]]]:
    ...
    collections = json_cfg.get("collections", {})
    different = json_cfg.get("different", {})
    schemes_aliases = json_cfg.get("schemes_aliases", {})
    msg_url = json_cfg.get("msg_url")
    init_apps_update = json_cfg.get("init_apps_update", {})
    app_settings = json_cfg.get("app_settings", [])
    app_cfg_extension = json_cfg.get("app_cfg_extension", {})
