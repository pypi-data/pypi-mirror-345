...
from unitforge.unitforge import DistanceUnit, Force, ForceUnit, StressUnit, ForceDistanceUnit
...
def test_matrix_str():
    mat = Matrix3.zero()
    mat[0, 1] = Force(12, ForceUnit.N)
    mat[1, 0] = Force(3, ForceUnit.N)
    mat[2, 2] = Force(1, ForceUnit.N)
    assert str(mat) == 'Matrix3: [\n[ForceQuantity(0 N), ForceQuantity(12 N), ForceQuantity(0 N)]\n[ForceQuantity(3 N), ForceQuantity(0 N), ForceQuantity(0 N)]\n[ForceQuantity(0 N), ForceQuantity(0 N), ForceQuantity(1 N)]]'
