...
tool_setMeetingRecord = {
                    ...
                    "function": {
                        ...
                        "description": "For a future meeting/event/task/deadline record the date, name and content to a calendar.Find todays date before with tool: getTodaysDateTime.",
                        "parameters": {
                            "type": "object",
                            "properties": {
                                "date_": {
...
tool_getTodaysDateTime = {
                    ...
                    "function": {
                        ...
                        "description": "get todays date in %Y%m%d_%a_%H%M format, %a is abbreviated day, no parameters required."
