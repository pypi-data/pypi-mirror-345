...
class OrganisationDocument(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "uploadedByUser": OrganisationDocumentUploadedByUser.from_dict(obj["uploadedByUser"]) if obj.get("uploadedByUser") is not None else None,
