...
class GooeyArgumentGroup(_ArgumentGroup):
    ...
    def add_argument_group(self, *args, **kwargs):
        ...
        group = GooeyArgumentGroup(
            self.parser, self.widgets, self.options, *args, **kwargs
        )
    ...
    def add_mutually_exclusive_group(self, *args, **kwargs):
        ...
        group = GooeyMutuallyExclusiveGroup(
            container, self.parser, self.widgets, self.options, *args, **kwargs
        )
        group.gooey_options = options
    ...
    def inner(*args, **kwargs):
        class ActionWrapper(cls):
            def __call__(self, p, namespace, values, option_string, **qkwargs):
                ...
                super(ActionWrapper, self).__call__(
                    p, namespace, values, option_string, **qkwargs
                )
...
class GooeyParser(object):
    ...
    def add_argument(self, *args, **kwargs):
        ...
        self._validate_constraints(
            self.parser._actions[-1], widget, options or {}, **kwargs
        )
        return action
    ...
    def add_mutually_exclusive_group(self, *args, **kwargs):
        options = kwargs.pop("gooey_options", {})
        group = GooeyMutuallyExclusiveGroup(
            self, self.parser, self.widgets, self.options, *args, **kwargs
        )
        group.gooey_options = options
        self.parser._mutually_exclusive_groups.append(group)
        return group
    ...
    def _validate_constraints(self, parser_action, widget, options, **kwargs):
        from GooeyEx.python_bindings import constraints
