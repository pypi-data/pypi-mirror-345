...
class KymographNavigator(QMainWindow):
    ...
    def create_ui(self):
        ...
        self.movieNameLabel.setStyleSheet("background: transparent; font-size: 16px")
    ...
    def handleGlobalX(self):
        ...
        if frame_image is not None:
            if self.analysis_intensities[idx] is None:
                ...
                # self.kymoCanvas.overlay_spot_center(fitted_center[0], fitted_center[1], size=12, color="magenta") #Doesnt work
            else:
    ...
    def overlay_all_rois(self):
        ...
        for roi_name, roi in self.rois.items():
            ...
            txt = self.movieCanvas.ax.annotate(
                ...
                color="white", fontsize=(30*72.0/self.movieCanvas.fig.get_dpi()), #previously 10pt
                ha="center", va="center",
                bbox=dict(
