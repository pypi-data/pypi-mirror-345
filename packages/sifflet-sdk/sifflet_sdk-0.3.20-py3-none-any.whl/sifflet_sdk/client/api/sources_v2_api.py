...
from sifflet_sdk.client.model.public_create_source_v2201_response import (
...
class SourcesV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.public_get_source_v2_endpoint = _Endpoint(
            settings={
                "response_type": (PublicCreateSourceV2201Response,),
                "auth": ["JWT"],
                "endpoint_path": "/v2/sources/{id}",
                "operation_id": "public_get_source_v2",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
    ...
    def public_get_source_v2(self, id, **kwargs):
        """Get a source by id (v2)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.public_get_source_v2(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["id"] = id
        return self.public_get_source_v2_endpoint.call_with_http_info(**kwargs)
