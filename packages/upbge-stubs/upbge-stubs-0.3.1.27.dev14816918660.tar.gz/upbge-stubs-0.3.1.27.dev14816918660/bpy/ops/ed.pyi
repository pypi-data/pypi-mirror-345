...
:func:`lib_id_generate_preview_from_object`

:func:`lib_id_load_custom_preview`

:func:`lib_id_override_editable_toggle`

:func:`lib_id_remove_preview`
...
def lib_id_generate_preview_from_object() -> None:
...
def lib_id_override_editable_toggle() -> None:
...
def lib_id_remove_preview() -> None:
...
def undo_history(*args, item: int = 0) -> None:
...
def undo_push(*args, message: str = 'Add an undo step *argsfunction may be moved*args') -> None:
