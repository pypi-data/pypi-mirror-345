...
class SubmitDayAheadOrIntraDayBidsRequestBidGroups(BaseModel):
    ...
    bids: List[SubmitDayAheadOrIntraDayBidsRequestBidGroupsBids]
    __properties: ClassVar[List[str]] = ["id", "bidTag", "bids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bids": [SubmitDayAheadOrIntraDayBidsRequestBidGroupsBids.from_dict(_item) for _item in obj["bids"]] if obj.get("bids") is not None else None
        })
        return _obj
