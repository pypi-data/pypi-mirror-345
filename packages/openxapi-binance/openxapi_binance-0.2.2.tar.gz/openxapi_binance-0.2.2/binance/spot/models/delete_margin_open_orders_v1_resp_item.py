...
class DeleteMarginOpenOrdersV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clientOrderId", "cummulativeQuoteQty", "executedQty", "isIsolated", "orderId", "orderListId", "origClientOrderId", "origQty", "price", "selfTradePreventionMode", "side", "status", "symbol", "timeInForce", "type"]
