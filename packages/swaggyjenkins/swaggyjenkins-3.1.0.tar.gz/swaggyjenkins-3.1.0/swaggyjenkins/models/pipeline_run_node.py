...
class PipelineRunNode(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_class", "displayName", "durationInMillis", "edges", "id", "result", "startTime", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "edges": [PipelineRunNodeedges.from_dict(_item) for _item in obj["edges"]] if obj.get("edges") is not None else None,
            "id": obj.get("id"),
