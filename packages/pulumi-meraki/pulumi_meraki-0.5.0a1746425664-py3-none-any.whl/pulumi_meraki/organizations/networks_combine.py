...
__all__ = ['NetworksCombineArgs', 'NetworksCombine']

@pulumi.input_type
class NetworksCombineArgs:
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Input['NetworksCombineParametersArgs']:
        return pulumi.get(self, "parameters")

    @parameters.setter
    def parameters(self, value: pulumi.Input['NetworksCombineParametersArgs']):
...
class NetworksCombine(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NetworksCombineArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NetworksCombineArgs.__new__(NetworksCombineArgs)
        ...
        super(NetworksCombine, __self__).__init__(
    ...
    def get(resource_name: str,
        ...
        __props__ = _NetworksCombineState.__new__(_NetworksCombineState)

        __props__.__dict__["item"] = item
        __props__.__dict__["organization_id"] = organization_id
        __props__.__dict__["parameters"] = parameters
        return NetworksCombine(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def item(self) -> pulumi.Output['outputs.NetworksCombineItem']:
        return pulumi.get(self, "item")
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Output['outputs.NetworksCombineParameters']:
        return pulumi.get(self, "parameters")
