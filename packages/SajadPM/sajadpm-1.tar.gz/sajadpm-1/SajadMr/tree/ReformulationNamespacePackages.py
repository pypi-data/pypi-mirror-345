...
from SajadMr.nodes.CallNodes import ExpressionCallNoKeywords
...
from SajadMr.nodes.ModuleAttributeNodes import ExpressionModuleAttributeFileRef
from SajadMr.nodes.ModuleNodes import CompiledPythonNamespacePackage
from SajadMr.nodes.VariableNameNodes import StatementAssignmentVariableName
from SajadMr.Options import getFileReferenceMode
        ...
        if package.canHaveExternalImports():
            ...
            for count in range(len(parts)):
                path_part = _makeCall(
                    ...
                    source_ref,
                    makeConstantRefNode(
                        constant="SajadSx_PACKAGE_%s" % "_".join(parts[: count + 1]),
                        source_ref=source_ref,
                    ),
                    makeConstantRefNode(
