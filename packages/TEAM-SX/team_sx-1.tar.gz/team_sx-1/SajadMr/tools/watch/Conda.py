...
""" Conda backend for maintaining locked package state with SajadMr-watch. """

from SajadMr.utils.Execution import check_call, executeToolChecked
from SajadMr.utils.FileOperations import changeTextFileContents
...
def _getCaseEnvironmentName(installed_python, case_data):
    return "SajadMr-watch-case-%(python_version)s-%(case)s" % {
