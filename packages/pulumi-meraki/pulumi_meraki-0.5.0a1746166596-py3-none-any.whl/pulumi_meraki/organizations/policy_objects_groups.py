...
class PolicyObjectsGroupsArgs:
    def __init__(__self__, *,
                 ...
                 object_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 policy_object_group_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] category: Category of a policy object group (one of: NetworkObjectGroup, GeoLocationGroup, PortObjectGroup, ApplicationGroup)
        :param pulumi.Input[builtins.str] name: A name for the group of network addresses, unique within the organization (alphanumeric, space, dash, or underscore characters only)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] object_ids: A list of Policy Object ID's that this NetworkObjectGroup should be associated to (note: these ID's will replace the existing associated Policy Objects)
        :param pulumi.Input[builtins.str] policy_object_group_id: policyObjectGroupId path parameter. Policy object group ID
        """
    ...
    def object_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @object_ids.setter
    def object_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "object_ids", value)

    @property
    @pulumi.getter(name="policyObjectGroupId")
    def policy_object_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def policy_object_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PolicyObjectsGroups(pulumi.CustomResource):
    ...
    pulumi_type = "meraki:organizations/policyObjectsGroups:PolicyObjectsGroups"
    ...
    def get(resource_name: str,
            ...
            organization_id: Optional[pulumi.Input[builtins.str]] = None,
            policy_object_group_id: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'PolicyObjectsGroups':
        """
    ...
    @property
    @pulumi.getter(name="objectIds")
    def object_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of Policy Object ID's that this NetworkObjectGroup should be associated to (note: these ID's will replace the existing associated Policy Objects)
        """
        return pulumi.get(self, "object_ids")
    ...
    @property
    @pulumi.getter(name="policyObjectGroupId")
    def policy_object_group_id(self) -> pulumi.Output[builtins.str]:
        """
        policyObjectGroupId path parameter. Policy object group ID
        """
        return pulumi.get(self, "policy_object_group_id")
