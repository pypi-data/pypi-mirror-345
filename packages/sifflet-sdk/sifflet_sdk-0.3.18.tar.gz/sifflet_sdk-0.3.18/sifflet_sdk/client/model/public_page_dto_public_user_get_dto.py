...
def lazy_import():
    ...
    globals()["PublicUserGetDto"] = PublicUserGetDto


class PublicPageDtoPublicUserGetDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([PublicUserGetDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """PublicPageDtoPublicUserGetDto - a model defined in OpenAPI

        Args:
            data ([PublicUserGetDto]):
