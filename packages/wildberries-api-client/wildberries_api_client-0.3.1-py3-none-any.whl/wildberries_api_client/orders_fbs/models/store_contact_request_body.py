...
class StoreContactRequestBody(object):
    ...
    """
    swagger_types = {
        'contacts': 'list[StoreContactRequestBodyContacts]'
    }
    ...
    def __init__(self, contacts=None):  # noqa: E501
        """StoreContactRequestBody - a model defined in Swagger"""  # noqa: E501
        self._contacts = None
    ...
    @property
    def contacts(self):
        """Gets the contacts of this StoreContactRequestBody.  # noqa: E501


        :return: The contacts of this StoreContactRequestBody.  # noqa: E501
        :rtype: list[StoreContactRequestBodyContacts]
        """
        return self._contacts

    @contacts.setter
    def contacts(self, contacts):
        """Sets the contacts of this StoreContactRequestBody.


        :param contacts: The contacts of this StoreContactRequestBody.  # noqa: E501
        :type: list[StoreContactRequestBodyContacts]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StoreContactRequestBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StoreContactRequestBody):
            return False
