...
class GetUmAccountV1Resp(BaseModel):
    """
    GetUmAccountV1Resp
    """ # noqa: E501
    assets: Optional[List[GetCmAccountV1RespAssetsInner]] = None
    positions: Optional[List[GetUmAccountV1RespPositionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "positions": [GetUmAccountV1RespPositionsInner.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None
        })
        return _obj
