...
class MiddlewareHandler(CustomLogger):
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        completion_args = {
            ...
            "subscriber_credential_name": metadata.get('user_api_key_alias', ''),
            "subscriber_credential": metadata['user_api_key_alias'],
            "subscriber_email": metadata.get('user_api_key_user_email', ''),
            "subscriber_id": metadata.get('x-revenium-subscriber-id', ''),
    ...
    async def async_log_failure_event(self, kwargs, response_obj, start_time, end_time):
        ...
        completion_args = {
            ...
            "task_type": headers.get("x-revenium-task-type"),
            "subscriber_credential_name": metadata.get('user_api_key_alias', ''),
            "subscriber_credential": metadata.get('user_api_key_hash', ''),
            "subscriber_email": metadata.get('user_api_key_user_email', ''),
            "subscriber_id": metadata.get('x-revenium-subscriber-id', ''),
