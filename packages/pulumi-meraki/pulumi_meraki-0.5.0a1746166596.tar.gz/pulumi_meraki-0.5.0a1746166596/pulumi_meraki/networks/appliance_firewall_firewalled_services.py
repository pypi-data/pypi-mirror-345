...
class ApplianceFirewallFirewalledServicesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service: Appliance service name
        :param pulumi.Input[builtins.str] access: A string indicating the rule for which IPs are allowed to use the specified service
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_ips: An array of allowed IPs that can access the service
        """
...
class ApplianceFirewallFirewalledServices(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            allowed_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            network_id: Optional[pulumi.Input[builtins.str]] = None,
            service: Optional[pulumi.Input[builtins.str]] = None) -> 'ApplianceFirewallFirewalledServices':
        """
    ...
    @property
    @pulumi.getter(name="allowedIps")
    def allowed_ips(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        An array of allowed IPs that can access the service
        """
        return pulumi.get(self, "allowed_ips")
