...
class V3WarehousesBody(object):
    ...
    def __init__(self, name=None, office_id=None):  # noqa: E501
        """V3WarehousesBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this V3WarehousesBody.  # noqa: E501

        Ima sklada prodavca  # noqa: E501

        :return: The name of this V3WarehousesBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this V3WarehousesBody.

        Ima sklada prodavca  # noqa: E501

        :param name: The name of this V3WarehousesBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def office_id(self):
        """Gets the office_id of this V3WarehousesBody.  # noqa: E501

        ID sklada WB  # noqa: E501

        :return: The office_id of this V3WarehousesBody.  # noqa: E501
        :rtype: int
        """
    ...
    def office_id(self, office_id):
        """Sets the office_id of this V3WarehousesBody.

        ID sklada WB  # noqa: E501

        :param office_id: The office_id of this V3WarehousesBody.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V3WarehousesBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V3WarehousesBody):
            return False
