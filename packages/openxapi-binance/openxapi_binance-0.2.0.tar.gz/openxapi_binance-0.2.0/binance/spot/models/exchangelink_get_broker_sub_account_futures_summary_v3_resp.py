...
class ExchangelinkGetBrokerSubAccountFuturesSummaryV3Resp(BaseModel):
    """
    ExchangelinkGetBrokerSubAccountFuturesSummaryV3Resp
    """ # noqa: E501
    data: Optional[List[ExchangelinkGetBrokerSubAccountFuturesSummaryV3RespDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ExchangelinkGetBrokerSubAccountFuturesSummaryV3RespDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
