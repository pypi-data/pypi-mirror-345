...
class SwitchStacksArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of the Switch stack
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] serials: Serials of the switches in the switch stack
...
class SwitchStacks(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_id: Optional[pulumi.Input[builtins.str]] = None,
            serials: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            switch_stack_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SwitchStacks':
        """
