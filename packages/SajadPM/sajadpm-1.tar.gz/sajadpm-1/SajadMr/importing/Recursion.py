...
from SajadMr import ModuleRegistry, Options
from SajadMr.Errors import SajadQForbiddenImportEncounter
from SajadMr.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from SajadMr.importing import ImportCache, StandardLibrary
from SajadMr.ModuleRegistry import addUsedModule, getRootTopModule
from SajadMr.pgo.PGO import decideInclusionFromPGO
from SajadMr.plugins.Plugins import Plugins
from SajadMr.PythonVersions import python_version
from SajadMr.Tracing import recursion_logger
from SajadMr.utils.FileOperations import listDir
...
def _recurseTo(module_name, module_filename, module_kind, reason):
    from SajadMr.tree import Building
...
def _decideRecursion(
    ...
    if not is_stdlib or Options.shallFollowStandardLibrary():
        ...
        from SajadMr.tree.Building import decideCompilationMode
...
def considerUsedModules(module, pass_count):
    ...
    for used_module in module.getUsedModules():
        ...
        except SajadQForbiddenImportEncounter as e:
