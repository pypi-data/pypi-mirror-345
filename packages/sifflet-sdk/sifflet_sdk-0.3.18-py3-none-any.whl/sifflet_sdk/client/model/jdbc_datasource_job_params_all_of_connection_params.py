...
def lazy_import():
    from sifflet_sdk.client.model.user_password_connection_params import (
        UserPasswordConnectionParams,
    )

    globals()["UserPasswordConnectionParams"] = UserPasswordConnectionParams


class JdbcDatasourceJobParamsAllOfConnectionParams(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            "UserPasswordConnectionParams": UserPasswordConnectionParams,
        }
        if not val:
            return None
        return {"type": val}
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JdbcDatasourceJobParamsAllOfConnectionParams - a model defined in OpenAPI
