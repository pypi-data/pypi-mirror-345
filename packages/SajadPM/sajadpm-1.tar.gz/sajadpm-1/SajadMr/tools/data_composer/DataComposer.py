...
from SajadMr.__past__ import BytesIO, long, to_byte, unicode, xrange
from SajadMr.build.DataComposerInterface import deriveModuleConstantsBlobName
from SajadMr.Builtins import builtin_exception_values_list, builtin_named_values
...
from SajadMr.Serialization import (
    BlobData,
    BuiltinAnonValue,
...
from SajadMr.Tracing import data_composer_logger
from SajadMr.utils.FileOperations import getFileSize, listDir, syncFileOutput
from SajadMr.utils.Json import writeJsonToFilename
...
def main():
    ...
    data_composer_logger.is_quiet = (
        os.getenv("SajadSx_DATA_COMPOSER_VERBOSE", "0") != "1"
    )

    # Internal tool, most simple command line handling. This is the build directory
    # where main SajadQ put the .const files.
