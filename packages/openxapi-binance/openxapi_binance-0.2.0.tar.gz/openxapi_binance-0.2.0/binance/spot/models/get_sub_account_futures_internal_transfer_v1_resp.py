...
class GetSubAccountFuturesInternalTransferV1Resp(BaseModel):
    """
    GetSubAccountFuturesInternalTransferV1Resp
    """ # noqa: E501
    futures_type: Optional[StrictInt] = Field(default=None, alias="futuresType")
    success: Optional[StrictBool] = None
    transfers: Optional[List[GetSubAccountFuturesInternalTransferV1RespTransfersInner]] = None
    __properties: ClassVar[List[str]] = ["futuresType", "success", "transfers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "futuresType": obj.get("futuresType"),
            "success": obj.get("success"),
            "transfers": [GetSubAccountFuturesInternalTransferV1RespTransfersInner.from_dict(_item) for _item in obj["transfers"]] if obj.get("transfers") is not None else None
        })
        return _obj
