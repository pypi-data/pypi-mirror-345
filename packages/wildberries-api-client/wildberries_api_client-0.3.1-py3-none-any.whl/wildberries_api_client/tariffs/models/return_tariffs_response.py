...
class ReturnTariffsResponse(object):
    ...
    def __init__(self, response=None):  # noqa: E501
        """ReturnTariffsResponse - a model defined in Swagger"""  # noqa: E501
        self._response = None
    ...
    @property
    def response(self):
        """Gets the response of this ReturnTariffsResponse.  # noqa: E501


        :return: The response of this ReturnTariffsResponse.  # noqa: E501
        :rtype: ModelsReturnTariffsResponse
        """
        return self._response

    @response.setter
    def response(self, response):
        """Sets the response of this ReturnTariffsResponse.


        :param response: The response of this ReturnTariffsResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ReturnTariffsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReturnTariffsResponse):
            return False
