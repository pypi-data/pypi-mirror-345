...
class GetCmLeverageBracketV1RespItem(BaseModel):
    """
    GetCmLeverageBracketV1RespItem
    """ # noqa: E501
    brackets: Optional[List[GetCmLeverageBracketV1RespItemBracketsInner]] = None
    symbol: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["brackets", "symbol"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "brackets": [GetCmLeverageBracketV1RespItemBracketsInner.from_dict(_item) for _item in obj["brackets"]] if obj.get("brackets") is not None else None,
