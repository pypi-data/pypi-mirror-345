...
class GetConvertOrderStatusV1Resp(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["createTime", "fromAmount", "fromAsset", "inverseRatio", "orderId", "orderStatus", "ratio", "toAmount", "toAsset"]
