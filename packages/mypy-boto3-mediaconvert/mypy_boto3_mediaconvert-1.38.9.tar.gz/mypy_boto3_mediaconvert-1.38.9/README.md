...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-mediaconvert)](https://pypistats.org/packages/mypy-boto3-mediaconvert)
...
`mypy-boto3-mediaconvert` dependency in production. However, there is an issue
