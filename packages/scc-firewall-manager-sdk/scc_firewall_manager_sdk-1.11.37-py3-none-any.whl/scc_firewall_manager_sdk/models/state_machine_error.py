...
class StateMachineError(BaseModel):
    ...
    StateMachineError
    """ # noqa: E501
    action_identifier: Optional[StrictStr] = Field(default=None, alias="actionIdentifier")
    error_code: Optional[StrictStr] = Field(default=None, alias="errorCode")
    error_message: Optional[StrictStr] = Field(default=None, alias="errorMessage")
    __properties: ClassVar[List[str]] = ["actionIdentifier", "errorCode", "errorMessage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actionIdentifier": obj.get("actionIdentifier"),
