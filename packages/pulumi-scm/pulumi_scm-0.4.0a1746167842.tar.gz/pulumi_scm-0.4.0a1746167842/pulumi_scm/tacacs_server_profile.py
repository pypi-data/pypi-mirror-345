...
class TacacsServerProfileArgs:
    def __init__(__self__, *,
                 ...
                 use_single_connection: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a TacacsServerProfile resource.
        :param pulumi.Input[builtins.str] protocol: The Protocol param. String must be one of these: `"CHAP"`, `"PAP"`.
        ...
        :param pulumi.Input[builtins.int] timeout: The Timeout param. Value must be between 1 and 30.
        :param pulumi.Input[builtins.bool] use_single_connection: The UseSingleConnection param.
        """
    ...
    def use_single_connection(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_single_connection(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class TacacsServerProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tfid: Optional[pulumi.Input[builtins.str]] = None,
            timeout: Optional[pulumi.Input[builtins.int]] = None,
            use_single_connection: Optional[pulumi.Input[builtins.bool]] = None) -> 'TacacsServerProfile':
        """
    ...
    @property
    @pulumi.getter(name="useSingleConnection")
    def use_single_connection(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The UseSingleConnection param.
        """
        return pulumi.get(self, "use_single_connection")
