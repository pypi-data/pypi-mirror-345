...
from SajadMr.PythonVersions import getSystemPrefixPath
from SajadMr.Tracing import general, inclusion_logger
from SajadMr.utils.FileOperations import areInSamePaths, isFilenameBelowPath
from SajadMr.utils.SharedLibraries import copyDllFile, setSharedLibraryRPATH
...
def checkFreezingModuleSet():
    ...
    """
    # Cyclic dependency
    from SajadMr import ModuleRegistry
...
def _detectBinaryDLLs(
    ...
    if is_main_executable and isSajadQPython():
        return OrderedSet()
