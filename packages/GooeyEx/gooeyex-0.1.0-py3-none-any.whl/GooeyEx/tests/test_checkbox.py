...
class TestCheckbox(unittest.TestCase):
    ...
    def makeParser(self, **kwargs):
        ...
        parser.add_argument("--widget", action="store_true", **kwargs)
        return parser
    ...
    def testInitialValue(self):
        cases = [
            ...
            {
                "inputs": {"default": True, "widget": "CheckBox", "gooey_options": {}},
                "expect": True,
            },
            {"inputs": {"default": True, "widget": "CheckBox"}, "expect": True},
            {"inputs": {"widget": "CheckBox"}, "expect": False},
        ]
        for case in cases:
