...
def lazy_import():
    from sifflet_sdk.client.model.transformation_run_dto import TransformationRunDto

    globals()["TransformationRunDto"] = TransformationRunDto


class SearchCollectionTransformationRunDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([TransformationRunDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SearchCollectionTransformationRunDto - a model defined in OpenAPI

        Args:
            data ([TransformationRunDto]):
