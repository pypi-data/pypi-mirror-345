...
def to_html(
    ...
    *,
    ...
    elif question_type in ["multiquestion", "list_multiquestion"]:
...
def to_summary_list_row(question, *, action_link=None, **kwargs) -> Dict[str, dict]:
    ...
    if action_link is not None:
        ...
        optional_label = f" ({getattr(question, 'optional_text', '') or 'Optional'})"
        question_label = question.label + optional_label if question.is_optional else question.label
