...
def lazy_import():
    ...
    globals()["PublicCalendarGetDto"] = PublicCalendarGetDto


class PublicPageDtoPublicCalendarGetDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([PublicCalendarGetDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """PublicPageDtoPublicCalendarGetDto - a model defined in OpenAPI

        Args:
            data ([PublicCalendarGetDto]):
