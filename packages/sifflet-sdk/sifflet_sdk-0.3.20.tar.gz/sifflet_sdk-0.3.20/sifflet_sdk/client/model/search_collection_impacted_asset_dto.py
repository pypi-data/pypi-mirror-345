...
def lazy_import():
    from sifflet_sdk.client.model.impacted_asset_dto import ImpactedAssetDto

    globals()["ImpactedAssetDto"] = ImpactedAssetDto


class SearchCollectionImpactedAssetDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([ImpactedAssetDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SearchCollectionImpactedAssetDto - a model defined in OpenAPI

        Args:
            data ([ImpactedAssetDto]):
