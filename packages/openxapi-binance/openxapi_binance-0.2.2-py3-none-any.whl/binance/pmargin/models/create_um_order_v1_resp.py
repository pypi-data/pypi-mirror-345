...
class CreateUmOrderV1Resp(BaseModel):
    """
    CreateUmOrderV1Resp
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["avgPrice", "clientOrderId", "cumQty", "cumQuote", "executedQty", "goodTillDate", "orderId", "origQty", "positionSide", "price", "priceMatch", "reduceOnly", "selfTradePreventionMode", "side", "status", "symbol", "timeInForce", "type", "updateTime"]
