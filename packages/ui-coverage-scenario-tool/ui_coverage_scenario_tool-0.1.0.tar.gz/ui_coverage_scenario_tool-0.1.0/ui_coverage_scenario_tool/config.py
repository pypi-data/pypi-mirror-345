...
from ui_coverage_scenario_tool.src.tools.types import AppKey, AppName
...
class Settings(BaseSettings):
    ...
    def html_report_template_file(self):
        try:
            return importlib.resources.files("ui_coverage_scenario_tool.src.reports.templates") / "index.html"
        except importlib.metadata.PackageNotFoundError:
            return Path(os.path.join(os.getcwd(), "ui_coverage_scenario_tool/src/reports/templates/index.html"))
