...
class Mediapackagev2Client(AioBaseClient):
    ...
    async def cancel_harvest_job(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackagev2/client/#cancel_harvest_job)
        """
    ...
    async def create_harvest_job(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackagev2/client/#create_harvest_job)
        """
    ...
    async def get_harvest_job(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackagev2/client/#get_harvest_job)
        """
    ...
    async def list_harvest_jobs(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackagev2/client/#list_harvest_jobs)
        """
    ...
    def get_waiter(  # type: ignore[override]
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackagev2/client/#get_waiter)
        """
