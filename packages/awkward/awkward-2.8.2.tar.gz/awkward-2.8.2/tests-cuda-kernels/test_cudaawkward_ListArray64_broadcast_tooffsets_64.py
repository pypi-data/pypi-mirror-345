...
def test_cudaawkward_ListArray64_broadcast_tooffsets_64_1():
    ...
    lencontent = 3
    funcC = cupy_backend['awkward_ListArray_broadcast_tooffsets', cupy.int64, cupy.int64, cupy.int64, cupy.int64]

def test_cudaawkward_ListArray64_broadcast_tooffsets_64_2():
    tocarry = cupy.array([123], dtype=cupy.int64)
    fromoffsets = cupy.array([2, 3, 3, 4, 5, 5, 5, 5, 5, 6, 7, 8, 10, 11], dtype=cupy.int64)
    offsetslength = 3
