...
class Pipeline(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_class", "organization", "name", "displayName", "fullName", "weatherScore", "estimatedDurationInMillis", "latestRun"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "latestRun": PipelinelatestRun.from_dict(obj["latestRun"]) if obj.get("latestRun") is not None else None
        })
        return _obj
