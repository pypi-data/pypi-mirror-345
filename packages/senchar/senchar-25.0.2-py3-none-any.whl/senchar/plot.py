...
Contains plotting support for senchar.
...
#: list of markers with crosses  - *senchar.plot.style_x*
style_x = [
    "bx",
    "rx",
    "gx",
...
#: list of markers with circles - *senchar.plot.style_o*
style_o = [
    "bo",
    "ro",
    "go",
...
#: list of markers with dots - *senchar.plot.style_dot*
style_dot = [
    "b.",
    "r.",
    "g.",
...
#: list of line styles - *senchar.plot.style_lines*
style_lines = [
    "b-",
    "r-",
    "g-",
...
def tools(figure_number=1, include_motion: bool = 0) -> None:
    ...
    def mouse_motion(event):
        ...
        if event.inaxes:
            senchar.log("data coords", event.xdata, event.ydata)
...
def plot_image(
    ...
    """
    Plot an senchar image buffer nicely.
    ...
    if scale_type == "sdev":
        ...
        raise senchar.exceptions.SencharError("unrecognized scale_type")
