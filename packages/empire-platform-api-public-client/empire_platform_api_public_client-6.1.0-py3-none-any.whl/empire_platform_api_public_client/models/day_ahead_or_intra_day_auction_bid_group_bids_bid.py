...
class DayAheadOrIntraDayAuctionBidGroupBidsBid(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["value", "updatedAt", "status", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": DayAheadOrIntraDayAuctionBidGroupBidsBidResults.from_dict(obj["results"]) if obj.get("results") is not None else None
        })
        return _obj
