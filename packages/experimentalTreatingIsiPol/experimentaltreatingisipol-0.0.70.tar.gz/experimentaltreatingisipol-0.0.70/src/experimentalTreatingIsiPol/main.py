...
class SeveralMechanicalTestingFittingLinear():
    ...
    def __findOtherArchives(self, docConfig: str, archive_name :  str,
        ...
        if self.save_results != '':
            ...
            fig_final.savefig(os.path.join(self.save_results, 'resultados_finais.png'), dpi=2000 , bbox_inches='tight')
            fig_final.savefig(os.path.join(self.save_results, 'resultados_finais.jpeg'), dpi=2000, bbox_inches='tight')
