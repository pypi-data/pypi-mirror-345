...
class CmfuturesCreateBatchOrderV1ReqBatchOrdersItem(BaseModel):
    """
    ...
    close_position: Optional[StrictStr] = Field(default='', alias="closePosition")
    ...
    __properties: ClassVar[List[str]] = ["activationPrice", "callbackRate", "closePosition", "newClientOrderId", "newOrderRespType", "positionSide", "price", "priceMatch", "priceProtect", "quantity", "reduceOnly", "selfTradePreventionMode", "side", "stopPrice", "symbol", "timeInForce", "type", "workingType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "closePosition": obj.get("closePosition") if obj.get("closePosition") is not None else '',
