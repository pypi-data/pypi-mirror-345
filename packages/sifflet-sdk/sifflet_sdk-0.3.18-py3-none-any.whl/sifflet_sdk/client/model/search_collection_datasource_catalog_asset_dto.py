...
def lazy_import():
    from sifflet_sdk.client.model.datasource_catalog_asset_dto import (
        DatasourceCatalogAssetDto,
    )

    globals()["DatasourceCatalogAssetDto"] = DatasourceCatalogAssetDto


class SearchCollectionDatasourceCatalogAssetDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([DatasourceCatalogAssetDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SearchCollectionDatasourceCatalogAssetDto - a model defined in OpenAPI

        Args:
            data ([DatasourceCatalogAssetDto]):
