...
class TestDuplicateInputsValidation:
    ...
    def test_sync_validation(self, client: IOC.KognicIOClient):
        ...
        wait_for_scene_job(client=client, scene_uuid=resp.scene_uuid)
    ...
    def test_async_validation(self, client: IOC.KognicIOClient):
        ...
        # Wait
        status1 = wait_for_scene_job(client=client, scene_uuid=resp1.scene_uuid)
        status2 = wait_for_scene_job(client=client, scene_uuid=resp2.scene_uuid)
