...
class GetSubAccountUniversalTransferV1Resp(BaseModel):
    """
    GetSubAccountUniversalTransferV1Resp
    """ # noqa: E501
    result: Optional[List[GetSubAccountUniversalTransferV1RespResultInner]] = None
    total_count: Optional[StrictInt] = Field(default=None, alias="totalCount")
    __properties: ClassVar[List[str]] = ["result", "totalCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": [GetSubAccountUniversalTransferV1RespResultInner.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
