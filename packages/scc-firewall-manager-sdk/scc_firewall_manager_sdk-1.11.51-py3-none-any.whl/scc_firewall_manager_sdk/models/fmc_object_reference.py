...
class FmcObjectReference(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the FMC Object.")
    type: Optional[StrictStr] = Field(default=None, description="The type of the FMC Object.")
    uid: Optional[StrictStr] = Field(default=None, description="The unique identifier, represented as a UUID, of the FMC Object.")
    __properties: ClassVar[List[str]] = ["link", "name", "type", "uid"]
