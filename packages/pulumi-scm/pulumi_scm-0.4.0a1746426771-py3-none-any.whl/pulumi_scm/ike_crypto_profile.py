...
class IkeCryptoProfileArgs:
    def __init__(__self__, *,
                 dh_groups: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 encryptions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 hashes: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 authentication_multiple: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dh_groups: The DhGroups param. Individual elements in this list are subject to additional validation. String must be one of these: `"group1"`, `"group2"`, `"group5"`, `"group14"`, `"group19"`, `"group20"`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] encryptions: Encryption algorithm. Individual elements in this list are subject to additional validation. String must be one of these: `"des"`, `"3des"`, `"aes-128-cbc"`, `"aes-192-cbc"`, `"aes-256-cbc"`, `"aes-128-gcm"`, `"aes-256-gcm"`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] hashes: The Hashes param. Individual elements in this list are subject to additional validation. String must be one of these: `"md5"`, `"sha1"`, `"sha256"`, `"sha384"`, `"sha512"`.
        :param pulumi.Input[builtins.int] authentication_multiple: IKEv2 SA reauthentication interval equals authetication-multiple * rekey-lifetime; 0 means reauthentication disabled. Value must be less than or equal to 50. Default: `0`.
        ...
        :param pulumi.Input[builtins.str] name: Alphanumeric string begin with letter: [0-9a-zA-Z._-]. String length must not exceed 31 characters.
    ...
    def dh_groups(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @dh_groups.setter
    def dh_groups(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "dh_groups", value)

    @property
    @pulumi.getter
    def encryptions(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @encryptions.setter
    def encryptions(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "encryptions", value)

    @property
    @pulumi.getter
    def hashes(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @hashes.setter
    def hashes(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "hashes", value)

    @property
    @pulumi.getter(name="authenticationMultiple")
    def authentication_multiple(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def authentication_multiple(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _IkeCryptoProfileState:
    def __init__(__self__, *,
                 authentication_multiple: Optional[pulumi.Input[builtins.int]] = None,
                 device: Optional[pulumi.Input[builtins.str]] = None,
                 dh_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 encryptions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 folder: Optional[pulumi.Input[builtins.str]] = None,
                 hashes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 lifetime: Optional[pulumi.Input['IkeCryptoProfileLifetimeArgs']] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 snippet: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="dhGroups")
    def dh_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The DhGroups param. Individual elements in this list are subject to additional validation. String must be one of these: `"group1"`, `"group2"`, `"group5"`, `"group14"`, `"group19"`, `"group20"`.
        """
        return pulumi.get(self, "dh_groups")
    ...
    @dh_groups.setter
    def dh_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "dh_groups", value)
    ...
    @property
    @pulumi.getter
    def hashes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The Hashes param. Individual elements in this list are subject to additional validation. String must be one of these: `"md5"`, `"sha1"`, `"sha256"`, `"sha384"`, `"sha512"`.
        """
        return pulumi.get(self, "hashes")
    ...
    @hashes.setter
    def hashes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "hashes", value)
...
class IkeCryptoProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            snippet: Optional[pulumi.Input[builtins.str]] = None,
            tfid: Optional[pulumi.Input[builtins.str]] = None) -> 'IkeCryptoProfile':
        """
    ...
    @property
    @pulumi.getter(name="authenticationMultiple")
    def authentication_multiple(self) -> pulumi.Output[builtins.int]:
        """
        IKEv2 SA reauthentication interval equals authetication-multiple * rekey-lifetime; 0 means reauthentication disabled. Value must be less than or equal to 50. Default: `0`.
        """
        return pulumi.get(self, "authentication_multiple")
    ...
    @property
    @pulumi.getter(name="dhGroups")
    def dh_groups(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The DhGroups param. Individual elements in this list are subject to additional validation. String must be one of these: `"group1"`, `"group2"`, `"group5"`, `"group14"`, `"group19"`, `"group20"`.
        """
        return pulumi.get(self, "dh_groups")
    ...
    @property
    @pulumi.getter
    def encryptions(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Encryption algorithm. Individual elements in this list are subject to additional validation. String must be one of these: `"des"`, `"3des"`, `"aes-128-cbc"`, `"aes-192-cbc"`, `"aes-256-cbc"`, `"aes-128-gcm"`, `"aes-256-gcm"`.
        """
        return pulumi.get(self, "encryptions")
    ...
    @property
    @pulumi.getter
    def hashes(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The Hashes param. Individual elements in this list are subject to additional validation. String must be one of these: `"md5"`, `"sha1"`, `"sha256"`, `"sha384"`, `"sha512"`.
        """
        return pulumi.get(self, "hashes")
