...
class VisibilityInfoOpenCard(object):
    ...
    def __init__(self, current=None, dynamics=None):  # noqa: E501
        """VisibilityInfoOpenCard - a model defined in Swagger"""  # noqa: E501
        self._current = None
        self._dynamics = None
    ...
    @property
    def current(self):
        """Gets the current of this VisibilityInfoOpenCard.  # noqa: E501

        Tekuhee kolihestvo perehodov  # noqa: E501

        :return: The current of this VisibilityInfoOpenCard.  # noqa: E501
        :rtype: int
        """
    ...
    def current(self, current):
        """Sets the current of this VisibilityInfoOpenCard.

        Tekuhee kolihestvo perehodov  # noqa: E501

        :param current: The current of this VisibilityInfoOpenCard.  # noqa: E501
        :type: int
        """
        if current is None:
    ...
    @property
    def dynamics(self):
        """Gets the dynamics of this VisibilityInfoOpenCard.  # noqa: E501

        Dinamika po sravneniu s predyduhim periodom, %  # noqa: E501

        :return: The dynamics of this VisibilityInfoOpenCard.  # noqa: E501
        :rtype: int
        """
    ...
    def dynamics(self, dynamics):
        """Sets the dynamics of this VisibilityInfoOpenCard.

        Dinamika po sravneniu s predyduhim periodom, %  # noqa: E501

        :param dynamics: The dynamics of this VisibilityInfoOpenCard.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VisibilityInfoOpenCard, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VisibilityInfoOpenCard):
            return False
