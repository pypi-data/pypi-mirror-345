...
# Calculator class
class AdaptiveRGBCalculator(BaseTool):
    def __init__(
        self,
        ...
        adaptive_rgb_nstack = np.stack(
            [
                exposure.equalize_adapthist(
                    self.normalized_bands["red"], nbins=256, clip_limit=0.08
                ),
                exposure.equalize_adapthist(
                    self.normalized_bands["green"], nbins=256, clip_limit=0.08
                ),
                exposure.equalize_adapthist(
                    self.normalized_bands["blue"], nbins=256, clip_limit=0.08
                ),
            ],
            axis=2,
        )

        self._output = adaptive_rgb_nstack
    ...
    def chart_export(
        ...
        title: str | None = None,
        figsize: tuple = (10, 10),
        filename_prefix: str = "Chart_Adaptive_RGB_IE_Tool_output",
        dpi: int = 500,
...
if __name__ == "__main__":
    ...
    ).chart_export("./", title="Adaptive-RGB IE")
