...
class ConstructionStage(_message.Message):
    ...
    class LoadingRow(_message.Message):
        ...
        description: str
        load_case: int
        status_type: ConstructionStage.LoadingRow.Status
        permanent: bool
        factor: float
        def __init__(self, no: _Optional[int] = ..., description: _Optional[str] = ..., load_case: _Optional[int] = ..., status_type: _Optional[_Union[ConstructionStage.LoadingRow.Status, str]] = ..., permanent: bool = ..., factor: _Optional[float] = ...) -> None: ...
    ...
    class MemberPropertyModificationsRow(_message.Message):
        ...
        action_type: ConstructionStage.MemberPropertyModificationsRow.Action
        property_to_modify_type: ConstructionStage.MemberPropertyModificationsRow.PropertyToModify
        original_value: int
        new_value: int
        comment: str
        def __init__(self, no: _Optional[int] = ..., description: _Optional[str] = ..., members_no: _Optional[_Iterable[int]] = ..., action_type: _Optional[_Union[ConstructionStage.MemberPropertyModificationsRow.Action, str]] = ..., property_to_modify_type: _Optional[_Union[ConstructionStage.MemberPropertyModificationsRow.PropertyToModify, str]] = ..., original_value: _Optional[int] = ..., new_value: _Optional[int] = ..., comment: _Optional[str] = ...) -> None: ...
    ...
    class SurfacePropertyModificationsRow(_message.Message):
        ...
        action_type: ConstructionStage.SurfacePropertyModificationsRow.Action
        property_to_modify_type: ConstructionStage.SurfacePropertyModificationsRow.PropertyToModify
        original_value: int
        new_value: int
        comment: str
        def __init__(self, no: _Optional[int] = ..., description: _Optional[str] = ..., surfaces_no: _Optional[_Iterable[int]] = ..., action_type: _Optional[_Union[ConstructionStage.SurfacePropertyModificationsRow.Action, str]] = ..., property_to_modify_type: _Optional[_Union[ConstructionStage.SurfacePropertyModificationsRow.PropertyToModify, str]] = ..., original_value: _Optional[int] = ..., new_value: _Optional[int] = ..., comment: _Optional[str] = ...) -> None: ...
    ...
    class SolidPropertyModificationsRow(_message.Message):
        ...
        action_type: ConstructionStage.SolidPropertyModificationsRow.Action
        property_to_modify_type: ConstructionStage.SolidPropertyModificationsRow.PropertyToModify
        original_value: int
        new_value: int
        comment: str
        def __init__(self, no: _Optional[int] = ..., description: _Optional[str] = ..., solids_no: _Optional[_Iterable[int]] = ..., action_type: _Optional[_Union[ConstructionStage.SolidPropertyModificationsRow.Action, str]] = ..., property_to_modify_type: _Optional[_Union[ConstructionStage.SolidPropertyModificationsRow.PropertyToModify, str]] = ..., original_value: _Optional[int] = ..., new_value: _Optional[int] = ..., comment: _Optional[str] = ...) -> None: ...
    NO_FIELD_NUMBER: _ClassVar[int]
