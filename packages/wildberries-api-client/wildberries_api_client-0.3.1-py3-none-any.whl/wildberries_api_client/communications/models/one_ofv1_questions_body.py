...
class OneOfv1QuestionsBody(object):
    ...
    def __init__(self):  # noqa: E501
        """OneOfv1QuestionsBody - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OneOfv1QuestionsBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfv1QuestionsBody):
            return False
