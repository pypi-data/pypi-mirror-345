...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in fleetspeak/src/server/grpcservice/proto/fleetspeak_grpcservice/grpcservice_pb2_grpc.py depends on'
...
def add_ProcessorServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('fleetspeak.grpcservice.Processor', rpc_method_handlers)
