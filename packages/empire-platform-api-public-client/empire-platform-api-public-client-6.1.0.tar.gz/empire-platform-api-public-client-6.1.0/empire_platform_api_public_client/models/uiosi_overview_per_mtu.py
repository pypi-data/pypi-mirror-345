...
class UiosiOverviewPerMtu(BaseModel):
    ...
    allocated_capacity: StrictInt = Field(description="Capacity value in kilowatts (kW) - the required system precision allows for handling capacity values as integers", alias="allocatedCapacity")
    unnominated_capacity: StrictInt = Field(description="Capacity value in kilowatts (kW) - the required system precision allows for handling capacity values as integers", alias="unnominatedCapacity")
    resold: UiosiResold
    not_resold: UiosiNotResold = Field(alias="notResold")
    __properties: ClassVar[List[str]] = ["mtu", "allocatedCapacity", "unnominatedCapacity", "resold", "notResold"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resold": UiosiResold.from_dict(obj["resold"]) if obj.get("resold") is not None else None,
            "notResold": UiosiNotResold.from_dict(obj["notResold"]) if obj.get("notResold") is not None else None
        })
        return _obj
