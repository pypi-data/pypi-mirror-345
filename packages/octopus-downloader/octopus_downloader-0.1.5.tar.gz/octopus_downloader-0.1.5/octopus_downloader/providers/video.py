from octopus_downloader.providers.video_providers.tiktok import TikTokProvider
from octopus_downloader.providers.video_providers.youtube import YouTubeProvider
from octopus_downloader.providers.video_providers.douyin import DouYinProvider
