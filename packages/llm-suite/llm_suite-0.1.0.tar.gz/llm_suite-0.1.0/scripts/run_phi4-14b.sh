...
mkdir -p "$HOME/results/phi4-14b-$SLURM_JOB_ID"
cp "$INPUT_FILE" "$HOME/results/phi4-14b-$SLURM_JOB_ID/phi4-14b_input.jsonl"
cp "$OUTPUT_FILE" "$HOME/results/phi4-14b-$SLURM_JOB_ID/phi4-14b_output.jsonl"
cp "$LOG_FILE" "$HOME/results/phi4-14b-$SLURM_JOB_ID/phi4-14b_log.log"
cp /tmp/ollama-$SLURM_JOB_ID.log "$HOME/results/phi4-14b-$SLURM_JOB_ID/ollama.log"
