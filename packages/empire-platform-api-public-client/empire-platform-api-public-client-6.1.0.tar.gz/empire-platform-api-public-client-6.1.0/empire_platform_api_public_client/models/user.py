...
class User(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "organisation", "name", "email", "phoneNumber", "role", "status", "jobTitle"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "organisation": UserOrganisation.from_dict(obj["organisation"]) if obj.get("organisation") is not None else None,
            "name": obj.get("name"),
            "email": obj.get("email"),
