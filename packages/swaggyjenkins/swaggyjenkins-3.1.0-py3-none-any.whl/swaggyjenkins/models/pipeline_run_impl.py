...
class PipelineRunImpl(BaseModel):
    ...
    links: Optional[PipelineRunImpllinks] = Field(default=None, alias="_links")
    ...
    __properties: ClassVar[List[str]] = ["_class", "_links", "durationInMillis", "enQueueTime", "endTime", "estimatedDurationInMillis", "id", "organization", "pipeline", "result", "runSummary", "startTime", "state", "type", "commitId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": PipelineRunImpllinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
