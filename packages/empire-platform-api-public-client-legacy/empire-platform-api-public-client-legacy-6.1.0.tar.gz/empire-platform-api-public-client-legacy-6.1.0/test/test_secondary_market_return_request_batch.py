...
from empire_platform_api_public_client_legacy.models.secondary_market_return_request_batch import SecondaryMarketReturnRequestBatch  # noqa: E501
    ...
    def make_instance(self, include_optional) -> SecondaryMarketReturnRequestBatch:
        ...
        if include_optional:
            return SecondaryMarketReturnRequestBatch(
                entries = [
                    empire_platform_api_public_client_legacy.models.secondary_market_return_request.SecondaryMarketReturnRequest(
                        id = '8d3787bb-b9ce-4d75-9a75-074ddd5d1e09', 
                        source_auction = empire_platform_api_public_client_legacy.models.source_auction_display_data.SourceAuctionDisplayData(
                            id = '8d3787bb-b9ce-4d75-9a75-074ddd5d1e09', 
                            display_id = 'BDL-NL-GB-E-BASE---220305-01', ), 
                        return_auction = empire_platform_api_public_client_legacy.models.return_auction.ReturnAuction(
                            id = '8d3787bb-b9ce-4d75-9a75-074ddd5d1e09', 
                            display_id = 'BDL-NL-GB-E-BASE---220305-01', 
                            direction = 'GB_NL', 
