...
def lazy_import():
    from sifflet_sdk.client.model.public_source_v2_athena_parameters_dto_all_of import (
        PublicSourceV2AthenaParametersDtoAllOf,
    )
    from sifflet_sdk.client.model.public_source_v2_parameters_dto import (
        PublicSourceV2ParametersDto,
    )

    globals()["PublicSourceV2AthenaParametersDtoAllOf"] = PublicSourceV2AthenaParametersDtoAllOf
    globals()["PublicSourceV2ParametersDto"] = PublicSourceV2ParametersDto


class PublicSourceV2AthenaParametersDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PublicSourceV2AthenaParametersDto - a model defined in OpenAPI

        Keyword Args:
            datasource (str): Your Athena data source name
            region (str): Your Athena instance AWS region
            role_arn (str): ARN of the IAM role to use for Athena queries
            s3_output_location (str): The S3 location where Athena query results are stored
            workgroup (str): Your Athena workgroup name
            type (str):
