...
SH_MV_DEFORM = vv.shaders.ShaderCodePart(
    "deform",
    "mesh",
    """
    >>--uniforms--
...
SH_3F_DEFORM = vv.shaders.ShaderCodePart(
    "deform",
    "3D",
    """
    >>--uniforms--
...
class DeformableTexture3D(vv.Texture3D, DeformableMixin):
    ...
    def _UpdateDeformShaderAfterSetDeforms(self, origin, sampling, shape):
        ...
        self.shader.SetStaticUniform("scaleBiasDeform", self._deformTexture._ScaleBias_get)
...
class DeformableMesh(vv.Mesh, DeformableMixin):
    ...
    def _UpdateDeformShaderAfterSetDeforms(self, origin, sampling, shape):
        ...
        for shader in [self.faceShader, self.shapeShader]:
            ...
            shader.SetStaticUniform("scaleBiasDeform", self._deformTexture._ScaleBias_get)
