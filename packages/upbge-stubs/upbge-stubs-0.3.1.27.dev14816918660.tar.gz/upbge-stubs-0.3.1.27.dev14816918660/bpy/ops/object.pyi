...
def grease_pencil_add(*args, type: str = 'EMPTY', use_in_front: bool = True, stroke_depth_offset: float = 0.05, use_lights: bool = False, stroke_depth_order: str = '3D', radius: float = 1.0, align: str = 'WORLD', location: mathutils.Vector = (0.0, 0.0, 0.0), rotation: mathutils.Euler = (0.0, 0.0, 0.0), scale: mathutils.Vector = (0.0, 0.0, 0.0)) -> None:
...
def link_to_collection(*args, collection_index: int = -1, is_new: bool = False, new_collection_name: str = '') -> None:
...
def move_to_collection(*args, collection_index: int = -1, is_new: bool = False, new_collection_name: str = '') -> None:
...
def multires_base_apply(*args, modifier: str = '') -> None:
...
def pointcloud_add(*args, align: str = 'WORLD', location: mathutils.Vector = (0.0, 0.0, 0.0), rotation: mathutils.Euler = (0.0, 0.0, 0.0), scale: mathutils.Vector = (0.0, 0.0, 0.0)) -> None:
...
def subdivision_set(*args, level: int = 1, relative: bool = False) -> None:
...
def transform_apply(*args, location: bool = True, rotation: bool = True, scale: bool = True, properties: bool = True, isolate_users: bool = False) -> None:
