                ...
                columns: [
                    {
                        ...
                        template: (data) => {
                            var _a;
                            const currentPath = ((_a = fileManagerRef.current) === null || _a === void 0 ? void 0 : _a.path) || '/';
                            ...
                            return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: "custom-name-cell" },
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: iconCss }),
                                data.name));
                        },
                    },
...
(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__.registerLicense)(config.license);
...
async function activate(app, settingRegistry) {
    ...
    const leftSideBarContent = new _widgets_FileManagerPanelWidget__WEBPACK_IMPORTED_MODULE_4__.FileManagerPanelWidget(downloadsFolder);
    const leftSideBarWidget = new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.MainAreaWidget({
        content: leftSideBarContent
    });
    leftSideBarWidget.id = 'filemanager-panel-widget';
    leftSideBarWidget.toolbar.hide();
    leftSideBarWidget.title.icon = _style_IconsStyle__WEBPACK_IMPORTED_MODULE_5__.telescopeIcon;
...
//# sourceMappingURL=lib_index_js.5a5145a6c7b523cbd22b.js.map