...
class SpotCreateOrderCancelReplaceV3FailResp(BaseModel):
    """
    SpotCreateOrderCancelReplaceV3FailResp
    """ # noqa: E501
    code: Optional[StrictInt] = None
    data: Optional[SpotCreateOrderCancelReplaceV3Data] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": SpotCreateOrderCancelReplaceV3Data.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "msg": obj.get("msg")
        })
        return _obj
