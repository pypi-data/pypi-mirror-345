...
class LiveToolsCableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ports: A list of ports for which to perform the cable test.
        """
...
class _LiveToolsCableState:
    def __init__(__self__, *,
                 cable_test_id: Optional[pulumi.Input[builtins.str]] = None,
                 callback: Optional[pulumi.Input['LiveToolsCableCallbackArgs']] = None,
        ...
        :param pulumi.Input[builtins.str] cable_test_id: Id of the cable test request. Used to check the status of the request.
        :param pulumi.Input['LiveToolsCableCallbackArgs'] callback: Details for the callback. Please include either an httpServerId OR url and sharedSecret
        ...
        :param pulumi.Input[builtins.str] serial: serial path parameter.
        :param pulumi.Input[builtins.str] status: Status of the cable test request.
        :param pulumi.Input[builtins.str] url: GET this url to check the status of your cable test request.
        """
    ...
    def cable_test_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cable_test_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LiveToolsCable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            serial: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'LiveToolsCable':
        """
    ...
    @property
    @pulumi.getter(name="cableTestId")
    def cable_test_id(self) -> pulumi.Output[builtins.str]:
        """
        Id of the cable test request. Used to check the status of the request.
        """
        return pulumi.get(self, "cable_test_id")
