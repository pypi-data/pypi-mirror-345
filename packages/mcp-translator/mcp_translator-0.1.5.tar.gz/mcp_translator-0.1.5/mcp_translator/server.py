...
# Import docling for docx/html conversion
...
async def start_translation(file_path: str) -> dict:
    ...
    try:
        ...
        elif file_extension in [".docx", ".html"]:
             logger.info(f"Processing {file_extension} file with docling: {absolute_file_path}")
             try:
                 converter = DocumentConverter()
                 result = converter.convert(absolute_file_path)
