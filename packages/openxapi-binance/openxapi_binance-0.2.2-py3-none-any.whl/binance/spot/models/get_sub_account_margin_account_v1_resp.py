...
class GetSubAccountMarginAccountV1Resp(BaseModel):
    """
    GetSubAccountMarginAccountV1Resp
    """ # noqa: E501
    email: Optional[StrictStr] = None
    margin_level: Optional[StrictStr] = Field(default=None, alias="marginLevel")
    margin_trade_coeff_vo: Optional[GetSubAccountMarginAccountV1RespMarginTradeCoeffVo] = Field(default=None, alias="marginTradeCoeffVo")
    margin_user_asset_vo_list: Optional[List[GetManagedSubaccountMarginAssetV1RespUserAssetsInner]] = Field(default=None, alias="marginUserAssetVoList")
    ...
    __properties: ClassVar[List[str]] = ["email", "marginLevel", "marginTradeCoeffVo", "marginUserAssetVoList", "totalAssetOfBtc", "totalLiabilityOfBtc", "totalNetAssetOfBtc"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "marginTradeCoeffVo": GetSubAccountMarginAccountV1RespMarginTradeCoeffVo.from_dict(obj["marginTradeCoeffVo"]) if obj.get("marginTradeCoeffVo") is not None else None,
            "marginUserAssetVoList": [GetManagedSubaccountMarginAssetV1RespUserAssetsInner.from_dict(_item) for _item in obj["marginUserAssetVoList"]] if obj.get("marginUserAssetVoList") is not None else None,
