...
class GetMarginAccountV1Resp(BaseModel):
    ...
    """ # noqa: E501
    asset: Optional[List[GetMarginAccountV1RespAssetInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "asset": [GetMarginAccountV1RespAssetInner.from_dict(_item) for _item in obj["asset"]] if obj.get("asset") is not None else None,
