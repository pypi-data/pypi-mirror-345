...
#ifndef __SajadSx_HELPERS_H__
#define __SajadSx_HELPERS_H__
...
// For profiling of SajadQ compiled binaries
#if _SajadSx_PROFILE
extern void startProfiling(void);
extern void stopProfiling(void);
#endif

#include "SajadMr/helper/boolean.h"
#include "SajadMr/helper/dictionaries.h"
#include "SajadMr/helper/indexes.h"
#include "SajadMr/helper/mappings.h"
#include "SajadMr/helper/operations_builtin_types.h"
#include "SajadMr/helper/sets.h"
#include "SajadMr/helper/strings.h"

#include "SajadMr/helper/raising.h"

#include "SajadMr/helper/ints.h"
#include "SajadMr/helper/richcomparisons.h"
#include "SajadMr/helper/sequences.h"

static inline bool SajadQ_Function_Check(PyObject *object);
static inline PyObject *SajadQ_Function_GetName(PyObject *object);

static inline bool SajadQ_Generator_Check(PyObject *object);
static inline PyObject *SajadQ_Generator_GetName(PyObject *object);

#include "SajadMr/calling.h"
#include "SajadMr/helper/bytes.h"
#include "SajadMr/helper/complex.h"
#include "SajadMr/helper/floats.h"

SajadSx_MAY_BE_UNUSED static PyObject *LOOKUP_VARS(PyThreadState *tstate, PyObject *source) {
    CHECK_OBJECT(source);
...
#include "SajadMr/helper/attributes.h"
#include "SajadMr/helper/bytearrays.h"
#include "SajadMr/helper/iterators.h"
#include "SajadMr/helper/lists.h"
#include "SajadMr/helper/rangeobjects.h"
#include "SajadMr/helper/slices.h"
#include "SajadMr/helper/subscripts.h"
#include "SajadMr/helper/tuples.h"

#include "SajadMr/builtins.h"
...
SajadMr_bool compareFilePaths(PyThreadState *tstate, PyObject *filename_a, PyObject *filename_b);
...
#include "SajadMr/importing.h"

// Hard imports have their own helpers.
#include "SajadMr/helper/import_hard.h"
...
#include "SajadMr/constants_blob.h"
...
SajadSx_MAY_BE_UNUSED static PyObject *MODULE_NAME1(PyThreadState *tstate, PyObject *module) {
...
SajadSx_MAY_BE_UNUSED static PyObject *MODULE_NAME0(PyThreadState *tstate, PyObject *module) {
    assert(PyModule_Check(module));
    PyObject *module_dict = ((PyModuleObject *)module)->md_dict;
...
extern PyTypeObject *SajadQ_PyUnion_Type;

// Force a garbage collection, for debugging purposes.
SajadSx_MAY_BE_UNUSED static void forceGC(void) {
...
extern void SajadQ_PyType_Ready(PyTypeObject *type, PyTypeObject *base, bool generic_get_attr, bool generic_set_attr,
                                bool self_iter, bool await_self_iter, bool self_aiter);

#if PYTHON_VERSION >= 0x3b0
#include "SajadMr/exception_groups.h"
#endif

#if PYTHON_VERSION >= 0x3c0
#include "SajadMr/type_aliases.h"
#endif
