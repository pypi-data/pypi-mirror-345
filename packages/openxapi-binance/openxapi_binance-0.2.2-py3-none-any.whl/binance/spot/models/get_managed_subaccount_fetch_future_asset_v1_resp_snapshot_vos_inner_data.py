...
class GetManagedSubaccountFetchFutureAssetV1RespSnapshotVosInnerData(BaseModel):
    """
    GetManagedSubaccountFetchFutureAssetV1RespSnapshotVosInnerData
    """ # noqa: E501
    assets: Optional[List[GetManagedSubaccountFetchFutureAssetV1RespSnapshotVosInnerDataAssetsInner]] = None
    position: Optional[List[GetManagedSubaccountFetchFutureAssetV1RespSnapshotVosInnerDataPositionInner]] = None
    __properties: ClassVar[List[str]] = ["assets", "position"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": [GetManagedSubaccountFetchFutureAssetV1RespSnapshotVosInnerDataAssetsInner.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None,
            "position": [GetManagedSubaccountFetchFutureAssetV1RespSnapshotVosInnerDataPositionInner.from_dict(_item) for _item in obj["position"]] if obj.get("position") is not None else None
        })
        return _obj
