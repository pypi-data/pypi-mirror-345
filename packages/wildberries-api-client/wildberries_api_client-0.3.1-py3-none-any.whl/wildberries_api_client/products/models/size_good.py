...
class SizeGood(object):
    ...
    def __init__(self, nm_id=None, size_id=None, vendor_code=None, price=None, currency_iso_code4217=None, discounted_price=None, club_discounted_price=None, discount=None, club_discount=None, tech_size_name=None, editable_size_price=None):  # noqa: E501
        ...
        self._club_discounted_price = None
        self._discount = None
        ...
        if club_discounted_price is not None:
            self.club_discounted_price = club_discounted_price
    ...
    def size_id(self):
        ...
        ID razmera. Mohno poluhit s pomohu metoda [Poluhenie spiska tovarov po artikulam](./work-with-products#tag/Ceny-i-skidki/paths/~1api~1v2~1list~1goods~1filter/get), pole `sizeID`. V metodah kontenta eto pole `chrtID`  # noqa: E501
    ...
    @property
    def club_discounted_price(self):
        """Gets the club_discounted_price of this SizeGood.  # noqa: E501

        cena so skidkoi, vkluhaa skidku WB Kluba  # noqa: E501

        :return: The club_discounted_price of this SizeGood.  # noqa: E501
        :rtype: float
        """
        return self._club_discounted_price

    @club_discounted_price.setter
    def club_discounted_price(self, club_discounted_price):
        """Sets the club_discounted_price of this SizeGood.

        cena so skidkoi, vkluhaa skidku WB Kluba  # noqa: E501

        :param club_discounted_price: The club_discounted_price of this SizeGood.  # noqa: E501
        :type: float
        """

        self._club_discounted_price = club_discounted_price
    ...
    def club_discount(self):
        """Gets the club_discount of this SizeGood.  # noqa: E501

        Skidka WB Kluba, %  # noqa: E501

        :return: The club_discount of this SizeGood.  # noqa: E501
        :rtype: int
        """
    ...
    def club_discount(self, club_discount):
        """Sets the club_discount of this SizeGood.

        Skidka WB Kluba, %  # noqa: E501

        :param club_discount: The club_discount of this SizeGood.  # noqa: E501
        :type: int
        """
