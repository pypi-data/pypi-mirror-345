...
class CustomUniverse(QuantConnect.Data.UniverseSelection.UserDefinedUniverse):
    ...
    def __init__(self, configuration: QuantConnect.Data.SubscriptionDataConfig, universe_settings: QuantConnect.Data.UniverseSelection.UniverseSettings, interval: datetime.timedelta, selector: typing.Callable[[datetime.datetime], typing.Iterable[str]]) -> None:
...
class ManualUniverse(QuantConnect.Data.UniverseSelection.UserDefinedUniverse):
    ...
    @overload
    def __init__(self, configuration: QuantConnect.Data.SubscriptionDataConfig, universe_settings: QuantConnect.Data.UniverseSelection.UniverseSettings, symbols: typing.Iterable[QuantConnect.Symbol]) -> None:
...
class ManualUniverseSelectionModel(QuantConnect.Algorithm.Framework.Selection.UniverseSelectionModel):
    ...
    @overload
    def __init__(self, symbols: typing.Iterable[QuantConnect.Symbol], universe_settings: QuantConnect.Data.UniverseSelection.UniverseSettings) -> None:
        """
...
class CustomUniverseSelectionModel(QuantConnect.Algorithm.Framework.Selection.UniverseSelectionModel):
    ...
    @overload
    def __init__(self, name: str, selector: typing.Callable[[datetime.datetime], typing.Iterable[str]]) -> None:
        """
        Initializes a new instance of the CustomUniverseSelectionModel class
        for Market.USA and SecurityType.Equity
        using the algorithm's universe settings
    ...
    @overload
    def __init__(self, security_type: QuantConnect.SecurityType, name: str, market: str, selector: typing.Callable[[datetime.datetime], typing.Iterable[str]], universe_settings: QuantConnect.Data.UniverseSelection.UniverseSettings, interval: datetime.timedelta) -> None:
        """
        Initializes a new instance of the CustomUniverseSelectionModel class
...
class FutureUniverseSelectionModel(QuantConnect.Algorithm.Framework.Selection.UniverseSelectionModel):
    ...
    @overload
    def __init__(self, refresh_interval: datetime.timedelta, future_chain_symbol_selector: typing.Callable[[datetime.datetime], typing.Iterable[QuantConnect.Symbol]], universe_settings: QuantConnect.Data.UniverseSelection.UniverseSettings) -> None:
        """
        Creates a new instance of FutureUniverseSelectionModel
...
class OpenInterestFutureUniverseSelectionModel(QuantConnect.Algorithm.Framework.Selection.FutureUniverseSelectionModel):
    ...
    @overload
    def __init__(self, algorithm: QuantConnect.Interfaces.IAlgorithm, future_chain_symbol_selector: typing.Callable[[datetime.datetime], typing.Iterable[QuantConnect.Symbol]], chain_contracts_lookup_limit: typing.Optional[int] = 6, results_limit: typing.Optional[int] = 1) -> None:
        """
        Creates a new instance of OpenInterestFutureUniverseSelectionModel
...
class FundamentalUniverseSelectionModel(QuantConnect.Algorithm.Framework.Selection.UniverseSelectionModel):
    ...
    @overload
    def __init__(self, market: str, selector: typing.Callable[[typing.Iterable[QuantConnect.Data.Fundamental.Fundamental]], typing.Iterable[QuantConnect.Symbol]], universe_settings: QuantConnect.Data.UniverseSelection.UniverseSettings = None) -> None:
        """
        Initializes a new instance of the FundamentalUniverseSelectionModel class
    ...
    @overload
    def __init__(self, selector: typing.Callable[[typing.Iterable[QuantConnect.Data.Fundamental.Fundamental]], typing.Iterable[QuantConnect.Symbol]], universe_settings: QuantConnect.Data.UniverseSelection.UniverseSettings = None) -> None:
        """
        Initializes a new instance of the FundamentalUniverseSelectionModel class
    ...
    @staticmethod
    def coarse(coarse_selector: typing.Callable[[typing.Iterable[QuantConnect.Data.UniverseSelection.CoarseFundamental]], typing.Iterable[QuantConnect.Symbol]]) -> QuantConnect.Algorithm.Framework.Selection.IUniverseSelectionModel:
        """
    ...
    @staticmethod
    def fine(coarse_selector: typing.Callable[[typing.Iterable[QuantConnect.Data.UniverseSelection.CoarseFundamental]], typing.Iterable[QuantConnect.Symbol]], fine_selector: typing.Callable[[typing.Iterable[QuantConnect.Data.Fundamental.FineFundamental]], typing.Iterable[QuantConnect.Symbol]]) -> QuantConnect.Algorithm.Framework.Selection.IUniverseSelectionModel:
        """
    ...
    @staticmethod
    def fundamental(selector: typing.Callable[[typing.Iterable[QuantConnect.Data.Fundamental.Fundamental]], typing.Iterable[QuantConnect.Symbol]]) -> QuantConnect.Algorithm.Framework.Selection.IUniverseSelectionModel:
        """
...
class CoarseFundamentalUniverseSelectionModel(QuantConnect.Algorithm.Framework.Selection.FundamentalUniverseSelectionModel):
    ...
    @overload
    def __init__(self, coarse_selector: typing.Callable[[typing.Iterable[QuantConnect.Data.UniverseSelection.CoarseFundamental]], typing.Iterable[QuantConnect.Symbol]], universe_settings: QuantConnect.Data.UniverseSelection.UniverseSettings = None) -> None:
        """
        Initializes a new instance of the CoarseFundamentalUniverseSelectionModel class
...
class ScheduledUniverseSelectionModel(QuantConnect.Algorithm.Framework.Selection.UniverseSelectionModel):
    ...
    @overload
    def __init__(self, time_zone: typing.Any, date_rule: QuantConnect.Scheduling.IDateRule, time_rule: QuantConnect.Scheduling.ITimeRule, selector: typing.Callable[[datetime.datetime], typing.Iterable[QuantConnect.Symbol]], settings: QuantConnect.Data.UniverseSelection.UniverseSettings = None) -> None:
        """
    ...
    @overload
    def __init__(self, date_rule: QuantConnect.Scheduling.IDateRule, time_rule: QuantConnect.Scheduling.ITimeRule, selector: typing.Callable[[datetime.datetime], typing.Iterable[QuantConnect.Symbol]], settings: QuantConnect.Data.UniverseSelection.UniverseSettings = None) -> None:
        """
        Initializes a new instance of the ScheduledUniverseSelectionModel class using the algorithm's time zone
...
class OptionUniverseSelectionModel(QuantConnect.Algorithm.Framework.Selection.UniverseSelectionModel):
    ...
    @overload
    def __init__(self, refresh_interval: datetime.timedelta, option_chain_symbol_selector: typing.Callable[[datetime.datetime], typing.Iterable[QuantConnect.Symbol]], universe_settings: QuantConnect.Data.UniverseSelection.UniverseSettings) -> None:
        """
        Creates a new instance of OptionUniverseSelectionModel
...
class ETFConstituentsUniverseSelectionModel(QuantConnect.Algorithm.Framework.Selection.UniverseSelectionModel):
    ...
    @overload
    def __init__(self, etf_symbol: typing.Union[QuantConnect.Symbol, str, QuantConnect.Data.Market.BaseContract], universe_filter_func: typing.Callable[[typing.Iterable[QuantConnect.Data.UniverseSelection.ETFConstituentUniverse]], typing.Iterable[QuantConnect.Symbol]]) -> None:
        """
        Initializes a new instance of the ETFConstituentsUniverseSelectionModel class
    ...
    @overload
    def __init__(self, etf_ticker: str, universe_settings: QuantConnect.Data.UniverseSelection.UniverseSettings, universe_filter_func: typing.Callable[[typing.Iterable[QuantConnect.Data.UniverseSelection.ETFConstituentUniverse]], typing.Iterable[QuantConnect.Symbol]]) -> None:
        """
        Initializes a new instance of the ETFConstituentsUniverseSelectionModel class
    ...
    @overload
    def __init__(self, etf_ticker: str, universe_filter_func: typing.Callable[[typing.Iterable[QuantConnect.Data.UniverseSelection.ETFConstituentUniverse]], typing.Iterable[QuantConnect.Symbol]]) -> None:
        """
        Initializes a new instance of the ETFConstituentsUniverseSelectionModel class
...
class FineFundamentalUniverseSelectionModel(QuantConnect.Algorithm.Framework.Selection.FundamentalUniverseSelectionModel):
    ...
    @overload
    def __init__(self, coarse_selector: typing.Callable[[typing.Iterable[QuantConnect.Data.UniverseSelection.CoarseFundamental]], typing.Iterable[QuantConnect.Symbol]], fine_selector: typing.Callable[[typing.Iterable[QuantConnect.Data.Fundamental.FineFundamental]], typing.Iterable[QuantConnect.Symbol]], universe_settings: QuantConnect.Data.UniverseSelection.UniverseSettings = None) -> None:
        """
        Initializes a new instance of the FineFundamentalUniverseSelectionModel class
...
class LiquidETFUniverse(QuantConnect.Algorithm.Framework.Selection.InceptionDateUniverseSelectionModel):
    ...
    class Grouping(typing.List[QuantConnect.Symbol]):
        ...
        def __init__(self, long_tickers: typing.Iterable[str], inverse_tickers: typing.Iterable[str]) -> None:
            """
