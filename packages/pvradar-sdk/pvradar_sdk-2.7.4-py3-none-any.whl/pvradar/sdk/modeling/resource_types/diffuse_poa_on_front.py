...
class diffuse_poa_on_front(ResourceTypeDescriptor):
    """The total diffuse solar irradiance incident on the front side of a photovoltaic (PV) module, adjusted for the module’s orientation and tilt"""
