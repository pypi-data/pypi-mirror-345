...
# Build the wheels for both architectures
log "Building Python wheels for x86_64 and arm64..."

# Build x86_64 wheel
log "Building x86_64 wheel..."
maturin build --release --target x86_64-unknown-linux-gnu

# Build arm64 wheel
log "Building arm64 wheel..."
...
log "Publishing x86_64 wheel..."
maturin publish $PUBLISH_FLAG $SKIP_EXISTING --target x86_64-unknown-linux-gnu

log "Publishing arm64 wheel..."
maturin publish $PUBLISH_FLAG $SKIP_EXISTING --target aarch64-unknown-linux-gnu

log "Package published successfully for both architectures!" 