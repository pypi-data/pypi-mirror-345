...
def test_cudaawkward_ListArray64_getitem_next_at_64_1():
    ...
    lenstarts = 3
    at = 0
    funcC = cupy_backend['awkward_ListArray_getitem_next_at', cupy.int64, cupy.int64, cupy.int64]
...
def test_cudaawkward_ListArray64_getitem_next_at_64_2():
