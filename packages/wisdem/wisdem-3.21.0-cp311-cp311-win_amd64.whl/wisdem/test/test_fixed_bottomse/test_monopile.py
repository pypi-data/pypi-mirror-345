...
class TestMonopileSE(unittest.TestCase):
    ...
    def testExampleRegression(self):
        ...
        npt.assert_almost_equal(
            ...
            [
                [0.03629343, 0.01790444, 0.1231257 , 0.13828851, 0.05543313, 0.0103132 ],
                [0.03660269, 0.02187838, 0.09140849, 0.11723732, 0.04804845, 0.01055353],
           ],
            3,
        )
        npt.assert_almost_equal(
        ...
        npt.assert_almost_equal(
            ...
            [
                [3.49559758e-03, 1.30133175e-03, 5.91065050e-01, 1.76189058e+00, 6.40073292e-01, 8.86263584e-02],
                [3.54514895e-03, 1.57721535e-03, 5.79699748e-01, 1.75253288e+00, 6.36853374e-01, 9.12750706e-02],
            ],
            3,
        )
        ...
        npt.assert_almost_equal(
            prob["post.constr_global_buckling"].T,
            [
                [3.94666251e-02, 4.87423322e-02, 1.14742952e-01, 9.36498331e-02, 4.89077185e-02, 2.23941975e-10],
                [3.27614138e-02, 3.33555347e-02, 4.97277191e-02, 4.43681620e-02, 3.14888158e-02, 6.58549177e-11],
            ],
            1,
        )
        npt.assert_almost_equal(
            prob["post.constr_shell_buckling"].T,
            [
                [0.0395443 , 0.04453798, 0.57195478, 1.74908189, 0.82858381, 0.16249937],
                [0.03915959, 0.04162512, 0.56193478, 1.73429118, 0.81353285, 0.16628148],
            ],
            2,
        )
        npt.assert_almost_equal(prob["monopile.mudline_F"][0, :], [1284992.14390681,  930371.37678699], 2)
