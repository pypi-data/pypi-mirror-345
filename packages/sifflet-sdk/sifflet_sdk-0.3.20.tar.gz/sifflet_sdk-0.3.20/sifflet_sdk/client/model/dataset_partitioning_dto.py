...
def lazy_import():
    from sifflet_sdk.client.model.dataset_partitioning_dto_properties import (
        DatasetPartitioningDtoProperties,
    )

    globals()["DatasetPartitioningDtoProperties"] = DatasetPartitioningDtoProperties


class DatasetPartitioningDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "properties": (DatasetPartitioningDtoProperties,),  # noqa: E501
    ...
    def _from_openapi_data(cls, properties, *args, **kwargs):  # noqa: E501
        """DatasetPartitioningDto - a model defined in OpenAPI

        Args:
            properties (DatasetPartitioningDtoProperties):
