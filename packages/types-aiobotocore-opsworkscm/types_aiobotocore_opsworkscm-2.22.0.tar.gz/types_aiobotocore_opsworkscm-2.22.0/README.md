...
[![PyPI - Downloads](https://static.pepy.tech/badge/types-aiobotocore-opsworkscm)](https://pypistats.org/packages/types-aiobotocore-opsworkscm)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[aiobotocore OpsWorksCM 2.22.0](https://pypi.org/project/aiobotocore/)
...
`types-aiobotocore-opsworkscm` dependency in production. However, there is an
