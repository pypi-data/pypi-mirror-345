...
class GetCmLeverageBracketV1RespItemBracketsInner(BaseModel):
    """
    ...
    qty_floor: Optional[StrictInt] = Field(default=None, alias="qtyFloor")
    __properties: ClassVar[List[str]] = ["bracket", "cum", "initialLeverage", "maintMarginRatio", "qtyCap", "qtyFloor"]
