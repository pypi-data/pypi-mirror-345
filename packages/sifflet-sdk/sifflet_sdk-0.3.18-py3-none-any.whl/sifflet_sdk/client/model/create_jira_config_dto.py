...
class CreateJiraConfigDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, api_token, login, url, *args, **kwargs):  # noqa: E501
        """CreateJiraConfigDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, api_token, login, url, *args, **kwargs):  # noqa: E501
        """CreateJiraConfigDto - a model defined in OpenAPI
