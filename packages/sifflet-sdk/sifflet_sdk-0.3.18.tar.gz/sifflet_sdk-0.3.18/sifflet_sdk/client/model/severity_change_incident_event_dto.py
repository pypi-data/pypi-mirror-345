...
def lazy_import():
    ...
    from sifflet_sdk.client.model.severity_change_incident_event_dto_all_of import (
        SeverityChangeIncidentEventDtoAllOf,
    )
    from sifflet_sdk.client.model.user_dto import UserDto

    globals()["IncidentEventDto"] = IncidentEventDto
    globals()["SeverityChangeIncidentEventDtoAllOf"] = SeverityChangeIncidentEventDtoAllOf
    globals()["UserDto"] = UserDto


class SeverityChangeIncidentEventDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SeverityChangeIncidentEventDto - a model defined in OpenAPI
