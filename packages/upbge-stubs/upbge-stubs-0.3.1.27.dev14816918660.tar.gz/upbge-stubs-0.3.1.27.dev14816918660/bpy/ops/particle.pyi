...
def brush_edit(*args, stroke: typing.Union[typing.Sequence[OperatorStrokeElement], typing.Mapping[str, OperatorStrokeElement], bpy.types.bpy_prop_collection] = None, pen_flip: bool = False) -> None:
...
def connect_hair(*args, all: bool = False) -> None:
...
def copy_particle_systems(*args, space: str = 'OBJECT', remove_target_particles: bool = True, use_active: bool = False) -> None:
...
def delete(*args, type: str = 'PARTICLE') -> None:
...
def disconnect_hair(*args, all: bool = False) -> None:
...
def duplicate_particle_system(*args, use_duplicate_settings: bool = False) -> None:
...
def hair_dynamics_preset_add(*args, name: str = '', remove_name: bool = False, remove_active: bool = False) -> None:
...
def rekey(*args, keys_number: int = 2) -> None:
...
def remove_doubles(*args, threshold: float = 0.0002) -> None:
...
def select_linked_pick(*args, deselect: bool = False, location: typing.Tuple[int, int] = (0, 0)) -> None:
...
def select_random(*args, ratio: float = 0.5, seed: int = 0, action: str = 'SELECT', type: str = 'HAIR') -> None:
...
def select_roots(*args, action: str = 'SELECT') -> None:
...
def select_tips(*args, action: str = 'SELECT') -> None:
...
def weight_set(*args, factor: float = 1.0) -> None:
