...
class IApprovalAmounts(BaseModel):
    """
    IApprovalAmounts
    """ # noqa: E501
    overall_approval_amount: NumberType = Field(description="The overall maximum amount approved for the badgeIDs and ownershipTimes. Running tally that includes all transfers that match this approval.", alias="overallApprovalAmount")
    per_to_address_approval_amount: NumberType = Field(description="The maximum amount approved for the badgeIDs and ownershipTimes for each to address. Running tally that includes all transfers from each unique to address that match this approval.", alias="perToAddressApprovalAmount")
    per_from_address_approval_amount: NumberType = Field(description="The maximum amount approved for the badgeIDs and ownershipTimes for each from address. Running tally that includes all transfers from each unique from address that match this approval.", alias="perFromAddressApprovalAmount")
    per_initiated_by_address_approval_amount: NumberType = Field(description="The maximum amount approved for the badgeIDs and ownershipTimes for each initiated by address. Running tally that includes all transfers from each unique initiated by address that match this approval.", alias="perInitiatedByAddressApprovalAmount")
    ...
    __properties: ClassVar[List[str]] = ["overallApprovalAmount", "perToAddressApprovalAmount", "perFromAddressApprovalAmount", "perInitiatedByAddressApprovalAmount", "amountTrackerId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IApprovalAmounts from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of overall_approval_amount
        if self.overall_approval_amount:
            _dict['overallApprovalAmount'] = self.overall_approval_amount.to_dict()
        # override the default output from pydantic by calling `to_dict()` of per_to_address_approval_amount
        if self.per_to_address_approval_amount:
            _dict['perToAddressApprovalAmount'] = self.per_to_address_approval_amount.to_dict()
        # override the default output from pydantic by calling `to_dict()` of per_from_address_approval_amount
        if self.per_from_address_approval_amount:
            _dict['perFromAddressApprovalAmount'] = self.per_from_address_approval_amount.to_dict()
        # override the default output from pydantic by calling `to_dict()` of per_initiated_by_address_approval_amount
        if self.per_initiated_by_address_approval_amount:
            _dict['perInitiatedByAddressApprovalAmount'] = self.per_initiated_by_address_approval_amount.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IApprovalAmounts from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "overallApprovalAmount": NumberType.from_dict(obj["overallApprovalAmount"]) if obj.get("overallApprovalAmount") is not None else None,
            "perToAddressApprovalAmount": NumberType.from_dict(obj["perToAddressApprovalAmount"]) if obj.get("perToAddressApprovalAmount") is not None else None,
            "perFromAddressApprovalAmount": NumberType.from_dict(obj["perFromAddressApprovalAmount"]) if obj.get("perFromAddressApprovalAmount") is not None else None,
            "perInitiatedByAddressApprovalAmount": NumberType.from_dict(obj["perInitiatedByAddressApprovalAmount"]) if obj.get("perInitiatedByAddressApprovalAmount") is not None else None,
