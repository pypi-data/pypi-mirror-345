...
#ifndef __SajadSx_COMPILED_GENERATOR_H__
#define __SajadSx_COMPILED_GENERATOR_H__
...
// The SajadQ_GeneratorObject is the storage associated with a compiled
// generator object instance of which there can be many for each code.
struct SajadQ_GeneratorObject {
...
#if PYTHON_VERSION >= 0x300
    struct SajadQ_ExceptionStackItem m_resume_exception;
#endif
...
extern PyTypeObject SajadQ_Generator_Type;

typedef PyObject *(*generator_code)(PyThreadState *tstate, struct SajadQ_GeneratorObject *, PyObject *);

extern PyObject *SajadQ_Generator_New(generator_code code, PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                      PyObject *qualname,
#endif
...
extern PyObject *SajadQ_Generator_NewEmpty(PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                           PyObject *qualname,
#endif
                                           PyCodeObject *code_object, struct SajadQ_CellObject **closure,
...
extern PyObject *SajadQ_Generator_qiter(PyThreadState *tstate, struct SajadQ_GeneratorObject *generator,
                                        bool *finished);

static inline bool SajadQ_Generator_Check(PyObject *object) { return Py_TYPE(object) == &SajadQ_Generator_Type; }

static inline PyObject *SajadQ_Generator_GetName(PyObject *object) {
    return ((struct SajadQ_GeneratorObject *)object)->m_name;
}

static inline void SAVE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct SajadQ_GeneratorObject *generator) {
...
static inline void RESTORE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct SajadQ_GeneratorObject *generator) {
...
extern void SajadQ_PreserveHeap(void *dest, ...);
extern void SajadQ_RestoreHeap(void *source, ...);

SajadSx_MAY_BE_UNUSED static void STORE_GENERATOR_EXCEPTION(PyThreadState *tstate,
...
SajadSx_MAY_BE_UNUSED static void DROP_GENERATOR_EXCEPTION(struct SajadQ_GeneratorObject *generator) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_SajadQ_Generator_Type;
extern int count_allocated_SajadQ_Generator_Type;
extern int count_released_SajadQ_Generator_Type;
#endif
