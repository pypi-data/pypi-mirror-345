...
class SmUserAccessDevicesDeleteArgs:
    def __init__(__self__, *,
                 ...
                 user_access_device_id: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] user_access_device_id: userAccessDeviceId path parameter. User access device ID
        """
    ...
    def user_access_device_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def user_access_device_id(self, value: pulumi.Input[builtins.str]):
...
class _SmUserAccessDevicesDeleteState:
    def __init__(__self__, *,
                 ...
                 user_access_device_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="userAccessDeviceId")
    def user_access_device_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        userAccessDeviceId path parameter. User access device ID
        """
        return pulumi.get(self, "user_access_device_id")
    ...
    @user_access_device_id.setter
    def user_access_device_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_access_device_id", value)
...
class SmUserAccessDevicesDelete(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            network_id: Optional[pulumi.Input[builtins.str]] = None,
            user_access_device_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SmUserAccessDevicesDelete':
        """
    ...
    @property
    @pulumi.getter(name="userAccessDeviceId")
    def user_access_device_id(self) -> pulumi.Output[builtins.str]:
        """
        userAccessDeviceId path parameter. User access device ID
        """
        return pulumi.get(self, "user_access_device_id")
