...
class ApplianceWarmSpareArgs:
    def __init__(__self__, *,
                 ...
                 spare_serial: Optional[pulumi.Input[builtins.str]] = None,
                 uplink_mode: Optional[pulumi.Input[builtins.str]] = None,
                 virtual_ip1: Optional[pulumi.Input[builtins.str]] = None,
                 virtual_ip2: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] enabled: Enable warm spare
        :param pulumi.Input[builtins.str] spare_serial: Serial number of the warm spare appliance
        :param pulumi.Input[builtins.str] uplink_mode: Uplink mode, either virtual or public
        :param pulumi.Input[builtins.str] virtual_ip1: The WAN 1 shared IP
        :param pulumi.Input[builtins.str] virtual_ip2: The WAN 2 shared IP
        """
    ...
    def spare_serial(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @spare_serial.setter
    def spare_serial(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "spare_serial", value)

    @property
    @pulumi.getter(name="uplinkMode")
    def uplink_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @uplink_mode.setter
    def uplink_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "uplink_mode", value)

    @property
    @pulumi.getter(name="virtualIp1")
    def virtual_ip1(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The WAN 1 shared IP
        """
    ...
    @virtual_ip1.setter
    def virtual_ip1(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "virtual_ip1", value)

    @property
    @pulumi.getter(name="virtualIp2")
    def virtual_ip2(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The WAN 2 shared IP
        """
    ...
    @virtual_ip2.setter
    def virtual_ip2(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ApplianceWarmSpareState:
    def __init__(__self__, *,
                 ...
                 primary_serial: Optional[pulumi.Input[builtins.str]] = None,
                 spare_serial: Optional[pulumi.Input[builtins.str]] = None,
                 uplink_mode: Optional[pulumi.Input[builtins.str]] = None,
                 virtual_ip1: Optional[pulumi.Input[builtins.str]] = None,
                 virtual_ip2: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def primary_serial(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "primary_serial")

    @primary_serial.setter
    def primary_serial(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ApplianceWarmSpare(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="primarySerial")
    def primary_serial(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "primary_serial")

    @property
    @pulumi.getter(name="spareSerial")
    def spare_serial(self) -> pulumi.Output[builtins.str]:
        """
        Serial number of the warm spare appliance
        """
        return pulumi.get(self, "spare_serial")
    ...
    @property
    @pulumi.getter(name="uplinkMode")
    def uplink_mode(self) -> pulumi.Output[builtins.str]:
        """
        Uplink mode, either virtual or public
        """
        return pulumi.get(self, "uplink_mode")
    ...
    @property
    @pulumi.getter(name="virtualIp1")
    def virtual_ip1(self) -> pulumi.Output[builtins.str]:
        """
        The WAN 1 shared IP
        """
        return pulumi.get(self, "virtual_ip1")
    ...
    @property
    @pulumi.getter(name="virtualIp2")
    def virtual_ip2(self) -> pulumi.Output[builtins.str]:
        """
        The WAN 2 shared IP
        """
        return pulumi.get(self, "virtual_ip2")
