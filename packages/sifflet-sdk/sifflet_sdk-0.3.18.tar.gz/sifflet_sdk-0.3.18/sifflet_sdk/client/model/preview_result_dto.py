...
class PreviewResultDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, results, success, *args, **kwargs):  # noqa: E501
        """PreviewResultDto - a model defined in OpenAPI

        Args:
            results ([{str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)}]):
            success (bool):
    ...
    @convert_js_args_to_python_args
    def __init__(self, results, success, *args, **kwargs):  # noqa: E501
        """PreviewResultDto - a model defined in OpenAPI
