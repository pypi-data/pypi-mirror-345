"""
The wntrfr.network.base module includes base classes for network elements and 
the network model.
"""
import logging
import six
...
class Node(six.with_metaclass(abc.ABCMeta, object)):
    ...
    :class:`~wntrfr.network.elements.Junction`, 
    :class:`~wntrfr.network.elements.Tank`, and
    :class:`~wntrfr.network.elements.Reservoir`
...
class Link(six.with_metaclass(abc.ABCMeta, object)):
    ...
    For details about the different subclasses, see one of the following:
    :class:`~wntrfr.network.elements.Pipe`, 
    :class:`~wntrfr.network.elements.Pump`, and
    :class:`~wntrfr.network.elements.Valve`
    ...
    def initial_status(self):
        """:class:`~wntrfr.network.base.LinkStatus`: The initial status (`Opened`, `Closed`, `Active`) of the Link"""
    ...
    @property
    def start_node(self):
        """:class:`~wntrfr.network.base.Node`: The start node object."""
    ...
    @property
    def end_node(self):
        """:class:`~wntrfr.network.base.Node`: The end node object."""
    ...
    @abc.abstractmethod
    def status(self):
        """:class:`~wntrfr.network.base.LinkStatus`: (**abstract**) current status of the link"""
        pass
    @status.setter
    # @abc.abstractmethod
...
class LinkStatus(enum.IntEnum):
    ...
    .. warning::
        ...
        The class for output status is wntrfr.epanet.util.LinkTankStatus.
