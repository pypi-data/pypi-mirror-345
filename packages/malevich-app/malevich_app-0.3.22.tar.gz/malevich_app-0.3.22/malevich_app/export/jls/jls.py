...
def input_doc(id: Optional[str] = None, collection_from: Optional[str] = None, collections_from: Optional[List[str]] = None, extra_collection_from: Optional[str] = None, extra_collections_from: Optional[List[str]] = None, query: Optional[str] = None, finish_msg: Optional[str] = None, cpu_bound: bool = False, tags: Dict[str, str] = None, **kwargs):
    def wrap_input(fun):
...
def input_true(id: Optional[str] = None, collection_from: Optional[str] = None, collections_from: Optional[List[str]] = None, extra_collection_from: Optional[str] = None, extra_collections_from: Optional[List[str]] = None, query: Optional[str] = None, finish_msg: Optional[str] = None, cpu_bound: bool = False, tags: Dict[str, str] = None, **kwargs):
    def wrap_input(fun):
...
def processor(id: Optional[str] = None, finish_msg: Optional[str] = None, drop_internal: bool = True, get_scale_part_all: bool = False, cpu_bound: bool = False, tags: Dict[str, str] = None, is_stream: bool = False, **kwargs):
    def wrap_input(fun):
        Wrapper.app.register_processor(fun, id, finish_msg=finish_msg, cpu_bound=cpu_bound, is_stream=is_stream, tags=__tags(tags, **kwargs), drop_internal=drop_internal, get_scale_part_all=get_scale_part_all)
        return fun
    return wrap_input


def output(id: Optional[str] = None, collection_name: Optional[str] = None, collection_names: Optional[List[str]] = None, finish_msg: Optional[str] = None, drop_internal: bool = True, cpu_bound: bool = False, tags: Dict[str, str] = None, **kwargs):
    def wrap_output(fun):
...
def condition(id: Optional[str] = None, finish_msg: Optional[str] = None, drop_internal: bool = True, cpu_bound: bool = False, tags: Dict[str, str] = None, **kwargs):
...
def init(id: Optional[str] = None, enable: bool = True, tl: Optional[int] = None, prepare: bool = False, cpu_bound: bool = False, tags: Dict[str, str] = None, **kwargs):
    def wrap_init(fun):
