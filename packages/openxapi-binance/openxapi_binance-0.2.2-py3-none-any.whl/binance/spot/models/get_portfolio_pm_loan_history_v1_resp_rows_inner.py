...
class GetPortfolioPmLoanHistoryV1RespRowsInner(BaseModel):
    """
    GetPortfolioPmLoanHistoryV1RespRowsInner
    """ # noqa: E501
    amount: Optional[StrictStr] = None
    asset: Optional[StrictStr] = None
    repay_time: Optional[StrictInt] = Field(default=None, alias="repayTime")
    __properties: ClassVar[List[str]] = ["amount", "asset", "repayTime"]
