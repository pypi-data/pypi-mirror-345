...
class V3SuppliesBody(object):
    ...
    def __init__(self, name=None):  # noqa: E501
        """V3SuppliesBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this V3SuppliesBody.  # noqa: E501

        Naimenovanie postavki  # noqa: E501

        :return: The name of this V3SuppliesBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this V3SuppliesBody.

        Naimenovanie postavki  # noqa: E501

        :param name: The name of this V3SuppliesBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V3SuppliesBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V3SuppliesBody):
            return False
