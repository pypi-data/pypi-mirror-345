...
__all__ = ['ServiceLanVpnFeatureAssociateRoutingEigrpFeatureArgs', 'ServiceLanVpnFeatureAssociateRoutingEigrpFeature']

@pulumi.input_type
class ServiceLanVpnFeatureAssociateRoutingEigrpFeatureArgs:
    def __init__(__self__, *,
                 feature_profile_id: pulumi.Input[builtins.str],
                 service_lan_vpn_feature_id: pulumi.Input[builtins.str],
                 service_routing_eigrp_feature_id: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] service_routing_eigrp_feature_id: Service Routing EIGRP Feature ID
        """
    ...
    def service_routing_eigrp_feature_id(self) -> pulumi.Input[builtins.str]:
        """
        Service Routing EIGRP Feature ID
        """
        return pulumi.get(self, "service_routing_eigrp_feature_id")

    @service_routing_eigrp_feature_id.setter
    def service_routing_eigrp_feature_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "service_routing_eigrp_feature_id", value)


@pulumi.input_type
class _ServiceLanVpnFeatureAssociateRoutingEigrpFeatureState:
    def __init__(__self__, *,
                 feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
                 service_lan_vpn_feature_id: Optional[pulumi.Input[builtins.str]] = None,
                 service_routing_eigrp_feature_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="serviceRoutingEigrpFeatureId")
    def service_routing_eigrp_feature_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Service Routing EIGRP Feature ID
        """
        return pulumi.get(self, "service_routing_eigrp_feature_id")
    ...
    @service_routing_eigrp_feature_id.setter
    def service_routing_eigrp_feature_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_routing_eigrp_feature_id", value)
...
class ServiceLanVpnFeatureAssociateRoutingEigrpFeature(pulumi.CustomResource):
    ...
    pulumi_type = "sdwan:index/serviceLanVpnFeatureAssociateRoutingEigrpFeature:ServiceLanVpnFeatureAssociateRoutingEigrpFeature"
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ServiceLanVpnFeatureAssociateRoutingEigrpFeatureArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServiceLanVpnFeatureAssociateRoutingEigrpFeatureArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServiceLanVpnFeatureAssociateRoutingEigrpFeatureArgs.__new__(ServiceLanVpnFeatureAssociateRoutingEigrpFeatureArgs)
    ...
    def get(resource_name: str,
            ...
            service_lan_vpn_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            service_routing_eigrp_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'ServiceLanVpnFeatureAssociateRoutingEigrpFeature':
        """
        ...
        __props__ = _ServiceLanVpnFeatureAssociateRoutingEigrpFeatureState.__new__(_ServiceLanVpnFeatureAssociateRoutingEigrpFeatureState)
    ...
    @property
    @pulumi.getter(name="serviceRoutingEigrpFeatureId")
    def service_routing_eigrp_feature_id(self) -> pulumi.Output[builtins.str]:
        """
        Service Routing EIGRP Feature ID
        """
        return pulumi.get(self, "service_routing_eigrp_feature_id")
