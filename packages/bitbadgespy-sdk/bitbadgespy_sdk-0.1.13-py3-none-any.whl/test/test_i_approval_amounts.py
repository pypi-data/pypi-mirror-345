...
class TestIApprovalAmounts(unittest.TestCase):
    """IApprovalAmounts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IApprovalAmounts:
        """Test IApprovalAmounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IApprovalAmounts`
        """
        model = IApprovalAmounts()
        if include_optional:
            return IApprovalAmounts(
                overall_approval_amount = None,
                per_to_address_approval_amount = None,
                per_from_address_approval_amount = None,
                per_initiated_by_address_approval_amount = None,
                amount_tracker_id = ''
            )
        else:
            return IApprovalAmounts(
