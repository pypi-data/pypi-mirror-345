...
def lazy_import():
    from sifflet_sdk.client.model.public_dbt_cloud_parameters_dto_all_of import (
        PublicDbtCloudParametersDtoAllOf,
    )
    from sifflet_sdk.client.model.public_source_parameters_dto import (
        PublicSourceParametersDto,
    )

    globals()["PublicDbtCloudParametersDtoAllOf"] = PublicDbtCloudParametersDtoAllOf
    globals()["PublicSourceParametersDto"] = PublicSourceParametersDto


class PublicDbtCloudParametersDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PublicDbtCloudParametersDto - a model defined in OpenAPI

        Keyword Args:
            account_id (str): Your dbt Cloud account ID
            base_url (str): Your dbt Cloud base URL
            project_id (str): Your dbt Cloud project ID
            type (str):
