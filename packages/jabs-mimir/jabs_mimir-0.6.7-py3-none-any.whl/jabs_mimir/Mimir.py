...
class Mimir:
    ...
    def renderBlockUI(self, container, fields, blockList, layout="horizontal", meta=None, label=None, noRemove=False, fullwidth=False):
        """
        ...
        Args:
            ...
            fullwidth (bool): If True and layout is "vertical", block expands horizontally.
        ...
        if layout == "vertical":
            ...
            # Main improvement: expandable frame
            sticky_mode = "nsew" if fullwidth else "n"
            frame.grid(row=row, column=0, padx=10, pady=10, sticky=sticky_mode)
        ...
        # Allow internal row layout and weight
    ...
    def addTabbedView(self, tabs, parent=None, row=0, column=0, columnspan=1, rowspan=1, sticky="nsew", fit=True, background="#f8f9fa"):
        """
