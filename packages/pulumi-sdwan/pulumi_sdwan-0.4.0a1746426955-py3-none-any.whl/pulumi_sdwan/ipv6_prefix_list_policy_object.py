...
__all__ = ['Ipv6PrefixListPolicyObjectArgs', 'Ipv6PrefixListPolicyObject']
...
class Ipv6PrefixListPolicyObject(pulumi.CustomResource):

    pulumi_type = "sdwan:index/ipv6PrefixListPolicyObject:Ipv6PrefixListPolicyObject"
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param Ipv6PrefixListPolicyObjectArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Ipv6PrefixListPolicyObjectArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = Ipv6PrefixListPolicyObjectArgs.__new__(Ipv6PrefixListPolicyObjectArgs)
        ...
        super(Ipv6PrefixListPolicyObject, __self__).__init__(
            'sdwan:index/ipv6PrefixListPolicyObject:Ipv6PrefixListPolicyObject',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            entries: Optional[pulumi.Input[Sequence[pulumi.Input[Union['Ipv6PrefixListPolicyObjectEntryArgs', 'Ipv6PrefixListPolicyObjectEntryArgsDict']]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'Ipv6PrefixListPolicyObject':
        """
        ...
        __props__ = _Ipv6PrefixListPolicyObjectState.__new__(_Ipv6PrefixListPolicyObjectState)
