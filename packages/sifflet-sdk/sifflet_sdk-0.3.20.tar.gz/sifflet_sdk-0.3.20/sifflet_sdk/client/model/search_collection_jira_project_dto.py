...
def lazy_import():
    from sifflet_sdk.client.model.jira_project_dto import JiraProjectDto

    globals()["JiraProjectDto"] = JiraProjectDto


class SearchCollectionJiraProjectDto(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SearchCollectionJiraProjectDto - a model defined in OpenAPI
