...
class SettingsResponse(_message.Message):
    __slots__ = ("openid_connect", "oauth2", "tileserver_url", "map_attribution")
    OPENID_CONNECT_FIELD_NUMBER: _ClassVar[int]
    OAUTH2_FIELD_NUMBER: _ClassVar[int]
    TILESERVER_URL_FIELD_NUMBER: _ClassVar[int]
    MAP_ATTRIBUTION_FIELD_NUMBER: _ClassVar[int]
    openid_connect: OpenIdConnect
    oauth2: OAuth2
    tileserver_url: str
    map_attribution: str
    def __init__(self, openid_connect: _Optional[_Union[OpenIdConnect, _Mapping]] = ..., oauth2: _Optional[_Union[OAuth2, _Mapping]] = ..., tileserver_url: _Optional[str] = ..., map_attribution: _Optional[str] = ...) -> None: ...
