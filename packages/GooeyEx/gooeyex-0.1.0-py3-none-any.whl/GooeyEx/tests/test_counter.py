...
class TestCounter(unittest.TestCase):
    ...
    def makeParser(self, **kwargs):
        ...
        parser.add_argument("--widget", action="count", widget="Counter", **kwargs)
        return parser
    ...
    def testInitialValue(self):
        cases = [
            ...
            {
                "inputs": {"default": 1, "gooey_options": {"initial_value": 3}},
                "expect": "3",
            },
            {"inputs": {"gooey_options": {"initial_value": 1}}, "expect": "1"},
            {"inputs": {"default": 2, "gooey_options": {}}, "expect": "2"},
            {"inputs": {"default": 1}, "expect": "1"},
            {"inputs": {}, "expect": None},
        ]
        for case in cases:
