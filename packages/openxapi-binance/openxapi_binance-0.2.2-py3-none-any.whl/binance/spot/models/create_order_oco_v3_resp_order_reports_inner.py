...
class CreateOrderOcoV3RespOrderReportsInner(BaseModel):
    """
    CreateOrderOcoV3RespOrderReportsInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["clientOrderId", "cummulativeQuoteQty", "executedQty", "orderId", "orderListId", "origQty", "origQuoteOrderQty", "price", "selfTradePreventionMode", "side", "status", "stopPrice", "symbol", "timeInForce", "transactTime", "type", "workingTime"]
