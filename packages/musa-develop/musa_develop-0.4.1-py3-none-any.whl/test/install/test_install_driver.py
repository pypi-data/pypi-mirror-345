...
from musa_develop.install import PACKAGE_MANAGER, DriverPkgMgr
from musa_develop.demo import DEMO
from musa_develop.utils import shell_cmd
...
def test_demo():
    ...
    assert (
        "Please execute \x1b[32m`docker exec -it musa_develop_torch_musa_base bash"
        in result_string
    )
