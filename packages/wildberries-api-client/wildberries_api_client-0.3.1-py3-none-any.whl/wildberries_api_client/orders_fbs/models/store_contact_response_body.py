...
class StoreContactResponseBody(object):
    ...
    """
    swagger_types = {
        'contacts': 'list[StoreContactResponseBodyContacts]'
    }
    ...
    def __init__(self, contacts=None):  # noqa: E501
        """StoreContactResponseBody - a model defined in Swagger"""  # noqa: E501
        self._contacts = None
    ...
    @property
    def contacts(self):
        """Gets the contacts of this StoreContactResponseBody.  # noqa: E501


        :return: The contacts of this StoreContactResponseBody.  # noqa: E501
        :rtype: list[StoreContactResponseBodyContacts]
        """
        return self._contacts

    @contacts.setter
    def contacts(self, contacts):
        """Sets the contacts of this StoreContactResponseBody.


        :param contacts: The contacts of this StoreContactResponseBody.  # noqa: E501
        :type: list[StoreContactResponseBodyContacts]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StoreContactResponseBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StoreContactResponseBody):
            return False
