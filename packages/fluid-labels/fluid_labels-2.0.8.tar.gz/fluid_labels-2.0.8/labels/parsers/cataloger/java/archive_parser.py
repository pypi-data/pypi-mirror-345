...
from labels.parsers.cataloger.java.parse_pom_properties import (
...
from labels.parsers.licenses import (
    parser,
)
...
class ArchiveParser(BaseModel):
    ...
    def parse_licenses(self, manifest: JavaManifest) -> tuple[list[str], str, str]:
