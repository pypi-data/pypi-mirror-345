...
class global_poa_on_front(ResourceTypeDescriptor):
    """The total solar irradiance incident on the front side of a photovoltaic (PV) module, accounting for the module's orientation and tilt. """
