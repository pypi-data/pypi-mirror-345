...
def create_config_file(default_dir):  
    ...
    "field_capacity": {"description": "The amount of soil moisture or water content held in the soil after excess water has drained away [optional]", "default": None, "required": False},
    "wilting_point": {"description": "The amount of water that is held so tightly by the soil matrix that roots cannot absorb it and plants will wilt [optional]", "default": None, "required": False},
