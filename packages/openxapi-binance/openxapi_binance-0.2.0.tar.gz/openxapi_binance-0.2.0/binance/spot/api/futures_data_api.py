...
class FuturesDataApi:
    ...
    @validate_call
    def get_futures_hist_data_link_v1(
        self,
        symbol: Annotated[StrictStr, Field(description="symbol name, e.g. BTCUSDT or BTCUSD_PERP ｜")],
        data_type: Annotated[StrictStr, Field(description="`T_DEPTH` for ticklevel orderbook data, `S_DEPTH` for orderbook snapshot data")],
        ...
        :param symbol: symbol name, e.g. BTCUSDT or BTCUSD_PERP ｜ (required)
        :type symbol: str
        :param data_type: `T_DEPTH` for ticklevel orderbook data, `S_DEPTH` for orderbook snapshot data (required)
        :type data_type: str
        ...
        _param = self._get_futures_hist_data_link_v1_serialize(
            symbol=symbol,
            data_type=data_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetFuturesHistDataLinkV1Resp",
            '4XX': "APIError",
            '5XX': "APIError",
        }
    ...
    @validate_call
    def get_futures_hist_data_link_v1_with_http_info(
        self,
        symbol: Annotated[StrictStr, Field(description="symbol name, e.g. BTCUSDT or BTCUSD_PERP ｜")],
        data_type: Annotated[StrictStr, Field(description="`T_DEPTH` for ticklevel orderbook data, `S_DEPTH` for orderbook snapshot data")],
        start_time: StrictInt,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetFuturesHistDataLinkV1Resp]:
        """Get Future TickLevel Orderbook Historical Data Download Link(USER_DATA)
    ...
    @validate_call
    def get_futures_hist_data_link_v1_without_preload_content(
        self,
        symbol: Annotated[StrictStr, Field(description="symbol name, e.g. BTCUSDT or BTCUSD_PERP ｜")],
        data_type: Annotated[StrictStr, Field(description="`T_DEPTH` for ticklevel orderbook data, `S_DEPTH` for orderbook snapshot data")],
        start_time: StrictInt,
    ...
    def _get_futures_hist_data_link_v1_serialize(
        self,
        symbol,
        data_type,
        start_time,
