...
and the provided triage guidelines to determine the correct triage action.
...
Decide:
 - triage_status: "AUTOMATIC" or "END_CONVERSATION"
 - triage_reason: If triage_status == "END_CONVERSATION", specify reason
 - response_action_to_take: One of {allowed_actions}

DO NOT generate the full email body here. Only provide triage info.

Your JSON output must match:
{{
  "triage_status": "AUTOMATIC" or "END_CONVERSATION",
  "triage_reason": "<reason if END_CONVERSATION else null>",
