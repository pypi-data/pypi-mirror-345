...
class Color:
  ...
  def __init__(self, rgb: typing.Any) -> None:
...
class Euler:
  ...
  def __init__(self, angles: typing.Any, order: str = 'XYZ') -> None:
...
matrices from 2x2 up to 4x4.
  ...
  def LocRotScale(cls, location: Vector, rotation: Matrix, scale: Vector) -> Matrix:
...
Such a representation is useful for interpolation between multiple orientations.
  ...
  def to_swing_twist(self, axis: str) -> typing.Any:
...
class Vector:
  ...
  def __init__(self, seq: typing.Any) -> None:
  ...
  def Repeat(cls, vector: Vector, size: int) -> None:
  ...
  def angle_signed(self, other: Vector, fallback: typing.Any = None) -> float:
...
vector and another.
  ...
  def to_tuple(self, precision: int = -1) -> typing.Any:
