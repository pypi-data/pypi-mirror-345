...
mod tests {
    ...
    #[test]
    fn test_latitude() {
        assert_relative_eq!(*"4903.50N".parse::<Latitude>().unwrap(), 49.05833333333333);
        assert_relative_eq!(*"4903.50S".parse::<Latitude>().unwrap(), -49.05833333333333);
        assert_eq!(
    ...
    fn test_longitude() {
        ...
        assert_relative_eq!(
            *"04903.50W".parse::<Longitude>().unwrap(),
            -49.05833333333333
        );
        assert_eq!(
    ...
    fn test_encode_latitude() {
        assert_eq!(
            encode_latitude(Latitude(49.05833333333333)),
    ...
    fn test_encode_longitude() {
        assert_eq!(
            encode_longitude(Longitude(129.05833333333334)),
            Ok("12903.50E".to_string())
        );
        assert_eq!(
            encode_longitude(Longitude(-49.05833333333333)),
