...
class Route(object):
    ...
    def __init__(
        ...
        **_kwargs: ViewCallable,
        ...
        if provide_request is not None:
    ...
    def __repr__(self):
        ...
        for viewspec, methods in view_methods_map.items():
            ...
            s.append("%s %s => %r" % (method_str, str(self.pattern), fq_path(viewspec)))
    ...
    def add_prefix(self, path):
        ...
        newroute.__dict__ = dict(self.__dict__, pattern=self.pattern.add_prefix(path))
        return newroute
...
class RouteCollection(MutableSequence):
    ...
    def pathfor(self, viewspec, *args, **kwargs):
        ...
        if isinstance(viewspec, str) and ":" in viewspec:
            ...
            p1, remainder_args, remainder_kwargs = delegated_route.path(*args, **kwargs)
        ...
        for route, result in routes:
            ...
            if isinstance(route, DelegateRoute):
                ...
                for sub in sub_routes.get_route_traversals(
                    ...
                    traversed.extend(
                        TraversedCollection(c, result.path_matched + p, r, a, k, ta, tk)
    ...
    def __init__(self, prefix, view, dynamic=False, *args, **kwargs):
        ...
        if self.dynamic:
            ...
            if not isinstance(view, RouteCollection):
                routes = [
                    r.bindto(view) if r.instance is None else r for r in view.__routes__
                ]
