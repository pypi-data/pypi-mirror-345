...
class GithubRepository(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": GithubRepositorylinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "defaultBranch": obj.get("defaultBranch"),
            "description": obj.get("description"),
            "name": obj.get("name"),
            "permissions": GithubRepositorypermissions.from_dict(obj["permissions"]) if obj.get("permissions") is not None else None,
