...
class VersionsConfig(BaseModel):
    """
    Parsed configuration from `setup.cfg` in the cluster directory.
    """ # noqa: E501
    gitops: StrictStr
    aws: StrictStr
    python: StrictStr
    current_release: StrictStr
    previous_release: StrictStr
    penultimate_release: StrictStr
    __properties: ClassVar[List[str]] = ["gitops", "aws", "python", "current_release", "previous_release", "penultimate_release"]
