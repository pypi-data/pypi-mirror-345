...
class ParameterOptimizer:
    ...
    def _save_optimization_results(self):
        ...
        self.logger(f"优化结果已保存到: {filename}")
        ...
        try:
            ...
            self.logger(f"优化结果已导出到Excel: {excel_filename}")
    ...
    def _save_best_results(self, full_results):
        ...
        self.logger(f"最优参数结果已保存到: {filename}")
    ...
    def _plot_parameter_distribution(self, output_dir):
        ...
        try:
            ...
            self.logger(f"参数分布图已保存到: {plot_path}")
    ...
    def plot_optimization_results(self, save_path=None):
        ...
        try:
            ...
            self.logger(f"优化结果可视化已保存: {', '.join(plot_paths)}")
