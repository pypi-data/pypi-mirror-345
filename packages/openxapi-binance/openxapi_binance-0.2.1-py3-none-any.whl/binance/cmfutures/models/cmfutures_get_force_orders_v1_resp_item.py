...
class CmfuturesGetForceOrdersV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["avgPrice", "clientOrderId", "closePosition", "cumBase", "executedQty", "orderId", "origQty", "origType", "pair", "positionSide", "price", "priceProtect", "reduceOnly", "side", "status", "stopPrice", "symbol", "time", "timeInForce", "type", "updateTime", "workingType"]
