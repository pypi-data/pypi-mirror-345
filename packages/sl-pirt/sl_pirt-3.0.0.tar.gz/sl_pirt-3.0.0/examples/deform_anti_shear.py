"""
This illustrates the shape of the (mathematical) function that limits the knot values to prevent folding and shearing
(i.e., make the deformation diffeomorphic).
"""
