...
from h2ogpte.rest.api_response import ApiResponse, T as ApiResponseT
import h2ogpte.rest.models
from h2ogpte.rest import rest
from h2ogpte.rest.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.6.28/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(h2ogpte.rest.models, klass)
