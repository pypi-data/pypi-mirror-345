...
def test_cudaawkward_ListArrayU32_min_range_1():
    ...
    lenstarts = 3
    funcC = cupy_backend['awkward_ListArray_min_range', cupy.int64, cupy.uint32, cupy.uint32]
...
def test_cudaawkward_ListArrayU32_min_range_2():
    tomin = cupy.array([123], dtype=cupy.int64)
...
def test_cudaawkward_ListArrayU32_min_range_3():
    tomin = cupy.array([123], dtype=cupy.int64)
...
def test_cudaawkward_ListArrayU32_min_range_4():
    tomin = cupy.array([123], dtype=cupy.int64)
...
def test_cudaawkward_ListArrayU32_min_range_5():
    tomin = cupy.array([123], dtype=cupy.int64)
