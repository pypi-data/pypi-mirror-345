...
class SwitchMtuArgs:
    def __init__(__self__, *,
                 ...
                 default_mtu_size: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] default_mtu_size: MTU size for the entire network. Default value is 9578.
    ...
    def default_mtu_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def default_mtu_size(self, value: Optional[pulumi.Input[builtins.int]]):
...
class SwitchMtu(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="defaultMtuSize")
    def default_mtu_size(self) -> pulumi.Output[builtins.int]:
        """
        MTU size for the entire network. Default value is 9578.
        """
        return pulumi.get(self, "default_mtu_size")
