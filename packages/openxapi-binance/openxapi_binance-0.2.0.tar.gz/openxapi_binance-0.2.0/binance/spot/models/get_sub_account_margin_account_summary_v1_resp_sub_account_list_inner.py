...
class GetSubAccountMarginAccountSummaryV1RespSubAccountListInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["email", "totalAssetOfBtc", "totalLiabilityOfBtc", "totalNetAssetOfBtc"]
