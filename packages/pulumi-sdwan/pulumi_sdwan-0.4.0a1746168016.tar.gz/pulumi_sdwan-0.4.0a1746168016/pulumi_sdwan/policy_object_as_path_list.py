...
class PolicyObjectAsPathListArgs:
    def __init__(__self__, *,
                 as_path_list_id: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.int] as_path_list_id: As path List Number - Range: `1`-`500`
    ...
    def as_path_list_id(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def as_path_list_id(self, value: pulumi.Input[builtins.int]):
...
class _PolicyObjectAsPathListState:
    def __init__(__self__, *,
                 as_path_list_id: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="asPathListId")
    def as_path_list_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        As path List Number - Range: `1`-`500`
        """
        return pulumi.get(self, "as_path_list_id")
    ...
    @as_path_list_id.setter
    def as_path_list_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "as_path_list_id", value)
...
class PolicyObjectAsPathList(pulumi.CustomResource):
    ...
    pulumi_type = "sdwan:index/policyObjectAsPathList:PolicyObjectAsPathList"
    ...
    def get(resource_name: str,
            ...
            feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'PolicyObjectAsPathList':
        """
    ...
    @property
    @pulumi.getter(name="asPathListId")
    def as_path_list_id(self) -> pulumi.Output[builtins.int]:
        """
        As path List Number - Range: `1`-`500`
        """
        return pulumi.get(self, "as_path_list_id")
