...
class CountPerHealthStatus(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, count, health_status, *args, **kwargs):  # noqa: E501
        """CountPerHealthStatus - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, count, health_status, *args, **kwargs):  # noqa: E501
        """CountPerHealthStatus - a model defined in OpenAPI
