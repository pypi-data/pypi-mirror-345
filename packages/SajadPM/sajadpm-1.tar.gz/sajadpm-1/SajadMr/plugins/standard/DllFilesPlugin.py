...
""" Standard plug-in to tell SajadQ about DLLs needed for standalone imports.
...
from SajadMr.utils.SharedLibraries import getPyWin32Dir
from SajadMr.utils.Utils import isFreeBSD, isLinux, isMacOS, isWin32Windows


class SajadQPluginDllFiles(SajadQYamlPluginBase):
