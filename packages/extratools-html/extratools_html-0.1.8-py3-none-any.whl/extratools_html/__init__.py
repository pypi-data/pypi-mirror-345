...
PRE_ACTION_TIMEOUT: timedelta = timedelta(seconds=1)
...
async def __download_via_browser(
    ...
    *,
    ...
    async with async_playwright() as playwright:
        ...
        page.set_default_timeout(PRE_ACTION_TIMEOUT.total_seconds() * 1_000)
                ...
                match action:
                    ...
                    case PageElementAction.TO_BE_VISIBLE:
                        await expect(page.locator(selector)).to_be_visible(
                            # This timeout is not covered by default timeout above
                            timeout=PRE_ACTION_TIMEOUT.total_seconds() * 1_000,
                        )
