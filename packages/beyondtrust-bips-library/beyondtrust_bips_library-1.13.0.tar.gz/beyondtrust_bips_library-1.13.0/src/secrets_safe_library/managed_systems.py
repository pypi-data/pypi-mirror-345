...
class ManagedSystem(APIObject):
    ...
    def __init__(self, authentication: Authentication, logger: logging.Logger = None):
        ...
        self._schema = {
            "host_name": {"type": "string", "maxlength": 128},
            "ip_address": {"type": "string", "maxlength": 45},
            "dns_name": {"type": "string", "maxlength": 255},
            "instance_name": {"type": "string", "maxlength": 100},
            "forest_name": {"type": "string", "maxlength": 64},
            "net_bios_name": {"type": "string", "maxlength": 15},
            "contact_email": {"type": "string", "maxlength": 1000},
            "description": {"type": "string", "maxlength": 255},
            "ssh_key_enforcement_mode": {"type": "integer", "allowed": [0, 1, 2]},
            "release_duration": {"type": "integer", "min": 1, "max": 525600},
            "max_release_duration": {"type": "integer", "min": 1, "max": 525600},
            "isa_release_duration": {"type": "integer", "min": 1, "max": 525600},
            ...
            "change_frequency_days": {
                ...
                "min": 1,
                "max": 999,
                "dependencies": {"change_frequency_type": "xdays"},
            },
            "change_time": {
                "type": "string",
                "regex": r"^(?:[01]\d|2[0-3]):[0-5]\d$",  # 24-hour format (HH:MM)
                "default": "23:30",  # Default value
            },
            "remote_client_type": {
                "type": "string",
                "allowed": ["EPM"],
            ...
            "application_host_id": {"type": "integer", "nullable": True},
            "is_application_host": {
                "type": "boolean",
                "default": False,
            },
            "access_url": {"type": "string", "maxlength": 2048},
        }
    ...
    def post_managed_system_by_asset_id(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_managed_system_by_asset_id endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def post_managed_system_by_database_id(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_managed_system_by_database_id endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def post_managed_system_by_workgroup_id(
        ...
        dss_key_rule_id: int = None,
        login_account_id: int = None,
        oracle_internet_directory_id: int = None,
        functional_account_id: int = None,
        elevation_command: str = None,
        application_host_id: int = None,
    ) -> dict:
        ...
        Args:
            ...
            oracle_internet_directory_id (int, optional): The Oracle Internet
                                                          Directory ID.
        ...
        utils.print_log(
            self._logger,
            f"Calling post_managed_system_by_workgroup_id endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def delete_managed_system_by_id(self, managed_system_id: int) -> None:
        ...
        utils.print_log(
            self._logger,
            f"Calling delete_managed_system_by_id endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def put_managed_system_by_id(
        ...
        utils.print_log(
            self._logger,
            f"Calling put_managed_system_by_id endpoint: {endpoint}",
            logging.DEBUG,
        )
