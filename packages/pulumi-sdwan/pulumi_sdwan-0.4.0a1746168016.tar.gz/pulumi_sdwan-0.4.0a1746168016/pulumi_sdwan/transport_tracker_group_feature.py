...
class TransportTrackerGroupFeatureArgs:
    def __init__(__self__, *,
                 ...
                 tracker_boolean: Optional[pulumi.Input[builtins.str]] = None,
                 tracker_boolean_variable: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] tracker_boolean: tracker ref list combine boolean and or - Choices: `and`, `or` - Default value: `or`
        :param pulumi.Input[builtins.str] tracker_boolean_variable: Variable name
    ...
    def tracker_boolean(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tracker_boolean(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tracker_boolean", value)

    @property
    @pulumi.getter(name="trackerBooleanVariable")
    def tracker_boolean_variable(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Variable name
        """
    ...
    def tracker_boolean_variable(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TransportTrackerGroupFeature(pulumi.CustomResource):
    ...
    pulumi_type = "sdwan:index/transportTrackerGroupFeature:TransportTrackerGroupFeature"
    ...
    def get(resource_name: str,
            ...
            tracker_boolean_variable: Optional[pulumi.Input[builtins.str]] = None,
            tracker_elements: Optional[pulumi.Input[Sequence[pulumi.Input[Union['TransportTrackerGroupFeatureTrackerElementArgs', 'TransportTrackerGroupFeatureTrackerElementArgsDict']]]]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'TransportTrackerGroupFeature':
        """
    ...
    @property
    @pulumi.getter(name="trackerBoolean")
    def tracker_boolean(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        tracker ref list combine boolean and or - Choices: `and`, `or` - Default value: `or`
        """
        return pulumi.get(self, "tracker_boolean")
    ...
    @property
    @pulumi.getter(name="trackerBooleanVariable")
    def tracker_boolean_variable(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Variable name
        """
        return pulumi.get(self, "tracker_boolean_variable")
