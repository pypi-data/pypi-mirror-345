...
Refer to the Terraform Registry for docs: [`data_cloudflare_user_agent_blocking_rules`](https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/user_agent_blocking_rules).
'''
...
class DataCloudflareUserAgentBlockingRules(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/user_agent_blocking_rules cloudflare_user_agent_blocking_rules}.'''
    ...
    def __init__(
        ...
        *,
        ...
        ua_search: typing.Optional[builtins.str] = None,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/user_agent_blocking_rules cloudflare_user_agent_blocking_rules} Data Source.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param zone_id: Defines an identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/user_agent_blocking_rules#zone_id DataCloudflareUserAgentBlockingRules#zone_id}
        :param description: A string to search for in the description of existing rules. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/user_agent_blocking_rules#description DataCloudflareUserAgentBlockingRules#description}
        :param description_search: A string to search for in the description of existing rules. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/user_agent_blocking_rules#description_search DataCloudflareUserAgentBlockingRules#description_search}
        :param max_items: Max items to fetch, default: 1000. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/user_agent_blocking_rules#max_items DataCloudflareUserAgentBlockingRules#max_items}
        :param ua_search: A string to search for in the user agent values of existing rules. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/user_agent_blocking_rules#ua_search DataCloudflareUserAgentBlockingRules#ua_search}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataCloudflareUserAgentBlockingRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/user_agent_blocking_rules#import import section} in the documentation of this resource for the id to use
    ...
    @jsii.member(jsii_name="resetUaSearch")
    def reset_ua_search(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetUaSearch", []))
    ...
    @builtins.property
    @jsii.member(jsii_name="uaSearchInput")
    def ua_search_input(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "uaSearchInput"))
    ...
    def description_search(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__36d6a9b8b347345c071c747a7f9c15749b7813c51bcb9b95cdc954d1edb1a7ff)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    @builtins.property
    @jsii.member(jsii_name="uaSearch")
    def ua_search(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "uaSearch"))

    @ua_search.setter
    def ua_search(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c8f8d6049b48f60c35155371673fd2746415f7dd42ac6a5cc5a2d9adfebbd70e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "uaSearch", value) # pyright: ignore[reportArgumentType]
...
class DataCloudflareUserAgentBlockingRulesConfig(
    ...
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument ua_search", value=ua_search, expected_type=type_hints["ua_search"])
        ...
        if ua_search is not None:
            self._values["ua_search"] = ua_search
    ...
    def zone_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/user_agent_blocking_rules#zone_id DataCloudflareUserAgentBlockingRules#zone_id}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/user_agent_blocking_rules#description DataCloudflareUserAgentBlockingRules#description}
        '''
    ...
    def description_search(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/user_agent_blocking_rules#description_search DataCloudflareUserAgentBlockingRules#description_search}
        '''
    ...
    def max_items(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/user_agent_blocking_rules#max_items DataCloudflareUserAgentBlockingRules#max_items}
        '''
        result = self._values.get("max_items")
        return typing.cast(typing.Optional[jsii.Number], result)

    @builtins.property
    def ua_search(self) -> typing.Optional[builtins.str]:
        '''A string to search for in the user agent values of existing rules.

        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/user_agent_blocking_rules#ua_search DataCloudflareUserAgentBlockingRules#ua_search}
        '''
        result = self._values.get("ua_search")
        return typing.cast(typing.Optional[builtins.str], result)
...
def _typecheckingstub__36d6a9b8b347345c071c747a7f9c15749b7813c51bcb9b95cdc954d1edb1a7ff(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__c8f8d6049b48f60c35155371673fd2746415f7dd42ac6a5cc5a2d9adfebbd70e(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
