...
class IpsecCryptoProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dh_group: phase-2 DH group (PFS DH group). String must be one of these: `"no-pfs"`, `"group1"`, `"group2"`, `"group5"`, `"group14"`, `"group19"`, `"group20"`. Default: `"group2"`.
...
class IpsecCryptoProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            snippet: Optional[pulumi.Input[builtins.str]] = None,
            tfid: Optional[pulumi.Input[builtins.str]] = None) -> 'IpsecCryptoProfile':
        """
    ...
    @property
    @pulumi.getter(name="dhGroup")
    def dh_group(self) -> pulumi.Output[builtins.str]:
        """
        phase-2 DH group (PFS DH group). String must be one of these: `"no-pfs"`, `"group1"`, `"group2"`, `"group5"`, `"group14"`, `"group19"`, `"group20"`. Default: `"group2"`.
        """
        return pulumi.get(self, "dh_group")
