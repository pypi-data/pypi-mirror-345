...
class WirelessSsidsTrafficShapingRulesArgs:
    def __init__(__self__, *,
                 ...
                 default_rules_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input['WirelessSsidsTrafficShapingRulesRuleArgs']]]] = None,
                 traffic_shaping_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] default_rules_enabled: Whether default traffic shaping rules are enabled (true) or disabled (false). There are 4 default rules, which can be seen on your network's traffic shaping page. Note that default rules count against the rule limit of 8.
        ...
        :param pulumi.Input[builtins.bool] traffic_shaping_enabled: Whether traffic shaping rules are applied to clients on your SSID.
        """
    ...
    def default_rules_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def default_rules_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def traffic_shaping_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def traffic_shaping_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class WirelessSsidsTrafficShapingRules(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            number: Optional[pulumi.Input[builtins.str]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['WirelessSsidsTrafficShapingRulesRuleArgs', 'WirelessSsidsTrafficShapingRulesRuleArgsDict']]]]] = None,
            traffic_shaping_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'WirelessSsidsTrafficShapingRules':
        """
    ...
    @property
    @pulumi.getter(name="defaultRulesEnabled")
    def default_rules_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Whether default traffic shaping rules are enabled (true) or disabled (false). There are 4 default rules, which can be seen on your network's traffic shaping page. Note that default rules count against the rule limit of 8.
        """
        return pulumi.get(self, "default_rules_enabled")
    ...
    @property
    @pulumi.getter(name="trafficShapingEnabled")
    def traffic_shaping_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Whether traffic shaping rules are applied to clients on your SSID.
        """
        return pulumi.get(self, "traffic_shaping_enabled")
