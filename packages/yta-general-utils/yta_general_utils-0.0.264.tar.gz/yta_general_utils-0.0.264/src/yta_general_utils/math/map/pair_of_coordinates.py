...
class PairOfCoordinates:
    ...
    def _get_y_from_x(
        ...
        value = NormalizableValue(self.rate_function.get_n_value(1 - value.normalized if self.is_backwards else value.normalized), (self.min_y, self.max_y), value_is_normalized = True)
