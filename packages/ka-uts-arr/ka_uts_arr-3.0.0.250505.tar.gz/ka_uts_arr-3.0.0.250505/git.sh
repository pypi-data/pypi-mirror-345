...
# Initialized empty Git repository in /mnt/hgfs/SOURCE/python/ka_uts_uts/.git/

# Add Remote Repository: Link your local repository to the GitHub repository you created:
git config --global --add safe.directory /mnt/hgfs/SOURCE/python/ka_uts_arr
git remote add ka_uts_arr https://github.com/bs291048/ka_uts_arr.git

# fatal: detected dubious ownership in repository at '/mnt/hgfs/SOURCE/python/ka_uts_uts'
# To add an exception for this directory, call:
# git config --global --add safe.directory /mnt/hgfs/SOURCE/python/ka_uts_uts
