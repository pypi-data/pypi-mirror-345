...
class WorkspaceApi(BaseApi):
    ...
    def delete_workspace(self, id: UUID, dry_run: bool) -> WorkspaceApplyResponseDto:
        ...
        response = self.api_instance.delete_workspace(str(id), dry_run=dry_run, _check_return_type=False)
    ...
    def apply_workspace(
        ...
        request = LightWorkspaceApplyRequestDto(_check_type=False, changes=changes)
        logger.debug(
