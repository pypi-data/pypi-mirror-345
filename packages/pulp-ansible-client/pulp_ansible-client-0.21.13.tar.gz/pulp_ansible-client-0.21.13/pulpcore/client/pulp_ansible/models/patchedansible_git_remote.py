...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, pulp_labels=None, rate_limit=None, tls_validation=None, connect_timeout=None, ca_cert=None, total_timeout=None, proxy_password=None, password=None, client_cert=None, max_retries=None, username=None, sock_connect_timeout=None, sock_read_timeout=None, proxy_username=None, client_key=None, url=None, proxy_url=None, name=None, headers=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
