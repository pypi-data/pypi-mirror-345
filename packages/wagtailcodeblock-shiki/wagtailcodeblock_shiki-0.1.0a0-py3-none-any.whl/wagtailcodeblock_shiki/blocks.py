...
class CodeBlock(StructBlock):
    ...
    class Meta:
        icon = "code"
        template = "wagtailcodeblock_shiki/code_block.html"
        form_classname = "code-block struct-block"
        form_template = "wagtailcodeblock_shiki/code_block_form.html"


class CodeBlockAdapter(StructBlockAdapter):
    js_constructor = "wagtailcodeblock_shiki.blocks.CodeBlock"
    ...
    def media(self):
        ...
        return Media(
            ...
            ["wagtailcodeblock_shiki/js/wagtailcodeblock_shiki.js"],
            # ["js/wagtailcodeblock_shiki.js"],
