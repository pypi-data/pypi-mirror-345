...
def lazy_import():
    ...
    globals()["PublicGetSourceDto"] = PublicGetSourceDto


class PublicPageDtoPublicGetSourceDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([PublicGetSourceDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """PublicPageDtoPublicGetSourceDto - a model defined in OpenAPI

        Args:
            data ([PublicGetSourceDto]):
