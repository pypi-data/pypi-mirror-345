...
from SajadMr import ModuleRegistry, Options, Variables
from SajadMr.importing.Importing import addExtraSysPaths
from SajadMr.importing.Recursion import considerUsedModules
...
from SajadMr.Tracing import general, optimization_logger, progress_logger
from SajadMr.utils.MemoryUsage import MemoryWatch, reportMemoryUsage
...
def restoreFromXML(text):
    from SajadMr.nodes.NodeBases import fromXML
    from SajadMr.TreeXML import fromString
