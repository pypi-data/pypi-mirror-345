...
class GetUmApiTradingStatusV1RespIndicatorsBTCUSDTInner(BaseModel):
    """
    ...
    trigger_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="triggerValue")
    value: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["indicator", "isLocked", "plannedRecoverTime", "triggerValue", "value"]
