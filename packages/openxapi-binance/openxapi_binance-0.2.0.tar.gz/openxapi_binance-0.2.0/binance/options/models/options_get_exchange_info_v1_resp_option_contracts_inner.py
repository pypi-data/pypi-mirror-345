...
class OptionsGetExchangeInfoV1RespOptionContractsInner(BaseModel):
    """
    ...
    settle_asset: Optional[StrictStr] = Field(default=None, alias="settleAsset")
    underlying: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["baseAsset", "quoteAsset", "settleAsset", "underlying"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "settleAsset": obj.get("settleAsset"),
