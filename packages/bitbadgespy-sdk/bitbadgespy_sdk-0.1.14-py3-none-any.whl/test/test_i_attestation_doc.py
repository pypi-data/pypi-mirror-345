    ...
    def make_instance(self, include_optional) -> IAttestationDoc:
        ...
        if include_optional:
            return IAttestationDoc(
                ...
                proof_of_issuance = bitbadgespy_sdk.models.i_create_attestation_payload_proof_of_issuance.iCreateAttestationPayload_proofOfIssuance(
                    message = '', 
                    signature = '', 
                    signer = '', 
                    public_key = '', ),
                ...
                data_integrity_proof = bitbadgespy_sdk.models.i_create_attestation_payload_data_integrity_proof.iCreateAttestationPayload_dataIntegrityProof(
                    signature = '', 
                    signer = '', 
                    public_key = '', 
                    is_derived = True, ),
