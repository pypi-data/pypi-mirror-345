...
class GetMarginForceOrdersV1RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["avgPrice", "executedQty", "orderId", "price", "qty", "side", "symbol", "timeInForce", "updatedTime"]
