...
- Never use directory_tree tool in root directory, because there might be lot of files and folders. 
List directory instead for root folder in case you need.
"""