...
class GetSubAccountFuturesAccountSummaryV1RespSubAccountListInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["asset", "email", "totalInitialMargin", "totalMaintenanceMargin", "totalMarginBalance", "totalOpenOrderInitialMargin", "totalPositionInitialMargin", "totalUnrealizedProfit", "totalWalletBalance"]
