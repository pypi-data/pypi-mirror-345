...
class PublicAggregatedNominationsOverviewResponse(BaseModel):
    ...
    mtus: List[PublicAggregatedNominationsOverviewResponseMtus]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mtus": [PublicAggregatedNominationsOverviewResponseMtus.from_dict(_item) for _item in obj["mtus"]] if obj.get("mtus") is not None else None
        })
        return _obj
