...
class GetSubAccountFuturesAccountV2RespFutureAccountResp(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["assets", "canDeposit", "canTrade", "canWithdraw", "email", "feeTier", "maxWithdrawAmount", "totalInitialMargin", "totalMaintenanceMargin", "totalMarginBalance", "totalOpenOrderInitialMargin", "totalPositionInitialMargin", "totalUnrealizedProfit", "totalWalletBalance", "updateTime"]
