...
def fetch_option_candles_by_symbol(underlying, symbol, start_date, end_date, granularity=1):
    """ Function to Fetch Options Trade Data """
    try:
        headers = {"x-api-key": api_key, "content-type": "application/json"}
        request_data = {"underlying": underlying, "symbol": symbol, "from_date": start_date, "to_date": end_date, "granularity": granularity}
