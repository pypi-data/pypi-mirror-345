...
PyObject *SajadQ_Slice_New(PyThreadState *tstate, PyObject *start, PyObject *stop, PyObject *step) {
    ...
    if (*slice_cache_ptr != NULL) {
        ...
        *slice_cache_ptr = NULL;
        ...
        SajadQ_Py_NewReference((PyObject *)result_slice);
    } else {
        result_slice = (PySliceObject *)SajadQ_GC_New(&PySlice_Type);
