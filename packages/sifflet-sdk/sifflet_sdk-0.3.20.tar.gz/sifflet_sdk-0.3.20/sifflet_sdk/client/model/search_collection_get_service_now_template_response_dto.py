...
def lazy_import():
    ...
    globals()["GetServiceNowTemplateResponseDto"] = GetServiceNowTemplateResponseDto


class SearchCollectionGetServiceNowTemplateResponseDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([GetServiceNowTemplateResponseDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SearchCollectionGetServiceNowTemplateResponseDto - a model defined in OpenAPI

        Args:
            data ([GetServiceNowTemplateResponseDto]):
