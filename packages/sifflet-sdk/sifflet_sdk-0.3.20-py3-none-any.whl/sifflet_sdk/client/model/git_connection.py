...
class GitConnection(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, auth_type, secret_id, url, *args, **kwargs):  # noqa: E501
        """GitConnection - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, auth_type, secret_id, url, *args, **kwargs):  # noqa: E501
        """GitConnection - a model defined in OpenAPI
