class LiveConstants:
   ...
   # Binance Endpoints
    ...
    # Bybit Endpoints
    class Bybit:
        RESTAPI_SPOT_URL = "https://api.bybit.com"
        RESTAPI_FUTURES_URL = "https://api.bybit.com"
        WEBSOCKET_SPOT_URL = "wss://stream.bybit.com/v5/public/spot"
        WEBSOCKET_FUTURES_URL = "wss://stream.bybit.com/v5/public/futures"
        PUBLIC_CHANNELS = {
            "ticker": "tickers",
            "trade": "publicTrade",
