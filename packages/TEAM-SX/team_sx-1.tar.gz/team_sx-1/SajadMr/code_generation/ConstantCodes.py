...
from SajadMr.ModuleRegistry import getRootTopModule
from SajadMr.PythonVersions import python_version
from SajadMr.Serialization import GlobalConstantAccessor
from SajadMr.utils.CStrings import encodePythonStringToC
from SajadMr.utils.Distributions import (
    getDistribution,
    getDistributionTopLevelPackageNames,
)
from SajadMr.Version import getSajadQVersionTuple
...
def getConstantsDefinitionCode():
    ...
    header = template_header_guard % {
        "header_guard_name": "__SajadSx_GLOBAL_CONSTANTS_H__",
        "header_body": "\n".join(lines),
    }

    major, minor, micro, is_final, _rc_number = getSajadQVersionTuple()
    ...
    body = template_constants_reading % {
        ...
        "SajadMr_version_major": major,
        "SajadMr_version_minor": minor,
        "SajadMr_version_micro": micro,
        "SajadMr_version_level": "release" if is_final else "candidate",
