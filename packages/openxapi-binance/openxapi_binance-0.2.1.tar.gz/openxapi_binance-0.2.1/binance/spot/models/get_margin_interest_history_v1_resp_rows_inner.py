...
class GetMarginInterestHistoryV1RespRowsInner(BaseModel):
    """
    ...
    isolated_symbol: Optional[StrictStr] = Field(default=None, alias="isolatedSymbol")
    ...
    __properties: ClassVar[List[str]] = ["asset", "interest", "interestAccuredTime", "interestRate", "isolatedSymbol", "principal", "rawAsset", "txId", "type"]
