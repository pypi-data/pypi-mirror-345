...
def by_signature(cuda_kernel_templates):
    ...
    out["awkward_UnionArray_regular_index_a", int32, int32, int64] = None
    out["awkward_UnionArray_regular_index_b", int32, int32, int64] = None
    out["awkward_UnionArray_regular_index_c", int32, int32, int64] = None
    f.dir = ['out', 'out', 'in', 'in', 'in']
    f.is_ptr = [True, True, False, True, False]
    ...
    def f(grid, block, args):
        ...
        cuda_kernel_templates.get_function(fetch_specialization(["awkward_UnionArray_regular_index_b", toindex.dtype, current.dtype, fromtags.dtype]))(grid, block, (toindex, current, size, fromtags, length, atomicAdd_toptr, invocation_index, err_code))
        cuda_kernel_templates.get_function(fetch_specialization(["awkward_UnionArray_regular_index_c", toindex.dtype, current.dtype, fromtags.dtype]))(grid, block, (toindex, current, size, fromtags, length, atomicAdd_toptr, invocation_index, err_code))
    out["awkward_UnionArray_regular_index_a", int64, int64, int64] = None
    out["awkward_UnionArray_regular_index_b", int64, int64, int64] = None
    out["awkward_UnionArray_regular_index_c", int64, int64, int64] = None
    f.dir = ['out', 'out', 'in', 'in', 'in']
    f.is_ptr = [True, True, False, True, False]
    ...
    def f(grid, block, args):
        ...
        cuda_kernel_templates.get_function(fetch_specialization(["awkward_UnionArray_regular_index_b", toindex.dtype, current.dtype, fromtags.dtype]))(grid, block, (toindex, current, size, fromtags, length, atomicAdd_toptr, invocation_index, err_code))
        cuda_kernel_templates.get_function(fetch_specialization(["awkward_UnionArray_regular_index_c", toindex.dtype, current.dtype, fromtags.dtype]))(grid, block, (toindex, current, size, fromtags, length, atomicAdd_toptr, invocation_index, err_code))
    out["awkward_UnionArray_regular_index_a", uint32, uint32, int64] = None
    out["awkward_UnionArray_regular_index_b", uint32, uint32, int64] = None
    out["awkward_UnionArray_regular_index_c", uint32, uint32, int64] = None
    f.dir = ['out', 'out', 'in', 'in', 'in']
    f.is_ptr = [True, True, False, True, False]
    ...
    def f(grid, block, args):
        cuda_kernel_templates.get_function(fetch_specialization(['awkward_UnionArray_simplify', int8, int64, int64, int64, int8, int64]))(grid, block, args)
    ...
    def f(grid, block, args):
        cuda_kernel_templates.get_function(fetch_specialization(['awkward_UnionArray_simplify_one', int8, int64, int64, int64]))(grid, block, args)
    f.dir = ['out', 'out', 'in', 'in', 'in', 'in', 'in', 'in']
    f.is_ptr = [True, True, True, True, False, False, False, False]
