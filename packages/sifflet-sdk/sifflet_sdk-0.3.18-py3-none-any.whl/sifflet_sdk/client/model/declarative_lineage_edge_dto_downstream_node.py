...
def lazy_import():
    from sifflet_sdk.client.model.dataset_field_node_dto import DatasetFieldNodeDto
    from sifflet_sdk.client.model.dataset_node_dto import DatasetNodeDto

    globals()["DatasetFieldNodeDto"] = DatasetFieldNodeDto
    globals()["DatasetNodeDto"] = DatasetNodeDto


class DeclarativeLineageEdgeDtoDownstreamNode(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            "DatasetFieldNodeDto": DatasetFieldNodeDto,
            "DatasetNodeDto": DatasetNodeDto,
            "dataset": DatasetNodeDto,
            "dataset_field": DatasetFieldNodeDto,
        }
        if not val:
            return None
        return {"type": val}
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DeclarativeLineageEdgeDtoDownstreamNode - a model defined in OpenAPI
