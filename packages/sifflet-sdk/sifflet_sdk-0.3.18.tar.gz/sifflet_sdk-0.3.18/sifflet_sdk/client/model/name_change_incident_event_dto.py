...
def lazy_import():
    ...
    from sifflet_sdk.client.model.name_change_incident_event_dto_all_of import (
        NameChangeIncidentEventDtoAllOf,
    )
    from sifflet_sdk.client.model.user_dto import UserDto

    globals()["IncidentEventDto"] = IncidentEventDto
    globals()["NameChangeIncidentEventDtoAllOf"] = NameChangeIncidentEventDtoAllOf
    globals()["UserDto"] = UserDto


class NameChangeIncidentEventDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NameChangeIncidentEventDto - a model defined in OpenAPI
