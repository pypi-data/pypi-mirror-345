...
class ParticipantOverviewApi:
    ...
    def get_participant_overview(
        ...
        """get_participant_overview

        Fetch an overview of Participant-related information  ---  __Requires Permission:__ (at least one)   * `VIEW_ANY_ORGANISATIONS`   * `VIEW_OWN_ORGANISATIONS`
        ...
        _param = self._get_participant_overview_serialize(
    ...
    @validate_call
    def get_participant_overview_with_http_info(
        self,
        x_participant_id: Annotated[StrictStr, Field(description="Internal ID of a Participant-type Organisation")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ParticipantOverviewData]:
        """get_participant_overview
    ...
    @validate_call
    def get_participant_overview_without_preload_content(
        self,
        x_participant_id: Annotated[StrictStr, Field(description="Internal ID of a Participant-type Organisation")],
        _request_timeout: Union[
            None,
    ...
    def _get_participant_overview_serialize(
        self,
        x_participant_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/participant-overview',
