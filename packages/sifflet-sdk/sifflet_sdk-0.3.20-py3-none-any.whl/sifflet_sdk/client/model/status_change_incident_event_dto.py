...
def lazy_import():
    ...
    from sifflet_sdk.client.model.status_change_incident_event_dto_all_of import (
        StatusChangeIncidentEventDtoAllOf,
    )
    from sifflet_sdk.client.model.user_dto import UserDto

    globals()["IncidentEventDto"] = IncidentEventDto
    globals()["StatusChangeIncidentEventDtoAllOf"] = StatusChangeIncidentEventDtoAllOf
    globals()["UserDto"] = UserDto


class StatusChangeIncidentEventDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StatusChangeIncidentEventDto - a model defined in OpenAPI
