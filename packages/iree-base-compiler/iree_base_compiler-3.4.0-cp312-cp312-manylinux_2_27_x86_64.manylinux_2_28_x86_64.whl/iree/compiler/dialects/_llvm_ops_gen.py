...
def intr_acos(in_, *, fastmath_flags=None, loc=None, ip=None) -> _ods_ir.Value:
  return ACosOp(in_=in_, fastmathFlags=fastmath_flags, loc=loc, ip=ip).result
...
def intr_asin(in_, *, fastmath_flags=None, loc=None, ip=None) -> _ods_ir.Value:
  return ASinOp(in_=in_, fastmathFlags=fastmath_flags, loc=loc, ip=ip).result
...
def intr_atan2(a, b, *, fastmath_flags=None, loc=None, ip=None) -> _ods_ir.Value:
  return ATan2Op(a=a, b=b, fastmathFlags=fastmath_flags, loc=loc, ip=ip).result
...
def intr_atan(in_, *, fastmath_flags=None, loc=None, ip=None) -> _ods_ir.Value:
  return ATanOp(in_=in_, fastmathFlags=fastmath_flags, loc=loc, ip=ip).result
...
def mlir_alias(alias_type, sym_name, linkage, *, dso_local=None, thread_local_=None, unnamed_addr=None, visibility_=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def blockaddress(res, block_addr, *, loc=None, ip=None) -> _ods_ir.Value:
...
def blocktag(tag, *, loc=None, ip=None) -> _ods_ir.Operation:
...
def call_intrinsic(results_, intrin, args, op_bundle_operands, op_bundle_sizes, *, fastmath_flags=None, op_bundle_tags=None, arg_attrs=None, res_attrs=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(CallIntrinsicOp(results_=results_, intrin=intrin, args=args, op_bundle_operands=op_bundle_operands, op_bundle_sizes=op_bundle_sizes, fastmathFlags=fastmath_flags, op_bundle_tags=op_bundle_tags, arg_attrs=arg_attrs, res_attrs=res_attrs, loc=loc, ip=ip))
  ...
  def __init__(self, result, callee_operands, op_bundle_operands, op_bundle_sizes, *, var_callee_type=None, callee=None, fastmathFlags=None, branch_weights=None, CConv=None, TailCallKind=None, memory_effects=None, convergent=None, no_unwind=None, will_return=None, op_bundle_tags=None, arg_attrs=None, res_attrs=None, no_inline=None, always_inline=None, inline_hint=None, access_groups=None, alias_scopes=None, noalias_scopes=None, tbaa=None, loc=None, ip=None):
    ...
    if var_callee_type is not None: attributes["var_callee_type"] = (var_callee_type if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_888')) else
          _ods_ir.AttrBuilder.get('anonymous_888')(var_callee_type, context=_ods_context))
...
def intr_experimental_constrained_fpext(res, arg_0, fp_exception_behavior, *, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_experimental_constrained_sitofp(res, arg_0, roundingmode, fp_exception_behavior, *, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_experimental_constrained_uitofp(res, arg_0, roundingmode, fp_exception_behavior, *, loc=None, ip=None) -> _ods_ir.Value:
...
class CountLeadingZerosOp(_ods_ir.OpView):
  ...
  def __init__(self, in_, is_zero_poison, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def intr_ctlz(in_, is_zero_poison, *, loc=None, ip=None) -> _ods_ir.Value:
  return CountLeadingZerosOp(in_=in_, is_zero_poison=is_zero_poison, loc=loc, ip=ip).result
...
def intr_cttz(in_, is_zero_poison, *, loc=None, ip=None) -> _ods_ir.Value:
  return CountTrailingZerosOp(in_=in_, is_zero_poison=is_zero_poison, loc=loc, ip=ip).result
...
def dso_local_equivalent(res, function_name, *, loc=None, ip=None) -> _ods_ir.Value:
...
def intr_exp10(in_, *, fastmath_flags=None, loc=None, ip=None) -> _ods_ir.Value:
  return Exp10Op(in_=in_, fastmathFlags=fastmath_flags, loc=loc, ip=ip).result
...
def intr_frexp(res, val, *, fastmath_flags=None, loc=None, ip=None) -> _ods_ir.Value:
...
def mlir_global_ctors(ctors, priorities, data, *, loc=None, ip=None) -> _ods_ir.Operation:
...
def mlir_global_dtors(dtors, priorities, data, *, loc=None, ip=None) -> _ods_ir.Operation:
...
class IndirectBrOp(_ods_ir.OpView):
  ...
  @builtins.property
  def succOperands(self):
    _ods_variadic_group_length = len(self.operation.operands) - 2 + 1
    return self.operation.operands[1:1 + _ods_variadic_group_length]

  @builtins.property
  def indbr_operand_segments(self):
    return self.operation.attributes["indbr_operand_segments"]

  @indbr_operand_segments.setter
  def indbr_operand_segments(self, value):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["indbr_operand_segments"] = value

def indirectbr(addr, succ_operands, indbr_operand_segments, successors, *, loc=None, ip=None) -> _ods_ir.Operation:
...
class IntToPtrOp(_ods_ir.OpView):
  ...
  def dereferenceable(self, value):
    if value is not None:
...
def inttoptr(res, arg, *, dereferenceable=None, loc=None, ip=None) -> _ods_ir.Value:
...
def invoke(result, callee_operands, normal_dest_operands, unwind_dest_operands, op_bundle_operands, op_bundle_sizes, normal_dest, unwind_dest, *, var_callee_type=None, callee=None, arg_attrs=None, res_attrs=None, branch_weights=None, c_conv=None, op_bundle_tags=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(InvokeOp(result=result, callee_operands=callee_operands, normalDestOperands=normal_dest_operands, unwindDestOperands=unwind_dest_operands, op_bundle_operands=op_bundle_operands, op_bundle_sizes=op_bundle_sizes, normalDest=normal_dest, unwindDest=unwind_dest, var_callee_type=var_callee_type, callee=callee, arg_attrs=arg_attrs, res_attrs=res_attrs, branch_weights=branch_weights, CConv=c_conv, op_bundle_tags=op_bundle_tags, loc=loc, ip=ip))
...
class LLVMFuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, function_type, *, sym_visibility=None, linkage=None, dso_local=None, CConv=None, comdat=None, convergent=None, personality=None, garbageCollector=None, passthrough=None, arg_attrs=None, res_attrs=None, function_entry_count=None, memory_effects=None, visibility_=None, arm_streaming=None, arm_locally_streaming=None, arm_streaming_compatible=None, arm_new_za=None, arm_in_za=None, arm_out_za=None, arm_inout_za=None, arm_preserves_za=None, section=None, unnamed_addr=None, alignment=None, vscale_range=None, frame_pointer=None, target_cpu=None, tune_cpu=None, target_features=None, unsafe_fp_math=None, no_infs_fp_math=None, no_nans_fp_math=None, approx_func_fp_math=None, no_signed_zeros_fp_math=None, denormal_fp_math=None, denormal_fp_math_f32=None, fp_contract=None, no_inline=None, always_inline=None, no_unwind=None, will_return=None, optimize_none=None, vec_type_hint=None, work_group_size_hint=None, reqd_work_group_size=None, intel_reqd_sub_group_size=None, uwtable_kind=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_888')) else
      _ods_ir.AttrBuilder.get('anonymous_888')(function_type, context=_ods_context))
...
def intr_ldexp(res, val, power, *, fastmath_flags=None, loc=None, ip=None) -> _ods_ir.Value:
...
def load(res, addr, *, alignment=None, volatile_=None, nontemporal=None, invariant=None, invariant_group=None, ordering=None, syncscope=None, dereferenceable=None, access_groups=None, alias_scopes=None, noalias_scopes=None, tbaa=None, loc=None, ip=None) -> _ods_ir.Value:
...
def module_flags(flags, *, loc=None, ip=None) -> _ods_ir.Operation:
...
class PtrMaskOp(_ods_ir.OpView):
  ...
  def __init__(self, ptr, mask, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def intr_ptrmask(ptr, mask, *, loc=None, ip=None) -> _ods_ir.Value:
  return PtrMaskOp(ptr=ptr, mask=mask, loc=loc, ip=ip).result
...
def intr_tan(in_, *, fastmath_flags=None, loc=None, ip=None) -> _ods_ir.Value:
  return TanOp(in_=in_, fastmathFlags=fastmath_flags, loc=loc, ip=ip).result
