...
_EXAMPLE = _descriptor.Descriptor(
  name='Example',
  full_name='data_serialize.Example',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='features', full_name='data_serialize.Example.features', index=0,
...
_SEQUENCEEXAMPLE = _descriptor.Descriptor(
  ...
  full_name='data_serialize.SequenceExample',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='context', full_name='data_serialize.SequenceExample.context', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='feature_lists', full_name='data_serialize.SequenceExample.feature_lists', index=1,
