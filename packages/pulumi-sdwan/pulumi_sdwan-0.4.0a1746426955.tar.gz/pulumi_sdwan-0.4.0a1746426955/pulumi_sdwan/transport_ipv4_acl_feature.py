...
__all__ = ['TransportIpv4AclFeatureArgs', 'TransportIpv4AclFeature']
...
class TransportIpv4AclFeatureArgs:
    ...
    @property
    @pulumi.getter
    def sequences(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['TransportIpv4AclFeatureSequenceArgs']]]]:
        """
        Access Control List
        """
    ...
    @sequences.setter
    def sequences(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['TransportIpv4AclFeatureSequenceArgs']]]]):
        pulumi.set(self, "sequences", value)


@pulumi.input_type
class _TransportIpv4AclFeatureState:
    def __init__(__self__, *,
                 default_action: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
...
class TransportIpv4AclFeature(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 sequences: Optional[pulumi.Input[Sequence[pulumi.Input[Union['TransportIpv4AclFeatureSequenceArgs', 'TransportIpv4AclFeatureSequenceArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[builtins.str] feature_profile_id: Feature Profile ID
        :param pulumi.Input[builtins.str] name: The name of the Feature
        :param pulumi.Input[Sequence[pulumi.Input[Union['TransportIpv4AclFeatureSequenceArgs', 'TransportIpv4AclFeatureSequenceArgsDict']]]] sequences: Access Control List
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TransportIpv4AclFeatureArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TransportIpv4AclFeatureArgs.__new__(TransportIpv4AclFeatureArgs)
        ...
        super(TransportIpv4AclFeature, __self__).__init__(
            'sdwan:index/transportIpv4AclFeature:TransportIpv4AclFeature',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            sequences: Optional[pulumi.Input[Sequence[pulumi.Input[Union['TransportIpv4AclFeatureSequenceArgs', 'TransportIpv4AclFeatureSequenceArgsDict']]]]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'TransportIpv4AclFeature':
        """
        ...
        __props__ = _TransportIpv4AclFeatureState.__new__(_TransportIpv4AclFeatureState)
        ...
        return TransportIpv4AclFeature(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def sequences(self) -> pulumi.Output[Optional[Sequence['outputs.TransportIpv4AclFeatureSequence']]]:
        """
        Access Control List
        """
        return pulumi.get(self, "sequences")
