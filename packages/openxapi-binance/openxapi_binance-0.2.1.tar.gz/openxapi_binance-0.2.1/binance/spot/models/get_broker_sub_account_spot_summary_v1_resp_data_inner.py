...
class GetBrokerSubAccountSpotSummaryV1RespDataInner(BaseModel):
    """
    GetBrokerSubAccountSpotSummaryV1RespDataInner
    """ # noqa: E501
    sub_account_id: Optional[StrictStr] = Field(default=None, alias="subAccountId")
    total_balance_of_btc: Optional[StrictStr] = Field(default=None, alias="totalBalanceOfBtc")
    __properties: ClassVar[List[str]] = ["subAccountId", "totalBalanceOfBtc"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "totalBalanceOfBtc": obj.get("totalBalanceOfBtc")
        })
        return _obj
