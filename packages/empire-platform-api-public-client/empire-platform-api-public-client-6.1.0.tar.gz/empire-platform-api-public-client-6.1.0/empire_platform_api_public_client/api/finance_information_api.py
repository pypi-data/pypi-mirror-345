...
class FinanceInformationApi:
    ...
    def get_finance_information(
        ...
        """get_finance_information

        Fetch current Finance Information for a Participant  ---  __Requires Permission:__ (at least one)   * `VIEW_ANY_ORGANISATIONS`   * `VIEW_OWN_ORGANISATIONS`
        ...
        _param = self._get_finance_information_serialize(
    ...
    @validate_call
    def get_finance_information_with_http_info(
        self,
        x_participant_id: Annotated[StrictStr, Field(description="Internal ID of a Participant-type Organisation")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FinanceInformation]:
        """get_finance_information
    ...
    @validate_call
    def get_finance_information_without_preload_content(
        self,
        x_participant_id: Annotated[StrictStr, Field(description="Internal ID of a Participant-type Organisation")],
        _request_timeout: Union[
            None,
    ...
    def _get_finance_information_serialize(
        self,
        x_participant_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/finance-information',
