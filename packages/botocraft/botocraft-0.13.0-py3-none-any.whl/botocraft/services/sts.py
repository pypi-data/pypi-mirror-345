...
class AssumeRoleManager(Boto3ModelManager):
    ...
    def assume(
        ...
        RoleSessionName: str,
        *,
        PolicyArns: Optional[List["STSPolicyDescriptorType"]] = None,
        ...
        ProvidedContexts: Optional[List["STSProvidedContext"]] = None
    ) -> "AssumeRole":
        """
    ...
    def assume_with_saml(
        ...
        *,
        ...
        results: Optional["AssumeRole"] = None
        if response is not None:
            results = response

        self.sessionize(results)
        return cast(Optional["AssumeRole"], results)
...
class AssumeRole(ReadonlyPrimaryBoto3Model):
    ...
    token.
    """
    AssumedRoleUser: Optional[STSAssumedRoleUser] = None
    """
    The Amazon Resource Name (ARN) and the assumed role ID, which are identifiers that you can use to refer to the
    resulting temporary security credentials.
    ...
    called ``AssumeRole``.
    """
    PackedPolicySize: Optional[int] = None
    """
    A percentage value that indicates the packed size of the session policies and session tags combined passed in the
    request.

    The request fails if the packed size is greater than 100 percent, which means the policies and tags exceeded the
    allowed space.
    """
    SourceIdentity: Optional[str] = None
    """
    ...
    def pk(self) -> Optional[str]:
        """
        Return the primary key of the model.   This is the value of the :py:attr:`Credentials.AccessKeyId` attribute.
    ...
    def arn(self) -> Optional[str]:
        """
        Return the ARN of the model.   This is the value of the :py:attr:`AssumedRoleUser.Arn` attribute.
...
class CallerIdentity(ReadonlyPrimaryBoto3Model):
    ...
    The exact value depends on the type of entity that is making the call. The values returned are those listed in the
    ...
    **Policy Variables** reference page in the *IAM User Guide*.
    ...
    def pk(self) -> Optional[str]:
        """
        Return the primary key of the model.   This is the value of the :py:attr:`Account` attribute.
    ...
    def name(self) -> Optional[str]:
        """
        Return the name of the model.   This is the value of the :py:attr:`UserId` attribute.
...
class STSProvidedContext(Boto3Model):
    ...
    This includes the signed and encrypted trusted context assertion and the context provider ARN from which the trusted
...
class AssumeRoleWithSAMLResponse(Boto3Model):
    ...
    """
    NameQualifier: Optional[str] = None
    """
...
class AssumeRoleWithWebIdentityResponse(Boto3Model):
    ...
    """
    SubjectFromWebIdentityToken: Optional[str] = None
    """
