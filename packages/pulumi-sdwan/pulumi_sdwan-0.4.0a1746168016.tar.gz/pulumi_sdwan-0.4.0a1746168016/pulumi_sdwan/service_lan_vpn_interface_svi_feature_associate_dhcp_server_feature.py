...
__all__ = ['ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeatureArgs', 'ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeature']

@pulumi.input_type
class ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeatureArgs:
    def __init__(__self__, *,
                 feature_profile_id: pulumi.Input[builtins.str],
                 service_dhcp_server_feature_id: pulumi.Input[builtins.str],
                 service_lan_vpn_feature_id: pulumi.Input[builtins.str],
                 service_lan_vpn_interface_svi_feature_id: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] service_lan_vpn_interface_svi_feature_id: Service LAN VPN Interface SVI Feature ID
        """
    ...
    def service_lan_vpn_interface_svi_feature_id(self) -> pulumi.Input[builtins.str]:
        """
        Service LAN VPN Interface SVI Feature ID
        """
        return pulumi.get(self, "service_lan_vpn_interface_svi_feature_id")

    @service_lan_vpn_interface_svi_feature_id.setter
    def service_lan_vpn_interface_svi_feature_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "service_lan_vpn_interface_svi_feature_id", value)


@pulumi.input_type
class _ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeatureState:
    def __init__(__self__, *,
                 ...
                 service_lan_vpn_interface_svi_feature_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="serviceLanVpnInterfaceSviFeatureId")
    def service_lan_vpn_interface_svi_feature_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Service LAN VPN Interface SVI Feature ID
        """
        return pulumi.get(self, "service_lan_vpn_interface_svi_feature_id")
    ...
    @service_lan_vpn_interface_svi_feature_id.setter
    def service_lan_vpn_interface_svi_feature_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_lan_vpn_interface_svi_feature_id", value)
...
class ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeature(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeatureArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource can manage a Service LAN VPN Interface SVI Feature Associate DHCP Server Feature .
          - Minimum SD-WAN Manager version: `20.12.0`
        ...
        :param str resource_name: The name of the resource.
        :param ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeatureArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeatureArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeatureArgs.__new__(ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeatureArgs)
    ...
    def get(resource_name: str,
            ...
            service_lan_vpn_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            service_lan_vpn_interface_svi_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeature':
        """
        ...
        __props__ = _ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeatureState.__new__(_ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeatureState)
    ...
    @property
    @pulumi.getter(name="serviceLanVpnInterfaceSviFeatureId")
    def service_lan_vpn_interface_svi_feature_id(self) -> pulumi.Output[builtins.str]:
        """
        Service LAN VPN Interface SVI Feature ID
        """
        return pulumi.get(self, "service_lan_vpn_interface_svi_feature_id")
