...
class PulpAnsibleApiV3PluginAnsibleContentCollectionsApi(object):
    ...
    def read(self, distro_base_path, path,  **kwargs):  # noqa: E501
        """read  # noqa: E501

        ViewSet for Repository Metadata.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(distro_base_path, path, async_req=True)
        >>> result = thread.get()
        ...
        return self.read_with_http_info(distro_base_path, path,  **kwargs)  # noqa: E501

    def read_with_http_info(self, distro_base_path, path,  **kwargs):  # noqa: E501
        """read  # noqa: E501

        ViewSet for Repository Metadata.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(distro_base_path, path, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(RepoMetadataResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/{path}/api/v3/plugin/ansible/content/{distro_base_path}/collections/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='RepoMetadataResponse',  # noqa: E501
