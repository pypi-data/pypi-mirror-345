...
class GetLeverageBracketV2RespItem(BaseModel):
    """
    GetLeverageBracketV2RespItem
    """ # noqa: E501
    brackets: Optional[List[GetLeverageBracketV1RespItemBracketsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "brackets": [GetLeverageBracketV1RespItemBracketsInner.from_dict(_item) for _item in obj["brackets"]] if obj.get("brackets") is not None else None,
