...
class EvolutionaryStructureExplorer:
    ...
    def setup_evolution_parameters(self, params: dict = None):
        ...
        serializable_keys = [
            ...
            'multiobjective_params', 'thermostat_params', 'convergence_params', 
    ...
    def _validate_candidates(self, structures: list) -> list:
        ...
        validate = self.BO.validate if self.BO else lambda *args, **kwargs: True
    ...
    def _execute_physical_model(self, structures, temperature, generation:int=None):
        ...
        generation_partition.containers = no_collision_unique_valid_structures
    ...
    def run(self, partition_path:str='.', debug=False):
        ...
        for generation in range(1, self._max_generations + 1):
            ...
            self.partitions['generation'] = self._execute_physical_model(new_structures, temperature)
            ...
            self._update_main_dataset(self.partitions['generation'].containers, generation)
