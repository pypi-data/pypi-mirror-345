...
class AuctionBatch(BaseModel):
    """
    Paginated results of auctions matching the filter parameters.
    """ # noqa: E501
    entries: List[Auction]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [Auction.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
