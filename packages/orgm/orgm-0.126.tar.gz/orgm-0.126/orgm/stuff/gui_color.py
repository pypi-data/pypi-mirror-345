...
CLASE_BOTON_PRIMARIO = "bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
CLASE_BOTON_CANCELAR = "bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded"
CLASE_BOTON_EXITO = "bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded"
