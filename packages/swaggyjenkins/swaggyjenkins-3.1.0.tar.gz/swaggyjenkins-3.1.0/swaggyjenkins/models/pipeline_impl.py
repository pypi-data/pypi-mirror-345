...
class PipelineImpl(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_class", "displayName", "estimatedDurationInMillis", "fullName", "latestRun", "name", "organization", "weatherScore", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": PipelineImpllinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
