...
from empire_platform_api_public_client_legacy.models.default_nomination_options import DefaultNominationOptions  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DefaultNominationOptions:
        ...
        if include_optional:
            return DefaultNominationOptions(
                mtu_sizes = [
                    empire_platform_api_public_client_legacy.models.mtu_size_per_timescale.MtuSizePerTimescale(
                        timescale = 'LONG_TERM', 
