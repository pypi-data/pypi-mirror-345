...
def lazy_import():
    from sifflet_sdk.client.model.public_get_asset_list_dto import PublicGetAssetListDto

    globals()["PublicGetAssetListDto"] = PublicGetAssetListDto


class PublicPageDtoPublicGetAssetListDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([PublicGetAssetListDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """PublicPageDtoPublicGetAssetListDto - a model defined in OpenAPI

        Args:
            data ([PublicGetAssetListDto]):
