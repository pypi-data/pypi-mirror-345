...
class NetworkFirewallClient(AioBaseClient):
    ...
    async def get_analysis_report_results(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_network_firewall/client/#get_analysis_report_results)
        """
    ...
    async def list_analysis_reports(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_network_firewall/client/#list_analysis_reports)
        """
    ...
    async def update_firewall_analysis_settings(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_network_firewall/client/#update_firewall_analysis_settings)
        """
