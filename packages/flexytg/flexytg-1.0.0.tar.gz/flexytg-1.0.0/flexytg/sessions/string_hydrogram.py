#Function To Pack And Unpack hydrogram String Sessions
...
#Defs
def string_hydrogram(dc_id=None,api_id=None,test_mode=0,auth_key=None,date=int(time.time()),user_id=None,is_bot=0):
...
def unstring_hydrogram(string_session=None):
    if string_session:
