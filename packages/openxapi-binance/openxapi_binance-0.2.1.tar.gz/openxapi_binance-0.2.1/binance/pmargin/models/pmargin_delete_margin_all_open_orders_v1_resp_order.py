...
class PmarginDeleteMarginAllOpenOrdersV1RespOrder(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clientOrderId", "cummulativeQuoteQty", "executedQty", "icebergQty", "orderId", "orderListId", "origClientOrderId", "origQty", "price", "side", "status", "stopPrice", "symbol", "timeInForce", "type"]
