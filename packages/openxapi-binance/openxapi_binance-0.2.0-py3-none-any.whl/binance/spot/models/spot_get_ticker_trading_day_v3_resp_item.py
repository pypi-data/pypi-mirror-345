...
class SpotGetTickerTradingDayV3RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["closeTime", "count", "firstId", "highPrice", "lastId", "lastPrice", "lowPrice", "openPrice", "openTime", "priceChange", "priceChangePercent", "quoteVolume", "symbol", "volume", "weightedAvgPrice"]
