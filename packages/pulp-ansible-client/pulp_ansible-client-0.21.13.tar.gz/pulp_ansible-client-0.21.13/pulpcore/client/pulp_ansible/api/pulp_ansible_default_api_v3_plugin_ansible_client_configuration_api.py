...
class PulpAnsibleDefaultApiV3PluginAnsibleClientConfigurationApi(object):
    ...
    def read(self,  **kwargs):  # noqa: E501
        ...
        Return configurations for the ansible-galaxy client.  # noqa: E501
    ...
    def read_with_http_info(self,  **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ClientConfigurationResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/default/api/v3/plugin/ansible/client-configuration/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='ClientConfigurationResponse',  # noqa: E501
