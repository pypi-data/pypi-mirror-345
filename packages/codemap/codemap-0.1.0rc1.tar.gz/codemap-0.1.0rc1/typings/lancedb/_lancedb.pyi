...
from .index import BTree, Bitmap, FTS, HnswPq, HnswSq, IvfFlat, IvfPq, LabelList
from .remote import ClientConfig

class Connection:
    uri: str
    async def table_names(self, start_after: Optional[str], limit: Optional[int]) -> list[str]:
        ...
    
    async def create_table(self, name: str, mode: str, data: pa.RecordBatchReader, storage_options: Optional[Dict[str, str]] = ...) -> Table:
        ...
    
    async def create_empty_table(self, name: str, mode: str, schema: pa.Schema, storage_options: Optional[Dict[str, str]] = ...) -> Table:
        ...
...
class Table:
    ...
    async def add(self, data: pa.RecordBatchReader, mode: Literal["append", "overwrite"]) -> None:
        ...
    ...
    async def create_index(self, column: str, index: Union[IvfFlat, IvfPq, HnswPq, HnswSq, BTree, Bitmap, LabelList, FTS], replace: Optional[bool]):
        ...
    ...
    async def optimize(self, *, cleanup_since_ms: Optional[int] = ..., delete_unverified: Optional[bool] = ...) -> OptimizeStats:
        ...
...
async def connect(uri: str, api_key: Optional[str], region: Optional[str], host_override: Optional[str], read_consistency_interval: Optional[float], client_config: Optional[Union[ClientConfig, Dict[str, Any]]], storage_options: Optional[Dict[str, str]]) -> Connection:
    ...
