...
class ApplianceSingleLanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] appliance_ip: The local IP of the appliance on the single LAN
        ...
        :param pulumi.Input[builtins.str] subnet: The subnet of the single LAN
        """
...
class ApplianceSingleLan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            mandatory_dhcp: Optional[pulumi.Input[Union['ApplianceSingleLanMandatoryDhcpArgs', 'ApplianceSingleLanMandatoryDhcpArgsDict']]] = None,
            network_id: Optional[pulumi.Input[builtins.str]] = None,
            subnet: Optional[pulumi.Input[builtins.str]] = None) -> 'ApplianceSingleLan':
        """
