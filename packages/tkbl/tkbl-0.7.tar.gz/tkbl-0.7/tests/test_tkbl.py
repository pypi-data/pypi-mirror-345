...
class TestTkbl(unittest.TestCase):
    def test_filter_by_uniformat_code_valid(self):
        ...
        expected_output = [
            {
                'category': 'Construction and Building Supplies',
                'subcategory': 'Skylights',
                'title': '',
                'uniformat code': 'B202001',
                'uniformat description': 'WINDOWS',
                'url': 'https://sftool.gov/greenprocurement/green-products/1/construction-building-supplies/1591/skylights/0?addon=False'
            },
            {
                'category': 'Construction and Building Supplies',
                ...
                'uniformat code': 'B202001',
                'uniformat description': 'WINDOWS',
                'url': 'https://sftool.gov/greenprocurement/green-products/1/construction-building-supplies/1827/storm-windows/0?addon=False'
            },
            {
                'category': 'Construction and Building Supplies',
                'subcategory': 'Windows',
                ...
                'uniformat code': 'B202001',
                'uniformat description': 'WINDOWS',
                'url': 'https://sftool.gov/greenprocurement/green-products/1/construction-building-supplies/272/windows/0?addon=False'
            },
            {
                'category': 'ESTCP',
                'subcategory': '',
                'title': 'Kinetic Super-Resolution Long-Wave Infrared Thermography Diagnostic for Building Envelopes',
                'uniformat code': 'B202001',
                'uniformat description': 'WINDOWS',
                'url': 'https://serdp-estcp.mil/projects/details/f89309bd-1f07-4cb6-8507-e59f2e7fc7c0'
            }
        ]
