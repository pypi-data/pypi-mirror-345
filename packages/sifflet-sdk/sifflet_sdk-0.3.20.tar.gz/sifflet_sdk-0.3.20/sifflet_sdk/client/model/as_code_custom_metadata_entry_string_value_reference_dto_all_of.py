...
class AsCodeCustomMetadataEntryStringValueReferenceDtoAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AsCodeCustomMetadataEntryStringValueReferenceDtoAllOf - a model defined in OpenAPI
