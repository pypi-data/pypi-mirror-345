    ...
    def draw_trajectories_on_kymo(self):
        ...
        for idx, traj in enumerate(self.navigator.trajectoryCanvas.trajectories):
            ...
            if self.color_by_column is not None:
                ...
                main_color = "#FFC107" if val else "magenta"
            ...
            for (cx, cy, suf), sign in [((x0, y0, 'A'), -1), ((x1, y1, 'B'), +1)]:
                ...
                lbl = ax.annotate(
                    ...
                    ha='center', va='center',
                    color=textcolor, fontsize=(24*72.0/self.fig.get_dpi()), #previously 8pt
                    bbox=dict(
    ...
    def draw_trajectories_on_movie(self):
        ...
        if original_coords:
            ...
            start_label = self.ax.annotate(
                ...
                color='white',
                fontsize=(30*72.0/self.fig.get_dpi()), #previously 10pt
                ha="center",
                va="center",
...
class IntensityCanvas(FigureCanvas):
    ...
    def plot_intensity(self, frames, intensities, avg_intensity=None, median_intensity=None,
        ...
        self.ax_bottom.set_ylabel("Intensity (AU)", fontsize=(32*72.0/dpi)) #previously 12pt
        self.ax_bottom.set_xlabel("Frame", fontsize=(32*72.0/dpi)) #previously 12pt
        ...
        legend = self.ax_bottom.legend(
            loc="upper right",
            fontsize=(30*72.0/dpi), #previously 10pt
            frameon=True,
            labelspacing=0.5,
            handlelength=2
        )
...
class HistogramCanvas(FigureCanvas):
    ...
    def _do_update_histogram(self, image, center, crop_size, sigma=None, intensity=None, background=None):
        ...
        self.ax.clear()
        self.ax.set_facecolor("white")
        self.ax.set_xlabel("Pixel Intensity", fontsize=(32*72.0/dpi)) #previously 12pt
        self.ax.set_ylabel("Count", fontsize=(32*72.0/dpi))
...
class VelocityCanvas(FigureCanvas):
    ...
    def plot_velocity_histogram(self, velocities, ax=None):
        ...
        if valid_velocities and self.navigator.pixel_size is not None and self.navigator.frame_interval is not None:
            ...
            ax.set_xlabel("Speed (μm/s)", fontsize=(32*72.0/dpi)) #previously 12pt
        else:
            ax.set_xlabel("Speed (px/frame)", fontsize=(32*72.0/dpi)) #previously 12pt

        ax.set_ylabel("Count", fontsize=(32*72.0/dpi)) #previously 12pt
