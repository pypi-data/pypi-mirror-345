...
""" Standard plug-in to tell SajadQ about implicit imports.
...
from SajadMr.plugins.YamlPluginBase import SajadQYamlPluginBase
from SajadMr.utils.ModuleNames import ModuleName
from SajadMr.utils.Utils import isMacOS, isWin32Windows


class SajadQPluginImplicitImports(SajadQYamlPluginBase):
    ...
    def __init__(self):
        SajadQYamlPluginBase.__init__(self)
    ...
    def onModuleSourceCode(self, module_name, source_filename, source_code):
        ...
        if module_name == "site":
            ...
            source_code = """\
__file__ = (__SajadMr_binary_dir + '%ssite.py') if '__SajadMr_binary_dir' in dict(__builtins__ ) else '<frozen>';%s""" % (
                os.path.sep,
                source_code,
            )
...
def makeExpressionImportModuleNameHardExistsAfterImportFactory(
    ...
    from SajadMr.HardImportRegistry import trust_node_factory
    from SajadMr.nodes.ImportHardNodes import (
