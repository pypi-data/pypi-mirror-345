...
class SoundcloudAsyncAPI:
    ...
    async def get_following(self, own_user_id: str, limit: int = 120) -> dict[str, Any]:
    ...
    async def get_recommended_users(self, limit: int = 5) -> dict[str, Any]:
    ...
    async def get_last_track_info(self, limit: int = 1) -> dict[str, Any]:
    ...
    async def get_track_likes_users(self, track_id: str) -> dict[str, Any]:
    ...
    async def get_track_by_genre_popular(self, genre: str, limit: int = 10) -> dict[str, Any]:
    ...
    async def get_tracks_from_user(self, user_id: str, limit: int = 10) -> dict[str, Any]:
    ...
    async def get_popular_tracks_user(self, user_id: str, limit: int = 12) -> dict[str, Any]:
    ...
    async def get_playlists_by_genre(self, genre: str, limit: int = 10) -> dict[str, Any]:
    ...
    async def get_playlists_from_user(self, user_id: str, limit: int = 10) -> dict[str, Any]:
    ...
    async def get_mixed_selection(self, limit: int = 5) -> dict[str, Any]:
    ...
    async def search(self, query_string: str, limit: int = 25) -> dict[str, Any]:
        """Search.
    ...
    async def get_subscribe_feed(self, limit: int = 10) -> dict[str, Any]:
        """Get subscribe feed."""
        return await self.get(
    ...
    async def get_album_from_user(self, user_id: str, limit: int = 5) -> dict[str, Any]:
        """Get album from user.
    ...
    async def get_all_feed_user(self, user_id: str, limit: int = 20) -> dict[str, Any]:
