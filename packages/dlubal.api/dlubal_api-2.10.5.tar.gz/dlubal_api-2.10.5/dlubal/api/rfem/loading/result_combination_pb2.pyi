...
class ResultCombination(_message.Message):
    ...
    class ItemsRow(_message.Message):
        ...
        operator_type: ResultCombination.ItemsRow.Operator
        left_parenthesis: bool
        right_parenthesis: bool
        group_factor: float
        case_object_factor: float
        case_object_sub_result_type: ResultCombination.ItemsRow.CaseObjectSubResult
    ...
    def __init__(self, no: _Optional[int] = ..., design_situation: _Optional[int] = ..., user_defined_name_enabled: bool = ..., name: _Optional[str] = ..., to_solve: bool = ..., comment: _Optional[str] = ..., combination_type: _Optional[_Union[ResultCombination.CombinationType, str]] = ..., srss_combination: bool = ..., srss_extreme_value_sign: _Optional[_Union[ResultCombination.SrssExtremeValueSign, str]] = ..., srss_use_equivalent_linear_combination: bool = ..., srss_according_load_case_or_combination: _Optional[int] = ..., items: _Optional[_Union[ResultCombination.ItemsTable, _Mapping]] = ..., combination_rule_str: _Optional[str] = ..., generate_subcombinations: bool = ..., load_duration: _Optional[_Union[ResultCombination.LoadDuration, str]] = ..., is_generated: bool = ..., consider_construction_stage: _Optional[int] = ..., consider_construction_stage_active: bool = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...
