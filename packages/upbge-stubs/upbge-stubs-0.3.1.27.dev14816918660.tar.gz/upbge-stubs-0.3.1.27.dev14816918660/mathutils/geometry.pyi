...
def barycentric_transform(point: mathutils.Vector, tri_a1: mathutils.Vector, tri_a2: mathutils.Vector, tri_a3: mathutils.Vector, tri_b1: mathutils.Vector, tri_b2: mathutils.Vector, tri_b3: mathutils.Vector) -> mathutils.Vector:
...
def box_fit_2d(points: typing.Any) -> float:
...
def box_pack_2d(boxes: typing.Any) -> typing.Any:
...
def convex_hull_2d(points: typing.Any) -> typing.List[int]:
...
def delaunay_2d_cdt(vert_coords: typing.Any, edges: typing.Any, faces: typing.Any, output_type: int, epsilon: float, need_ids: typing.Any = True) -> typing.Any:
...
def intersect_line_line(v1: mathutils.Vector, v2: mathutils.Vector, v3: mathutils.Vector, v4: mathutils.Vector) -> typing.Any:
...
def intersect_line_sphere(line_a: mathutils.Vector, line_b: mathutils.Vector, sphere_co: mathutils.Vector, sphere_radius: float, clip: typing.Any = True) -> typing.Any:
...
def intersect_line_sphere_2d(line_a: mathutils.Vector, line_b: mathutils.Vector, sphere_co: mathutils.Vector, sphere_radius: float, clip: typing.Any = True) -> typing.Any:
...
def intersect_plane_plane(plane_a_co: mathutils.Vector, plane_a_no: mathutils.Vector, plane_b_co: mathutils.Vector, plane_b_no: mathutils.Vector) -> typing.Any:
...
def intersect_sphere_sphere_2d(p_a: mathutils.Vector, radius_a: float, p_b: mathutils.Vector, radius_b: float) -> typing.Any:
...
def normal(vectors: typing.Any) -> mathutils.Vector:
...
def points_in_planes(planes: typing.List[mathutils.Vector], epsilon_coplanar: float = 0.0001, epsilon_isect: float = 1e-06) -> typing.Any:
...
def tessellate_polygon(polylines: typing.Any) -> typing.Any:
