...
class ServiceConnectionArgs:
    def __init__(__self__, *,
                 ipsec_tunnel: pulumi.Input[builtins.str],
                 region: pulumi.Input[builtins.str],
                 backup_sc: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 no_export_community: Optional[pulumi.Input[builtins.str]] = None,
                 onboarding_type: Optional[pulumi.Input[builtins.str]] = None,
                 protocol: Optional[pulumi.Input['ServiceConnectionProtocolArgs']] = None,
                 qos: Optional[pulumi.Input['ServiceConnectionQosArgs']] = None,
                 secondary_ipsec_tunnel: Optional[pulumi.Input[builtins.str]] = None,
                 source_nat: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] ipsec_tunnel: The IpsecTunnel param.
        :param pulumi.Input[builtins.str] region: The Region param.
        :param pulumi.Input[builtins.str] backup_sc: The BackupSC param.
        :param pulumi.Input['ServiceConnectionBgpPeerArgs'] bgp_peer: The BgpPeer param.
        :param pulumi.Input[builtins.str] folder: The Folder param. String can either be a specific string(`"Service Connections"`) or match this regex: `^[0-9a-zA-Z._\\s-]{1,}$`. Default: `"Service Connections"`.
        :param pulumi.Input[builtins.str] name: The Name param.
        :param pulumi.Input[builtins.str] nat_pool: The NatPool param.
        :param pulumi.Input[builtins.str] no_export_community: The NoExportCommunity param. String must be one of these: `"Disabled"`, `"Enabled-In"`, `"Enabled-Out"`, `"Enabled-Both"`.
        :param pulumi.Input[builtins.str] onboarding_type: The OnboardingType param. String must be one of these: `"classic"`. Default: `"classic"`.
        ...
        :param pulumi.Input[builtins.str] secondary_ipsec_tunnel: The SecondaryIpsecTunnel param.
        :param pulumi.Input[builtins.bool] source_nat: The SourceNat param.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnets: The Subnets param.
        """
    ...
    def ipsec_tunnel(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ipsec_tunnel.setter
    def ipsec_tunnel(self, value: pulumi.Input[builtins.str]):
    ...
    def backup_sc(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The BackupSC param.
        """
    ...
    @backup_sc.setter
    def backup_sc(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def no_export_community(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def no_export_community(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "no_export_community", value)

    @property
    @pulumi.getter(name="onboardingType")
    def onboarding_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def onboarding_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def secondary_ipsec_tunnel(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def secondary_ipsec_tunnel(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "secondary_ipsec_tunnel", value)

    @property
    @pulumi.getter(name="sourceNat")
    def source_nat(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        The SourceNat param.
        """
    ...
    @source_nat.setter
    def source_nat(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ServiceConnectionState:
    def __init__(__self__, *,
                 backup_sc: Optional[pulumi.Input[builtins.str]] = None,
                 bgp_peer: Optional[pulumi.Input['ServiceConnectionBgpPeerArgs']] = None,
                 encrypted_values: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 folder: Optional[pulumi.Input[builtins.str]] = None,
                 ipsec_tunnel: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 nat_pool: Optional[pulumi.Input[builtins.str]] = None,
                 no_export_community: Optional[pulumi.Input[builtins.str]] = None,
                 onboarding_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] backup_sc: The BackupSC param.
        :param pulumi.Input['ServiceConnectionBgpPeerArgs'] bgp_peer: The BgpPeer param.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] encrypted_values: (Internal use) Encrypted values returned from the API.
        :param pulumi.Input[builtins.str] folder: The Folder param. String can either be a specific string(`"Service Connections"`) or match this regex: `^[0-9a-zA-Z._\\s-]{1,}$`. Default: `"Service Connections"`.
        :param pulumi.Input[builtins.str] ipsec_tunnel: The IpsecTunnel param.
        :param pulumi.Input[builtins.str] name: The Name param.
        :param pulumi.Input[builtins.str] nat_pool: The NatPool param.
    ...
    def encrypted_values(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def encrypted_values(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    @property
    @pulumi.getter(name="ipsecTunnel")
    def ipsec_tunnel(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IpsecTunnel param.
        """
        return pulumi.get(self, "ipsec_tunnel")
    ...
    @ipsec_tunnel.setter
    def ipsec_tunnel(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipsec_tunnel", value)
...
class ServiceConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_nat: Optional[pulumi.Input[builtins.bool]] = None,
            subnets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tfid: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceConnection':
        """
    ...
    @property
    @pulumi.getter(name="backupSC")
    def backup_sc(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The BackupSC param.
        """
        return pulumi.get(self, "backup_sc")
    ...
    @property
    @pulumi.getter(name="encryptedValues")
    def encrypted_values(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        (Internal use) Encrypted values returned from the API.
        """
        return pulumi.get(self, "encrypted_values")
    ...
    @property
    @pulumi.getter(name="ipsecTunnel")
    def ipsec_tunnel(self) -> pulumi.Output[builtins.str]:
        """
        The IpsecTunnel param.
        """
        return pulumi.get(self, "ipsec_tunnel")
    ...
    @property
    @pulumi.getter(name="natPool")
    def nat_pool(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The NatPool param.
        """
        return pulumi.get(self, "nat_pool")
    ...
    @property
    @pulumi.getter(name="noExportCommunity")
    def no_export_community(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The NoExportCommunity param. String must be one of these: `"Disabled"`, `"Enabled-In"`, `"Enabled-Out"`, `"Enabled-Both"`.
        """
        return pulumi.get(self, "no_export_community")
    ...
    @property
    @pulumi.getter(name="onboardingType")
    def onboarding_type(self) -> pulumi.Output[builtins.str]:
        """
        The OnboardingType param. String must be one of these: `"classic"`. Default: `"classic"`.
        """
        return pulumi.get(self, "onboarding_type")
    ...
    @property
    @pulumi.getter(name="secondaryIpsecTunnel")
    def secondary_ipsec_tunnel(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The SecondaryIpsecTunnel param.
        """
        return pulumi.get(self, "secondary_ipsec_tunnel")
    ...
    @property
    @pulumi.getter(name="sourceNat")
    def source_nat(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The SourceNat param.
        """
        return pulumi.get(self, "source_nat")
