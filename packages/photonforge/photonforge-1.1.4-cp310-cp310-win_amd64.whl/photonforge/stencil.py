from .extension import linear_taper, mmi, grating, focused_grating, cross, ruler, vernier_scale
...
def as_component(
    *,
    layer: _typ.Union[str, _typ.Sequence],
    stencil: _typ.Literal[_stencils.keys()],
    ...
    **stencil_kwargs,
    ...
    for group_layer, group_structures in zip(layer, structures):
        try:
