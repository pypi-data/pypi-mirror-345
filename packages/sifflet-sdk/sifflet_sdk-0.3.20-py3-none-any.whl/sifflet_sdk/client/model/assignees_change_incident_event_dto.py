...
def lazy_import():
    from sifflet_sdk.client.model.assignees_change_incident_event_dto_all_of import (
        AssigneesChangeIncidentEventDtoAllOf,
    )
    ...
    globals()["AssigneesChangeIncidentEventDtoAllOf"] = AssigneesChangeIncidentEventDtoAllOf
    globals()["IncidentEventDto"] = IncidentEventDto
    globals()["UserDto"] = UserDto


class AssigneesChangeIncidentEventDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AssigneesChangeIncidentEventDto - a model defined in OpenAPI

        Keyword Args:
            first_date (int):
            last_date (int):
            new_assignees ([UserDto]):
            old_assignees ([UserDto]):
            date (int):
