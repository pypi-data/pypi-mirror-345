...
class CmfuturesDeleteBatchOrdersV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["activatePrice", "avgPrice", "clientOrderId", "closePosition", "cumBase", "cumQty", "executedQty", "orderId", "origQty", "origType", "positionSide", "price", "priceMatch", "priceProtect", "priceRate", "reduceOnly", "selfTradePreventionMode", "side", "status", "stopPrice", "symbol", "timeInForce", "type", "updateTime", "workingType"]
