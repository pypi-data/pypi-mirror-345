...
class SpotGetTicker24hrV3RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["askPrice", "askQty", "bidPrice", "bidQty", "closeTime", "count", "firstId", "highPrice", "lastId", "lastPrice", "lastQty", "lowPrice", "openPrice", "openTime", "prevClosePrice", "priceChange", "priceChangePercent", "quoteVolume", "symbol", "volume", "weightedAvgPrice"]
