...
class FeedbacksAnswerBody(object):
    ...
    def __init__(self, id=None, text=None):  # noqa: E501
        """FeedbacksAnswerBody - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._text = None
    ...
    @property
    def id(self):
        """Gets the id of this FeedbacksAnswerBody.  # noqa: E501

        ID otzyva  # noqa: E501

        :return: The id of this FeedbacksAnswerBody.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this FeedbacksAnswerBody.

        ID otzyva  # noqa: E501

        :param id: The id of this FeedbacksAnswerBody.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def text(self):
        """Gets the text of this FeedbacksAnswerBody.  # noqa: E501

        Tekst otveta  # noqa: E501

        :return: The text of this FeedbacksAnswerBody.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this FeedbacksAnswerBody.

        Tekst otveta  # noqa: E501

        :param text: The text of this FeedbacksAnswerBody.  # noqa: E501
        :type: str
        """
        if text is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FeedbacksAnswerBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeedbacksAnswerBody):
            return False
