...
class CentralizedPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the centralized policy
        :param pulumi.Input[Sequence[pulumi.Input['CentralizedPolicyDefinitionArgs']]] definitions: List of policy definitions
        :param pulumi.Input[builtins.str] name: The name of the centralized policy
        """
...
class CentralizedPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'CentralizedPolicy':
        """
