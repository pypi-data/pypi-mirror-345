...
from GooeyEx.gui import formatters, events
from GooeyEx.gui.util import wx_util
from GooeyEx.python_bindings.types import FormField
from GooeyEx.util.functional import getin, ifPresent
from GooeyEx.gui.validators import runValidator
...
class TextContainer(BaseWidget):
    ...
    def __init__(self, parent, widgetInfo, *args, **kwargs):
        ...
        self.help_text = AutoWrappedStaticText(
            self, label=widgetInfo["data"]["help"] or ""
        )
