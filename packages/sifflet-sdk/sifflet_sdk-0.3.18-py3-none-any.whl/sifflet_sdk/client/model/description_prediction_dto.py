...
class DescriptionPredictionDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, id, validation_status, *args, **kwargs):  # noqa: E501
        """DescriptionPredictionDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, id, validation_status, *args, **kwargs):  # noqa: E501
        """DescriptionPredictionDto - a model defined in OpenAPI
