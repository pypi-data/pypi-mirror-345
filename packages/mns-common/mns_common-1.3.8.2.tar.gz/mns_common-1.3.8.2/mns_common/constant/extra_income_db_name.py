...
# us stock 1分钟集合数据
US_STOCK_MINUTE_K_LINE_BFQ_C = 'us_stock_one_minute_k_line_bfq'

# us etf 1分钟集合数据
US_ETF_MINUTE_K_LINE_BFQ_C = 'us_etf_one_minute_k_line_bfq'

# hk stock daily_k_line
HK_STOCK_DAILY_QFQ_K_LINE = 'hk_stock_daily_qfq_k_line'
# hk stock 1分钟集合数据
HK_STOCK_MINUTE_K_LINE_BFQ_C = 'hk_stock_one_minute_k_line_bfq'
# hk etf 1分钟集合数据
HK_STOCK_MINUTE_K_LINE_BFQ_C = 'hk_etf_one_minute_k_line_bfq'
