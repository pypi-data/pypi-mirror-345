...
from heaserver.service.db import mongo, mongoservicelib, aws
...
from heaobject.root import Permission, Share, ShareImpl, DesktopObjectDict, desktop_object_type_for_name, PermissionContext, desktop_object_from_dict, DesktopObject
from heaobject.keychain import Credentials, CredentialsLifespanClass
from heaobject.activity import RecentlyAccessedView
from collections.abc import AsyncGenerator, Sequence, Awaitable, Collection, AsyncIterator
...
async def get_organization_accounts(request: web.Request) -> web.Response:
    ...
    async def gen() -> AsyncIterator[Coroutine[Any, Any, AccountView | None]]:
