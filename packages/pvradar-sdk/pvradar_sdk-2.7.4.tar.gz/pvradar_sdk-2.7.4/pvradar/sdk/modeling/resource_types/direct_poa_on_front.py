...
class direct_poa_on_front(ResourceTypeDescriptor):
    """The direct component of the solar irradiance incident on the front side of a photovoltaic (PV) module, accounting for the module's orientation and tilt. """
