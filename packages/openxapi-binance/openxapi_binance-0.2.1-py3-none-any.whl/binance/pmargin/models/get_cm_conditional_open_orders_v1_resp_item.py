...
class GetCmConditionalOpenOrdersV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["activatePrice", "bookTime", "newClientStrategyId", "origQty", "positionSide", "price", "priceRate", "reduceOnly", "side", "stopPrice", "strategyId", "strategyStatus", "strategyType", "symbol", "timeInForce", "updateTime"]
