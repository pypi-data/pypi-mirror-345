...
def lazy_import():
    from sifflet_sdk.client.model.public_source_v2_big_query_parameters_dto_all_of import (
        PublicSourceV2BigQueryParametersDtoAllOf,
    )
    from sifflet_sdk.client.model.public_source_v2_parameters_dto import (
        PublicSourceV2ParametersDto,
    )

    globals()["PublicSourceV2BigQueryParametersDtoAllOf"] = PublicSourceV2BigQueryParametersDtoAllOf
    globals()["PublicSourceV2ParametersDto"] = PublicSourceV2ParametersDto


class PublicSourceV2BigQueryParametersDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PublicSourceV2BigQueryParametersDto - a model defined in OpenAPI

        Keyword Args:
            project_id (str): Your BigQuery project ID
            type (str):
