...
class DomainUiLightDto(ModelNormal):
    ...
    allowed_values = {
        ("role",): {
            "EDITOR": "Editor",
            "MONITOR_RESPONDER": "Monitor responder",
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, is_all_domain, name, role, *args, **kwargs):  # noqa: E501
        """DomainUiLightDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, is_all_domain, name, role, *args, **kwargs):  # noqa: E501
        """DomainUiLightDto - a model defined in OpenAPI
