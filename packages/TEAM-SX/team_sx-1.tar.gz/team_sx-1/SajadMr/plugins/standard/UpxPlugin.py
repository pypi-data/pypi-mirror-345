...
from SajadMr.Options import isOnefileMode, isOnefileTempDirMode
from SajadMr.plugins.PluginBase import SajadQPluginBase
from SajadMr.utils.AppDirs import getCacheDir
from SajadMr.utils.Execution import executeToolChecked, getExecutablePath
from SajadMr.utils.FileOperations import copyFile, makePath
from SajadMr.utils.Hashing import Hash, getFileContentsHash
from SajadMr.utils.Utils import isLinux


class SajadQPluginUpx(SajadQPluginBase):
    ...
    plugin_name = "upx"  # SajadQ knows us by this name
