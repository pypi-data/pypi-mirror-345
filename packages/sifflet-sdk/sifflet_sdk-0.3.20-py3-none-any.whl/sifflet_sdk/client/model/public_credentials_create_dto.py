...
class PublicCredentialsCreateDto(ModelNormal):
    ...
    validations = {
        ("name",): {
            "regex": {
                "pattern": r"^[a-zA-Z][-a-zA-Z0-9]{0,125}[a-zA-Z]$",  # noqa: E501
            },
        },
    }
    ...
    def _from_openapi_data(cls, name, value, *args, **kwargs):  # noqa: E501
        """PublicCredentialsCreateDto - a model defined in OpenAPI

        Args:
            name (str): Name of credentials. Must start and end with a letter, and contain only letters, digits, and hyphens
            value (str): Value of credentials. Double quotes must be escaped with a backslash.
        ...
        Keyword Args:
            ...
            description (str): Description of credentials. [optional]  # noqa: E501
        """
