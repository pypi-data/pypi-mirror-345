...
Refer to the Terraform Registry for docs: [`data_cloudflare_cloudforce_one_request_message`](https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/cloudforce_one_request_message).
'''
...
class DataCloudflareCloudforceOneRequestMessage(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_identifier: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/cloudforce_one_request_message#account_identifier DataCloudflareCloudforceOneRequestMessage#account_identifier}
        :param request_identifier: UUID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/data-sources/cloudforce_one_request_message#request_identifier DataCloudflareCloudforceOneRequestMessage#request_identifier}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def account_identifier(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__227642867ab7b0ac00070d84c15b98f89e899068eb9c9ee69208749c735a9e8b)
    ...
    def request_identifier(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b50b6927c5f7cfd28df1fdabb2af393cfc18e9e2e941a098ab37e335dbb651cd)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
def _typecheckingstub__227642867ab7b0ac00070d84c15b98f89e899068eb9c9ee69208749c735a9e8b(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__b50b6927c5f7cfd28df1fdabb2af393cfc18e9e2e941a098ab37e335dbb651cd(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
