    ...
    def make_instance(self, include_optional) -> ParticipantDashboardNettedNominationsData:
        ...
        if include_optional:
            return ParticipantDashboardNettedNominationsData(
                ...
                mtus = [
                    empire_platform_api_public_client.models.participant_dashboard_netted_nominations_data_mtus.ParticipantDashboardNettedNominationsDataMtus(
                        mtu = '2022-01-04T10:00:00.000Z', 
                        aggregated_nominations = [
                            empire_platform_api_public_client.models.participant_dashboard_netted_nominations_data_mtus_aggregated_nominations.ParticipantDashboardNettedNominationsDataMtus_aggregatedNominations(
                                direction = 'GB_NL', 
                                value = 56, )
                            ], 
                        netted_nominations = empire_platform_api_public_client.models.participant_dashboard_netted_nominations_data_mtus_netted_nominations.ParticipantDashboardNettedNominationsDataMtus_nettedNominations(
                            direction = 'GB_NL', 
                            flow = 56, ), )
                    ]
            )
