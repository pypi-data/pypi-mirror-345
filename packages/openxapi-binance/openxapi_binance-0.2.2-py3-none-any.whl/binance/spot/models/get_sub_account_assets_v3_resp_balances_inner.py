...
class GetSubAccountAssetsV3RespBalancesInner(BaseModel):
    """
    GetSubAccountAssetsV3RespBalancesInner
    """ # noqa: E501
    asset: Optional[StrictStr] = None
    free: Optional[StrictInt] = None
    freeze: Optional[StrictInt] = None
    locked: Optional[StrictInt] = None
    withdrawing: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["asset", "free", "freeze", "locked", "withdrawing"]
