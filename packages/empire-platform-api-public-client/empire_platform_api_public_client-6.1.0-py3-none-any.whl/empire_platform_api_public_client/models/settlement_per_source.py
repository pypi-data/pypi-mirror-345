...
class SettlementPerSource(BaseModel):
    ...
    SettlementPerSource
    """ # noqa: E501
    source: SettlementSourceType
    sub_source: SettlementSubSourceType = Field(alias="subSource")
    total_amount: Union[Annotated[float, Field(multiple_of=0.01, strict=True)], Annotated[int, Field(strict=True)]] = Field(description="Currency value in Euros (€), accepted with a precision of maximum 2 decimal places", alias="totalAmount")
    values: List[SettlementItem]
    __properties: ClassVar[List[str]] = ["source", "subSource", "totalAmount", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "values": [SettlementItem.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
