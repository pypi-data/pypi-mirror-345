...
class TestIMaxNumTransfers(unittest.TestCase):
    """IMaxNumTransfers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMaxNumTransfers:
        """Test IMaxNumTransfers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMaxNumTransfers`
        """
        model = IMaxNumTransfers()
        if include_optional:
            return IMaxNumTransfers(
                overall_max_num_transfers = None,
                per_to_address_max_num_transfers = None,
                per_from_address_max_num_transfers = None,
                per_initiated_by_address_max_num_transfers = None,
                amount_tracker_id = ''
            )
        else:
            return IMaxNumTransfers(
