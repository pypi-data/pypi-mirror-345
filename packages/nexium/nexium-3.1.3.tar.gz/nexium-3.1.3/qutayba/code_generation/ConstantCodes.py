...
from qutayba.containers.Namedtuples import makeNamedtupleClass
from qutayba.ModuleRegistry import getRootTopModule
from qutayba.PythonVersions import python_version
from qutayba.Serialization import GlobalConstantAccessor
from qutayba.utils.CStrings import encodePythonStringToC
from qutayba.utils.Distributions import (
    getDistribution,
    getDistributionTopLevelPackageNames,
)
from qutayba.Version import getnexiumVersionTuple
...
def getConstantsDefinitionCode():
    ...
    header = template_header_guard % {
        "header_guard_name": "__DEVILPY_GLOBAL_CONSTANTS_H__",
        "header_body": "\n".join(lines),
    }

    major, minor, micro, is_final, _rc_number = getnexiumVersionTuple()
    ...
    body = template_constants_reading % {
        ...
        "qutayba_version_major": major,
        "qutayba_version_minor": minor,
        "qutayba_version_micro": micro,
        "qutayba_version_level": "release" if is_final else "candidate",
