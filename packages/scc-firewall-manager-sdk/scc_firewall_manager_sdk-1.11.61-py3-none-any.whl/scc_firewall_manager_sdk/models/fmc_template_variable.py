...
class FmcTemplateVariable(BaseModel):
    """
    ...
    value: StrictStr = Field(description="Specify the value of the template variable. The value specified should be valid for the template variable, as defined in the template configuration.")
