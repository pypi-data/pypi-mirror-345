...
class CountryUtils(object):
    ...
    country_code_map_by_country["Korea (Democratic People's Republic of)"] = "KP"
    ...
    country_code_map_by_country["Macedonia (the former Yugoslav Republic of)"] = "MK"
    ...
    country_code_map_by_country["Saint Helena, Ascension and Tristan da Cunha"] = "SH"
    ...
    country_code_map_by_country["South Georgia and the South Sandwich Islands"] = "GS"
    ...
    for country in list(country_code_map_by_country.keys()):
        country_map_by_country_code[country_code_map_by_country[country]] = country
    ...
    def get_country_by_country_code(country_code):
        ...
        return CountryUtils.fuzzy_match(
            CountryUtils.country_map_by_country_code,
            country_code,
    ...
    def get_country_code_by_country(country):
        ...
        match = CountryUtils.fuzzy_match(
            CountryUtils.country_code_map_by_country,
            country,
