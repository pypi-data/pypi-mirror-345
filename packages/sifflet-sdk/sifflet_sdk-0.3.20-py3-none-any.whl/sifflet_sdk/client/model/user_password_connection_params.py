...
def lazy_import():
    from sifflet_sdk.client.model.jdbc_datasource_connection_params import (
        JdbcDatasourceConnectionParams,
    )
    from sifflet_sdk.client.model.user_password_connection_params_all_of import (
        UserPasswordConnectionParamsAllOf,
    )

    globals()["JdbcDatasourceConnectionParams"] = JdbcDatasourceConnectionParams
    globals()["UserPasswordConnectionParamsAllOf"] = UserPasswordConnectionParamsAllOf


class UserPasswordConnectionParams(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UserPasswordConnectionParams - a model defined in OpenAPI
