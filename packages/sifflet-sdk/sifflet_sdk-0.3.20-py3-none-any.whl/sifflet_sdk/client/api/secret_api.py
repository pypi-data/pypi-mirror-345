...
from sifflet_sdk.client.model.create_or_update_secret_request_dto import (
    CreateOrUpdateSecretRequestDto,
)
from sifflet_sdk.client.model.secret_dto import SecretDto
...
class SecretApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_secret_endpoint = _Endpoint(
            ...
            root_map={
                ...
                "attribute_map": {},
                "location_map": {
                    "create_or_update_secret_request_dto": "body",
                },
        ...
        self.get_all_secrets_endpoint = _Endpoint(
            settings={
                "response_type": ([SecretDto],),
                "auth": ["JWT"],
                "endpoint_path": "/ui/v1/secrets",
                "operation_id": "get_all_secrets",
                "http_method": "GET",
                "servers": None,
            },
    ...
    def create_secret(self, create_or_update_secret_request_dto, **kwargs):
        """create_secret  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_secret(create_or_update_secret_request_dto, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["create_or_update_secret_request_dto"] = create_or_update_secret_request_dto
    ...
    def get_all_secrets(self, **kwargs):
        """get_all_secrets  # noqa: E501
        ...
        kwargs["_host_index"] = kwargs.get("_host_index")
        kwargs["_request_auths"] = kwargs.get("_request_auths", None)
        return self.get_all_secrets_endpoint.call_with_http_info(**kwargs)

    def update(self, create_or_update_secret_request_dto, **kwargs):
        """update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update(create_or_update_secret_request_dto, async_req=True)
        >>> result = thread.get()
