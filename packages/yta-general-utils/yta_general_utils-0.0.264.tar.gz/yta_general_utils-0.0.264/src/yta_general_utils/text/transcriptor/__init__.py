"""
TODO: This must be moved to another library as it is
depending on the ChromeScraper which is now in the
'yta_web_scraper' library.
"""
from yta_general_utils.web.scraper.chrome_scraper import ChromeScraper
from yta_general_utils.text.finder import TextFinder
...
class WebRealTimeAudioTranscriptor:
    ...
    def detect_fast(
        ...
        text = remove_non_ascii_characters(text.lower(), do_remove_accents = True)
