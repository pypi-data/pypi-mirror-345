...
class SecurityRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: The action to be taken when the rule is matched. String must be one of these: `"allow"`, `"deny"`, `"drop"`, `"reset-client"`, `"reset-server"`, `"reset-both"`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] applications: The application(s) being accessed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] categories: The URL categories being accessed.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] services: The service(s) being accessed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] source_users: The source user(s) or group(s).
        ...
        :param pulumi.Input[builtins.str] description: The description of the security rule.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] destination_hips: The destination Host Integrity Profile(s).
        :param pulumi.Input[builtins.str] device: The Device param.
        :param pulumi.Input[builtins.bool] disabled: The state of the security rule. Default: `false`.
        :param pulumi.Input[builtins.str] folder: The Folder param.
        :param pulumi.Input[builtins.str] log_setting: The external log forwarding profile.
        :param pulumi.Input[builtins.str] name: The name of the security rule.
        :param pulumi.Input[builtins.bool] negate_destination: Negate the destination addresses(es). Default: `false`.
        :param pulumi.Input[builtins.bool] negate_source: Negate the source address(es). Default: `false`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] source_hips: The source Host Integrity Profile(s).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags associated with the security rule.
        """
...
class SecurityRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tfid: Optional[pulumi.Input[builtins.str]] = None,
            tos: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'SecurityRule':
        """
