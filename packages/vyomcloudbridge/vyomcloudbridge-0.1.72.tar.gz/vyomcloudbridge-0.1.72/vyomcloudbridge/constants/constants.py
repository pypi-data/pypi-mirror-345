...
cert_dir = "/etc/vyomcloudbridge/certs/"
vyom_home_dir = "/etc/vyomcloudbridge"
...
machine_config_file = os.path.join(vyom_home_dir, "machine.conf")
machine_topics_file = os.path.join(vyom_home_dir, "machine_topics.json")
start_script_file = os.path.join(vyom_home_dir, "vyomcloudbridge.sh")

service_dir = "/etc/systemd/system"
service_file = os.path.join(service_dir, "vyomcloudbridge.service")

BUFFER_API_URL = "https://test.hqapi.vyomos.org/machine/buffer/"
# MISSION_STATS_API_URL = "https://test.hqapi.vyomos.org/mission-stats/"
UPLOAD_DATA_DIR = "/vyomos/robotics/upload_data"
MISSION_DATA_DIR = "/vyomos/robotics/mission_data"
MACHINE_REGISTER_API_URL = "https://test.hqapi.vyomos.org/device/register/"
MACHINE_MODELS_API_URL = "https://test.hqapi.vyomos.org/machine-model/"
MACHINE_TOPICS_API_URL = "https://test.hqapi.vyomos.org/machine-model/topic/list/"

MAX_FILE_SIZE = 120 * 1024  # in bytes (~120KB)

default_upload_dir = "_upload_" # default project id for non-mission related data uploads

default_project_id = "_all_"
default_mission_id = "_all_"

data_buffer_key = "_all_" # buffer key for non-mission related data
mission_buffer_key = "<mission_id>" # buffer key for non-mission related data, <== DO NOT IMPORT ==>
