...
def lazy_import():
    from sifflet_sdk.client.model.jira_issue_type_dto import JiraIssueTypeDto

    globals()["JiraIssueTypeDto"] = JiraIssueTypeDto


class SearchCollectionJiraIssueTypeDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([JiraIssueTypeDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SearchCollectionJiraIssueTypeDto - a model defined in OpenAPI

        Args:
            data ([JiraIssueTypeDto]):
