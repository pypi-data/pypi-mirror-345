...
class MspManagedTenant(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["displayName", "name", "region", "uid"]
    ...
    def region_validate_enum(cls, value):
        ...
        if value not in set(['US', 'EU', 'APJ', 'AUS', 'IN', 'CI', 'SCALE', 'STAGING', 'UNKNOWN']):
            raise ValueError("must be one of enum values ('US', 'EU', 'APJ', 'AUS', 'IN', 'CI', 'SCALE', 'STAGING', 'UNKNOWN')")
        return value
