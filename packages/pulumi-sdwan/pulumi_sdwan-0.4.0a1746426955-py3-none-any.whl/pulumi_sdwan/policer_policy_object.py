...
class PolicerPolicyObjectArgs:
    def __init__(__self__, *,
                 burst: pulumi.Input[builtins.int],
                 exceed_action: pulumi.Input[builtins.str],
                 rate: pulumi.Input[builtins.int],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a PolicerPolicyObject resource.
        :param pulumi.Input[builtins.int] burst: Burst in bytes - Range: `15000`-`10000000`
        :param pulumi.Input[builtins.str] exceed_action: Exceed action - Choices: `drop`, `remark`
        :param pulumi.Input[builtins.int] rate: Rate in bps - Range: `8`-`100000000000`
    ...
    @property
    @pulumi.getter
    def burst(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @burst.setter
    def burst(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "burst", value)

    @property
    @pulumi.getter(name="exceedAction")
    def exceed_action(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def exceed_action(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "exceed_action", value)

    @property
    @pulumi.getter
    def rate(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @rate.setter
    def rate(self, value: pulumi.Input[builtins.int]):
...
class _PolicerPolicyObjectState:
    def __init__(__self__, *,
                 ...
                 exceed_action: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="exceedAction")
    def exceed_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Exceed action - Choices: `drop`, `remark`
        """
        return pulumi.get(self, "exceed_action")
    ...
    @exceed_action.setter
    def exceed_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "exceed_action", value)
...
class PolicerPolicyObject(pulumi.CustomResource):
    ...
    pulumi_type = "sdwan:index/policerPolicyObject:PolicerPolicyObject"
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            rate: Optional[pulumi.Input[builtins.int]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'PolicerPolicyObject':
        """
    ...
    @property
    @pulumi.getter
    def burst(self) -> pulumi.Output[builtins.int]:
        """
        Burst in bytes - Range: `15000`-`10000000`
        """
        return pulumi.get(self, "burst")
    ...
    @property
    @pulumi.getter(name="exceedAction")
    def exceed_action(self) -> pulumi.Output[builtins.str]:
        """
        Exceed action - Choices: `drop`, `remark`
        """
        return pulumi.get(self, "exceed_action")
    ...
    @property
    @pulumi.getter
    def rate(self) -> pulumi.Output[builtins.int]:
        """
        Rate in bps - Range: `8`-`100000000000`
        """
        return pulumi.get(self, "rate")
