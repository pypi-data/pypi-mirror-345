...
class GetAccountInfoV1Resp(BaseModel):
    """
    ...
    is_options_enabled: Optional[StrictBool] = Field(default=None, alias="isOptionsEnabled")
    is_portfolio_margin_retail_enabled: Optional[StrictBool] = Field(default=None, alias="isPortfolioMarginRetailEnabled")
    vip_level: Optional[StrictInt] = Field(default=None, alias="vipLevel")
    __properties: ClassVar[List[str]] = ["isFutureEnabled", "isMarginEnabled", "isOptionsEnabled", "isPortfolioMarginRetailEnabled", "vipLevel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isOptionsEnabled": obj.get("isOptionsEnabled"),
            "isPortfolioMarginRetailEnabled": obj.get("isPortfolioMarginRetailEnabled"),
