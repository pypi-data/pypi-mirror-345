...
def main():
    ...
    parser_one.add_argument(
        "-c", "--counter", default=3, action="count", widget="Counter"
    )
    #
    parser_one.add_argument(
        "-o", "--overwrite", action="store_true", default=True, widget="CheckBox"
    )
    ...
    parser_one.add_argument(
        "--colourchooser", default="#000000", widget="ColourChooser"
    )
