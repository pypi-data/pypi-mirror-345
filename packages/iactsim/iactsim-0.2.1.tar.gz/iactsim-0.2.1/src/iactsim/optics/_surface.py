...
class Surface:
    ...
    def get_rotation_matrix(self) -> np.ndarray:
        """
        Calculates the 3D rotation matrix for the surface based on its tilt angles.
        Assumes rotations are applied in the order (last first): ZYX (yaw, pitch, roll).
