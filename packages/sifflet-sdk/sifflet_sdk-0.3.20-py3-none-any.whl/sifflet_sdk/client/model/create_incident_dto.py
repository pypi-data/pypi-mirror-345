...
class CreateIncidentDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, assigned_user_ids, criticality, name, rule_ids, status, *args, **kwargs):  # noqa: E501
        """CreateIncidentDto - a model defined in OpenAPI

        Args:
            assigned_user_ids ([str]):
            criticality (int):
            name (str):
            rule_ids ([str]):
            status (str):
    ...
    @convert_js_args_to_python_args
    def __init__(self, assigned_user_ids, criticality, name, rule_ids, status, *args, **kwargs):  # noqa: E501
        """CreateIncidentDto - a model defined in OpenAPI
