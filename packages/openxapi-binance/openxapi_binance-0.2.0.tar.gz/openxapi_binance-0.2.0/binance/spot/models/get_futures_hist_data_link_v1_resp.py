...
class GetFuturesHistDataLinkV1Resp(BaseModel):
    """
    GetFuturesHistDataLinkV1Resp
    """ # noqa: E501
    data: Optional[List[GetFuturesHistDataLinkV1RespDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GetFuturesHistDataLinkV1RespDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
