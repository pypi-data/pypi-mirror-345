...
def lazy_import():
    from sifflet_sdk.client.model.public_quicksight_parameters_dto_all_of import (
        PublicQuicksightParametersDtoAllOf,
    )
    from sifflet_sdk.client.model.public_source_v2_parameters_dto import (
        PublicSourceV2ParametersDto,
    )

    globals()["PublicQuicksightParametersDtoAllOf"] = PublicQuicksightParametersDtoAllOf
    globals()["PublicSourceV2ParametersDto"] = PublicSourceV2ParametersDto


class PublicSourceV2QuicksightParametersDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PublicSourceV2QuicksightParametersDto - a model defined in OpenAPI

        Keyword Args:
            account_id (str): Your AWS account ID
            aws_region (str): Your AWS region
            role_arn (str): The ARN for your QuickSight role
            type (str):
