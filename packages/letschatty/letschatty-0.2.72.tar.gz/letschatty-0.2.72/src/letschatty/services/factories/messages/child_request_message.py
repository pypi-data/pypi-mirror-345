...
class fromMessageDraftFactory:
    ...
    @staticmethod
    def from_draft(message: MessageDraft, sent_by: str) -> ChattyMessage | None:
        match message.type:
    ...
    def instance_text_message(message: MessageDraft, sent_by: str) -> TextMessage:
        return fromMessageDraftFactory.instantiate_message(message=message, message_type=TextMessage, sent_by=sent_by)

    @staticmethod
    def instance_image_message(message: MessageDraft, sent_by: str) -> ImageMessage:
        return fromMessageDraftFactory.instantiate_message(message=message, message_type=ImageMessage, sent_by=sent_by)

    @staticmethod
    def instance_video_message(message: MessageDraft, sent_by: str) -> VideoMessage:
        return fromMessageDraftFactory.instantiate_message(message=message, message_type=VideoMessage, sent_by=sent_by)

    @staticmethod
    def instance_document_message(message: MessageDraft, sent_by: str) -> DocumentMessage:
        return fromMessageDraftFactory.instantiate_message(message=message, message_type=DocumentMessage, sent_by=sent_by)

    @staticmethod
    def instance_audio_message(message: MessageDraft, sent_by: str) -> AudioMessage:
        return fromMessageDraftFactory.instantiate_message(message=message, message_type=AudioMessage, sent_by=sent_by)

    @staticmethod
    def instance_sticker_message(message: MessageDraft, sent_by: str) -> StickerMessage:
        return fromMessageDraftFactory.instantiate_message(message=message, message_type=StickerMessage, sent_by=sent_by)

    @staticmethod
    def instance_contact_message(message: MessageDraft, sent_by: str) -> ContactMessage:
        return fromMessageDraftFactory.instantiate_message(message=message, message_type=ContactMessage, sent_by=sent_by)

    @staticmethod
    def instance_location_message(message: MessageDraft, sent_by: str) -> LocationMessage:
        return fromMessageDraftFactory.instantiate_message(message=message, message_type=LocationMessage, sent_by=sent_by)

    @staticmethod
    def instance_central_notification(message: MessageDraft, sent_by: str) -> CentralNotification:
        return fromMessageDraftFactory.instantiate_message(message=message, message_type=CentralNotification, sent_by=sent_by)

    @staticmethod
    def instance_reaction_message(message: MessageDraft, sent_by: str) -> ReactionMessage:
        return fromMessageDraftFactory.instantiate_message(message=message, message_type=ReactionMessage, sent_by=sent_by)
