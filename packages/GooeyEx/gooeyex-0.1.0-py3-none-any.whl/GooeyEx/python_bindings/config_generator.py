...
from GooeyEx.gui.util.functional import merge_dictionaries
...
def create_from_parser(parser, source_path, **kwargs):
    ...
    build_spec["program_description"] = (
        build_spec["program_description"] or parser.description or ""
    )

    layout_data = (
        argparse_to_json.convert(parser, **build_spec)
