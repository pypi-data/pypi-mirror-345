...
class OneOfinlineResponse20011(object):
    ...
    def __init__(self):  # noqa: E501
        """OneOfinlineResponse20011 - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OneOfinlineResponse20011, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfinlineResponse20011):
            return False
