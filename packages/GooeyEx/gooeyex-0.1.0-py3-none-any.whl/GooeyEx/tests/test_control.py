...
from GooeyEx.python_bindings.coms import decode_payload, deserialize_inbound
from GooeyEx.python_bindings.dynamics import patch_argument, check_value
from GooeyEx.python_bindings import control
from GooeyEx.python_bindings.parameters import gooey_params
from GooeyEx.gui import state as s
from GooeyEx.python_bindings.schema import validate_public_state
...
class TestControl(unittest.TestCase):
    ...
    def test_validate_form(self):
        ...
        parser.add_argument(
            "a", type=int, gooey_options={"initial_value": "not-an-int"}
        )
        # ERROR: mismatched custom type
        parser.add_argument(
            "b", type=custom_type, gooey_options={"initial_value": "not-a-float"}
        )
        ...
        parser.add_argument(
            "gb", type=custom_type, gooey_options={"initial_value": "1234"}
        )
        # VALID: optional
