...
DJANGO_SITE_ROOT_ABSOLUTE_URL = "http://localhost:8088"  # for the Django dev server  # noqa
...
SECRET_KEY = 'p_$!c-vsrsocxcj^9*to5kihua04k)5%oyn7e!h@_=d7!%67jr'
...
CRATE_HTTPS = False  # require HTTPS and disallow plain HTTP
...
DATABASES = {
    ...
    'research': {
        ...
        # 'HOST': '127.0.0.1',
        # 'PORT': 3306,  # local
        # 'NAME': 'research',  # will be the default database; use None for no default database  # noqa
        # 'USER': 'research',
        # 'PASSWORD': 'research',
        "ENGINE": "mssql",
        "HOST": "",  # e.g. 127.0.0.1
        "PORT": "",  # local, e.g. 3306
        "NAME": "anondb",  # will be the default database; use None for no default database  # noqa
        "OPTIONS": {"dsn": "anondb"},
        "USER": "administrator",
        "PASSWORD": "8z31I84qmvBX",
    },
...
RESEARCH_DB_INFO = [
    {
        ...
        RDIKeys.DESCRIPTION: 'Research database',
        ...
        # e.g. 'brcid'
        RDIKeys.RID_FIELD: 'rid',
        # e.g. 1
        RDIKeys.RID_FAMILY: 1,
        # e.g. 'patients'
        RDIKeys.MRID_TABLE: 'patient',
        # e.g. 'nhshash'
        RDIKeys.MRID_FIELD: 'mrid',
...
CRATE_WORKING = "/home/martinb/workspace/crate/working"
ARCHIVE_TEMPLATE_DIR = os.path.join(CRATE_WORKING, "archive_templates")
ARCHIVE_TEMPLATE_CACHE_DIR = os.path.join(ARCHIVE_TEMPLATE_DIR, "cache")
ARCHIVE_STATIC_DIR = os.path.join(ARCHIVE_TEMPLATE_DIR, "static")
ARCHIVE_ROOT_TEMPLATE = "root.mako"
ARCHIVE_ATTACHMENT_DIR = os.path.join(CRATE_WORKING, "archive_attachments")
ARCHIVE_CONTEXT = {}
...
PRIVATE_FILE_STORAGE_ROOT = '/home/martinb/workspace/crate/working/files'
...
DEVELOPER_EMAIL = "mb2353@cam.ac.uk"
