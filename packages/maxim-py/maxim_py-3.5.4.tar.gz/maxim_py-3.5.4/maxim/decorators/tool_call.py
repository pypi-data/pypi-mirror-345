    ...
    def decorator(func):
        if asyncio.iscoroutinefunction(func):
            ...
            async def async_wrapper(*args, **kwargs):
                ...
                config = ToolCallConfig(id=actual_tool_call_id, name=name, description=description, args=arguments, tags=tags)
                ...
                try:
                    ...
                    if not tool_call.is_output_set:
                        if isinstance(result, (dict)):
                            tool_call.result(json.dumps(result))
                        elif isinstance(result, list):
                            tool_call.result([json.dumps(item) for item in result])
