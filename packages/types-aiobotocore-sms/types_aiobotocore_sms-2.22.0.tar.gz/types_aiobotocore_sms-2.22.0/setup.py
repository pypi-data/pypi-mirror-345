...
setup(
    ...
    description="Type annotations for aiobotocore SMS 2.22.0 service generated with mypy-boto3-builder 8.10.1",
    classifiers=[
    ...
    keywords="aiobotocore sms aiobotocore-stubs type-annotations mypy typeshed autocomplete",
