...
class Classifier(BaseClassifer):
    ...
    @staticmethod
    def get_pharse_repetition(toks: list[Token]) -> str | None:
    ...
    def is_repetition(self, o_toks: list[Token]) -> bool:
        """
        ...
        prev_start_token = cur_start_token - (cur_end_token - cur_start_token)
        ...
        next_end_token = cur_end_token + (cur_end_token - cur_start_token)
        ...
        if cur_text == prev_text or cur_text == next_text:
            return True
        return False
