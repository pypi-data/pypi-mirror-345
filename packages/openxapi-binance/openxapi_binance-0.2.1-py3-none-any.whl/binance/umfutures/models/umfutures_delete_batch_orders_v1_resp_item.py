...
class UmfuturesDeleteBatchOrdersV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["activatePrice", "clientOrderId", "closePosition", "cumQty", "cumQuote", "executedQty", "goodTillDate", "orderId", "origQty", "origType", "positionSide", "price", "priceMatch", "priceProtect", "priceRate", "reduceOnly", "selfTradePreventionMode", "side", "status", "stopPrice", "symbol", "timeInForce", "type", "updateTime", "workingType"]
