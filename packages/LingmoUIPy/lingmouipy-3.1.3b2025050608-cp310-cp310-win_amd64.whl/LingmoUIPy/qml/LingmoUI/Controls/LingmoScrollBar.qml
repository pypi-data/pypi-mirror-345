...
T.ScrollBar {
    ...
    property color color : LingmoTheme.dark ? Qt.rgba(159/255,159/255,159/255,1) : Qt.rgba(138/255,138/255,138/255,1)
    property color pressedColor: LingmoTheme.dark ? Qt.darker(color,1.2) : Qt.lighter(color,1.2)
    ...
    background: Rectangle{
        id:back_rect
        radius: 5
        color:LingmoTheme.dark ? Qt.rgba(44/255,44/255,44/255,1) : Qt.rgba(255/255,255/255,255/255,1)
        opacity:{
            if(vertical){
    ...
    LingmoIconButton{
        ...
        iconSource: LingmoIcons.CaretLeftSolid8
        onClicked: {
            control.decrease()
        }
    }
    LingmoIconButton{
        ...
        visible: control.horizontal
        iconSource: LingmoIcons.CaretRightSolid8
        onClicked: {
            control.increase()
        }
    }
    LingmoIconButton{
        ...
        iconSource: LingmoIcons.CaretUpSolid8
        onClicked: {
            control.decrease()
        }
    }
    LingmoIconButton{
        ...
        visible: control.vertical
        iconSource: LingmoIcons.CaretDownSolid8
        onClicked: {
            control.increase()
        }
    }
