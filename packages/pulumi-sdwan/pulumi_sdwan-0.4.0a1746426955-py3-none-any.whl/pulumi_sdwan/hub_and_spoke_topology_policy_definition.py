...
class HubAndSpokeTopologyPolicyDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 vpn_list_id: Optional[pulumi.Input[builtins.str]] = None,
                 vpn_list_version: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] vpn_list_id: VPN list ID
        :param pulumi.Input[builtins.int] vpn_list_version: VPN list version
        """
    ...
    def vpn_list_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        VPN list ID
        """
    ...
    @vpn_list_id.setter
    def vpn_list_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vpn_list_id", value)

    @property
    @pulumi.getter(name="vpnListVersion")
    def vpn_list_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        VPN list version
        """
    ...
    def vpn_list_version(self, value: Optional[pulumi.Input[builtins.int]]):
...
class HubAndSpokeTopologyPolicyDefinition(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            version: Optional[pulumi.Input[builtins.int]] = None,
            vpn_list_id: Optional[pulumi.Input[builtins.str]] = None,
            vpn_list_version: Optional[pulumi.Input[builtins.int]] = None) -> 'HubAndSpokeTopologyPolicyDefinition':
        """
    ...
    @property
    @pulumi.getter(name="vpnListId")
    def vpn_list_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        VPN list ID
        """
        return pulumi.get(self, "vpn_list_id")
    ...
    @property
    @pulumi.getter(name="vpnListVersion")
    def vpn_list_version(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        VPN list version
        """
        return pulumi.get(self, "vpn_list_version")
