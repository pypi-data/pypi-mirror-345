...
class SalesItem(object):
    ...
    attribute_map = {
        ...
        'spp': 'spp',
        'payment_sale_amount': 'paymentSaleAmount',
        'for_pay': 'forPay',
    ...
    def __init__(self, _date=None, last_change_date=None, warehouse_name=None, warehouse_type=None, country_name=None, oblast_okrug_name=None, region_name=None, supplier_article=None, nm_id=None, barcode=None, category=None, subject=None, brand=None, tech_size=None, income_id=None, is_supply=None, is_realization=None, total_price=None, discount_percent=None, spp=None, payment_sale_amount=None, for_pay=None, finished_price=None, price_with_disc=None, sale_id=None, sticker=None, g_number=None, srid=None):  # noqa: E501
        ...
        self._spp = None
        self._payment_sale_amount = None
        self._for_pay = None
        ...
        if spp is not None:
            self.spp = spp
        if payment_sale_amount is not None:
    ...
    def _date(self):
        ...
        Data i vrema prodahi. Eto pole sootvetstvuet parametru `dateFrom` v zaprose, esli parametr `flag`=1. Esli hasovoi poas ne ukazan, to beretsa Moskovskoe vrema (UTC+3).  # noqa: E501
    ...
    def warehouse_type(self):
        """Gets the warehouse_type of this SalesItem.  # noqa: E501

        Tip sklada hranenia tovarov  # noqa: E501

        :return: The warehouse_type of this SalesItem.  # noqa: E501
        :rtype: str
        """
    ...
    def warehouse_type(self, warehouse_type):
        """Sets the warehouse_type of this SalesItem.

        Tip sklada hranenia tovarov  # noqa: E501

        :param warehouse_type: The warehouse_type of this SalesItem.  # noqa: E501
        :type: str
        """
        allowed_values = ["Sklad WB", "Sklad prodavca"]  # noqa: E501
        if warehouse_type not in allowed_values:
            raise ValueError(
                "Invalid value for `warehouse_type` ({0}), must be one of {1}"  # noqa: E501
                .format(warehouse_type, allowed_values)
            )
    ...
    @property
    def payment_sale_amount(self):
        """Gets the payment_sale_amount of this SalesItem.  # noqa: E501

        Oplaheno s WB Kohelka  # noqa: E501

        :return: The payment_sale_amount of this SalesItem.  # noqa: E501
        :rtype: int
        """
        return self._payment_sale_amount

    @payment_sale_amount.setter
    def payment_sale_amount(self, payment_sale_amount):
        """Sets the payment_sale_amount of this SalesItem.

        Oplaheno s WB Kohelka  # noqa: E501

        :param payment_sale_amount: The payment_sale_amount of this SalesItem.  # noqa: E501
        :type: int
        """

        self._payment_sale_amount = payment_sale_amount

    @property
    def for_pay(self):
        """Gets the for_pay of this SalesItem.  # noqa: E501

        K perehisleniu prodavcu  # noqa: E501
    ...
    def price_with_disc(self):
        ...
        cena so skidkoi prodavca, ot kotoroi shitaetsa summa k perehisleniu prodavcu `forPay` (= `totalPrice` * (1 - `discountPercent`/100))  # noqa: E501
    ...
    def sale_id(self):
        ...
        Unikalnyi ID prodahi/vozvrata <ul>  <li> `S**********` — prodaha <li> `R**********` — vozvrat (na sklad WB) </ul>   # noqa: E501
    ...
    def srid(self):
        ...
        Unikalnyi ID zakaza.<br> Primehanie dla ispolzuuhih API Marketpleis: `srid` raven `rid` v otvetah metodov sborohnyh zadanii.   # noqa: E501
