...
class LazyArgs:
    def __init__(self, args_to_pickle):
        ...
        self.pickled_args = cloudpickle.dumps(args_to_pickle)  # Pickle the arguments
    ...
    def get_args(self):
        ...
        if self._args is None:
            print("Loading args...")  # Simulate the loading/unpickling process. Crucially, this happens *after* environment setup.
            self._args = cloudpickle.loads(self.pickled_args)  # Unpickle only when needed
        return self._args
