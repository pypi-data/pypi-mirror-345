...
#ifndef __SajadSx_FILESYSTEM_PATH_OPS_H__
#define __SajadSx_FILESYSTEM_PATH_OPS_H__
...
#define SajadQ_String_FromFilename(filename) SajadQUnicode_FromWideChar(filename, -1)
#else
...
#define SajadQ_String_FromFilename SajadQ_String_FromString
#endif
