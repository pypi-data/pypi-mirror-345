...
class GetCmConditionalAllOrdersV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["activatePrice", "bookTime", "newClientStrategyId", "orderId", "origQty", "positionSide", "price", "priceRate", "reduceOnly", "side", "status", "stopPrice", "strategyId", "strategyStatus", "strategyType", "symbol", "timeInForce", "triggerTime", "type", "updateTime"]
