    ...
    def __init__(
        ...
        **kwargs,
        ...
        if default_value := kwargs.get("default"):
            if not (
                isinstance(default_value, (BaseModel, BaseTypeModel))
                or issubclass(default_value, (BaseModel, BaseTypeModel))
            ):
                raise ValueError(
                    "default value must be a subcall of BaseModel or BaseTypeModel"
                )
