"""
Logging system for the inspectomat package.
...
# Default log file and directory
DEFAULT_LOG_DIR = os.path.expanduser('~/.inspectomat/logs')
DEFAULT_LOG_FILE = 'inspectomat.log'
...
def setup_logging(
    ...
    Args:
        ...
        log_file: Path to the log file (default: ~/.inspectomat/logs/inspectomat.log)
...
# Create a default logger for the inspectomat package
logger = get_logger('inspectomat')
