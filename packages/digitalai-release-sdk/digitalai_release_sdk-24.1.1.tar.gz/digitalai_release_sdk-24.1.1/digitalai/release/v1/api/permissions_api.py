...
class PermissionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_global_permissions_endpoint = _Endpoint(
            settings={
                'response_type': ([str],),
                'auth': [
                    'basicAuth',
                ...
                'endpoint_path': '/api/v1/global-permissions',
                'operation_id': 'get_global_permissions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_global_permissions(
        ...
        **kwargs
        ...
        """get_global_permissions  # noqa: E501
        ...
        return self.get_global_permissions_endpoint.call_with_http_info(**kwargs)
