...
class.
"""
_HEXADECIMAL_3_DIGITS_NO_ALPHA = r'^(#|0x)?[0-9a-fA-F]{3}'
_HEXADECIMAL_4_DIGITS_ALPHA = r'^(#|0x)?[0-9a-fA-F]{4}'
_HEXADECIMAL_6_DIGITS_NO_ALPHA = r'^(#|0x)?[0-9a-fA-F]{6}'
_HEXADECIMAL_8_DIGITS_ALPHA = r'^(#|0x)?[0-9a-fA-F]{8}'
_HEXADECIMAL = (
    rf'{_HEXADECIMAL_3_DIGITS_NO_ALPHA}'
    rf'|{_HEXADECIMAL_4_DIGITS_ALPHA}'
    rf'|{_HEXADECIMAL_6_DIGITS_NO_ALPHA}'
    rf'|{_HEXADECIMAL_8_DIGITS_ALPHA}'
)
...
class ColorRegularExpression(RegularExpression):
    ...
    """
    HEXADECIMAL_3_DIGITS_NO_ALPHA = _HEXADECIMAL_3_DIGITS_NO_ALPHA
    """
    ...
    - '0xfff'
    """
    HEXADECIMAL_4_DIGITS_ALPHA = _HEXADECIMAL_4_DIGITS_ALPHA
    """
    Validate a hexadecimal color string starting with '#' or
    ...
    - '0xfff0'
    """
    HEXADECIMAL_6_DIGITS_NO_ALPHA = _HEXADECIMAL_6_DIGITS_NO_ALPHA
    """
    Validate a hexadecimal color string starting with '#' or
    ...
    - '0xffffff'
    """
    HEXADECIMAL_8_DIGITS_ALPHA = _HEXADECIMAL_8_DIGITS_ALPHA
    """
    Validate a hexadecimal color string starting with '#' or
