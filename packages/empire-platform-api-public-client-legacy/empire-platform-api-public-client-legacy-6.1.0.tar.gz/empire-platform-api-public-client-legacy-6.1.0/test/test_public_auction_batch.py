...
from empire_platform_api_public_client_legacy.models.public_auction_batch import PublicAuctionBatch  # noqa: E501
    ...
    def make_instance(self, include_optional) -> PublicAuctionBatch:
        ...
        if include_optional:
            return PublicAuctionBatch(
                entries = [
                    empire_platform_api_public_client_legacy.models.public_auction.PublicAuction(
