"""
AI Chat Connect in Python
----------------------

Links
`````

* `development version <https://bitbucket.org/entinco/eic-ai-prototypes/src/main/lib-aichatconnect-python>`
...
setup(
    name='eic_aichat_connect',
    version='1.0.8',
    url='https://bitbucket.org/entinco/eic-ai-prototypes/src/master/lib-aichatconnect-python',
    license='Commercial',
    author='Enterprise Innovation Consulting LLC',
    author_email='seroukhov@entinco.com',
    description='AI Chat Connect in Python',
