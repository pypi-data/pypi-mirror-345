...
class FTS:
    ...
    """
    with_position: bool = ...
    base_tokenizer: Literal["simple", "raw", "whitespace"] = ...
    language: str = ...
...
class IvfFlat:
    ...
    """
    distance_type: Literal["l2", "cosine", "dot", "hamming"] = ...
    num_partitions: Optional[int] = ...
    max_iterations: int = ...
    sample_rate: int = ...
...
__all__ = ["BTree", "IvfPq", "IvfFlat", "HnswPq", "HnswSq", "IndexConfig", "FTS", "Bitmap", "LabelList"]
