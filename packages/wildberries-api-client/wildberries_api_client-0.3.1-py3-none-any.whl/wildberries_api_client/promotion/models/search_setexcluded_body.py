...
class SearchSetexcludedBody(object):
    ...
    def __init__(self, excluded=None):  # noqa: E501
        """SearchSetexcludedBody - a model defined in Swagger"""  # noqa: E501
        self._excluded = None
    ...
    @property
    def excluded(self):
        """Gets the excluded of this SearchSetexcludedBody.  # noqa: E501

        Minus-frazy (maks. 1000 ht.)  # noqa: E501

        :return: The excluded of this SearchSetexcludedBody.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def excluded(self, excluded):
        """Sets the excluded of this SearchSetexcludedBody.

        Minus-frazy (maks. 1000 ht.)  # noqa: E501

        :param excluded: The excluded of this SearchSetexcludedBody.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SearchSetexcludedBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchSetexcludedBody):
            return False
