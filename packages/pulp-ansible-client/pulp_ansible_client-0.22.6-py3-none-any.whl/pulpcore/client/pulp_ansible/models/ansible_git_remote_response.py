...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_href=None, prn=None, sock_read_timeout=None, pulp_created=None, connect_timeout=None, headers=None, pulp_last_updated=None, client_cert=None, tls_validation=None, pulp_labels=None, sock_connect_timeout=None, hidden_fields=None, ca_cert=None, download_concurrency=None, max_retries=None, name=None, rate_limit=None, proxy_url=None, url=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def prn(self):
        """Gets the prn of this AnsibleGitRemoteResponse.  # noqa: E501

        The Pulp Resource Name (PRN).  # noqa: E501

        :return: The prn of this AnsibleGitRemoteResponse.  # noqa: E501
        :rtype: str
        """
        return self._prn
    ...
    @prn.setter
    def prn(self, prn):
        """Sets the prn of this AnsibleGitRemoteResponse.

        The Pulp Resource Name (PRN).  # noqa: E501

        :param prn: The prn of this AnsibleGitRemoteResponse.  # noqa: E501
        :type: str
        """
