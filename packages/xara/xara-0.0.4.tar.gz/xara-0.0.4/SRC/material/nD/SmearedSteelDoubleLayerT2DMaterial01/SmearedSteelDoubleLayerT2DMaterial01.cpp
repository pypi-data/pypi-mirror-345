...
void* OPS_ADD_RUNTIME_VPV(OPS_SmearedSteelDoubleLayerT2DMaterial01)
{
	...
	// Steel Layer 1
	UniaxialMaterial* theUniaxialMaterial1 = G3_getSafeBuilder(rt)->getTypedObject<UniaxialMaterial>(iData[0]);
	...
	// Steel Layer 2
	UniaxialMaterial* theUniaxialMaterial2 = G3_getSafeBuilder(rt)->getTypedObject<UniaxialMaterial>(iData[1]);
