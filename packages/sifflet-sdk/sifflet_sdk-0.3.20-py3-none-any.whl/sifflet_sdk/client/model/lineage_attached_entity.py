...
class LineageAttachedEntity(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, datasource_type, name, type, urn, *args, **kwargs):  # noqa: E501
        """LineageAttachedEntity - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, datasource_type, name, type, urn, *args, **kwargs):  # noqa: E501
        """LineageAttachedEntity - a model defined in OpenAPI
