...
# -*- coding: utf-8 -*-
#
# cellmaps_imagedownloader documentation build configuration file, created by
...
intersphinx_mapping = {"python": ("https://docs.python.org/3", None),
                       ...
                       "cellmaps-utils": ("https://cellmaps-utils.readthedocs.io/en/latest/", None)
                      }
...
project = u'cellmaps_imagedownloader'
...
init_file = os.path.join('..', 'cellmaps_imagedownloader', '__init__.py')
...
latex_documents = [
    (master_doc, 'cellmaps_imagedownloader.tex',
     u'cellmaps_imagedownloader Documentation',
     u'Gege Qian', 'manual'),
]
...
man_pages = [
    (master_doc, 'cellmaps_imagedownloader',
     u'cellmaps_imagedownloader Documentation',
     [author], 1)
]
