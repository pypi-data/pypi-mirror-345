...
class GetUmAccountV2Resp(BaseModel):
    """
    GetUmAccountV2Resp
    """ # noqa: E501
    assets: Optional[List[GetCmAccountV1RespAssetsInner]] = None
    positions: Optional[List[GetUmAccountV2RespPositionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": [GetCmAccountV1RespAssetsInner.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None,
            "positions": [GetUmAccountV2RespPositionsInner.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None
        })
        return _obj
