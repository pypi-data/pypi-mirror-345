...
class GetSubAccountStatusV1RespItem(BaseModel):
    """
    ...
    mobile: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["email", "insertTime", "isFutureEnabled", "isMarginEnabled", "isSubUserEnabled", "isUserActive", "mobile"]
