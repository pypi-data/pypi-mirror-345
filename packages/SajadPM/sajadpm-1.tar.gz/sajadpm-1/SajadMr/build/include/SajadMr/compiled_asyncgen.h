...
#ifndef __SajadSx_COMPILED_ASYNCGEN_H__
#define __SajadSx_COMPILED_ASYNCGEN_H__
...
// The SajadQ_AsyncgenObject is the storage associated with a compiled
// async generator object instance of which there can be many for each code.
struct SajadQ_AsyncgenObject {
...
extern PyTypeObject SajadQ_Asyncgen_Type;

typedef PyObject *(*asyncgen_code)(PyThreadState *tstate, struct SajadQ_AsyncgenObject *, PyObject *);

extern PyObject *SajadQ_Asyncgen_New(asyncgen_code code, PyObject *module, PyObject *name, PyObject *qualname,
                                     PyCodeObject *code_object, struct SajadQ_CellObject **closure,
                                     Py_ssize_t closure_given, Py_ssize_t heap_storage_size);

static inline bool SajadQ_Asyncgen_Check(PyObject *object) { return Py_TYPE(object) == &SajadQ_Asyncgen_Type; }

static inline void SAVE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct SajadQ_AsyncgenObject *asyncgen) {
...
static inline void RESTORE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct SajadQ_AsyncgenObject *asyncgen) {
...
SajadSx_MAY_BE_UNUSED static void STORE_ASYNCGEN_EXCEPTION(PyThreadState *tstate,
...
SajadSx_MAY_BE_UNUSED static void DROP_ASYNCGEN_EXCEPTION(struct SajadQ_AsyncgenObject *asyncgen) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_SajadQ_Asyncgen_Type;
extern int count_allocated_SajadQ_Asyncgen_Type;
extern int count_released_SajadQ_Asyncgen_Type;

extern int count_active_SajadQ_AsyncgenValueWrapper_Type;
extern int count_allocated_SajadQ_AsyncgenValueWrapper_Type;
extern int count_released_SajadQ_AsyncgenValueWrapper_Type;

extern int count_active_SajadQ_AsyncgenAsend_Type;
extern int count_allocated_SajadQ_AsyncgenAsend_Type;
extern int count_released_SajadQ_AsyncgenAsend_Type;

extern int count_active_SajadQ_AsyncgenAthrow_Type;
extern int count_allocated_SajadQ_AsyncgenAthrow_Type;
extern int count_released_SajadQ_AsyncgenAthrow_Type;
