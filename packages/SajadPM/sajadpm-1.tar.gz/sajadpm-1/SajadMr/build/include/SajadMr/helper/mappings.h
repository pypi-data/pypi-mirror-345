...
#ifndef __SajadSx_MAPPINGS_H__
#define __SajadSx_MAPPINGS_H__

extern Py_ssize_t SajadQ_PyMapping_Size(PyObject *mapping);

SajadSx_MAY_BE_UNUSED static int MAPPING_HAS_ITEM(PyThreadState *tstate, PyObject *mapping, PyObject *key) {
