...
class ConfigSchema():
    ...
    def getJson(self):
        ...
        if self.AllowValues is not None:
            json["AllowValues"] = self.AllowValues
...
class ContentPatcher:
    ...
    def registryContentData(self, contentData:Load|EditData|EditImage|EditMap, contentFile:str="content", newFile:bool=False):
    ...
    def addConfigSchema(self, configSchema:ConfigSchema):
        self.contentFile["ConfigSchema"].append(configSchema.json)
