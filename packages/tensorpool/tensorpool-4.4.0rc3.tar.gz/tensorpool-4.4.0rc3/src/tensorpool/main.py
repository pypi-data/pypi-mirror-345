...
def create_cluster(public_keys_path: str, instance_type: str, num_nodes: int = 1):
    ...
    with Spinner(text="Creating cluster..."):
        success, message = create_new_cluster(key_content, instance_type, num_nodes)
...
def main():
    ...
    # on_parser.add_argument("cluster_ip", help="IP address of the cluster to turn on")

    off_parser = cluster_subparsers.add_parser("off", help="Deactivate a cluster")
    off_parser.add_argument("cluster_id", help="ID of the cluster to turn off")
