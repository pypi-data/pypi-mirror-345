...
[![PyPI - types-boto3-kinesis](https://img.shields.io/pypi/v/types-boto3-kinesis.svg?color=blue)](https://pypi.org/project/types-boto3-kinesis/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-kinesis.svg?color=blue)](https://pypi.org/project/types-boto3-kinesis/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-kinesis)](https://pypistats.org/packages/types-boto3-kinesis)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 Kinesis 1.38.8](https://pypi.org/project/boto3/)
...
[types-boto3-kinesis docs](https://youtype.github.io/types_boto3_docs/types_boto3_kinesis/).
...
- Install `types-boto3[kinesis]` in your environment:
...
- Install `types-boto3[kinesis]` with services you use in your environment:
...
`types_boto3_kinesis.paginator` module contains type annotations for all
paginators.
...
`types_boto3_kinesis.waiter` module contains type annotations for all waiters.

```python
from boto3.session import Session

from types_boto3_kinesis import KinesisClient
from types_boto3_kinesis.waiter import StreamExistsWaiter, StreamNotExistsWaiter
...
`types_boto3_kinesis.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

Full list of `Kinesis` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_kinesis/literals/).
...
`types_boto3_kinesis.type_defs` module contains structures and shapes assembled
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_kinesis/)
