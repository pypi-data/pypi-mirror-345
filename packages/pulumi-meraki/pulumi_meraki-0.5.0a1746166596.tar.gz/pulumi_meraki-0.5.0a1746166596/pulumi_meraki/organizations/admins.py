...
class AdminsArgs:
    def __init__(__self__, *,
                 ...
                 admin_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 org_access: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] admin_id: adminId path parameter. Admin ID
        :param pulumi.Input[builtins.str] authentication_method: Admin's authentication method
        :param pulumi.Input[builtins.str] email: Admin's email address
        :param pulumi.Input[builtins.str] name: Admin's username
        :param pulumi.Input[Sequence[pulumi.Input['AdminsNetworkArgs']]] networks: Admin network access information
        :param pulumi.Input[builtins.str] org_access: Admin's level of access to the organization
    ...
    def admin_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @admin_id.setter
    def admin_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def org_access(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @org_access.setter
    def org_access(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AdminsState:
    def __init__(__self__, *,
                 ...
                 authentication_method: Optional[pulumi.Input[builtins.str]] = None,
                 email: Optional[pulumi.Input[builtins.str]] = None,
                 has_api_key: Optional[pulumi.Input[builtins.bool]] = None,
                 last_active: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 networks: Optional[pulumi.Input[Sequence[pulumi.Input['AdminsNetworkArgs']]]] = None,
                 org_access: Optional[pulumi.Input[builtins.str]] = None,
                 organization_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['AdminsTagArgs']]]] = None,
                 two_factor_auth_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        Input properties used for looking up and filtering Admins resources.
        :param pulumi.Input[builtins.str] account_status: Status of the admin's account
        :param pulumi.Input[builtins.str] admin_id: adminId path parameter. Admin ID
        :param pulumi.Input[builtins.str] authentication_method: Admin's authentication method
        :param pulumi.Input[builtins.str] email: Admin's email address
        :param pulumi.Input[builtins.bool] has_api_key: Indicates whether the admin has an API key
        :param pulumi.Input[builtins.str] last_active: Time when the admin was last active
        :param pulumi.Input[builtins.str] name: Admin's username
        :param pulumi.Input[Sequence[pulumi.Input['AdminsNetworkArgs']]] networks: Admin network access information
        :param pulumi.Input[builtins.str] org_access: Admin's level of access to the organization
        :param pulumi.Input[builtins.str] organization_id: organizationId path parameter. Organization ID
        :param pulumi.Input[Sequence[pulumi.Input['AdminsTagArgs']]] tags: Admin tag information
        :param pulumi.Input[builtins.bool] two_factor_auth_enabled: Indicates whether two-factor authentication is enabled
        """
    ...
    def has_api_key(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @has_api_key.setter
    def has_api_key(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "has_api_key", value)

    @property
    @pulumi.getter(name="lastActive")
    def last_active(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @last_active.setter
    def last_active(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def two_factor_auth_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def two_factor_auth_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Admins(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            organization_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AdminsTagArgs', 'AdminsTagArgsDict']]]]] = None,
            two_factor_auth_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'Admins':
        """
    ...
    @property
    @pulumi.getter(name="adminId")
    def admin_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        adminId path parameter. Admin ID
        """
        return pulumi.get(self, "admin_id")
    ...
    @property
    @pulumi.getter(name="hasApiKey")
    def has_api_key(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the admin has an API key
        """
        return pulumi.get(self, "has_api_key")
    ...
    @property
    @pulumi.getter(name="lastActive")
    def last_active(self) -> pulumi.Output[builtins.str]:
        """
        Time when the admin was last active
        """
        return pulumi.get(self, "last_active")
    ...
    @property
    @pulumi.getter(name="orgAccess")
    def org_access(self) -> pulumi.Output[builtins.str]:
        """
        Admin's level of access to the organization
        """
        return pulumi.get(self, "org_access")
    ...
    @property
    @pulumi.getter(name="twoFactorAuthEnabled")
    def two_factor_auth_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether two-factor authentication is enabled
        """
        return pulumi.get(self, "two_factor_auth_enabled")
