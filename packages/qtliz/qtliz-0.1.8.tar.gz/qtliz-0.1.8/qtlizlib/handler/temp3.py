...
#
#     # def handle_tlb_group_adding(self, toolbar_handler: ToolbarHandler, group: QActionGroup):
#     #     if self.settings.toolbar_widget_type == ToolbarWidgetType.BUTTON_DROP_DOWN:
#     #
#     #         tool_button = QToolButton()
#     #         tool_button.setText(self.inner_menu.objectName())
...
#     #         tool_button.setMenu(self.inner_menu)
#     #
#     #         toolbar_handler.add_button_dropdown(tool_button)
