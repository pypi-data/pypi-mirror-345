...
class GetLeverageBracketV1RespItemBracketsInner(BaseModel):
    """
    ...
    qty_cap: Optional[StrictInt] = Field(default=None, alias="qtyCap")
    qtyl_floor: Optional[StrictInt] = Field(default=None, alias="qtylFloor")
    __properties: ClassVar[List[str]] = ["bracket", "cum", "initialLeverage", "maintMarginRatio", "qtyCap", "qtylFloor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "qtyCap": obj.get("qtyCap"),
            "qtylFloor": obj.get("qtylFloor")
        })
        return _obj
