...
class KoefficientySkladovApi(object):
    ...
    def api_v1_tariffs_box_get(self, _date, **kwargs):  # noqa: E501
        ...
        Dla tovarov, kotorye postavlautsa na sklad v korobah, metod predostavlaet [stoimost](https://seller.wildberries.ru/dynamic-product-categories):   - dostavki so sklada ili punkta priema do pokupatela   - dostavki ot pokupatela do punkta priema   - hranenia na sklade WB  <div class=\"description_limit\">     Maksimum 60 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> na odin akkaunt prodavca </div>   # noqa: E501
    ...
    def api_v1_tariffs_pallet_get(self, _date, **kwargs):  # noqa: E501
        """Tarify dla monopallet  # noqa: E501

        Dla tovarov, kotorye postavlautsa na sklad WB na monopalletah, metod predostavlaet [stoimost](https://seller.wildberries.ru/dynamic-product-categories):   - dostavki so sklada do pokupatela   - dostavki ot pokupatela do sklada   - hranenia na sklade WB  <div class=\"description_limit\">     Maksimum 60 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> na odin akkaunt prodavca </div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
