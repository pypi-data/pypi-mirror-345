...
class IntelligentFeedArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] url: The intelligent feed source.
        :param pulumi.Input[builtins.str] audit_comment: The audit comment.
        :param pulumi.Input[builtins.str] certificate: The certificate profile.
        :param pulumi.Input[builtins.str] description: The description.
        :param pulumi.Input[builtins.str] frequency: Update frequency. Valid values are `HOURLY` or `DAILY`. Defaults to `HOURLY`.
        ...
        :param pulumi.Input[builtins.int] time: The time to poll for updates if frequency is daily. The number must be between [0, 23] incluside.
        :param pulumi.Input[builtins.str] type: The intelligent feed type. Valid values are `IP_LIST` or `URL_LIST`. Defaults to `IP_LIST`.
        """
...
class IntelligentFeed(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            update_token: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'IntelligentFeed':
        """
    ...
    @property
    @pulumi.getter
    def time(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The time to poll for updates if frequency is daily. The number must be between [0, 23] incluside.
        """
        return pulumi.get(self, "time")
