...
class ActivateCentralizedPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] version: The version of the centralized policy
        """
...
class ActivateCentralizedPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'ActivateCentralizedPolicy':
        """
