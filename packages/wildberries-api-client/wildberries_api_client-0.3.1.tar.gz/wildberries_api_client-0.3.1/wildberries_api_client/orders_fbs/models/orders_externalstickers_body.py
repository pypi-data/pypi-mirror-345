...
class OrdersExternalstickersBody(object):
    ...
    def __init__(self, orders=None):  # noqa: E501
        """OrdersExternalstickersBody - a model defined in Swagger"""  # noqa: E501
        self._orders = None
    ...
    @property
    def orders(self):
        """Gets the orders of this OrdersExternalstickersBody.  # noqa: E501

        Massiv ID sborohnyh zadanii  # noqa: E501

        :return: The orders of this OrdersExternalstickersBody.  # noqa: E501
        :rtype: list[int]
        """
        return self._orders
    ...
    def orders(self, orders):
        """Sets the orders of this OrdersExternalstickersBody.

        Massiv ID sborohnyh zadanii  # noqa: E501

        :param orders: The orders of this OrdersExternalstickersBody.  # noqa: E501
        :type: list[int]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrdersExternalstickersBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrdersExternalstickersBody):
            return False
