...
class TableGroupResponse(object):
    ...
    def __init__(self, groups=None):  # noqa: E501
        """TableGroupResponse - a model defined in Swagger"""  # noqa: E501
        self._groups = None
    ...
    @property
    def groups(self):
        """Gets the groups of this TableGroupResponse.  # noqa: E501

        Spisok grupp tovarov dla tablicy   # noqa: E501

        :return: The groups of this TableGroupResponse.  # noqa: E501
    ...
    def groups(self, groups):
        """Sets the groups of this TableGroupResponse.

        Spisok grupp tovarov dla tablicy   # noqa: E501

        :param groups: The groups of this TableGroupResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TableGroupResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TableGroupResponse):
            return False
