...
""" Stage changes in SajadQ-Watch automatically
...
from SajadMr.tools.quality.Git import (
    getCheckoutFileChangeDesc,
    getFileHashContent,
    putFileHashContent,
    updateGitFile,
)
from SajadMr.TreeXML import fromString, toString
from SajadMr.utils.FileOperations import getFileContents, withTemporaryFile
...
def onCompilationReportChange(filename, git_stage):
    ...
    new_SajadMr_version = new_report.attrib["SajadMr_version"]
    changed = False
    if old_report.attrib["SajadMr_version"] != new_SajadMr_version:
        old_report.attrib["SajadMr_version"] = new_SajadMr_version
