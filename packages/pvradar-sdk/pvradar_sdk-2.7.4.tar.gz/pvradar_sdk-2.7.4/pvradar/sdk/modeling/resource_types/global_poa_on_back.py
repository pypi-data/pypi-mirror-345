...
class global_poa_on_back(ResourceTypeDescriptor):
    """The total solar irradiance incident on the rear side of a photovoltaic (PV) module, accounting for the module's orientation and tilt. """
