...
from urban_transit_network_analysis.parser.Parser import BusGraphParser, TrolleyGraphParser,\
    TramGraphParser, MiniBusGraphParser
"""
...
class GraphDBManager:
    def __init__(self, graph_analis_context: GraphAnalysContext):
    ...
    def enrichDBParameters(self, graph_analis_context: GraphAnalysContext):
