...
class PostavkiFBSApi(object):
    ...
    def api_v3_supplies_get(self, limit, next, **kwargs):  # noqa: E501
        ...
        Metod predostavlaet spisok [postavok](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D/get).  <div class=\"description_limit\">     Maksimum 300 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> dla vseh metodov kategorii <a href=\"/openapi/api-information#tag/Avtorizaciya/Kak-sozdat-token\">Marketpleis</a> na odin akkaunt prodavca.   <br><br>   Odin zapros s kodom otveta <code>409</code> uhityvaetsa kak 5 zaprosov </div>   # noqa: E501
    ...
    def api_v3_supplies_post(self, body, **kwargs):  # noqa: E501
        ...
        Metod sozdaet novuu [postavku](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D/get).  Ogranihenia: - Tolko dla [sborohnyh zadanii](/openapi/orders-fbs#tag/Sborochnye-zadaniya/paths/~1api~1v3~1orders/get) po sheme FBS. - Pri dobavlenii v postavku vse peredavaemye sborohnye zadania v [statuse](/openapi/orders-fbs#tag/Sborochnye-zadaniya/paths/~1api~1v3~1orders~1status/post) `new` budut avtomatiheski perevedeny v status `confirm` — na sborke. - Esli vy perevedete sborohnoe zadanie v status `cancel` — otmena prodavcom, prikreplennoe sborohnoe zadanie avtomatiheski udalitsa iz postavki. - Postavku mohno sobrat tolko iz sborohnyh zadanii (zakazov) odnogo gabaritnogo tipa `cargoType`. Novaa postavka ne obladaet gabaritnym priznakom, ona priobretaet gabaritnyi priznak pervogo zakaza, dobavlennogo v postavku.  <div class=\"description_limit\">     Maksimum 300 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> dla vseh metodov kategorii <a href=\"/openapi/api-information#tag/Avtorizaciya/Kak-sozdat-token\">Marketpleis</a> na odin akkaunt prodavca.   <br><br>   Odin zapros s kodom otveta <code>409</code> uhityvaetsa kak 5 zaprosov </div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def api_v3_supplies_supply_id_barcode_get(self, supply_id, type, **kwargs):  # noqa: E501
        """Poluhit QR-kod postavki  # noqa: E501

        Metod predostavlaet QR-kod [postavki](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D/get) v formatah:   - SVG   - ZPLV (vertikalnyi)   - ZPLH (gorizontalnyi)   - PNG  QR-kod postavki mohno poluhit tolko esli postavka [peredana v dostavku](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D~1deliver/patch). <br><br> Razmer — 580x400 px.  <div class=\"description_limit\">     Maksimum 300 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> dla vseh metodov kategorii <a href=\"/openapi/api-information#tag/Avtorizaciya/Kak-sozdat-token\">Marketpleis</a> na odin akkaunt prodavca.   <br><br>   Odin zapros s kodom otveta <code>409</code> uhityvaetsa kak 5 zaprosov </div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def api_v3_supplies_supply_id_delete(self, supply_id, **kwargs):  # noqa: E501
        ...
        Metod udalaet [postavku](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D/get), esli ona aktivna i za nei ne zakrepleno ni odno [sborohnoe zadanie](/openapi/orders-fbs#tag/Sborochnye-zadaniya/paths/~1api~1v3~1orders/get).  <div class=\"description_limit\">     Maksimum 300 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> dla vseh metodov kategorii <a href=\"/openapi/api-information#tag/Avtorizaciya/Kak-sozdat-token\">Marketpleis</a> na odin akkaunt prodavca.   <br><br>   Odin zapros s kodom otveta <code>409</code> uhityvaetsa kak 5 zaprosov </div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def api_v3_supplies_supply_id_deliver_patch(self, supply_id, **kwargs):  # noqa: E501
        ...
        Metod zakryvaet [postavku](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D/get) i perevodit vse [sborohnye zadania](/openapi/orders-fbs#tag/Sborochnye-zadaniya/paths/~1api~1v3~1orders/get) v nei v [status](/openapi/orders-fbs#tag/Sborochnye-zadaniya/paths/~1api~1v3~1orders~1status/post) `complete` — v dostavke. Posle zakrytia postavki dobavit novye sborohnye zadania k nei nelza. <br><br> Esli postavka ne byla peredana v dostavku, to pri skanirovanii ee htrihkoda ili priemke pervogo tovara postavka avtomatiheski zakroetsa. <br><br> Peredat postavku v dostavku mohno tolko esli v nei:   - est hota by odno sborohnoe zadania   - otsutstvuut pustye koroba  <div class=\"description_limit\">     Maksimum 300 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> dla vseh metodov kategorii <a href=\"/openapi/api-information#tag/Avtorizaciya/Kak-sozdat-token\">Marketpleis</a> na odin akkaunt prodavca.   <br><br>   Odin zapros s kodom otveta <code>409</code> uhityvaetsa kak 5 zaprosov </div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def api_v3_supplies_supply_id_get(self, supply_id, **kwargs):  # noqa: E501
        ...
        Metod predostavlaet podrobnuu informaciu o postavke.  <div class=\"description_limit\">     Maksimum 300 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> dla vseh metodov kategorii <a href=\"/openapi/api-information#tag/Avtorizaciya/Kak-sozdat-token\">Marketpleis</a> na odin akkaunt prodavca.   <br><br>   Odin zapros s kodom otveta <code>409</code> uhityvaetsa kak 5 zaprosov </div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def api_v3_supplies_supply_id_orders_get(self, supply_id, **kwargs):  # noqa: E501
        ...
        Metod predostavlaet [sborohnye zadania](/openapi/orders-fbs#tag/Sborochnye-zadaniya/paths/~1api~1v3~1orders/get), zakreplennye za [postavkoi](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D/get).  <div class=\"description_limit\">     Maksimum 300 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> dla vseh metodov kategorii <a href=\"/openapi/api-information#tag/Avtorizaciya/Kak-sozdat-token\">Marketpleis</a> na odin akkaunt prodavca.   <br><br>   Odin zapros s kodom otveta <code>409</code> uhityvaetsa kak 5 zaprosov </div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def api_v3_supplies_supply_id_orders_order_id_patch(self, supply_id, order_id, **kwargs):  # noqa: E501
        """Dobavit sborohnoe zadanie k postavke  # noqa: E501

        Metod dobavlaet [sborohnoe zadanie](/openapi/orders-fbs#tag/Sborochnye-zadaniya/paths/~1api~1v3~1orders/get) k postavke i perevodit ego v [status](/openapi/orders-fbs#tag/Sborochnye-zadaniya/paths/~1api~1v3~1orders~1status/post) `confirm` — na sborke.   Mohet peremehat sborohnoe zadanie:   - mehdu aktivnymi postavkami.   - iz zakrytoi postavki v aktivnuu, esli sborohnoe zadanie trebuet [povtornoi otgruzki](/openapi/orders-fbs#tag/Sborochnye-zadaniya/paths/~1api~1v3~1supplies~1orders~1reshipment/get).  <div class=\"description_important\">   V pustuu postavku mohno dobavit sborohnoe zadanie lubogo gabaritnogo tipa. Postavka priobretaet gabaritnyi tip pervogo dobavlennogo sborohnogo zadania <a href =\"./orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D/get\">iz pola</a> <code>cargoType</code>.<br>Posle etogo v postavku mohno dobavit sborohnye zadania tolko togo he gabaritnogo tipa, hto i u postavki. </div>  <div class=\"description_limit\">     Maksimum 1 000 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> na odin akkaunt prodavca.   <br><br>   Odin zapros s kodom otveta <code>409</code> uhityvaetsa kak 5 zaprosov </div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def api_v3_supplies_supply_id_trbx_delete(self, supply_id, **kwargs):  # noqa: E501
        ...
        Metod ubiraet zakazy iz perehislennyh [korobov](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D~1trbx/get) [postavki](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D/get) i udalaet koroba.  <br><br> Mohno udalit tolko poka postavka na sborke.  <div class=\"description_limit\">     Maksimum 300 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> dla vseh metodov kategorii <a href=\"/openapi/api-information#tag/Avtorizaciya/Kak-sozdat-token\">Marketpleis</a> na odin akkaunt prodavca.   <br><br>   Odin zapros s kodom otveta <code>409</code> uhityvaetsa kak 5 zaprosov </div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def api_v3_supplies_supply_id_trbx_get(self, supply_id, **kwargs):  # noqa: E501
        ...
        Metod predostavlaet spisok korobov i ID [zakazov](/openapi/orders-fbs#tag/Sborochnye-zadaniya/paths/~1api~1v3~1orders/get), vhodahih v eti koroba.  <div class=\"description_limit\">     Maksimum 300 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> dla vseh metodov kategorii <a href=\"/openapi/api-information#tag/Avtorizaciya/Kak-sozdat-token\">Marketpleis</a> na odin akkaunt prodavca.   <br><br>   Odin zapros s kodom otveta <code>409</code> uhityvaetsa kak 5 zaprosov </div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def api_v3_supplies_supply_id_trbx_post(self, supply_id, **kwargs):  # noqa: E501
        ...
        Metod dobavlaet trebuemoe kolihestvo [korobov](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D~1trbx/get) v [postavku](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D/get).  <br><br> Mohno dobavit tolko poka postavka na sborke.  <div class=\"description_limit\">     Maksimum 300 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> dla vseh metodov kategorii <a href=\"/openapi/api-information#tag/Avtorizaciya/Kak-sozdat-token\">Marketpleis</a> na odin akkaunt prodavca.   <br><br>   Odin zapros s kodom otveta <code>409</code> uhityvaetsa kak 5 zaprosov </div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def api_v3_supplies_supply_id_trbx_stickers_post(self, type, supply_id, **kwargs):  # noqa: E501
        ...
        Metod predostavlaet QR-stikery v formatah:   - SVG   - ZPLV (vertikalnyi)   - ZPLH (gorizontalnyi)   - PNG  Mohno poluhit tolko esli v [korobe](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D~1trbx/get) est zakazy. <br><br> Razmer stikerov — 580x400 px.  <div class=\"description_limit\">     Maksimum 300 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> dla vseh metodov kategorii <a href=\"/openapi/api-information#tag/Avtorizaciya/Kak-sozdat-token\">Marketpleis</a> na odin akkaunt prodavca.   <br><br>   Odin zapros s kodom otveta <code>409</code> uhityvaetsa kak 5 zaprosov </div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def api_v3_supplies_supply_id_trbx_trbx_id_orders_order_id_delete(self, supply_id, trbx_id, order_id, **kwargs):  # noqa: E501
        ...
        Metod udalaet zakaz iz [koroba](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D~1trbx/get) vybrannoi [postavki](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D/get). <br><br> Mohno udalit tolko poka postavka na sborke.  <div class=\"description_limit\">     Maksimum 300 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> dla vseh metodov kategorii <a href=\"/openapi/api-information#tag/Avtorizaciya/Kak-sozdat-token\">Marketpleis</a> na odin akkaunt prodavca.   <br><br>   Odin zapros s kodom otveta <code>409</code> uhityvaetsa kak 5 zaprosov </div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def api_v3_supplies_supply_id_trbx_trbx_id_patch(self, supply_id, trbx_id, **kwargs):  # noqa: E501
        """Dobavit zakazy v korob  # noqa: E501

        Metod dobavlaet zakazy v [korob](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D~1trbx/get) dla vybrannoi [postavki](/openapi/orders-fbs#tag/Postavki-FBS/paths/~1api~1v3~1supplies~1%7BsupplyId%7D/get). <br><br> Mohno dobavit tolko poka postavka na sborke.  <div class=\"description_limit\">     Maksimum 300 zaprosov v <a href=\"/openapi/api-information#tag/Vvedenie/Limity-zaprosov\">minutu</a> dla vseh metodov kategorii <a href=\"/openapi/api-information#tag/Avtorizaciya/Kak-sozdat-token\">Marketpleis</a> na odin akkaunt prodavca.   <br><br>   Odin zapros s kodom otveta <code>409</code> uhityvaetsa kak 5 zaprosov </div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
