...
class PulpAnsibleApiV3PluginAnsibleContentCollectionsIndexApi(object):
    ...
    def delete(self, distro_base_path, name, namespace, path,  **kwargs):  # noqa: E501
        """delete  # noqa: E501

        Trigger an asynchronous delete task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete(distro_base_path, name, namespace, path, async_req=True)
        >>> result = thread.get()
        ...
        return self.delete_with_http_info(distro_base_path, name, namespace, path,  **kwargs)  # noqa: E501

    def delete_with_http_info(self, distro_base_path, name, namespace, path,  **kwargs):  # noqa: E501
        """delete  # noqa: E501

        Trigger an asynchronous delete task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_with_http_info(distro_base_path, name, namespace, path, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/{path}/api/v3/plugin/ansible/content/{distro_base_path}/collections/index/{namespace}/{name}/', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_with_http_info(self, distro_base_path, path,  **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/{path}/api/v3/plugin/ansible/content/{distro_base_path}/collections/index/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read(self, distro_base_path, name, namespace, path,  **kwargs):  # noqa: E501
        """read  # noqa: E501

        ViewSet for Collections.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(distro_base_path, name, namespace, path, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(distro_base_path, name, namespace, path,  **kwargs)  # noqa: E501

    def read_with_http_info(self, distro_base_path, name, namespace, path,  **kwargs):  # noqa: E501
        """read  # noqa: E501

        ViewSet for Collections.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(distro_base_path, name, namespace, path, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/{path}/api/v3/plugin/ansible/content/{distro_base_path}/collections/index/{namespace}/{name}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update(self, distro_base_path, name, namespace, path, patched_collection,  **kwargs):  # noqa: E501
        """update  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update(distro_base_path, name, namespace, path, patched_collection, async_req=True)
        >>> result = thread.get()
        ...
        :param str namespace: (required)
        :param str path: (required)
        :param PatchedCollection patched_collection: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_with_http_info(distro_base_path, name, namespace, path, patched_collection,  **kwargs)  # noqa: E501

    def update_with_http_info(self, distro_base_path, name, namespace, path, patched_collection,  **kwargs):  # noqa: E501
        """update  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_with_http_info(distro_base_path, name, namespace, path, patched_collection, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('distro_base_path' not in local_var_params or  # noqa: E501
                                                        local_var_params['distro_base_path'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `distro_base_path` when calling `update`")  # noqa: E501
        # verify the required parameter 'name' is set
        if self.api_client.client_side_validation and ('name' not in local_var_params or  # noqa: E501
                                                        local_var_params['name'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('patched_collection' not in local_var_params or  # noqa: E501
                                                        local_var_params['patched_collection'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `patched_collection` when calling `update`")  # noqa: E501
        ...
        body_params = None
        if 'patched_collection' in local_var_params:
            body_params = local_var_params['patched_collection']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/{path}/api/v3/plugin/ansible/content/{distro_base_path}/collections/index/{namespace}/{name}/', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
