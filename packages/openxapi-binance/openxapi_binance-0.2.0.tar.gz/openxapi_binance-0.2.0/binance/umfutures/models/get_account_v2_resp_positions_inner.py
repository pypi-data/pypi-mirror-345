...
class GetAccountV2RespPositionsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["askNotional", "bidNotional", "entryPrice", "initialMargin", "isolated", "leverage", "maintMargin", "maxNotional", "openOrderInitialMargin", "positionAmt", "positionInitialMargin", "positionSide", "symbol", "unrealizedProfit", "updateTime"]
