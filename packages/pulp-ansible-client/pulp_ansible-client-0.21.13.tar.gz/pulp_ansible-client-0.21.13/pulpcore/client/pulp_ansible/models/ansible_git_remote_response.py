...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_labels=None, rate_limit=None, tls_validation=None, connect_timeout=None, ca_cert=None, total_timeout=None, client_cert=None, hidden_fields=None, max_retries=None, sock_connect_timeout=None, sock_read_timeout=None, pulp_href=None, pulp_last_updated=None, url=None, proxy_url=None, name=None, headers=None, pulp_created=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
