...
class PublicDeclarativeLineageDto(ModelNormal):
    ...
    def _from_openapi_data(cls, _from, to, *args, **kwargs):  # noqa: E501
        """PublicDeclarativeLineageDto - a model defined in OpenAPI

        Args:
            _from (str): URI string identifying the upstream asset of the lineage. <a href=\"https://docs.siffletdata.com/docs/uris\">[Read more about URIs]</a>
            to (str): URI string identifying the downstream asset of the lineage. <a href=\"https://docs.siffletdata.com/docs/uris\">[Read more about URIs]</a>
