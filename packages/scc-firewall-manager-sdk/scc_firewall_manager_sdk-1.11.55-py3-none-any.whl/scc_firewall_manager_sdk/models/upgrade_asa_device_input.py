...
class UpgradeAsaDeviceInput(BaseModel):
    ...
    one_field_present: Optional[StrictBool] = Field(default=None, alias="oneFieldPresent")
    ...
    __properties: ClassVar[List[str]] = ["asdmVersion", "oneFieldPresent", "softwareVersion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "oneFieldPresent": obj.get("oneFieldPresent"),
