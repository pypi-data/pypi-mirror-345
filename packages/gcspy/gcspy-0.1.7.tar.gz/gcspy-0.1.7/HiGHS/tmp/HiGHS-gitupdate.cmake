...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v1.8.1"
  WORKING_DIRECTORY "/Users/matthewmcilree/PhD_Code/glasgow-constraint-solver/HiGHS/src/HiGHS"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v1.8.1" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v1.8.1")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/matthewmcilree/PhD_Code/glasgow-constraint-solver/HiGHS/src/HiGHS'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/matthewmcilree/PhD_Code/glasgow-constraint-solver/HiGHS/src/HiGHS'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
