...
class AdaptivePolicyAclsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] acl_id: ID of the adaptive policy ACL
        :param pulumi.Input[builtins.str] description: Description of the adaptive policy ACL
        :param pulumi.Input[builtins.str] ip_version: IP version of adpative policy ACL
        :param pulumi.Input[builtins.str] name: Name of the adaptive policy ACL
...
class _AdaptivePolicyAclsState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] acl_id: ID of the adaptive policy ACL
        :param pulumi.Input[builtins.str] created_at: When the adaptive policy ACL was created
        :param pulumi.Input[builtins.str] description: Description of the adaptive policy ACL
        :param pulumi.Input[builtins.str] ip_version: IP version of adpative policy ACL
        :param pulumi.Input[builtins.str] name: Name of the adaptive policy ACL
        :param pulumi.Input[builtins.str] organization_id: organizationId path parameter. Organization ID
        :param pulumi.Input[Sequence[pulumi.Input['AdaptivePolicyAclsRuleArgs']]] rules: An ordered array of the adaptive policy ACL rules
        :param pulumi.Input[builtins.str] updated_at: When the adaptive policy ACL was last updated
        """
        if acl_id is not None:
            pulumi.set(__self__, "acl_id", acl_id)
...
class AdaptivePolicyAcls(pulumi.CustomResource):
    ...
    pulumi_type = "meraki:organizations/adaptivePolicyAcls:AdaptivePolicyAcls"
    ...
    def get(resource_name: str,
            ...
            organization_id: Optional[pulumi.Input[builtins.str]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AdaptivePolicyAclsRuleArgs', 'AdaptivePolicyAclsRuleArgsDict']]]]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'AdaptivePolicyAcls':
        """
