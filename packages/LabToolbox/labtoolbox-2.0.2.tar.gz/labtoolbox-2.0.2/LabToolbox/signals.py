...
def power_spectrum(t, y, interval = None, xscale = 0, yscale = 0, normalize=True, logscale=True, density=False, unit=""):
    """
    Compute and plot the power spectrum or power spectral density (PSD)
...
def harmonic(t, y, prominence=0.05, n_max=None):
    """
    Identify the dominant harmonics present in a real-valued signal.
...
def decompose(t, y, freqs):
    """
    Reconstruct specified sinusoidal components from a real-valued signal.
