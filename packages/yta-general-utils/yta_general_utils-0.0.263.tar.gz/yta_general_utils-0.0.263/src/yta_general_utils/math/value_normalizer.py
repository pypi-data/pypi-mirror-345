...
class ValueNormalizer:
    ...
    def normalize(
        ...
        if not NumberValidator.is_number(value):
            raise Exception('The provided "value" is not a number.')
        ...
        return Math.normalize(value, self.lower_limit, self.upper_limit)
    ...
    def denormalize(
        ...
        return Math.denormalize(value, self.lower_limit, self.upper_limit)
    ...
    def to_range_value(
        ...
        """
        if new_range_lower_limit == new_range_upper_limit or new_range_lower_limit > new_range_upper_limit:
