...
import six
from wildberries_api_client.analytics.models.common_response_properties import CommonResponseProperties  # noqa: F401,E501

class InlineResponse2006(CommonResponseProperties):
    ...
    if hasattr(CommonResponseProperties, "swagger_types"):
        swagger_types.update(CommonResponseProperties.swagger_types)

    attribute_map = {
        'data': 'data'
    }
    if hasattr(CommonResponseProperties, "attribute_map"):
        attribute_map.update(CommonResponseProperties.attribute_map)
    ...
    def __init__(self, data=None, *args, **kwargs):  # noqa: E501
        ...
        self.data = data
        CommonResponseProperties.__init__(self, *args, **kwargs)
    ...
    def data(self):
        ...
        :rtype: ProductSearchTextsResponse
        """
        return self._data
