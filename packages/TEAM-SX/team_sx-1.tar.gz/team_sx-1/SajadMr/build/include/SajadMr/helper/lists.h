...
#ifndef __SajadSx_HELPER_LISTS_H__
#define __SajadSx_HELPER_LISTS_H__
...
#define SajadSx_LIST_HAS_FREELIST 1
extern PyObject *MAKE_LIST_EMPTY(PyThreadState *tstate, Py_ssize_t size);
#else
#define SajadSx_LIST_HAS_FREELIST 0
...
SajadSx_MAY_BE_UNUSED static PyObject *MAKE_LIST_REPEATED(PyThreadState *tstate, Py_ssize_t size, PyObject *element) {
