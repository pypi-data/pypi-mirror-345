...
----------
:mod:`cellnition.meta`
    Similar logic performed at :mod:`cellnition` importation time.
'''
...
def skip(reason: str):
    ...
    * :func:`pytest.skip`, intended to be called only directly as a function.
      ...
      ``"SKIP [1] cellnition_test/unit/test_import.py:66: could not import
...
def skip_if_python_version_greater_than_or_equal_to(version: str):
    ...
    # Defer heavyweight imports.
    from cellnition.meta import _convert_version_str_to_tuple
...
def _skip_if_callable_raises_exception(
    ...
    * No exception, this test continues as expected.
    ...
    from cellnition_test._util.mark.pytmark import noop
