"""
The wntrfr.metrics.economic module contains economic metrics.
"""
from wntrfr.network import Tank, Pipe, Pump, Valve
import numpy as np 
import pandas as pd 
import logging
import scipy
...
def pump_cost(energy, wn):
    ...
    energy : pandas DataFrame
        A pandas DataFrame containing pump energy (J), computed from ``wntrfr.metrics.pump_energy`` 
        (index = times, columns = pump names).
