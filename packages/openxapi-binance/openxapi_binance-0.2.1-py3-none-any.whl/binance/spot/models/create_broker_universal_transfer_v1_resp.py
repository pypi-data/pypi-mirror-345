...
class CreateBrokerUniversalTransferV1Resp(BaseModel):
    """
    CreateBrokerUniversalTransferV1Resp
    """ # noqa: E501
    client_tran_id: Optional[StrictStr] = Field(default=None, alias="clientTranId")
    txn_id: Optional[StrictInt] = Field(default=None, alias="txnId")
    __properties: ClassVar[List[str]] = ["clientTranId", "txnId"]
