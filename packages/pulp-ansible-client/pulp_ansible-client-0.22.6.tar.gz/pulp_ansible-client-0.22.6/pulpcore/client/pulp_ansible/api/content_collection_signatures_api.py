...
class ContentCollectionSignaturesApi(object):
    ...
    def create(self, signed_collection,  **kwargs):  # noqa: E501
        ...
        >>> thread = api.create(signed_collection, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_with_http_info(signed_collection,  **kwargs)  # noqa: E501

    def create_with_http_info(self, signed_collection,  **kwargs):  # noqa: E501
        """Create a collection version signature  # noqa: E501

        Trigger an asynchronous task to create content,optionally create new repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(signed_collection, async_req=True)
        >>> result = thread.get()
