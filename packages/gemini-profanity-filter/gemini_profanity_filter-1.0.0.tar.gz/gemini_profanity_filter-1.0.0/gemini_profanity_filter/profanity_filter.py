...
8. Advanced word boundary manipulation:
   ...
   -  Explicitly detect reversed profanity: "сарадип" → "пидарас" (Russian offensive slur via complete string reversal). Classify as highly offensive.

9. Specialized exception rules:
...
10. NEW: Multi-token distributed patterns:
...
11. NEW: Iterative transformation detection:
...
12. NEW: Adversarial pattern detection:
...
13. NEW: Dialect and sociolect variations:
...
14. NEW: Cross-linguistic puns and wordplay:
