...
class DatevLohnUndGehalt(BrynQ):
    def __init__(self, debug: bool = False):
        ...
        self.agent_url = "https://datev-agent.app.brynq.com/brynq-agent/rest-request"
        ...
        # Access parent method directly
        credentials = self.interfaces.credentials.get(interface_id=os.getenv("DATA_INTERFACE_ID"), system="datev-lohn-und-gehalt")
