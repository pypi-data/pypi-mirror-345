...
class GetListData(object):
    ...
    """
    swagger_types = {
        'documents': 'list[GetListDataDocuments]'
    }
    ...
    def __init__(self, documents=None):  # noqa: E501
        """GetListData - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def documents(self):
        """Gets the documents of this GetListData.  # noqa: E501

        Kategorii dokumentov  # noqa: E501

        :return: The documents of this GetListData.  # noqa: E501
        :rtype: list[GetListDataDocuments]
        """
        return self._documents

    @documents.setter
    def documents(self, documents):
        """Sets the documents of this GetListData.

        Kategorii dokumentov  # noqa: E501

        :param documents: The documents of this GetListData.  # noqa: E501
        :type: list[GetListDataDocuments]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetListData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetListData):
            return False
