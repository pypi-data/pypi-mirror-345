...
class PulpAnsibleApiV3NamespacesApi(object):
    ...
    def list_with_http_info(self, path,  **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/{path}/api/v3/namespaces/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read(self, name, path,  **kwargs):  # noqa: E501
        """read  # noqa: E501

        Legacy v3 endpoint.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(name, path, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(name, path,  **kwargs)  # noqa: E501

    def read_with_http_info(self, name, path,  **kwargs):  # noqa: E501
        """read  # noqa: E501

        Legacy v3 endpoint.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(name, path, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/{path}/api/v3/namespaces/{name}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
