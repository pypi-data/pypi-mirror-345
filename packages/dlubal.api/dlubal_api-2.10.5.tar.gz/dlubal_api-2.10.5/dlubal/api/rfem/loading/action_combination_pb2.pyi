...
class ActionCombination(_message.Message):
    ...
    class ItemsRow(_message.Message):
        __slots__ = ("no", "description", "action_item", "operator_type", "left_parenthesis", "right_parenthesis", "group_factor", "action_factor", "action_load_type", "group_load_type", "action", "is_leading", "gamma", "psi", "xi", "k_fi", "c_esl", "k_def", "psi_0", "psi_1", "psi_2", "fi", "gamma_0", "alfa", "k_f", "phi", "rho", "omega_0", "gamma_l_1", "k_creep", "gamma_n", "j_2", "omega_m", "omega_n", "d1", "d2")
        ...
        description: str
        action_item: int
        operator_type: ActionCombination.ItemsRow.Operator
    ...
    def __init__(self, no: _Optional[int] = ..., user_defined_name_enabled: bool = ..., name: _Optional[str] = ..., attribute_always_editable: _Optional[str] = ..., comment: _Optional[str] = ..., design_situation: _Optional[int] = ..., items: _Optional[_Union[ActionCombination.ItemsTable, _Mapping]] = ..., active: bool = ..., construction_stage: _Optional[int] = ..., combination_type: _Optional[_Union[ActionCombination.CombinationType, str]] = ..., generated_load_combinations: _Optional[_Iterable[int]] = ..., generated_result_combinations: _Optional[_Iterable[int]] = ..., is_generated: bool = ..., generating_object_info: _Optional[str] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...
