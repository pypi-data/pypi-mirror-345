...
Possible values are *POINTS*, *LINES*, *TRIS*, *LINE_STRIP*, *LINE_LOOP*, *TRI_STRIP*, *TRI_FAN*, *LINES_ADJ*, *TRIS_ADJ* and *LINE_STRIP_ADJ*.
  ...
  def draw(self, shader: typing.Any = None) -> None:
...
For cube map textures, layer is translated into a cube map face.
  ...
  def __init__(self, depth_slot: GPUTexture = None, color_slots: GPUTexture = None) -> None:
  ...
  def clear(self, color: typing.Any = None, depth: float = None, stencil: int = None) -> None:
...
to transform the output sRGB colors to the frame-buffer color-space.
  ...
  def uniform_int(self, name: str, seq: typing.Any) -> None:
...
class GPUShaderCreateInfo:
  ...
  def depth_write(self, value: typing.Any) -> None:
...
to be performed.
  ...
  def image(self, slot: int, format: str, type: str, name: str, qualifiers: typing.Any = {'NO_RESTRICT'}) -> None:
...
class GPUTexture:
  ...
  def __init__(self, size: int, layers: int = 0, is_cubemap: int = False, format: str = 'RGBA8', data: Buffer = None) -> None:
