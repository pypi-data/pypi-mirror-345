...
/* package gotdf_python/build/lib.linux-aarch64-cpython-312/otdf_python */
...
//
extern long long int gotdf_python_OpentdfConfig_CTor();
extern char* gotdf_python_OpentdfConfig_ClientId_Get(long long int handle);
extern void gotdf_python_OpentdfConfig_ClientId_Set(long long int handle, char* val);
extern char* gotdf_python_OpentdfConfig_ClientSecret_Get(long long int handle);
extern void gotdf_python_OpentdfConfig_ClientSecret_Set(long long int handle, char* val);
extern char* gotdf_python_OpentdfConfig_PlatformEndpoint_Get(long long int handle);
extern void gotdf_python_OpentdfConfig_PlatformEndpoint_Set(long long int handle, char* val);
extern char* gotdf_python_OpentdfConfig_TokenEndpoint_Get(long long int handle);
extern void gotdf_python_OpentdfConfig_TokenEndpoint_Set(long long int handle, char* val);
extern char* gotdf_python_OpentdfConfig_KasUrl_Get(long long int handle);
extern void gotdf_python_OpentdfConfig_KasUrl_Set(long long int handle, char* val);
...
extern long long int gotdf_python_EncryptFilesInDirNPE(char* dirPath, long long int config, long long int dataAttributes, long long int authScopes);
extern long long int gotdf_python_EncryptFilesWithExtensionsNPE(char* dirPath, long long int extensions, long long int config, long long int dataAttributes, long long int authScopes);
extern char* gotdf_python_EncryptString(char* inputText, long long int config, long long int dataAttributes, long long int authScopes);
extern char* gotdf_python_DecryptFile(char* inputFilePath, char* outputFilePath, long long int config);
extern long long int gotdf_python_DecryptFilesWithExtensionsNPE(char* dirPath, long long int extensions, long long int config, long long int authScopes);
extern char* gotdf_python_DecryptStringPE(char* inputText, long long int config, long long int token, long long int authScopes);
extern char* gotdf_python_EncryptFile(char* inputFilePath, char* outputFilePath, long long int config, long long int dataAttributes, long long int authScopes);
extern char* gotdf_python_EncryptFilePE(char* inputFilePath, char* outputFilePath, long long int config, long long int token, long long int dataAttributes, long long int authScopes);
extern char* gotdf_python_DecryptFilePE(char* inputFilePath, char* outputFilePath, long long int config, long long int token, long long int authScopes);
extern long long int gotdf_python_DecryptFilesInDirNPE(char* dirPath, long long int config, long long int authScopes);
