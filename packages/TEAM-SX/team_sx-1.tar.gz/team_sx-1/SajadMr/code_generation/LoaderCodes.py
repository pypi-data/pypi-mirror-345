...
from SajadMr.utils.CStrings import encodePythonStringToC, encodePythonUnicodeToC
...
def getModuleMetaPathLoaderEntryCode(module, bytecode_accessor):
    ...
    if module.isUncompiledPythonModule():
        ...
        flags.append("SajadSx_BYTECODE_FLAG")
        if is_package:
            flags.append("SajadSx_PACKAGE_FLAG")
        ...
        flags.append("SajadSx_EXTENSION_MODULE_FLAG")
...
PyThreadState *tstate, PyObject *, struct SajadQ_MetaPathBasedLoaderEntry const *);"""
