...
class TransmissionRightsOverviewMtusValues(BaseModel):
    ...
    timescales: List[TransmissionRightsOverviewMtusValuesTimescales]
    ...
    __properties: ClassVar[List[str]] = ["direction", "timescales", "total", "curtailed", "remaining"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.timescales:
            for _item_timescales in self.timescales:
                if _item_timescales:
                    _items.append(_item_timescales.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timescales": [TransmissionRightsOverviewMtusValuesTimescales.from_dict(_item) for _item in obj["timescales"]] if obj.get("timescales") is not None else None,
            "total": obj.get("total"),
