...
class SteelBoundaryConditions(_message.Message):
    ...
    class NodalSupportsRow(_message.Message):
        ...
        eccentricity_type_z_type: SteelBoundaryConditions.NodalSupportsRow.EccentricityTypeZ
        eccentricity_x: float
        eccentricity_y: float
        eccentricity_z: float
        nodes: _containers.RepeatedScalarFieldContainer[int]
        def __init__(self, no: _Optional[int] = ..., description: _Optional[str] = ..., node_seq_no: _Optional[str] = ..., support_type: _Optional[_Union[SteelBoundaryConditions.NodalSupportsRow.SupportType, str]] = ..., support_in_x: bool = ..., support_in_y: bool = ..., support_in_z: bool = ..., restraint_about_x: bool = ..., restraint_about_y: bool = ..., restraint_about_z: bool = ..., restraint_warping: bool = ..., rotation: _Optional[float] = ..., rotation_about_x: _Optional[float] = ..., rotation_about_y: _Optional[float] = ..., rotation_about_z: _Optional[float] = ..., support_spring_in_x: _Optional[float] = ..., support_spring_in_y: _Optional[float] = ..., support_spring_in_z: _Optional[float] = ..., restraint_spring_about_x: _Optional[float] = ..., restraint_spring_about_y: _Optional[float] = ..., restraint_spring_about_z: _Optional[float] = ..., restraint_spring_warping: _Optional[float] = ..., eccentricity_type_z_type: _Optional[_Union[SteelBoundaryConditions.NodalSupportsRow.EccentricityTypeZ, str]] = ..., eccentricity_x: _Optional[float] = ..., eccentricity_y: _Optional[float] = ..., eccentricity_z: _Optional[float] = ..., nodes: _Optional[_Iterable[int]] = ...) -> None: ...
