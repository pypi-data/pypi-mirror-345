...
class PeriodSt(object):
    ...
    def __init__(self, start=None, end=None):  # noqa: E501
        """PeriodSt - a model defined in Swagger"""  # noqa: E501
        self._start = None
        self._end = None
    ...
    @property
    def start(self):
        """Gets the start of this PeriodSt.  # noqa: E501

        Data nahala perioda. Ne pozdnee `end`. Ne ranee 3 mesacev ot tekuhei daty  # noqa: E501

        :return: The start of this PeriodSt.  # noqa: E501
        :rtype: date
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this PeriodSt.

        Data nahala perioda. Ne pozdnee `end`. Ne ranee 3 mesacev ot tekuhei daty  # noqa: E501

        :param start: The start of this PeriodSt.  # noqa: E501
        :type: date
        """
        if start is None:
    ...
    @property
    def end(self):
        """Gets the end of this PeriodSt.  # noqa: E501

        Data okonhania perioda. Ne ranee 3 mesacev ot tekuhei daty  # noqa: E501

        :return: The end of this PeriodSt.  # noqa: E501
        :rtype: date
        """
        return self._end
    ...
    @end.setter
    def end(self, end):
        """Sets the end of this PeriodSt.

        Data okonhania perioda. Ne ranee 3 mesacev ot tekuhei daty  # noqa: E501

        :param end: The end of this PeriodSt.  # noqa: E501
        :type: date
        """
        if end is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PeriodSt):
            return False
