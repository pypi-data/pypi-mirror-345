...
from eic_aichat_connect.facade.version1.ModelConnectionOperationsV1 import ModelConnectionOperationsV1
from eic_aichat_connect.services.ModelConnectionService import ModelConnectionService

class AIChatConnectFactory(Factory):
    __ServiceDescriptor = Descriptor('aichatconnect', 'mux', 'default', 'default', '1.0')
    __OperationsDescriptor = Descriptor('aichatconnect', 'operations', 'http', 'default', '1.0')
