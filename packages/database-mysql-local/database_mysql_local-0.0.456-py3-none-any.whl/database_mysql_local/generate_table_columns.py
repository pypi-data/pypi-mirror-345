...
try:
    ...
    print(f"{len(tables_and_columns)} tables found.")
    print(f"{sum(len(columns) for columns in tables_and_columns.values())} columns found.")
    ...
    with open("src/table_columns.py", "w") as f:
        ...
        f.write("# Generated by generate_table_columns.py (should be generated by Sql2Code in the future\n\n")
