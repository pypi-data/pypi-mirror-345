...
class RadiusServerProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] retries: The Retries param. Value must be between 1 and 5.
        :param pulumi.Input[builtins.str] snippet: The Snippet param.
        :param pulumi.Input[builtins.int] timeout: The Timeout param. Value must be between 1 and 120.
        """
...
class RadiusServerProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            snippet: Optional[pulumi.Input[builtins.str]] = None,
            tfid: Optional[pulumi.Input[builtins.str]] = None,
            timeout: Optional[pulumi.Input[builtins.int]] = None) -> 'RadiusServerProfile':
        """
