...
def lazy_import():
    from sifflet_sdk.client.model.public_postgresql_parameters_dto_all_of import (
        PublicPostgresqlParametersDtoAllOf,
    )
    from sifflet_sdk.client.model.public_source_parameters_dto import (
        PublicSourceParametersDto,
    )

    globals()["PublicPostgresqlParametersDtoAllOf"] = PublicPostgresqlParametersDtoAllOf
    globals()["PublicSourceParametersDto"] = PublicSourceParametersDto


class PublicPostgresqlParametersDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PublicPostgresqlParametersDto - a model defined in OpenAPI
