...
class Message(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "receivedAt", "category", "sender", "severity", "type", "subject", "body", "read", "entityId", "attachment"]
