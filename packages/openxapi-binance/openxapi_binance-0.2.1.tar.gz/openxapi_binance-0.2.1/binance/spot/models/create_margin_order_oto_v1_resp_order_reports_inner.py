...
class CreateMarginOrderOtoV1RespOrderReportsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clientOrderId", "cummulativeQuoteQty", "executedQty", "orderId", "orderListId", "origQty", "price", "selfTradePreventionMode", "side", "status", "symbol", "timeInForce", "transactTime", "type"]
