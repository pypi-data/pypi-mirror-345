...
def lazy_import():
    from sifflet_sdk.client.model.field_level_search_field_dto import (
        FieldLevelSearchFieldDto,
    )

    globals()["FieldLevelSearchFieldDto"] = FieldLevelSearchFieldDto


class SearchCollectionFieldLevelSearchFieldDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([FieldLevelSearchFieldDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SearchCollectionFieldLevelSearchFieldDto - a model defined in OpenAPI

        Args:
            data ([FieldLevelSearchFieldDto]):
