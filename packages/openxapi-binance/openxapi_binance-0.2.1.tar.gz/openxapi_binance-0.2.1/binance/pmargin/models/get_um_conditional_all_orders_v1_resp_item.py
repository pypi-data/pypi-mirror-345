...
class GetUmConditionalAllOrdersV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["activatePrice", "bookTime", "goodTillDate", "newClientStrategyId", "orderId", "origQty", "positionSide", "price", "priceMatch", "priceRate", "reduceOnly", "selfTradePreventionMode", "side", "status", "stopPrice", "strategyId", "strategyStatus", "strategyType", "symbol", "timeInForce", "triggerTime", "type", "updateTime"]
