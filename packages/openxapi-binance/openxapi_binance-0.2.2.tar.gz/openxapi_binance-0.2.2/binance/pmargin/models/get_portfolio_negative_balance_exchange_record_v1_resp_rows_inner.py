...
class GetPortfolioNegativeBalanceExchangeRecordV1RespRowsInner(BaseModel):
    """
    GetPortfolioNegativeBalanceExchangeRecordV1RespRowsInner
    """ # noqa: E501
    details: Optional[List[GetPortfolioNegativeBalanceExchangeRecordV1RespRowsInnerDetailsInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["details", "endTime", "startTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "details": [GetPortfolioNegativeBalanceExchangeRecordV1RespRowsInnerDetailsInner.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
