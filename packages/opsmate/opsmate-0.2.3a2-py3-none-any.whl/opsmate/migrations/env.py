...
from opsmate.gui.models import SQLModel as GUISQLModel
...
target_metadata = [
    WorkflowSQLModel.metadata,
    IngestionModel.metadata,
    DBQSQLModel.metadata,
    GUISQLModel.metadata,
]
...
def run_migrations_online() -> None:
    ...
    cfg["sqlalchemy.url"] = opsmate_config.db_url
