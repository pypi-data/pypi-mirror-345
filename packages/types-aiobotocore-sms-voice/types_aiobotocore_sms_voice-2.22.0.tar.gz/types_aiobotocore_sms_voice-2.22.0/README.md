...
[![PyPI - Downloads](https://static.pepy.tech/badge/types-aiobotocore-sms-voice)](https://pypistats.org/packages/types-aiobotocore-sms-voice)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[aiobotocore SMSVoice 2.22.0](https://pypi.org/project/aiobotocore/) compatible
...
Install `types-aiobotocore` for `SMSVoice` service.
...
`types-aiobotocore-sms-voice` dependency in production. However, there is an
...
`SMSVoiceClient` provides annotations for `session.create_client("sms-voice")`.

```python
from aiobotocore.session import get_session

from types_aiobotocore_sms_voice import SMSVoiceClient
...
Full list of `SMSVoice` Literals can be found in
...
Full list of `SMSVoice` TypeDefs can be found in
