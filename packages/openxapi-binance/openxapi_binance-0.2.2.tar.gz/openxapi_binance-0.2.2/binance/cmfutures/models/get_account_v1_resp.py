...
class GetAccountV1Resp(BaseModel):
    ...
    GetAccountV1Resp
    """ # noqa: E501
    assets: Optional[List[GetAccountV1RespAssetsInner]] = None
    ...
    positions: Optional[List[GetAccountV1RespPositionsInner]] = None
    update_time: Optional[StrictInt] = Field(default=None, alias="updateTime")
    __properties: ClassVar[List[str]] = ["assets", "canDeposit", "canTrade", "canWithdraw", "feeTier", "positions", "updateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": [GetAccountV1RespAssetsInner.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None,
            "canDeposit": obj.get("canDeposit"),
            "canTrade": obj.get("canTrade"),
            "canWithdraw": obj.get("canWithdraw"),
            "feeTier": obj.get("feeTier"),
            "positions": [GetAccountV1RespPositionsInner.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None,
