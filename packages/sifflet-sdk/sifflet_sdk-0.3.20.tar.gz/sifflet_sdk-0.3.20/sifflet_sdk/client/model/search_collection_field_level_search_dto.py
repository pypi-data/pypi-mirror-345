...
def lazy_import():
    from sifflet_sdk.client.model.field_level_search_dto import FieldLevelSearchDto

    globals()["FieldLevelSearchDto"] = FieldLevelSearchDto


class SearchCollectionFieldLevelSearchDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "data": ([FieldLevelSearchDto],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """SearchCollectionFieldLevelSearchDto - a model defined in OpenAPI

        Args:
            data ([FieldLevelSearchDto]):
