...
from .config import BiQwen_START_INDEX, logger
...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def __init__(self, config: Qwen2Config):
        ...
        self.bidirectionals = [BiQwen_START_INDEX > -1 and layer_idx >= BiQwen_START_INDEX
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        for is_bidirectional, decoder_layer in zip(self.bidirectionals, self.layers):
