...
class GetAssetDribbletV1RespUserAssetDribbletsInnerUserAssetDribbletDetailsInner(BaseModel):
    """
    ...
    service_charge_amount: Optional[StrictStr] = Field(default=None, alias="serviceChargeAmount")
    trans_id: Optional[StrictInt] = Field(default=None, alias="transId")
    transfered_amount: Optional[StrictStr] = Field(default=None, alias="transferedAmount")
    __properties: ClassVar[List[str]] = ["amount", "fromAsset", "operateTime", "serviceChargeAmount", "transId", "transferedAmount"]
