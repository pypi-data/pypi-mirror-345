...
__all__ = ['ServiceLanVpnFeatureAssociateMulticastFeatureArgs', 'ServiceLanVpnFeatureAssociateMulticastFeature']

@pulumi.input_type
class ServiceLanVpnFeatureAssociateMulticastFeatureArgs:
    def __init__(__self__, *,
                 feature_profile_id: pulumi.Input[builtins.str],
                 service_lan_vpn_feature_id: pulumi.Input[builtins.str],
                 service_multicast_feature_id: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] service_multicast_feature_id: Service Multicast Feature ID
        """
    ...
    def service_multicast_feature_id(self) -> pulumi.Input[builtins.str]:
        """
        Service Multicast Feature ID
        """
        return pulumi.get(self, "service_multicast_feature_id")

    @service_multicast_feature_id.setter
    def service_multicast_feature_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "service_multicast_feature_id", value)


@pulumi.input_type
class _ServiceLanVpnFeatureAssociateMulticastFeatureState:
    def __init__(__self__, *,
                 feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
                 service_lan_vpn_feature_id: Optional[pulumi.Input[builtins.str]] = None,
                 service_multicast_feature_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="serviceMulticastFeatureId")
    def service_multicast_feature_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Service Multicast Feature ID
        """
        return pulumi.get(self, "service_multicast_feature_id")
    ...
    @service_multicast_feature_id.setter
    def service_multicast_feature_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_multicast_feature_id", value)
...
class ServiceLanVpnFeatureAssociateMulticastFeature(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ServiceLanVpnFeatureAssociateMulticastFeatureArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServiceLanVpnFeatureAssociateMulticastFeatureArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServiceLanVpnFeatureAssociateMulticastFeatureArgs.__new__(ServiceLanVpnFeatureAssociateMulticastFeatureArgs)
    ...
    def get(resource_name: str,
            ...
            service_lan_vpn_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            service_multicast_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'ServiceLanVpnFeatureAssociateMulticastFeature':
        """
        ...
        __props__ = _ServiceLanVpnFeatureAssociateMulticastFeatureState.__new__(_ServiceLanVpnFeatureAssociateMulticastFeatureState)
    ...
    @property
    @pulumi.getter(name="serviceMulticastFeatureId")
    def service_multicast_feature_id(self) -> pulumi.Output[builtins.str]:
        """
        Service Multicast Feature ID
        """
        return pulumi.get(self, "service_multicast_feature_id")
