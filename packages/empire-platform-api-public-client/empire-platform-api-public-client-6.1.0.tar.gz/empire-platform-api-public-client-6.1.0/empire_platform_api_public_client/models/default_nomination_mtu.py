...
class DefaultNominationMtu(BaseModel):
    ...
    """ # noqa: E501
    mtu: Annotated[str, Field(strict=True)] = Field(description="The first moment (inclusive) of an MTU period in local time, minute resolution, interpreted in **System Time**  - string, interpreted in `hh:mm` format - only `XX:00`, `XX:15`, `XX:30` and `XX:45` are valid values (depending on MTU size) ")
    type: DefaultNominationDeclarationType
    ...
    __properties: ClassVar[List[str]] = ["mtu", "type", "value"]
