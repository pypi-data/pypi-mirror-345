...
class DeleteMarginOrderListV1Resp(BaseModel):
    """
    ...
    order_reports: Optional[List[DeleteMarginOrderListV1RespOrderReportsInner]] = Field(default=None, alias="orderReports")
    ...
    __properties: ClassVar[List[str]] = ["contingencyType", "isIsolated", "listClientOrderId", "listOrderStatus", "listStatusType", "orderListId", "orderReports", "orders", "symbol", "transactionTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderReports": [DeleteMarginOrderListV1RespOrderReportsInner.from_dict(_item) for _item in obj["orderReports"]] if obj.get("orderReports") is not None else None,
