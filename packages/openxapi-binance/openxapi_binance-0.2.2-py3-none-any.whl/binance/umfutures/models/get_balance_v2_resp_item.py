...
class GetBalanceV2RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accountAlias", "asset", "availableBalance", "balance", "crossUnPnl", "crossWalletBalance", "marginAvailable", "maxWithdrawAmount", "updateTime"]
