...
#include "./hashmap.h"
#include "./iterator.h"
#include "./pxrTslRobinMap/robin_map.h"
#include "./pxrTslRobinMap/robin_set.h"
#include "./stl.h"
...
using Tf_PathNodeChildrenTable = tsl::robin_map<
...
struct TfMallocTag::_ThreadData {
    ...
    tsl::robin_set<Tf_MallocCallSite *, TfHash> _callSitesOnStack;
};
