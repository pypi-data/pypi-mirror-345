...
class FieldLevelSearchFieldDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, entity_type, name, *args, **kwargs):  # noqa: E501
        """FieldLevelSearchFieldDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, entity_type, name, *args, **kwargs):  # noqa: E501
        """FieldLevelSearchFieldDto - a model defined in OpenAPI
