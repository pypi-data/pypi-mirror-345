...
class RemotesRoleApi(object):
    ...
    def set_label(self, ansible_role_remote_href, set_label,  **kwargs):  # noqa: E501
        """Set a label  # noqa: E501

        Set a single pulp_label on the object to a specific value or null.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_label(ansible_role_remote_href, set_label, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.set_label_with_http_info(ansible_role_remote_href, set_label,  **kwargs)  # noqa: E501

    def set_label_with_http_info(self, ansible_role_remote_href, set_label,  **kwargs):  # noqa: E501
        """Set a label  # noqa: E501

        Set a single pulp_label on the object to a specific value or null.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_label_with_http_info(ansible_role_remote_href, set_label, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('ansible_role_remote_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['ansible_role_remote_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ansible_role_remote_href` when calling `set_label`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '{ansible_role_remote_href}set_label/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def unset_label(self, ansible_role_remote_href, unset_label,  **kwargs):  # noqa: E501
        """Unset a label  # noqa: E501

        Unset a single pulp_label on the object.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unset_label(ansible_role_remote_href, unset_label, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.unset_label_with_http_info(ansible_role_remote_href, unset_label,  **kwargs)  # noqa: E501

    def unset_label_with_http_info(self, ansible_role_remote_href, unset_label,  **kwargs):  # noqa: E501
        """Unset a label  # noqa: E501

        Unset a single pulp_label on the object.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unset_label_with_http_info(ansible_role_remote_href, unset_label, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('ansible_role_remote_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['ansible_role_remote_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ansible_role_remote_href` when calling `unset_label`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '{ansible_role_remote_href}unset_label/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
