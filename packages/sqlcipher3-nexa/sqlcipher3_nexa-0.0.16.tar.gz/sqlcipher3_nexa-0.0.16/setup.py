...
def get_setup_args():
    use_static = os.environ.get('NEXA_SQLCIPHER_STATIC', '').lower() in ('1', 'true', 'yes')

    cmdclass = {
        "build_ext": AmalgationLibSqliteBuilder if use_static else SystemLibSqliteBuilder,
        "build_static": AmalgationLibSqliteBuilder,   # Always static
        "build_dynamic": SystemLibSqliteBuilder,       # Always dynamic, ignores env
    }
