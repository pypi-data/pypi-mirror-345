...
class DayAheadOrIntraDayDefaultBid(BaseModel):
    ...
    bids: List[DayAheadOrIntraDayDefaultBidBids]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bids": [DayAheadOrIntraDayDefaultBidBids.from_dict(_item) for _item in obj["bids"]] if obj.get("bids") is not None else None
        })
        return _obj
