...
mkdir -p "$HOME/results/gemma3-27b-$SLURM_JOB_ID"
cp "$INPUT_FILE" "$HOME/results/gemma3-27b-$SLURM_JOB_ID/gemma3-27b_input.jsonl"
cp "$OUTPUT_FILE" "$HOME/results/gemma3-27b-$SLURM_JOB_ID/gemma3-27b_output.jsonl"
cp "$LOG_FILE" "$HOME/results/gemma3-27b-$SLURM_JOB_ID/gemma3-27b_log.log"
cp /tmp/ollama-$SLURM_JOB_ID.log "$HOME/results/gemma3-27b-$SLURM_JOB_ID/ollama.log"
