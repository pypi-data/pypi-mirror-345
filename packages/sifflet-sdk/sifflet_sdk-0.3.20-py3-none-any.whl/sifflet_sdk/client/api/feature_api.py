...
from sifflet_sdk.client.model.feature_consumption_dto import FeatureConsumptionDto
...
class FeatureApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_feature_consumption_endpoint = _Endpoint(
            settings={
                "response_type": (FeatureConsumptionDto,),
                "auth": ["JWT"],
                "endpoint_path": "/ui/v1/features",
                "operation_id": "get_feature_consumption",
                "http_method": "GET",
                "servers": None,
            },
    ...
    def get_feature_consumption(self, **kwargs):
        """Fetch current feature consumption  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_feature_consumption(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_feature_consumption_endpoint.call_with_http_info(**kwargs)
