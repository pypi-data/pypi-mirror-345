...
__all__ = ['PolicyObjectFeatureProfileArgs', 'PolicyObjectFeatureProfile']

@pulumi.input_type
class PolicyObjectFeatureProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the policy object feature profile
        """
...
@pulumi.input_type
class _PolicyObjectFeatureProfileState:
    def __init__(__self__, *,
...
class PolicyObjectFeatureProfile(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PolicyObjectFeatureProfileArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PolicyObjectFeatureProfileArgs.__new__(PolicyObjectFeatureProfileArgs)

            if description is None and not opts.urn:
                raise TypeError("Missing required property 'description'")
            __props__.__dict__["description"] = description
            __props__.__dict__["name"] = name
        super(PolicyObjectFeatureProfile, __self__).__init__(
            'sdwan:index/policyObjectFeatureProfile:PolicyObjectFeatureProfile',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            description: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'PolicyObjectFeatureProfile':
        """
        ...
        __props__ = _PolicyObjectFeatureProfileState.__new__(_PolicyObjectFeatureProfileState)

        __props__.__dict__["description"] = description
        __props__.__dict__["name"] = name
        return PolicyObjectFeatureProfile(resource_name, opts=opts, __props__=__props__)
