...
def lazy_import():
    ...
    from sifflet_sdk.client.model.qlik_params_all_of import QlikParamsAllOf
    ...
    globals()["QlikParamsAllOf"] = QlikParamsAllOf
    globals()["QlikSpace"] = QlikSpace
    globals()["TimeZoneDto"] = TimeZoneDto


class QlikParams(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """QlikParams - a model defined in OpenAPI

        Keyword Args:
            excluded_spaces ([QlikSpace]):
            host (str):
            included_spaces ([QlikSpace]):
