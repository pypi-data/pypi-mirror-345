...
class UmfuturesGetExchangeInfoV1RespSymbolsInner(BaseModel):
    """
    ...
    filters: Optional[List[UmfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["OrderType", "baseAsset", "baseAssetPrecision", "contractType", "deliveryDate", "filters", "liquidationFee", "maintMarginPercent", "marginAsset", "marketTakeBound", "onboardDate", "pair", "pricePrecision", "quantityPrecision", "quoteAsset", "quotePrecision", "requiredMarginPercent", "settlePlan", "status", "symbol", "timeInForce", "triggerProtect", "underlyingSubType", "underlyingType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": [UmfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None,
