    ...
    def __init__(
        ...
        try:
            ...
            if existing_tasks:
                ...
                print(f"Found existing task: {self.task.metadata.id}")
            else:
                self.task = None
        ...
        if not self.task:
            print(f"Creating task {self.name} in namespace {self.namespace}")
            ...
            print(f"Created task {self.task.metadata.id}")
