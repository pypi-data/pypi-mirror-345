...
class BodyQadeployApiWorkspacesQadeployPost(BaseModel):
    ...
    extra_tags: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["app_name", "image_prefix", "clone_qa_db_data", "author_email", "author_name", "extra_deployment", "extra_tags"]
