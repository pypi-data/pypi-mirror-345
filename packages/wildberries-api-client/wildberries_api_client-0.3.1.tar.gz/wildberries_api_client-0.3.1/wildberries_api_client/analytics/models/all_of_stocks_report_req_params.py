...
class AllOfStocksReportReqParams(CommonReportFilters):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfStocksReportReqParams - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfStocksReportReqParams, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfStocksReportReqParams):
            return False
