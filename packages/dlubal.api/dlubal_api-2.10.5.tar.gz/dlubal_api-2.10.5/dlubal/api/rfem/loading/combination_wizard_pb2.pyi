...
class CombinationWizard(_message.Message):
    ...
    class InitialStateItemsRow(_message.Message):
        ...
        def __init__(self, no: _Optional[int] = ..., description: _Optional[str] = ..., case_object: _Optional[int] = ..., definition_type: _Optional[_Union[CombinationWizard.InitialStateItemsRow.DefinitionType, str]] = ...) -> None: ...
    NO_FIELD_NUMBER: _ClassVar[int]
