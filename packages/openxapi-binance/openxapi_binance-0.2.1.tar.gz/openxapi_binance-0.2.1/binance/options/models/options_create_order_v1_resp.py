...
class OptionsCreateOrderV1Resp(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["avgPrice", "clientOrderId", "createDate", "createTime", "executedQty", "fee", "mmp", "optionSide", "orderId", "postOnly", "price", "priceScale", "quantity", "quantityScale", "quoteAsset", "reduceOnly", "side", "status", "symbol", "timeInForce", "type", "updateTime"]
