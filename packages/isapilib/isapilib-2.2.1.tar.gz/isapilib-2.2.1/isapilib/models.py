...
class VinAccesorio(BaseModel):
    vin = DummyForeignKey(Vin, db_column='VIN', to_field='vin', on_delete=models.PROTECT, related_name='accessories')
...
class Venta(BaseModel, VentaMixin):
    ...
    servicio_serie = DummyForeignKey(Vin, db_column='ServicioSerie', to_field='vin', on_delete=models.PROTECT,
                              related_name='ventas')
...
class VentaD(BaseModel):
    venta = DummyForeignKey(Venta, db_column='ID', to_field='id', on_delete=models.PROTECT, related_name='details')
