...
class GetLocalentityWithdrawHistoryV2RespItem(BaseModel):
    """
    ...
    withdrawal_status: Optional[StrictInt] = Field(default=None, alias="withdrawalStatus")
    __properties: ClassVar[List[str]] = ["address", "addressTag", "amount", "applyTime", "coin", "completeTime", "confirmNo", "id", "info", "network", "questionnaire", "trId", "transactionFee", "transferType", "travelRuleStatus", "txId", "txKey", "walletType", "withdrawOrderId", "withdrawalStatus"]
