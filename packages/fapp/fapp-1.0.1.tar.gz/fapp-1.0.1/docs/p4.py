...
def main():
    ...
    structure1.add_fixity(node_tag=4, ux=0, uy=0, uz=0, rx=0, ry=0, rz=0)
    ...
    # define loading
    structure1.add_load_nodal(node_tag=1, Fx=9.5)
    structure1.add_load_nodal(node_tag=2, Fx=9.5)
    structure1.add_load_nodal(node_tag=3, Fx=9.5)
