...
__all__ = ['ServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6FeatureArgs', 'ServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6Feature']

@pulumi.input_type
class ServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6FeatureArgs:
    def __init__(__self__, *,
                 feature_profile_id: pulumi.Input[builtins.str],
                 service_lan_vpn_feature_id: pulumi.Input[builtins.str],
                 service_routing_ospfv3_ipv6_feature_id: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] service_routing_ospfv3_ipv6_feature_id: Service Routing OSPFv3 IPv6 Feature ID
        """
    ...
    def service_routing_ospfv3_ipv6_feature_id(self) -> pulumi.Input[builtins.str]:
        """
        Service Routing OSPFv3 IPv6 Feature ID
        """
        return pulumi.get(self, "service_routing_ospfv3_ipv6_feature_id")

    @service_routing_ospfv3_ipv6_feature_id.setter
    def service_routing_ospfv3_ipv6_feature_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "service_routing_ospfv3_ipv6_feature_id", value)


@pulumi.input_type
class _ServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6FeatureState:
    def __init__(__self__, *,
                 feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
                 service_lan_vpn_feature_id: Optional[pulumi.Input[builtins.str]] = None,
                 service_routing_ospfv3_ipv6_feature_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="serviceRoutingOspfv3Ipv6FeatureId")
    def service_routing_ospfv3_ipv6_feature_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Service Routing OSPFv3 IPv6 Feature ID
        """
        return pulumi.get(self, "service_routing_ospfv3_ipv6_feature_id")
    ...
    @service_routing_ospfv3_ipv6_feature_id.setter
    def service_routing_ospfv3_ipv6_feature_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_routing_ospfv3_ipv6_feature_id", value)
...
class ServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6Feature(pulumi.CustomResource):
    ...
    pulumi_type = "sdwan:index/serviceLanVpnFeatureAssociateRoutingOspfv3Ipv6Feature:ServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6Feature"
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6FeatureArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6FeatureArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6FeatureArgs.__new__(ServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6FeatureArgs)
    ...
    def get(resource_name: str,
            ...
            service_lan_vpn_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            service_routing_ospfv3_ipv6_feature_id: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'ServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6Feature':
        """
        ...
        __props__ = _ServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6FeatureState.__new__(_ServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6FeatureState)
    ...
    @property
    @pulumi.getter(name="serviceRoutingOspfv3Ipv6FeatureId")
    def service_routing_ospfv3_ipv6_feature_id(self) -> pulumi.Output[builtins.str]:
        """
        Service Routing OSPFv3 IPv6 Feature ID
        """
        return pulumi.get(self, "service_routing_ospfv3_ipv6_feature_id")
