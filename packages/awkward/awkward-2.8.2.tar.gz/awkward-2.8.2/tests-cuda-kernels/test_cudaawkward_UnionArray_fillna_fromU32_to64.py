...
def test_cudaawkward_UnionArray_fillna_fromU32_to64_1():
    toindex = cupy.array([123, 123, 123], dtype=cupy.int64)
    fromindex = cupy.array([1, 0, 0, 1, 1, 1, 0, 0, 1, 0, 1, 0, 1, 1], dtype=cupy.uint32)
    length = 3
    funcC = cupy_backend['awkward_UnionArray_fillna', cupy.int64, cupy.uint32]
...
def test_cudaawkward_UnionArray_fillna_fromU32_to64_2():
    toindex = cupy.array([123, 123, 123], dtype=cupy.int64)
...
def test_cudaawkward_UnionArray_fillna_fromU32_to64_3():
    toindex = cupy.array([123, 123, 123], dtype=cupy.int64)
...
def test_cudaawkward_UnionArray_fillna_fromU32_to64_4():
    toindex = cupy.array([123, 123, 123], dtype=cupy.int64)
...
def test_cudaawkward_UnionArray_fillna_fromU32_to64_5():
    toindex = cupy.array([123, 123, 123], dtype=cupy.int64)
