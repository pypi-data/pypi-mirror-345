...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-appconfig)](https://pypistats.org/packages/mypy-boto3-appconfig)
...
`mypy-boto3-appconfig` dependency in production. However, there is an issue in
...
`mypy_boto3_appconfig.waiter` module contains type annotations for all waiters.
