...
class AddressGroupArgs:
    def __init__(__self__, *,
                 ...
                 static_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] static_lists: The StaticList param. Individual elements in this list are subject to additional validation. String length must not exceed 63 characters. Ensure that only one of the following is specified: `dynamic`, `static`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: Tags for address group object. List must contain at most 64 elements. Individual elements in this list are subject to additional validation. String length must not exceed 127 characters.
        """
    ...
    def static_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @static_lists.setter
    def static_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class AddressGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            static_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tfid: Optional[pulumi.Input[builtins.str]] = None) -> 'AddressGroup':
        """
    ...
    @property
    @pulumi.getter(name="staticLists")
    def static_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The StaticList param. Individual elements in this list are subject to additional validation. String length must not exceed 63 characters. Ensure that only one of the following is specified: `dynamic`, `static`
        """
        return pulumi.get(self, "static_lists")
