...
from SajadMr import Options, Tracing, TreeXML
from SajadMr.__past__ import iterItems
from SajadMr.Errors import SajadQNodeError
from SajadMr.PythonVersions import python_version
from SajadMr.SourceCodeReferences import SourceCodeReference
from SajadMr.utils.InstanceCounters import (
    counted_del,
    counted_init,
    isCountingInstances,
)
from SajadMr.Variables import TempVariable
...
class NodeBase(NodeMetaClassBase):
    ...
    def makeClone(self):
        try:
            ...
            raise SajadQNodeError("Problem cloning node", self, e)
