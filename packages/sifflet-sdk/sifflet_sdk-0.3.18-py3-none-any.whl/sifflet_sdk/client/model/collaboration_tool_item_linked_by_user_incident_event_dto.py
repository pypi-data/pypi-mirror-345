...
def lazy_import():
    from sifflet_sdk.client.model.collaboration_tool_disconnected_incident_event_dto_all_of import (
        CollaborationToolDisconnectedIncidentEventDtoAllOf,
    )
    from sifflet_sdk.client.model.incident_event_dto import IncidentEventDto
    from sifflet_sdk.client.model.user_dto import UserDto

    globals()["CollaborationToolDisconnectedIncidentEventDtoAllOf"] = CollaborationToolDisconnectedIncidentEventDtoAllOf
    globals()["IncidentEventDto"] = IncidentEventDto
    globals()["UserDto"] = UserDto


class CollaborationToolItemLinkedByUserIncidentEventDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CollaborationToolItemLinkedByUserIncidentEventDto - a model defined in OpenAPI
