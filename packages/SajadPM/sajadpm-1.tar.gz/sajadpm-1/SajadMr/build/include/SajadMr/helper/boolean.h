...
#ifndef __SajadSx_HELPER_BOOLEAN_H__
#define __SajadSx_HELPER_BOOLEAN_H__
...
SajadSx_MAY_BE_UNUSED static int CHECK_IF_TRUE(PyObject *object) {
    CHECK_OBJECT(object);
...
SajadSx_MAY_BE_UNUSED static int CHECK_IF_FALSE(PyObject *object) {
...
SajadSx_MAY_BE_UNUSED static inline PyObject *BOOL_FROM(bool value) {
...
typedef enum {
    SajadSx_BOOL_FALSE = 0,
    SajadSx_BOOL_TRUE = 1,
    SajadSx_BOOL_UNASSIGNED = 2,
    SajadSx_BOOL_EXCEPTION = -1
} SajadMr_bool;

typedef enum { SajadSx_VOID_OK = 0, SajadSx_VOID_EXCEPTION = 1 } SajadMr_void;
