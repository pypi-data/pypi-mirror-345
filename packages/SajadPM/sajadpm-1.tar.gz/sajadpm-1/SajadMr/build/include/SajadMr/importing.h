...
#ifndef __SajadSx_IMPORTING_H__
#define __SajadSx_IMPORTING_H__
...
SajadSx_MAY_BE_UNUSED static PyObject *SajadQ_GetSysModules(void) {
...
SajadSx_MAY_BE_UNUSED static bool SajadQ_HasModule(PyThreadState *tstate, PyObject *module_name) {
    return DICT_HAS_ITEM(tstate, SajadQ_GetSysModules(), module_name) == 1;
}

// Replacement for "PyImport_GetModule" working across all versions and less checks.
SajadSx_MAY_BE_UNUSED static PyObject *SajadQ_GetModule(PyThreadState *tstate, PyObject *module_name) {
    return DICT_GET_ITEM1(tstate, SajadQ_GetSysModules(), module_name);
}

// Replacement for PyImport_GetModule working across all versions and less checks.
SajadSx_MAY_BE_UNUSED static PyObject *SajadQ_GetModuleString(PyThreadState *tstate, char const *module_name) {
    PyObject *module_name_object = SajadQ_String_FromString(module_name);
    PyObject *result = SajadQ_GetModule(tstate, module_name_object);
...
SajadSx_MAY_BE_UNUSED static bool SajadQ_SetModule(PyObject *module_name, PyObject *module) {
    CHECK_OBJECT(module_name);
    CHECK_OBJECT(module);
    assert(PyModule_Check(module));

    return DICT_SET_ITEM(SajadQ_GetSysModules(), module_name, module);
}

// Add a module to the modules dictionary from name C string
SajadSx_MAY_BE_UNUSED static bool SajadQ_SetModuleString(char const *module_name, PyObject *module) {
    PyObject *module_name_object = SajadQ_String_FromString(module_name);
    bool result = SajadQ_SetModule(module_name_object, module);
    Py_DECREF(module_name_object);
...
SajadSx_MAY_BE_UNUSED static bool SajadQ_DelModule(PyThreadState *tstate, PyObject *module_name) {
    CHECK_OBJECT(module_name);
...
SajadSx_MAY_BE_UNUSED static bool SajadQ_DelModuleString(PyThreadState *tstate, char const *module_name) {
    PyObject *module_name_object = SajadQ_String_FromString(module_name);
    bool result = SajadQ_DelModule(tstate, module_name_object);
    Py_DECREF(module_name_object);
...
SajadSx_MAY_BE_UNUSED static PyObject *SajadQ_GetFilenameObject(PyThreadState *tstate, PyObject *module) {
#if PYTHON_VERSION < 0x300
