...
class SupplyIdTrbxBody1(object):
    ...
    def __init__(self, trbx_ids=None):  # noqa: E501
        """SupplyIdTrbxBody1 - a model defined in Swagger"""  # noqa: E501
        self._trbx_ids = None
    ...
    @property
    def trbx_ids(self):
        """Gets the trbx_ids of this SupplyIdTrbxBody1.  # noqa: E501

        Spisok ID korobov, kotorye neobhodimo udalit.  # noqa: E501

        :return: The trbx_ids of this SupplyIdTrbxBody1.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def trbx_ids(self, trbx_ids):
        """Sets the trbx_ids of this SupplyIdTrbxBody1.

        Spisok ID korobov, kotorye neobhodimo udalit.  # noqa: E501

        :param trbx_ids: The trbx_ids of this SupplyIdTrbxBody1.  # noqa: E501
        :type: list[str]
        """
        if trbx_ids is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SupplyIdTrbxBody1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SupplyIdTrbxBody1):
            return False
