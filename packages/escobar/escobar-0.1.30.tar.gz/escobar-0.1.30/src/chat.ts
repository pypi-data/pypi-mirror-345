...
import { initPythonBridge, callPython, registerFunction, get_ws, PYTHON_CALL_EVENTS } from './voitta/pythonBridge_browser'
...
const DEFAULT_SETTINGS: IChatSettings = {
  ...
  maxMessages: 100,
  serverUrl: process.env.SERVER_URL || 'ws://localhost:8777/ws',
