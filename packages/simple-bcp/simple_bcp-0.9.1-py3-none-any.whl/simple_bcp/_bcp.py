...
class BCP:
    ...
    def _get_options(
            ...
            packet_size: _POSITIVE_INT | None,
    ) -> dict[str, str | None]:
        ...
        if isinstance(bcp_encoding_settings, (str, pathlib.Path)):
            ...
            options[bcp_encoding_settings.field_encoding_type.value] = None
    ...
    def download_table(
            ...
            packet_size: _POSITIVE_INT | None = None,
    ) -> pathlib.Path:
        """
        ...
        :param packet_size: the number of bytes, per network packet, sent to and from the server.
