...
from empire_platform_api_public_client_legacy.models.participant_dashboard_next_auctions_and_nomination_gates import ParticipantDashboardNextAuctionsAndNominationGates  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ParticipantDashboardNextAuctionsAndNominationGates:
        ...
        if include_optional:
            return ParticipantDashboardNextAuctionsAndNominationGates(
                nomination_gates = [
                    empire_platform_api_public_client_legacy.models.dashboard_next_nomination_gate.DashboardNextNominationGate(
                        timescale = 'LONG_TERM', 
                        window = empire_platform_api_public_client_legacy.models.dashboard_next_nomination_gate_window.DashboardNextNominationGate_window(
                ...
                day_ahead_auctions = [
                    empire_platform_api_public_client_legacy.models.participant_dashboard_next_auction.ParticipantDashboardNextAuction(
