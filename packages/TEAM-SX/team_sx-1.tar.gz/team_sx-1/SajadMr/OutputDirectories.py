...
""" Directories and paths to for output of SajadQ.
...
from SajadMr.utils.Utils import isWin32OrPosixWindows, isWin32Windows
...
def getPgoRunInputFilename():
    return getPgoRunExecutable() + ".SajadMr-pgo"
