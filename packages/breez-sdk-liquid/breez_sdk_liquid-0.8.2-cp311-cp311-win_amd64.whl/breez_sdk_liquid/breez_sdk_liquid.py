...
class Config:
    ...
    def __str__(self):
        return "Config(liquid_explorer={}, bitcoin_explorer={}, working_dir={}, network={}, payment_timeout_sec={}, sync_service_url={}, breez_api_key={}, cache_dir={}, zero_conf_max_amount_sat={}, use_default_external_input_parsers={}, external_input_parsers={}, onchain_fee_rate_leeway_sat_per_vbyte={}, asset_metadata={}, sideswap_api_key={})".format(self.liquid_explorer, self.bitcoin_explorer, self.working_dir, self.network, self.payment_timeout_sec, self.sync_service_url, self.breez_api_key, self.cache_dir, self.zero_conf_max_amount_sat, self.use_default_external_input_parsers, self.external_input_parsers, self.onchain_fee_rate_leeway_sat_per_vbyte, self.asset_metadata, self.sideswap_api_key)
...
class PrepareSendResponse:
    ...
    def __init__(self, *, destination: "SendDestination", fees_sat: "typing.Optional[int]", estimated_asset_fees: "typing.Optional[float]"):
        self.destination = destination
        self.fees_sat = fees_sat
        self.estimated_asset_fees = estimated_asset_fees

    def __str__(self):
        return "PrepareSendResponse(destination={}, fees_sat={}, estimated_asset_fees={})".format(self.destination, self.fees_sat, self.estimated_asset_fees)
...
class SendPaymentRequest:
    ...
    def __init__(self, *, prepare_response: "PrepareSendResponse", use_asset_fees: "typing.Optional[bool]" = _DEFAULT):
        self.prepare_response = prepare_response
    ...
    def __str__(self):
        return "SendPaymentRequest(prepare_response={}, use_asset_fees={})".format(self.prepare_response, self.use_asset_fees)
...
class PayAmount:
    ...
    class ASSET:
        ...
        def __init__(self,asset_id: "str", receiver_amount: "float", estimate_asset_fees: "typing.Optional[bool]"):
            self.asset_id = asset_id
            self.receiver_amount = receiver_amount
            self.estimate_asset_fees = estimate_asset_fees

        def __str__(self):
            return "PayAmount.ASSET(asset_id={}, receiver_amount={}, estimate_asset_fees={})".format(self.asset_id, self.receiver_amount, self.estimate_asset_fees)
...
class PaymentDetails:
    ...
    class LIQUID:
        ...
        def __init__(self,asset_id: "str", destination: "str", description: "str", asset_info: "typing.Optional[AssetInfo]", lnurl_info: "typing.Optional[LnUrlInfo]", bip353_address: "typing.Optional[str]"):
            self.asset_id = asset_id
            self.destination = destination
            self.description = description
        ...
        def __str__(self):
            return "PaymentDetails.LIQUID(asset_id={}, destination={}, description={}, asset_info={}, lnurl_info={}, bip353_address={})".format(self.asset_id, self.destination, self.description, self.asset_info, self.lnurl_info, self.bip353_address)
