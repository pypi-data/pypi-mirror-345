...
LingmoIconButton {
    ...
    property LingmoHotkey syncHotkey: undefined
    signal accepted
    padding: 0
    verticalPadding: 0
    horizontalPadding: 0
    ...
    contentItem: Item {
        ...
        Rectangle {
            id: layout_rect
            border.color: LingmoTheme.dark ? "#505050" : "#DFDFDF"
            border.width: 1
            ...
            Row {
                ...
                LingmoIcon {
                    iconSource: LingmoIcons.EditMirrored
                    iconSize: 13
                    anchors {
    ...
    LingmoCustomDialog {
        ...
        buttonFlags: LingmoCustomDialogType.NegativeButton | LingmoCustomDialogType.PositiveButton | LingmoCustomDialogType.NeutralButton
