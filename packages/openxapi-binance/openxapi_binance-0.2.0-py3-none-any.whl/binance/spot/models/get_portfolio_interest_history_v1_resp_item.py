...
class GetPortfolioInterestHistoryV1RespItem(BaseModel):
    """
    GetPortfolioInterestHistoryV1RespItem
    """ # noqa: E501
    asset: Optional[StrictStr] = None
    interest: Optional[StrictStr] = None
    interest_accrued_time: Optional[StrictInt] = Field(default=None, alias="interestAccruedTime")
    interest_rate: Optional[StrictStr] = Field(default=None, alias="interestRate")
    principal: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["asset", "interest", "interestAccruedTime", "interestRate", "principal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "interestAccruedTime": obj.get("interestAccruedTime"),
