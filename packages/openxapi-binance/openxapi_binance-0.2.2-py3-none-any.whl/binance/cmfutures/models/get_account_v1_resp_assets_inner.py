...
class GetAccountV1RespAssetsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["asset", "availableBalance", "crossUnPnl", "crossWalletBalance", "initialMargin", "maintMargin", "marginBalance", "maxWithdrawAmount", "openOrderInitialMargin", "positionInitialMargin", "unrealizedProfit", "updateTime", "walletBalance"]
