...
class GetUmConditionalOpenOrdersV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["activatePrice", "bookTime", "goodTillDate", "newClientStrategyId", "origQty", "positionSide", "price", "priceMatch", "priceRate", "reduceOnly", "selfTradePreventionMode", "side", "stopPrice", "strategyId", "strategyStatus", "strategyType", "symbol", "timeInForce", "updateTime"]
