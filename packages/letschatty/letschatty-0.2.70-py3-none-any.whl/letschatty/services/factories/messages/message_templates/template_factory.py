...
class TemplateFactory:
    ...
    @staticmethod
    def required_fields_for_template(template: WhatsappTemplate) -> RequiredTemplateData:
        parameters = RequiredTemplateParameter.from_whatsapp_template(template)
        return RequiredTemplateData(name=template.name, text=template.body_component.text, parameters=parameters)
