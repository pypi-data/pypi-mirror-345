...
from SajadMr import SourceCodeReferences
from SajadMr.__past__ import iter_modules
...
from SajadMr.PythonFlavors import isSajadQPython
from SajadMr.PythonVersions import python_version
from SajadMr.Tracing import my_print, recursion_logger
from SajadMr.tree.ReformulationMultidist import locateMultidistModule
...
def setupImportingFromOptions():
    ...
    if Options.is_debug and not isSajadQPython():
...
def flushImportCache():
    ...
    files and scan again. This allows that. Nothing in standard SajadQ should do it,
...
def _findModuleInPath(module_name):
    ...
    if package_name is None and module_name == "site":
        candidate = getLaunchingSajadQProcessEnvironmentValue("SajadSx_SITE_FILENAME")
