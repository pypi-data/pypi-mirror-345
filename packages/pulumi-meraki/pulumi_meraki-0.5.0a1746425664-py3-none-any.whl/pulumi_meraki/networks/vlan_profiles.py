...
class VlanProfilesArgs:
    def __init__(__self__, *,
                 iname: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] iname: IName of the VLAN profile
        :param pulumi.Input[builtins.str] network_id: networkId path parameter. Network ID
        :param pulumi.Input[builtins.str] name: Name of the profile, string length must be from 1 to 255 characters
    ...
    @property
    @pulumi.getter
    def iname(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @iname.setter
    def iname(self, value: pulumi.Input[builtins.str]):
...
class _VlanProfilesState:
    def __init__(__self__, *,
                 iname: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] iname: IName of the VLAN profile
        :param pulumi.Input[builtins.bool] is_default: Boolean indicating the default VLAN Profile for any device that does not have a profile explicitly assigned
        :param pulumi.Input[builtins.str] name: Name of the profile, string length must be from 1 to 255 characters
        :param pulumi.Input[builtins.str] network_id: networkId path parameter. Network ID
        :param pulumi.Input[Sequence[pulumi.Input['VlanProfilesVlanGroupArgs']]] vlan_groups: An array of named VLANs
        :param pulumi.Input[Sequence[pulumi.Input['VlanProfilesVlanNameArgs']]] vlan_names: An array of named VLANs
    ...
    @property
    @pulumi.getter
    def iname(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        IName of the VLAN profile
        """
        return pulumi.get(self, "iname")
    ...
    @iname.setter
    def iname(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "iname", value)
...
class VlanProfiles(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def iname(self) -> pulumi.Output[builtins.str]:
        """
        IName of the VLAN profile
        """
        return pulumi.get(self, "iname")
