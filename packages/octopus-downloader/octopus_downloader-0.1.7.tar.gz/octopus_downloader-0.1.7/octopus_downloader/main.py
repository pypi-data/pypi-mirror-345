...
from octopus_downloader.utils.helper import set_api_key, check_api_key
from octopus_downloader.models.video_downloader import VideoDownloaderOptions
from octopus_downloader.providers.video import ProviderFactory
...
def info(url: str = typer.Argument(..., help="The URL of the video playback page.")):
    ...
    async def async_info():
        try:
            ...
            console.print(f"[green]Video information retrieved successfully![/green]")
            console.print(f"[blue]Title: {video_info['title']}[/blue]")
            console.print(f"[blue]Duration: {video_info['duration']} seconds[/blue]")
            console.print(f"[blue]Download URL: {video_info['download_url']}[/blue]")
            return video_info
...
def download(
    ...
    async def async_download():
        try:
            ...
            console.print(f"[green]Download completed! File saved to {output_file}[/green]")
