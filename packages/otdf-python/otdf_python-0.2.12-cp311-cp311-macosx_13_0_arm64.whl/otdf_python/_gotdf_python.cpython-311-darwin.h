...
/* package gotdf_python/build/lib.macosx-11.0-arm64-cpython-311/otdf_python */
...
//
extern long long gotdf_python_OpentdfConfig_CTor();
extern char* gotdf_python_OpentdfConfig_ClientId_Get(long long handle);
extern void gotdf_python_OpentdfConfig_ClientId_Set(long long handle, char* val);
extern char* gotdf_python_OpentdfConfig_ClientSecret_Get(long long handle);
extern void gotdf_python_OpentdfConfig_ClientSecret_Set(long long handle, char* val);
extern char* gotdf_python_OpentdfConfig_PlatformEndpoint_Get(long long handle);
extern void gotdf_python_OpentdfConfig_PlatformEndpoint_Set(long long handle, char* val);
extern char* gotdf_python_OpentdfConfig_TokenEndpoint_Get(long long handle);
extern void gotdf_python_OpentdfConfig_TokenEndpoint_Set(long long handle, char* val);
extern char* gotdf_python_OpentdfConfig_KasUrl_Get(long long handle);
extern void gotdf_python_OpentdfConfig_KasUrl_Set(long long handle, char* val);
...
extern long long gotdf_python_DecryptFilesInDirNPE(char* dirPath, long long config, long long authScopes);
extern char* gotdf_python_EncryptFile(char* inputFilePath, char* outputFilePath, long long config, long long dataAttributes, long long authScopes);
extern long long gotdf_python_DecryptFilesWithExtensionsNPE(char* dirPath, long long extensions, long long config, long long authScopes);
extern char* gotdf_python_DecryptStringPE(char* inputText, long long config, long long token, long long authScopes);
extern char* gotdf_python_EncryptFilePE(char* inputFilePath, char* outputFilePath, long long config, long long token, long long dataAttributes, long long authScopes);
extern long long gotdf_python_EncryptFilesInDirNPE(char* dirPath, long long config, long long dataAttributes, long long authScopes);
extern long long gotdf_python_EncryptFilesWithExtensionsNPE(char* dirPath, long long extensions, long long config, long long dataAttributes, long long authScopes);
extern char* gotdf_python_EncryptString(char* inputText, long long config, long long dataAttributes, long long authScopes);
extern char* gotdf_python_DecryptFile(char* inputFilePath, char* outputFilePath, long long config);
extern char* gotdf_python_DecryptFilePE(char* inputFilePath, char* outputFilePath, long long config, long long token, long long authScopes);
