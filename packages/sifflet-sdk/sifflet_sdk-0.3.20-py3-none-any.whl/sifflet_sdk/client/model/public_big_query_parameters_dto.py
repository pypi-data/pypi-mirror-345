...
def lazy_import():
    from sifflet_sdk.client.model.public_big_query_parameters_dto_all_of import (
        PublicBigQueryParametersDtoAllOf,
    )
    from sifflet_sdk.client.model.public_source_parameters_dto import (
        PublicSourceParametersDto,
    )

    globals()["PublicBigQueryParametersDtoAllOf"] = PublicBigQueryParametersDtoAllOf
    globals()["PublicSourceParametersDto"] = PublicSourceParametersDto


class PublicBigQueryParametersDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PublicBigQueryParametersDto - a model defined in OpenAPI
