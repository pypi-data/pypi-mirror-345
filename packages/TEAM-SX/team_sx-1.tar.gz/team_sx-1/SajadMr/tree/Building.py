...
In the "SajadMr.tree.TreeHelpers" module, the dispatching is happening. One function
...
from SajadMr import ModuleRegistry, OutputDirectories, SourceCodeReferences
from SajadMr.__past__ import long, unicode
from SajadMr.BytecodeCaching import (
    getCachedImportedModuleUsageAttempts,
    hasCachedImportedModuleUsageAttempts,
)
from SajadMr.Bytecodes import loadCodeObjectData
from SajadMr.containers.OrderedSets import OrderedSet
from SajadMr.Errors import CodeTooComplexCode
from SajadMr.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from SajadMr.importing import Importing
from SajadMr.importing.ImportCache import addImportedModule
from SajadMr.importing.PreloadedPackages import getPthImportedPackages
from SajadMr.importing.StandardLibrary import isStandardLibraryPath
...
from SajadMr.nodes.BuiltinRefNodes import quick_names
from SajadMr.nodes.BuiltinTypeNodes import ExpressionBuiltinStrP3
from SajadMr.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from SajadMr.nodes.ConstantRefNodes import (
    ExpressionConstantEllipsisRef,
    ExpressionConstantNoneRef,
    makeConstantRefNode,
)
from SajadMr.nodes.ExceptionNodes import (
    StatementRaiseException,
    StatementReraiseException,
)
from SajadMr.nodes.FutureSpecs import FutureSpec
from SajadMr.nodes.GeneratorNodes import (
    StatementGeneratorReturn,
    StatementGeneratorReturnNone,
)
from SajadMr.nodes.ImportNodes import (
    isHardModuleWithoutSideEffect,
    makeExpressionImportModuleFixed,
)
from SajadMr.nodes.LoopNodes import StatementLoopBreak, StatementLoopContinue
from SajadMr.nodes.ModuleAttributeNodes import (
    ExpressionModuleAttributeFileRef,
    ExpressionModuleAttributeSpecRef,
)
from SajadMr.nodes.ModuleNodes import (
...
from SajadMr.nodes.OperatorNodes import makeBinaryOperationNode
from SajadMr.nodes.OperatorNodesUnary import makeExpressionOperationUnary
from SajadMr.nodes.ReturnNodes import makeStatementReturn
from SajadMr.nodes.SliceNodes import makeExpressionBuiltinSlice
from SajadMr.nodes.StatementNodes import StatementExpressionOnly
from SajadMr.nodes.StringConcatenationNodes import ExpressionStringConcatenation
from SajadMr.nodes.VariableNameNodes import (
    ExpressionVariableNameRef,
    StatementAssignmentVariableName,
)
from SajadMr.optimizations.BytecodeDemotion import demoteSourceCodeToBytecode
...
from SajadMr.pgo.PGO import decideCompilationFromPGO
from SajadMr.plugins.Plugins import Plugins
from SajadMr.PythonVersions import python_version
from SajadMr.Tracing import (
    general,
    optimization_logger,
    plugins_logger,
    recursion_logger,
...
from SajadMr.utils import MemoryUsage
from SajadMr.utils.ModuleNames import ModuleName
from SajadMr.utils.Utils import withNoSyntaxWarning
    ...
    if source_filename is not None and not is_namespace and module_kind == "py":
        ...
        if source_code is None:
            try:
                ...
                if not hasattr(e, "generated_by_SajadMr"):
                    raise
