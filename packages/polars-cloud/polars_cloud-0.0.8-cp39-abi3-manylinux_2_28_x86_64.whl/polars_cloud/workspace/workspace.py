...
class Workspace:
    ...
    def defaults(self) -> WorkspaceDefaultComputeSpecs | None:
        ...
        try:
            self._defaults = WorkspaceDefaultComputeSpecs._from_api_schema(
                pcr.get_workspace_default_compute_specs(self.id)
            )
    ...
    def _load_by_id(self) -> None:
        ...
        assert self._id is not None
        workspace_details = pcr.get_workspace_details(self._id)
    ...
    def delete(self) -> None:
        ...
        workspace_info = pcr.delete_workspace(self.id)
    ...
    def setup(
        ...
        organizations = pcr.get_organizations(organization_name)
        ...
        workspace_schema = pcr.create_workspace(workspace_name, organization_id)
