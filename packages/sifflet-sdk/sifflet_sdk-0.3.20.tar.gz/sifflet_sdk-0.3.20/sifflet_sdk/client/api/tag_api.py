...
class TagApi(object):
    ...
    def create_tag(self, tag_create_dto, **kwargs):
        """Create a Tag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_tag(tag_create_dto, async_req=True)
        >>> result = thread.get()
    ...
    def update_tag(self, id, tag_update_dto, **kwargs):
        """Update a Tag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_tag(id, tag_update_dto, async_req=True)
        >>> result = thread.get()
