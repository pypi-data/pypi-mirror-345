...
class SecondaryMarketNoticeboardEntry(BaseModel):
    ...
    notice_capacity: Optional[StrictInt] = Field(default=None, description="Capacity value in kilowatts (kW) - the required system precision allows for handling capacity values as integers", alias="noticeCapacity")
    notice_price: Optional[Union[Annotated[float, Field(multiple_of=0.01, strict=True)], Annotated[int, Field(strict=True)]]] = Field(default=None, description="Currency value in Euros (€), accepted with a precision of maximum 2 decimal places", alias="noticePrice")
    ...
    status: SecondaryMarketNoticeboardEntryStatus
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "deliveryPeriod", "timescale", "direction", "noticeCapacity", "noticePrice", "postedAt", "status", "expiresAt", "isOwn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "noticeCapacity": obj.get("noticeCapacity"),
            "noticePrice": obj.get("noticePrice"),
