...
__all__ = ['SystemIpv6DeviceAccessFeatureArgs', 'SystemIpv6DeviceAccessFeature']

@pulumi.input_type
class SystemIpv6DeviceAccessFeatureArgs:
    ...
    @property
    @pulumi.getter
    def sequences(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SystemIpv6DeviceAccessFeatureSequenceArgs']]]]:
        """
    ...
    @sequences.setter
    def sequences(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SystemIpv6DeviceAccessFeatureSequenceArgs']]]]):
        pulumi.set(self, "sequences", value)


@pulumi.input_type
class _SystemIpv6DeviceAccessFeatureState:
    def __init__(__self__, *,
                 default_action: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
...
class SystemIpv6DeviceAccessFeature(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 sequences: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SystemIpv6DeviceAccessFeatureSequenceArgs', 'SystemIpv6DeviceAccessFeatureSequenceArgsDict']]]]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SystemIpv6DeviceAccessFeatureArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SystemIpv6DeviceAccessFeatureArgs.__new__(SystemIpv6DeviceAccessFeatureArgs)
        ...
        super(SystemIpv6DeviceAccessFeature, __self__).__init__(
            'sdwan:index/systemIpv6DeviceAccessFeature:SystemIpv6DeviceAccessFeature',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            sequences: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SystemIpv6DeviceAccessFeatureSequenceArgs', 'SystemIpv6DeviceAccessFeatureSequenceArgsDict']]]]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'SystemIpv6DeviceAccessFeature':
        """
        ...
        __props__ = _SystemIpv6DeviceAccessFeatureState.__new__(_SystemIpv6DeviceAccessFeatureState)
        ...
        return SystemIpv6DeviceAccessFeature(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def sequences(self) -> pulumi.Output[Optional[Sequence['outputs.SystemIpv6DeviceAccessFeatureSequence']]]:
        """
        Device Access Control List
        """
        return pulumi.get(self, "sequences")
