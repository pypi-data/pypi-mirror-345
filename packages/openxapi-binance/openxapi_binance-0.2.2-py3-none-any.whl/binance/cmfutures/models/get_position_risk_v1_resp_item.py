...
class GetPositionRiskV1RespItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["breakEvenPrice", "entryPrice", "isAutoAddMargin", "isolatedMargin", "leverage", "liquidationPrice", "marginType", "markPrice", "maxQty", "positionAmt", "positionSide", "symbol", "unRealizedProfit", "updateTime"]
