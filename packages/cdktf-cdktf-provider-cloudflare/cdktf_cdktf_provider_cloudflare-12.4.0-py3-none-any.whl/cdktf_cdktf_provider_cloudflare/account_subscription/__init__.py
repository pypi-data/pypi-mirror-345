...
Refer to the Terraform Registry for docs: [`cloudflare_account_subscription`](https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_subscription).
'''
...
class AccountSubscription(
    ...
    def __init__(
        ...
        *,
        ...
        subscription_identifier: typing.Optional[builtins.str] = None,
        ...
        :param account_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_subscription#account_id AccountSubscription#account_id}
        :param frequency: How often the subscription is renewed automatically. Available values: "weekly", "monthly", "quarterly", "yearly". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_subscription#frequency AccountSubscription#frequency}
        :param rate_plan: The rate plan applied to the subscription. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_subscription#rate_plan AccountSubscription#rate_plan}
        :param subscription_identifier: Subscription identifier tag. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_subscription#subscription_identifier AccountSubscription#subscription_identifier}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing AccountSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_subscription#import import section} in the documentation of this resource for the id to use
    ...
    def put_rate_plan(
        ...
        *,
        ...
        '''
        :param currency: The currency applied to the rate plan subscription. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_subscription#currency AccountSubscription#currency}
        :param externally_managed: Whether this rate plan is managed externally from Cloudflare. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_subscription#externally_managed AccountSubscription#externally_managed}
        :param id: The ID of the rate plan. Available values: "free", "lite", "pro", "pro_plus", "business", "enterprise", "partners_free", "partners_pro", "partners_business", "partners_enterprise". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_subscription#id AccountSubscription#id} Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param is_contract: Whether a rate plan is enterprise-based (or newly adopted term contract). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_subscription#is_contract AccountSubscription#is_contract}
        :param public_name: The full name of the rate plan. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_subscription#public_name AccountSubscription#public_name}
        :param scope: The scope that this rate plan applies to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_subscription#scope AccountSubscription#scope}
        :param sets: The list of sets this rate plan applies to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/account_subscription#sets AccountSubscription#sets}
        '''
    ...
    @jsii.member(jsii_name="resetSubscriptionIdentifier")
    def reset_subscription_identifier(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetSubscriptionIdentifier", []))
    ...
    @builtins.property
    @jsii.member(jsii_name="subscriptionIdentifierInput")
    def subscription_identifier_input(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "subscriptionIdentifierInput"))
    ...
    @builtins.property
    @jsii.member(jsii_name="subscriptionIdentifier")
    def subscription_identifier(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "subscriptionIdentifier"))

    @subscription_identifier.setter
    def subscription_identifier(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5566010aa9ea5ae4464f0888de46465f968cc7a60d27fceca6227b60cd7f8895)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "subscriptionIdentifier", value) # pyright: ignore[reportArgumentType]
...
class AccountSubscriptionConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument subscription_identifier", value=subscription_identifier, expected_type=type_hints["subscription_identifier"])
        ...
        if subscription_identifier is not None:
            self._values["subscription_identifier"] = subscription_identifier
    ...
    @builtins.property
    def subscription_identifier(self) -> typing.Optional[builtins.str]:
        ...
        '''
        result = self._values.get("subscription_identifier")
        return typing.cast(typing.Optional[builtins.str], result)
...
def _typecheckingstub__5566010aa9ea5ae4464f0888de46465f968cc7a60d27fceca6227b60cd7f8895(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
