...
class GetUmIncomeAsynIdV1Resp(BaseModel):
    """
    ...
    s3_link: Optional[Dict[str, Any]] = Field(default=None, alias="s3Link")
    status: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["downloadId", "expirationTimestamp", "isExpired", "notified", "s3Link", "status", "url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if s3_link (nullable) is None
        # and model_fields_set contains the field
        if self.s3_link is None and "s3_link" in self.model_fields_set:
            _dict['s3Link'] = None
