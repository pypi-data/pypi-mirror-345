...
class AuthenticationPortalArgs:
    def __init__(__self__, *,
                 authentication_profile: Optional[pulumi.Input[builtins.str]] = None,
                 certificate_profile: Optional[pulumi.Input[builtins.str]] = None,
                 device: Optional[pulumi.Input[builtins.str]] = None,
                 folder: Optional[pulumi.Input[builtins.str]] = None,
                 gp_udp_port: Optional[pulumi.Input[builtins.int]] = None,
                 idle_timer: Optional[pulumi.Input[builtins.int]] = None,
                 redirect_host: Optional[pulumi.Input[builtins.str]] = None,
                 snippet: Optional[pulumi.Input[builtins.str]] = None,
                 timer: Optional[pulumi.Input[builtins.int]] = None,
                 tls_service_profile: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a AuthenticationPortal resource.
        :param pulumi.Input[builtins.str] authentication_profile: The AuthenticationProfile param.
        :param pulumi.Input[builtins.str] certificate_profile: The CertificateProfile param.
        :param pulumi.Input[builtins.str] device: The Device param.
        :param pulumi.Input[builtins.str] folder: The Folder param.
        :param pulumi.Input[builtins.int] gp_udp_port: The GpUdpPort param. Value must be between 1 and 65535.
        :param pulumi.Input[builtins.int] idle_timer: The IdleTimer param. Value must be between 1 and 1440.
        :param pulumi.Input[builtins.str] redirect_host: The RedirectHost param.
        :param pulumi.Input[builtins.str] snippet: The Snippet param.
        :param pulumi.Input[builtins.int] timer: The Timer param. Value must be between 1 and 1440.
        :param pulumi.Input[builtins.str] tls_service_profile: The TlsServiceProfile param.
        """
    ...
    def authentication_profile(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def authentication_profile(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "authentication_profile", value)

    @property
    @pulumi.getter(name="certificateProfile")
    def certificate_profile(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def certificate_profile(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def gp_udp_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @gp_udp_port.setter
    def gp_udp_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "gp_udp_port", value)

    @property
    @pulumi.getter(name="idleTimer")
    def idle_timer(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @idle_timer.setter
    def idle_timer(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "idle_timer", value)

    @property
    @pulumi.getter(name="redirectHost")
    def redirect_host(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def redirect_host(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def timer(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @timer.setter
    def timer(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "timer", value)

    @property
    @pulumi.getter(name="tlsServiceProfile")
    def tls_service_profile(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tls_service_profile(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AuthenticationPortal(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tfid: Optional[pulumi.Input[builtins.str]] = None,
            timer: Optional[pulumi.Input[builtins.int]] = None,
            tls_service_profile: Optional[pulumi.Input[builtins.str]] = None) -> 'AuthenticationPortal':
        """
    ...
    @property
    @pulumi.getter(name="authenticationProfile")
    def authentication_profile(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The AuthenticationProfile param.
        """
        return pulumi.get(self, "authentication_profile")
    ...
    @property
    @pulumi.getter(name="certificateProfile")
    def certificate_profile(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The CertificateProfile param.
        """
        return pulumi.get(self, "certificate_profile")
    ...
    @property
    @pulumi.getter(name="gpUdpPort")
    def gp_udp_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The GpUdpPort param. Value must be between 1 and 65535.
        """
        return pulumi.get(self, "gp_udp_port")
    ...
    @property
    @pulumi.getter(name="idleTimer")
    def idle_timer(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The IdleTimer param. Value must be between 1 and 1440.
        """
        return pulumi.get(self, "idle_timer")
    ...
    @property
    @pulumi.getter(name="redirectHost")
    def redirect_host(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The RedirectHost param.
        """
        return pulumi.get(self, "redirect_host")
    ...
    @property
    @pulumi.getter
    def timer(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The Timer param. Value must be between 1 and 1440.
        """
        return pulumi.get(self, "timer")
    ...
    @property
    @pulumi.getter(name="tlsServiceProfile")
    def tls_service_profile(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The TlsServiceProfile param.
        """
        return pulumi.get(self, "tls_service_profile")
