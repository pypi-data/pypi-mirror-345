...
class EncodeObject(BaseModel):
    """
    Must convert to a Thorchain address. Throws when cannot convert.
    """ # noqa: E501
    type_url: StrictStr = Field(alias="typeUrl")
    value: Optional[Any]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EncodeObject from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EncodeObject from a dict"""
        if obj is None:
            return None
