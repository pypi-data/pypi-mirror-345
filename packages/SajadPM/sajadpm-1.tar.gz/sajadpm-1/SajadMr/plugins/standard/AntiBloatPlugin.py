...
SajadQ hard codes stupid monkey patching normally not needed here and avoids
...
from SajadMr.ModuleRegistry import getModuleByName
...
class SajadQPluginAntiBloat(SajadQYamlPluginBase):
    ...
    def onModuleRecursion(
        ...
        for handled_module_name, (
            ...
            if module_name.hasNamespace(handled_module_name):
                ...
                if mode == "error":
                    raise SajadQForbiddenImportEncounter(
