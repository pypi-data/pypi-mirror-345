...
class ITransferWithIncrements(BaseModel):
    ...
    approval_duration_from_now: Optional[NumberType] = Field(default=None, description="The number of unix milliseconds to approve starting from now.", alias="approvalDurationFromNow")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["from", "toAddresses", "balances", "precalculateBalancesFromApproval", "merkleProofs", "memo", "prioritizedApprovals", "onlyCheckPrioritizedCollectionApprovals", "onlyCheckPrioritizedIncomingApprovals", "onlyCheckPrioritizedOutgoingApprovals", "toAddressesLength", "incrementBadgeIdsBy", "incrementOwnershipTimesBy", "approvalDurationFromNow"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of approval_duration_from_now
        if self.approval_duration_from_now:
            _dict['approvalDurationFromNow'] = self.approval_duration_from_now.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "approvalDurationFromNow": NumberType.from_dict(obj["approvalDurationFromNow"]) if obj.get("approvalDurationFromNow") is not None else None
        })
