...
from GooeyEx import PrefixTokenizers
from GooeyEx.gui.components.filtering.prefix_filter import SearchOptions, PrefixSearch
...
Places = namedtuple("Places", ["kabul", "tirana", "kyoto", "tokyo"])
...
class TestPrefixFilter(unittest.TestCase):
    ...
    def setUp(self):
        self.testdata = Places(
            "Afghanistan Kabul", "Albania Tirana", "Japan Kyoto", "Japan Tokyo"
        )
    ...
    def test_prefix_searching(self):
        ...
        cases = [
            ...
            TestData(
                {"choice_tokenizer": PrefixTokenizers.WORDS}, "a", [p.kabul, p.tirana]
            ),
