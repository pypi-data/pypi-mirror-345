...
class TextToSqlRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dataset_ids, rule_template_name, text, *args, **kwargs):  # noqa: E501
        """TextToSqlRequestDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, dataset_ids, rule_template_name, text, *args, **kwargs):  # noqa: E501
        """TextToSqlRequestDto - a model defined in OpenAPI
