...
from istari_digital_client.models.resource_like import ResourceLike

if TYPE_CHECKING:
    from istari_digital_client.api.client_api import ClientApi


class FunctionAuthSecret(BaseModel, ResourceLike):
    """
    ...
    function_auth_provider_id: StrictStr
    function_auth_type: FunctionAuthType
    expiration: Optional[datetime] = None
    _client: Optional["ClientApi"] = None
    __properties: ClassVar[List[str]] = ["id", "created", "file", "comments", "archive_status_history", "created_by_id", "function_auth_provider_id", "function_auth_type", "expiration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "function_auth_provider_id": obj.get("function_auth_provider_id"),
