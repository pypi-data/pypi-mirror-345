...
class TestNormedConstantExtendedHermitePhysicistsFunction(
        TestConstantExtendedHermitePhysicistsFunction, TestNormed,
        unittest.TestCase): pass

class TestNotNormedConstantExtendedHermitePhysicistsFunction(
    TestConstantExtendedHermitePhysicistsFunction, TestNotNormed,
    unittest.TestCase
): pass
...
class TestNormedPositiveDefiniteConstantExtendedHermitePhysicistsFunction(
    ...
    def setUp(self):
        super().setUp()
        # Softer tolerances due to the positive eps.
        self.rtol = 1e-8
        self.atol = 1e-10
...
class TestNormedConstantExtendedHermiteProbabilistsFunction(
        TestConstantExtendedHermiteProbabilistsFunction, TestNormed, unittest.TestCase):
    pass

class TestNotNormedConstantExtendedHermiteProbabilistsFunction(
        TestConstantExtendedHermiteProbabilistsFunction, TestNotNormed, unittest.TestCase):
    pass
...
class TestNotNormedPositiveDefiniteConstantExtendedHermiteProbabilistsFunction(
        TestPositiveDefiniteConstantExtendedHermiteProbabilistsFunction,
        TestNotNormed, unittest.TestCase):
    def setUp(self):
        super().setUp()
        # Softer tolerances due to the positive eps.
        self.rtol = 1e-8
