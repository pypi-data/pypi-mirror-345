...
class ExperimentType:
    ...
    def create(self):
        ...
        response = mdc_client.create_experiment_type_api(self.__get_resource())
    ...
    def update(self):
        mdc_client = self.metadata_client
        response = mdc_client.update_experiment_type_api(self.id,
                                                         self.__get_resource())
    ...
    @staticmethod
    def get_all_by_name(mdc_client, name, page=DEF_PAGE,
                        page_size=DEF_PAGE_SIZE):
        response = mdc_client.get_all_experiment_types_by_name_api(
            name, page, page_size)
