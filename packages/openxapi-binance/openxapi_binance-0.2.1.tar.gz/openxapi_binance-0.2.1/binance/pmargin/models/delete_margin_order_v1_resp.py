...
class DeleteMarginOrderV1Resp(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["clientOrderId", "cummulativeQuoteQty", "executedQty", "orderId", "origClientOrderId", "origQty", "price", "side", "status", "symbol", "timeInForce", "type"]
