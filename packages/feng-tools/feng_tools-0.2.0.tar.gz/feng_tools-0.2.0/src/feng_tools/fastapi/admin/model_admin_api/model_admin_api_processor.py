...
from feng_tools.fastapi.admin.model_admin_api.model_admin_api import ModelAdminApi
from feng_tools.fastapi.admin.model_admin_api.model_admin_api_post_processor import ModelAdminApiPostProcessor
from feng_tools.fastapi.admin.model_admin_api.model_admin_api_pre_processor import ModelAdminApiPreProcessor
from feng_tools.fastapi.admin.model_admin_api.model_value_transformer import ModelValueTransformer
from feng_tools.fastapi.admin.model_admin_api.model_value_validator import ModelValueValidator
...
class ModelAdminApiProcessor(ModelAdminApi):
    def __init__(self, api_tools: ApiTools, db_engine: Engine, model_admin_settings: ModelAdminSettings,
            ...
            if request.query_params:
                ...
                for query_key, query_value in request.query_params.items():
                    ...
                    if query_value != '' and query_key in field_info_dict:
                        field_type = model_tools.get_annotation_outer_type(
                            model_tools.get_field_annotation(field_info_dict.get(query_key)))
