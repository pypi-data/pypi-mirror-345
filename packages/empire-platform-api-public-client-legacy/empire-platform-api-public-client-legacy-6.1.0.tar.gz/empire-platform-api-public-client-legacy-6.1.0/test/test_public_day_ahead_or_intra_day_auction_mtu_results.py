...
from empire_platform_api_public_client_legacy.models.public_day_ahead_or_intra_day_auction_mtu_results import PublicDayAheadOrIntraDayAuctionMtuResults  # noqa: E501
    ...
    def make_instance(self, include_optional) -> PublicDayAheadOrIntraDayAuctionMtuResults:
        ...
        if include_optional:
            return PublicDayAheadOrIntraDayAuctionMtuResults(
                bids = [
                    empire_platform_api_public_client_legacy.models.public_day_ahead_or_intra_day_auction_mtu_results_bids.PublicDayAheadOrIntraDayAuctionMtuResults_bids(
