...
class RequestOAuthIntegrationConfigDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, client_id, url, *args, **kwargs):  # noqa: E501
        """RequestOAuthIntegrationConfigDto - a model defined in OpenAPI
        ...
        Keyword Args:
            provider (str): defaults to "SERVICENOW", must be one of ["SERVICENOW", ]  # noqa: E501
        ...
        provider = kwargs.get("provider", "SERVICENOW")
    ...
    @convert_js_args_to_python_args
    def __init__(self, client_id, url, *args, **kwargs):  # noqa: E501
        """RequestOAuthIntegrationConfigDto - a model defined in OpenAPI
