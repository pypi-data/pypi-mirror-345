...
class DeleteOrderListV3RespOrderReportsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clientOrderId", "cummulativeQuoteQty", "executedQty", "orderId", "orderListId", "origClientOrderId", "origQty", "origQuoteOrderQty", "price", "selfTradePreventionMode", "side", "status", "stopPrice", "symbol", "timeInForce", "transactTime", "type"]
