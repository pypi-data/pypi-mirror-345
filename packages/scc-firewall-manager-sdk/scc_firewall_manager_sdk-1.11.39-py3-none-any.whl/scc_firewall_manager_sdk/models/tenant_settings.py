...
class TenantSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["aiAssistant", "asaHealthMetrics", "autoAcceptDeviceChanges", "autoDiscoverOnPremFmcs", "changeRequestSupport", "conflictDetectionInterval", "denyCiscoSupportAccessToTenant", "multicloudDefense", "policyAnalyzer", "scheduledDeployments", "uid", "webAnalytics"]
