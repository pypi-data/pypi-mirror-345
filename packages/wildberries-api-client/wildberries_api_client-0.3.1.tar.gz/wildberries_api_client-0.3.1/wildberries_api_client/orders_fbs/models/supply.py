...
class Supply(object):
    ...
    def cargo_type(self):
        ...
        <dl> <dt>Tip postavki:</dt> <dd>0 - priznak otsutstvuet</dd> <dd>1 - MGT (Soderhit malogabaritnye tovary)</dd> <dd>2 - SGT (Soderhit sverhgabaritnye tovary)</dd> <dd>3 - KGT+ (Soderhit krupnogabaritnye tovary)</dd> </dl>   # noqa: E501
