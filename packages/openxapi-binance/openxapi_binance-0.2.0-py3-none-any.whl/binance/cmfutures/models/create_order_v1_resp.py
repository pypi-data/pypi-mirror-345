...
class CreateOrderV1Resp(BaseModel):
    """
    CreateOrderV1Resp
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["activatePrice", "avgPrice", "clientOrderId", "closePosition", "cumBase", "cumQty", "executedQty", "orderId", "origQty", "origType", "pair", "positionSide", "price", "priceMatch", "priceProtect", "priceRate", "reduceOnly", "selfTradePreventionMode", "side", "status", "stopPrice", "symbol", "timeInForce", "type", "updateTime", "workingType"]
