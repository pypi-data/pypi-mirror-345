...
class TestLiveDynamicUpdates(unittest.TestCase):
    ...
    def test_validate_form(self):
        ...
        from GooeyEx.tests.dynamics.files import basic
    ...
    def test_lifecycle_handlers(self):
        cases = [
            {
                ...
                "expected_update": "success",
            },
            {
                "input": "fail",
                "expected_stdout": "EXCEPTION",
                "expected_update": "error",
            },
        ]
        from GooeyEx.tests.dynamics.files import lifecycles
        ...
        for case in cases:
            with self.subTest(case):
                with instrumentGooey(lifecycles.make_parser(), **params) as (
                    app,
                    frame,
                    gapp,
                ):
