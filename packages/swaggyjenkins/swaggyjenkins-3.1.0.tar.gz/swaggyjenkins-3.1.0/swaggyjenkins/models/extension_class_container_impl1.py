...
class ExtensionClassContainerImpl1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_class", "_links", "map"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": ExtensionClassContainerImpl1links.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "map": ExtensionClassContainerImpl1map.from_dict(obj["map"]) if obj.get("map") is not None else None
        })
        return _obj
