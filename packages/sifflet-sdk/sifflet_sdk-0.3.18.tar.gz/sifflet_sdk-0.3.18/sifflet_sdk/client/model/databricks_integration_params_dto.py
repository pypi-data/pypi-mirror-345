...
def lazy_import():
    from sifflet_sdk.client.model.databricks_integration_params_dto_all_of import (
        DatabricksIntegrationParamsDtoAllOf,
    )
    ...
    globals()["DatabricksIntegrationParamsDtoAllOf"] = DatabricksIntegrationParamsDtoAllOf
    globals()["IntegrationParamsDto"] = IntegrationParamsDto
    globals()["TimeZoneDto"] = TimeZoneDto


class DatabricksIntegrationParamsDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DatabricksIntegrationParamsDto - a model defined in OpenAPI
