...
[Documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_bedrock_agent_runtime/type_defs/)
...
class ApiResultOutputTypeDef(TypedDict):
    ...
    responseBody: NotRequired[Dict[str, ContentBodyTypeDef]]
...
class OptimizePromptResponseTypeDef(TypedDict):
    optimizedPrompt: AioEventStream[OptimizedPromptStreamTypeDef]
    ResponseMetadata: ResponseMetadataTypeDef
...
class RetrieveAndGenerateStreamResponseTypeDef(TypedDict):
    sessionId: str
    stream: AioEventStream[RetrieveAndGenerateStreamResponseOutputTypeDef]
    ResponseMetadata: ResponseMetadataTypeDef
...
class InvokeInlineAgentResponseTypeDef(TypedDict):
    completion: AioEventStream[InlineAgentResponseStreamTypeDef]
    contentType: str
    sessionId: str
    ResponseMetadata: ResponseMetadataTypeDef
