...
class TestNumbericInputs(unittest.TestCase):
    ...
    def testDefault(self):
        cases = [
            ...
            # unless explicitly widened via gooey_options
            [
                {"widget": "IntegerField", "gooey_options": {"initial_value": 81234}},
                100,
            ],
            # here we set the max to something higher than
            # the default and all works as expected.
            ...
            [
                {
                    "widget": "IntegerField",
                    "gooey_options": {"initial_value": 81234, "max": 99999},
                },
                81234,
            ],
            ...
            # unless explicitly widened via gooey_options
            [
                {"widget": "DecimalField", "gooey_options": {"initial_value": 81234}},
                100,
            ],
            # here we set the max to something higher than
            # the default and all works as expected.
    ...
    def testGooeyOptions(self):
        cases = [
            {
                "widget": "DecimalField",
                "gooey_options": {"min": -100, "max": 1234, "increment": 1.240},
            },
            {
                "widget": "DecimalField",
                "gooey_options": {"min": 1234, "max": 3456, "increment": 2.2},
            },
    ...
    def testNoLossOfPrecision(self):
        parser = self.makeParser(
            widget="DecimalField", default=12.23534, gooey_options={"precision": 20}
        )
        with instrumentGooey(parser) as (app, frame, gapp):
            field = gapp.getActiveConfig().reifiedWidgets[0]
            result = field.getValue()
