...
class rainfall_rate(ResourceTypeDescriptor):
    """The instantaneous amount of rain (liquid water volume) per time."""
    ...
    def __init__(
        self,
        *,
        datasource: Annotated[Optional[Literal['merra2', 'noaa', 'aemet-grid']], 'data source'] = None,
