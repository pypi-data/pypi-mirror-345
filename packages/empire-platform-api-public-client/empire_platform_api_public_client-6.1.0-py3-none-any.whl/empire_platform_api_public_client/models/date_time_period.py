...
class DateTimePeriod(BaseModel):
    """
    Period of date and time, marked by two absolute points in time  - the start of the period is inclusive, while the end of the period is exclusive - interpreted as: start <= VALUE < end 
    """ # noqa: E501
