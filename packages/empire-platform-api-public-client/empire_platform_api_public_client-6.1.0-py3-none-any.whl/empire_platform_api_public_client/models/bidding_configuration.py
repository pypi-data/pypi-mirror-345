...
class BiddingConfiguration(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": [BiddingConfigurationValues.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None,
            "secondaryMarketNotices": BiddingConfigurationSecondaryMarketNotices.from_dict(obj["secondaryMarketNotices"]) if obj.get("secondaryMarketNotices") is not None else None
        })
        return _obj
