...
setup(
    ...
    description="Type annotations for aiobotocore OpsWorksCM 2.22.0 service generated with mypy-boto3-builder 8.10.1",
    classifiers=[
    ...
    keywords="aiobotocore opsworkscm aiobotocore-stubs type-annotations mypy typeshed autocomplete",
