...
def lazy_import():
    ...
    from sifflet_sdk.client.model.new_failures_incident_event_dto_all_of import (
        NewFailuresIncidentEventDtoAllOf,
    )
    ...
    globals()["NewFailuresIncidentEventDtoAllOf"] = NewFailuresIncidentEventDtoAllOf
    globals()["RuleInNewFailuresIncidentEventDto"] = RuleInNewFailuresIncidentEventDto


class NewFailuresIncidentEventDto(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NewFailuresIncidentEventDto - a model defined in OpenAPI

        Keyword Args:
            first_date (int):
            last_date (int):
            rule_failures ([RuleInNewFailuresIncidentEventDto]):
            date (int):
