...
[aiobotocore 2.22.0](https://pypi.org/project/aiobotocore/) compatible with
...
- `types-aiobotocore-lite[full]` - Type annotations for all 402 services in one
  package (recommended).
- `types-aiobotocore-lite[all]` - Type annotations for all 402 services in
  separate packages.
...
- `types-aiobotocore-lite[sms-voice]` - Type annotations for
  [SMSVoice](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/)
  service.
