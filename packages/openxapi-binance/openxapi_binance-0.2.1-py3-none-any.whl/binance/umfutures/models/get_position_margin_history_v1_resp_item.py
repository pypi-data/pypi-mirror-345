...
class GetPositionMarginHistoryV1RespItem(BaseModel):
    """
    GetPositionMarginHistoryV1RespItem
    """ # noqa: E501
    amount: Optional[StrictStr] = None
    asset: Optional[StrictStr] = None
    delta_type: Optional[StrictStr] = Field(default=None, alias="deltaType")
    ...
    __properties: ClassVar[List[str]] = ["amount", "asset", "deltaType", "positionSide", "symbol", "time", "type"]
