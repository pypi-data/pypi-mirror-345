...
class CrossborderTurkeyClientInfoResp(object):
    ...
    """
    swagger_types = {
        'orders': 'list[CrossborderTurkeyClientInfo]'
    }
    ...
    def __init__(self, orders=None):  # noqa: E501
        """CrossborderTurkeyClientInfoResp - a model defined in Swagger"""  # noqa: E501
        self._orders = None
    ...
    @property
    def orders(self):
        """Gets the orders of this CrossborderTurkeyClientInfoResp.  # noqa: E501

        Informacia po klientu dla krossborder-zakaza iz Turcii  # noqa: E501

        :return: The orders of this CrossborderTurkeyClientInfoResp.  # noqa: E501
        :rtype: list[CrossborderTurkeyClientInfo]
        """
        return self._orders

    @orders.setter
    def orders(self, orders):
        """Sets the orders of this CrossborderTurkeyClientInfoResp.

        Informacia po klientu dla krossborder-zakaza iz Turcii  # noqa: E501

        :param orders: The orders of this CrossborderTurkeyClientInfoResp.  # noqa: E501
        :type: list[CrossborderTurkeyClientInfo]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CrossborderTurkeyClientInfoResp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CrossborderTurkeyClientInfoResp):
            return False
