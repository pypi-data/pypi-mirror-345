...
class ParentalControl:
    ...
    def get_auth_url(self):
        ...
        # build the login url
        print('get_auth_url verification_code=', self.verification_code)
        params = {
            "client_id": CLIENT_ID,
    ...
    def process_auth_link(self, link: str):
        ...
        if not resp.ok:
            print('process_auth_link failed', resp.text)
    ...
    def get_account_id(self):
        ...
        if self.account_id is None:
            ...
            print('get_account_id resp=', resp.text)
            print(resp.json())
    ...
    def send_request(self, method='GET', *a, **k):
        ...
        '''
        print('send_request(method=', method, a, k)
        i = 3
        while i > 0:
            i -= 1
    ...
    def add_playtime_minutes_for_today(self, device_label: str, minutes: int):
