...
class CellularGatewaySubnetPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cidr: CIDR of the pool of subnets. Each MG in this network will automatically pick a subnet from this pool.
        :param pulumi.Input[builtins.int] mask: Mask used for the subnet of all MGs in  this network.
        """
