...
class PulpAnsibleApiV3CollectionsVersionsApi(object):
    ...
    def delete(self, name, namespace, path, version,  **kwargs):  # noqa: E501
        """delete  # noqa: E501

        Legacy v3 endpoint.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete(name, namespace, path, version, async_req=True)
        >>> result = thread.get()
        ...
        return self.delete_with_http_info(name, namespace, path, version,  **kwargs)  # noqa: E501

    def delete_with_http_info(self, name, namespace, path, version,  **kwargs):  # noqa: E501
        """delete  # noqa: E501

        Legacy v3 endpoint.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_with_http_info(name, namespace, path, version, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/{path}/api/v3/collections/{namespace}/{name}/versions/{version}/', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
