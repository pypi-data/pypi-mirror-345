...
from wntrfr.network.base import NodeType, LinkType, LinkStatus
from wntrfr.network.elements import Junction, Tank, Reservoir, Pipe, Pump, HeadPump, PowerPump, PRValve, PSValve, FCValve, \
    TCValve, GPValve, PBValve
from collections import OrderedDict
from wntrfr.utils.ordered_set import OrderedSet
from wntrfr.sim import aml
from wntrfr.sim.models import constants, var, param, constraint
from wntrfr.sim.models.utils import ModelUpdater
...
def create_hydraulic_model(wn, HW_approx='default'):
    ...
    -------
    m: wntrfr.aml.Model
    model_updater: wntrfr.models.utils.ModelUpdater
    """
    m = aml.Model()
...
def update_model_for_controls(m, wn, model_updater, change_tracker):
    ...
    model_updater: wntrfr.models.utils.ModelUpdater
    change_tracker: wntrfr.network.controls.ControlChangeTracker
    """
