...
class PulpAnsibleApiV2CollectionsVersionsApi(object):
    ...
    def get(self, name, namespace, path, version,  **kwargs):  # noqa: E501
        """get  # noqa: E501

        Return a response to the \"GET\" action.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get(name, namespace, path, version, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_with_http_info(name, namespace, path, version,  **kwargs)  # noqa: E501

    def get_with_http_info(self, name, namespace, path, version,  **kwargs):  # noqa: E501
        """get  # noqa: E501

        Return a response to the \"GET\" action.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_with_http_info(name, namespace, path, version, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/{path}/api/v2/collections/{namespace}/{name}/versions/{version}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
