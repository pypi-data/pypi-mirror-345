...
class MarginCreateMarginOrderV1Resp(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clientOrderId", "cummulativeQuoteQty", "executedQty", "fills", "isIsolated", "marginBuyBorrowAmount", "marginBuyBorrowAsset", "orderId", "origQty", "price", "selfTradePreventionMode", "side", "status", "symbol", "timeInForce", "transactTime", "type"]
