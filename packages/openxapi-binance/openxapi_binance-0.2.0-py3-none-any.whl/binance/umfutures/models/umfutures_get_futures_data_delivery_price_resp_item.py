...
class UmfuturesGetFuturesDataDeliveryPriceRespItem(BaseModel):
    """
    UmfuturesGetFuturesDataDeliveryPriceRespItem
    """ # noqa: E501
    delivery_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="deliveryPrice")
    delivery_time: Optional[StrictInt] = Field(default=None, alias="deliveryTime")
    __properties: ClassVar[List[str]] = ["deliveryPrice", "deliveryTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deliveryPrice": obj.get("deliveryPrice"),
