...
class UmfuturesUpdateBatchOrdersV1ReqBatchOrdersItem(BaseModel):
    """
    ...
    side: StrictStr
    symbol: StrictStr
    __properties: ClassVar[List[str]] = ["orderId", "origClientOrderId", "price", "priceMatch", "quantity", "side", "symbol"]
