...
class WirelessBluetoothSettingsArgs:
    def __init__(__self__, *,
                 ...
                 advertising_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 major: Optional[pulumi.Input[builtins.int]] = None,
                 major_minor_assignment_mode: Optional[pulumi.Input[builtins.str]] = None,
                 minor: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.bool] advertising_enabled: Whether APs will advertise beacons.
        :param pulumi.Input[builtins.int] major: The major number to be used in the beacon identifier. Only valid in 'Non-unique' mode.
        :param pulumi.Input[builtins.str] major_minor_assignment_mode: The way major and minor number should be assigned to nodes in the network. ('Unique', 'Non-unique')
        :param pulumi.Input[builtins.int] minor: The minor number to be used in the beacon identifier. Only valid in 'Non-unique' mode.
        :param pulumi.Input[builtins.bool] scanning_enabled: Whether APs will scan for Bluetooth enabled clients.
        :param pulumi.Input[builtins.str] uuid: The UUID to be used in the beacon identifier.
        """
    ...
    def advertising_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def advertising_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "advertising_enabled", value)

    @property
    @pulumi.getter
    def major(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @major.setter
    def major(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "major", value)

    @property
    @pulumi.getter(name="majorMinorAssignmentMode")
    def major_minor_assignment_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def major_minor_assignment_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "major_minor_assignment_mode", value)

    @property
    @pulumi.getter
    def minor(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @minor.setter
    def minor(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _WirelessBluetoothSettingsState:
    def __init__(__self__, *,
                 advertising_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 esl_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 major: Optional[pulumi.Input[builtins.int]] = None,
                 major_minor_assignment_mode: Optional[pulumi.Input[builtins.str]] = None,
                 minor: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.bool] advertising_enabled: Whether APs will advertise beacons.
        :param pulumi.Input[builtins.bool] esl_enabled: Whether ESL is enabled on this network.
        :param pulumi.Input[builtins.int] major: The major number to be used in the beacon identifier. Only valid in 'Non-unique' mode.
        :param pulumi.Input[builtins.str] major_minor_assignment_mode: The way major and minor number should be assigned to nodes in the network. ('Unique', 'Non-unique')
        :param pulumi.Input[builtins.int] minor: The minor number to be used in the beacon identifier. Only valid in 'Non-unique' mode.
        :param pulumi.Input[builtins.str] network_id: networkId path parameter. Network ID
    ...
    def esl_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @esl_enabled.setter
    def esl_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class WirelessBluetoothSettings(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_id: Optional[pulumi.Input[builtins.str]] = None,
            scanning_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            uuid: Optional[pulumi.Input[builtins.str]] = None) -> 'WirelessBluetoothSettings':
        """
    ...
    @property
    @pulumi.getter(name="advertisingEnabled")
    def advertising_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Whether APs will advertise beacons.
        """
        return pulumi.get(self, "advertising_enabled")
    ...
    @property
    @pulumi.getter(name="eslEnabled")
    def esl_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Whether ESL is enabled on this network.
        """
        return pulumi.get(self, "esl_enabled")
    ...
    @property
    @pulumi.getter
    def major(self) -> pulumi.Output[builtins.int]:
        """
        The major number to be used in the beacon identifier. Only valid in 'Non-unique' mode.
        """
        return pulumi.get(self, "major")
    ...
    @property
    @pulumi.getter(name="majorMinorAssignmentMode")
    def major_minor_assignment_mode(self) -> pulumi.Output[builtins.str]:
        """
        The way major and minor number should be assigned to nodes in the network. ('Unique', 'Non-unique')
        """
        return pulumi.get(self, "major_minor_assignment_mode")
    ...
    @property
    @pulumi.getter
    def minor(self) -> pulumi.Output[builtins.int]:
        """
        The minor number to be used in the beacon identifier. Only valid in 'Non-unique' mode.
        """
        return pulumi.get(self, "minor")
    ...
    @property
    @pulumi.getter(name="scanningEnabled")
    def scanning_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Whether APs will scan for Bluetooth enabled clients.
        """
        return pulumi.get(self, "scanning_enabled")
