"""
The wntrfr.gis.network module contains methods to convert between water network 
...
import wntrfr.network.elements
...
class WaterNetworkGIS:
    ...
    def _create_gis(self, wn, crs: str = None, pumps_as_points: bool = False, 
        ...
        This method is used by wntrfr.network.io.to_gis
    ...
    def _create_wn(self, append=None):
        ...
        This method is used by wntrfr.network.io.from_gis
        ...
        from wntrfr.network import from_dict
    ...
    def _valid_names(self, complete_list=True, truncate_names=None):
        ...
        element_objects = {
            'junctions': wntrfr.network.elements.Junction,
            'tanks': wntrfr.network.elements.Tank,
            'reservoirs': wntrfr.network.elements.Reservoir,
            'pipes': wntrfr.network.elements.Pipe,
            'pumps': wntrfr.network.elements.Pump,
            'valves': wntrfr.network.elements.Valve}
