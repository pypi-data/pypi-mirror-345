...
class ModelsWarehouseReturnRates(object):
    ...
    def delivery_dump_kgt_office_base(self):
        ...
        <b>Stoimost vozvrata pri gruzovoi dostavke, dostavka na PVZ (bazovaa cena za 1 l), ₽</b> Primenaetsa dla krupnogabaritnyh tovarov, kogda: <ul>   <li>prodavec hohet vyvezti tovary so sklada WB;</li>   <li>na sklade obnaruhili brakovannye tovary;</li>   <li>pokupatel vozvrahaet tovar, no ego nelza vernut v prodahu.</li> </ul>   # noqa: E501
    ...
    def delivery_dump_kgt_office_liter(self):
        ...
        <b>Stoimost vozvrata pri gruzovoi dostavke, dostavka na PVZ (dop. litr), ₽</b><br> Stoimost za kahdyi dopolnitelnyi litr.   # noqa: E501
    ...
    def delivery_dump_kgt_return_expr(self):
        ...
        <b>Stoimost vozvrata pri gruzovoi dostavke, obratnaa logistika nevostrebovannogo vozvrata, ₽</b><br> Gruzovaa dostavka nevostrebovannogo vozvrata obratno na sklad WB. Za edinicu tovara.   # noqa: E501
    ...
    def delivery_dump_srg_office_expr(self):
        ...
        <b>Stoimost vozvrata neopoznannogo skladom tovara za kahduu edinicu, dostavka na PVZ, ₽</b> <p>Primenaetsa dla tovarov, kotorye ne smogli prinat na sklade.</p>   # noqa: E501
    ...
    def delivery_dump_srg_return_expr(self):
        ...
        <p><b>Stoimost vozvrata neopoznannogo skladom tovara za kahduu edinicu, obratnaa logistika nevostrebovannogo vozvrata, ₽</b></p> Dostavka nevostrebovannogo vozvrata obratno na sklad WB.  # noqa: E501
    ...
    def delivery_dump_sup_courier_base(self):
        ...
        **Stoimost vozvrata, dostavka kurerom (bazovaa cena za 1 l), ₽**  Primenaetsa, kogda:   - prodavec hohet vyvezti tovary so sklada Wildberries   - na sklade obnaruhili brakovannye tovary   - pokupatel vozvrahaet tovar, no ego nelza vernut v prodahu   - podkluhen avtovozvrat tovarov, prodavaemyh po sheme Marketpleis   # noqa: E501
    ...
    def delivery_dump_sup_courier_liter(self):
        ...
        **Stoimost vozvrata, dostavka kurerom (dop. l), ₽** <p>Stoimost za kahdyi dopolnitelnyi litr.</p>   # noqa: E501
    ...
    def delivery_dump_sup_office_base(self):
        ...
        **Stoimost vozvrata, dostavka na PVZ (bazovaa cena za 1 l), ₽**  Primenaetsa, kogda:   - prodavec hohet vyvezti tovary so sklada Wildberries   - na sklade obnaruhili brakovannye tovary   - pokupatel vozvrahaet tovar, no ego nelza vernut v prodahu   - podkluhen avtovozvrat tovarov, prodavaemyh po sheme Marketpleis   # noqa: E501
    ...
    def delivery_dump_sup_office_liter(self):
        ...
        <b>Stoimost vozvrata, dostavka na PVZ (dop. litr), ₽</b> Stoimost za kahdyi dopolnitelnyi litr  # noqa: E501
    ...
    def delivery_dump_sup_return_expr(self):
        ...
        <b>Stoimost vozvrata, obratnaa logistika nevostrebovannogo vozvrata, za edinicu tovara, ₽</b><br> Dostavka nevostrebovannogo vozvrata obratno na sklad Wildberries.  Primenaetsa, kogda:   - prodavec hohet vyvezti tovary so sklada Wildberries   - na sklade obnaruhili brakovannye tovary   - pokupatel vozvrahaet tovar, no ego nelza vernut v prodahu   - podkluhen avtovozvrat tovarov, prodavaemyh po sheme Marketpleis   # noqa: E501
