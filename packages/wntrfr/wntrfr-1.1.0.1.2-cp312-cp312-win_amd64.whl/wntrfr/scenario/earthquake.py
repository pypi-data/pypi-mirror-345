"""
The wntrfr.scenario.earthquake module includes methods to
...
class Earthquake(object):
    ...
    def distance_to_epicenter(self, wn, element_type=wntrfr.network.Node):
        """
        ...
        element_type: optional (default = wntrfr.network.Node)
        ...
        if element_type in [wntrfr.network.Link, wntrfr.network.Pipe, wntrfr.network.Pump, wntrfr.network.Valve]:
        ...
        elif element_type in [wntrfr.network.Node, wntrfr.network.Junction, wntrfr.network.Tank, wntrfr.network.Reservoir]:
