...
def publish_rna(key: bpy.types.Property) -> None:
...
def subscribe_rna(key: bpy.types.Property, owner: typing.Any, args: typing.Any, notify: typing.Any, options: typing.Any = set()) -> None:
