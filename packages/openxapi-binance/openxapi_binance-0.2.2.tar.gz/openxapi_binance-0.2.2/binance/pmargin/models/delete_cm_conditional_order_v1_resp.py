...
class DeleteCmConditionalOrderV1Resp(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["activatePrice", "bookTime", "newClientStrategyId", "origQty", "positionSide", "price", "priceProtect", "priceRate", "reduceOnly", "side", "stopPrice", "strategyId", "strategyStatus", "strategyType", "symbol", "timeInForce", "updateTime", "workingType"]
