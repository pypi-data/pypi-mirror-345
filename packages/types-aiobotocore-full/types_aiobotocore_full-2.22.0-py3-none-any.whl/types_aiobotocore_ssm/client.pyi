...
class SSMClient(AioBaseClient):
    ...
    async def get_execution_preview(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ssm/client/#get_execution_preview)
        """
    ...
    async def get_ops_item(
        self, **kwargs: Unpack[GetOpsItemRequestTypeDef]
    ) -> GetOpsItemResponseTypeDef:
        """
    ...
    async def list_nodes(self, **kwargs: Unpack[ListNodesRequestTypeDef]) -> ListNodesResultTypeDef:
        """
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ssm/client/#list_nodes)
        """
    ...
    async def list_nodes_summary(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ssm/client/#list_nodes_summary)
        """
    ...
    async def start_execution_preview(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ssm/client/#start_execution_preview)
        """
