...
class WirelessSsidsFirewallL3FirewallRulesArgs:
    def __init__(__self__, *,
                 ...
                 allow_lan_access: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] allow_lan_access: Allow wireless client access to local LAN (boolean value - true allows access and false denies access) (optional)
    ...
    def allow_lan_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_lan_access(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class WirelessSsidsFirewallL3FirewallRules(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="allowLanAccess")
    def allow_lan_access(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Allow wireless client access to local LAN (boolean value - true allows access and false denies access) (optional)
        """
        return pulumi.get(self, "allow_lan_access")
