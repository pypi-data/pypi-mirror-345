...
def lazy_import():
    from sifflet_sdk.client.model.execute_statement_job_action_all_of import (
        ExecuteStatementJobActionAllOf,
    )
    from sifflet_sdk.client.model.jdbc_datasource_job_action import (
        JdbcDatasourceJobAction,
    )

    globals()["ExecuteStatementJobActionAllOf"] = ExecuteStatementJobActionAllOf
    globals()["JdbcDatasourceJobAction"] = JdbcDatasourceJobAction


class ExecuteStatementJobAction(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ExecuteStatementJobAction - a model defined in OpenAPI
