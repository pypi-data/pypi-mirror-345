...
class ECSClient(AioBaseClient):
    ...
    async def describe_service_deployments(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ecs/client/#describe_service_deployments)
        """
    ...
    async def describe_service_revisions(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ecs/client/#describe_service_revisions)
        """
    ...
    async def list_service_deployments(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ecs/client/#list_service_deployments)
        """
