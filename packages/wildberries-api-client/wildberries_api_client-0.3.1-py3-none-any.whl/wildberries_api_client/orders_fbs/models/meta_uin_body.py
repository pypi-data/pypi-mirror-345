...
class MetaUinBody(object):
    ...
    def __init__(self, uin=None):  # noqa: E501
        """MetaUinBody - a model defined in Swagger"""  # noqa: E501
        self._uin = None
    ...
    @property
    def uin(self):
        """Gets the uin of this MetaUinBody.  # noqa: E501

        UIN  # noqa: E501

        :return: The uin of this MetaUinBody.  # noqa: E501
        :rtype: str
        """
        return self._uin
    ...
    @uin.setter
    def uin(self, uin):
        """Sets the uin of this MetaUinBody.

        UIN  # noqa: E501

        :param uin: The uin of this MetaUinBody.  # noqa: E501
        :type: str
        """
        if uin is None:
            raise ValueError("Invalid value for `uin`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetaUinBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetaUinBody):
            return False
