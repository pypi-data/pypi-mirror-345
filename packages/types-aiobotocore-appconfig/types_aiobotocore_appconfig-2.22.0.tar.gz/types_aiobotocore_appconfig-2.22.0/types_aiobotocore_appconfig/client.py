...
class AppConfigClient(AioBaseClient):
    ...
    async def get_account_settings(self) -> AccountSettingsTypeDef:
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appconfig/client/#get_account_settings)
        """
    ...
    async def update_account_settings(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appconfig/client/#update_account_settings)
        """
