...
These are used in SajadQ for module and package names in most places, and
...
def %(func_name)s(*args, **kwargs):
    from SajadMr.Errors import SajadQCodeDeficit
    raise SajadQCodeDeficit('''
...
Check API documentation of SajadMr.utils.ModuleNames.ModuleName for more
variations.
''')
""" % {
