...
@pro_aws_provider(api=_H,name=_A)
...
@pro_aws_provider(should_load=lambda:is_pro_activated(),requires_license=_B)
...
@pro_aws_provider(api='bedrock-runtime',should_load=lambda:is_pro_activated(),requires_license=_B)
...
@pro_aws_provider(api=_I,should_load=lambda:is_pro_activated()and config_ext.ENABLE_CODEX)
...
@pro_aws_provider(should_load=lambda:is_pro_activated()and config_ext.ENABLE_DMS,requires_license=_B)
...
@pro_aws_provider(api='dynamodb',name=_E)
...
@pro_aws_provider(api=_F,name=_E)
...
@pro_aws_provider(api=_F,name='v1_pro')
...
@pro_aws_provider(api='verifiedpermissions',requires_license=_B)
