...
class GetMarginInterestRateHistoryV1RespItem(BaseModel):
    """
    GetMarginInterestRateHistoryV1RespItem
    """ # noqa: E501
    asset: Optional[StrictStr] = None
    daily_interest_rate: Optional[StrictStr] = Field(default=None, alias="dailyInterestRate")
    timestamp: Optional[StrictInt] = None
    vip_level: Optional[StrictInt] = Field(default=None, alias="vipLevel")
    __properties: ClassVar[List[str]] = ["asset", "dailyInterestRate", "timestamp", "vipLevel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "asset": obj.get("asset"),
            "dailyInterestRate": obj.get("dailyInterestRate"),
