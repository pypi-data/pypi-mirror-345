            ...
            if (indices.length > 1) {
                ...
                indices.slice(1).forEach(index => {
                    ...
                    notebookIssues.push({
                        ...
                        customDetailedDescription: 'This can be confusing for screen reader users as it creates redundant landmarks in the document structure. Please consider combining the sections or using different heading text.',
                        issueContentRaw: heading.html,
                        metadata: {
                            headingStructure: headingStructure.filter(h => h.level === 1 || h.level === 2)
                        }
            ...
            if (h2Headings.has(content)) {
                ...
                h2Headings.get(content).forEach(index => {
                    ...
                    notebookIssues.push({
                        ...
                        cellType: 'markdown',
                        violationId: 'heading-duplicate',
                        customDescription: 'Ensure h1 and h2 headings do not share the same text.',
                        customDetailedDescription: 'This can be confusing for screen reader users as it creates redundant landmarks in the document structure. Please use different text for h1 and h2 headings.',
                        issueContentRaw: heading.html,
                        metadata: {
                            headingStructure: headingStructure.filter(h => h.level === 1 || h.level === 2)
                        }
...
const issueToDescription = new Map([
    ...
    [
        'heading-duplicate',
        {
            ...
            description: 'Ensure identical headings are not used at the same level in the notebook.',
...
//# sourceMappingURL=lib_index_js.178fe8b58c29f2f6375e.js.map