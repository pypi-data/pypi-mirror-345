...
class Button:
    def __init__(self,
        type: Literal['callback', 'link', 'request_geo_location', 'request_contact', 'chat'],
        text: str
    ):
        '''
        Base button class
        '''
        self.type: Literal['callback', 'link', 'request_geo_location', 'request_contact', 'chat'] = type
        self.text: str = text
...
class GeolocationButton(Button):
    def __init__(self,
        ...
        :param text: Button text
        :param quick: Whether to show a confirmational message to a user when pressing the button
        '''
...
class ChatButton(Button):
    def __init__(self,
        ...
        :param payload: Payload that will be sent to the bot when the chat is created
        :param uuid: Chat UUID, assigned when new message is sent. Provide when editing message 
        '''
