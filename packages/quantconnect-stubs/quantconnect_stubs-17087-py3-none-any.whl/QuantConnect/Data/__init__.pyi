...
class SubscriptionDataSource(System.Object, System.IEquatable[QuantConnect_Data_SubscriptionDataSource]):
    ...
    @overload
    def __init__(self, source: str, transport_medium: QuantConnect.SubscriptionTransportMedium, format: QuantConnect.Data.FileFormat, headers: typing.Iterable[System.Collections.Generic.KeyValuePair[str, str]]) -> None:
        """
...
class Slice(QuantConnect.ExtendedDictionary[typing.Any], typing.Iterable[System.Collections.Generic.KeyValuePair[QuantConnect.Symbol, QuantConnect.Data.BaseData]]):
    ...
    @overload
    def __init__(self, time: typing.Union[datetime.datetime, datetime.date], data: typing.Iterable[QuantConnect.Data.BaseData], utc_time: typing.Union[datetime.datetime, datetime.date]) -> None:
        """
...
class SliceExtensions(System.Object):
    ...
    @staticmethod
    @overload
    def get(slices: typing.Iterable[QuantConnect.Data.Slice], type: typing.Type, symbol: typing.Union[QuantConnect.Symbol, str, QuantConnect.Data.Market.BaseContract] = None) -> typing.Iterable[typing.Any]:
        """
    ...
    @staticmethod
    @overload
    def get(slices: typing.Iterable[QuantConnect.Data.Slice], symbol: typing.Union[QuantConnect.Symbol, str, QuantConnect.Data.Market.BaseContract]) -> typing.Iterable[QuantConnect.Data.Market.TradeBar]:
        """
    ...
    @staticmethod
    @overload
    def get(slices: typing.Iterable[QuantConnect.Data.Slice], symbol: typing.Union[QuantConnect.Symbol, str, QuantConnect.Data.Market.BaseContract], field: typing.Callable[[QuantConnect.Data.BaseData], float]) -> typing.Iterable[float]:
        """
