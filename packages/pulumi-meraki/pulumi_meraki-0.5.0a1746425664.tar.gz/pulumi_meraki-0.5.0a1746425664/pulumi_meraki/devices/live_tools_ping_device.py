...
__all__ = ['LiveToolsPingDeviceArgs', 'LiveToolsPingDevice']

@pulumi.input_type
class LiveToolsPingDeviceArgs:
    def __init__(__self__, *,
                 parameters: pulumi.Input['LiveToolsPingDeviceParametersArgs'],
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Input['LiveToolsPingDeviceParametersArgs']:
        return pulumi.get(self, "parameters")

    @parameters.setter
    def parameters(self, value: pulumi.Input['LiveToolsPingDeviceParametersArgs']):
...
class LiveToolsPingDevice(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param LiveToolsPingDeviceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LiveToolsPingDeviceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LiveToolsPingDeviceArgs.__new__(LiveToolsPingDeviceArgs)
        ...
        super(LiveToolsPingDevice, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            parameters: Optional[pulumi.Input[Union['LiveToolsPingDeviceParametersArgs', 'LiveToolsPingDeviceParametersArgsDict']]] = None,
            serial: Optional[pulumi.Input[builtins.str]] = None) -> 'LiveToolsPingDevice':
        """
        ...
        __props__ = _LiveToolsPingDeviceState.__new__(_LiveToolsPingDeviceState)

        __props__.__dict__["item"] = item
        __props__.__dict__["parameters"] = parameters
        __props__.__dict__["serial"] = serial
        return LiveToolsPingDevice(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def item(self) -> pulumi.Output['outputs.LiveToolsPingDeviceItem']:
        return pulumi.get(self, "item")

    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Output['outputs.LiveToolsPingDeviceParameters']:
        return pulumi.get(self, "parameters")
