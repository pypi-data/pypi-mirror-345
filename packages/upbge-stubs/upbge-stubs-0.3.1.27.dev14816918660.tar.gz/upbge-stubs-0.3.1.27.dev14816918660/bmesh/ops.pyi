...
def find_doubles(bm: bmesh.types.BMesh, verts: typing.List[typing.Any] = [], keep_verts: typing.List[typing.Any] = [], dist: float = 0) -> typing.Dict[str, typing.Any]:
...
def remove_doubles(bm: bmesh.types.BMesh, verts: typing.List[typing.Any] = [], dist: float = 0) -> None:
...
def extrude_face_region(bm: bmesh.types.BMesh, geom: typing.List[typing.Any] = [], edges_exclude: typing.Set[typing.Any] = set(), use_keep_orig: bool = False, use_normal_flip: bool = False, use_normal_from_adjacent: bool = False, use_dissolve_ortho_edges: bool = False, use_select_history: bool = False) -> typing.Dict[str, typing.Any]:
...
def dissolve_edges(bm: bmesh.types.BMesh, edges: typing.List[typing.Any] = [], use_verts: bool = False, use_face_split: bool = False) -> typing.Dict[str, typing.Any]:
