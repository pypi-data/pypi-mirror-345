...
class GetBrokerSubAccountMarginSummaryV1RespDataInner(BaseModel):
    """
    GetBrokerSubAccountMarginSummaryV1RespDataInner
    """ # noqa: E501
    margin_enable: Optional[StrictBool] = Field(default=None, alias="marginEnable")
    ...
    __properties: ClassVar[List[str]] = ["marginEnable", "marginLevel", "subAccountId", "totalAssetOfBtc", "totalLiabilityOfBtc", "totalNetAssetOfBtc"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "marginEnable": obj.get("marginEnable"),
