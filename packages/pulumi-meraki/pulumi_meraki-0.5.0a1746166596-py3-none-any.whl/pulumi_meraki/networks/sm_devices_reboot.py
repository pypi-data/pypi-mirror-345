...
__all__ = ['SmDevicesRebootArgs', 'SmDevicesReboot']

@pulumi.input_type
class SmDevicesRebootArgs:
    def __init__(__self__, *,
                 network_id: pulumi.Input[builtins.str],
                 parameters: pulumi.Input['SmDevicesRebootParametersArgs']):
        """
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Input['SmDevicesRebootParametersArgs']:
        return pulumi.get(self, "parameters")

    @parameters.setter
    def parameters(self, value: pulumi.Input['SmDevicesRebootParametersArgs']):
...
class SmDevicesReboot(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param SmDevicesRebootArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SmDevicesRebootArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SmDevicesRebootArgs.__new__(SmDevicesRebootArgs)
        ...
        super(SmDevicesReboot, __self__).__init__(
    ...
    def get(resource_name: str,
        ...
        __props__ = _SmDevicesRebootState.__new__(_SmDevicesRebootState)

        __props__.__dict__["item"] = item
        __props__.__dict__["network_id"] = network_id
        __props__.__dict__["parameters"] = parameters
        return SmDevicesReboot(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def item(self) -> pulumi.Output['outputs.SmDevicesRebootItem']:
        return pulumi.get(self, "item")
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Output['outputs.SmDevicesRebootParameters']:
        return pulumi.get(self, "parameters")
