...
class Image(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["release_timestamp", "status", "attachment", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "caption", "@id", "@type", "summary", "download_url"]
