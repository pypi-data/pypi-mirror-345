...
@deprecated("Use ToolCallConfigDict instead. This will be removed in a future version.")
@dataclass
...
@deprecated("Use ToolCallErrorDict instead. This will be removed in a future version.")
@dataclass
class ToolCallError:
    message: str
